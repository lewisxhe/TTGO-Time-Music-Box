# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\spi_flash//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_encrypt.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_encrypt.h"
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/cache_utils.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/cache_utils.h"
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 2
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
static 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
      _Bool 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
           spi_flash_ensure_unmodified_region(size_t start_addr, size_t length);

typedef struct mmap_entry_{
    uint32_t handle;
    int page;
    int count;
    struct { struct mmap_entry_ *le_next; struct mmap_entry_ **le_prev; } entries;
} mmap_entry_t;


static struct mmap_entries_head { struct mmap_entry_ *lh_first; } s_mmap_entries_head =
        { 
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0) 
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
       };
static uint8_t s_mmap_page_refcnt[4 * 64] = {0};
static uint32_t s_mmap_last_handle = 0;


static void __attribute__((section(".iram1"))) spi_flash_mmap_init()
{
    ...
    for (int i = 0; i < 4 * 64; ++i) {
        uint32_t entry_pro = DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]);
        uint32_t entry_app = DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF12000)[i]);
        ...
        if ((entry_pro & 0x100) == 0 && (i == 0 || i == ((0x400D0000 - 0x40000000) / 0x10000 + 64) || entry_pro != 0)) {
            s_mmap_page_refcnt[i] = 1;
        } else {
            ((volatile uint32_t*) 0x3FF10000)[i] = 0x100;
            ((volatile uint32_t*) 0x3FF12000)[i] = 0x100;
        }
    }
    _xtos_set_intlevel(intLvl);
}

static void __attribute__((section(".iram1"))) get_mmu_region(spi_flash_mmap_memory_t memory, int* out_begin, int* out_size,uint32_t* region_addr)
{
    if (memory == SPI_FLASH_MMAP_DATA) {

        *out_begin = 0;
        *out_size = 64;
        *region_addr = 0x3F400000;
    } else {

        *out_begin = ((0x400D0000 - 0x40000000) / 0x10000 + 64);
        *out_size = 3 * 64 - *out_begin;
        *region_addr = 0x400D0000;
    }
}

esp_err_t __attribute__((section(".iram1"))) spi_flash_mmap(size_t src_addr, size_t size, spi_flash_mmap_memory_t memory,
                         const void** out_ptr, spi_flash_mmap_handle_t* out_handle)
{
    esp_err_t ret;
    if (src_addr & 0xffff) {
    ...
    int phys_page = src_addr / 0x10000;
    int page_count = (size + 0x10000 - 1) / 0x10000;

    int *pages = heap_caps_malloc(sizeof(int)*page_count, (1<<11));
    if (pages == 
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                ((void *)0)
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                    ) {
        return 0x101;
    }
...
esp_err_t __attribute__((section(".iram1"))) spi_flash_mmap_pages(const int *pages, size_t page_count, spi_flash_mmap_memory_t memory,
                         const void** out_ptr, spi_flash_mmap_handle_t* out_handle)
{
    esp_err_t ret;
    
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
   _Bool 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
        did_flush, need_flush = 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                0
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                     ;
    ...
    for (int i = 0; i < page_count; i++) {
        if (pages[i] < 0 || pages[i]*0x10000 >= g_rom_flashchip.chip_size) {
            return 0x102;
        }
    }
    mmap_entry_t* new_entry = (mmap_entry_t*) heap_caps_malloc(sizeof(mmap_entry_t), (1<<11)|(1<<2));
    if (new_entry == 0) {
        return 0x101;
    }
    ...
    did_flush = 0;
    for (int i = 0; i < page_count; i++) {
        if (spi_flash_ensure_unmodified_region(pages[i]*0x10000, 0x10000)) {
            did_flush = 1;
        }
    }
    spi_flash_mmap_init();
    ...
    for (start = region_begin; start < end; ++start) {
        ...
        for (pos = start; pos < start + page_count; ++pos, ++pageno) {
            int table_val = (int) DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[pos]);
    ...
    if (start == end) {
        *out_handle = 0;
        *out_ptr = 
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                  ((void *)0)
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                      ;
        ret = 0x101;
    } else {
        ...
        for (int i = start; i != start + page_count; ++i, ++pageno) {
            ...
            uint32_t entry_pro = DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]);
            uint32_t entry_app = DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF12000)[i]);
            ((s_mmap_page_refcnt[i] == 0 || (entry_pro == pages[pageno] && entry_app == pages[pageno])) ? (void)0 : __assert_func (

                                                "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
            ,

                                                220
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
            , __func__, "s_mmap_page_refcnt[i] == 0 || (entry_pro == pages[pageno] && entry_app == pages[pageno])"))

                                                 ;
            if (s_mmap_page_refcnt[i] == 0) {
                if (entry_pro != pages[pageno] || entry_app != pages[pageno]) {
                    ((volatile uint32_t*) 0x3FF10000)[i] = pages[pageno];
                    ((volatile uint32_t*) 0x3FF12000)[i] = pages[pageno];
                    need_flush = 
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                1
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                    ;
                }
            }
        ...
        _xtos_set_intlevel(intLvl);
        do { ; if (((((new_entry))->entries.le_next) = (((&s_mmap_entries_head))->lh_first)) != 
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0)
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
       ) (((&s_mmap_entries_head))->lh_first)->entries.le_prev = &(((new_entry))->entries.le_next); (((&s_mmap_entries_head))->lh_first) = (new_entry); (new_entry)->entries.le_prev = &(((&s_mmap_entries_head))->lh_first); } while (0);
        new_entry->page = start;
        new_entry->count = page_count;
        new_entry->handle = ++s_mmap_last_handle;
        *out_handle = new_entry->handle;
        *out_ptr = (void*) (region_addr + (start - region_begin) * 0x10000);
        ret = 0;
    }
    ...
    if (*out_ptr == 
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                   ((void *)0)
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                       ) {
        free(new_entry);
    }
    return ret;
...
void __attribute__((section(".iram1"))) spi_flash_munmap(spi_flash_mmap_handle_t handle)
{
    spi_flash_disable_interrupts_caches_and_other_cpu();
    mmap_entry_t* it;

    for (it = ((&s_mmap_entries_head)->lh_first); it != 
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
        ...
        if (it->handle == handle) {
            ...
            for (int i = it->page; i < it->page + it->count; ++i) {
                ((s_mmap_page_refcnt[i] > 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c", 272, __func__, "s_mmap_page_refcnt[i] > 0"));
                if (--s_mmap_page_refcnt[i] == 0) {
                    ((volatile uint32_t*) 0x3FF10000)[i] = 0x100;
                    ((volatile uint32_t*) 0x3FF12000)[i] = 0x100;
                }
...
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
           ((void *)0)
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
    ...
    spi_flash_enable_interrupts_caches_and_other_cpu();
    if (it == 
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
             ((void *)0)
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                 ) {
        ((0 && "invalid handle, or handle already unmapped") ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c", 284, __func__, "0 && \"invalid handle, or handle already unmapped\""));
    }
    free(it);
}
...
void spi_flash_mmap_dump()
{
    ...
    mmap_entry_t* it;
    for (it = ((&s_mmap_entries_head)->lh_first); it != 
# 293 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 293 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                                         ; it = ((it)->entries.le_next)) {
    ...
    for (int i = 0; i < 4 * 64; ++i) {
        if (s_mmap_page_refcnt[i] != 0) {
            printf("page %d: refcnt=%d paddr=%d\n",
                    i, (int) s_mmap_page_refcnt[i], DPORT_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]));
        }
    }
}
...
uint32_t spi_flash_mmap_get_free_pages(spi_flash_mmap_memory_t memory)
{
    ...
    for (int i = region_begin; i < region_begin + region_size; ++i) {
        if (s_mmap_page_refcnt[i] == 0 && DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]) == 0x100) {
            count++;
        }
    }
   _xtos_set_intlevel(intLvl);
...
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
static uint32_t written_pages[256/32];

static 
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
      _Bool 
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
           update_written_pages(size_t start_addr, size_t length, 
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                                                  _Bool 
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                                                       mark);

void __attribute__((section(".iram1"))) spi_flash_mark_modified_region(size_t start_addr, size_t length)
{
    update_written_pages(start_addr, length, 
# 341 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                            1
# 341 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                                );
}

static __attribute__((section(".iram1"))) 
# 344 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                _Bool 
# 344 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                     spi_flash_ensure_unmodified_region(size_t start_addr, size_t length)
{
    return update_written_pages(start_addr, length, 
# 346 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                                   0
# 346 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                                        );
}


static inline __attribute__((section(".iram1"))) 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                       _Bool 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                            update_written_pages(size_t start_addr, size_t length, 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                                                                                   _Bool 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                                                                                        mark)
{
    ...
    uint32_t page_start_addr = start_addr & ~(0x10000 -1);
    length += (start_addr - page_start_addr);
    length = (length + 0x10000 - 1) & ~(0x10000 -1);
    for (uint32_t addr = page_start_addr; addr < page_start_addr + length; addr += 0x10000) {
        int page = addr / 0x10000;
        if (page >= 256) {
            return 
# 359 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                  0
# 359 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                       ;
        }
...
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
            Cache_Flush(0);
            ...
            return 
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
                  1
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
                      ;
        }
    }
    return 
# 384 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
          0
# 384 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
               ;
}
...
uint32_t spi_flash_cache2phys(const void *cached)
{
    ...
    size_t cache_page;
    if (c >= 0x40000000 && c < 0x400D0000) {

        return 0xffffffffUL;
    }
    else if (c < 0x400D0000) {

        cache_page = (c - 0x3F400000) / 0x10000;
    } else {

        cache_page = (c - 0x40000000) / 0x10000 + 64;
    }
    ...
    uint32_t phys_page = DPORT_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[cache_page]);
    if (phys_page == 0x100) {

        return 0xffffffffUL;
    }
    uint32_t phys_offs = phys_page * 0x10000;
    return phys_offs | (c & (0x10000 -1));
}


const void *spi_flash_phys2cache(uint32_t phys_offs, spi_flash_mmap_memory_t memory)
{
    uint32_t phys_page = phys_offs / 0x10000;
    ...
    if (memory == SPI_FLASH_MMAP_DATA) {
        ...
        start = ((0x400D0000 - 0x40000000) / 0x10000 + 64);
        end = 256;
        base = 0x40000000;
        page_delta = 64;
    }
    ...
    for (int i = start; i < end; i++) {
        if (DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]) == phys_page) {
            i -= page_delta;
            intptr_t cache_page = base + (0x10000 * i);
            _xtos_set_intlevel(intLvl);
            return (const void *) (cache_page | (phys_offs & (0x10000 -1)));
        }
    }
    _xtos_set_intlevel(intLvl);
    return 
# 445 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c" 3 4
          ((void *)0)
# 445 "D:/ESP32/esp-idf-v3.1-rc1/components/spi_flash/flash_mmap.c"
              ;
}
