# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\pthread//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
void _pthread_cleanup_pop (struct _pthread_cleanup_context *_context, int _execute)
               ...
               ;
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/queue.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 2
...
typedef struct key_entry_t_ {
    ...
    struct { struct key_entry_t_ *sle_next; } next;
} key_entry_t;


struct key_list_t { struct key_entry_t_ *slh_first; } s_keys = { 
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                             ((void *)0) 
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                             };

static portMUX_TYPE s_keys_lock = { .owner = 0xB33FFFFF, .count = 0, };


typedef struct value_entry_t_ {
    pthread_key_t key;
    void *value;
    struct { struct value_entry_t_ *sle_next; } next;
} value_entry_t;


struct values_list_t_ { struct value_entry_t_ *slh_first; };
...
int pthread_key_create(pthread_key_t *key, pthread_destructor_t destructor)
{
    ...
    if (new_key == 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                  ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                      ) {
        return 12;
    }

    vTaskEnterCritical(&s_keys_lock);

    const key_entry_t *head = ((&s_keys)->slh_first);
    new_key->key = (head == 
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                           ((void *)0)
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                               ) ? 1 : (head->key + 1);
    new_key->destructor = destructor;
    *key = new_key->key;

    do { (((new_key))->next.sle_next) = (((&s_keys))->slh_first); (((&s_keys))->slh_first) = (new_key); } while (0);

    vTaskExitCritical(&s_keys_lock);
    return 0;
}
...
static key_entry_t *find_key(pthread_key_t key)
{
    vTaskEnterCritical(&s_keys_lock);
    key_entry_t *result = 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                         ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                             ;;
    for ((result) = (((&s_keys))->slh_first); (result); (result) = (((result))->next.sle_next)) {
        if(result->key == key) {
            break;
        }
    }
...
int pthread_key_delete(pthread_key_t key)
{
    ...
    if (entry != 
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                ((void *)0)
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                    ) {
        do { ; if ((((&s_keys))->slh_first) == (entry)) { do { ((((&s_keys)))->slh_first) = ((((((&s_keys)))->slh_first))->next.sle_next); } while (0); } else { struct key_entry_t_ *curelm = (((&s_keys))->slh_first); while (((curelm)->next.sle_next) != (entry)) curelm = ((curelm)->next.sle_next); do { ((curelm)->next.sle_next) = ((((curelm)->next.sle_next))->next.sle_next); } while (0); } ; } while (0);
        free(entry);
    }
...
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
static void pthread_local_storage_thread_deleted_callback(int index, void *v_tls)
{
    values_list_t *tls = (values_list_t *)v_tls;
    ((tls != 
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
   ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c", 126, __func__, "tls != NULL"));


    value_entry_t *entry = ((tls)->slh_first);
    while(entry != 
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                  ((void *)0)
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                      ) {
        ...
        if (key != 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                  ((void *)0) 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                       && key->destructor != 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                             ((void *)0)
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
        ...
        value_entry_t *next_entry = ((entry)->next.sle_next);
        free(entry);
        entry = next_entry;
    }
    free(tls);
}
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
void pthread_internal_local_storage_destructor_callback()
{
    void *tls = pvTaskGetThreadLocalStoragePointer(
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                  ((void *)0)
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                      , 0);
    if (tls != 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
              ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                  ) {
        pthread_local_storage_thread_deleted_callback(0, tls);
...
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                       ((void *)0)
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                           ,
                                                        0,
                                                        
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                       ((void *)0)
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                           ,
                                                        
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                       ((void *)0)
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                           );
...
{
    value_entry_t *result = 
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                           ((void *)0)
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                               ;;
    for ((result) = (((list))->slh_first); (result); (result) = (((result))->next.sle_next)) {
        if(result->key == key) {
            break;
        }
    }
...
{
    values_list_t *tls = (values_list_t *) pvTaskGetThreadLocalStoragePointer(
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                                             ((void *)0)
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                                                 , 0);
    if (tls == 
# 202 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
              ((void *)0)
# 202 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                  ) {
        return 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
              ((void *)0)
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                  ;
    }

    value_entry_t *entry = find_value(tls, key);
    if(entry != 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
               ((void *)0)
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                   ) {
        return entry->value;
    }
    return 
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
          ((void *)0)
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
              ;
}
...
int pthread_setspecific(pthread_key_t key, const void *value)
{
    ...
    if (key_entry == 
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                    ((void *)0)
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                        ) {
        return 2;
    }

    values_list_t *tls = pvTaskGetThreadLocalStoragePointer(
# 220 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                           ((void *)0)
# 220 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                               , 0);
    if (tls == 
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
              ((void *)0)
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                  ) {
        tls = calloc(1, sizeof(values_list_t));
        if (tls == 
# 223 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                  ((void *)0)
# 223 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                      ) {
            return 12;
        }
        ...
        vTaskSetThreadLocalStoragePointerAndDelCallback(
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                                                       ((void *)0)
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                                                           ,
                                                        0,
                                                        tls,
    ...
    value_entry_t *entry = find_value(tls, key);
    if (entry != 
# 237 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                ((void *)0)
# 237 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                    ) {
        if (value != 
# 238 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                    ((void *)0)
# 238 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                        ) {


            entry->value = (void *) value;
        } else {
            do { ; if ((((tls))->slh_first) == (entry)) { do { ((((tls)))->slh_first) = ((((((tls)))->slh_first))->next.sle_next); } while (0); } else { struct value_entry_t_ *curelm = (((tls))->slh_first); while (((curelm)->next.sle_next) != (entry)) curelm = ((curelm)->next.sle_next); do { ((curelm)->next.sle_next) = ((((curelm)->next.sle_next))->next.sle_next); } while (0); } ; } while (0);
            free(entry);
        }
    } else if (value != 
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                       ((void *)0)
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                           ) {
        entry = malloc(sizeof(value_entry_t));
        if (entry == 
# 248 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c" 3 4
                    ((void *)0)
# 248 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_local_storage.c"
                        ) {
            return 12;
        }
        entry->key = key;
        entry->value = (void *) value;
        do { (((entry))->next.sle_next) = (((tls))->slh_first); (((tls))->slh_first) = (entry); } while (0);
    }
