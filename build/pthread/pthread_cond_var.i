# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\pthread//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
void _pthread_cleanup_pop (struct _pthread_cleanup_context *_context, int _execute)
               ...
               ;
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/list.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/queue.h" 1
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
int setitimer (int __which, const struct itimerval *restrict __value, struct itimerval *restrict __ovalue)
                                            ;
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 2
const static char *TAG = "esp_pthread";

typedef struct esp_pthread_cond_waiter {
    SemaphoreHandle_t wait_sem;
    struct { struct esp_pthread_cond_waiter *tqe_next; struct esp_pthread_cond_waiter **tqe_prev; } link;
} esp_pthread_cond_waiter_t;

typedef struct esp_pthread_cond {
    _lock_t lock;
    struct { struct esp_pthread_cond_waiter *tqh_first; struct esp_pthread_cond_waiter **tqh_last; } waiter_list;
} esp_pthread_cond_t;

int pthread_cond_signal(pthread_cond_t *cv)
{
    if (cv == 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0) 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                  || *cv == (pthread_cond_t) 0) {
        return 22;
    }
    ...
    entry = ((&cond->waiter_list)->tqh_first);
    if (entry) {
        xQueueGenericSend( ( QueueHandle_t ) ( entry->wait_sem ), 
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
       ((void *)0)
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
...
{
    if (cv == 
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0) 
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                  || *cv == (pthread_cond_t) 0) {
        return 22;
    }
    ...
    _lock_acquire_recursive(&cond->lock);
    esp_pthread_cond_waiter_t *entry;
    for ((entry) = (((&cond->waiter_list))->tqh_first); (entry); (entry) = (((entry))->link.tqe_next)) {
        xQueueGenericSend( ( QueueHandle_t ) ( entry->wait_sem ), 
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
       ((void *)0)
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    _lock_release_recursive(&cond->lock);
...
{
    return pthread_cond_timedwait(cv, mut, 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
                                          ((void *)0)
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                                              );
}
...
int pthread_cond_timedwait(pthread_cond_t *cv, pthread_mutex_t *mut, const struct timespec *to)
{
    ...
    if (cv == 
# 94 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0) 
# 94 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                  || *cv == (pthread_cond_t) 0) {
        return 22;
    }
    ...
    if (to == 
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0)
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                 ) {
        timeout_ticks = ( TickType_t ) 0xffffffffUL;
    } else {
        struct timeval abs_time, cur_time, diff_time;
        long timeout_msec;

        gettimeofday(&cur_time, 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
                               ((void *)0)
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                                   );

        abs_time.tv_sec = to->tv_sec;
        abs_time.tv_usec = to->tv_nsec / 1000;

        if ((((&abs_time)->tv_sec == (&cur_time)->tv_sec) ? ((&abs_time)->tv_usec < (&cur_time)->tv_usec) : ((&abs_time)->tv_sec < (&cur_time)->tv_sec))) {



            timeout_msec = 0;
        } else {
            do { (&diff_time)->tv_sec = (&abs_time)->tv_sec - (&cur_time)->tv_sec; (&diff_time)->tv_usec = (&abs_time)->tv_usec - (&cur_time)->tv_usec; if ((&diff_time)->tv_usec < 0) { --(&diff_time)->tv_sec; (&diff_time)->tv_usec += 1000000; } } while (0);
        ...
        timeout_ticks = timeout_msec / ( ( TickType_t ) 1000 / ( 100 ) );
    }

    esp_pthread_cond_waiter_t w;
    w.wait_sem = xQueueCreateCountingSemaphore( ( 1 ), ( 0 ) );

    _lock_acquire_recursive(&cond->lock);
    do { ; (((&w))->link.tqe_next) = 
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
   ((void *)0)
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
   ; (&w)->link.tqe_prev = (&cond->waiter_list)->tqh_last; *(&cond->waiter_list)->tqh_last = (&w); (&cond->waiter_list)->tqh_last = &(((&w))->link.tqe_next); ; ; } while (0);
    _lock_release_recursive(&cond->lock);
    pthread_mutex_unlock(mut);

    if (xQueueGenericReceive( ( QueueHandle_t ) ( w.wait_sem ), 
# 136 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
       ((void *)0)
# 136 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
    ...
    _lock_acquire_recursive(&cond->lock);
    do { ; ; ; ; if (((((&w))->link.tqe_next)) != 
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
   ((void *)0)
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
   ) (((&w))->link.tqe_next)->link.tqe_prev = (&w)->link.tqe_prev; else { (&cond->waiter_list)->tqh_last = (&w)->link.tqe_prev; ; } *(&w)->link.tqe_prev = (((&w))->link.tqe_next); ; ; ; } while (0);
    _lock_release_recursive(&cond->lock);
    vQueueDelete( ( QueueHandle_t ) ( w.wait_sem ) );
...
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s not yet implemented (%p)" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, attr); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s not yet implemented (%p)" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, attr); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s not yet implemented (%p)" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, attr); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s not yet implemented (%p)" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, attr); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s not yet implemented (%p)" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, attr); } } while(0); } while(0);
    return 88;
}
...
int pthread_cond_init(pthread_cond_t *cv, const pthread_condattr_t *att)
{
    ...
    if (cv == 
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0)
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                 ) {
        return 22;
    }
    ...
    if (cond == 
# 166 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
               ((void *)0)
# 166 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                   ) {
        return 12;
    }

    _lock_init_recursive(&cond->lock);
    do { (((&cond->waiter_list))->tqh_first) = 
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
   ((void *)0)
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
   ; (&cond->waiter_list)->tqh_last = &(((&cond->waiter_list))->tqh_first); ; } while (0);
...
int pthread_cond_destroy(pthread_cond_t *cv)
{
    ...
    if (cv == 
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
             ((void *)0) 
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
                  || *cv == (pthread_cond_t) 0) {
        return 22;
    }
    ...
    _lock_acquire_recursive(&cond->lock);
    if (!((&cond->waiter_list)->tqh_first == 
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c" 3 4
        ((void *)0)
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/pthread/pthread_cond_var.c"
        )) {
        ret = 16;
    }
    _lock_release_recursive(&cond->lock);
