# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\log//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/FreeRTOSConfig.h" 1
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/string.h"
...
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
...
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/queue.h" 1
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 2
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
typedef struct {
    const char* tag;
    uint32_t level : 3;
...
typedef struct uncached_tag_entry_{
    struct { struct uncached_tag_entry_ *sle_next; } entries;
    uint8_t level;
    char tag[0];
} uncached_tag_entry_t;

static esp_log_level_t s_log_default_level = ESP_LOG_VERBOSE;
static struct log_tags_head { struct uncached_tag_entry_ *slh_first; } s_log_tags = { 
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                                                                   ((void *)0) 
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                                                                   };
static cached_tag_entry_t s_log_cache[31];
...
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                                      ((void *)0)
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                                          ;
...
static inline 
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  get_cached_log_level(const char* tag, esp_log_level_t* level);
static inline 
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  get_uncached_log_level(const char* tag, esp_log_level_t* level);
...
static inline 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  should_output(esp_log_level_t level_for_message, esp_log_level_t level_for_tag);
static inline void clear_log_level_list();

vprintf_like_t esp_log_set_vprintf(vprintf_like_t func)
{
    if (!s_log_mutex) {
        s_log_mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    }
    xQueueGenericReceive( ( QueueHandle_t ) ( s_log_mutex ), 
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ((void *)0)
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );

    vprintf_like_t orig_func = s_log_print_func;
    s_log_print_func = func;

    xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 119 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ((void *)0)
# 119 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
...
void esp_log_level_set(const char* tag, esp_log_level_t level)
{
    ...
    xQueueGenericReceive( ( QueueHandle_t ) ( s_log_mutex ), 
# 128 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ((void *)0)
# 128 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    ...
    if (strcmp(tag, "*") == 0) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
       ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        return;
    }
...
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                              ((void *)0)
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                                  ;
    for ((it) = (((&s_log_tags))->slh_first); (it); (it) = (((it))->entries.sle_next)) {
    ...
    if ( it == 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
              ((void *)0) 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                   ) {

        size_t entry_size = 
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                           __builtin_offsetof (
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                           uncached_tag_entry_t
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                           , 
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
...
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
        ...
        if (!new_entry) {
            xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
           ((void *)0)
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
            return;
        }
        new_entry->level = (uint8_t) level;
        strcpy(new_entry->tag, tag);
        do { (((new_entry))->entries.sle_next) = (((&s_log_tags))->slh_first); (((&s_log_tags))->slh_first) = (new_entry); } while (0);
    }
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}

void clear_log_level_list()
{
    while( !((&s_log_tags)->slh_first == 
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
           ((void *)0)
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
           )) {
        do { (((&s_log_tags))->slh_first) = (((((&s_log_tags))->slh_first))->entries.sle_next); } while (0);
    }
...
void __attribute__((section(".iram1"))) esp_log_write(esp_log_level_t level,
        const char* tag,
        const char* format, ...)
{
    if (!s_log_mutex) {
    ...
    if (xQueueGenericReceive( ( QueueHandle_t ) ( s_log_mutex ), 
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
       ((void *)0)
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
       , ( ((10 + ( ( TickType_t ) 1000 / ( 100 ) ) - 1) / ( ( TickType_t ) 1000 / ( 100 ) )) ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 )) {
        return;
    }
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ((void *)0)
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   __builtin_va_start(
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   list
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   ,
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
...
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   __builtin_va_end(
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
   list
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
   )
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
...
static inline 
# 219 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 219 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  get_cached_log_level(const char* tag, esp_log_level_t* level)
{
    ...
    if (i == s_log_cache_entry_count) {
        return 
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
              0
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                   ;
    }
    ...
    *level = (esp_log_level_t) s_log_cache[i].level;
    ...
    return 
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
          1
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
              ;
}
...
static inline 
# 277 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 277 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  get_uncached_log_level(const char* tag, esp_log_level_t* level)
{
    ...
    for ((it) = (((&s_log_tags))->slh_first); (it); (it) = (((it))->entries.sle_next)) {
        if (strcmp(tag, it->tag) == 0) {
            *level = it->level;
            return 
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
                  1
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                      ;
        }
    }
    return 
# 288 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
          0
# 288 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
               ;
}

static inline 
# 291 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c" 3 4
             _Bool 
# 291 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
                  should_output(esp_log_level_t level_for_message, esp_log_level_t level_for_tag)
{
...
# 324 "D:/ESP32/esp-idf-v3.1-rc1/components/log/log.c"
extern uint32_t g_ticks_per_us_pro;

uint32_t __attribute__((section(".iram1"))) esp_log_early_timestamp()
{
...
uint32_t __attribute__((section(".iram1"))) esp_log_timestamp()
{
    ...
    return base + xTaskGetTickCount() * (1000 / ( 100 ));
}
...
void esp_log_buffer_hexdump_internal( const char *tag, const void *buffer, uint16_t buff_len, esp_log_level_t log_level)
{
    ...
    char hd_buffer[10+3+16*3+3+16 +1+1];
    char *ptr_hd;
    int bytes_cur_line;
    ...
    do {
        ...
        ptr_hd += sprintf( ptr_hd, "  |" );
        for( int i = 0; i < bytes_cur_line; i ++ ) {
            if ( (((__ctype_ptr__+sizeof(""[(int)ptr_line[i]]))[(int)((int)ptr_line[i])])&(020|01|02|04|0200)) ) {
