# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\tft//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
# 11 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/spidriver/spi_master_lobo.h"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/spidriver/spi_master_lobo.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/spidriver/spi_master_lobo.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/spidriver/spi_master_lobo.h" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/spi_reg.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 2
...
uint8_t tft_disp_type = 2;


spi_lobo_device_handle_t disp_spi = 
# 35 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                                   ((void *)0)
# 35 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                                       ;
spi_lobo_device_handle_t ts_spi = 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                                 ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                                     ;




static color_t *trans_cline = 
# 41 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                             ((void *)0)
# 41 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                                 ;
static uint8_t _dma_sending = 0;
# 55 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
esp_err_t __attribute__((section(".iram1"))) wait_trans_finish(uint8_t free_line)
{
 ...
 if ((free_line) && (trans_cline)) {
  free(trans_cline);
  trans_cline = 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
               ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                   ;
 }
 if (_dma_sending) {
  ...
  disp_spi->host->hw->dma_conf.val |= ((1UL << (3)))|((1UL << (2)))|((1UL << (5)))|((1UL << (4)));
...
esp_err_t __attribute__((section(".iram1"))) disp_select()
{
 wait_trans_finish(1);
...
esp_err_t __attribute__((section(".iram1"))) disp_deselect()
{
 wait_trans_finish(1);
...
static void __attribute__((section(".iram1"))) _spi_transfer_start(spi_lobo_device_handle_t spi_dev, int wrbits, int rdbits) {
...
void __attribute__((section(".iram1"))) disp_spi_transfer_cmd(int8_t cmd) {
...
void __attribute__((section(".iram1"))) disp_spi_transfer_cmd_data(int8_t cmd, uint8_t *data, uint32_t len) {
 ...
 if ((len == 0) || (data == 
# 137 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                           ((void *)0)
# 137 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                               )) return;
...
static void __attribute__((section(".iram1"))) disp_spi_transfer_addrwin(uint16_t x1, uint16_t x2, uint16_t y1, uint16_t y2) {
 uint32_t wd;
 ...
 disp_spi->host->hw->data_buf[0] = (uint32_t)0x2A;
 ...
 disp_spi->host->hw->cmd.usr = 1;
    ...
    while (disp_spi->host->hw->cmd.usr);
    gpio_set_level(16, 0);
    disp_spi->host->hw->data_buf[0] = (uint32_t)0x2B;
 disp_spi->host->hw->mosi_dlen.usr_mosi_dbitlen = 7;
 disp_spi->host->hw->cmd.usr = 1;
...
static color_t __attribute__((section(".iram1"))) color2gs(color_t color)
{
 color_t _color;
    float gs_clr = 0.2989 * color.r + 0.4870 * color.g + 0.2140 * color.b;
...
void __attribute__((section(".iram1"))) drawPixel(int16_t x, int16_t y, color_t color, uint8_t sel)
{
 if (!(disp_spi->cfg.flags & (1<<4))) return;
 ...
 disp_spi_transfer_addrwin(x, x+1, y, y+1);
    ...
    gpio_set_level(16, 0);
    disp_spi->host->hw->data_buf[0] = (uint32_t)0x2C;
 disp_spi->host->hw->mosi_dlen.usr_mosi_dbitlen = 7;
 disp_spi->host->hw->cmd.usr = 1;
 while (disp_spi->host->hw->cmd.usr);
...
static void __attribute__((section(".iram1"))) _dma_send(uint8_t *data, uint32_t size)
{

    spi_lobo_dmaworkaround_transfer_active(disp_spi->host->dma_chan);
    spi_lobo_setup_dma_desc_links(disp_spi->host->dmadesc_tx, size, data, 
# 286 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                                                                         0
# 286 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                                                                              );
    disp_spi->host->hw->user.usr_mosi_highpart=0;
...
static void __attribute__((section(".iram1"))) _direct_send(color_t *color, uint32_t len, uint8_t rep)
{
 uint32_t cidx = 0;
 uint32_t wd = 0;
 int idx = 0;
...
# 361 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
static void __attribute__((section(".iram1"))) _TFT_pushColorRep(color_t *color, uint32_t len, uint8_t rep, uint8_t wait)
{
 if (len == 0) return;
 if (!(disp_spi->cfg.flags & (1<<4))) return;
...
# 407 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
  buf_colors = ((len > (_width*2)) ? (_width*2) : len);
  buf_bytes = buf_colors * 3;


  trans_cline = heap_caps_malloc(buf_bytes, (1<<3));
  if (trans_cline == 
# 412 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                    ((void *)0)
# 412 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                        ) return;
...
void __attribute__((section(".iram1"))) TFT_pushColorRep(int x1, int y1, int x2, int y2, color_t color, uint32_t len)
{
 if (disp_select() != 0) return;
...
void __attribute__((section(".iram1"))) send_data(int x1, int y1, int x2, int y2, uint32_t len, color_t *buf)
{
...
int __attribute__((section(".iram1"))) read_data(int x1, int y1, int x2, int y2, int len, uint8_t *buf, uint8_t set_sp)
{
 ...
 if (set_sp) {
  if (disp_deselect() != 0) return -1;

  current_clock = spi_lobo_get_speed(disp_spi);
  if (max_rdclock < current_clock) spi_lobo_set_speed(disp_spi, max_rdclock);
 }

 if (disp_select() != 0) return -2;


 disp_spi_transfer_addrwin(x1, x2, y1, y2);


 disp_spi_transfer_cmd(0x2E);

    t.length=0;
    t.tx_buffer=
# 487 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
               ((void *)0)
# 487 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                   ;
    t.rxlength=8*((len*3)+1);
    t.rx_buffer=buf;


 esp_err_t res = spi_lobo_transfer_data(disp_spi, &t);
...
color_t __attribute__((section(".iram1"))) readPixel(int16_t x, int16_t y)
{
...
int __attribute__((section(".iram1"))) touch_get_data(uint8_t type)
{
# 540 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
...
# 558 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
static void __attribute__((section(".iram1"))) stmpe610_write_reg(uint8_t reg, uint8_t val) {
...
static uint8_t __attribute__((section(".iram1"))) stmpe610_read_byte(uint8_t reg) {
    spi_lobo_device_select(ts_spi, 0);
...
static uint16_t __attribute__((section(".iram1"))) stmpe610_read_word(uint8_t reg) {
    spi_lobo_device_select(ts_spi, 0);
...
void stmpe610_Init()
{
    stmpe610_write_reg(0x03, 0x02);
    vTaskDelay(10 / ( ( TickType_t ) 1000 / ( 100 ) ));

    stmpe610_write_reg(0x04, 0x04);

    stmpe610_write_reg(0x0A, 0x00);

    stmpe610_write_reg(0x20, 0x48);
    vTaskDelay(2 / ( ( TickType_t ) 1000 / ( 100 ) ));
    stmpe610_write_reg(0x21, 0x01);
    stmpe610_write_reg(0x17, 0x00);
    stmpe610_write_reg(0x41, 0xE3);
    stmpe610_write_reg(0x4A, 0x01);
    stmpe610_write_reg(0x4B, 0x01);
    stmpe610_write_reg(0x4B, 0x00);
    stmpe610_write_reg(0x56, 0x07);
    stmpe610_write_reg(0x58, 0x01);
    stmpe610_write_reg(0x40, 0x30);
    stmpe610_write_reg(0x40, 0x31);
    stmpe610_write_reg(0x0B, 0xFF);
    stmpe610_write_reg(0x09, 0x00);
}


int stmpe610_get_touch(uint16_t *x, uint16_t *y, uint16_t *z)
{
 if (!(stmpe610_read_byte(0x40) & 0x80)) return 0;


    uint8_t fifo_size = stmpe610_read_byte(0x4C);
    while (fifo_size < 2) {
     if (!(stmpe610_read_byte(0x40) & 0x80)) return 0;
        fifo_size = stmpe610_read_byte(0x4C);
    }
    while (fifo_size > 120) {
     if (!(stmpe610_read_byte(0x40) & 0x80)) return 0;
        *x = stmpe610_read_word(0x4D);
        *y = stmpe610_read_word(0x4F);
        *z = stmpe610_read_byte(0x51);
        fifo_size = stmpe610_read_byte(0x4C);
    }
...
uint32_t find_rd_speed()
{
 ...
 uint32_t max_speed = 1000000;
    ...
    int line_check;
    color_t *color_line = 
# 675 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                         ((void *)0)
# 675 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                             ;
    uint8_t *line_rdbuf = 
# 676 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                         ((void *)0)
# 676 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                             ;
 ...
 color_line = malloc(_width*3);
    if (color_line == 
# 683 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                     ((void *)0)
# 683 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                         ) goto exit;

    line_rdbuf = malloc((_width*3)+1);
 if (line_rdbuf == 
# 686 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c" 3 4
                  ((void *)0)
# 686 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
                      ) goto exit;
...
# 804 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
    switch (rotation) {
        case 0:
        madctl = (0x80 | 0x40 | 0x00);
        break;
        case 1:
...
# 849 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
 if (send) {
  if (disp_select() == 0) {
   disp_spi_transfer_cmd_data(0x36, &madctl, 1);
   disp_deselect();
  }
 }
...
void TFT_PinsInit()
{
    ...
    gpio_set_level(16, 0);
# 886 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c"
...
void TFT_display_init()
{
    ...
    gpio_set_level(17, 1);
    vTaskDelay(150 / ( ( TickType_t ) 1000 / ( 100 ) ));


    ret = disp_select();
    ((ret==0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c", 907, __func__, "ret==ESP_OK"));

 if (tft_disp_type == 0) {
  commandList(disp_spi, ILI9341_init);
 }
 else if (tft_disp_type == 1) {
  commandList(disp_spi, ILI9488_init);
 }
 else if (tft_disp_type == 2) {
  commandList(disp_spi, ST7789V_init);
 }
 else if (tft_disp_type == 3) {
  commandList(disp_spi, STP7735_init);
 }
 else if (tft_disp_type == 4) {
  commandList(disp_spi, STP7735R_init);
  commandList(disp_spi, Rcmd2green);
  commandList(disp_spi, Rcmd3);
 }
 else if (tft_disp_type == 5) {
  commandList(disp_spi, STP7735R_init);
  commandList(disp_spi, Rcmd2red);
  commandList(disp_spi, Rcmd3);
     uint8_t dt = 0xC0;
  disp_spi_transfer_cmd_data(0x36, &dt, 1);
 }
 else ((0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c", 933, __func__, "0"));

    ret = disp_deselect();
 ((ret==0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/tft/tftspi.c", 936, __func__, "ret==ESP_OK"));
