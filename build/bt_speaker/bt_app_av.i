# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt_speaker//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
# 10 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 12 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_core.h" 1
# 14 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_core.h"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_core.h" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/api/include/api/esp_a2dp_api.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/api/include/api/esp_a2dp_api.h" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 2
...
# 45 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 3 4
                                                                                         ((void *)0)
# 45 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
                                                                                             );
        break;
    }
    default:
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid A2DP event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid A2DP event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "Invalid A2DP event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "Invalid A2DP event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid A2DP event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } } while(0); } while(0);
        break;
    }
}
...
void bt_app_a2d_data_cb(const uint8_t *data, uint32_t len)
{
    ...
    i2s_write(0, data, len, &bytes_written, ( TickType_t ) 0xffffffffUL);
...
# 83 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 3 4
                                                                                              ((void *)0)
# 83 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
                                                                                                  );
        break;
    }
    default:
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid AVRC event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid AVRC event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "Invalid AVRC event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "Invalid AVRC event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid AVRC event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", event); } } while(0); } while(0);
        break;
    }
}
...
# 95 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c" 3 4
                             ((void *)0)
# 95 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/bt_speaker/bt_app_av.c"
                                 ;
    switch (event) {
    case ESP_A2D_CONNECTION_STATE_EVT: {
        a2d = (esp_a2d_cb_param_t *)(p_param);
        uint8_t *bda = a2d->conn_stat.remote_bda;
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "A2DP connection state: %s, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_conn_state_str[a2d->conn_stat.state], bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "A2DP connection state: %s, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_conn_state_str[a2d->conn_stat.state], bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "A2DP connection state: %s, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_conn_state_str[a2d->conn_stat.state], bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "A2DP connection state: %s, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_conn_state_str[a2d->conn_stat.state], bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "A2DP connection state: %s, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_conn_state_str[a2d->conn_stat.state], bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } } while(0); } while(0)
                                                                                                        ;
    ...
    case ESP_A2D_AUDIO_STATE_EVT: {
        a2d = (esp_a2d_cb_param_t *)(p_param);
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "A2DP audio state: %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_audio_state_str[a2d->audio_stat.state]); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "A2DP audio state: %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_audio_state_str[a2d->audio_stat.state]); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "A2DP audio state: %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_audio_state_str[a2d->audio_stat.state]); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "A2DP audio state: %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_audio_state_str[a2d->audio_stat.state]); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "A2DP audio state: %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", m_a2d_audio_state_str[a2d->audio_stat.state]); } } while(0); } while(0);
    ...
    case ESP_A2D_AUDIO_CFG_EVT: {
        a2d = (esp_a2d_cb_param_t *)(p_param);
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "A2DP audio stream configuration, codec type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.type); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "A2DP audio stream configuration, codec type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.type); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "A2DP audio stream configuration, codec type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.type); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "A2DP audio stream configuration, codec type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.type); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "A2DP audio stream configuration, codec type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.type); } } while(0); } while(0);

        if (a2d->audio_cfg.mcc.type == (0)) {
            ...
            do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "Configure audio player %x-%x-%x-%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.cie.sbc[0], a2d->audio_cfg.mcc.cie.sbc[1], a2d->audio_cfg.mcc.cie.sbc[2], a2d->audio_cfg.mcc.cie.sbc[3]); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "Configure audio player %x-%x-%x-%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.cie.sbc[0], a2d->audio_cfg.mcc.cie.sbc[1], a2d->audio_cfg.mcc.cie.sbc[2], a2d->audio_cfg.mcc.cie.sbc[3]); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "Configure audio player %x-%x-%x-%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.cie.sbc[0], a2d->audio_cfg.mcc.cie.sbc[1], a2d->audio_cfg.mcc.cie.sbc[2], a2d->audio_cfg.mcc.cie.sbc[3]); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "Configure audio player %x-%x-%x-%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.cie.sbc[0], a2d->audio_cfg.mcc.cie.sbc[1], a2d->audio_cfg.mcc.cie.sbc[2], a2d->audio_cfg.mcc.cie.sbc[3]); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "Configure audio player %x-%x-%x-%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", a2d->audio_cfg.mcc.cie.sbc[0], a2d->audio_cfg.mcc.cie.sbc[1], a2d->audio_cfg.mcc.cie.sbc[2], a2d->audio_cfg.mcc.cie.sbc[3]); } } while(0); } while(0)



                                                   ;
            do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "Audio player configured, sample rate=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", sample_rate); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "Audio player configured, sample rate=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", sample_rate); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "Audio player configured, sample rate=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", sample_rate); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "Audio player configured, sample rate=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", sample_rate); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "Audio player configured, sample rate=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", sample_rate); } } while(0); } while(0);
        }
        break;
    }
    default:
...
static void bt_av_hdl_avrc_evt(uint16_t event, void *p_param)
{
    ...
    case ESP_AVRC_CT_CONNECTION_STATE_EVT: {
        ...
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC conn_state evt: state %d, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->conn_stat.connected, bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "AVRC conn_state evt: state %d, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->conn_stat.connected, bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "AVRC conn_state evt: state %d, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->conn_stat.connected, bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "AVRC conn_state evt: state %d, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->conn_stat.connected, bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC conn_state evt: state %d, [%02x:%02x:%02x:%02x:%02x:%02x]" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->conn_stat.connected, bda[0], bda[1], bda[2], bda[3], bda[4], bda[5]); } } while(0); } while(0)
                                                                                         ;
    ...
    case ESP_AVRC_CT_PASSTHROUGH_RSP_EVT: {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC passthrough rsp: key_code 0x%x, key_state %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->psth_rsp.key_code, rc->psth_rsp.key_state); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "AVRC passthrough rsp: key_code 0x%x, key_state %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->psth_rsp.key_code, rc->psth_rsp.key_state); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "AVRC passthrough rsp: key_code 0x%x, key_state %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->psth_rsp.key_code, rc->psth_rsp.key_state); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "AVRC passthrough rsp: key_code 0x%x, key_state %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->psth_rsp.key_code, rc->psth_rsp.key_state); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC passthrough rsp: key_code 0x%x, key_state %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->psth_rsp.key_code, rc->psth_rsp.key_state); } } while(0); } while(0);
        break;
    }
    case ESP_AVRC_CT_METADATA_RSP_EVT: {
        ...
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC metadata rsp: attribute id 0x%x, %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->meta_rsp.attr_id, rc->meta_rsp.attr_text); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "AVRC metadata rsp: attribute id 0x%x, %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->meta_rsp.attr_id, rc->meta_rsp.attr_text); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "AVRC metadata rsp: attribute id 0x%x, %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->meta_rsp.attr_id, rc->meta_rsp.attr_text); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "AVRC metadata rsp: attribute id 0x%x, %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->meta_rsp.attr_id, rc->meta_rsp.attr_text); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC metadata rsp: attribute id 0x%x, %s" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->meta_rsp.attr_id, rc->meta_rsp.attr_text); } } while(0); } while(0);
        free(rc->meta_rsp.attr_text);
        break;
    }
    case ESP_AVRC_CT_CHANGE_NOTIFY_EVT: {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC event notification: %d, param: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->change_ntf.event_id, rc->change_ntf.event_parameter); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "AVRC event notification: %d, param: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->change_ntf.event_id, rc->change_ntf.event_parameter); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "AVRC event notification: %d, param: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->change_ntf.event_id, rc->change_ntf.event_parameter); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "AVRC event notification: %d, param: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->change_ntf.event_id, rc->change_ntf.event_parameter); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC event notification: %d, param: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->change_ntf.event_id, rc->change_ntf.event_parameter); } } while(0); } while(0);
        bt_av_notify_evt_handler(rc->change_ntf.event_id, rc->change_ntf.event_parameter);
        break;
    }
    case ESP_AVRC_CT_REMOTE_FEATURES_EVT: {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC remote features %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->rmt_feats.feat_mask); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "AVRC remote features %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->rmt_feats.feat_mask); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "AVRC remote features %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->rmt_feats.feat_mask); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "AVRC remote features %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->rmt_feats.feat_mask); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC remote features %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", rc->rmt_feats.feat_mask); } } while(0); } while(0);
        break;
    }
    default:
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "BT_AV", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unhandled evt %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", __func__, event); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "BT_AV", "\033[0;" "33" "m" "W" " (%d) %s: " "%s unhandled evt %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", __func__, event); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "BT_AV", "D" " (%d) %s: " "%s unhandled evt %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", __func__, event); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "BT_AV", "V" " (%d) %s: " "%s unhandled evt %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", __func__, event); } else { esp_log_write(ESP_LOG_INFO, "BT_AV", "\033[0;" "32" "m" "I" " (%d) %s: " "%s unhandled evt %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AV", __func__, event); } } while(0); } while(0);
