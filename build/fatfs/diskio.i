# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2
...
int setitimer (int __which, const struct itimerval *restrict __value, struct itimerval *restrict __ovalue)
                                            ;
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 2

static ff_diskio_impl_t * s_impls[2] = { 
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 3 4
                                                 ((void *)0) 
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
                                                      };
...
void ff_diskio_register(BYTE pdrv, const ff_diskio_impl_t* discio_impl)
{
    ((pdrv < 2) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c", 41, __func__, "pdrv < FF_VOLUMES"));

    if (s_impls[pdrv]) {
        ff_diskio_impl_t* im = s_impls[pdrv];
        s_impls[pdrv] = 
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 3 4
                       ((void *)0)
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
                           ;
        free(im);
    }
    ...
    ((impl != 
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 3 4
   ((void *)0)
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c", 54, __func__, "impl != NULL"));
...
{
    time_t t = time(
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c" 3 4
                   ((void *)0)
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.c"
                       );
    struct tm tmr;
    localtime_r(&t, &tmr);
