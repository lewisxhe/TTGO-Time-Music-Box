# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c" 2

static sdmmc_card_t* s_cards[2] = { 
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c" 3 4
                                            ((void *)0) 
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c"
                                                 };
...
DRESULT ff_sdmmc_read (BYTE pdrv, BYTE* buff, DWORD sector, UINT count)
{
    ...
    ((card) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c", 38, __func__, "card"));
    esp_err_t err = sdmmc_read_sectors(card, buff, sector, count);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    sdmmc_card_t* card = s_cards[pdrv];
    ((card) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c", 50, __func__, "card"));
    esp_err_t err = sdmmc_write_sectors(card, buff, sector, count);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    sdmmc_card_t* card = s_cards[pdrv];
    ((card) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_sdmmc.c", 62, __func__, "card"));
    switch(cmd) {
        case 0:
            return RES_OK;
        case 1:
