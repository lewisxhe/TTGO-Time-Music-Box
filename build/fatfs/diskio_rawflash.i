# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.h"
...
esp_err_t esp_partition_mmap(const esp_partition_t* partition, uint32_t offset, uint32_t size,
                             ...
                             const void** out_ptr, spi_flash_mmap_handle_t* out_handle);
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c" 2

static const char* TAG = "diskio_rawflash";

const esp_partition_t* ff_raw_handles[2];
...
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_raw_read - pdrv=%i, sector=%i, count=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_raw_read - pdrv=%i, sector=%i, count=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_raw_read - pdrv=%i, sector=%i, count=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_raw_read - pdrv=%i, sector=%i, count=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_raw_read - pdrv=%i, sector=%i, count=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } } while(0); } while(0);
    const esp_partition_t* part = ff_raw_handles[pdrv];
    ((part) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c", 41, __func__, "part"));
    esp_err_t err = esp_partition_read(part, sector * 4096, buff, count * 4096);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_partition_read failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_partition_read failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_partition_read failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_partition_read failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_partition_read failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    const esp_partition_t* part = ff_raw_handles[pdrv];
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_raw_ioctl: cmd=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_raw_ioctl: cmd=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_raw_ioctl: cmd=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_raw_ioctl: cmd=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_raw_ioctl: cmd=%in" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
    ((part) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.c", 60, __func__, "part"));
    switch (cmd) {
        case 0:
            return RES_OK;
        case 1:
            *((DWORD *) buff) = part->size / 4096;
            return RES_OK;
        case 2:
            *((WORD *) buff) = 4096;
            return RES_OK;
