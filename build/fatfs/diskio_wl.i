# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2
...
# 302 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/ffconf.h"
...
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/ffconf.h" 2
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/ff.h" 1
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/ff.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/ffconf.h" 1
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.h"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c" 2


static const char* TAG = "ff_diskio_spiflash";

wl_handle_t ff_wl_handles[2] = {
        -1,
        -1,
};
...
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } } while(0); } while(0);
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    ((wl_handle + 1) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c", 44, __func__, "wl_handle + 1"));
    esp_err_t err = wl_read(wl_handle, sector * wl_sector_size(wl_handle), buff, count * wl_sector_size(wl_handle));
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); } } while(0); } while(0);
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    ((wl_handle + 1) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c", 57, __func__, "wl_handle + 1"));
    esp_err_t err = wl_erase_range(wl_handle, sector * wl_sector_size(wl_handle), count * wl_sector_size(wl_handle));
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    err = wl_write(wl_handle, sector * wl_sector_size(wl_handle), buff, count * wl_sector_size(wl_handle));
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
    ((wl_handle + 1) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.c", 75, __func__, "wl_handle + 1"));
    switch (cmd) {
    case 0:
        return RES_OK;
    case 1:
