# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h" 1
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.h" 1
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_rawflash.h"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2


# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.h" 1
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio_wl.h"
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 2
    ...
    wl_handle_t* wl_handle)
{
    ...
    void *workbuf = 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                   ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                       ;
    ...
    if (data_partition == 
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } } while(0); } while(0);
        return 0x105;
    }

    result = wl_mount(data_partition, wl_handle);
    if (result != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to mount wear levelling layer. result = %i" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to mount wear levelling layer. result = %i" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to mount wear levelling layer. result = %i" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to mount wear levelling layer. result = %i" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to mount wear levelling layer. result = %i" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } } while(0); } while(0);
        return result;
    }
    ...
    if (result != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_diskio_register_wl_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_diskio_register_wl_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_diskio_register_wl_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_diskio_register_wl_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_diskio_register_wl_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } } while(0); } while(0);
        goto fail;
    }
    FATFS *fs;
    ...
    if (result == 0x103) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } } while(0); } while(0);
        goto fail;
    }
    ...
    if (fresult != FR_OK) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_mount failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_mount failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_mount failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_mount failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_mount failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } } while(0); } while(0);
        ...
        if (workbuf == 
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                      ((void *)0)
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                          ) {
            result = 0x101;
            goto fail;
        }
        ...
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Formatting FATFS partition, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Formatting FATFS partition, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Formatting FATFS partition, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Formatting FATFS partition, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Formatting FATFS partition, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } } while(0); } while(0);
        fresult = f_mkfs(drv, 0x07 | 0x08, alloc_unit_size, workbuf, workbuf_size);
        if (fresult != FR_OK) {
            result = -1;
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } } while(0); } while(0);
            goto fail;
        }
        free(workbuf);
        workbuf = 
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                 ((void *)0)
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                     ;
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        fresult = f_mount(fs, drv, 0);
        if (fresult != FR_OK) {
            result = -1;
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, fresult); } } while(0); } while(0);
            goto fail;
        }
    }
    return 0;
...
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
   );
    return result;
}
...
esp_err_t esp_vfs_fat_spiflash_unmount(const char *base_path, wl_handle_t wl_handle)
{
    ...
    f_mount(0, drv, 0);
    ff_diskio_register(pdrv, 
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
   );

    esp_err_t err_drv = wl_unmount(wl_handle);
    esp_err_t err = esp_vfs_fat_unregister_path(base_path);
    if (err == 0) err = err_drv;
    return err;
}
    ...
    const esp_vfs_fat_mount_config_t* mount_config)
{
    ...
    if (data_partition == 
# 142 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 142 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } } while(0); } while(0);
        return 0x105;
    }
    ...
    if (result != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ff_diskio_register_raw_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ff_diskio_register_raw_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ff_diskio_register_raw_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_diskio_register_raw_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ff_diskio_register_raw_partition failed pdrv=%i, error - 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv, result); } } while(0); } while(0);
        goto fail;
    }
...
fail:
    esp_vfs_fat_unregister_path(base_path);
    ff_diskio_register(pdrv, 
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
   );
    return result;
}
...
esp_err_t esp_vfs_fat_rawflash_unmount(const char *base_path, const char* partition_label)
{
    ...
    if (data_partition == 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } } while(0); } while(0);
        return 0x105;
    }
    ...
    f_mount(0, drv, 0);
    ff_diskio_register(pdrv, 
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_spiflash.c"
   );
    esp_err_t err = esp_vfs_fat_unregister_path(base_path);
    return err;
}
