# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/sys/unistd.h"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/vfs/include/esp_vfs.h" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/vfs/include/esp_vfs.h" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/vfs/include/esp_vfs.h" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/vfs/include/esp_vfs.h" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_internal.h" 1
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_internal.h"
       



# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_internal.h" 2
        ...
        size_t sector_size, size_t requested_size)
{
    ...
    alloc_unit_size = ((alloc_unit_size) > (sector_size) ? (alloc_unit_size) : (sector_size));
    alloc_unit_size = ((alloc_unit_size) < (max_size) ? (alloc_unit_size) : (max_size));
    return alloc_unit_size;
}
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
...
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
void ff_diskio_register(BYTE pdrv, const ff_diskio_impl_t* discio_impl);
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
void ff_diskio_register_sdmmc(BYTE pdrv, sdmmc_card_t* card);
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/diskio.h"
esp_err_t ff_diskio_get_drive(BYTE* out_pdrv);
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 2

static const char* TAG = "vfs_fat_sdmmc";
static sdmmc_card_t* s_card = 
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                             ((void *)0)
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                                 ;
static uint8_t s_pdrv = 0;
static char * s_base_path = 
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                           ((void *)0)
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                               ;
    ...
    sdmmc_card_t** out_card)
{
    ...
    void* workbuf = 
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                   ((void *)0)
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                       ;
    FATFS* fs = 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
               ((void *)0)
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                   ;

    if (s_card != 
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                 ((void *)0)
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                     ) {
        return 0x103;
    }
    ...
    if (ff_diskio_get_drive(&pdrv) != 0 || pdrv == 0xFF) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "the maximum count of volumes is already mounted" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "the maximum count of volumes is already mounted" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "the maximum count of volumes is already mounted" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "the maximum count of volumes is already mounted" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "the maximum count of volumes is already mounted" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }

    s_base_path = strdup(base_path);
    if(!s_base_path){
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "could not copy base_path" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "could not copy base_path" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "could not copy base_path" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "could not copy base_path" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "could not copy base_path" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }
    esp_err_t err = 0;
    s_card = malloc(sizeof(sdmmc_card_t));
    if (s_card == 
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                 ((void *)0)
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                     ) {
        err = 0x101;
        goto fail;
    }
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "host init returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "host init returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "host init returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "host init returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "host init returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        goto fail;
    }
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "slot_config returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "slot_config returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "slot_config returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "slot_config returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "slot_config returned rc=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        goto fail;
    }
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_card_init failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_card_init failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_card_init failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_card_init failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_card_init failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        goto fail;
    }
    if (out_card != 
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                   ((void *)0)
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                       ) {
        *out_card = s_card;
    }
    ...
    s_pdrv = pdrv;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "using pdrv=%i" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "using pdrv=%i" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "using pdrv=%i" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "using pdrv=%i" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "using pdrv=%i" "\033[0m" "\n", esp_log_timestamp(), TAG, pdrv); } } while(0); } while(0);
    ...
    if (err == 0x103) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_vfs_fat_register failed 0x(%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        goto fail;
    }
    ...
    if (res != FR_OK) {
        err = -1;
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to mount card (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to mount card (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to mount card (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to mount card (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to mount card (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } } while(0); } while(0);
        if (!(res == FR_NO_FILESYSTEM && mount_config->format_if_mount_failed)) {
            goto fail;
        }
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "partitioning card" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "partitioning card" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "partitioning card" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "partitioning card" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "partitioning card" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        workbuf = malloc(workbuf_size);
        if (workbuf == 
# 117 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                      ((void *)0)
# 117 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                          ) {
            err = 0x101;
            goto fail;
        }
        ...
        if (res != FR_OK) {
            err = -1;
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_fdisk failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_fdisk failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_fdisk failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_fdisk failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_fdisk failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } } while(0); } while(0);
            goto fail;
        }
        size_t alloc_unit_size = esp_vfs_fat_get_allocation_unit_size(
                s_card->csd.sector_size,
                mount_config->allocation_unit_size);
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "formatting card, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "formatting card, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "formatting card, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "formatting card, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "formatting card, allocation unit size=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, alloc_unit_size); } } while(0); } while(0);
        res = f_mkfs(drv, 0x07, alloc_unit_size, workbuf, workbuf_size);
        if (res != FR_OK) {
            err = -1;
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_mkfs failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } } while(0); } while(0);
            goto fail;
        }
        free(workbuf);
        workbuf = 
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                 ((void *)0)
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                     ;
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "mounting again" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        res = f_mount(fs, drv, 0);
        if (res != FR_OK) {
            err = -1;
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "f_mount failed after formatting (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, res); } } while(0); } while(0);
            goto fail;
        }
    }
    return 0;
...
fail:
    ...
    if (fs) {
        f_mount(
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
               ((void *)0)
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                   , drv, 0);
    }
    esp_vfs_fat_unregister_path(base_path);
    ff_diskio_register(pdrv, 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
   ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
   );
    free(s_card);
    s_card = 
# 159 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
            ((void *)0)
# 159 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                ;
    return err;
}
...
{
    if (s_card == 
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                 ((void *)0)
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                     ) {
        return 0x103;
    }
...
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
   ((void *)0)
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
   );
    free(s_card);
    s_card = 
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
            ((void *)0)
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                ;
    (*host_deinit)();
    esp_err_t err = esp_vfs_fat_unregister_path(s_base_path);
    free(s_base_path);
    s_base_path = 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c" 3 4
                 ((void *)0)
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/fatfs/src/vfs_fat_sdmmc.c"
                     ;
    return err;
}
