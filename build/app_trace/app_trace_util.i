# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\app_trace//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 2
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
esp_err_t esp_apptrace_tmo_check(esp_apptrace_tmo_t *tmo)
{
    int cpu_freq = esp_clk_cpu_freq();
    if (tmo->tmo != ((uint32_t)-1)) {
        unsigned cur = xthal_get_ccount();
        if (tmo->start <= cur) {
            tmo->elapsed = ((cur - tmo->start)/(cpu_freq/1000000));
        } else {
            tmo->elapsed = ((0xFFFFFFFF - tmo->start + cur)/(cpu_freq/1000000));
        }
...
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
       _Bool 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
            success = vPortCPUAcquireMutexTimeout(&lock->mux, 0);

        if (success) {
            lock->int_state = int_state;
            return 0;
        }
        do { ; _xtos_set_intlevel(int_state); } while (0);
...
uint8_t *esp_apptrace_rb_produce(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->wr + size >= rb->size) {
            if (rb->rd == 0) {
                return 
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
                      ((void *)0)
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
                          ;
            }
            if (rb->wr + size == rb->size) {
                rb->wr = 0;
                ...
                if (size > rb->rd - 1) {
                    return 
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
                          ((void *)0)
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
                              ;
                }
        ...
        if (size > rb->rd - rb->wr - 1) {
            return 
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
                      ;
        }
        rb->wr += size;
    }
...
uint8_t *esp_apptrace_rb_consume(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->rd + size > rb->wr) {
            return 
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
                      ;
        }
        rb->rd += size;
    } else {
        ...
        if (rb->rd + size > rb->cur_size) {
            return 
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/app_trace/app_trace_util.c"
                      ;
