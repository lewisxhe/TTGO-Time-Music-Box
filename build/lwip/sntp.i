# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
...
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2


# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/timers.h" 1
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/timers.h"
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/timers.h" 2
...
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2
...
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                 dns_found_callback found, void *callback_arg,
                                 u8_t dns_addrtype);
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2
...
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2
...
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 2
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
...
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
static u32_t sntp_retry_timeout;
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
static void
sntp_process(u32_t *receive_timestamp)
{
  ...
  u32_t t = is_1900_based ? (rx_secs - (2208988800UL)) : (rx_secs + (2085978496UL));
  time_t tim = t;


  u32_t us = lwip_ntohl(receive_timestamp[1]) / 4295;
  do { struct timeval tv = { .tv_sec = t, .tv_usec = us }; settimeofday(&tv, 
# 217 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
 ((void *)0)
# 217 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
 ); } while (0);;

  do { if ( (((0x00U | 0x40U)) & 0x80U) && (((0x00U | 0x40U)) & 0x80U) && ((s16_t)(((0x00U | 0x40U)) & 0x03) >= 0x00)) { do {printf ("sntp_process: %s, %""d"" us", ctime(&tim), us);} while(0); if (((0x00U | 0x40U)) & 0x08U) { while(1); } } } while(0);
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
  (void)tim;
}
...
{
  memset(req, 0, 48);
  req->li_vn_mode = 0x00 | (4 <<3) | 0x03;
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
}
...
sntp_retry(void* arg)
{
  ...
  do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_retry: Next request will be sent in %""d"" ms\n", sntp_retry_timeout);} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0)
                        ;


  sys_timeout(sntp_retry_timeout, sntp_request, 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                               ((void *)0)
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                                   );
...
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
static void
...
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                     ((void *)0)
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                         );
  sys_untimeout(sntp_request, 
# 343 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                             ((void *)0)
# 343 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                 );
    ...
    if (p->tot_len == 48) {
      ...
      if (((sntp_opmode == 0) && (mode == 0x04)) ||
        ...
        if (stratum == 0x00) {
          ...
          err = 1;
          do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_recv: Received Kiss-of-Death\n");} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
        } else {
# 379 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
          {

            err = 0;
            pbuf_copy_partial(p, &receive_timestamp, 2 * 4, 40);
          }
        }
      } else {
        do { if ( (((0x00U | 0x01)) & 0x80U) && (((0x00U | 0x01)) & 0x80U) && ((s16_t)(((0x00U | 0x01)) & 0x03) >= 0x00)) { do {printf ("sntp_recv: Invalid mode in response: %""d""\n", (u16_t)mode);} while(0); if (((0x00U | 0x01)) & 0x08U) { while(1); } } } while(0);

        err = -3;
      }
    } else {
      do { if ( (((0x00U | 0x01)) & 0x80U) && (((0x00U | 0x01)) & 0x80U) && ((s16_t)(((0x00U | 0x01)) & 0x03) >= 0x00)) { do {printf ("sntp_recv: Invalid packet length: %""d""\n", p->tot_len);} while(0); if (((0x00U | 0x01)) & 0x08U) { while(1); } } } while(0);
    }
  }
  ...
  if (err == 0) {
    ...
    if (sntp_opmode == 0) {
      ...
      sntp_retry_timeout = 3000;

      sys_timeout((u32_t)3600000, sntp_request, 
# 409 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                                         ((void *)0)
# 409 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                                             );
      do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_recv: Scheduled next time request: %""d"" ms\n", (u32_t)3600000);} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0)
                                  ;
    }
  } else if (err != -3) {
    ...
    if (sntp_opmode == 0) {
      if (err == 1) {
        ...
        sntp_retry(
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                            ((void *)0)
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                );
      } else {

        sntp_retry(
# 421 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                  ((void *)0)
# 421 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                      );
      }
    }
  }
...
sntp_send_request(const ip_addr_t *server_addr)
{
  ...
  if (p != 
# 436 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
          ((void *)0)
# 436 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
              ) {
    struct sntp_msg *sntpmsg = (struct sntp_msg *)p->payload;
    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_send_request: Sending request to server\n");} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);

    sntp_initialize_request(sntpmsg);

    udp_sendto(sntp_pcb, p, server_addr, 123);

    pbuf_free(p);

    sys_timeout((u32_t)3000, sntp_retry, 
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                                               ((void *)0)
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                                                   );
    ...
    do { if ( (((0x00U | 0x02)) & 0x80U) && (((0x00U | 0x02)) & 0x80U) && ((s16_t)(((0x00U | 0x02)) & 0x03) >= 0x00)) { do {printf ("sntp_send_request: Out of memory, trying again in %""d"" ms\n", (u32_t)3000);} while(0); if (((0x00U | 0x02)) & 0x08U) { while(1); } } } while(0)
                                 ;

    sys_timeout((u32_t)3000, sntp_request, 
# 455 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                                        ((void *)0)
# 455 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                                            );
  }
}
...
sntp_dns_found(const char* hostname, const ip_addr_t *ipaddr, void *arg)
{
  ...
  if (ipaddr != 
# 469 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
               ((void *)0)
# 469 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                   ) {

    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_dns_found: Server address resolved, sending request\n");} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sntp_send_request(ipaddr);
  } else {

    do { if ( (((0x00U | 0x01 | 0x20U)) & 0x80U) && (((0x00U | 0x01 | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x01 | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_dns_found: Failed to resolve server address resolved, trying next server\n");} while(0); if (((0x00U | 0x01 | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sntp_retry(
# 476 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                        ((void *)0)
# 476 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                            );
  }
}
...
sntp_request(void *arg)
{
  ...
  if (sntp_servers[0].name) {
    ...
    do{ do{((&((&sntp_servers[0].addr)->u_addr.ip6)))->addr[0] = 0; ((&((&sntp_servers[0].addr)->u_addr.ip6)))->addr[1] = 0; ((&((&sntp_servers[0].addr)->u_addr.ip6)))->addr[2] = 0; ((&((&sntp_servers[0].addr)->u_addr.ip6)))->addr[3] = 0;}while(0); do { if((&sntp_servers[0].addr) != 
# 498 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
   ((void *)0)
# 498 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
   ) { do { (*(&sntp_servers[0].addr)).type = (0); }while(0); }}while(0); }while(0);
    err = dns_gethostbyname(sntp_servers[0].name, &sntp_server_address,
      sntp_dns_found, 
# 500 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                     ((void *)0)
# 500 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                         );
    if (err == -5) {

      do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_request: Waiting for server address to be resolved.\n");} while(0); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
      return;
    } else if (err == 0) {
...

  {
    ...
    err = ((((((&sntp_server_address)->type) == 6U)) ? (((*(&((&(sntp_server_address))->u_addr.ip6))).addr[0] == 0) && ((*(&((&(sntp_server_address))->u_addr.ip6))).addr[1] == 0) && ((*(&((&(sntp_server_address))->u_addr.ip6))).addr[2] == 0) && ((*(&((&(sntp_server_address))->u_addr.ip6))).addr[3] == 0)) : ((*(&((&(sntp_server_address))->u_addr.ip4))).addr == ((u32_t)0x00000000UL)))) ? -15 : 0;
  }

  if (err == 0) {
    do { if ( (((0x00U | 0x40U)) & 0x80U) && (((0x00U | 0x40U)) & 0x80U) && ((s16_t)(((0x00U | 0x40U)) & 0x03) >= 0x00)) { do {printf ("sntp_request: current server address is %s\n", (((&sntp_server_address) == 
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
   ((void *)0)
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
   ) ? "NULL" : (((((&sntp_server_address) != 
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
   ((void *)0)
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
   ) && (((&*(&sntp_server_address))->type) == 6U))) ? ip6addr_ntoa((&((&sntp_server_address)->u_addr.ip6))) : ip4addr_ntoa((&((&sntp_server_address)->u_addr.ip4))))));} while(0); if (((0x00U | 0x40U)) & 0x08U) { while(1); } } } while(0)
                                         ;
    sntp_send_request(&sntp_server_address);
  } else {

    do { if ( (((0x00U | 0x01 | 0x20U)) & 0x80U) && (((0x00U | 0x01 | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x01 | 0x20U)) & 0x03) >= 0x00)) { do {printf ("sntp_request: Invalid server address, trying next server.\n");} while(0); if (((0x00U | 0x01 | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sys_timeout((u32_t)3000, sntp_retry, 
# 522 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                                                ((void *)0)
# 522 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                                                    );
  }
}
...
sntp_init(void)
{
# 541 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
  if (sntp_pcb == 
# 541 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                 ((void *)0)
# 541 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                     ) {
    sntp_pcb = udp_new_ip_type(46U);
    do { if(!(sntp_pcb != 
# 543 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
   ((void *)0)
# 543 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
   )) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c", 543, __func__, "Failed to allocate udp pcb for sntp client"); } while(0);
    if (sntp_pcb != 
# 544 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                   ((void *)0)
# 544 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                       ) {
      udp_recv(sntp_pcb, sntp_recv, 
# 545 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                                   ((void *)0)
# 545 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                       );
      ...
      if (sntp_opmode == 0) {
        ...
        sntp_request(
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                    ((void *)0)
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                        );

      } else if (sntp_opmode == 1) {
        ((sntp_pcb)->so_options |= (0x20U));
        udp_bind(sntp_pcb, (&ip_addr_any_type), 123);
      }
    }
  }
}
...
{
  if (sntp_pcb != 
# 568 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                 ((void *)0)
# 568 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                     ) {
    sys_untimeout(sntp_request, 
# 569 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                               ((void *)0)
# 569 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                   );
    udp_remove(sntp_pcb);
    sntp_pcb = 
# 571 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
              ((void *)0)
# 571 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                  ;
  }
}
...
{
  return (sntp_pcb != 
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                     ((void *)0)
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                         )? 1 : 0;
}
...
{
  do { if(!(operating_mode <= 1)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c", 590, __func__, "Invalid operating mode"); } while(0);
  do { if(!(sntp_pcb == 
# 591 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
 ((void *)0)
# 591 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
 )) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c", 591, __func__, "Operating mode must not be set while SNTP client is running"); } while(0);
...
# 625 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
void
sntp_setserver(u8_t idx, const ip_addr_t *server)
{
  if (idx < 1) {
    if (server != 
# 629 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                 ((void *)0)
# 629 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                     ) {
      sntp_servers[idx].addr = (*server);
    } else {
      do{ do{((&((&sntp_servers[idx].addr)->u_addr.ip6)))->addr[0] = 0; ((&((&sntp_servers[idx].addr)->u_addr.ip6)))->addr[1] = 0; ((&((&sntp_servers[idx].addr)->u_addr.ip6)))->addr[2] = 0; ((&((&sntp_servers[idx].addr)->u_addr.ip6)))->addr[3] = 0;}while(0); do { if((&sntp_servers[idx].addr) != 
# 632 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
     ((void *)0)
# 632 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
     ) { do { (*(&sntp_servers[idx].addr)).type = (0); }while(0); }}while(0); }while(0);
    }

    sntp_servers[idx].name = 
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
                            ((void *)0)
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
                                ;

  }
}
# 674 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
ip_addr_t
...
# 690 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
void
...
# 705 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
char *
sntp_getservername(u8_t idx)
{
  ...
  return 
# 711 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c" 3 4
        ((void *)0)
# 711 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/sntp/sntp.c"
            ;
}
