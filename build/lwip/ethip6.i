# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/ethip6.h" 1
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/ethip6.h"
...
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/ethip6.h" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
...
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
...
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
...
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
...
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c" 2
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
static err_t
...
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
  ,
                                      74
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
  , __func__, "netif->hwaddr_len must be 6 for ethip6!"); } while(0)
                                       ;
  memcpy(&ethhdr->dest,dst,6);
  memcpy(&ethhdr->src,src,6);
  ethhdr->type = ((((0x86DDU) & 0xff) << 8) | (((0x86DDU) & 0xff00) >> 8));
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {printf ("ethip6_send: sending packet %p\n", (void *)p);} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

  return netif->linkoutput(netif, p);
}
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ethip6.c"
err_t
ethip6_output(struct netif *netif, struct pbuf *q, const ip6_addr_t *ip6addr)
{
  ...
  if ((((ip6addr)->addr[0] & ((((0xff000000UL) & 0xff) << 24) | (((0xff000000UL) & 0xff00) << 8) | (((0xff000000UL) & 0xff0000UL) >> 8) | (((0xff000000UL) & 0xff000000UL) >> 24))) == ((((0xff000000UL) & 0xff) << 24) | (((0xff000000UL) & 0xff00) << 8) | (((0xff000000UL) & 0xff0000UL) >> 8) | (((0xff000000UL) & 0xff000000UL) >> 24)))) {
  ...
  if ((neighbor_cache[i].state == ND6_REACHABLE) ||
    ...
    memcpy(dest.addr,neighbor_cache[i].lladdr,6);
    return ethip6_send(netif, q, (struct eth_addr*)(netif->hwaddr), &dest);
  }


  pbuf_header(q, -(s16_t)(14 + 0));
