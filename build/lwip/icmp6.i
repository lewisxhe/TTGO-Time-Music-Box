# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp6.h" 1
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp6.h"
...
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp6.h" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp6.h" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp6.h" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
...
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 2
# 67 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
static void icmp6_send_response(struct pbuf *p, u8_t code, u32_t data, u8_t type);
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
void
icmp6_input(struct pbuf *p, struct netif *inp)
{
  ...
  {
    if (ip6_chksum_pseudo(p, 58, p->tot_len, ((&((&ip_data.current_iphdr_src)->u_addr.ip6))),
                          ((&((&ip_data.current_iphdr_dest)->u_addr.ip6)))) != 0) {
  ...
  case ICMP6_TYPE_EREQ:
    ...
    if (r == 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 3 4
            ((void *)0)
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
                ) {
...
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
    {
...

    {
      ((struct icmp6_echo_hdr *)(r->payload))->chksum = ip6_chksum_pseudo(r,
          58, r->tot_len, reply_src, ((&((&ip_data.current_iphdr_src)->u_addr.ip6))));
    }



    ;
    ip6_output_if(r, reply_src, ((&((&ip_data.current_iphdr_src)->u_addr.ip6))),
        255, 0, 58, inp);
    pbuf_free(r);
...
# 215 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
void
icmp6_dest_unreach(struct pbuf *p, enum icmp6_dur_code c)
{
  icmp6_send_response(p, c, 0, ICMP6_TYPE_DUR);
}
# 228 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
void
icmp6_packet_too_big(struct pbuf *p, u32_t mtu)
{
  icmp6_send_response(p, 0, mtu, ICMP6_TYPE_PTB);
}
# 241 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
void
icmp6_time_exceeded(struct pbuf *p, enum icmp6_te_code c)
{
  icmp6_send_response(p, c, 0, ICMP6_TYPE_TE);
}
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
void
icmp6_param_problem(struct pbuf *p, enum icmp6_pp_code c, u32_t pointer)
{
  icmp6_send_response(p, c, pointer, ICMP6_TYPE_PP);
}
# 270 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
static void
icmp6_send_response(struct pbuf *p, u8_t code, u32_t data, u8_t type)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp6_hdr) + 40 + 8,
                 PBUF_RAM);
  if (q == 
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 3 4
          ((void *)0)
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_time_exceeded: failed to allocate pbuf for ICMPv6 packet.\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    return;
  }
  do { if(!((q->len >= (sizeof(struct icmp6_hdr) + 40 + 8)))) __assert_func(
                                                                                    "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
  ,
                                                                                    290
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
  , __func__, "check that first pbuf can hold icmp 6message"); } while(0)
                                                                                     ;
  ...
  memcpy((u8_t *)q->payload + sizeof(struct icmp6_hdr),(u8_t *)p->payload,40 + 8)
                                         ;


  if (((ip_data.current_netif) == 
# 302 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 3 4
                            ((void *)0)
# 302 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
                                ) ||
    ...
    do{(reply_dest_local).addr[0] = (ip6hdr->src).addr[0]; (reply_dest_local).addr[1] = (ip6hdr->src).addr[1]; (reply_dest_local).addr[2] = (ip6hdr->src).addr[2]; (reply_dest_local).addr[3] = (ip6hdr->src).addr[3];}while(0);
    do{(reply_src_local).addr[0] = (ip6hdr->dest).addr[0]; (reply_src_local).addr[1] = (ip6hdr->dest).addr[1]; (reply_src_local).addr[2] = (ip6hdr->dest).addr[2]; (reply_src_local).addr[3] = (ip6hdr->dest).addr[3];}while(0);
    reply_dest = &reply_dest_local;
    reply_src = &reply_src_local;
    netif = ip6_route(reply_src, reply_dest);
    if (netif == 
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 3 4
                ((void *)0)
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
                    ) {
    ...
    reply_src = (&((ip6_select_source_address(netif, reply_dest))->u_addr.ip6));
    if (reply_src == 
# 327 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c" 3 4
                    ((void *)0)
# 327 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/icmp6.c"
                        ) {
  ...
  {
    icmp6hdr->chksum = ip6_chksum_pseudo(q, 58, q->tot_len,
