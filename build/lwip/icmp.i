# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp.h" 1
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp.h"
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 2
...
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 2
...
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 2
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (p->len < sizeof(u16_t)*2) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: short ICMP (%""d"" bytes) received\n", p->tot_len);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  ...
  case 8:
    ...
    if ((((((&((&ip_data.current_iphdr_dest)->u_addr.ip4))))->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24)))) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: Not echoing to multicast pings\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto icmperr;

    }

    if (ip4_addr_isbroadcast_u32((((&((&ip_data.current_iphdr_dest)->u_addr.ip4))))->addr, (ip_data.current_netif))) {




      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: Not echoing to broadcast pings\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto icmperr;
    ...
    if (pbuf_header(p, (40 + (14 + 0) + 0))) {
      ...
      if (r == 
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
                  ) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: allocating new pbuf failed\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        goto icmperr;
      }
      do { if(!((r->len >= hlen + sizeof(struct icmp_echo_hdr)))) __assert_func(
                                                                 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
      ,
                                                                 159
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
      , __func__, "check that first pbuf can hold struct the ICMP header"); } while(0)
                                                                  ;

      memcpy(r->payload,iphdr_in,hlen);

      if (pbuf_header(r, -hlen)) {
        do { if(!(0)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c", 164, __func__, "icmp_input: moving r->payload to icmp header failed\n"); } while(0);
        pbuf_free(r);
        goto icmperr;
      }

      if (pbuf_copy(r, p) != 0) {
        do { if(!(0)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c", 170, __func__, "icmp_input: copying to new pbuf failed\n"); } while(0);
        pbuf_free(r);
        goto icmperr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(40 + (14 + 0) + 0))) {
        do { if(!(0)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c", 181, __func__, "icmp_input: restoring original p->payload failed\n"); } while(0);
        goto icmperr;
      }
    }
    ...
    if (pbuf_header(p, hlen)) {
      do { if(!(0)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c", 191, __func__, "Can't move over header in packet"); } while(0);
    } else {
      err_t ret;
      struct ip_hdr *iphdr = (struct ip_hdr*)p->payload;
      ((iphdr->src).addr = (*src).addr);
      ((iphdr->dest).addr = (*((&((&ip_data.current_iphdr_src)->u_addr.ip4)))).addr);
      ((iecho)->type = (0));

      {

        if (iecho->chksum > ((((0xffffU - (8 << 8)) & 0xff) << 8) | (((0xffffU - (8 << 8)) & 0xff00) >> 8))) {
          iecho->chksum += ((((8 << 8) & 0xff) << 8) | (((8 << 8) & 0xff00) >> 8)) + 1;
        } else {
          iecho->chksum += ((((8 << 8) & 0xff) << 8) | (((8 << 8) & 0xff00) >> 8));
        }
      }
# 217 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
      (iphdr)->_ttl = (u8_t)((255));
      (iphdr)->_chksum = (0);
      ...
      ret = ip4_output_if(p, src, 
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 3 4
                                 ((void *)0)
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
                                           ,
                   (255), 0, 1, inp);
      if (ret != 0) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: ip_output_if returned an error: %s\n", lwip_strerr(ret));} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    break;
  default:
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: ICMP type %""d"" code %""d"" not supported.\n", (s16_t)type, (s16_t)code);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                          ;
    ;
    ;
  }
...
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
void
...
# 321 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 337 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_time_exceeded: failed to allocate pbuf for ICMP packet.\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    return;
  }
  do { if(!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) __assert_func(
                                                                                              "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
  ,
                                                                                              343
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
  , __func__, "check that first pbuf can hold icmp message"); } while(0)
                                                                                               ;
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[0])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[1])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[2])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[3])));} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf (" to ");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[0])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[1])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[2])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[3])));} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...

  {
    ...
    ((iphdr_dst).addr = (iphdr->dest).addr);
  ...
  if (netif != 
# 372 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 372 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
                  ) {
    ...
    ;
    ip4_output_if(q, 
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/icmp.c"
                        , &iphdr_src, (255), 0, 1, netif);
  }
  pbuf_free(q);
}
