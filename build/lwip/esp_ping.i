# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.h" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c" 2
...
esp_err_t esp_ping_set_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len)
{
    ...
    if (opt_val == 
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c" 3 4
                  ((void *)0)
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c"
                      ) {
        return 0x6000 + 0x01;
    }
    ...
    case PING_TARGET_IP_ADDRESS:
        do { if ((opt_len) < sizeof(uint32_t)) { return 0x6000 + 0x01; }}while(0);
    ...
    case PING_TARGET_DELAY_TIME:
        ...
        break;
    case PING_TARGET_ID:
        do { if ((opt_len) < sizeof(uint16_t)) { return 0x6000 + 0x01; }}while(0);
...
esp_err_t esp_ping_get_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len)
{
    ...
    if (opt_val == 
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c" 3 4
                  ((void *)0)
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/apps/ping/esp_ping.c"
                      ) {
        return 0x6000 + 0x01;
    }
