# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 2



const ip_addr_t ip6_addr_any = { { { { 0ul, 0ul, 0ul, 0ul } } }, 6U };
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
int
ip6addr_aton(const char *cp, ip6_addr_t *addr)
{
  ...
  for (s = cp; *s != 0; s++) {
    if (*s == ':') {
      zero_blocks--;
    } else if (!(((u8_t)*s >= '0' && (u8_t)*s <= '9') || ((u8_t)*s >= 'a' && (u8_t)*s <= 'f') || ((u8_t)*s >= 'A' && (u8_t)*s <= 'F'))) {
      break;
    }
  }
  ...
  for (s = cp; *s != 0; s++) {
    if (*s == ':') {
      ...
      current_block_value = (current_block_value << 4) +
          (((u8_t)*s >= '0' && (u8_t)*s <= '9') ? *s - '0' :
          10 + (((u8_t)*s >= 'a' && (u8_t)*s <= 'z') ? *s - 'a' : *s - 'A'));
    } else {
...
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
char *
...
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
char *
  ...
  for (current_block_index = 0; current_block_index < 8; current_block_index++) {
    ...
    if (current_block_value == 0) {
      if (current_block_index == 7) {
        ...
        if (i >= buflen) {
          return 
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
                ((void *)0)
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                    ;
        }
        break;
      }
      if (empty_block_flag == 0) {
        ...
        if (next_block_value == 0) {
          ...
          if (i >= buflen) {
            return 
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
                  ((void *)0)
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                      ;
          }
          continue;
        }
    ...
    if (current_block_index > 0) {
      ...
      if (i >= buflen) {
        return 
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if ((current_block_value & 0xf000) == 0) {
      ...
      buf[i++] = ((((current_block_value & 0xf000) >> 12)) < 10 ? '0' + (((current_block_value & 0xf000) >> 12)) : 'A' + (((current_block_value & 0xf000) >> 12)) - 10);
      zero_flag = 0;
      if (i >= buflen) {
        return 
# 256 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 256 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf00) == 0) && (zero_flag)) {
      ...
      buf[i++] = ((((current_block_value & 0xf00) >> 8)) < 10 ? '0' + (((current_block_value & 0xf00) >> 8)) : 'A' + (((current_block_value & 0xf00) >> 8)) - 10);
      zero_flag = 0;
      if (i >= buflen) {
        return 
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf0) == 0) && (zero_flag)) {
      ...
      buf[i++] = ((((current_block_value & 0xf0) >> 4)) < 10 ? '0' + (((current_block_value & 0xf0) >> 4)) : 'A' + (((current_block_value & 0xf0) >> 4)) - 10);
      zero_flag = 0;
      if (i >= buflen) {
        return 
# 277 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 277 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }

    buf[i++] = (((current_block_value & 0xf)) < 10 ? '0' + ((current_block_value & 0xf)) : 'A' + ((current_block_value & 0xf)) - 10);
    if (i >= buflen) {
      return 
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c" 3 4
            ((void *)0)
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv6/ip6_addr.c"
                ;
    }
  }
