# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
...
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c" 2
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c" 2
...
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c" 2



const ip_addr_t ip_addr_any = { { { { ((u32_t)0x00000000UL), 0ul, 0ul, 0ul } } }, 0U };
const ip_addr_t ip_addr_broadcast = { { { { ((u32_t)0xffffffffUL), 0ul, 0ul, 0ul } } }, 0U };
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
u8_t
ip4_addr_isbroadcast_u32(u32_t addr, const struct netif *netif)
{
  ...
  } else if (addr == ((((const ip4_addr_t*)(&((&((netif)->ip_addr))->u_addr.ip4))))->addr)) {
    return 0;

  } else if ((((&ipaddr)->addr & (((const ip4_addr_t*)(&((&((netif)->netmask))->u_addr.ip4))))->addr) == ((((const ip4_addr_t*)(&((&((netif)->ip_addr))->u_addr.ip4))))->addr & (((const ip4_addr_t*)(&((&((netif)->netmask))->u_addr.ip4))))->addr))

          && ((addr & ~((((const ip4_addr_t*)(&((&((netif)->netmask))->u_addr.ip4))))->addr)) ==
           (((u32_t)0xffffffffUL) & ~((((const ip4_addr_t*)(&((&((netif)->netmask))->u_addr.ip4))))->addr)))) {
...
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
u32_t
...
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
int
ip4addr_aton(const char *cp, ip4_addr_t *addr)
{
  ...
  for (;;) {
    ...
    for (;;) {
     ...
     ch = (int)(c + 10 - (((u8_t)c >= 'a' && (u8_t)c <= 'z') ? 'a' : 'A'));
     if (val > cutoff || (val == cutoff && ch > cutlim))
      return (0);
...
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
    if (c == '.') {
  ...
  case 4:
    ...
    break;
  default:
    do { if(!(0)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c", 290, __func__, "unhandled"); } while(0);
    break;
  }
  if (addr) {
...
# 307 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
char*
...
# 323 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
char*
ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
  ...
  for (n = 0; n < 4; n++) {
    ...
    while (i--) {
      if (len++ >= buflen) {
        return 
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c" 3 4
              ((void *)0)
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
                  ;
      }
      *rp++ = inv[i];
    }
    if (len++ >= buflen) {
      return 
# 353 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c" 3 4
            ((void *)0)
# 353 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/ipv4/ip4_addr.c"
                ;
    }
    *rp++ = '.';
    ap++;
