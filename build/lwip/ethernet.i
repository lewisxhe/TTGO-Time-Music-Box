# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/netif/ethernet.h" 1
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/netif/ethernet.h"
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/netif/ethernet.h" 2
...
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/netif/ethernet.h" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2
...
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2
...
struct udp_pcb;
struct netif;
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2
...
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c" 2
...
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
err_t
...
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
  if (p->len <= (14 + 0)) {
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {printf ("ethernet_input: dest:%""02x"":%""02x"":%""02x"":%""02x"":%""02x"":%""02x"", src:%""02x"":%""02x"":%""02x"":%""02x"":%""02x"":%""02x"", type:%""x""\n", (unsigned)ethhdr->dest.addr[0], (unsigned)ethhdr->dest.addr[1], (unsigned)ethhdr->dest.addr[2], (unsigned)ethhdr->dest.addr[3], (unsigned)ethhdr->dest.addr[4], (unsigned)ethhdr->dest.addr[5], (unsigned)ethhdr->src.addr[0], (unsigned)ethhdr->src.addr[1], (unsigned)ethhdr->src.addr[2], (unsigned)ethhdr->src.addr[3], (unsigned)ethhdr->src.addr[4], (unsigned)ethhdr->src.addr[5], (unsigned)lwip_htons(ethhdr->type));} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
  ...
  type = ethhdr->type;
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
  if (ethhdr->dest.addr[0] & 1) {
    ...
    else if ((ethhdr->dest.addr[0] == 0x33) &&
               (ethhdr->dest.addr[1] == 0x33)) {
  ...
  switch (type) {
    ...
    case ((((0x0800U) & 0xff) << 8) | (((0x0800U) & 0xff00) >> 8)):
      ...
      if ((p->len < ip_hdr_offset) || pbuf_header(p, (s16_t)-ip_hdr_offset)) {
        do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {printf ("ethernet_input: IPv4 packet dropped, too short (%""d""/%""d"")\n", p->tot_len, ip_hdr_offset);} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0)

                                     ;
        do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {printf ("Can't move over header in packet");} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
        goto free_and_return;
      } else {
    ...
    case ((((0x0806U) & 0xff) << 8) | (((0x0806U) & 0xff00) >> 8)):
      ...
      break;
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/netif/ethernet.c"
    case ((((0x86DDU) & 0xff) << 8) | (((0x86DDU) & 0xff00) >> 8)):

      if ((p->len < ip_hdr_offset) || pbuf_header(p, (s16_t)-ip_hdr_offset)) {
        do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {printf ("ethernet_input: IPv6 packet dropped, too short (%""d""/%""d"")\n", p->tot_len, ip_hdr_offset);} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0)
