# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
...
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/inet_chksum.h" 1
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/inet_chksum.h"
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/inet_chksum.h" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/lwip/inet_chksum.h" 2
...
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 2



# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 2
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t lwip_standard_chksum(const void *dataptr, int len);
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
...
# 262 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
static u16_t
inet_cksum_pseudo_base(struct pbuf *p, u8_t proto, u16_t proto_len, u32_t acc)
{
  ...
  for (q = p; q != 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 3 4
                  ((void *)0)
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
                      ; q = q->next) {
  ...
  acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
  acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("inet_chksum_pseudo(): pbuf chain lwip_chksum()=%""x""\n", acc);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return (u16_t)~(acc & 0xffffUL);
}
# 312 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
...
# 345 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
...
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
       ...
       const ip_addr_t *src, const ip_addr_t *dest)
{
  ...
  if ((((dest) != 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 3 4
     ((void *)0)
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
     ) && (((&*(dest))->type) == 6U))) {
    return ip6_chksum_pseudo(p, proto, proto_len, (&((src)->u_addr.ip6)), (&((dest)->u_addr.ip6)));
  }
  ...
  {
    return inet_chksum_pseudo(p, proto, proto_len, (&((src)->u_addr.ip4)), (&((dest)->u_addr.ip4)));
  }
       ...
       u16_t chksum_len, u32_t acc)
{
  ...
  for (q = p; (q != 
# 410 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 3 4
                   ((void *)0)
# 410 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
                       ) && (chksum_len > 0); q = q->next) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("inet_chksum_pseudo(): checksumming pbuf %p (has next %p) \n", (void *)q, (void *)q->next);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                  ;
    chklen = q->len;
    ...
    chksum_len -= chklen;
    do { if(!(chksum_len < 0x7fff)) __assert_func("D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c", 419, __func__, "delete me"); } while(0);
...
# 458 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
...
# 493 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
...
# 528 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
       ...
       u16_t chksum_len, const ip_addr_t *src, const ip_addr_t *dest)
{
  ...
  if ((((dest) != 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 3 4
     ((void *)0)
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
     ) && (((&*(dest))->type) == 6U))) {
    return ip6_chksum_pseudo_partial(p, proto, proto_len, chksum_len, (&((src)->u_addr.ip6)), (&((dest)->u_addr.ip6)));
  }
  ...
  {
    return inet_chksum_pseudo_partial(p, proto, proto_len, chksum_len, (&((src)->u_addr.ip4)), (&((dest)->u_addr.ip4)));
  }

}
# 557 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
inet_chksum(const void *dataptr, u16_t len)
{
  return (u16_t)~(unsigned int)lwip_standard_chksum(dataptr, len);
}
# 570 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
u16_t
inet_chksum_pbuf(struct pbuf *p)
{
  ...
  swapped = 0;
  for (q = p; q != 
# 579 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c" 3 4
                  ((void *)0)
# 579 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/core/inet_chksum.c"
                      ; q = q->next) {
    acc += lwip_standard_chksum(q->payload, q->len);
    acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
    if (q->len % 2 != 0) {
