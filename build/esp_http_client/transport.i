# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp_http_client//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/queue.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/include/transport.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/include/transport.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/include/transport.h" 2
...
esp_err_t transport_set_func(transport_handle_t t,
                             ...
                             trans_func _destroy);
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 2
...
struct transport_item_t {
    ...
    poll_func _poll_write;
    trans_func _destroy;
    struct { struct transport_item_t *stqe_next; } next;
};
...
struct transport_list_t { struct transport_item_t *stqh_first; struct transport_item_t **stqh_last; };


transport_list_handle_t transport_list_init()
{
    transport_list_handle_t list = calloc(1, sizeof(struct transport_list_t));
    if (!(list)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 56, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 56, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 56, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 56, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 56, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
   ((void *)0)
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
   ; };
    do { (((list))->stqh_first) = 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
   ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
   ; (list)->stqh_last = &(((list))->stqh_first); } while (0);
    return list;
}
...
{
    if (list == 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
               ((void *)0) 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                    || t == 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
                            ((void *)0)
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
    ...
    if (!(t->scheme)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 67, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 67, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 67, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 67, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 67, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 0x101; };
    strcpy(t->scheme, scheme);
    do { (((t))->next.stqe_next) = 
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
   ((void *)0)
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
   ; *(list)->stqh_last = (t); (list)->stqh_last = &(((t))->next.stqe_next); } while (0);
    return 0;
}
...
transport_handle_t transport_list_get_transport(transport_list_handle_t list, const char *scheme)
{
    if (!list) {
        return 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
              ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                  ;
    }
    if (scheme == 
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
                 ((void *)0)
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                     ) {
        return ((list)->stqh_first);
    }
    transport_handle_t item;
    for((item) = (((list))->stqh_first); (item); (item) = (((item))->next.stqe_next)) {
        if (strcasecmp(item->scheme, scheme) == 0) {
            return item;
        }
    }
    return 
# 87 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
          ((void *)0)
# 87 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
              ;
}
...
esp_err_t transport_list_clean(transport_list_handle_t list)
{
    transport_handle_t item = ((list)->stqh_first);
    transport_handle_t tmp;
    while (item != 
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
                  ((void *)0)
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                      ) {
    ...
    do { (((list))->stqh_first) = 
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
   ((void *)0)
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
   ; (list)->stqh_last = &(((list))->stqh_first); } while (0);
    return 0;
}
...
transport_handle_t transport_init()
{
    ...
    if (!(t)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 116, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 116, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 116, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 116, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c", 116, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
   ((void *)0)
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
   ; };
    return t;
}
...
void *transport_get_context_data(transport_handle_t t)
{
    ...
    return 
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
          ((void *)0)
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
              ;
}
...
{
    if (t == 
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
            ((void *)0)
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                ) {
        return -1;
    }
    t->_connect = _connect;
...
{
    if (t == 
# 219 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
            ((void *)0)
# 219 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                ) {
        return -1;
    }
    return t->port;
...
{
    if (t == 
# 227 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c" 3 4
            ((void *)0)
# 227 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport.c"
                ) {
        return -1;
    }
    t->port = port;
