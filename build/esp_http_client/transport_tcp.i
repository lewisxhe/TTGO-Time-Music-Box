# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp_http_client//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                 dns_found_callback found, void *callback_arg,
                                 u8_t dns_addrtype);
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
esp_err_t transport_set_func(transport_handle_t t,
                             ...
                             trans_func _destroy);
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 2
...
static int resolve_dns(const char *host, struct sockaddr_in *ip) {
    ...
    if (he == 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
             ((void *)0)
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
                 ) {
        return -1;
    }
    addr_list = (struct in_addr **)he->h_addr_list;
    if (addr_list[0] == 
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
                       ((void *)0)
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
                           ) {
        return -1;
    }
    ip->sin_family = 2;
...
static int tcp_connect(transport_handle_t t, const char *host, int port, int timeout_ms)
{
    ...
    if ((((2) == 10) ? ip6addr_aton((host),(ip6_addr_t*)(&remote_ip.sin_addr)) : (((2) == 2) ? ip4addr_aton((host),(ip4_addr_t*)(&remote_ip.sin_addr)) : 0)) != 1) {
        if (resolve_dns(host, &remote_ip) < 0) {
            return -1;
        }
    }

    tcp->sock = socket(2, 1, 0);

    if (tcp->sock < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }

    remote_ip.sin_family = 2;
    remote_ip.sin_port = lwip_htons(port);

    http_utils_ms_to_timeval(timeout_ms, &tv);

    setsockopt(tcp->sock, 0xfff, 0x1006, &tv, sizeof(tv));

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == 6U))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == 6U))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == 6U))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == 6U))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == 6U))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } } while(0); } while(0)
                                                                                        ;
...
static int tcp_poll_read(transport_handle_t t, int timeout_ms)
{
    ...
    ((&readset)->fds_bits[(tcp->sock)/(sizeof (fd_mask) * 8)] |= (1L << ((tcp->sock) % (sizeof (fd_mask) * 8))));
    struct timeval timeout;
    http_utils_ms_to_timeval(timeout_ms, &timeout);
    return select(tcp->sock + 1, &readset, 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
                                          ((void *)0)
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
                                              , 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
                                                ((void *)0)
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
...
static int tcp_poll_write(transport_handle_t t, int timeout_ms)
{
    ...
    ((&writeset)->fds_bits[(tcp->sock)/(sizeof (fd_mask) * 8)] |= (1L << ((tcp->sock) % (sizeof (fd_mask) * 8))));
    struct timeval timeout;
    http_utils_ms_to_timeval(timeout_ms, &timeout);
    return select(tcp->sock + 1, 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
                                ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
                                    , &writeset, 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
                                                 ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
...
transport_handle_t transport_tcp_init()
{
    ...
    if (!(tcp)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c", 160, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c", 160, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c", 160, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c", 160, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c", 160, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c" 3 4
   ((void *)0)
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/esp_http_client/lib/transport_tcp.c"
   ; };
    tcp->sock = -1;
