# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs/src/spiffs_gc.c"
...
# 2 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs/src/spiffs_gc.c" 2
...
s32_t spiffs_object_index_consistency_check(
    spiffs *fs);
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs/src/spiffs_gc.c" 2
...
static s32_t spiffs_gc_erase_block(
  ...
  {
    u32_t i;
    for (i = 0; i < ( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ); i++) {
      spiffs_cache_drop_page(fs, ( (bix) * ( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) ) + i);
    }
  }
  ...
  while (res == 0 && blocks--) {
    ...
    while (res == 0 && obj_lookup_page < (int)(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) )) {
      ...
      while (res == 0 &&
        ...
        if (obj_id == ((spiffs_obj_id)0)) {
          deleted_pages_in_block++;
        } else if (obj_id == ((spiffs_obj_id)-1)) {

          free_pages_in_block++;
          if (free_pages_in_block > max_free_pages) {
            obj_lookup_page = (((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) );
            res = 1;
            break;
          }
        } else {
    ...
    if (res == 0 &&
        deleted_pages_in_block + free_pages_in_block == ( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) )-(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) ) &&
...
s32_t spiffs_gc_check(
  ...
  s32_t res;
  s32_t free_pages =
      (( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) - (((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) )) * (fs->block_count-2)
      - fs->stats_p_allocated - fs->stats_p_deleted;
  int tries = 0;

  if (fs->free_blocks > 3 &&
      (s32_t)len < free_pages * (s32_t)( ((fs)->cfg.log_page_size) - sizeof(spiffs_page_header) )) {
    return 0;
  }

  u32_t needed_pages = (len + ( ((fs)->cfg.log_page_size) - sizeof(spiffs_page_header) ) - 1) / ( ((fs)->cfg.log_page_size) - sizeof(spiffs_page_header) );
  ...
  do {
    ...
    if (count == 0) {
      ;
      return (s32_t)needed_pages < free_pages ? 0 : -10001;
    }
  ...
  } while (++tries < 10 && (fs->free_blocks <= 2 ||
      (s32_t)len > free_pages*(s32_t)( ((fs)->cfg.log_page_size) - sizeof(spiffs_page_header) )));

  free_pages =
        (( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) - (((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) )) * (fs->block_count - 2)
        - fs->stats_p_allocated - fs->stats_p_deleted;
  if ((s32_t)len > free_pages*(s32_t)( ((fs)->cfg.log_page_size) - sizeof(spiffs_page_header) )) {
    res = -10001;
  }
...
s32_t spiffs_gc_erase_page_stats(
  ...
  while (res == 0 && obj_lookup_page < (int)(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) )) {
    int entry_offset = obj_lookup_page * entries_per_page;
    res = spiffs_phys_rd((fs), ((0<<0) | (5<<2)), (0), (bix * ((fs)->cfg.log_block_size) + ( ((fs)->cfg.phys_addr) + (obj_lookup_page) * ((fs)->cfg.log_page_size) )), (((fs)->cfg.log_page_size)), (fs->lu_work))
                                                                                                                                  ;

    while (res == 0 &&
        cur_entry - entry_offset < entries_per_page && cur_entry < (int)(( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) )-(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) ))) {
      spiffs_obj_id obj_id = obj_lu_buf[cur_entry-entry_offset];
...
s32_t spiffs_gc_find_candidate(
  ...
  int max_candidates = ((fs->block_count) < ((((fs)->cfg.log_page_size)-8)/(sizeof(spiffs_block_ix) + sizeof(s32_t))) ? (fs->block_count) : ((((fs)->cfg.log_page_size)-8)/(sizeof(spiffs_block_ix) + sizeof(s32_t))));
  *candidate_count = 0;
  ...
  while (res == 0 && blocks--) {
    ...
    if (res == 0 ) {
      ...
      if (fs->max_erase_count > erase_count) {
        ...
        erase_age = ((spiffs_obj_id)-1) - (erase_count - fs->max_erase_count);
      }

      s32_t score =
          deleted_pages_in_block * (5) +
          used_pages_in_block * (-1) +
          erase_age * (fs_crammed ? 0 : (50));
      int cand_ix = 0;
      ;
...
# 377 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs/src/spiffs_gc.c"
s32_t spiffs_gc_clean(spiffs *fs, spiffs_block_ix bix) {
  s32_t res = 0;
  const int entries_per_page = (((fs)->cfg.log_page_size) / sizeof(spiffs_obj_id));
  ...
  while (res == 0 && gc.state != FINISHED) {
    ...
    while (scan && res == 0 && obj_lookup_page < (int)(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) )) {
      int entry_offset = obj_lookup_page * entries_per_page;
      res = spiffs_phys_rd((fs), ((0<<0) | (5<<2)), (0), (bix * ((fs)->cfg.log_block_size) + ( ((fs)->cfg.phys_addr) + (obj_lookup_page) * ((fs)->cfg.log_page_size) )), (((fs)->cfg.log_page_size)), (fs->lu_work))
      ...
      while (scan && res == 0 &&
          cur_entry - entry_offset < entries_per_page && cur_entry < (int)(( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) )-(((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) ))) {
        spiffs_obj_id obj_id = obj_lu_buf[cur_entry-entry_offset];
        cur_pix = ((bix)*( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) + ((((1) > ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size)) ? (1) : ((( ((fs)->cfg.log_block_size)/((fs)->cfg.log_page_size) ) * sizeof(spiffs_obj_id)) / ((fs)->cfg.log_page_size))) ) + cur_entry));


        switch (gc.state) {
        case FIND_OBJ_DATA:

          if (obj_id != ((spiffs_obj_id)0) && obj_id != ((spiffs_obj_id)-1) &&
        ...
        case MOVE_OBJ_DATA:
          ...
          if (obj_id == gc.cur_obj_id) {
            spiffs_page_header p_hdr;
            res = spiffs_phys_rd((fs), ((1<<0) | (5<<2)), (0), (( ((fs)->cfg.phys_addr) + (cur_pix) * ((fs)->cfg.log_page_size) )), (sizeof(spiffs_page_header)), ((u8_t*)&p_hdr))
                                                                                                ;
            do { if ((res) < 0) return (res); } while (0);;
            ;
            if (((p_hdr.span_ix) < ((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)) ? 0 : (1+((p_hdr.span_ix)-((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)))/((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix))/sizeof(spiffs_page_ix)))) != gc.cur_objix_spix) {
              ;
            } else {
              ...
              if (gc.cur_objix_spix == 0) {
                ...
                ((spiffs_page_ix*)((u8_t *)objix + sizeof(spiffs_page_object_ix)))[((p_hdr.span_ix) < ((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)) ? (p_hdr.span_ix) : (((p_hdr.span_ix)-((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)))%((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix))/sizeof(spiffs_page_ix))))] = new_data_pix;
                ;
              }
            }
          }
          ...
          if (obj_id != ((spiffs_obj_id)0) && obj_id != ((spiffs_obj_id)-1) &&
            ...
            if (p_hdr.flags & (1<<7)) {
              ...
              spiffs_cb_object_event(fs, (spiffs_page_object_ix *)&p_hdr,
                  (3), obj_id, p_hdr.span_ix, new_pix, 0);
              ...
              if (res == 0) {
                spiffs_cb_object_event(fs, (spiffs_page_object_ix *)0,
                    (2), obj_id, p_hdr.span_ix, cur_pix, 0);
              }
            }
            do { if ((res) < 0) return (res); } while (0);;
          }
    ...
    case FIND_OBJ_DATA:
      if (gc.obj_id_found) {
        ...
        res = spiffs_phys_rd((fs), ((1<<0) | (5<<2)), (0), (( ((fs)->cfg.phys_addr) + (cur_pix) * ((fs)->cfg.log_page_size) )), (sizeof(spiffs_page_header)), ((u8_t*)&p_hdr))
                                                                                            ;
        do { if ((res) < 0) return (res); } while (0);;
        gc.cur_objix_spix = ((p_hdr.span_ix) < ((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)) ? 0 : (1+((p_hdr.span_ix)-((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix_header))/sizeof(spiffs_page_ix)))/((((fs)->cfg.log_page_size) - sizeof(spiffs_page_object_ix))/sizeof(spiffs_page_ix))));
        ;
        res = spiffs_obj_lu_find_id_and_span(fs, gc.cur_obj_id | ((spiffs_obj_id)(1<<(8*sizeof(spiffs_obj_id)-1))), gc.cur_objix_spix, 0, &objix_pix);
        if (res == -10002) {
        ...
        do { if ((res) < 0) return (res); } while (0);;
        ;
        res = spiffs_phys_rd((fs), ((1<<0) | (5<<2)), (0), (( ((fs)->cfg.phys_addr) + (objix_pix) * ((fs)->cfg.log_page_size) )), (((fs)->cfg.log_page_size)), (fs->work))
                                                                                         ;
        do { if ((res) < 0) return (res); } while (0);;


        if (((objix->p_hdr).flags & (1<<0)) != 0) return -10012; if (((objix->p_hdr).flags & (1<<7)) == 0) return -10004; if (((objix->p_hdr).flags & (1<<1)) != 0) return -10005; if (((objix->p_hdr).flags & (1<<2)) != 0) return -10006; if (((gc.cur_obj_id | ((spiffs_obj_id)(1<<(8*sizeof(spiffs_obj_id)-1)))) & ((spiffs_obj_id)(1<<(8*sizeof(spiffs_obj_id)-1)))) == 0) return -10006; if ((objix->p_hdr).span_ix != (gc.cur_objix_spix)) return -10013;;
    ...
    case MOVE_OBJ_DATA: {
      ...
      if (gc.cur_objix_spix == 0) {
        ...
        res = spiffs_object_update_index_hdr(fs, 0, gc.cur_obj_id | ((spiffs_obj_id)(1<<(8*sizeof(spiffs_obj_id)-1))), gc.cur_objix_pix, fs->work, 0, 0, 0, &new_objix_pix);
        ;
        do { if ((res) < 0) return (res); } while (0);;
      } else {

        res = spiffs_page_move(fs, 0, fs->work, gc.cur_obj_id | ((spiffs_obj_id)(1<<(8*sizeof(spiffs_obj_id)-1))), 0, gc.cur_objix_pix, &new_objix_pix);
        ;
        do { if ((res) < 0) return (res); } while (0);;
        spiffs_cb_object_event(fs, (spiffs_page_object_ix *)fs->work,
            (0), gc.cur_obj_id, objix->p_hdr.span_ix, new_objix_pix, 0);
      }
    }
    break;
    case MOVE_OBJ_IX:
