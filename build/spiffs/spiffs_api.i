# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\spiffs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2
...
esp_err_t esp_partition_mmap(const esp_partition_t* partition, uint32_t offset, uint32_t size,
                             ...
                             const void** out_ptr, spi_flash_mmap_handle_t* out_handle);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h" 1
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
typedef struct {
        const char* base_path;
        const char* partition_label;
        size_t max_files;
        
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h" 3 4
       _Bool 
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
            format_if_mount_failed;
} esp_vfs_spiffs_conf_t;
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
esp_err_t esp_vfs_spiffs_register(const esp_vfs_spiffs_conf_t * conf);
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
esp_err_t esp_vfs_spiffs_unregister(const char* partition_label);
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"

# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h" 3 4
_Bool 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
    esp_spiffs_mounted(const char* partition_label);
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
esp_err_t esp_spiffs_format(const char* partition_label);
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/esp_spiffs.h"
esp_err_t esp_spiffs_info(const char* partition_label, size_t *total_bytes, size_t *used_bytes);
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/vfs/include/esp_vfs.h" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h" 1
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h"
       


# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/include/spiffs_config.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h" 3 4
   _Bool 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.h"
        by_label;
    spiffs_config cfg;
    uint8_t *work;
    uint8_t *fds;
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 2

const char* TAG = "SPIFFS";

void spiffs_api_lock(spiffs *fs)
{
    xQueueGenericReceive( ( QueueHandle_t ) ( ((esp_spiffs_t *)(fs->user_data))->lock ), 
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 3 4
   ((void *)0)
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
}

void spiffs_api_unlock(spiffs *fs)
{
    xQueueGenericSend( ( QueueHandle_t ) ( ((esp_spiffs_t *)(fs->user_data))->lock ), 
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c" 3 4
   ((void *)0)
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/spiffs/spiffs_api.c"
...
s32_t spiffs_api_read(spiffs *fs, uint32_t addr, uint32_t size, uint8_t *dst)
{
    esp_err_t err = esp_partition_read(((esp_spiffs_t *)(fs->user_data))->partition,
                                        addr, dst, size);
    if (err) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to read addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to read addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to read addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to read addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to read addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } } while(0); } while(0);
        return -1;
    }
    return 0;
}
...
s32_t spiffs_api_write(spiffs *fs, uint32_t addr, uint32_t size, uint8_t *src)
{
    esp_err_t err = esp_partition_write(((esp_spiffs_t *)(fs->user_data))->partition,
                                        addr, src, size);
    if (err) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to write addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to write addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to write addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to write addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to write addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } } while(0); } while(0);
        return -1;
    }
    return 0;
}
...
s32_t spiffs_api_erase(spiffs *fs, uint32_t addr, uint32_t size)
{
    esp_err_t err = esp_partition_erase_range(((esp_spiffs_t *)(fs->user_data))->partition,
                                        addr, size);
    if (err) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to erase addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to erase addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to erase addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to erase addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to erase addr %08x, size %08x, err %d" "\033[0m" "\n", esp_log_timestamp(), TAG, addr, size, err); } } while(0); } while(0);
        return -1;
    }
    return 0;
}
                            ...
                            spiffs_check_report report, uint32_t arg1, uint32_t arg2)
{
    ...
    if (report != SPIFFS_CHECK_PROGRESS) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "CHECK: type:%s, report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_type_str[type], spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "CHECK: type:%s, report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_type_str[type], spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CHECK: type:%s, report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_type_str[type], spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "CHECK: type:%s, report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_type_str[type], spiffs_check_report_str[report], arg1, arg2); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "CHECK: type:%s, report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_type_str[type], spiffs_check_report_str[report], arg1, arg2); } } while(0); } while(0)
                                                                          ;
    } else {
        do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "CHECK PROGRESS: report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "CHECK PROGRESS: report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CHECK PROGRESS: report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_report_str[report], arg1, arg2); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "CHECK PROGRESS: report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_report_str[report], arg1, arg2); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "CHECK PROGRESS: report:%s, %x:%x" "\033[0m" "\n", esp_log_timestamp(), TAG, spiffs_check_report_str[report], arg1, arg2); } } while(0); } while(0)
                                                                          ;
    }
}
