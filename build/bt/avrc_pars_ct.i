# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 2
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
...
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c" 3 4
                               ((void *)0)
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
                                   ) {
        return 0x03;
    }

    p = p_msg->p_vendor_data;
    {p_result->pdu = (UINT8)(*(p)); (p) += 1;};
    p++;
    {len = (UINT16)(((UINT16)(*(p)) << 8) + (UINT16)(*((p) + 1))); (p) += 2;};
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "avrc_pars_vendor_rsp() ctype:0x%x pdu:0x%x, len:%d/0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_msg->hdr.ctype, p_result->pdu, len, len); };};
    if (p_msg->hdr.ctype == 10) {
    ...
    case 0x50:
        if (len != 1) {
            ...
            {p_result->volume.volume = (UINT8)(*(p)); (p) += 1;};
        }
        break;
    ...
    case 0x31:
        ...
        {eventid = (UINT8)(*(p)); (p) += 1;};
        if (0x0d == eventid
                && (13 == p_msg->hdr.ctype || 15 == p_msg->hdr.ctype
                    || 10 == p_msg->hdr.ctype || 8 == p_msg->hdr.ctype)) {
            p_result->reg_notif.status = p_msg->hdr.ctype;
            p_result->reg_notif.event_id = eventid;
            {p_result->reg_notif.param.volume = (UINT8)(*(p)); (p) += 1;};
        }
        {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "avrc_pars_vendor_rsp PDU reg notif response:event %x, volume %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", eventid, p_result->reg_notif.param.volume); };}
                                                          ;
...
# 115 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_pars_ct.c"
tAVRC_STS AVRC_ParsResponse (tAVRC_MSG *p_msg, tAVRC_RESPONSE *p_result, UINT8 *p_buf, UINT16 buf_len)
{
    ...
    if (p_msg && p_result) {
        ...
        default:
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC_ParsResponse() unknown opcode:0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_msg->hdr.opcode); };};
            break;
        }
