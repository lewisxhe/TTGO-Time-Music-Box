# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
typedef struct {
    btc_sm_state_t state;
    btc_sm_handler_t *p_handlers;
} btc_sm_cb_t;
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
btc_sm_handle_t btc_sm_init(const btc_sm_handler_t *p_handlers, btc_sm_state_t initial_state)
{
    btc_sm_cb_t *p_cb;

    if (p_handlers == 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                     ((void *)0)
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                         ) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s : p_handlers is NULL" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        return 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
              ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                  ;
    }

    p_cb = (btc_sm_cb_t *)malloc((sizeof(btc_sm_cb_t)));
    p_cb->state = initial_state;
    p_cb->p_handlers = (btc_sm_handler_t *)p_handlers;


    p_cb->p_handlers[initial_state](0xFFFF, 
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                     ((void *)0)
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                                                         );

    return (btc_sm_handle_t)p_cb;
}
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
void btc_sm_shutdown(btc_sm_handle_t handle)
{
    btc_sm_cb_t *p_cb = (btc_sm_cb_t *)handle;

    if (p_cb == 
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
               ((void *)0)
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                   ) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s : Invalid handle" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        return;
    }
    free((p_cb));
}
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
btc_sm_state_t btc_sm_get_state(btc_sm_handle_t handle)
{
    btc_sm_cb_t *p_cb = (btc_sm_cb_t *)handle;

    if (p_cb == 
# 122 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
               ((void *)0)
# 122 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                   ) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s : Invalid handle" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        return 0;
    }
...
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
bt_status_t btc_sm_dispatch(btc_sm_handle_t handle, btc_sm_event_t event,
                            void *data)
{
    ...
    if (p_cb == 
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
               ((void *)0)
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                   ) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s : Invalid handle" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        return BT_STATUS_FAIL;
    }

    if (p_cb->p_handlers[p_cb->state](event, data) == 
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                     0
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                                                          ) {
...
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
bt_status_t btc_sm_change_state(btc_sm_handle_t handle, btc_sm_state_t state)
{
    bt_status_t status = BT_STATUS_SUCCESS;
    btc_sm_cb_t *p_cb = (btc_sm_cb_t *)handle;
    ...
    if (p_cb == 
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
               ((void *)0)
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                   ) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s : Invalid handle" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        return BT_STATUS_FAIL;
    }
    ...
    if (p_cb->p_handlers[p_cb->state](0xFFFE, 
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                      ((void *)0)
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                                                          ) == 
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                               0
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
    ...
    if (p_cb->p_handlers[p_cb->state](0xFFFF, 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                       ((void *)0)
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
                                                           ) == 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c" 3 4
                                                                0
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_sm.c"
