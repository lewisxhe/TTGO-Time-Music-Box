# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 2
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_rm_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    bta_sys_cb.prm_cb = p_cback;
}
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_policy_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    bta_sys_cb.p_policy_cb = p_cback;
}
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_role_chg_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    bta_sys_cb.p_role_cb = p_cback;
}
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_notify_role_chg(BD_ADDR_PTR p_bda, UINT8 new_role, UINT8 hci_status)
{
    if (bta_sys_cb.p_role_cb) {
        bta_sys_cb.p_role_cb(0x14, new_role, hci_status, p_bda);
    }
}
# 119 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
...
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_notify_collision (BD_ADDR_PTR p_bda)
{
    ...
    for (index = 0; index < 5; index++) {
        if ((bta_sys_cb.colli_reg.id[index] != 0) &&
                (bta_sys_cb.colli_reg.p_coll_cback[index] != 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                            ((void *)0)
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
                                                                )) {
            bta_sys_cb.colli_reg.p_coll_cback[index] (0, 0, 0, p_bda);
        }
    }
}
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    bta_sys_cb.p_sco_cb = p_cback;
}
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_pm_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    bta_sys_cb.ppm_cb = p_cback;
}
# 196 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_conn_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if (bta_sys_cb.prm_cb) {

        bta_sys_cb.prm_cb(0x00, id, app_id, peer_addr);

    }

    if (bta_sys_cb.ppm_cb) {

        bta_sys_cb.ppm_cb(0x00, id, app_id, peer_addr);

    }
}
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_conn_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if (bta_sys_cb.prm_cb) {

        bta_sys_cb.prm_cb(0x01, id, app_id, peer_addr);

    }

    if (bta_sys_cb.ppm_cb) {

        bta_sys_cb.ppm_cb(0x01, id, app_id, peer_addr);

    }
}
# 251 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_app_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if (bta_sys_cb.ppm_cb) {
        bta_sys_cb.ppm_cb(0x02, id, app_id, peer_addr);
    }
}
# 270 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_app_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if (bta_sys_cb.ppm_cb) {
        bta_sys_cb.ppm_cb(0x03, id, app_id, peer_addr);
    }
}
# 288 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{

    if ((id != 5) && (bta_sys_cb.p_sco_cb)) {

        bta_sys_cb.p_sco_cb(0x04, 1, app_id, peer_addr);
    }

    if (bta_sys_cb.ppm_cb) {
        bta_sys_cb.ppm_cb(0x04, id, app_id, peer_addr);
    }
}
# 311 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    ...
    if ((id != 5) && (bta_sys_cb.p_sco_cb)) {
        ...
        bta_sys_cb.p_sco_cb(0x05, num_sco_links, app_id, peer_addr);
    }

    if (bta_sys_cb.ppm_cb) {
        bta_sys_cb.ppm_cb(0x05, id, app_id, peer_addr);
    }
}
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
...
# 356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
...
# 394 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_set_policy (UINT8 id, UINT8 policy, BD_ADDR peer_addr)
{
    if (bta_sys_cb.p_policy_cb) {
        bta_sys_cb.p_policy_cb(0x10, id, policy, peer_addr);
    }
}
# 411 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_clear_policy (UINT8 id, UINT8 policy, BD_ADDR peer_addr)
{
    if (bta_sys_cb.p_policy_cb) {
        bta_sys_cb.p_policy_cb(0x11, id, policy, peer_addr);
    }
}
# 428 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_set_default_policy (UINT8 id, UINT8 policy)
{
    if (bta_sys_cb.p_policy_cb) {
        bta_sys_cb.p_policy_cb(0x12, id, policy, 
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                                ((void *)0)
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
                                                                    );
    }
}
# 445 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_clear_default_policy (UINT8 id, UINT8 policy)
{
    if (bta_sys_cb.p_policy_cb) {
        bta_sys_cb.p_policy_cb(0x13, id, policy, 
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                                ((void *)0)
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
                                                                    );
    }
}
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_idle(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{

    if (bta_sys_cb.prm_cb) {

        bta_sys_cb.prm_cb(0x06, id, app_id, peer_addr);

    }

    if (bta_sys_cb.ppm_cb) {

        bta_sys_cb.ppm_cb(0x06, id, app_id, peer_addr);
    }
}
# 487 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_busy(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if (bta_sys_cb.prm_cb) {

        bta_sys_cb.prm_cb(0x07, id, app_id, peer_addr);

    }

    if (bta_sys_cb.ppm_cb) {

        bta_sys_cb.ppm_cb(0x07, id, app_id, peer_addr);

    }
}
# 513 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_eir_register(tBTA_SYS_EIR_CBACK *p_cback)
{
    bta_sys_cb.eir_cb = p_cback;
}
# 528 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_add_uuid(UINT16 uuid16)
{
    if (bta_sys_cb.eir_cb) {
        bta_sys_cb.eir_cb(uuid16, 
# 531 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                 1 
# 531 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
                                      );
    }
}
# 545 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_remove_uuid(UINT16 uuid16)
{
    if (bta_sys_cb.eir_cb) {
        bta_sys_cb.eir_cb(uuid16, 
# 548 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                 0
# 548 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
                                      );
    }
}
# 562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
BOOLEAN bta_sys_vs_hdl(UINT16 evt, void *p)
{
    ...
    return 
# 568 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c" 3 4
          0
# 568 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/bta_sys_conn.c"
               ;
}
