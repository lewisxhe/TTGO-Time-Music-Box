# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/include/sbc_enc_func_declare.h" 1
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/include/sbc_enc_func_declare.h"
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c" 2
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
static SINT32 s32DCTY[16] = {0};
static SINT32 s32X[((8*10*2) + 64) / 2];
static SINT16 *s16X = (SINT16 *) s32X;
# 902 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
...
# 935 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
    ...
    for (s32Blk = 0; s32Blk < s32NumOfBlocks; s32Blk++) {
        ...
        for (s32Ch = 0; s32Ch < s32NumOfChannels; s32Ch++) {
            ...
            { { s32Temp=(SINT32)(SINT16)0x0166*(SINT32)(s16X[ChOffset+8]-s16X[ChOffset+32]); s32Temp+=(SINT32)(SINT16)0x115B*(SINT32)(s16X[ChOffset+16]-s16X[ChOffset+24]); s32DCTY[0]=(SINT32)(s32Temp);}; { s32Temp=(SINT32)(SINT16)0x0012*(SINT32)s16X[ChOffset+1]; s32Temp2=(SINT32)(SINT16)0x0012*(SINT32)s16X[ChOffset+32+7]; s32Temp+=(SINT32)(SINT16)0x029E*(SINT32)s16X[ChOffset+8+1]; s32Temp2+=(SINT32)(SINT16)0x029E*(SINT32)s16X[ChOffset+24+7]; s32Temp+=(SINT32)(SINT16)0x18F5*(SINT32)s16X[ChOffset+16+1]; s32Temp2+=(SINT32)(SINT16)0x18F5*(SINT32)s16X[ChOffset+16+7]; s32Temp+=(SINT32)(SINT16)0xF610*(SINT32)s16X[ChOffset+24+1]; s32Temp2+=(SINT32)(SINT16)0xF610*(SINT32)s16X[ChOffset+8+7]; s32Temp+=(SINT32)(SINT16)0xFF9C*(SINT32)s16X[ChOffset+32+1]; s32Temp2+=(SINT32)(SINT16)0xFF9C*(SINT32)s16X[ChOffset+7]; s32DCTY[1]=(SINT32)(s32Temp); s32DCTY[7]=(SINT32)(s32Temp2);}; { s32Temp=(SINT32)(SINT16)0x0031*(SINT32)s16X[ChOffset+2]; s32Temp2=(SINT32)(SINT16)0x0031*(SINT32)s16X[ChOffset+32+6]; s32Temp+=(SINT32)(SINT16)0x03B2*(SINT32)s16X[ChOffset+8+2]; s32Temp2+=(SINT32)(SINT16)0x03B2*(SINT32)s16X[ChOffset+24+6]; s32Temp+=(SINT32)(SINT16)0x1F91*(SINT32)s16X[ChOffset+16+2]; s32Temp2+=(SINT32)(SINT16)0x1F91*(SINT32)s16X[ChOffset+16+6]; s32Temp+=(SINT32)(SINT16)0xFC50*(SINT32)s16X[ChOffset+24+2]; s32Temp2+=(SINT32)(SINT16)0xFC50*(SINT32)s16X[ChOffset+8+6]; s32Temp+=(SINT32)(SINT16)0x003D*(SINT32)s16X[ChOffset+32+2]; s32Temp2+=(SINT32)(SINT16)0x003D*(SINT32)s16X[ChOffset+6]; s32DCTY[2]=(SINT32)(s32Temp); s32DCTY[6]=(SINT32)(s32Temp2);}; { s32Temp=(SINT32)(SINT16)0x005A*(SINT32)s16X[ChOffset+3]; s32Temp2=(SINT32)(SINT16)0x005A*(SINT32)s16X[ChOffset+32+5]; s32Temp+=(SINT32)(SINT16)0x041F*(SINT32)s16X[ChOffset+8+3]; s32Temp2+=(SINT32)(SINT16)0x041F*(SINT32)s16X[ChOffset+24+5]; s32Temp+=(SINT32)(SINT16)0x2413*(SINT32)s16X[ChOffset+16+3]; s32Temp2+=(SINT32)(SINT16)0x2413*(SINT32)s16X[ChOffset+16+5]; s32Temp+=(SINT32)(SINT16)0x00C9*(SINT32)s16X[ChOffset+24+3]; s32Temp2+=(SINT32)(SINT16)0x00C9*(SINT32)s16X[ChOffset+8+5]; s32Temp+=(SINT32)(SINT16)0x0080*(SINT32)s16X[ChOffset+32+3]; s32Temp2+=(SINT32)(SINT16)0x0080*(SINT32)s16X[ChOffset+5]; s32DCTY[3]=(SINT32)(s32Temp); s32DCTY[5]=(SINT32)(s32Temp2);}; { s32Temp=(SINT32)(SINT16)0x007E*(SINT32)(s16X[ChOffset+4]+s16X[ChOffset+4+32]); s32Temp+=(SINT32)(SINT16)0x0350*(SINT32)(s16X[ChOffset+4+8]+s16X[ChOffset+4+24]); s32Temp+=(SINT32)(SINT16)0x25AC*(SINT32)s16X[ChOffset+4+16]; s32DCTY[4]=(SINT32)(s32Temp);};}
        ...
        if (s32NumOfChannels == 1) {
            if (ShiftCounter >= EncMaxShiftCounter) {
                { ps32X=(SINT32 *)(s16X+EncMaxShiftCounter+38); for (i=0;i<9;i++) { *ps32X=*(ps32X-2-(ShiftCounter>>1)); ps32X--; *ps32X=*(ps32X-2-(ShiftCounter>>1)); ps32X--; } };
                ShiftCounter = 0;
            } else {
                ShiftCounter += 4;
            }
            ...
            if (ShiftCounter >= EncMaxShiftCounter) {
                { ps32X=(SINT32 *)(s16X+EncMaxShiftCounter+38); ps32X2=(SINT32 *)(s16X+(EncMaxShiftCounter<<1)+78); for (i=0;i<9;i++) { *ps32X=*(ps32X-2-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-2-(ShiftCounter>>1)); ps32X--; ps32X2--; *ps32X=*(ps32X-2-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-2-(ShiftCounter>>1)); ps32X--; ps32X2--; } };
                ShiftCounter = 0;
            } else {
                ShiftCounter += 4;
            }
...
void SbcAnalysisFilter8 (SBC_ENC_PARAMS *pstrEncParams)
{
    ...
    register SINT32 s32Temp, s32Temp2;
# 1013 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_analysis.c"
    s32NumOfChannels = pstrEncParams->s16NumOfChannels;
    s32NumOfBlocks = pstrEncParams->s16NumOfBlocks;
    ...
    for (s32Blk = 0; s32Blk < s32NumOfBlocks; s32Blk++) {
        ...
        for (s32Ch = 0; s32Ch < s32NumOfChannels; s32Ch++) {
            ...
            { { s32Temp=(SINT32)(SINT16)0x00B9*(SINT32)(s16X[ChOffset+16]-s16X[ChOffset+64]); s32Temp+=(SINT32)(SINT16)0x08B4*(SINT32)(s16X[ChOffset+32]-s16X[ChOffset+48]); s32DCTY[0]=(SINT32)s32Temp;}; { s32Temp=(SINT32)(SINT16)0x0005*(SINT32)s16X[ChOffset+1]; s32Temp2=(SINT32)(SINT16)0x0005*(SINT32)s16X[ChOffset+64+15]; s32Temp+=(SINT32)(SINT16)0x0107*(SINT32)s16X[ChOffset+16+1]; s32Temp2+=(SINT32)(SINT16)0x0107*(SINT32)s16X[ChOffset+48+15]; s32Temp+=(SINT32)(SINT16)0x0A9F*(SINT32)s16X[ChOffset+32+1]; s32Temp2+=(SINT32)(SINT16)0x0A9F*(SINT32)s16X[ChOffset+32+15]; s32Temp+=(SINT32)(SINT16)0xF931*(SINT32)s16X[ChOffset+48+1]; s32Temp2+=(SINT32)(SINT16)0xF931*(SINT32)s16X[ChOffset+16+15]; s32Temp+=(SINT32)(SINT16)0xFF8D*(SINT32)s16X[ChOffset+64+1]; s32Temp2+=(SINT32)(SINT16)0xFF8D*(SINT32)s16X[ChOffset+15]; s32DCTY[1]=(SINT32)s32Temp; s32DCTY[15]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x000B*(SINT32)s16X[ChOffset+2]; s32Temp2=(SINT32)(SINT16)0x000B*(SINT32)s16X[ChOffset+64+14]; s32Temp+=(SINT32)(SINT16)0x0157*(SINT32)s16X[ChOffset+16+2]; s32Temp2+=(SINT32)(SINT16)0x0157*(SINT32)s16X[ChOffset+48+14]; s32Temp+=(SINT32)(SINT16)0x0C7D*(SINT32)s16X[ChOffset+32+2]; s32Temp2+=(SINT32)(SINT16)0x0C7D*(SINT32)s16X[ChOffset+32+14]; s32Temp+=(SINT32)(SINT16)0xFB00*(SINT32)s16X[ChOffset+48+2]; s32Temp2+=(SINT32)(SINT16)0xFB00*(SINT32)s16X[ChOffset+16+14]; s32Temp+=(SINT32)(SINT16)0xFFCA*(SINT32)s16X[ChOffset+64+2]; s32Temp2+=(SINT32)(SINT16)0xFFCA*(SINT32)s16X[ChOffset+14]; s32DCTY[2]=(SINT32)s32Temp; s32DCTY[14]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x0012*(SINT32)s16X[ChOffset+3]; s32Temp2=(SINT32)(SINT16)0x0012*(SINT32)s16X[ChOffset+64+13]; s32Temp+=(SINT32)(SINT16)0x01A2*(SINT32)s16X[ChOffset+16+3]; s32Temp2+=(SINT32)(SINT16)0x01A2*(SINT32)s16X[ChOffset+48+13]; s32Temp+=(SINT32)(SINT16)0x0E3C*(SINT32)s16X[ChOffset+32+3]; s32Temp2+=(SINT32)(SINT16)0x0E3C*(SINT32)s16X[ChOffset+32+13]; s32Temp+=(SINT32)(SINT16)0xFCA8*(SINT32)s16X[ChOffset+48+3]; s32Temp2+=(SINT32)(SINT16)0xFCA8*(SINT32)s16X[ChOffset+16+13]; s32Temp+=(SINT32)(SINT16)0xFFFA*(SINT32)s16X[ChOffset+64+3]; s32Temp2+=(SINT32)(SINT16)0xFFFA*(SINT32)s16X[ChOffset+13]; s32DCTY[3]=(SINT32)s32Temp; s32DCTY[13]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x001B*(SINT32)s16X[ChOffset+4]; s32Temp2=(SINT32)(SINT16)0x001B*(SINT32)s16X[ChOffset+64+12]; s32Temp+=(SINT32)(SINT16)0x01E0*(SINT32)s16X[ChOffset+16+4]; s32Temp2+=(SINT32)(SINT16)0x01E0*(SINT32)s16X[ChOffset+48+12]; s32Temp+=(SINT32)(SINT16)0x0FC7*(SINT32)s16X[ChOffset+32+4]; s32Temp2+=(SINT32)(SINT16)0x0FC7*(SINT32)s16X[ChOffset+32+12]; s32Temp+=(SINT32)(SINT16)0xFE20*(SINT32)s16X[ChOffset+48+4]; s32Temp2+=(SINT32)(SINT16)0xFE20*(SINT32)s16X[ChOffset+16+12]; s32Temp+=(SINT32)(SINT16)0x001E*(SINT32)s16X[ChOffset+64+4]; s32Temp2+=(SINT32)(SINT16)0x001E*(SINT32)s16X[ChOffset+12]; s32DCTY[4]=(SINT32)s32Temp; s32DCTY[12]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x0025*(SINT32)s16X[ChOffset+5]; s32Temp2=(SINT32)(SINT16)0x0025*(SINT32)s16X[ChOffset+64+11]; s32Temp+=(SINT32)(SINT16)0x0209*(SINT32)s16X[ChOffset+16+5]; s32Temp2+=(SINT32)(SINT16)0x0209*(SINT32)s16X[ChOffset+48+11]; s32Temp+=(SINT32)(SINT16)0x110F*(SINT32)s16X[ChOffset+32+5]; s32Temp2+=(SINT32)(SINT16)0x110F*(SINT32)s16X[ChOffset+32+11]; s32Temp+=(SINT32)(SINT16)0xFF5F*(SINT32)s16X[ChOffset+48+5]; s32Temp2+=(SINT32)(SINT16)0xFF5F*(SINT32)s16X[ChOffset+16+11]; s32Temp+=(SINT32)(SINT16)0x0035*(SINT32)s16X[ChOffset+64+5]; s32Temp2+=(SINT32)(SINT16)0x0035*(SINT32)s16X[ChOffset+11]; s32DCTY[5]=(SINT32)s32Temp; s32DCTY[11]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x0030*(SINT32)s16X[ChOffset+6]; s32Temp2=(SINT32)(SINT16)0x0030*(SINT32)s16X[ChOffset+64+10]; s32Temp+=(SINT32)(SINT16)0x0214*(SINT32)s16X[ChOffset+16+6]; s32Temp2+=(SINT32)(SINT16)0x0214*(SINT32)s16X[ChOffset+48+10]; s32Temp+=(SINT32)(SINT16)0x1204*(SINT32)s16X[ChOffset+32+6]; s32Temp2+=(SINT32)(SINT16)0x1204*(SINT32)s16X[ChOffset+32+10]; s32Temp+=(SINT32)(SINT16)0x0060*(SINT32)s16X[ChOffset+48+6]; s32Temp2+=(SINT32)(SINT16)0x0060*(SINT32)s16X[ChOffset+16+10]; s32Temp+=(SINT32)(SINT16)0x0041*(SINT32)s16X[ChOffset+64+6]; s32Temp2+=(SINT32)(SINT16)0x0041*(SINT32)s16X[ChOffset+10]; s32DCTY[6]=(SINT32)s32Temp; s32DCTY[10]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x003A*(SINT32)s16X[ChOffset+7]; s32Temp2=(SINT32)(SINT16)0x003A*(SINT32)s16X[ChOffset+64+9]; s32Temp+=(SINT32)(SINT16)0x01F6*(SINT32)s16X[ChOffset+16+7]; s32Temp2+=(SINT32)(SINT16)0x01F6*(SINT32)s16X[ChOffset+48+9]; s32Temp+=(SINT32)(SINT16)0x129C*(SINT32)s16X[ChOffset+32+7]; s32Temp2+=(SINT32)(SINT16)0x129C*(SINT32)s16X[ChOffset+32+9]; s32Temp+=(SINT32)(SINT16)0x0122*(SINT32)s16X[ChOffset+48+7]; s32Temp2+=(SINT32)(SINT16)0x0122*(SINT32)s16X[ChOffset+16+9]; s32Temp+=(SINT32)(SINT16)0x0045*(SINT32)s16X[ChOffset+64+7]; s32Temp2+=(SINT32)(SINT16)0x0045*(SINT32)s16X[ChOffset+9]; s32DCTY[7]=(SINT32)s32Temp; s32DCTY[9]=(SINT32)s32Temp2;}; { s32Temp=(SINT32)(SINT16)0x0042*(SINT32)(s16X[ChOffset+8]+s16X[ChOffset+64+8]); s32Temp+=(SINT32)(SINT16)0x01A8*(SINT32)(s16X[ChOffset+16+8]+s16X[ChOffset+48+8]); s32Temp+=(SINT32)(SINT16)0x12CF*(SINT32)s16X[ChOffset+32+8]; s32DCTY[8]=(SINT32)s32Temp;};}
        ...
        if (s32NumOfChannels == 1) {
            if (ShiftCounter >= EncMaxShiftCounter) {
                { ps32X=(SINT32 *)(s16X+EncMaxShiftCounter+78); for (i=0;i<9;i++) { *ps32X=*(ps32X-4-(ShiftCounter>>1)); ps32X--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); ps32X--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); ps32X--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); ps32X--; } };
                ShiftCounter = 0;
            } else {
                ShiftCounter += 8;
            }
            ...
            if (ShiftCounter >= EncMaxShiftCounter) {
                { ps32X=(SINT32 *)(s16X+EncMaxShiftCounter+78); ps32X2=(SINT32 *)(s16X+(EncMaxShiftCounter<<1)+158); for (i=0;i<9;i++) { *ps32X=*(ps32X-4-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-4-(ShiftCounter>>1)); ps32X--; ps32X2--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-4-(ShiftCounter>>1)); ps32X--; ps32X2--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-4-(ShiftCounter>>1)); ps32X--; ps32X2--; *ps32X=*(ps32X-4-(ShiftCounter>>1)); *(ps32X2)=*(ps32X2-4-(ShiftCounter>>1)); ps32X--; ps32X2--; } };
                ShiftCounter = 0;
            } else {
                ShiftCounter += 8;
            }
...
{
    memset(s16X, 0, ((8*10*2) + 64) * sizeof(SINT16));
    ShiftCounter = 0;
}
