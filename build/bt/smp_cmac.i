# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
{
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
}
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void padding ( BT_OCTET16 dest, UINT8 length )
{
    UINT8 i, *p = dest;

    for ( i = length ; i < 16; i++ ) {
        p[16 - i - 1] = ( i == length ) ? 0x80 : 0;
    }
}
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void leftshift_onebit(UINT8 *input, UINT8 *output)
{
    UINT8 i, overflow = 0 , next_overflow = 0;
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "leftshift_onebit " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
...
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_aes_cleanup(void)
{
    if (cmac_cb.text != 
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                       ((void *)0)
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                           ) {
        free((cmac_cb.text));
    }
    memset(&cmac_cb, 0, sizeof(tCMAC_CB));
}
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_aes_k_calculate(BT_OCTET16 key, UINT8 *p_signature, UINT16 tlen)
{
    ...
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_aes_k_calculate " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    while (i <= cmac_cb.round) {
        smp_xor_128(&cmac_cb.text[(cmac_cb.round - i)*16], x);

        if (!SMP_Encrypt(key, 16, &cmac_cb.text[(cmac_cb.round - i)*16], 16, &output)) {
            err = 1;
            break;
        }

        memcpy(x, output.param_buf, 16);
        i ++;
    }

    if (!err) {
        p_mac = output.param_buf + (16 - tlen);
        memcpy(p_signature, p_mac, tlen);

        {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "tlen = %d p_mac = %p" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", tlen, p_mac); };};
        {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "p_mac[0] = 0x%02x p_mac[1] = 0x%02x p_mac[2] = 0x%02x p_mac[3] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", *p_mac, *(p_mac + 1), *(p_mac + 2), *(p_mac + 3)); };}
                                                                         ;
        {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "p_mac[4] = 0x%02x p_mac[5] = 0x%02x p_mac[6] = 0x%02x p_mac[7] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", *(p_mac + 4), *(p_mac + 5), *(p_mac + 6), *(p_mac + 7)); };}
                                                                               ;

        return 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
              1
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;

    } else {
        return 
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
              0
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                   ;
    }
}
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_prepare_last_block (BT_OCTET16 k1, BT_OCTET16 k2)
{

    BOOLEAN flag;

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_prepare_last_block " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    flag = ((cmac_cb.len % 16) == 0 && cmac_cb.len != 0) ? 
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                       1 
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                                                                            : 
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                              0
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
    ...
    {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "flag = %d round = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", flag, cmac_cb.round); };};
...
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_subkey_cont(tSMP_ENC *p)
{
    UINT8 k1[16], k2[16];
    UINT8 *pp = p->param_buf;
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_subkey_cont " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
...
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_generate_subkey(BT_OCTET16 key)
{
    BT_OCTET16 z = {0};
    BOOLEAN ret = 
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                     1
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                         ;
    tSMP_ENC output;
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " " cmac_generate_subkey" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    if (SMP_Encrypt(key, 16, z, 16, &output)) {
        cmac_subkey_cont(&output);;
    } else {
        ret = 
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;
    }

    return ret;
}
# 280 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
BOOLEAN aes_cipher_msg_auth_code(BT_OCTET16 key, UINT8 *input, UINT16 length,
                                 UINT16 tlen, UINT8 *p_signature)
{
    UINT16 len, diff;
    UINT16 n = (length + 16 - 1) / 16;
    BOOLEAN ret = 
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                 0
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                      ;
    ...
    {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "AES128_CMAC started, allocate buffer size = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", len); };};

    if ((cmac_cb.text = (UINT8 *)malloc((len))) != 
# 296 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                    ((void *)0)
# 296 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                                                        ) {
        cmac_cb.round = n;
        ...
        if (input != 
# 302 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                    ((void *)0) 
# 302 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                         && length > 0) {
        ...
        ret = 
# 317 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 317 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "No resources" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
    }
