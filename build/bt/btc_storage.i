# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/include/btc/btc_storage.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/include/btc/btc_storage.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/include/btc/btc_storage.h" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/include/btc/btc_storage.h" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 2
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_add_bonded_device(bt_bdaddr_t *remote_bd_addr,
        LINK_KEY link_key,
        uint8_t key_type,
        uint8_t pin_length)
{
    ...
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "add to storage: Remote device:%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", bdstr); };};
    ...
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Storage add rslt %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", ret); };};
    return ret ? BT_STATUS_SUCCESS : BT_STATUS_FAIL;
}
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
static bt_status_t btc_in_fetch_bonded_devices(int add)
{
    BOOLEAN bt_linkkey_file_found = 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 3 4
                                   0
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
                                        ;
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end(); iter = btc_config_section_next(iter)) {
        ...
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Remote device:%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", name); };};
        LINK_KEY link_key;
...
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c" 3 4
                                       1
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
                                           ;
            } else {
                {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "bounded device:%s, LinkKeyType or PinLength is invalid\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", name); };};
            }
        }
        if (!bt_linkkey_file_found) {
            {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Remote device:%s, no link key\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", name); };};
        }
    }
    btc_config_unlock();
...
# 128 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_load_bonded_devices(void)
{
    bt_status_t status;
...
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_remove_bonded_device(bt_bdaddr_t *remote_bd_addr)
{
    bdstr_t bdstr;
    bdaddr_to_string(remote_bd_addr, bdstr, sizeof(bdstr));
...
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
int btc_storage_get_num_bt_bond_devices(void)
{
    int num_dev = 0;
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end();
        ...
        const char *name = btc_config_section_name(iter);
        if (string_is_bdaddr(name) &&
            btc_config_exist(name, "LinkKeyType") &&
            btc_config_exist(name, "PinLength") &&
            btc_config_exist(name, "LinkKey")) {
            num_dev++;
        }
    }
    btc_config_unlock();
...
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_get_bonded_bt_devices_list(bt_bdaddr_t *bond_dev, int dev_num)
{
    bt_bdaddr_t bd_addr;
