# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/include/osi/buffer.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/include/osi/buffer.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/include/osi/buffer.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 2
...
buffer_t *buffer_new(size_t size)
{
    ((size > 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 34, __func__, "size > 0"));

    buffer_t *buffer = malloc((sizeof(buffer_t) + size));
    if (!buffer) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_OSI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate buffer of %zu bytes." "\033[0m" "\n", esp_log_timestamp(), "BT_OSI", __func__, size); };};
        return 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
              ((void *)0)
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
                  ;
    }
...
{
    ((buf != 
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
   ((void *)0)
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 51, __func__, "buf != NULL"));
...
{
    ((buf != 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
   ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 57, __func__, "buf != NULL"));
    ((slice_size > 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 58, __func__, "slice_size > 0"));
    ((slice_size <= buf->length) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 59, __func__, "slice_size <= buf->length"));

    buffer_t *ret = calloc(1, (sizeof(buffer_t)));
    if (!ret) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_OSI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate new buffer for slice of length %zu." "\033[0m" "\n", esp_log_timestamp(), "BT_OSI", __func__, slice_size); };};
        return 
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
              ((void *)0)
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
                  ;
    }

    ret->root = buf->root;
    ret->refcount = 0xffffffffU;
...
{
    ((buf != 
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
   ((void *)0)
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 96, __func__, "buf != NULL"));
...
{
    ((buf != 
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c" 3 4
   ((void *)0)
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/buffer.c", 102, __func__, "buf != NULL"));
    return buf->length;
}
