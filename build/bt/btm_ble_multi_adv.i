# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 67 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_deq_op_q(UINT8 *p_opcode, UINT8 *p_inst_id, UINT8 *p_cb_evt)
{
    ...
    *p_opcode = (p_op_q->p_sub_code[p_op_q->pending_idx] & 0x0F);

    p_op_q->pending_idx = (p_op_q->pending_idx + 1) % BTM_BleMaxMultiAdvInstanceCount();
}
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_vsc_cmpl_cback (tBTM_VSC_CMPL *p_params)
{
    ...
    if (len < 2) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "wrong length for btm_ble_multi_adv_vsc_cmpl_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "op_code = %02x inst_id = %d cb_evt = %02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", opcode, inst_id, cb_evt); };};

    if (opcode != subcode || inst_id == 0) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "get unexpected VSC cmpl, expect: %d get: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", subcode, opcode); };};
        return;
    }
    ...
    switch (subcode) {
    case 0x05: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_ENB status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};


        if (0x00 != status && 1 == cb_evt) {
            btm_multi_adv_cb.p_adv_inst[inst_id - 1].in_use = 
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                             0
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                                  ;
        }
        break;
    }
    ...
    case 0x01: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_SET_PARAM status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x02: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_WRITE_ADV_DATA status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x03: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_WRITE_SCAN_RSP_DATA status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x04: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_SET_RANDOM_ADDR status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }
    ...
    if (cb_evt != 0 && p_inst->p_cback != 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             ) {
        (p_inst->p_cback)(cb_evt, inst_id, p_inst->p_ref, status);
    }
    return;
}
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS btm_ble_enable_multi_adv (BOOLEAN enable, UINT8 inst_id, UINT8 cb_evt)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_enable_multi_adv: enb %d, Inst ID %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", enb, inst_id); };};

    if ((rt = BTM_VendorSpecificCommand ((0x0154 | (0x3F << 10)),
                                         3,
                                         param,
                                         btm_ble_multi_adv_vsc_cmpl_cback))
            == BTM_CMD_STARTED) {
        btm_ble_multi_adv_enq_op_q(0x05, inst_id, cb_evt);
    }
    return rt;
}
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
int btm_ble_tx_power[4 + 1] = {-21, -15, -7, 1, 9};
char btm_ble_map_adv_tx_power(int tx_power_index)
{
    if (0 <= tx_power_index && tx_power_index < 4) {
        return (char)btm_ble_tx_power[tx_power_index];
    }
    return 0;
}
# 244 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
        ...
        UINT8 cb_evt)
{
    ...
    {*(pp)++ = (UINT8)(p_params->adv_int_min); *(pp)++ = (UINT8)((p_params->adv_int_min) >> 8);};
    {*(pp)++ = (UINT8)(p_params->adv_int_max); *(pp)++ = (UINT8)((p_params->adv_int_max) >> 8);};
    {*(pp)++ = (UINT8)(p_params->adv_type);};


    if (btm_cb.ble_ctr_cb.privacy_mode != 0) {
        {*(pp)++ = (UINT8)(0x01);};
        {register int ijk; for (ijk = 0; ijk < 6; ijk++) *(pp)++ = (UINT8) p_inst->rpa[6 - 1 - ijk];};
    } else

    {
        {*(pp)++ = (UINT8)(0x00);};
        {register int ijk; for (ijk = 0; ijk < 6; ijk++) *(pp)++ = (UINT8) controller_get_interface()->get_address()->address[6 - 1 - ijk];};
    }

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_multi_adv_set_params,Min %d, Max %d,adv_type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_params->adv_int_min, p_params->adv_int_max, p_params->adv_type); };}
                                                                                      ;

    {*(pp)++ = (UINT8)(0);};
    {register int ijk; for (ijk = 0; ijk < 6; ijk++) *(pp)++ = (UINT8) dummy[6 - 1 - ijk];};

    if (p_params->channel_map == 0 || p_params->channel_map > ((0x01 << 0)| (0x01 << 1)| (0x01 << 2))) {
        p_params->channel_map = ((0x01 << 0)| (0x01 << 1)| (0x01 << 2));
    }
    {*(pp)++ = (UINT8)(p_params->channel_map);};

    if (p_params->adv_filter_policy >= 0x04) {
        p_params->adv_filter_policy = 0x00;
    }
    {*(pp)++ = (UINT8)(p_params->adv_filter_policy);};

    {*(pp)++ = (UINT8)(p_inst->inst_id);};

    if (p_params->tx_power > 4) {
        p_params->tx_power = 4;
    }
    {*(pp)++ = (UINT8)(btm_ble_map_adv_tx_power(p_params->tx_power));};

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "set_params:Chnl Map %d,adv_fltr policy %d,ID:%d, TX Power%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_params->channel_map, p_params->adv_filter_policy, p_inst->inst_id, p_params->tx_power); };}
                                                                                                            ;
    ...
    if ((rt = BTM_VendorSpecificCommand ((0x0154 | (0x3F << 10)),
        ...
        if (btm_cb.ble_ctr_cb.privacy_mode != 0) {
            ...
            p_inst->raddr_timer_ent.param = (UINT32) p_inst;
            btu_start_timer_oneshot(&p_inst->raddr_timer_ent, 103,
                                    900);
        }

        btm_ble_multi_adv_enq_op_q(0x01, p_inst->inst_id, cb_evt);
    }
    return rt;
}
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS btm_ble_multi_adv_write_rpa (tBTM_BLE_MULTI_ADV_INST *p_inst, BD_ADDR random_addr)
{
    UINT8 param[8], *pp = param;
    tBTM_STATUS rt;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s-BD_ADDR:%02x-%02x-%02x-%02x-%02x-%02x,inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__, random_addr[5], random_addr[4], random_addr[3], random_addr[2], random_addr[1], random_addr[0], p_inst->inst_id); };}
    ...
    {*(pp)++ = (UINT8)(0x04);};
    {register int ijk; for (ijk = 0; ijk < 6; ijk++) *(pp)++ = (UINT8) random_addr[6 - 1 - ijk];};
    {*(pp)++ = (UINT8)(p_inst->inst_id);};
    ...
    if ((rt = BTM_VendorSpecificCommand ((0x0154 | (0x3F << 10)),
        ...
        btm_ble_multi_adv_enq_op_q(0x04, p_inst->inst_id, 0);
    }
    return rt;
}
# 370 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_gen_rpa_cmpl(tBTM_RAND_ENC *p)
{
    ...
    UINT8 index = 0;
    tBTM_BLE_MULTI_ADV_INST *p_inst = 
# 375 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 375 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;


    if (btm_multi_adv_idx_q.front == -1) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " " %s can't locate advertise instance" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
        return;
    } else {
        ...
        if (btm_multi_adv_idx_q.front == btm_multi_adv_idx_q.rear) {
            ...
            btm_multi_adv_idx_q.front = (btm_multi_adv_idx_q.front + 1) % 16;
        }
    }

    p_inst = &(btm_multi_adv_cb.p_adv_inst[index]);

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_gen_rpa_cmpl inst_id = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_inst->inst_id); };};
    if (p) {
        p->param_buf[2] &= (~0xc0);
        p->param_buf[2] |= 0x40;
        ...
        if (!SMP_Encrypt(btm_cb.devcb.id_keys.irk, 16, p->param_buf, 3, &output)) {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "generate random address failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        } else {
...
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_configure_rpa (tBTM_BLE_MULTI_ADV_INST *p_inst)
{
    if (btm_multi_adv_idx_q.front == (btm_multi_adv_idx_q.rear + 1) % 16) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "outstanding rand generation exceeded max allowed " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    } else {
        if (btm_multi_adv_idx_q.front == -1) {
            ...
            btm_multi_adv_idx_q.rear = (btm_multi_adv_idx_q.rear + 1) % 16;
        }
...
# 459 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_reenable(UINT8 inst_id)
{
    tBTM_BLE_MULTI_ADV_INST *p_inst = &btm_multi_adv_cb.p_adv_inst[inst_id - 1];

    if (
# 463 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
       1 
# 463 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
            == p_inst->in_use) {
        if (p_inst->adv_evt != 0x01) {
            btm_ble_enable_multi_adv (
# 465 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     1
# 465 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         , p_inst->inst_id, 0);
        } else

        {
            (p_inst->p_cback)(2, p_inst->inst_id, p_inst->p_ref, 0);
            p_inst->in_use = 
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                            0
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                 ;
        }
    }
}
# 486 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_enb_privacy(BOOLEAN enable)
{
    UINT8 i;
    ...
    for (i = 0; i < BTM_BleMaxMultiAdvInstanceCount() - 1; i ++, p_inst++) {
        p_inst->in_use = 
# 492 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                        0
# 492 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                             ;
        if (enable) {
...
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleEnableAdvInstance (tBTM_BLE_ADV_PARAMS *p_params,
                                      tBTM_BLE_MULTI_ADV_CBACK *p_cback, void *p_ref)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleEnableAdvInstance called" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (0 == btm_cb.cmn_ble_vsc_cb.adv_inst_max) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Controller does not support Multi ADV" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }

    if (
# 530 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
       ((void *)0) 
# 530 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
            == p_inst) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid instance in BTM_BleEnableAdvInstance" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }

    for (i = 0; i < BTM_BleMaxMultiAdvInstanceCount() - 1; i ++, p_inst++) {
        if (
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           0 
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                 == p_inst->in_use) {
            p_inst->in_use = 
# 537 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                            1
# 537 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                ;
            ...
            {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_enable_multi_adv being called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_inst->inst_id); };}
                                            ;

            if (BTM_CMD_STARTED == rt) {
                if ((rt = btm_ble_enable_multi_adv (
# 550 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                   1
# 550 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                       , p_inst->inst_id,
                                                    1)) == BTM_CMD_STARTED) {
            ...
            if (BTM_CMD_STARTED != rt) {
                p_inst->in_use = 
# 558 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                0
# 558 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                     ;
                {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_BleEnableAdvInstance failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            }
            break;
        }
    }
...
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleUpdateAdvInstParam (UINT8 inst_id, tBTM_BLE_ADV_PARAMS *p_params)
{
    tBTM_STATUS rt = BTM_ILLEGAL_VALUE;
    tBTM_BLE_MULTI_ADV_INST *p_inst = &btm_multi_adv_cb.p_adv_inst[inst_id - 1];

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleUpdateAdvInstParam called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
    ...
    if (inst_id < BTM_BleMaxMultiAdvInstanceCount() &&
            inst_id != 0 &&
            p_params != 
# 594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                       ((void *)0)
# 594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                           ) {
        if (
# 595 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           0 
# 595 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                 == p_inst->in_use) {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "adv instance %d is not active" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
            return BTM_WRONG_MODE;
        } else {
            btm_ble_enable_multi_adv(
# 599 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                    0
# 599 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         , inst_id, 0);
        }

        if (BTM_CMD_STARTED == btm_ble_multi_adv_set_params(p_inst, p_params, 0)) {
            rt = btm_ble_enable_multi_adv(
# 603 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         1
# 603 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             , inst_id, 3);
        }
    }
    return rt;
}
# 624 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleCfgAdvInstData (UINT8 inst_id, BOOLEAN is_scan_rsp,
                                   tBTM_BLE_AD_MASK data_mask,
                                   tBTM_BLE_ADV_DATA *p_data)
{
    UINT8 param[(31 + 3)], *pp = param;
    UINT8 sub_code = (is_scan_rsp) ?
                           0x03 : 0x02;
    UINT8 *p_len;
    tBTM_STATUS rt;
    UINT8 *pp_temp = (UINT8 *)(param + (31 + 3) - 1);
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleCfgAdvInstData called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
    if (inst_id > 16 || inst_id == 0) {
    ...
    *p_len = (UINT8)(pp - param - 2);
    ...
    if ((rt = BTM_VendorSpecificCommand ((0x0154 | (0x3F << 10)),
                                         ...
                                         btm_ble_multi_adv_vsc_cmpl_cback))
            == BTM_CMD_STARTED) {
        btm_ble_multi_adv_enq_op_q(sub_code, inst_id, 4);
    }
    return rt;
}
# 679 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleDisableAdvInstance (UINT8 inst_id)
{
    tBTM_STATUS rt = BTM_ILLEGAL_VALUE;
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleDisableAdvInstance with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
    ...
    if (inst_id < BTM_BleMaxMultiAdvInstanceCount() &&
            inst_id != 0) {
        if ((rt = btm_ble_enable_multi_adv(
# 695 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                          0
# 695 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                               , inst_id, 2))
                == BTM_CMD_STARTED) {
            ...
            btm_multi_adv_cb.p_adv_inst[inst_id - 1].in_use = 
# 699 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                             0
# 699 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                                  ;
        }
    }
    return rt;
}
# 713 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_vse_cback(UINT8 len, UINT8 *p)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_vse_cback called with event:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", sub_event); };};
    if ((sub_event == 0x55) && (len >= 4)) {
        {adv_inst = (UINT8)(*(p)); (p) += 1;};
        ++p;
        {conn_handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

        if ((idx = btm_handle_to_acl_index(conn_handle)) != 4) {

            if (btm_cb.ble_ctr_cb.privacy_mode != 0 &&
                    adv_inst <= 16 && adv_inst != 0) {
        ...
        if (adv_inst < BTM_BleMaxMultiAdvInstanceCount() &&
                adv_inst != 0) {
            {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_reenable called" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
...
# 765 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_init()
{
    ...
    if (btm_cb.cmn_ble_vsc_cb.adv_inst_max > 0) {
        btm_multi_adv_cb.p_adv_inst = malloc((sizeof(tBTM_BLE_MULTI_ADV_INST) * (btm_cb.cmn_ble_vsc_cb.adv_inst_max)))
                                                                           ;
        memset(btm_multi_adv_cb.p_adv_inst, 0, sizeof(tBTM_BLE_MULTI_ADV_INST) *
               (btm_cb.cmn_ble_vsc_cb.adv_inst_max));

        btm_multi_adv_cb.op_q.p_sub_code = malloc((sizeof(UINT8) * (btm_cb.cmn_ble_vsc_cb.adv_inst_max)))
                                                                                ;
        memset(btm_multi_adv_cb.op_q.p_sub_code, 0,
               sizeof(UINT8) * (btm_cb.cmn_ble_vsc_cb.adv_inst_max));

        btm_multi_adv_cb.op_q.p_inst_id = malloc((sizeof(UINT8) * (btm_cb.cmn_ble_vsc_cb.adv_inst_max)))
                                                                               ;
    ...
    BTM_RegisterForVSEvents(btm_ble_multi_adv_vse_cback, 
# 796 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                        1
# 796 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                            );
}
# 809 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_cleanup(void)
{
    if (btm_multi_adv_cb.p_adv_inst) {
        free((btm_multi_adv_cb.p_adv_inst));
        btm_multi_adv_cb.p_adv_inst = 
# 813 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 813 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;
    }

    if (btm_multi_adv_cb.op_q.p_sub_code) {
        free((btm_multi_adv_cb.op_q.p_sub_code));
        btm_multi_adv_cb.op_q.p_sub_code = 
# 818 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                          ((void *)0)
# 818 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                              ;
    }

    if (btm_multi_adv_cb.op_q.p_inst_id) {
        free((btm_multi_adv_cb.op_q.p_inst_id));
        btm_multi_adv_cb.op_q.p_inst_id = 
# 823 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         ((void *)0)
# 823 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             ;
    }

}
# 839 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
void *btm_ble_multi_adv_get_ref(UINT8 inst_id)
{
    tBTM_BLE_MULTI_ADV_INST *p_inst = 
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;

    if (inst_id < BTM_BleMaxMultiAdvInstanceCount()) {
        p_inst = &btm_multi_adv_cb.p_adv_inst[inst_id - 1];
        if (
# 845 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           ((void *)0) 
# 845 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
                != p_inst) {
            return p_inst->p_ref;
        }
    }
    ...
    return 
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
          ((void *)0)
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_multi_adv.c"
              ;
}
