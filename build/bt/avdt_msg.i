# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 2
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
...
const UINT8 avdt_msg_cmd_2_evt[] = {
    AVDT_CCB_MSG_DISCOVER_CMD_EVT + 0x80,
    AVDT_CCB_MSG_GETCAP_CMD_EVT + 0x80,
    AVDT_SCB_MSG_SETCONFIG_CMD_EVT,
    AVDT_SCB_MSG_GETCONFIG_CMD_EVT,
    AVDT_SCB_MSG_RECONFIG_CMD_EVT,
    AVDT_SCB_MSG_OPEN_CMD_EVT,
    AVDT_CCB_MSG_START_CMD_EVT + 0x80,
    AVDT_SCB_MSG_CLOSE_CMD_EVT,
    AVDT_CCB_MSG_SUSPEND_CMD_EVT + 0x80,
    AVDT_SCB_MSG_ABORT_CMD_EVT,
    AVDT_SCB_MSG_SECURITY_CMD_EVT,
    AVDT_CCB_MSG_GETCAP_CMD_EVT + 0x80,
    AVDT_SCB_MSG_DELAY_RPT_CMD_EVT
...
const UINT8 avdt_msg_rsp_2_evt[] = {
    AVDT_CCB_MSG_DISCOVER_RSP_EVT + 0x80,
    AVDT_CCB_MSG_GETCAP_RSP_EVT + 0x80,
    AVDT_SCB_MSG_SETCONFIG_RSP_EVT,
    AVDT_SCB_MSG_GETCONFIG_RSP_EVT,
    AVDT_SCB_MSG_RECONFIG_RSP_EVT,
    AVDT_SCB_MSG_OPEN_RSP_EVT,
    AVDT_CCB_MSG_START_RSP_EVT + 0x80,
    AVDT_SCB_MSG_CLOSE_RSP_EVT,
    AVDT_CCB_MSG_SUSPEND_RSP_EVT + 0x80,
    AVDT_SCB_MSG_ABORT_RSP_EVT,
    AVDT_SCB_MSG_SECURITY_RSP_EVT,
    AVDT_CCB_MSG_GETCAP_RSP_EVT + 0x80,
    AVDT_SCB_MSG_DELAY_RPT_RSP_EVT
...
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_cfg(UINT8 **p, tAVDT_CFG *p_cfg)
{
    ...
    if (p_cfg->psc_mask & (1<<6)) {
        *(*p)++ = 6;

        if (p_cfg->psc_mask & (1<<3)) {
            *(*p)++ = 7;
        } else if (p_cfg->psc_mask & (1<<2)) {
            *(*p)++ = 5;
        } else {
            *(*p)++ = 3;
        }
        ...
        *(*p)++ = p_cfg->mux_tsid_media << 3;
        *(*p)++ = p_cfg->mux_tcid_media << 3;

        if (p_cfg->psc_mask & (1<<3)) {

            *(*p)++ = p_cfg->mux_tsid_report << 3;
            *(*p)++ = p_cfg->mux_tcid_report << 3;

            *(*p)++ = p_cfg->mux_tsid_recov << 3;
            *(*p)++ = p_cfg->mux_tcid_recov << 3;
        } else if (p_cfg->psc_mask & (1<<2)) {
    ...
    if (p_cfg->psc_mask & (1<<8)) {
        *(*p)++ = 8;
        *(*p)++ = 0;
    }
}
# 371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_none(UINT8 **p, tAVDT_MSG *p_msg)
{
    (void)(p);
    (void)(p_msg);
...
# 389 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_single(UINT8 **p, tAVDT_MSG *p_msg)
{
    *(*p)++ = (UINT8) ((p_msg->single.seid) << 2);;
}
# 405 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_setconfig_cmd(UINT8 **p, tAVDT_MSG *p_msg)
{
    *(*p)++ = (UINT8) ((p_msg->config_cmd.hdr.seid) << 2);;
    *(*p)++ = (UINT8) ((p_msg->config_cmd.int_seid) << 2);;
    avdt_msg_bld_cfg(p, p_msg->config_cmd.p_cfg);
}
# 423 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_reconfig_cmd(UINT8 **p, tAVDT_MSG *p_msg)
{
    *(*p)++ = (UINT8) ((p_msg->reconfig_cmd.hdr.seid) << 2);;


    p_msg->reconfig_cmd.p_cfg->psc_mask = 0;
    avdt_msg_bld_cfg(p, p_msg->reconfig_cmd.p_cfg);
}
# 443 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_multi(UINT8 **p, tAVDT_MSG *p_msg)
{
    int i;

    for (i = 0; i < p_msg->multi.num_seps; i++) {
        *(*p)++ = (UINT8) ((p_msg->multi.seid_list[i]) << 2);;
    }
}
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_security_cmd(UINT8 **p, tAVDT_MSG *p_msg)
{
    *(*p)++ = (UINT8) ((p_msg->security_cmd.hdr.seid) << 2);;
    memcpy(*p, p_msg->security_cmd.p_data, p_msg->security_cmd.len);
    *p += p_msg->security_cmd.len;
}
# 479 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_delay_rpt(UINT8 **p, tAVDT_MSG *p_msg)
{
    *(*p)++ = (UINT8) ((p_msg->delay_rpt_cmd.hdr.seid) << 2);;
    {*(*p)++ = (UINT8)((p_msg->delay_rpt_cmd.delay) >> 8); *(*p)++ = (UINT8)(p_msg->delay_rpt_cmd.delay);};
}
# 496 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_discover_rsp(UINT8 **p, tAVDT_MSG *p_msg)
{
    int i;
    ...
    for (i = 0; i < p_msg->discover_rsp.num_seps; i++) {
        ...
        *(*p)++ = (UINT8) (((p_msg->discover_rsp.p_sep_info[i].seid) << 2) | ((p_msg->discover_rsp.p_sep_info[i].in_use) << 1)); *(*p)++ = (UINT8) (((p_msg->discover_rsp.p_sep_info[i].media_type) << 4) | ((p_msg->discover_rsp.p_sep_info[i].tsep) << 3));


                                                                 ;
    }
}
# 520 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_svccap(UINT8 **p, tAVDT_MSG *p_msg)
{
    tAVDT_CFG cfg;
...
# 541 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_all_svccap(UINT8 **p, tAVDT_MSG *p_msg)
{
    avdt_msg_bld_cfg(p, p_msg->svccap.p_cfg);
}
# 557 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static void avdt_msg_bld_security_rsp(UINT8 **p, tAVDT_MSG *p_msg)
{
    memcpy(*p, p_msg->security_rsp.p_data, p_msg->security_rsp.len);
    *p += p_msg->security_rsp.len;
}
# 575 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_cfg(tAVDT_CFG *p_cfg, UINT8 *p, UINT16 len, UINT8 *p_elem, UINT8 sig_id)
{
    ...
    if (!p_cfg) {
        {if (avdt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVDT", "\033[0;" "31" "m" "E" " (%d) %s: " "not expecting this cfg" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        return 0x31;
    }
    ...
    while ((p < p_end) && (err == 0)) {
        ...
        if ((elem == 0) || (elem > 8)) {
            ...
            if ((sig_id == 3) || (sig_id == 5)) {
                ...
                p += elem_len;
                {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "skipping unknown service category=%d len: %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", elem, elem_len); };};
                continue;
            }
        }
        ...
        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "elem=%d elem_len: %d psc_mask=0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", elem, elem_len, p_cfg->psc_mask); };};
        ...
        case 3:
            ...
            p_cfg->recov_mrws = *p++;
            p_cfg->recov_mnmp = *p++;
            if (p_cfg->recov_type != 1) {
                err = 0x22;
            } else if ((p_cfg->recov_mrws < 0x01) ||
                       (p_cfg->recov_mrws > 0x18) ||
                       (p_cfg->recov_mnmp < 0x01) ||
                       (p_cfg->recov_mnmp > 0x18)) {
                err = 0x25;
            }
            break;
        ...
        case 6:
            ...
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "psc_mask=0x%x elem_len=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_cfg->psc_mask, elem_len); };};
            if ( ((0 == (p_cfg->psc_mask & ((1<<3) | (1<<2)))) && (elem_len != 3))
                    || (((p_cfg->psc_mask & (1<<2)) && !(p_cfg->psc_mask & (1<<3)))
                        && (elem_len != 5))
                    || ((!(p_cfg->psc_mask & (1<<2)) && (p_cfg->psc_mask & (1<<3)))
                        && (elem_len != 5))
                    || (((p_cfg->psc_mask & (1<<2)) && (p_cfg->psc_mask & (1<<3)))
    ...
    *p_elem = elem;
    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "err=0x%x, elem:0x%x psc_mask=0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", err, elem, p_cfg->psc_mask); };};

    return err;
}
# 764 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_none(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    (void)(p_msg);
    (void)(p);
...
# 783 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_single(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = 0;
    ...
    if (len != 1) {
        ...
        p_msg->single.seid = *(p)++ >> 2;;

        if (avdt_scb_by_hdl(p_msg->single.seid) == 
# 793 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                  ((void *)0)
# 793 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                      ) {
            err = 0x12;
        }
    }
...
# 811 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_setconfig_cmd(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = 0;
    ...
    if (len < 2) {
        ...
        p_msg->config_cmd.hdr.seid = *(p)++ >> 2;;
        if (avdt_scb_by_hdl(p_msg->config_cmd.hdr.seid) == 
# 823 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                          ((void *)0)
# 823 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                              ) {
            err = 0x12;
        }

        p_msg->config_cmd.int_seid = *(p)++ >> 2;;
        if ((p_msg->config_cmd.int_seid < 0x01) ||
                (p_msg->config_cmd.int_seid > 0x3E)) {
            err = 0x12;
        }
    }
    ...
    if (!err) {
        ...
        len -= 2;
        err = avdt_msg_prs_cfg(p_msg->config_cmd.p_cfg, p, len, &p_msg->hdr.err_param, 3);

        if (!err) {

            if (((p_msg->config_cmd.p_cfg->psc_mask & (~((1<<1) | (1<<6) | (1<<2) | (1<<8)))) != 0) ||
...
# 862 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_reconfig_cmd(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = 0;
    ...
    if (len < 1) {
        ...
        p_msg->reconfig_cmd.hdr.seid = *(p)++ >> 2;;
        if (avdt_scb_by_hdl(p_msg->reconfig_cmd.hdr.seid) == 
# 874 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                            ((void *)0)
# 874 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                ) {
            err = 0x12;
        } else {

            len--;
            err = avdt_msg_prs_cfg(p_msg->config_cmd.p_cfg, p, len, &p_msg->hdr.err_param, 5);


            if (!err) {
                {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_msg_prs_reconfig_cmd psc_mask=0x%x/0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_msg->config_cmd.p_cfg->psc_mask, ((1<<1) | (1<<2) | (1<<8) | (1<<3) | (1<<5) | (1<<6))); };};
...
# 905 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_multi(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    int i;
    UINT8 err = 0;
    ...
    if (len < 1 || (len > 3)) {
        ...
        for (i = 0; i < len; i++) {
            p_msg->multi.seid_list[i] = *(p)++ >> 2;;
            if (avdt_scb_by_hdl(p_msg->multi.seid_list[i]) == 
# 919 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                             ((void *)0)
# 919 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                 ) {
                err = 0x12;
...
# 942 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_security_cmd(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = 0;
    ...
    if (len < 1) {
        ...
        p_msg->security_cmd.hdr.seid = *(p)++ >> 2;;
        if (avdt_scb_by_hdl(p_msg->security_cmd.hdr.seid) == 
# 952 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                            ((void *)0)
# 952 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                ) {
            err = 0x12;
        } else {
...
# 973 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_discover_rsp(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    int i;
    UINT8 err = 0;
    ...
    for (i = 0; i < p_msg->discover_rsp.num_seps; i++) {
        ...
        p_msg->discover_rsp.p_sep_info[i].seid = *(p) >> 2; p_msg->discover_rsp.p_sep_info[i].in_use = (*(p)++ >> 1) & 0x01; p_msg->discover_rsp.p_sep_info[i].media_type = *(p) >> 4; p_msg->discover_rsp.p_sep_info[i].tsep = (*(p)++ >> 3) & 0x01;


                                                                 ;


        if ((p_msg->discover_rsp.p_sep_info[i].seid < 0x01) ||
                (p_msg->discover_rsp.p_sep_info[i].seid > 0x3E)) {
            err = 0x12;
            break;
        }
    }
...
# 1015 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_svccap(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{

    UINT8 err = avdt_msg_prs_cfg(p_msg->svccap.p_cfg, p, len, &p_msg->hdr.err_param, 2);
    if (p_msg->svccap.p_cfg) {
        p_msg->svccap.p_cfg->psc_mask &= ((1<<1) | (1<<6) | (1<<2));
    }

    return (err);
}
# 1037 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_all_svccap(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = avdt_msg_prs_cfg(p_msg->svccap.p_cfg, p, len, &p_msg->hdr.err_param, 12);
    if (p_msg->svccap.p_cfg) {
        p_msg->svccap.p_cfg->psc_mask &= ((1<<1) | (1<<2) | (1<<8) | (1<<3) | (1<<5) | (1<<6));
    }
    return (err);
}
# 1057 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_security_rsp(tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
...
# 1075 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
...
# 1101 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
static UINT8 avdt_msg_prs_delay_rpt (tAVDT_MSG *p_msg, UINT8 *p, UINT16 len)
{
    UINT8 err = 0;
    ...
    if (len != 3) {
        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "avdt_msg_prs_delay_rpt expected len: %u  got: %u\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", 3, len); };};
        err = 0x11;
    } else {

        p_msg->delay_rpt_cmd.hdr.seid = *(p)++ >> 2;;

        if (avdt_scb_by_hdl(p_msg->delay_rpt_cmd.hdr.seid) == 
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                             ((void *)0)
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                 ) {
            err = 0x12;
        } else {
            {p_msg->delay_rpt_cmd.delay = (UINT16)(((UINT16)(*(p)) << 8) + (UINT16)(*((p) + 1))); (p) += 2;};
            {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_msg_prs_delay_rpt delay: %u\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_msg->delay_rpt_cmd.delay); };};
        }
    }
    return err;
}
# 1134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
BOOLEAN avdt_msg_send(tAVDT_CCB *p_ccb, BT_HDR *p_msg)
{
    ...
    p_tbl = avdt_ad_tc_tbl_by_type(AVDT_CHAN_SIG, p_ccb, 
# 1148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                        ((void *)0)
# 1148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                            );


    if (p_msg != 
# 1151 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1151 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
    ...
    while ((!p_ccb->cong) && (p_ccb->p_curr_msg != 
# 1159 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                  ((void *)0)
# 1159 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                      )) {
        ...
        if ((p_ccb->p_curr_msg->offset == (13 + 3 + 3)) &&
                (p_ccb->p_curr_msg->len <= p_tbl->peer_mtu - 2)) {
            pkt_type = 0;
            hdr_len = 2;
            p_buf = p_ccb->p_curr_msg;
        }

        else if ((p_ccb->p_curr_msg->offset == (13 + 3 + 3)) &&
                 (p_ccb->p_curr_msg->len > p_tbl->peer_mtu - 2)) {
            pkt_type = 1;
            hdr_len = 3;
            nosp = (p_ccb->p_curr_msg->len + 3 - p_tbl->peer_mtu) /
                   (p_tbl->peer_mtu - 1) + 2;


            if ((p_buf = (BT_HDR *) malloc((660))) == 
# 1180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                                     ((void *)0)
# 1180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                         ) {


                return 
# 1183 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                      1
# 1183 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                          ;
            }


            p_buf->offset = 13 + hdr_len;
            ...
            memcpy((UINT8 *)(p_buf + 1) + p_buf->offset,
                 ...
                 (p_ccb->p_curr_msg->len > (p_tbl->peer_mtu - 1))) {
            pkt_type = 2;
            hdr_len = 1;


            if ((p_buf = (BT_HDR *) malloc((660))) == 
# 1199 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                                     ((void *)0)
# 1199 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                         ) {


                return 
# 1202 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                      1
# 1202 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                          ;
            }
        ...
        label = ((UINT8)((p_ccb->p_curr_msg->layer_specific) >> 4));
        msg = ((UINT8)((p_ccb->p_curr_msg->layer_specific) & 0x000F));
        sig = (UINT8) p_ccb->p_curr_msg->event;
        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_msg_send label:%d, msg:%d, sig:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", label, msg, sig); };};
        ...
        if (curr_msg_len == 0) {
            ...
            p_ccb->p_curr_msg = 
# 1228 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                               ((void *)0)
# 1228 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                   ;
            ...
            if (msg == 0) {
                ...
                if ((sig == 1) || (sig == 2) ||
                        (sig == 11) || (avdt_cb.rcb.ret_tout == 0)) {
                    btu_start_timer(&p_ccb->timer_entry, 62, avdt_cb.rcb.sig_tout);
                } else if (sig != 13) {
                    btu_start_timer(&p_ccb->timer_entry, 61, avdt_cb.rcb.ret_tout);
                }
            }
        } else {
        ...
        *(p)++ = (UINT8) ((label) << 4) | ((pkt_type) << 2) | (msg);;
        if (pkt_type == 1) {
            *(p)++ = (UINT8) (nosp);;
        }
        if ((pkt_type == 1) || (pkt_type == 0)) {
            *(p)++ = (UINT8) (sig);;
        }


        avdt_ad_write_req(AVDT_CHAN_SIG, p_ccb, 
# 1261 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                               ((void *)0)
# 1261 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                   , p_buf);
    }
    return (p_ccb->cong);
}
# 1277 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
BT_HDR *avdt_msg_asmbl(tAVDT_CCB *p_ccb, BT_HDR *p_buf)
{
    ...
    if (p_buf->len < avdt_msg_pkt_type_len[pkt_type]) {
        free((p_buf));
        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Bad length during reassembly" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        p_ret = 
# 1292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
               ((void *)0)
# 1292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                   ;
    }
        ...
        if (p_ccb->p_rx_msg != 
# 1297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                              ((void *)0)
# 1297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                  ) {
            free((p_ccb->p_rx_msg));
            p_ccb->p_rx_msg = 
# 1299 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                             ((void *)0)
# 1299 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                 ;
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Got single during reassembly" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        }
        p_ret = p_buf;
    }
        ...
        if (p_ccb->p_rx_msg != 
# 1307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                              ((void *)0)
# 1307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                  ) {
      free((p_ccb->p_rx_msg));
      p_ccb->p_rx_msg = 
# 1309 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                       ((void *)0)
# 1309 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                           ;
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Got start during reassembly" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        }
        ...
        p_ccb->p_rx_msg = (BT_HDR *)malloc(((4096 + 16)));
        ...
        *(p + 1) = *p;
        ...
        p_ret = 
# 1336 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
               ((void *)0)
# 1336 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                   ;
    }
        ...
        if (p_ccb->p_rx_msg == 
# 1341 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                              ((void *)0)
# 1341 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                  ) {
            free((p_buf));
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Pkt type=%d out of order\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", pkt_type); };};
            p_ret = 
# 1344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                   ((void *)0)
# 1344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                       ;
        } else {

            buf_len = (4096 + 16) - sizeof(BT_HDR);
            ...
            if ((p_ccb->p_rx_msg->offset + p_buf->len) > buf_len) {
                ...
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Fragmented message too big!" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", __func__); };};
                free((p_ccb->p_rx_msg));
                p_ccb->p_rx_msg = 
# 1358 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                 ((void *)0)
# 1358 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                     ;
                free((p_buf));
                p_ret = 
# 1360 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                       ((void *)0)
# 1360 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                           ;
            } else {
                ...
                if (pkt_type == 3) {
                    ...
                    p_ccb->p_rx_msg = 
# 1370 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                     ((void *)0)
# 1370 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                         ;
                } else {
                    p_ccb->p_rx_msg->offset += p_buf->len;
                    p_ccb->p_rx_msg->len += p_buf->len;
                    p_ret = 
# 1374 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                           ((void *)0)
# 1374 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                               ;
                }
                free((p_buf));
            }
...
# 1398 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
void avdt_msg_send_cmd(tAVDT_CCB *p_ccb, void *p_scb, UINT8 sig_id, tAVDT_MSG *p_params)
{
    ...
    p_buf = (BT_HDR *) malloc((660));
    if (p_buf == 
# 1406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
        {if (avdt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVDT", "\033[0;" "31" "m" "E" " (%d) %s: " "avdt_msg_send_cmd out of buffer!!" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        return;
    }
    ...
    if (p_scb != 
# 1422 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1422 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
        p = (UINT8 *)(p_buf + 1);


        if ((sig_id == 7) || (sig_id == 9)) {
    ...
    p_buf->event = sig_id;
    p_buf->layer_specific = (((p_ccb->label) << 4) | (0));
    ...
    avdt_ccb_event(p_ccb, AVDT_CCB_SENDMSG_EVT, 
# 1444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                               ((void *)0)
# 1444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                   );
}
# 1463 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
void avdt_msg_send_rsp(tAVDT_CCB *p_ccb, UINT8 sig_id, tAVDT_MSG *p_params)
{
    ...
    p_buf = (BT_HDR *) malloc((660));
    if (p_buf == 
# 1471 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1471 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
        return;
    }
    ...
    p_buf->event = sig_id;
    p_buf->layer_specific = (((p_params->hdr.label) << 4) | (2));


    fixed_queue_enqueue(p_ccb->rsp_q, p_buf);
    avdt_ccb_event(p_ccb, AVDT_CCB_SENDMSG_EVT, 
# 1491 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                               ((void *)0)
# 1491 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                   );
}
# 1510 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
void avdt_msg_send_rej(tAVDT_CCB *p_ccb, UINT8 sig_id, tAVDT_MSG *p_params)
{
    ...
    p_buf = (BT_HDR *) malloc((660));
    if (p_buf == 
# 1518 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1518 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
        return;
    }
    ...
    if (sig_id != 0) {
        ...
        if ((sig_id == 3) ||
                (sig_id == 5)) {
            *(p)++ = (UINT8) (p_params->hdr.err_param);;
        } else if ((sig_id == 7) ||
                   (sig_id == 9)) {
            *(p)++ = (UINT8) ((p_params->hdr.err_param) << 2);;
        }


        *(p)++ = (UINT8) (p_params->hdr.err_code);;
    }
    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_msg_send_rej" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
    ...
    p_buf->event = sig_id;
    p_buf->layer_specific = (((p_params->hdr.label) << 4) | (3));


    fixed_queue_enqueue(p_ccb->rsp_q, p_buf);
    avdt_ccb_event(p_ccb, AVDT_CCB_SENDMSG_EVT, 
# 1551 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                               ((void *)0)
# 1551 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                   );
}
# 1569 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
void avdt_msg_send_grej(tAVDT_CCB *p_ccb, UINT8 sig_id, tAVDT_MSG *p_params)
{
    ...
    p_buf = (BT_HDR *) malloc((660));
    if (p_buf == 
# 1577 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                ((void *)0)
# 1577 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                    ) {
        return;
    }
    ...
    p_buf->event = 0;
    p_buf->layer_specific = (((p_params->hdr.label) << 4) | (0));
    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_msg_send_grej" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};


    fixed_queue_enqueue(p_ccb->rsp_q, p_buf);
    avdt_ccb_event(p_ccb, AVDT_CCB_SENDMSG_EVT, 
# 1595 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                               ((void *)0)
# 1595 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                   );
}
# 1611 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
void avdt_msg_ind(tAVDT_CCB *p_ccb, BT_HDR *p_buf)
{
    tAVDT_SCB *p_scb;
    UINT8 *p;
    BOOLEAN ok = 
# 1615 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                    1
# 1615 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                        ;
    BOOLEAN handle_rsp = 
# 1616 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                            0
# 1616 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                 ;
    BOOLEAN gen_rej = 
# 1617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                         0
# 1617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                              ;
    UINT8 label;
    UINT8 pkt_type;
    UINT8 msg_type;
    ...
    if ((p_buf = avdt_msg_asmbl(p_ccb, p_buf)) == 
# 1629 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                 ((void *)0)
# 1629 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                     ) {
        return;
    }
    ...
    label = *(p) >> 4; pkt_type = (*(p) >> 2) & 0x03; msg_type = *(p)++ & 0x03;;

    (void)(pkt_type);

    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "msg_type=%d, sig=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", msg_type, sig); };};
    ...
    if (msg_type == 1) {
        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Dropping msg msg_type=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", msg_type); };};
        ok = 
# 1648 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
            0
# 1648 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                 ;
    }

    else if ((msg_type == 3) && (p_buf->len == 2)) {
        gen_rej = 
# 1652 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                 1
# 1652 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                     ;
        if (p_ccb->p_curr_cmd != 
# 1653 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                ((void *)0)
# 1653 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                    ) {
            msg.hdr.sig_id = sig = (UINT8) p_ccb->p_curr_cmd->event;
            evt = avdt_msg_rej_2_evt[sig - 1];
            msg.hdr.err_code = 0x19;
            msg.hdr.err_param = 0;
        }
    } else {
        ...
        msg.hdr.sig_id = sig;
        if ((sig == 0) || (sig > 13)) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Dropping msg sig=%d msg_type:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", sig, msg_type); };};
            ok = 
# 1665 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                0
# 1665 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                     ;
    ...
    if (ok && !gen_rej) {
        ...
        } else if ((msg_type == 2) && (sig == 4)) {

            msg.svccap.p_cfg = &cfg;
        } else if ((msg_type == 0) && (sig == 3)) {

            msg.config_cmd.p_cfg = &cfg;
        } else if ((msg_type == 0) && (sig == 5)) {
        ...
        if (err != 0) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Parsing failed sig=%d err=0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", sig, err); };};




            ok = 
# 1717 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                0
# 1717 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                     ;
            if ((msg_type == 0) && (sig != 10)) {
    ...
    if (ok) {
        if ((msg_type == 2) || (msg_type == 3)) {
            if ((p_ccb->p_curr_cmd != 
# 1730 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                     ((void *)0)
# 1730 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                         ) &&
                    (p_ccb->p_curr_cmd->event == sig) &&
                    (((UINT8)((p_ccb->p_curr_cmd->layer_specific) >> 4)) == label)) {
                ...
                handle_rsp = 
# 1740 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                            1
# 1740 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                ;
            } else {
                ok = 
# 1742 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                    0
# 1742 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                         ;
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Cmd not found for rsp sig=%d label=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", sig, label); };};
            }
        }
    }
    ...
    if (ok) {
        ...
        if (evt & 0x80) {
            avdt_ccb_event(p_ccb, (UINT8)(evt & ~0x80), (tAVDT_CCB_EVT *) &msg);
        }
            ...
            if (evt && (p_scb = avdt_scb_by_hdl(scb_hdl)) != 
# 1767 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                            ((void *)0)
# 1767 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                                ) {
    ...
    if (handle_rsp) {
        avdt_ccb_event(p_ccb, AVDT_CCB_RCVRSP_EVT, 
# 1780 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c" 3 4
                                                  ((void *)0)
# 1780 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_msg.c"
                                                      );
    }
}
