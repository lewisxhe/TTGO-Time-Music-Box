# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 2
...
static void bta_dm_pm_stop_timer_by_index(tBTA_PM_TIMER *p_timer,
        UINT8 timer_idx);
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
void bta_dm_init_pm(void)
{
    ...
    if (p_bta_dm_pm_cfg[0].app_id != 0) {
        ...
        BTM_PmRegister((1 | 2), &bta_dm_cb.pm_id,
                       bta_dm_pm_btm_cback);
    }
    ...
    for (int i = 0; i < 7; i++) {
        for (int j = 0; j < 3; j++) {
            bta_dm_cb.pm_timer[i].srvc_id[j] = (44 + 2);
        }
    }
}
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
void bta_dm_disable_pm(void)
{
    BTM_PmRegister( 4, &bta_dm_cb.pm_id, 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                                   ((void *)0)
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                       );
    ...
    bta_sys_pm_register((tBTA_SYS_CONN_CBACK *)
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                              ((void *)0)
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                  );
    ...
    for (int i = 0; i < 7; i++) {
        for (int j = 0; j < 3; j++) {
            ...
            bta_dm_cb.pm_timer[i].pm_action[j] = 0x00;
        }
    }
}
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_stop_timer(BD_ADDR peer_addr)
{
    ...
    for (int i = 0; i < 7; i++) {
        if (bta_dm_cb.pm_timer[i].in_use && !bdcmp(bta_dm_cb.pm_timer[i].peer_bdaddr, peer_addr)) {
            for (int j = 0; j < 3; j++) {
                bta_dm_pm_stop_timer_by_index(&bta_dm_cb.pm_timer[i], j);
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
            }
            break;
        }
    }
}
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static UINT8 bta_pm_action_to_timer_idx(UINT8 pm_action)
{
    if (pm_action == 0x04) {
        return 2;
    } else if (pm_action == 0x10) {
        return 1;
    } else if ((pm_action & 0x20) == 0x20) {
        return 0;
    }
...
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_stop_timer_by_mode(BD_ADDR peer_addr, UINT8 power_mode)
{
    ...
    for (int i = 0; i < 7; i++) {
        if (bta_dm_cb.pm_timer[i].in_use && !bdcmp(bta_dm_cb.pm_timer[i].peer_bdaddr, peer_addr)) {
            if (bta_dm_cb.pm_timer[i].srvc_id[timer_idx] != (44 + 2)) {
...
# 222 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
...
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_start_timer(tBTA_PM_TIMER *p_timer, UINT8 timer_idx,
                                  INT32 timeout, UINT8 srvc_id, UINT8 pm_action)
{
    p_timer->in_use = 
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                     1
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                         ;
    p_timer->timer[timer_idx].p_cback = bta_dm_pm_timer_cback;

    if (p_timer->srvc_id[timer_idx] == (44 + 2)) {
        p_timer->active++;
    }
...
# 276 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_stop_timer_by_index(tBTA_PM_TIMER *p_timer,
        UINT8 timer_idx)
{
    if ((p_timer == 
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                   ((void *)0)
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                       ) || (timer_idx >= 3)) {
        return;
    }
    ...
    ((p_timer->in_use && (p_timer->active > 0)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c", 287, __func__, "p_timer->in_use && (p_timer->active > 0)"));

    bta_sys_stop_timer(&p_timer->timer[timer_idx]);
    p_timer->srvc_id[timer_idx] = (44 + 2);


    p_timer->active--;
    if (p_timer->active == 0) {
        p_timer->in_use = 
# 295 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                         0
# 295 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                              ;
    }
}
...
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_cback(tBTA_SYS_CONN_STATUS status, UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    ...
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_cback: st(%d), id(%d), app(%d)" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", status, id, app_id); };};
    ...
    for (i = 1; i <= p_bta_dm_pm_cfg[0].app_id; i++) {
        ...
        if ((p_bta_dm_pm_cfg[i].id == id)
                && ((p_bta_dm_pm_cfg[i].app_id == 0xFF ) || (p_bta_dm_pm_cfg[i].app_id == app_id ))) {
            break;
        }
...
# 355 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
    if (p_bta_dm_pm_spec[p_bta_dm_pm_cfg[i].spec_idx].actn_tbl[status][0].power_mode == 0x00) {
    ...
    for (j = 0; j < bta_dm_conn_srvcs.count ; j++) {
        ...
        if ((bta_dm_conn_srvcs.conn_srvc[j].id == id)
            ...
            bta_dm_conn_srvcs.conn_srvc[j].new_request = 
# 367 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                                        1
# 367 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                            ;
            break;
        }
    ...
    if (p_bta_dm_pm_spec[p_bta_dm_pm_cfg[i].spec_idx].actn_tbl[status][0].power_mode == 0x01) {
        if (j != bta_dm_conn_srvcs.count) {
            ...
            {if (appl_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_APPL", "\033[0;" "33" "m" "W" " (%d) %s: " "bta_dm_act no entry for connected service cbs" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
            return;
        }
    } else if (j == bta_dm_conn_srvcs.count ) {

        if (bta_dm_conn_srvcs.count == 10) {
            {if (appl_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_APPL", "\033[0;" "33" "m" "W" " (%d) %s: " "bta_dm_act no more connected service cbs" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
            return;
        }
        ...
        bta_dm_conn_srvcs.conn_srvc[j].app_id = app_id;
        bta_dm_conn_srvcs.conn_srvc[j].new_request = 
# 398 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                                    1
# 398 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                        ;
        bdcpy(bta_dm_conn_srvcs.conn_srvc[j].peer_bdaddr, peer_addr);

        {if (appl_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_APPL", "\033[0;" "33" "m" "W" " (%d) %s: " "new conn_srvc id:%d, app_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", id, app_id); };};
...
# 440 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
    bta_dm_pm_set_mode(peer_addr, 0x00, 2);
    ...
    if ( BTM_IsDeviceUp() &&
            ( ((status == 0x04) || (status == 0x05)) ||
              ((status == 0x00) && (id == 23) && bta_dm_pm_is_sco_active()) ) ) {
        BOOLEAN bScoActive;
        if (status == 0x00) {
            bScoActive = 
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                        1
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                            ;
        } else {
            bScoActive = (status == 0x04);
        }
...
# 473 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_set_mode(BD_ADDR peer_addr, tBTA_DM_PM_ACTION pm_request,
                               tBTA_DM_PM_REQ pm_req )
{

    tBTA_DM_PM_ACTION pm_action = 0x00;
    UINT16 timeout = 0;
    UINT8 i, j;
    tBTA_DM_PM_ACTION failed_pm = 0;
    tBTA_DM_PEER_DEVICE *p_peer_device = 
# 481 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                        ((void *)0)
# 481 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                            ;
...
# 487 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                  ((void *)0)
# 487 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                      ;
    BOOLEAN timer_started = 
# 488 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                           0
# 488 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                ;
    UINT8 timer_idx, available_timer = 3;
    ...
    if (p_peer_device == 
# 499 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                        ((void *)0)
# 499 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                            ) {
        return;
    }
    ...
    for (i = 0; i < bta_dm_conn_srvcs.count ; i++) {
        ...
        if (!bdcmp(p_srvcs->peer_bdaddr, peer_addr)) {
            ...
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_set_mode: srvcsid: %d, state: %d, j: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_srvcs->id, p_srvcs->state, j); };};
            ...
            if (!(failed_pm & p_act0->power_mode)) {
                ...
                if (p_act0->power_mode >= pm_action) {
                    ...
                    if (pm_req != 2 || p_srvcs->new_request) {
                        p_srvcs->new_request = 
# 537 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                              0
# 537 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                   ;
    ...
    if (pm_action & (0x10 | 0x20)) {

        if (!(allowed_modes & pm_action)) {


            pm_action = (allowed_modes & (0x10 | 0x20) & pref_modes);
    ...
    if ((pm_req != 3) && timeout) {
        for (i = 0; i < 7; i++) {
            if (bta_dm_cb.pm_timer[i].in_use && bdcmp(bta_dm_cb.pm_timer[i].peer_bdaddr, peer_addr) == 0) {
                if ((timer_idx = bta_pm_action_to_timer_idx(pm_action)) != 3) {
                    remaining_ticks = bta_dm_pm_get_remaining_ticks(&bta_dm_cb.pm_timer[i].timer[timer_idx]);
                    if (remaining_ticks < timeout) {
                        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s remain 0\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__); };};
# 584 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                    ...
                    timer_started = 
# 588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                   1
# 588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                       ;
                }
                break;
            } else if (!bta_dm_cb.pm_timer[i].in_use) {
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s dm_pm_timer:%d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, i, timeout); };};
                if (available_timer == 3) {
                    available_timer = i;
                }
            }
        }
        ...
        if (!timer_started) {
            if ( available_timer != 3) {
                ...
                if ((timer_idx = bta_pm_action_to_timer_idx(pm_action)) != 3) {
                    ...
                    timer_started = 
# 604 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                   1
# 604 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                       ;
                }
            }

            else {
                {if (appl_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_APPL", "\033[0;" "33" "m" "W" " (%d) %s: " "bta_dm_act dm_pm_timer no more" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
            }
        }
        return;
    }
    ...
    if (pm_req == 3 && pm_request < pm_action) {
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "Ignore the power mode request: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", pm_request); };}
        return;
    }
    if (pm_action == 0x10) {
        p_peer_device->pm_mode_attempted = 0x10;
        bta_dm_pm_park(peer_addr);
    } else if (pm_action & 0x20) {

        if (p_peer_device->link_policy & 0x0004) {
            p_peer_device->pm_mode_attempted = 0x20;
            bta_dm_pm_sniff(p_peer_device, (UINT8)(pm_action & 0x0F) );
        } else {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_set_mode: Link policy disallows SNIFF, ignore request" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
        }
    } else if (pm_action == 0x40) {
        bta_dm_pm_active(peer_addr);
    }
}
# 645 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static BOOLEAN bta_dm_pm_park(BD_ADDR peer_addr)
{
    ...
    if (mode != BTM_PM_MD_PARK) {
        BTM_SetPowerMode (bta_dm_cb.pm_id, peer_addr, &p_bta_dm_pm_md[5]);
    }
    return 
# 656 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
          1
# 656 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
              ;

}
# 670 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static BOOLEAN bta_dm_pm_sniff(tBTA_DM_PEER_DEVICE *p_peer_dev, UINT8 index)
{
    tBTM_PM_MODE mode = BTM_PM_STS_ACTIVE;
...
# 688 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_sniff cur:%d, idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", mode, index); };};
    if (mode != BTM_PM_MD_SNIFF)

    {
# 704 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
        memcpy(&pwr_md, &p_bta_dm_pm_md[index], sizeof (tBTM_PM_PWR_MD));
        if (p_peer_dev->info & 0x02) {
        ...
        if (status == BTM_CMD_STORED || status == BTM_CMD_STARTED) {
            p_peer_dev->info &= ~(0x02 | 0x04);
            p_peer_dev->info |= 0x01;
        } else if (status == BTM_SUCCESS) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_sniff BTM_SetPowerMode() returns BTM_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
            p_peer_dev->info &= ~(0x02 | 0x04 | 0x01);
        } else {
            {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_dm_pm_sniff BTM_SetPowerMode() returns ERROR status=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", status); };};
            p_peer_dev->info &= ~(0x02 | 0x04 | 0x01);
        }
    }
    return 
# 720 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
          1
# 720 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
              ;

}
# 794 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
...
# 815 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_btm_cback(BD_ADDR bd_addr, tBTM_PM_STATUS status, UINT16 value, UINT8 hci_status)
{
    tBTA_DM_PM_BTM_STATUS *p_buf;

    if ((p_buf = (tBTA_DM_PM_BTM_STATUS *) malloc((sizeof(tBTA_DM_PM_BTM_STATUS)))) != 
# 819 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                                                                        ((void *)0)
# 819 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                                                            ) {
...
# 839 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_timer_cback(void *p_tle)
{
    UINT8 i, j;

    for (i = 0; i < 7; i++) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "dm_pm_timer[%d] in use? %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, bta_dm_cb.pm_timer[i].in_use); };};
        if (bta_dm_cb.pm_timer[i].in_use) {
            for (j = 0; j < 3; j++) {
                if (&bta_dm_cb.pm_timer[i].timer[j] == (TIMER_LIST_ENT *) p_tle) {
                    bta_dm_cb.pm_timer[i].active --;
                    bta_dm_cb.pm_timer[i].srvc_id[j] = (44 + 2);
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "dm_pm_timer[%d] expires, timer_idx=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, j); };};
                    break;
                }
            }
            if (bta_dm_cb.pm_timer[i].active == 0) {
                bta_dm_cb.pm_timer[i].in_use = 
# 855 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                              0
# 855 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                                   ;
            }
            if (j < 3) {
                break;
    ...
    tBTA_DM_PM_TIMER *p_buf = (tBTA_DM_PM_TIMER *) malloc((sizeof(tBTA_DM_PM_TIMER)));
    if (p_buf != 
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                ((void *)0)
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                    ) {
...
# 888 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
void bta_dm_pm_btm_status(tBTA_DM_MSG *p_data)
{
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s status: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, p_data->pm_status.status); };};

    tBTA_DM_PEER_DEVICE *p_dev = bta_dm_find_peer_device(p_data->pm_status.bd_addr);
    if (
# 893 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
       ((void *)0) 
# 893 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
            == p_dev) {
        return;
    }
    ...
    case BTM_PM_STS_ACTIVE:
        ...
        if (p_data->pm_status.hci_status != 0) {
            {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "%s hci_status=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, p_data->pm_status.hci_status); };};
            p_dev->info &= ~(0x02 | 0x04 | 0x01);

            if (p_dev->pm_mode_attempted & (0x10 | 0x20)) {
                p_dev->pm_mode_failed
                |= ((0x10 | 0x20) & p_dev->pm_mode_attempted);
                bta_dm_pm_stop_timer_by_mode(p_data->pm_status.bd_addr, p_dev->pm_mode_attempted);
                bta_dm_pm_set_mode(p_data->pm_status.bd_addr, 0x00, 1);
            }
        } else {
# 922 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
            bta_dm_pm_stop_timer(p_data->pm_status.bd_addr);
            bta_dm_pm_set_mode(p_data->pm_status.bd_addr, 0x00, 1);
        }
        break;
# 946 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
...
# 985 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
void bta_dm_pm_timer(tBTA_DM_MSG *p_data)
{
    ...
    bta_dm_pm_set_mode(p_data->pm_timer.bd_addr, p_data->pm_timer.pm_request, 3);
}
# 1000 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static BOOLEAN bta_dm_pm_is_sco_active ()
{
    int j;
    BOOLEAN bScoActive = 
# 1003 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                        0
# 1003 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                             ;

    for (j = 0; j < bta_dm_conn_srvcs.count ; j++) {

        if ( (bta_dm_conn_srvcs.conn_srvc[j].id == 5 ) && (bta_dm_conn_srvcs.conn_srvc[j].state == 0x04) ) {
            bScoActive = 
# 1008 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                        1
# 1008 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                            ;
            break;
        }
    }

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_is_sco_active: SCO active: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", bScoActive); };};
    return bScoActive;
}
# 1028 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_hid_check(BOOLEAN bScoActive)
{
    int j;
    ...
    for (j = 0; j < bta_dm_conn_srvcs.count ; j++) {
        ...
        if (bta_dm_conn_srvcs.conn_srvc[j].id == 23 ) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "SCO status change(Active: %d), modify HID link policy. state: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", bScoActive, bta_dm_conn_srvcs.conn_srvc[j].state); };}
                                                                               ;
            bta_dm_pm_set_sniff_policy( bta_dm_find_peer_device(bta_dm_conn_srvcs.conn_srvc[j].peer_bdaddr), bScoActive);


            if (!bScoActive)
                bta_dm_pm_set_mode(bta_dm_conn_srvcs.conn_srvc[j].peer_bdaddr, 0x00,
                                   1);
        }
    }

}
# 1058 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
static void bta_dm_pm_set_sniff_policy(tBTA_DM_PEER_DEVICE *p_dev, BOOLEAN bDisable)
{
...
# 1099 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
UINT8 bta_dm_get_av_count(void)
{
    UINT8 count = 0;
    for (int i = 0; i < bta_dm_conn_srvcs.count; i++) {
        if (bta_dm_conn_srvcs.conn_srvc[i].id == 18) {
            ++count;
        }
    }
    return count;
}
# 1119 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
tBTA_DM_PEER_DEVICE *bta_dm_find_peer_device(BD_ADDR peer_addr)
{
    tBTA_DM_PEER_DEVICE *p_dev = 
# 1121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c" 3 4
                                ((void *)0)
# 1121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
                                    ;
...
# 1144 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_pm.c"
tBTA_DM_CONTRL_STATE bta_dm_pm_obtain_controller_state(void)
{



    tBTA_DM_CONTRL_STATE cur_state = 0;
    cur_state = BTM_PM_ReadControllerState();

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_dm_pm_obtain_controller_state: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cur_state); };};
    return cur_state;
}
