# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 2
...
int osi_mutex_new(osi_mutex_t *mutex)
{
    ...
    *mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    ...
    if (*mutex != 
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
                 ((void *)0)
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
                     ) {
        xReturn = 0;
    }
...
int osi_mutex_lock(osi_mutex_t *mutex, uint32_t timeout)
{
    ...
    if (timeout == 0xffffffffUL) {
        if (xQueueGenericReceive( ( QueueHandle_t ) ( *mutex ), 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
           ((void *)0)
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
           , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            ret = -1;
        }
    } else {
        if (xQueueGenericReceive( ( QueueHandle_t ) ( *mutex ), 
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
           ((void *)0)
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
...
void osi_mutex_unlock(osi_mutex_t *mutex)
{
    xQueueGenericSend( ( QueueHandle_t ) ( *mutex ), 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
   ((void *)0)
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
...
void osi_mutex_free(osi_mutex_t *mutex)
{
    ...
    *mutex = 
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
            ((void *)0)
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
                ;
}

int osi_mutex_global_init(void)
{
    gl_mutex = xQueueCreateMutex( ( ( uint8_t ) 4U ) );
    if (gl_mutex == 
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c" 3 4
                   ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/mutex.c"
                       ) {
        return -1;
    }
...
void osi_mutex_global_deinit(void)
{
    vQueueDelete( ( QueueHandle_t ) ( gl_mutex ) );
}

void osi_mutex_global_lock(void)
{
    xQueueTakeMutexRecursive( ( gl_mutex ), ( ( TickType_t ) 0xffffffffUL ) );
}

void osi_mutex_global_unlock(void)
{
    xQueueGiveMutexRecursive( ( gl_mutex ) );
}
