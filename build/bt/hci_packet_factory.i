# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_internals.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 2
...
{
    return make_command_no_params((0x0003 | (0x03 << 10)));
}

static BT_HDR *make_read_buffer_size(void)
{
    return make_command_no_params((0x0005 | (0x04 << 10)));
}
...
static BT_HDR *make_set_c2h_flow_control(uint8_t enable)
{
    ...
    BT_HDR *packet = make_command((0x0031 | (0x03 << 10)), parameter_size, &stream);
...
static BT_HDR *make_host_buffer_size(uint16_t acl_size, uint8_t sco_size, uint16_t acl_count, uint16_t sco_count)
{
    ...
    BT_HDR *packet = make_command((0x0033 | (0x03 << 10)), parameter_size, &stream);

    {*(stream)++ = (UINT8)(acl_size); *(stream)++ = (UINT8)((acl_size) >> 8);};
    {*(stream)++ = (UINT8)(sco_size);};
    {*(stream)++ = (UINT8)(acl_count); *(stream)++ = (UINT8)((acl_count) >> 8);};
    {*(stream)++ = (UINT8)(sco_count); *(stream)++ = (UINT8)((sco_count) >> 8);};
    return packet;
}

static BT_HDR *make_read_local_version_info(void)
{
    return make_command_no_params((0x0001 | (0x04 << 10)));
}

static BT_HDR *make_read_bd_addr(void)
{
    return make_command_no_params((0x0009 | (0x04 << 10)));
}

static BT_HDR *make_read_local_supported_commands(void)
{
    return make_command_no_params((0x0002 | (0x04 << 10)));
}
...
static BT_HDR *make_read_local_extended_features(uint8_t page_number)
{
    uint8_t *stream;
    const uint8_t parameter_size = 1;
    BT_HDR *packet = make_command((0x0004 | (0x04 << 10)), parameter_size, &stream);

    {*(stream)++ = (UINT8)(page_number);};
    return packet;
}
...
static BT_HDR *make_write_simple_pairing_mode(uint8_t mode)
{
    uint8_t *stream;
    const uint8_t parameter_size = 1;
    BT_HDR *packet = make_command((0x0056 | (0x03 << 10)), parameter_size, &stream);
...
static BT_HDR *make_write_secure_connections_host_support(uint8_t mode)
{
    uint8_t *stream;
    const uint8_t parameter_size = 1;
    BT_HDR *packet = make_command((0x007A | (0x03 << 10)), parameter_size, &stream);
...
static BT_HDR *make_set_event_mask(const bt_event_mask_t *event_mask)
{
    ...
    BT_HDR *packet = make_command((0x0001 | (0x03 << 10)), parameter_size, &stream);

    {register int ijk; for (ijk = 0; ijk < 8; ijk++) *(stream)++ = (UINT8) event_mask->as_array[7 - ijk];};
    return packet;
}
...
static BT_HDR *make_ble_write_host_support(uint8_t supported_host, uint8_t simultaneous_host)
{
    ...
    BT_HDR *packet = make_command((0x006D | (0x03 << 10)), parameter_size, &stream);

    {*(stream)++ = (UINT8)(supported_host);};
    {*(stream)++ = (UINT8)(simultaneous_host);};
    return packet;
}

static BT_HDR *make_ble_read_white_list_size(void)
{
    return make_command_no_params((0x000F | (0x08 << 10)));
}

static BT_HDR *make_ble_read_buffer_size(void)
{
    return make_command_no_params((0x0002 | (0x08 << 10)));
}

static BT_HDR *make_ble_read_supported_states(void)
{
    return make_command_no_params((0x001C | (0x08 << 10)));
}

static BT_HDR *make_ble_read_local_supported_features(void)
{
    return make_command_no_params((0x0003 | (0x08 << 10)));
}

static BT_HDR *make_ble_read_resolving_list_size(void)
{
    return make_command_no_params((0x002A | (0x08 << 10)));
}

static BT_HDR *make_ble_read_suggested_default_data_length(void)
{
    return make_command_no_params((0x0023 | (0x08 << 10)));
}
...
static BT_HDR *make_ble_write_suggested_default_data_length(uint16_t SuggestedMaxTxOctets, uint16_t SuggestedMaxTxTime)
{
    ...
    BT_HDR *packet = make_command((0x0024 | (0x08 << 10)), parameter_size, &stream);

    {*(stream)++ = (UINT8)(SuggestedMaxTxOctets); *(stream)++ = (UINT8)((SuggestedMaxTxOctets) >> 8);};
    {*(stream)++ = (UINT8)(SuggestedMaxTxTime); *(stream)++ = (UINT8)((SuggestedMaxTxTime) >> 8);};
    return packet;
}
...
static BT_HDR *make_ble_set_event_mask(const bt_event_mask_t *event_mask)
{
    uint8_t *stream;
    uint8_t parameter_size = sizeof(bt_event_mask_t);
    BT_HDR *packet = make_command((0x0001 | (0x08 << 10)), parameter_size, &stream);
...
static BT_HDR *make_write_sync_flow_control_enable(uint8_t enable)
{
    uint8_t *stream;
    const uint8_t parameter_size = 1;
    BT_HDR *packet = make_command((0x002F | (0x03 << 10)), parameter_size, &stream);
...
static BT_HDR *make_write_default_erroneous_data_report(uint8_t enable)
{
    uint8_t *stream;
    const uint8_t parameter_size = 1;
    BT_HDR *packet = make_command((0x005B | (0x03 << 10)), parameter_size, &stream);
...
static BT_HDR *make_command_no_params(uint16_t opcode)
{
    return make_command(opcode, 0, 
# 211 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 3 4
                                  ((void *)0)
# 211 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c"
                                      );
}

static BT_HDR *make_command(uint16_t opcode, size_t parameter_size, uint8_t **stream_out)
{
    BT_HDR *packet = make_packet(3 + parameter_size);

    uint8_t *stream = packet->data;
    {*(stream)++ = (UINT8)(opcode); *(stream)++ = (UINT8)((opcode) >> 8);};
    {*(stream)++ = (UINT8)(parameter_size);};

    if (stream_out != 
# 222 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c" 3 4
                     ((void *)0)
# 222 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c"
                         ) {
        *stream_out = stream;
    }
...
static BT_HDR *make_packet(size_t data_size)
{
    ...
    ((ret) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_factory.c", 232, __func__, "ret"));
    ret->event = 0;
    ret->offset = 0;
