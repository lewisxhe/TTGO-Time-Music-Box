# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 2
...
void btc_a2dp_control_command_ack(int status)
{
    ...
    if (btc_aa_ctrl_cb.a2dp_cmd_pending == ESP_A2D_MEDIA_CTRL_NONE) {
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "warning : no command pending, ignore ack" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
        return;
    }
...
static void btc_a2dp_datapath_open(void)
{
    ...
    if (btc_av_get_peer_sep() == 1 && btc_av_get_service_id() == 3) {
    ...
    btc_aa_ctrl_cb.data_channel_open = 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                      1
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                          ;
}
...
static void btc_a2dp_dispatch_datapath_evt(uint32_t dp_evt)
{
    ...
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s sig %u act %u, dp_evt %u\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, msg.sig, msg.act, arg.dp_evt); };};
    btc_transfer_context(&msg, &arg, sizeof(btc_av_args_t), 
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                                           ((void *)0)
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                               );
}

void btc_a2dp_control_media_ctrl(esp_a2d_media_ctrl_t ctrl)
{
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "BTC MEDIA (A2DP-DATA) EVENT %u" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", ctrl); };};

    if (btc_aa_ctrl_cb.a2dp_cmd_pending != ESP_A2D_MEDIA_CTRL_NONE) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "un-acked a2dp cmd: %u" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", btc_aa_ctrl_cb.a2dp_cmd_pending); };};
    ...
    case ESP_A2D_MEDIA_CTRL_CHECK_SRC_RDY:
        ...
        } else if ((btc_av_stream_ready() == 
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                            1
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                ) ||
                   (btc_av_stream_started_ready() == 
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                                    1
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                        )) {
    ...
    case ESP_A2D_MEDIA_CTRL_START:
        if (btc_av_stream_ready() == 
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                    1 
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                         ) {

            btc_dispatch_sm_event(BTC_AV_START_STREAM_REQ_EVT, 
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                                              ((void *)0)
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                                  , 0);

            btc_a2dp_dispatch_datapath_evt(BTC_AV_DATAPATH_OPEN_EVT);

            if (btc_av_get_peer_sep() == 0 && btc_av_get_service_id() == 18) {
                btc_a2dp_control_command_ack(ESP_A2D_MEDIA_CTRL_ACK_SUCCESS);
            }
    ...
    case ESP_A2D_MEDIA_CTRL_STOP:
        ...
        if (btc_av_get_peer_sep() == 1 && !btc_a2dp_source_is_streaming() &&
                btc_av_get_service_id() == 3) {

            btc_a2dp_control_command_ack(ESP_A2D_MEDIA_CTRL_ACK_SUCCESS);
            break;
        }

        btc_dispatch_sm_event(BTC_AV_STOP_STREAM_REQ_EVT, 
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                                         ((void *)0)
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                             , 0);
...
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
                                                                ((void *)0)
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
                                                                    , 0);
        } else {
    ...
    default :
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "### A2DP-MEDIA EVENT %u NOT HANDLED ###" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", ctrl); };};
        btc_a2dp_control_command_ack(ESP_A2D_MEDIA_CTRL_ACK_FAILURE);
        break;
    }
}
...
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
_Bool 
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
    btc_a2dp_control_init(void)
{
    memset(&btc_aa_ctrl_cb, 0, sizeof(tBTC_AA_CTRL_CB));
    return 
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c" 3 4
          1
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/a2dp/btc_a2dp_control.c"
              ;
}
