# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_packet_parser.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_packet_parser.h"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_packet_parser.h" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_packet_parser.h" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 2
    ...
    uint16_t *sco_buffer_count_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0005 | (0x04 << 10)), 7 );
    ((stream != 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 52, __func__, "stream != NULL"));
    {*acl_data_size_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {*sco_data_size_ptr = (UINT8)(*(stream)); (stream) += 1;};
    {*acl_buffer_count_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {*sco_buffer_count_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    buffer_allocator->free(response);
}
    ...
    bt_version_t *bt_version)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0001 | (0x04 << 10)), 8 );
    ((stream != 
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 66, __func__, "stream != NULL"));
    {bt_version->hci_version = (UINT8)(*(stream)); (stream) += 1;};
    {bt_version->hci_revision = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {bt_version->lmp_version = (UINT8)(*(stream)); (stream) += 1;};
    {bt_version->manufacturer = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {bt_version->lmp_subversion = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    ...
    bt_bdaddr_t *address_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0009 | (0x04 << 10)), sizeof(bt_bdaddr_t) );
    ((stream != 
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 82, __func__, "stream != NULL"));
    {register int ijk; register UINT8 *pbda = (UINT8 *)address_ptr->address + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *stream++;};
    ...
    size_t supported_commands_length)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0002 | (0x04 << 10)), supported_commands_length );
    ((stream != 
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 95, __func__, "stream != NULL"));
    {register int ijk; for (ijk = 0; ijk < (int)supported_commands_length; ijk++) ((UINT8 *) supported_commands_ptr)[ijk] = *stream++;};
    ...
    size_t feature_pages_count)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0004 | (0x04 << 10)), 2 + sizeof(bt_device_features_t) );
    if (stream != 
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
                 ((void *)0)
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
                     ) {
        {*page_number_ptr = (UINT8)(*(stream)); (stream) += 1;};
        {*max_page_number_ptr = (UINT8)(*(stream)); (stream) += 1;};

        ((*page_number_ptr < feature_pages_count) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 114, __func__, "*page_number_ptr < feature_pages_count"));
        {register int ijk; for (ijk = 0; ijk < (int)sizeof(bt_device_features_t); ijk++) ((UINT8 *) feature_pages[*page_number_ptr].as_array)[ijk] = *stream++;};
    } else {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_HCI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - WARNING: READING EXTENDED FEATURES FAILED. " "THIS MAY INDICATE A FIRMWARE/CONTROLLER ISSUE." "\033[0m" "\n", esp_log_timestamp(), "BT_HCI", __func__); };}
                                                                             ;
    }
    ...
    uint8_t *white_list_size_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x000F | (0x08 << 10)), 1 );
    ((stream != 
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 130, __func__, "stream != NULL"));
    {*white_list_size_ptr = (UINT8)(*(stream)); (stream) += 1;};
    ...
    uint8_t *acl_buffer_count_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0002 | (0x08 << 10)), 3 );
    ((stream != 
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 143, __func__, "stream != NULL"));
    {*data_size_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {*acl_buffer_count_ptr = (UINT8)(*(stream)); (stream) += 1;};
    ...
    size_t supported_states_size)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x001C | (0x08 << 10)), supported_states_size );
    ((stream != 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 157, __func__, "stream != NULL"));
    {register int ijk; for (ijk = 0; ijk < (int)supported_states_size; ijk++) ((UINT8 *) supported_states)[ijk] = *stream++;};
    ...
    bt_device_features_t *supported_features)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0003 | (0x08 << 10)), sizeof(bt_device_features_t) );
    ((stream != 
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
   ((void *)0)
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 169, __func__, "stream != NULL"));
    {register int ijk; for (ijk = 0; ijk < (int)sizeof(bt_device_features_t); ijk++) ((UINT8 *) supported_features->as_array)[ijk] = *stream++;};
    ...
    uint8_t *resolving_list_size_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x002A | (0x08 << 10)), 1 );
    {*resolving_list_size_ptr = (UINT8)(*(stream)); (stream) += 1;};
    ...
    uint16_t *ble_default_packet_txtime_ptr)
{
    ...
    uint8_t *stream = read_command_complete_header(response, (0x0023 | (0x08 << 10)), 2 );
    {*ble_default_packet_length_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    {*ble_default_packet_txtime_ptr = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    buffer_allocator->free(response);
}
    ...
    size_t minimum_bytes_after)
{
    ...
    {parameter_length = (UINT8)(*(stream)); (stream) += 1;};

    const size_t parameter_bytes_we_read_here = 4;


    ((event_code == 0x0E) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 217, __func__, "event_code == HCI_COMMAND_COMPLETE_EVT"));
    ((parameter_length >= (parameter_bytes_we_read_here + minimum_bytes_after)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 218, __func__, "parameter_length >= (parameter_bytes_we_read_here + minimum_bytes_after)"));
    ...
    if (expected_opcode != NO_OPCODE_CHECKING) {
        ((opcode == expected_opcode) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c", 228, __func__, "opcode == expected_opcode"));
    }
    ...
    if (status != 0x00) {
        return 
# 235 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c" 3 4
              ((void *)0)
# 235 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/hci_packet_parser.c"
                  ;
    }
