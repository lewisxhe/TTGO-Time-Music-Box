# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2


# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/include/btm_ble_int.h" 1
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 2
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
static void btm_gen_resolve_paddr_cmpl(tSMP_ENC *p)
{
    tBTM_LE_RANDOM_CB *p_cb = &btm_cb.ble_ctr_cb.addr_mgnt_cb;
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_resolve_paddr_cmpl" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    if (p) {
        ...
        p_cb->own_addr_type = 0x01;
        if (p_cb->set_local_privacy_cback){
            (*p_cb->set_local_privacy_cback)(BTM_SET_PRIVACY_SUCCESS);
            p_cb->set_local_privacy_cback = 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                           ((void *)0)
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                               ;
        }
        ...
        btu_start_timer_oneshot(&p_cb->raddr_timer_ent, 103,
                                900);

    } else {

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "set random address failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        if (p_cb->set_local_privacy_cback){
            (*p_cb->set_local_privacy_cback)(BTM_SET_PRIVACY_FAIL);
            p_cb->set_local_privacy_cback = 
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                           ((void *)0)
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                               ;
        }
    }
}
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
void btm_gen_resolve_paddr_low(tBTM_RAND_ENC *p)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_resolve_paddr_low" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    if (p) {
        p->param_buf[2] &= (~0xc0);
        p->param_buf[2] |= 0x40;
        ...
        if (!SMP_Encrypt(btm_cb.devcb.id_keys.irk, 16, p->param_buf, 3, &output)) {
            btm_gen_resolve_paddr_cmpl(
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                      ((void *)0)
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                          );
        } else {
...
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
void btm_gen_resolvable_private_addr (void *p_cmd_cplt_cback)
{
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_resolvable_private_addr" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (!btsnd_hcic_ble_rand((void *)p_cmd_cplt_cback)) {
        btm_gen_resolve_paddr_cmpl(
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                  ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                      );
    }
}
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
static void btm_gen_non_resolve_paddr_cmpl(tBTM_RAND_ENC *p)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_non_resolve_paddr_cmpl" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    p_cb->p_generate_cback = 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                            ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                ;
    if (p) {

        pp = p->param_buf;
        {register int ijk; register UINT8 *pbda = (UINT8 *)static_random + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *pp++;};

        static_random[0] &= 0x3f;
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_non_resolvable_private_addr failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        if (p_cback) {
            (* p_cback)(
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                       ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                           , p_data);
        }
    }
}
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
void btm_gen_non_resolvable_private_addr (tBTM_BLE_ADDR_CBACK *p_cback, void *p)
{
    tBTM_LE_RANDOM_CB *p_mgnt_cb = &btm_cb.ble_ctr_cb.addr_mgnt_cb;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_gen_non_resolvable_private_addr" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p_mgnt_cb->p_generate_cback != 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                      ((void *)0)
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                          ) {
        return;
    }
...
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                      ((void *)0)
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                          );
    }

}
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
static void btm_ble_resolve_address_cmpl(void)
{
    tBTM_LE_RANDOM_CB *p_mgnt_cb = &btm_cb.ble_ctr_cb.addr_mgnt_cb;
    tBTM_SEC_DEV_REC *p_dev_rec = 
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                                    ((void *)0)
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                                        ;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_resolve_address_cmpl p_mgnt_cb->index = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_mgnt_cb->index); };};

    if (p_mgnt_cb->index < 15) {
        p_dev_rec = &btm_cb.sec_dev_rec[p_mgnt_cb->index];
    }

    p_mgnt_cb->busy = 
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                     0
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                          ;

    (* p_mgnt_cb->p_resolve_cback)(p_dev_rec, p_mgnt_cb->p);
}
# 243 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
static BOOLEAN btm_ble_proc_resolve_x(tSMP_ENC *p)
{
    tBTM_LE_RANDOM_CB *p_mgnt_cb = &btm_cb.ble_ctr_cb.addr_mgnt_cb;
    UINT8 comp[3];
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_proc_resolve_x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    if (p) {
        if (!memcmp(p->param_buf, &comp[0], 3)) {
            ...
            {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "match is found" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            btm_ble_resolve_address_cmpl();
            return 
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                  1
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                      ;
        }
    }

    return 
# 262 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
          0
# 262 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
               ;
}
# 276 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
BOOLEAN btm_ble_init_pseudo_addr (tBTM_SEC_DEV_REC *p_dev_rec, BD_ADDR new_pseudo_addr)
{

    BD_ADDR dummy_bda = {0};

    if (memcmp(p_dev_rec->ble.pseudo_addr, dummy_bda, 6) == 0) {
        memcpy(p_dev_rec->ble.pseudo_addr, new_pseudo_addr, 6);
        return 
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
              1
# 283 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                  ;
    }

    return 
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
          0
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
               ;
}
# 298 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
BOOLEAN btm_ble_addr_resolvable (BD_ADDR rpa, tBTM_SEC_DEV_REC *p_dev_rec)
{
    BOOLEAN rt = 
# 300 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                0
# 300 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                     ;
    ...
    UINT8 rand[3];
    tSMP_ENC output;
    if ((p_dev_rec->device_type & 0x02) &&
            (p_dev_rec->ble.key_type & (1 << 1))) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s try to resolve" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
        ...
        SMP_Encrypt(p_dev_rec->ble.keys.irk, 16,
                    &rand[0], 3, &output);
        ...
        if (!memcmp(output.param_buf, &rand[0], 3)) {
            ...
            rt = 
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                1
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                    ;
        }
    }
...
# 345 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
static BOOLEAN btm_ble_match_random_bda(UINT16 rec_index)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s rec_index = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, rec_index); };};
    ...
    if (rec_index < 15) {
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "sec_flags = %02x device_type = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_dev_rec->sec_flags, p_dev_rec->device_type); };}
                                               ;
        ...
        if ((p_dev_rec->device_type & 0x02) &&
            ...
            return 
# 373 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                  0
# 373 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                       ;
        }
    } else {
        btm_ble_resolve_address_cmpl();
        return 
# 377 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
              1
# 377 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                  ;
    }
}
# 392 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
void btm_ble_resolve_random_addr(BD_ADDR random_bda, tBTM_BLE_RESOLVE_CBACK *p_cback, void *p)
{

    tBTM_LE_RANDOM_CB *p_mgnt_cb = &btm_cb.ble_ctr_cb.addr_mgnt_cb;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_resolve_random_addr" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    if ( !p_mgnt_cb->busy) {
        p_mgnt_cb->p = p;
        p_mgnt_cb->busy = 
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                         1
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                             ;
        p_mgnt_cb->index = 0;
        p_mgnt_cb->p_resolve_cback = p_cback;
        memcpy(p_mgnt_cb->random_bda, random_bda, 6);


        while (
# 406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
              1
# 406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                  ) {
        ...
        (*p_cback)(
# 414 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                  ((void *)0)
# 414 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                      , p);
    }


}
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
tBTM_SEC_DEV_REC *btm_find_dev_by_identity_addr(BD_ADDR bd_addr, UINT8 addr_type)
{
    ...
    for (i = 0; i < 15; i ++, p_dev_rec ++) {
        if ((p_dev_rec->sec_flags & 0x80) &&
                memcmp(p_dev_rec->ble.static_addr, bd_addr, 6) == 0) {
            if ((p_dev_rec->ble.static_addr_type & (~0x02)) !=
                    (addr_type & (~0x02))) {
                {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "%s find pseudo->random match with diff addr type: %d vs %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, p_dev_rec->ble.static_addr_type, addr_type); };}
                                                                                       ;
            }
    ...
    return 
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
          ((void *)0)
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
              ;
}
# 463 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
BOOLEAN btm_identity_addr_to_random_pseudo(BD_ADDR bd_addr, UINT8 *p_addr_type, BOOLEAN refresh)
{

    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev_by_identity_addr(bd_addr, *p_addr_type);

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};

    if (p_dev_rec != 
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                    ((void *)0)
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                        ) {
        ...
        if (!btm_ble_init_pseudo_addr (p_dev_rec, bd_addr)) {
            memcpy(bd_addr, p_dev_rec->ble.pseudo_addr, 6);
        }

        *p_addr_type = p_dev_rec->ble.ble_addr_type;
        return 
# 482 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
              1
# 482 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                  ;
    }

    return 
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
          0
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
               ;
}
# 496 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
BOOLEAN btm_random_pseudo_to_identity_addr(BD_ADDR random_pseudo, UINT8 *p_static_addr_type)
{
    ...
    if (p_dev_rec != 
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                    ((void *)0)
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                        ) {
        if (p_dev_rec->ble.in_controller_list & 0x02) {
            * p_static_addr_type = p_dev_rec->ble.static_addr_type;
            memcpy(random_pseudo, p_dev_rec->ble.static_addr, 6);
            if (controller_get_interface()->supports_ble_privacy() && p_dev_rec->ble.ble_addr_type != 0x00) {
                *p_static_addr_type |= 0x02;
            }
            return 
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                  1
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                      ;
        }
    }

    return 
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
          0
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
               ;
}
# 523 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
void btm_ble_refresh_peer_resolvable_private_addr(BD_ADDR pseudo_bda, BD_ADDR rpa,
        UINT8 rra_type)
{

    UINT8 rra_dummy = 
# 527 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                     0
# 527 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                          ;
    BD_ADDR dummy_bda = {0};

    if (memcmp(dummy_bda, rpa, 6) == 0) {
        rra_dummy = 
# 531 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                   1
# 531 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                       ;
    }
    ...
    if (p_sec_rec != 
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                    ((void *)0)
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                        ) {
        memcpy(p_sec_rec->ble.cur_rand_addr, rpa, 6);


        if (rra_type == 0) {
            p_sec_rec->ble.active_addr_type = rra_dummy ? 2 : 1;
        } else {
            p_sec_rec->ble.active_addr_type = rra_type;
        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "No matching known device in record" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s: active_addr_type: %d " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, p_sec_rec->ble.active_addr_type); };}
                                                              ;


    tACL_CONN *p_acl = btm_bda_to_acl(p_sec_rec->bd_addr, 2);
    if (p_acl == 
# 555 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                ((void *)0)
# 555 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                    ) {
        p_acl = btm_bda_to_acl(p_sec_rec->ble.pseudo_addr, 2);
    }

    if (p_acl != 
# 559 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
                ((void *)0)
# 559 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                    ) {
        if (rra_type == 0) {

            if (rra_dummy) {
                p_acl->active_remote_addr_type = p_sec_rec->ble.static_addr_type;
                memcpy(p_acl->active_remote_addr, p_sec_rec->ble.static_addr, 6);
            } else {
                p_acl->active_remote_addr_type = 0x01;
                memcpy(p_acl->active_remote_addr, rpa, 6);
            }
        } else {
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "p_acl->active_remote_addr_type: %d " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_acl->active_remote_addr_type); };};
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s conn_addr: %02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, p_acl->active_remote_addr[0], p_acl->active_remote_addr[1], p_acl->active_remote_addr[2], p_acl->active_remote_addr[3], p_acl->active_remote_addr[4], p_acl->active_remote_addr[5]); };}
...
# 591 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
        ...
        BD_ADDR local_rpa)
{
    ...
    if (p != 
# 598 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c" 3 4
            ((void *)0)
# 598 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_addr.c"
                ) {
        ...
        if (btm_cb.ble_ctr_cb.privacy_mode != 0 || btm_cb.ble_ctr_cb.addr_mgnt_cb.own_addr_type == 0x01) {
            p->conn_addr_type = 0x01;
            if (memcmp(local_rpa, dummy_bda, 6)) {
                memcpy(p->conn_addr, local_rpa, 6);
            } else {
                memcpy(p->conn_addr, btm_cb.ble_ctr_cb.addr_mgnt_cb.private_addr, 6);
            }
        } else {
            p->conn_addr_type = 0x00;
            memcpy(p->conn_addr, &controller_get_interface()->get_address()->address, 6);
        }
    }
