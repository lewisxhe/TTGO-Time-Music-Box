# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2

# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 2



tBTM_BLE_BATCH_SCAN_CB ble_batchscan_cb;
tBTM_BLE_ADV_TRACK_CB ble_advtrack_cb;
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_vsc_cmpl_cback (tBTM_VSC_CMPL *p_params);
void btm_ble_batchscan_cleanup(void);
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_filter_track_adv_vse_cback(UINT8 len, UINT8 *p)
{
    ...
    UINT8 sub_event = 0;
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;
    {sub_event = (UINT8)(*(p)); (p) += 1;};

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan_filter_track_adv_vse_cback called with event:%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", sub_event); };};
    if (0x54 == sub_event &&
            
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
           ((void *)0) 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                != ble_batchscan_cb.p_thres_cback) {
        ble_batchscan_cb.p_thres_cback(ble_batchscan_cb.ref_value);
        return;
    }

    if (0x56 == sub_event && 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                            ((void *)0) 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                                 != ble_advtrack_cb.p_track_cback) {
        if (len < 10) {
            return;
        }
        ...
        if (cmn_ble_vsc_cb.version_supported > 55) {
            {adv_data.filt_index = (UINT8)(*(p)); (p) += 1;};
            {adv_data.advertiser_state = (UINT8)(*(p)); (p) += 1;};
            {adv_data.advertiser_info_present = (UINT8)(*(p)); (p) += 1;};
            {register int ijk; register UINT8 *pbda = (UINT8 *)adv_data.bd_addr.address + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *p++;};
            {adv_data.addr_type = (UINT8)(*(p)); (p) += 1;};


            if (0x00 == adv_data.advertiser_info_present) {
                {adv_data.tx_power = (UINT8)(*(p)); (p) += 1;};
                {adv_data.rssi_value = (UINT8)(*(p)); (p) += 1;};
                {adv_data.time_stamp = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

                {adv_data.adv_pkt_len = (UINT8)(*(p)); (p) += 1;};
                if (adv_data.adv_pkt_len > 0) {
                    adv_data.p_adv_pkt_data = malloc((adv_data.adv_pkt_len));
                    memcpy(adv_data.p_adv_pkt_data, p, adv_data.adv_pkt_len);
                }

                {adv_data.scan_rsp_len = (UINT8)(*(p)); (p) += 1;};
                if (adv_data.scan_rsp_len > 0) {
                    adv_data.p_scan_rsp_data = malloc((adv_data.scan_rsp_len));
        ...
        {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "track_adv_vse_cback called: %d, %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", adv_data.filt_index, adv_data.addr_type, adv_data.advertiser_state); };}
                                                                      ;
        ble_advtrack_cb.p_track_cback(&adv_data);
        return;
    }
}
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                ...
                                UINT8 cb_evt, tBTM_BLE_REF_VALUE ref_value)
{
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan_enq_op_q: subcode:%d, Cur_state:%d, ref_value:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", ble_batchscan_cb.op_q.sub_code[ble_batchscan_cb.op_q.next_idx], ble_batchscan_cb.op_q.cur_state[ble_batchscan_cb.op_q.next_idx], ble_batchscan_cb.op_q.ref_value[ble_batchscan_cb.op_q.next_idx]); };}
...
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
...
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                                              ((void *)0)
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                                                  ;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan_enq_rep_q: index:%d, rep %d, ref %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", ble_batchscan_cb.main_rep_q.next_idx, report_format, ref_value); };}
                                                                                   ;
...
# 189 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_enq_rep_data(UINT8 report_format, UINT8 num_records, UINT8 *p_data,
                                    UINT8 data_len)
{
    int index = 0, len = 0;
    UINT8 *p_orig_data = 
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                        ((void *)0)
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                            , *p_app_data = 
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                            ((void *)0)
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan_enq_rep_data: index:%d, rep %d, num %d len : %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", index, report_format, num_records, data_len); };}
                                                                ;

    if (index < 2 && data_len > 0 && num_records > 0) {
        len = ble_batchscan_cb.main_rep_q.data_len[index];
        p_orig_data = ble_batchscan_cb.main_rep_q.p_data[index];
        if (
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
           ((void *)0) 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                != p_orig_data) {
            p_app_data = malloc((len + data_len));
...
# 235 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                    ...
                                    UINT8 *p_num_records, UINT8 **p_data, UINT16 *p_data_len)
{
    ...
    if (2 == index) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_batchscan_deq_rep_data: rep_format:%d not found" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", report_format); };};
        return;
    }
    ...
    *p_data_len = ble_batchscan_cb.main_rep_q.data_len[index];
    ...
    ble_batchscan_cb.main_rep_q.p_data[index] = 
# 256 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                               ((void *)0)
# 256 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                   ;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan_deq_rep_data: index:%d, rep %d, num %d, data_len %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", index, report_format, *p_num_records, *p_data_len); };}
                                                                      ;

    ble_batchscan_cb.main_rep_q.pending_idx = (ble_batchscan_cb.main_rep_q.pending_idx + 1)
            % 5;
}
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
...
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
        ...
        tBTM_BLE_REF_VALUE ref_value)
{
    ...
    if ((status = BTM_VendorSpecificCommand ((0x0156 | (0x3F << 10)),
                  2, param, btm_ble_batchscan_vsc_cmpl_cback))
            != BTM_CMD_STARTED) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_read_batchscan_reports %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        return BTM_ILLEGAL_VALUE;
    }

    if (BTM_CMD_STARTED == status) {

        btm_ble_batchscan_enq_op_q(0x04, ble_batchscan_cb.cur_state,
                                   3, ref_value);
    }

    return status;
}
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_vsc_cmpl_cback (tBTM_VSC_CMPL *p_params)
{
    ...
    UINT8 *p_data = 
# 353 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                   ((void *)0)
# 353 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                       ;

    if (len < 2) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "wrong length for btm_ble_batch_scan_vsc_cmpl_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_batchscan op_code = %02x state = %02x cb_evt = %02x,ref_value=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", opcode, cur_state, cb_evt, ref_value); };}
                                                         ;

    if (opcode != subcode) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Got unexpected VSC cmpl, expected: %d got: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", subcode, opcode); };};
        return;
    }
    ...
    case 0x01: {
        if (BTM_SUCCESS == status && BTM_BLE_SCAN_ENABLE_CALLED == cur_state) {
            ...
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "SCAN_ENB_DISAB_CUST_FEATURE - Invalid state after enb" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            ble_batchscan_cb.cur_state = BTM_BLE_SCAN_INVALID_STATE;
        }

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_BATCH_SCAN_ENB_DISAB_CUST_FEAT status = %d, state: %d,evt=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, ble_batchscan_cb.cur_state, cb_evt); };}
                                                                   ;

        if (cb_evt != 0 && 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                          ((void *)0) 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                               != ble_batchscan_cb.p_setup_cback) {
    ...
    case 0x02: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_BATCH_SCAN_SET_STORAGE_PARAM status = %d, evt=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, cb_evt); };}
                                       ;
        if (cb_evt != 0 && 
# 395 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                          ((void *)0) 
# 395 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                               != ble_batchscan_cb.p_setup_cback) {
            ble_batchscan_cb.p_setup_cback(cb_evt, ref_value, status);
        }
        break;
    ...
    case 0x03: {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_BATCH_SCAN_SET_PARAMS status = %d,evt=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, cb_evt); };};

        if (BTM_BLE_SCAN_DISABLE_CALLED == cur_state) {
            if (BTM_SUCCESS == status) {
                ble_batchscan_cb.cur_state = BTM_BLE_SCAN_DISABLED_STATE;
            } else {
                {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_BLE_BATCH_SCAN_SET_PARAMS - Invalid state after disabled" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
                ble_batchscan_cb.cur_state = BTM_BLE_SCAN_INVALID_STATE;
            }
        }

        if (cb_evt != 0 && 
# 413 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                          ((void *)0) 
# 413 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                               != ble_batchscan_cb.p_setup_cback) {
            ble_batchscan_cb.p_setup_cback(cb_evt, ref_value, status);
        }
        break;
    ...
    case 0x04: {
        if (cb_evt != 0 && 
# 420 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                          ((void *)0) 
# 420 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                               != ble_batchscan_cb.p_scan_rep_cback) {
            {report_format = (UINT8)(*(p)); (p) += 1;};
            {num_records = (UINT8)(*(p)); (p) += 1;};
            p = (uint8_t *)(p_params->p_param_buf + 4);
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_BATCH_SCAN_READ_RESULTS status=%d,len=%d,rec=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, len - 4, num_records); };}
                                                         ;
            ...
            if (0 == num_records) {
                btm_ble_batchscan_deq_rep_data(report_format, &ref_value, &num_records,
                                               &p_data, &data_len);
                if (
# 430 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                   ((void *)0) 
# 430 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                        != ble_batchscan_cb.p_scan_rep_cback)
                ...
                if ((len - 4) > 0) {
                    ...
                    if (BTM_CMD_STARTED != btm_status) {
                        ...
                        if (
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                           ((void *)0) 
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                != ble_batchscan_cb.p_scan_rep_cback && 
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                                        ((void *)0) 
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
...
# 472 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                       ...
                                       UINT8 batch_scan_notify_threshold)
{
    ...
    {*(pp)++ = (UINT8)(0x02);};
    {*(pp)++ = (UINT8)(batch_scan_full_max);};
    {*(pp)++ = (UINT8)(batch_scan_trunc_max);};
    {*(pp)++ = (UINT8)(batch_scan_notify_threshold);};

    if ((status = BTM_VendorSpecificCommand ((0x0156 | (0x3F << 10)),
                  4, param,
                  btm_ble_batchscan_vsc_cmpl_cback)) != BTM_CMD_STARTED) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_set_storage_config %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        return BTM_ILLEGAL_VALUE;
    }

    return status;
}
# 511 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
...
{
    tBTM_STATUS status = BTM_NO_RESOURCES;
    UINT8 scan_param[12], *pp_scan;

    pp_scan = scan_param;
    memset(scan_param, 0, 12);
    ...
    {*(pp_scan)++ = (UINT8)(0x03);};
    {*(pp_scan)++ = (UINT8)(scan_mode);};
    {*(pp_scan)++ = (UINT8)(scan_window); *(pp_scan)++ = (UINT8)((scan_window) >> 8); *(pp_scan)++ = (UINT8)((scan_window) >> 16); *(pp_scan)++ = (UINT8)((scan_window) >> 24);};
    {*(pp_scan)++ = (UINT8)(scan_interval); *(pp_scan)++ = (UINT8)((scan_interval) >> 8); *(pp_scan)++ = (UINT8)((scan_interval) >> 16); *(pp_scan)++ = (UINT8)((scan_interval) >> 24);};
    {*(pp_scan)++ = (UINT8)(addr_type);};
    {*(pp_scan)++ = (UINT8)(discard_rule);};

    if ((status = BTM_VendorSpecificCommand ((0x0156 | (0x3F << 10)),
                  12,
                  scan_param, btm_ble_batchscan_vsc_cmpl_cback)) != BTM_CMD_STARTED) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_set_batchscan_param %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        return BTM_ILLEGAL_VALUE;
    }

    return status;
}
# 553 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
tBTM_STATUS btm_ble_enable_disable_batchscan(BOOLEAN should_enable)
{
    tBTM_STATUS status = BTM_NO_RESOURCES;
    UINT8 shld_enable = 0x01;
    UINT8 enable_param[2], *pp_enable;
    ...
    if (should_enable) {
        ...
        memset(enable_param, 0, 2);

        {*(pp_enable)++ = (UINT8)(0x01);};
        {*(pp_enable)++ = (UINT8)(shld_enable);};

        if ((status = BTM_VendorSpecificCommand((0x0156 | (0x3F << 10)),
                                                2, enable_param,
                                                btm_ble_batchscan_vsc_cmpl_cback)) != BTM_CMD_STARTED) {
            status = BTM_MODE_UNSUPPORTED;
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_enable_disable_batchscan %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
            return BTM_ILLEGAL_VALUE;
        }
    } else if ((status = btm_ble_set_batchscan_param(0,
...
# 610 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                    ...
                                    tBTM_BLE_REF_VALUE ref_value)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " BTM_BleSetStorageConfig: %d, %d, %d, %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", ble_batchscan_cb.cur_state, ref_value, batch_scan_full_max, batch_scan_trunc_max, batch_scan_notify_threshold); };}
    ...
    if (0 == cmn_ble_vsc_cb.tot_scan_results_strg) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Controller does not support batch scan" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    if (batch_scan_full_max > 0x64 ||
            batch_scan_trunc_max > 0x64 ||
            batch_scan_notify_threshold > 0x64) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal set storage config params" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ILLEGAL_VALUE;
    }
    ...
    if (BTM_BLE_SCAN_INVALID_STATE == ble_batchscan_cb.cur_state ||
        ...
        status = btm_ble_enable_disable_batchscan(
# 650 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                 1
# 650 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                     );
        if (BTM_CMD_STARTED != status) {
            return status;
        }
        ...
        ble_batchscan_cb.cur_state = BTM_BLE_SCAN_ENABLE_CALLED;
        btm_ble_batchscan_enq_op_q(0x01,
    ...
    btm_ble_batchscan_enq_op_q(0x02, ble_batchscan_cb.cur_state,
                               2, ref_value);

    return status;
}
# 688 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
tBTM_STATUS BTM_BleEnableBatchScan(tBTM_BLE_BATCH_SCAN_MODE scan_mode,
                                   UINT32 scan_interval, UINT32 scan_window, tBLE_ADDR_TYPE addr_type,
                                   tBTM_BLE_DISCARD_RULE discard_rule, tBTM_BLE_REF_VALUE ref_value)
{
    tBTM_STATUS status = BTM_NO_RESOURCES;
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " BTM_BleEnableBatchScan: %d, %d, %d, %d, %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", scan_mode, scan_interval, scan_window, addr_type, discard_rule, ref_value); };}
                                                                                               ;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleEnableBatchScan: %d, %x, %x, %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", scan_mode, scan_interval, scan_window, discard_rule, ble_batchscan_cb.cur_state); };}
                                                                          ;
    ...
    if (((((scan_interval) >= (0x0004) && (scan_interval) <= (0x4000)) || ((scan_interval) == 0xffff)) ||
        ...
        if (BTM_BLE_SCAN_INVALID_STATE == ble_batchscan_cb.cur_state ||
                ...
                BTM_BLE_SCAN_DISABLE_CALLED == ble_batchscan_cb.cur_state) {
            status = btm_ble_enable_disable_batchscan(
# 722 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                     1
# 722 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                         );
            if (BTM_CMD_STARTED != status) {
                return status;
            }
        ...
        btm_ble_batchscan_enq_op_q(0x03, ble_batchscan_cb.cur_state,
                                   1, ref_value);
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal enable scan params" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ILLEGAL_VALUE;
    }
    return status;
}
# 763 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
tBTM_STATUS BTM_BleDisableBatchScan(tBTM_BLE_REF_VALUE ref_value)
{
    tBTM_STATUS status = BTM_NO_RESOURCES;
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " BTM_BleDisableBatchScan" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    status = btm_ble_enable_disable_batchscan(
# 780 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                             0
# 780 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                  );
    if (BTM_CMD_STARTED == status) {

        btm_ble_batchscan_enq_op_q(0x03,
                                   BTM_BLE_SCAN_DISABLE_CALLED, 6,
                                   ref_value);
    }

    return status;
}
# 803 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                   ...
                                   tBTM_BLE_REF_VALUE ref_value)
{
    ...
    UINT8 *p_data = 
# 809 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                    ((void *)0)
# 809 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                        , num_records = 0;
    UINT16 data_len = 0;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " BTM_BleReadScanReports; %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", scan_mode, ref_value); };};
    ...
    read_scan_mode = ble_batchscan_cb.scan_mode & 2;
    if (0 == read_scan_mode) {
        read_scan_mode = ble_batchscan_cb.scan_mode & 1;
    }


    if (read_scan_mode > 0 && (1 == scan_mode ||
                               2 == scan_mode)) {
        ...
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal read scan params: %d, %d, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", read_scan_mode, scan_mode, ble_batchscan_cb.cur_state); };}
                                                   ;
        return BTM_ILLEGAL_VALUE;
    }
    return status;
}
# 863 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
tBTM_STATUS BTM_BleTrackAdvertiser(tBTM_BLE_TRACK_ADV_CBACK *p_track_cback,
                                   tBTM_BLE_REF_VALUE ref_value)
{
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " BTM_BleTrackAdvertiser" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    if (!controller_get_interface()->supports_ble()) {
        return BTM_ILLEGAL_VALUE;
    }
    ...
    if (0 == cmn_ble_vsc_cb.tot_scan_results_strg) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Controller does not support scan storage" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }
...
# 895 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_init(void)
{
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_batchscan_init" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    memset(&ble_batchscan_cb, 0, sizeof(tBTM_BLE_BATCH_SCAN_CB));
    memset(&ble_advtrack_cb, 0, sizeof(tBTM_BLE_ADV_TRACK_CB));
    BTM_RegisterForVSEvents(btm_ble_batchscan_filter_track_adv_vse_cback, 
# 900 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                                         1
# 900 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                                             );
}
# 914 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
void btm_ble_batchscan_cleanup(void)
{
    int index = 0;
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_batchscan_cleanup" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    for (index = 0; index < 2; index++) {
        if (
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
           ((void *)0) 
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                != ble_batchscan_cb.main_rep_q.p_data[index]) {
            free((ble_batchscan_cb.main_rep_q.p_data[index]));
            ble_batchscan_cb.main_rep_q.p_data[index] = 
# 922 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c" 3 4
                                                       ((void *)0)
# 922 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_batchscan.c"
                                                           ;
        }
    }
