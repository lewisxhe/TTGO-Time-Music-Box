# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
extern void A2D_ParsSbcMplHdr(UINT8 *p_src, BOOLEAN *p_frag,
                              ...
                              UINT8 *p_num);
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 2
...
# 67 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 346 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
...
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
UINT8 bta_av_sbc_cfg_for_cap(UINT8 *p_peer, tA2D_SBC_CIE *p_cap, tA2D_SBC_CIE *p_pref)
{
    ...
    if ((status = A2D_ParsSbcInfo(&peer_cie, p_peer, 
# 415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 3 4
                                                    1
# 415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
                                                        )) != 0) {
        return status;
    }
    ...
    if (peer_cie.ch_mode & p_pref->ch_mode) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_sbc_cfg_for_cap: ch_mode(0x%02X) not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_pref->ch_mode); };};
        return 0x0A;
    }
    ...
    if (peer_cie.samp_freq & p_pref->samp_freq) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_sbc_cfg_for_cap: samp_freq(0x%02X) not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_pref->samp_freq); };};
        return 0x0A;
    }
    ...
    if (peer_cie.block_len & p_pref->block_len) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_sbc_cfg_for_cap: block_len(0x%02X) not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_pref->block_len); };};
        return 0x0A;
    }
    ...
    if (peer_cie.num_subbands & p_pref->num_subbands) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_sbc_cfg_for_cap: num_subbands(0x%02X) not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_pref->num_subbands); };};
        return 0x0A;
    }
    ...
    if (peer_cie.alloc_mthd & p_pref->alloc_mthd) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_sbc_cfg_for_cap: alloc_mthd(0x%02X) not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_pref->alloc_mthd); };};
        return 0x0A;
    }
    ...
    if (status == 0) {
        ...
        A2D_BldSbcInfo(0x00, &peer_cie, p_peer);
    }
    return status;
}
# 486 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
UINT8 bta_av_sbc_cfg_matches_cap(UINT8 *p_cfg, tA2D_SBC_CIE *p_cap)
{
    ...
    if ((status = A2D_ParsSbcInfo(&cfg_cie, p_cfg, 
# 492 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 3 4
                                                  1
# 492 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
                                                      )) != 0) {
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " " bta_av_sbc_cfg_matches_cap Parsing Failed %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", status); };};
        return status;
    }



    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " FREQ peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.samp_freq, p_cap->samp_freq); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " CH_MODE peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.ch_mode, p_cap->ch_mode); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " BLOCK_LEN peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.block_len, p_cap->block_len); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " SUB_BAND peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.num_subbands, p_cap->num_subbands); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " ALLOC_MTHD peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.alloc_mthd, p_cap->alloc_mthd); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " MAX_BitPool peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.max_bitpool, p_cap->max_bitpool); };};
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " " Min_bitpool peer: 0%x, capability  0%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", cfg_cie.min_bitpool, p_cap->min_bitpool); };};
...
# 550 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
UINT8 bta_av_sbc_cfg_in_cap(UINT8 *p_cfg, tA2D_SBC_CIE *p_cap)
{
    ...
    if ((status = A2D_ParsSbcInfo(&cfg_cie, p_cfg, 
# 556 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 3 4
                                                  0
# 556 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
                                                       )) != 0) {
        return status;
    }
...
# 604 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
void bta_av_sbc_bld_hdr(BT_HDR *p_buf, UINT16 fr_per_pkt)
{
    ...
    p_buf->len += 1;
    A2D_BldSbcMplHdr(p, 
# 611 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 3 4
                       0
# 611 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
                            , 
# 611 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c" 3 4
                              0
# 611 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_sbc.c"
