# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 2
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
tAVRC_CB avrc_cb;
...
const tSDP_PROTOCOL_ELEM avrc_proto_list [] = {
    ...
    {0x0017, 1, {0x0104, 0} }
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
};
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
static void avrc_sdp_cback(UINT16 status)
{
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_sdp_cback status: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", status); };};
...
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
UINT16 AVRC_FindService(UINT16 service_uuid, BD_ADDR bd_addr,
                        tAVRC_SDP_DB_PARAMS *p_db, tAVRC_FIND_CBACK *p_cback)
{
    tBT_UUID uuid_list;
    BOOLEAN result = 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                        1
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                            ;
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_FindService uuid: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", service_uuid); };};
    if ( (service_uuid != 0X110C && service_uuid != 0X110E) ||
            p_db == 
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                   ((void *)0) 
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                        || p_db->p_db == 
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                                         ((void *)0) 
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
...
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
    ...
    if ( avrc_cb.service_uuid == 0X110C ||
            avrc_cb.service_uuid == 0X110E) {
        return 1;
    }
    ...
    if (p_db->p_attrs == 
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                        ((void *)0) 
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                             || p_db->num_attr == 0) {
    ...
    if (result == 
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                 1
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                     ) {
    ...
    return (result ? 0 : 0x10);
}
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
UINT16 AVRC_AddRecord(UINT16 service_uuid, char *p_service_name,
                      char *p_provider_name, UINT16 categories, UINT32 sdp_handle)
{
    UINT16 browse_list[1];
    BOOLEAN result = 
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                        1
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                            ;
    UINT8 temp[8];
    UINT8 *p;
    UINT16 count = 1;
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_AddRecord uuid: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", service_uuid); };};
    ...
    if ( service_uuid == 0X110E ) {
        class_list[1] = 0X110F;
        count = 2;
    }
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
    result &= SDP_AddServiceClassIdList(sdp_handle, count, class_list);


    result &= SDP_AddProtocolList(sdp_handle, 2, (tSDP_PROTOCOL_ELEM *)avrc_proto_list);
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
    result &= SDP_AddProfileDescriptorList(sdp_handle, 0X110E, 0x0103);
    ...
    if (p_provider_name != 
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                          ((void *)0)
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                              ) {
    ...
    if (p_service_name != 
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c" 3 4
                         ((void *)0)
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
                             ) {
...
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
...
# 346 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
void AVRC_Init(void)
{
    ...
    avrc_cb.trace_level = 2;



}
# 371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_sdp.c"
