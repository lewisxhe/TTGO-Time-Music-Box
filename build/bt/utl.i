# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/utl.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/utl.h"
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/utl.h" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 2
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
...
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
...
# 119 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
UINT8 utl_itoa(UINT16 i, char *p_s)
{
    UINT16 j, k;
    char *p = p_s;
    BOOLEAN fill = 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
                  0
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                       ;
        ...
        *p++ = '0';
        ...
        for (j = 10000; j > 0; j /= 10) {
            ...
            if (k > 0 || fill) {
                *p++ = k + '0';
                fill = 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
                      1
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                          ;
            }
        }
    }
...
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
void utl_freebuf(void **p)
{
    if (*p != 
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
             ((void *)0)
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                 ) {
        free((*p));
        *p = 
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
            ((void *)0)
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                ;
    }
}
# 182 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
BOOLEAN utl_set_device_class(tBTA_UTL_COD *p_cod, UINT8 cmd)
{
    ...
    {service = dev[0]; service<<=8; service += dev[1]&0xE0;};
    {minor = dev[2]&0xFC;};
    {major = dev[1]&0x1F;};

    switch (cmd) {
    case 0x01:
        minor = p_cod->minor & 0xFC;
        major = p_cod->major & 0x1F;
        break;

    case 0x02:

        p_cod->service &= 0xFFE0;
    ...
    case 0x0a:
        minor = p_cod->minor & 0xFC;
        major = p_cod->major & 0x1F;
        service = p_cod->service & 0xFFE0;
        break;

    default:
        return 
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
              0
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                   ;
    }


    {dev_class[2] = minor; dev_class[1] = major+ ((service)&0x00E0); dev_class[0] = (service) >> 8;};

    if (BTM_SetDeviceClass(dev_class) == BTM_SUCCESS) {
        return 
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
              1
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                  ;
    }

    return 
# 235 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
          0
# 235 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
               ;
}
# 251 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
BOOLEAN utl_get_device_class(tBTA_UTL_COD *p_cod)
{
    ...
    return 
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
          1
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
              ;
}
# 280 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
BOOLEAN utl_isintstr(const char *p_s)
{
    ...
    for (i = 0; p_s[i] != 0; i++) {
        if (((p_s[i] < '0') || (p_s[i] > '9')) && (p_s[i] != ';')) {
            return 
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
                  0
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                       ;
        }
    }

    return 
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
          1
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
              ;
}
# 304 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
    ...
    for (i = 0; p_s[i] != 0; i++) {
        if (!(((p_s[i] >= '0') && (p_s[i] <= '9'))
                ...
                || ((p_s[i] == 'p') || (p_s[i] == 'P')
                    || (p_s[i] == 'w') || (p_s[i] == 'W')))) {
            return 
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
                  0
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
                       ;
        }
    }

    return 
# 318 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c" 3 4
          1
# 318 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sys/utl.c"
              ;
}
