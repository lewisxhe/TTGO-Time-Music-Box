# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2

# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 2
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
const UINT8 btm_pm_mode_off[3] = {0, 0, 1};

const UINT8 btm_pm_mode_msk[3] = {0x40, 0x80, 0x01};





const UINT8 btm_pm_md_comp_matrix[3 * 3] = {
    3,
    2,
    2,
...
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
tBTM_STATUS BTM_PmRegister (UINT8 mask, UINT8 *p_pm_id, tBTM_PM_STATUS_CBACK *p_cb)
{
    ...
    if (mask & 4) {
        ...
        btm_cb.pm_reg_db[*p_pm_id].mask = 0;
        return BTM_SUCCESS;
    }

    for (xx = 0; xx < 2; xx++) {

        if (btm_cb.pm_reg_db[xx].mask == 0) {

            if (mask & 2) {
                if (p_cb == 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                           ((void *)0)
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                               ) {
                    return BTM_ILLEGAL_VALUE;
                }
...
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
tBTM_STATUS BTM_SetPowerMode (UINT8 pm_id, BD_ADDR remote_bda, tBTM_PM_PWR_MD *p_mode)
{
    UINT8 *p_features;
    int ind, acl_ind;
    tBTM_PM_MCB *p_cb = 
# 176 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                       ((void *)0)
# 176 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                           ;
    tBTM_PM_MODE mode;
    int temp_pm_id;
    ...
    if (p_mode == 
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                 ((void *)0)
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                     ) {
        return BTM_ILLEGAL_VALUE;
    }

    {if (btm_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTM", "\033[0;" "32" "m" "I" " (%d) %s: " "BTM_SetPowerMode: pm_id %d BDA: %08x mode:0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", pm_id, (remote_bda[2] << 24) + (remote_bda[3] << 16) + (remote_bda[4] << 8) + remote_bda[5], p_mode->mode); };}
                                                                                                                      ;
    ...
    if (mode == p_cb->state) {
        ...
        if ( (mode == BTM_PM_MD_ACTIVE) ||
            ...
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_SetPowerMode: mode:0x%x interval %d max:%d, min:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_mode->mode, p_cb->interval, p_mode->max, p_mode->min); };};
            return BTM_SUCCESS;
        }
    }
    ...
    if ( ((pm_id != 0x80) &&
            (btm_cb.pm_reg_db[pm_id].mask & 1))
            || ((pm_id == 0x80) && (btm_cb.pm_pend_link != 4)) ) {




        btm_cb.pm_reg_db[temp_pm_id].mask |= 1;
        *(&p_cb->req_mode[temp_pm_id]) = *((tBTM_PM_PWR_MD *)p_mode);
        p_cb->chg_ind = 
# 236 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                       1
# 236 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                           ;
    }
    ...
    if ( (p_cb->state == BTM_PM_STS_HOLD) ||
            ...
            (btm_cb.pm_pend_link != 4) ) {
        if (acl_ind != btm_cb.pm_pend_link) {

            p_cb->state |= 0x80;
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_pm state stored:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", acl_ind); };};
        }
...
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
tBTM_STATUS BTM_ReadPowerMode (BD_ADDR remote_bda, tBTM_PM_MODE *p_mode)
{
    int acl_ind;

    if ( (acl_ind = btm_pm_find_acl_ind(remote_bda)) == 4) {
        return (BTM_UNKNOWN_ADDR);
    }
...
# 309 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
tBTM_STATUS BTM_SetSsrParams (BD_ADDR remote_bda, UINT16 max_lat,
                              UINT16 min_rmt_to, UINT16 min_loc_to)
{
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
    return BTM_ILLEGAL_ACTION;

}
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
void btm_pm_reset(void)
{
    int xx;
    tBTM_PM_STATUS_CBACK *cb = 
# 351 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                              ((void *)0)
# 351 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                  ;


    if ( (btm_cb.pm_pend_id != 0x80) &&
            (btm_cb.pm_reg_db[btm_cb.pm_pend_id].mask & 2) ) {
    ...
    for (xx = 0; xx < 2; xx++) {
        btm_cb.pm_reg_db[xx].mask = 0;
    }

    if (cb != 
# 365 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
             ((void *)0) 
# 365 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  && btm_cb.pm_pend_link < 4) {
...
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
void btm_pm_sm_alloc(UINT8 ind)
{
...
# 403 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
static int btm_pm_find_acl_ind(BD_ADDR remote_bda)
{
    ...
    for (xx = 0; xx < 4; xx++, p++) {
        if ((p->in_use) && (!memcmp (p->remote_addr, remote_bda, 6))
...
# 430 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
static tBTM_PM_PWR_MD *btm_pm_compare_modes(tBTM_PM_PWR_MD *p_md1, tBTM_PM_PWR_MD *p_md2, tBTM_PM_PWR_MD *p_res)
{
    UINT8 res;

    if (p_md1 == 
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                ((void *)0)
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                    ) {
        *p_res = *p_md2;
    ...
    if (p_md2->mode == BTM_PM_MD_ACTIVE || p_md1->mode == BTM_PM_MD_ACTIVE) {
        return 
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              ((void *)0)
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  ;
    }
    ...
    res = (p_md1->mode - 1) * 3 + (p_md2->mode - 1);
    ...
    case 3:
        ...
        if ( p_res->max < p_res->min) {
            return 
# 478 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                  ((void *)0)
# 478 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                      ;
        }
    ...
    return 
# 488 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
          ((void *)0)
# 488 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
              ;
}
# 499 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
static tBTM_PM_MODE btm_pm_get_set_mode(UINT8 pm_id, tBTM_PM_MCB *p_cb, tBTM_PM_PWR_MD *p_mode, tBTM_PM_PWR_MD *p_res)
{
    int xx, loop_max;
    tBTM_PM_PWR_MD *p_md = 
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                          ((void *)0)
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                              ;

    if (p_mode != 
# 504 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                 ((void *)0) 
# 504 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                      && p_mode->mode & BTM_PM_MD_FORCE) {
        *p_res = *p_mode;
        p_res->mode &= ~BTM_PM_MD_FORCE;
        return p_res->mode;
    }
...
# 524 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                                                ((void *)0)
# 524 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                                                    ) {
                    return BTM_PM_MD_ACTIVE;
                }
                p_md = p_res;
    ...
    if (p_md == 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
               ((void *)0)
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                   ) {
        if (p_mode) {
        ...
        if ( (pm_id == 0x80) &&
                ((btm_pm_compare_modes(p_mode, p_md, p_res)) == 
# 543 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                               ((void *)0)
# 543 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                                   ) ) {
            return BTM_PM_MD_ACTIVE;
        }
    }
...
# 558 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
static tBTM_STATUS btm_pm_snd_md_req(UINT8 pm_id, int link_ind, tBTM_PM_PWR_MD *p_mode)
{
    ...
    BOOLEAN chg_ind = 
# 563 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                          0
# 563 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                               ;
    ...
    if ( p_cb->state == mode) {
        ...
        chg_ind = 
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                 1
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                     ;
    }
    ...
    if ( mode != BTM_PM_MD_ACTIVE && p_cb->state != BTM_PM_MD_ACTIVE) {
        p_cb->chg_ind = 
# 586 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                       1
# 586 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                           ;
    }

    if (p_cb->chg_ind == 
# 589 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                        1
# 589 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                            ) {
        md_res.mode = BTM_PM_MD_ACTIVE;
    }
# 600 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
    btm_cb.pm_pend_link = 4;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s switching from %s to %s." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, mode_to_string(p_cb->state), mode_to_string(md_res.mode)); };};
    switch (md_res.mode) {
...
# 677 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
static void btm_pm_check_stored(void)
{
    int xx;
    for (xx = 0; xx < 4; xx++) {
        if (btm_cb.pm_mode_db[xx].state & 0x80) {
            btm_cb.pm_mode_db[xx].state &= ~0x80;
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_pm_check_stored :%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", xx); };};
            btm_pm_snd_md_req(0x80, xx, 
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                     ((void *)0)
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                         );
            break;
        }
    }
}
# 703 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
void btm_pm_proc_cmd_status(UINT8 status)
{
    tBTM_PM_MCB *p_cb;
...
# 754 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
void btm_pm_proc_mode_change (UINT8 hci_status, UINT16 hci_handle, UINT8 mode, UINT16 interval)
{
    tACL_CONN *p;
    tBTM_PM_MCB *p_cb = 
# 757 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                       ((void *)0)
# 757 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                           ;
    int xx, yy, zz;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s switched from %s to %s." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, mode_to_string(old_state), mode_to_string(p_cb->state)); };};

    if ((p_lcb = l2cu_find_lcb_by_bd_addr(p->remote_addr, 1)) != 
# 777 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                                                  ((void *)0)
# 777 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                                                      ) {
        if ((p_cb->state == BTM_PM_ST_ACTIVE) || (p_cb->state == BTM_PM_ST_SNIFF)) {


            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm mode change to active; check l2c_link for outgoing packets" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            l2c_link_check_send_pkts(p_lcb, 
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                           ((void *)0)
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                               , 
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                 ((void *)0)
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
    ...
    if (old_state & 0x80) {
        ...
        btm_pm_snd_md_req(0x80, xx, 
# 799 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                 ((void *)0)
# 799 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                     );
    } else {
        for (zz = 0; zz < 4; zz++) {
            if (btm_cb.pm_mode_db[zz].chg_ind == 
# 802 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                1
# 802 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                    ) {



                btm_pm_snd_md_req(0x80, zz, 
# 806 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
                                                         ((void *)0)
# 806 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                                                             );
                break;
            }
        }
...
# 883 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
BOOLEAN btm_pm_device_in_active_or_sniff_mode(void)
{
    ...
    if (BTM_GetNumAclLinks() > 0) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s - ACL links: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, BTM_GetNumAclLinks()); };};
        return 
# 890 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              1
# 890 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  ;
    }
    ...
    if (btm_ble_get_conn_st() != 0) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s - BLE state: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, btm_ble_get_conn_st()); };};
        return 
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              1
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  ;
    }


    return 
# 901 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
          0
# 901 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
               ;
}
# 913 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
BOOLEAN btm_pm_device_in_scan_state(void)
{
    ...
    if (btm_cb.is_paging || (!fixed_queue_is_empty(btm_cb.page_queue)) ||
            (0x10 | 0x4) == btm_cb.busy_level) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_pm_device_in_scan_state- paging" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return 
# 921 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              1
# 921 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  ;
    }


    if ((btm_cb.btm_inq_vars.inq_active & ((0x01|0x02|0x8) | (0x10|0x20))) != 0) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_pm_device_in_scan_state- Inq active" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return 
# 927 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              1
# 927 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
                  ;
    }

    return 
# 930 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
          0
# 930 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
               ;
}
# 942 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
tBTM_CONTRL_STATE BTM_PM_ReadControllerState(void)
{
    if (
# 944 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
       1 
# 944 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
            == btm_pm_device_in_active_or_sniff_mode()) {
        return 1;
    } else if (
# 946 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c" 3 4
              1 
# 946 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_pm.c"
