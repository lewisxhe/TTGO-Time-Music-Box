# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 2
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_mtu_cmd(UINT8 op_code, UINT16 rx_mtu)
{
    BT_HDR *p_buf = 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc((sizeof(BT_HDR) + 3 + 13))) != 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                            ((void *)0)
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                                ) {
        p = (UINT8 *)(p_buf + 1) + 13;

        {*(p)++ = (UINT8)(op_code);};
        {*(p)++ = (UINT8)(rx_mtu); *(p)++ = (UINT8)((rx_mtu) >> 8);};
...
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_exec_write_cmd (UINT8 op_code, UINT8 flag)
{
    BT_HDR *p_buf = 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc(((4096 + 16)))) != 
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                             ((void *)0)
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                 ) {
        p = (UINT8 *)(p_buf + 1) + 13;
...
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_err_cmd(UINT8 cmd_code, UINT16 err_handle, UINT8 reason)
{
    BT_HDR *p_buf = 
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc((sizeof(BT_HDR) + 13 + 5))) != 
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                ((void *)0)
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                    ) {
        p = (UINT8 *)(p_buf + 1) + 13;

        {*(p)++ = (UINT8)(0x01);};
        {*(p)++ = (UINT8)(cmd_code);};
        {*(p)++ = (UINT8)(err_handle); *(p)++ = (UINT8)((err_handle) >> 8);};
        {*(p)++ = (UINT8)(reason);};
...
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_browse_cmd(UINT8 op_code, UINT16 s_hdl, UINT16 e_hdl, tBT_UUID uuid)
{
    BT_HDR *p_buf = 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc((sizeof(BT_HDR) + 8 + 13))) != 
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                ((void *)0)
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                    ) {
        p = (UINT8 *)(p_buf + 1) + 13;
        ...
        {*(p)++ = (UINT8)(op_code);};
        {*(p)++ = (UINT8)(s_hdl); *(p)++ = (UINT8)((s_hdl) >> 8);};
        {*(p)++ = (UINT8)(e_hdl); *(p)++ = (UINT8)((e_hdl) >> 8);};
        p_buf->len += gatt_build_uuid_to_stream(&p, uuid);
    }

    return p_buf;
}
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_read_by_type_value_cmd (UINT16 payload_size, tGATT_FIND_TYPE_VALUE *p_value_type)
{
    BT_HDR *p_buf = 
# 163 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 163 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;
    UINT16 len = p_value_type->value_len;

    if ((p_buf = (BT_HDR *)malloc(((UINT16)(sizeof(BT_HDR) + payload_size + 13)))) != 
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                                     ((void *)0)
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                                         ) {
        p = (UINT8 *)(p_buf + 1) + 13;
        ...
        {*(p)++ = (UINT8)(0x06);};
        {*(p)++ = (UINT8)(p_value_type->s_handle); *(p)++ = (UINT8)((p_value_type->s_handle) >> 8);};
        {*(p)++ = (UINT8)(p_value_type->e_handle); *(p)++ = (UINT8)((p_value_type->e_handle) >> 8);};
...
# 198 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_read_multi_cmd(UINT16 payload_size, UINT16 num_handle, UINT16 *p_handle)
{
    BT_HDR *p_buf = 
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p, i = 0;

    if ((p_buf = (BT_HDR *)malloc(((UINT16)(sizeof(BT_HDR) + num_handle * 2 + 1 + 13)))) != 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                                           ((void *)0)
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                                               ) {
        p = (UINT8 *)(p_buf + 1) + 13;
        ...
        for (i = 0; i < num_handle && p_buf->len + 2 <= payload_size; i ++) {
            {*(p)++ = (UINT8)(*(p_handle + i)); *(p)++ = (UINT8)((*(p_handle + i)) >> 8);};
            p_buf->len += 2;
        }
    }
...
# 228 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_handle_cmd(UINT8 op_code, UINT16 handle, UINT16 offset)
{
    BT_HDR *p_buf = 
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc((sizeof(BT_HDR) + 5 + 13))) != 
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                ((void *)0)
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                    ) {
        p = (UINT8 *)(p_buf + 1) + 13;
        ...
        {*(p)++ = (UINT8)(handle); *(p)++ = (UINT8)((handle) >> 8);};
        p_buf->len += 2;

        if (op_code == 0x0C) {
            {*(p)++ = (UINT8)(offset); *(p)++ = (UINT8)((offset) >> 8);};
            p_buf->len += 2;
        }
...
# 262 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_opcode_cmd(UINT8 op_code)
{
    BT_HDR *p_buf = 
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p;

    if ((p_buf = (BT_HDR *)malloc((sizeof(BT_HDR) + 1 + 13))) != 
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                ((void *)0)
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                    ) {
        p = (UINT8 *)(p_buf + 1) + 13;
        p_buf->offset = 13;
...
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_value_cmd (UINT16 payload_size, UINT8 op_code, UINT16 handle,
                              UINT16 offset, UINT16 len, UINT8 *p_data)
{
    BT_HDR *p_buf = 
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                        ((void *)0)
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                            ;
    UINT8 *p, *pp, pair_len, *p_pair_len;

    if ((p_buf = (BT_HDR *)malloc(((UINT16)(sizeof(BT_HDR) + payload_size + 13)))) != 
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                                                     ((void *)0)
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                                                                         ) {
        p = pp = (UINT8 *)(p_buf + 1) + 13;
        ...
        if (op_code != 0x0D && op_code != 0x0B) {
            {*(p)++ = (UINT8)(handle); *(p)++ = (UINT8)((handle) >> 8);};
            p_buf->len += 2;
        }

        if (op_code == 0x16 || op_code == 0x17 ) {
            {*(p)++ = (UINT8)(offset); *(p)++ = (UINT8)((offset) >> 8);};
            p_buf->len += 2;
        }

        if (len > 0 && p_data != 
# 315 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                ((void *)0)
# 315 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                    ) {
            ...
            if (payload_size - p_buf->len < len) {
                ...
                {if (gatt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_GATT", "\033[0;" "33" "m" "W" " (%d) %s: " "attribute value too long, to be truncated to %d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", len); };};
            }

            {register int ijk; for (ijk = 0; ijk < len; ijk++) *(p)++ = (UINT8) p_data[ijk];};
            p_buf->len += len;
        }
    }
    return p_buf;
}
# 341 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
tGATT_STATUS attp_send_msg_to_l2cap(tGATT_TCB *p_tcb, BT_HDR *p_toL2CAP)
{
    ...
    if (p_tcb->att_lcid == 4) {
        l2cap_ret = L2CA_SendFixedChnlData (4, p_tcb->peer_bda, p_toL2CAP);
    } else {
    ...
    if (l2cap_ret == 
# 356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                    0
# 356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                   ) {
        {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "ATT   failed to pass msg:0x%0x to L2CAP" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", *((UINT8 *)(p_toL2CAP + 1) + p_toL2CAP->offset)); };}
                                                                         ;
        return 0x81;
    } else if (l2cap_ret == 2) {
        {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "ATT congested, message accepted" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
        return 0x8f;
    }
    return 0x00;
}
# 374 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
BT_HDR *attp_build_sr_msg(tGATT_TCB *p_tcb, UINT8 op_code, tGATT_SR_MSG *p_msg)
{
    BT_HDR *p_cmd = 
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                            ((void *)0)
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                ;
    UINT16 offset = 0;
    ...
    case 0x03:
        ...
        if (p_msg == 
# 389 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                    ((void *)0)
# 389 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                        ) {
            {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid parameters in %s, op_code=0x%x, the p_msg should not be NULL." "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", __func__, op_code); };};
            return 
# 391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                  ((void *)0)
# 391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                      ;
        }
        break;
    ...
    case 0x0D:
    case 0x17:
        {if (gatt_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "ATT_RSP_READ_BLOB/GATT_RSP_PREPARE_WRITE: len = %d offset = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", p_msg->attr_value.len, p_msg->attr_value.offset); };}
                                                                          ;
    ...
    default:
        {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "attp_build_sr_msg: unknown op code = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", op_code); };};
        break;
    }

    if (!p_cmd) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "No resources" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    }

    return p_cmd;
}
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
tGATT_STATUS attp_send_sr_msg (tGATT_TCB *p_tcb, BT_HDR *p_msg)
{
    tGATT_STATUS cmd_sent = 0x80;

    if (p_tcb != 
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                ((void *)0)
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                    ) {
        if (p_msg != 
# 467 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                    ((void *)0)
# 467 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                        ) {
            p_msg->offset = 13;
...
# 487 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
tGATT_STATUS attp_cl_send_cmd(tGATT_TCB *p_tcb, UINT16 clcb_idx, UINT8 cmd_code, BT_HDR *p_cmd)
{
    tGATT_STATUS att_ret = 0x00;

    if (p_tcb != 
# 491 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                ((void *)0)
# 491 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                    ) {
        cmd_code &= ~0x80;
        ...
        if (p_tcb->pending_cl_req == p_tcb->next_slot_inq ||
            ...
            if (att_ret == 0x8f || att_ret == 0x00) {

                if (cmd_code != 0x1E && cmd_code != 0x52) {
                    gatt_start_rsp_timer (clcb_idx);
                    gatt_cmd_enq(p_tcb, clcb_idx, 
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                 0
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                                      , cmd_code, 
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                                                  ((void *)0)
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
            ...
            att_ret = 0x86;
            gatt_cmd_enq(p_tcb, clcb_idx, 
# 509 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                                         1
# 509 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                             , cmd_code, p_cmd);
        }
    } else {
        att_ret = 0x85;
...
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
tGATT_STATUS attp_send_cl_msg (tGATT_TCB *p_tcb, UINT16 clcb_idx, UINT8 op_code, tGATT_CL_MSG *p_msg)
{
    tGATT_STATUS status = 0x80;
    BT_HDR *p_cmd = 
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                            ((void *)0)
# 536 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                                ;
    UINT16 offset = 0, handle;

    if (p_tcb != 
# 539 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                ((void *)0)
# 539 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                    ) {
        switch (op_code) {
        case 0x02:
            if (p_msg->mtu <= 517) {
                p_tcb->payload_size = p_msg->mtu;
                p_cmd = attp_build_mtu_cmd(0x02, p_msg->mtu);
            } else {
                status = 0x87;
            }
            break;
        ...
        case 0x08:
        case 0x10:
            if (((p_msg->browse.s_handle) != 0) &&
                    ((p_msg->browse.e_handle) != 0) &&
        ...
        case 0x0A:
            handle = (op_code == 0x0A) ? p_msg->handle : p_msg->read_blob.handle;
        ...
        if (p_cmd != 
# 617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c" 3 4
                    ((void *)0)
# 617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/att_protocol.c"
                        ) {
            status = attp_cl_send_cmd(p_tcb, clcb_idx, op_code, p_cmd);
        }

    } else {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "Peer device not connected" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    }
