# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 2
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
static BT_HDR *avrc_vendor_msg(tAVRC_MSG_VENDOR *p_msg)
{
    ...
    ((p_msg != 
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 3 4
   ((void *)0)
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c", 54, __func__, "p_msg != NULL"));


    ((660 > (20 + p_msg->vendor_len)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c", 57, __func__, "AVRC_META_CMD_BUF_SIZE > (AVRC_MIN_CMD_LEN + p_msg->vendor_len)"));
    if ((p_cmd = (BT_HDR *) malloc((660))) != 
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 3 4
                                                                  ((void *)0)
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
                                                                      )
...

    {
        ...
        *p_data++ = (p_msg->hdr.subunit_type << 3) | p_msg->hdr.subunit_id;
        *p_data++ = 0x00;
        {*(p_data)++ = (UINT8)((p_msg->company_id) >> 16); *(p_data)++ = (UINT8)((p_msg->company_id) >> 8); *(p_data)++ = (UINT8)(p_msg->company_id); };
...
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
...
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 3 4
                                                             ((void *)0)
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
                                                                 ) {
        p_cmd->offset = 15;
        p_data = (UINT8 *)(p_cmd + 1) + p_cmd->offset;
        *p_data++ = 1;
        ...
        *p_data++ = (0x1F << 3) | 0x07;
        *p_data++ = 0x30;
        memset(p_data, 0xFF, 5);
        p_cmd->len = p_data + 5 - (UINT8 *)(p_cmd + 1) - p_cmd->offset;
        p_cmd->layer_specific = 0x0001;
    }
    return AVCT_MsgReq( handle, label, 0, p_cmd);
}
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
UINT16 AVRC_SubCmd(UINT8 handle, UINT8 label, UINT8 page)
{
    ...
    if ((p_cmd = (BT_HDR *) malloc((288))) != 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c" 3 4
                                                             ((void *)0)
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
                                                                 ) {
        p_cmd->offset = 15;
        p_data = (UINT8 *)(p_cmd + 1) + p_cmd->offset;
        *p_data++ = 1;
        ...
        *p_data++ = 0x31;
        *p_data++ = ((page & 7) << 4) | 7;
        memset(p_data, 0xFF, 4);
        p_cmd->len = p_data + 4 - (UINT8 *)(p_cmd + 1) - p_cmd->offset;
        p_cmd->layer_specific = 0x0001;
    }
    return AVCT_MsgReq( handle, label, 0, p_cmd);
}
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
...
# 223 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_opt.c"
