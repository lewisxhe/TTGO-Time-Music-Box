# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 2

void future_free(future_t *future);

future_t *future_new(void)
{
    future_t *ret = calloc(1, (sizeof(future_t)));
    if (!ret) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_OSI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate memory for return value." "\033[0m" "\n", esp_log_timestamp(), "BT_OSI", __func__); };};
        goto error;
    }

    if (osi_sem_new(&ret->semaphore, 1, 0) != 0) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_OSI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate memory for the semaphore." "\033[0m" "\n", esp_log_timestamp(), "BT_OSI", __func__); };};
        goto error;
    }

    ret->ready_can_be_called = 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
                              1
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
                                  ;
    return ret;
error:;
    future_free(ret);
    return 
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
          ((void *)0)
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
              ;
}
...
future_t *future_new_immediate(void *value)
{
    ...
    ret->result = value;
    ret->ready_can_be_called = 
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
                              0
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
                                   ;
    return ret;
error:;
    future_free(ret);
    return 
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
          ((void *)0)
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
              ;
}
...
{
    ((future != 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
   ((void *)0)
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c", 65, __func__, "future != NULL"));
    ((future->ready_can_be_called) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c", 66, __func__, "future->ready_can_be_called"));

    future->ready_can_be_called = 
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
                                 0
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
                                      ;
    future->result = value;
...
{
    ((future != 
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c" 3 4
   ((void *)0)
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/osi/future.c", 75, __func__, "future != NULL"));


    if (future->semaphore) {
        osi_sem_take(&future->semaphore, 0xffffffffUL);
    }
