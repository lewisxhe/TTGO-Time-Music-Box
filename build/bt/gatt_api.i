# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
...
extern void GATT_ConfigServiceChangeCCC (BD_ADDR remote_bda, BOOLEAN enable,
        tBT_TRANSPORT transport);
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/include/gatt_int.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/include/gatt_int.h"
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 2
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
...
# 1150 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
void GATT_SetIdleTimeout (BD_ADDR bd_addr, UINT16 idle_tout, tBT_TRANSPORT transport)
{
    tGATT_TCB *p_tcb;
    BOOLEAN status = 
# 1153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                            0
# 1153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                 ;

    if ((p_tcb = gatt_find_tcb_by_addr (bd_addr, transport)) != 
# 1155 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                               ((void *)0)
# 1155 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                   ) {
        if (p_tcb->att_lcid == 4) {
            status = L2CA_SetFixedChannelTout (bd_addr, 4, idle_tout);

            if (idle_tout == 0)
                L2CA_SetIdleTimeoutByBdAddr(p_tcb->peer_bda,
                                            0, 2);
        } else {
            status = L2CA_SetIdleTimeout (p_tcb->att_lcid, idle_tout, 
# 1163 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                                     0
# 1163 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                          );
        }
    }

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_SetIdleTimeout idle_tout=%d status=%d(1-OK 0-not performed)" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", idle_tout, status); };}
                                      ;
}
# 1185 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128, tGATT_CBACK *p_cb_info)
{
    ...
    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_Register" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    gatt_dbg_display_uuid(*p_app_uuid128);

    for (i_gatt_if = 0, p_reg = gatt_cb.cl_rcb; i_gatt_if < 8; i_gatt_if++, p_reg++) {
        if (p_reg->in_use && !memcmp(p_app_uuid128->uu.uuid128, p_reg->app_uuid128.uu.uuid128, 16)) {
            {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "application already registered." "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
            return 0;
        }
    }
    ...
    for (i_gatt_if = 0, p_reg = gatt_cb.cl_rcb; i_gatt_if < 8; i_gatt_if++, p_reg++) {
        if (!p_reg->in_use) {
            ...
            p_reg->in_use = 
# 1209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                1
# 1209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                    ;

            break;
        }
    }
    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "allocated gatt_if=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
    return gatt_if;
}
# 1230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
void GATT_Deregister (tGATT_IF gatt_if)
{
    ...
    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_Deregister gatt_if=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};

    if ( (gatt_if == 0) || (p_reg == 
# 1242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                    ((void *)0)
# 1242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                        ) ) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_Deregister with invalid gatt_if: %u" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
        return;
    }
# 1262 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
    for (i = 0, p_tcb = gatt_cb.tcb; i < 4; i++, p_tcb++) {
        if (p_tcb->in_use) {
            if (gatt_get_ch_state(p_tcb) != 0) {
                gatt_update_app_use_link_flag(gatt_if, p_tcb, 
# 1265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                              0
# 1265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                   , 
# 1265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                                     0
# 1265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
            ...
            for (j = 0, p_clcb = &gatt_cb.clcb[j]; j < 12; j++, p_clcb++) {
                if (p_clcb->in_use &&
    ...
    GATT_Listen(gatt_if, 
# 1287 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                        0
# 1287 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                             , 
# 1287 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                               ((void *)0)
# 1287 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
...
# 1307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
void GATT_StartIf (tGATT_IF gatt_if)
{
    ...
    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_StartIf gatt_if=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
    if ((p_reg = gatt_get_regcb(gatt_if)) != 
# 1317 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                            ((void *)0)
# 1317 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                ) {
        start_idx = 0;
        while (gatt_find_the_connected_bda(start_idx, bda, &found_idx, &transport)) {
            p_tcb = gatt_find_tcb_by_addr(bda, transport);
            if (p_reg->app_cb.p_conn_cb && p_tcb) {
                conn_id = ((UINT16) ((((UINT8)(p_tcb->tcb_idx) ) << 8) | ((UINT8) (gatt_if))));
                (*p_reg->app_cb.p_conn_cb)(gatt_if, bda, conn_id, 
# 1323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                                 1
# 1323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                     , 0, transport);
            }
            start_idx = ++found_idx;
        }
...
# 1346 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
BOOLEAN GATT_Connect (tGATT_IF gatt_if, BD_ADDR bd_addr, tBLE_ADDR_TYPE bd_addr_type, BOOLEAN is_direct, tBT_TRANSPORT transport)
{
    tGATT_REG *p_reg;
    BOOLEAN status = 
# 1349 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                    0
# 1349 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                         ;

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_Connect gatt_if=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};


    if ((p_reg = gatt_get_regcb(gatt_if)) == 
# 1354 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                            ((void *)0)
# 1354 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                ) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_Connect - gatt_if =%d is not registered" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
        return (
# 1356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
               0
# 1356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                    );
    }
...
# 1363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                          1
# 1363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                              , bd_addr, 
# 1363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                                         1
# 1363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
            ...
            {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unsupported transport for background connection" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
        }
    }
...
# 1387 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
BOOLEAN GATT_CancelConnect (tGATT_IF gatt_if, BD_ADDR bd_addr, BOOLEAN is_direct)
{
    tGATT_REG *p_reg;
    tGATT_TCB *p_tcb;
    BOOLEAN status = 
# 1391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                          1
# 1391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                              ;
    tGATT_IF temp_gatt_if;
    UINT8 start_idx, found_idx;

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_CancelConnect gatt_if=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};

    if ((gatt_if != 0) && ((p_reg = gatt_get_regcb(gatt_if)) == 
# 1397 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                               ((void *)0)
# 1397 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                   )) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_CancelConnect - gatt_if =%d is not registered" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
        return (
# 1399 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
               0
# 1399 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                    );
    }

    if (is_direct) {
        if (!gatt_if) {
            {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "GATT_CancelConnect - unconditional" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
            start_idx = 0;

            p_tcb = gatt_find_tcb_by_addr(bd_addr, 2);
            if (p_tcb && gatt_num_apps_hold_link(p_tcb)) {
                ...
                {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_CancelConnect - no app found" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
                status = 
# 1415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                        0
# 1415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                             ;
            }
        } else {
        ...
        if (!gatt_if) {
            if (gatt_get_num_apps_for_bg_dev(bd_addr)) {
                ...
                {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_CancelConnect -no app associated with the bg device for unconditional removal" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
                status = 
# 1428 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                        0
# 1428 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                             ;
            }
        } else {
...
# 1450 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
tGATT_STATUS GATT_Disconnect (UINT16 conn_id)
{
    tGATT_STATUS ret = 0x87;
    tGATT_TCB *p_tcb = 
# 1453 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                            ((void *)0)
# 1453 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                ;
    tGATT_IF gatt_if = ((tGATT_IF)((UINT8) (conn_id)));
    UINT8 tcb_idx = ((UINT8) (((UINT16) (conn_id)) >> 8));

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_Disconnect conn_id=%d " "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", conn_id); };};

    p_tcb = gatt_get_tcb_by_idx(tcb_idx);

    if (p_tcb) {
        gatt_update_app_use_link_flag(gatt_if, p_tcb, 
# 1462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                     0
# 1462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                          , 
# 1462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                            0
# 1462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
...
# 1486 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                ...
                                tBT_TRANSPORT *p_transport)
{
    ...
    BOOLEAN status = 
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                            0
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                 ;

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_GetConnectionInfor conn_id=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", conn_id); };};

    if (p_tcb && p_reg ) {
        memcpy(bd_addr, p_tcb->peer_bda, 6);
        *p_gatt_if = gatt_if;
        *p_transport = p_tcb->transport;
        status = 
# 1502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                1
# 1502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                    ;
    }
    return status;
}
# 1523 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                  ...
                                  tBT_TRANSPORT transport)
{
    ...
    BOOLEAN status = 
# 1528 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                            0
# 1528 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                 ;

    if (p_reg && p_tcb && (gatt_get_ch_state(p_tcb) == 4) ) {
        *p_conn_id = ((UINT16) ((((UINT8)(p_tcb->tcb_idx) ) << 8) | ((UINT8) (gatt_if))));
        status = 
# 1532 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                1
# 1532 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                    ;
    }

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_GetConnIdIfConnected status=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", status); };};
    return status;
}
# 1555 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
BOOLEAN GATT_Listen (tGATT_IF gatt_if, BOOLEAN start, BD_ADDR_PTR bd_addr)
{
    tGATT_REG *p_reg;

    {if (gatt_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_GATT", "\033[0;" "32" "m" "I" " (%d) %s: " "GATT_Listen gatt_if=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};


    if ((p_reg = gatt_get_regcb(gatt_if)) == 
# 1562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                            ((void *)0)
# 1562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                ) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "GATT_Listen - gatt_if =%d is not registered" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", gatt_if); };};
        return (
# 1564 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
               0
# 1564 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                    );
    }

    if (bd_addr != 
# 1567 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                  ((void *)0)
# 1567 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                      ) {
        gatt_update_auto_connect_dev(gatt_if, start, bd_addr, 
# 1568 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c" 3 4
                                                             0
# 1568 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_api.c"
                                                                  );
    } else {
        p_reg->listening = start ? 0xff : 0;
    }
