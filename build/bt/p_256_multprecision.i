# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/p_256_multprecision.c" 2
...
void multiprecision_fast_mod(DWORD *c, DWORD *a)
{
    ...
    if (V) {
        multiprecision_sub(c, c, modp, 6);
    } else if (multiprecision_compare(c, modp, 6) >= 0) {
        multiprecision_sub(c, c, modp, 6);
    }
}
...
void multiprecision_fast_mod_P256(DWORD *c, DWORD *a)
{
    ...
    if (U & 0x80000000) {
        while (U) {
            multiprecision_add(c, c, modp, 8);
            U++;
        }
    } else if (U) {
        while (U) {
            multiprecision_sub(c, c, modp, 8);
            U--;
        }
    }

    if (multiprecision_compare(c, modp, 8) >= 0) {
        multiprecision_sub(c, c, modp, 8);
    }
