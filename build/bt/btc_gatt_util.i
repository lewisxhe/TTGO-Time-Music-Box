# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
void btc128_to_bta_uuid(tBT_UUID *p_dest, uint8_t *p_src)
{
    ...
    default:
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unknown UUID length %d!" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, p_dest->len); };};
        break;
    }
}
...
void btc_to_bta_uuid(tBT_UUID *p_dest, esp_bt_uuid_t *p_src)
{
    ...
    } else if (p_src->len == 16) {
        memcpy(&p_dest->uu.uuid128, p_src->uuid.uuid128, p_dest->len);
    } else if (p_src->len == 0) {

    } else {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s UUID len is invalid %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __func__, p_src->len); };};
    }
}
...
void btc_to_bta_response(tBTA_GATTS_RSP *p_dest, esp_gatt_rsp_t *p_src)
{
    ...
    memcpy(p_dest->attr_value.value, p_src->attr_value.value, 600);
}
...
uint16_t get_uuid16(tBT_UUID *p_uuid)
{
    ...
    } else if (p_uuid->len == 16) {
        UINT16 u16;
        UINT8 *p = &p_uuid->uu.uuid128[16 - 4];
...
uint16_t set_read_value(uint8_t *gattc_if, esp_ble_gattc_cb_param_t *p_dest, tBTA_GATTC_READ *p_src)
{
    ...
    p_dest->read.conn_id = (((uint16_t)(p_src->conn_id)) >> 8);
    *gattc_if = ((uint8_t)(p_src->conn_id));
    p_dest->read.status = p_src->status;
    p_dest->read.handle = p_src->handle;

    if (( p_src->status == 0x00 ) && (p_src->p_value != 
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 3 4
                                                              ((void *)0)
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
                                                                  ))
    {
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s len = %d " "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __func__, p_src->p_value->len); };};
        p_dest->read.value_len = p_src->p_value->len;
        if ( p_src->p_value->len > 0 && p_src->p_value->p_value != 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 3 4
                                                                   ((void *)0) 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
                                                                        ) {
