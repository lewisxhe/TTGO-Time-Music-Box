# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 2
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
BOOLEAN AVRC_IsValidAvcType(UINT8 pdu_id, UINT8 avc_type)
{
    BOOLEAN result = 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    0
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                         ;
    ...
    if (avc_type < 8) {
        ...
        case 0x30:
            if (avc_type == 1) {
                result = 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                        1
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                            ;
            }
            break;
        ...
        case 0x41:
            if (avc_type == 0) {
                result = 
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                        1
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                            ;
            }
            break;
        ...
        case 0x31:
            if (avc_type == 3) {
                result = 
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                        1
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                            ;
            }
            break;
        }
        ...
        if (avc_type >= 8 &&
                avc_type <= 15 ) {
            result = 
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    1
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                        ;
        }
    }
...
# 91 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
BOOLEAN avrc_is_valid_player_attrib_value(UINT8 attrib, UINT8 value)
{
    BOOLEAN result = 
# 93 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    0
# 93 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                         ;
    ...
    case 0x01:
        if ((value > 0) &&
                (value <= 0x02)) {
            result = 
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    1
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                        ;
        }
        break;
    ...
    case 0x02:
        if ((value > 0) &&
                (value <= 0x04)) {
            result = 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    1
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                        ;
        }
        break;
    ...
    case 0x04:
        if ((value > 0) &&
                (value <= 0x03)) {
            result = 
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    1
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                        ;
        }
        break;
    }
    ...
    if (attrib >= 0x80) {
        result = 
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                1
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                    ;
    }

    if (!result)
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_is_valid_player_attrib_value() found not matching attrib(x%x)-value(x%x) pair!" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", attrib, value); };}

                          ;

    return result;
}
# 140 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
BOOLEAN AVRC_IsValidPlayerAttr(UINT8 attr)
{
    BOOLEAN result = 
# 142 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                    0
# 142 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                         ;

    if ( (attr >= 0x01 && attr <= 0x04) ||
            (attr >= 0x80) ) {
        result = 
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                1
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                    ;
    }

    return result;
}
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
tAVRC_STS avrc_pars_pass_thru(tAVRC_MSG_PASS *p_msg, UINT16 *p_vendor_unique_id)
{
    UINT8 *p_data;
    UINT32 co_id;
    UINT16 id;
    tAVRC_STS status = 0x00;

    if (p_msg->op_id == 0x7E && p_msg->pass_len == 5) {
        p_data = p_msg->p_pass_data;
        {co_id = (((UINT32)(*((p_data) + 2))) + (((UINT32)(*((p_data) + 1))) << 8) + (((UINT32)(*(p_data))) << 16)); (p_data) += 3;};
        if (co_id == 0x00001958) {
            {id = (UINT16)(((UINT16)(*(p_data)) << 8) + (UINT16)(*((p_data) + 1))); (p_data) += 2;};
            if (((id <= 0x01) ? 
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
               1 
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
               : 
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
               0
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
...
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
...
# 222 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
BOOLEAN avrc_is_valid_opcode(UINT8 opcode)
{
    BOOLEAN is_valid = 
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                      0
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                           ;
    switch (opcode) {
    case 0xFF:
    case 0x7C:
    case 0x00:
        is_valid = 
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c" 3 4
                  1
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_utils.c"
                      ;
        break;
    }
    return is_valid;
