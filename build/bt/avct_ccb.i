# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 2
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
tAVCT_CCB *avct_ccb_alloc(tAVCT_CC *p_cc)
{
    ...
    for (i = 0; i < 3; i++, p_ccb++) {
        if (!p_ccb->allocated) {
            p_ccb->allocated = 0x01;
            memcpy(&p_ccb->cc, p_cc, sizeof(tAVCT_CC));
            {if (avct_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVCT", "D" " (%d) %s: " "avct_ccb_alloc %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVCT", i); };};
            break;
        }
    }
    ...
    if (i == 3) {
        ...
        p_ccb = 
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 3 4
               ((void *)0)
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
                   ;
        {if (avct_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVCT", "\033[0;" "33" "m" "W" " (%d) %s: " "Out of ccbs" "\033[0m" "\n", esp_log_timestamp(), "BT_AVCT"); };};
    }
    return p_ccb;
}
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
void avct_ccb_dealloc(tAVCT_CCB *p_ccb, UINT8 event, UINT16 result, BD_ADDR bd_addr)
{
    ...
    {if (avct_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVCT", "D" " (%d) %s: " "avct_ccb_dealloc %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVCT", avct_ccb_to_idx(p_ccb)); };};
# 91 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
...
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
UINT8 avct_ccb_to_idx(tAVCT_CCB *p_ccb)
{

    return (UINT8) (p_ccb - avct_cb.ccb);
}
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
tAVCT_CCB *avct_ccb_by_idx(UINT8 idx)
{
    ...
    if (idx < 3) {
        ...
        if (!p_ccb->allocated) {
            p_ccb = 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 3 4
                   ((void *)0)
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
                       ;
            {if (avct_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVCT", "\033[0;" "33" "m" "W" " (%d) %s: " "ccb %d not allocated" "\033[0m" "\n", esp_log_timestamp(), "BT_AVCT", idx); };};
        }
    } else {
        p_ccb = 
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c" 3 4
               ((void *)0)
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avct/avct_ccb.c"
                   ;
        {if (avct_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVCT", "\033[0;" "33" "m" "W" " (%d) %s: " "No ccb for idx %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVCT", idx); };};
    }
    return p_ccb;
}
