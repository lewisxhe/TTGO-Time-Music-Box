# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 2
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
UINT32 avdt_scb_gen_ssrc(tAVDT_SCB *p_scb)
{

    return ((UINT32)(p_scb->cs.cfg.codec_info[1] | p_scb->cs.cfg.codec_info[2]));
}
# 91 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_abort_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    p_scb->role = 0;
    avdt_scb_event(p_scb, AVDT_SCB_API_ABORT_RSP_EVT, p_data);
}
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_close_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    p_scb->role = 0;
    avdt_scb_event(p_scb, AVDT_SCB_API_CLOSE_RSP_EVT, p_data);
}
# 140 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_close_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    p_scb->close_code = p_data->msg.hdr.err_code;
}
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_open_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    avdt_scb_event(p_scb, AVDT_SCB_API_OPEN_RSP_EVT, p_data);
}
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_open_rej(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    avdt_scb_hdl_setconfig_rej(p_scb, p_data);
}
# 223 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_open_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    p_scb->role = 3;
    avdt_ad_open_req(AVDT_CHAN_MEDIA, p_scb->p_ccb, p_scb, 0);


    btu_start_timer(&p_scb->timer_entry, 64, 10);
}
# 244 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_pkt_no_frag(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    o_v = *(p) >> 6; o_p = (*(p) >> 5) & 0x01; o_x = (*(p) >> 4) & 0x01; o_cc = *(p)++ & 0x0F;;
    marker = *(p) >> 7; m_pt = *(p)++ & 0x7F;;
    {seq = (UINT16)(((UINT16)(*(p)) << 8) + (UINT16)(*((p) + 1))); (p) += 2;};
    {time_stamp = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
    p += 4;
    ...
    if (o_x) {
        p += 2;
        {ex_len = (UINT16)(((UINT16)(*(p)) << 8) + (UINT16)(*((p) + 1))); (p) += 2;};
        p += ex_len * 4;
    }
    ...
    if ((offset > p_data->p_pkt->len) || ((pad_len + offset) > p_data->p_pkt->len)) {
        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Got bad media packet" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        free((p_data->p_pkt));
        p_data->p_pkt = 
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 290 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ;
    }
        ...
        if (p_scb->cs.p_data_cback != 
# 297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                     ((void *)0)
# 297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                         ) {
            ...
            if ((p_scb->cs.p_media_cback != 
# 304 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                           ((void *)0)
# 304 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                               )
                    && (p_scb->p_media_buf != 
# 305 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                             ((void *)0)
# 305 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                 )
            ...
            free((p_data->p_pkt));
            p_data->p_pkt = 
# 315 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                           ((void *)0)
# 315 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                               ;
        }
    }
}
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
UINT8 *avdt_scb_hdl_report(tAVDT_SCB *p_scb, UINT8 *p, UINT16 len)
{
    ...
    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt_scb_hdl_report" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
    if (p_scb->cs.p_report_cback) {
        p_rpt = &report;

        o_v = *(p) >> 6; o_p = (*(p) >> 5) & 0x01; o_cc = *(p)++ & 0x1F;;
        pt = *p++;
        p += 2;
        {ssrc = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
        ...
        switch (pt) {
        case 200:
            {report.sr.ntp_sec = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.sr.ntp_frac = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.sr.rtp_time = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.sr.pkt_count = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.sr.octet_count = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            break;

        case 201:
            report.rr.frag_lost = *p;
            {report.rr.packet_lost = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            report.rr.packet_lost &= 0xFFFFFF;
            {report.rr.seq_num_rcvd = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.rr.jitter = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.rr.lsr = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            {report.rr.dlsr = ((UINT32)(*((p) + 3)) + ((UINT32)(*((p) + 2)) << 8) + ((UINT32)(*((p) + 1)) << 16) + ((UINT32)(*(p)) << 24)); (p) += 4;};
            break;
        ...
        case 202:
            if (*p == 1) {
                ...
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " " - SDES SSRC=0x%08x sc=%d %d len=%d %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", ssrc, o_cc, *p, *(p + 1), p + 2); };}
                                                                    ;
                result = 4;
            }
            break;
        ...
        default:
            {if (avdt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVDT", "\033[0;" "31" "m" "E" " (%d) %s: " "Bad Report pkt - packet type: %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", pt); };};
            result = 1;
        }
...
# 405 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_pkt_frag(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    while (p < p_end) {
        if (p_end - p < 4) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "p_end: %p - p:%p < 4\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_end, p); };};
            break;
        }
        ...
        case 0x00:
            ...
            break;
        case 0x01:
            {al_len = (UINT16)(((UINT16)(*(p)) << 8) + (UINT16)(*((p) + 1))); (p) += 2;};
            break;
        case 0x02:
            al_len = *p++;
            break;
        ...
        if (al_tsid != p_scb->curr_cfg.mux_tsid_media) {
            ...
            if ((p_scb->curr_cfg.psc_mask & (1<<2)) &&
            ...
            {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "bad tsid: %d, mux_tsid_media:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_tsid, p_scb->curr_cfg.mux_tsid_media); };};
                break;
            }
        }

        else if ((p_scb->p_media_buf == 
# 484 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                       ((void *)0)
# 484 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                           ) || (p_scb->cs.p_media_cback == 
# 484 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                            ((void *)0)
# 484 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                )) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "NULL p_media_buf or p_media_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
            break;
        }
        ...
        if (!al_frag) {
            {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "al:%d media:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_len, p_scb->media_buf_len); };}
                                                          ;

            p_scb->frag_off = 0;
            p_scb->frag_org_len = al_len;

            if (p_scb->frag_org_len < 12) {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "bad al_len: %d(<12)\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_len); };};
                break;
            }

            if (al_len > p_scb->media_buf_len) {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "bad al_len: %d(>%d)\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_len, p_scb->media_buf_len); };};
                break;
            }
            ...
            {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "al:%d media:%d frag_org_len:%d frag_off:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_len, p_scb->media_buf_len, p_scb->frag_org_len, p_scb->frag_off); };}
                                                                                                ;


            if (al_len != p_scb->frag_org_len - p_scb->frag_off) {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "al_len:%d != (frag_org_len:%d - frag_off:%d) %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", al_len, p_scb->frag_org_len, p_scb->frag_off, (p_scb->frag_org_len - p_scb->frag_off)); };}
            ...
            if (p_scb->frag_off == 0) {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "frag_off=0" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
                break;
            }
        }

        if ((p_scb->frag_org_len <= p_scb->frag_off) || (p_scb->frag_org_len >= p_scb->media_buf_len)) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "common sanity frag_off:%d frag_org_len:%d media_buf_len:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_scb->frag_off, p_scb->frag_org_len, p_scb->media_buf_len); };}
                                                                                          ;
            break;
        }

        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Received fragment org_len=%d off=%d al_len=%d frag_len=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_scb->frag_org_len, p_scb->frag_off, al_len, frag_len); };}
                                                                                ;
        ...
        if (p_scb->frag_off == p_scb->frag_org_len) {
            ...
            o_v = *(p_payload) >> 6; o_p = (*(p_payload) >> 5) & 0x01; o_x = (*(p_payload) >> 4) & 0x01; o_cc = *(p_payload)++ & 0x0F;;
            marker = *(p_payload) >> 7; m_pt = *(p_payload)++ & 0x7F;;
            {seq = (UINT16)(((UINT16)(*(p_payload)) << 8) + (UINT16)(*((p_payload) + 1))); (p_payload) += 2;};
            {time_stamp = ((UINT32)(*((p_payload) + 3)) + ((UINT32)(*((p_payload) + 2)) << 8) + ((UINT32)(*((p_payload) + 1)) << 16) + ((UINT32)(*(p_payload)) << 24)); (p_payload) += 4;};
            {ssrc = ((UINT32)(*((p_payload) + 3)) + ((UINT32)(*((p_payload) + 2)) << 8) + ((UINT32)(*((p_payload) + 1)) << 16) + ((UINT32)(*(p_payload)) << 24)); (p_payload) += 4;};
            ...
            if (o_x) {
                if (p_scb->p_media_buf + p_scb->frag_off - p_payload < 4) {
                    {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "length check frag_off:%d p_media_buf:%p p_payload:%p\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_scb->frag_off, p_scb->p_media_buf, p_payload); };}
                                                                                      ;
                    break;
                }
                p_payload += 2;
                {ex_len = (UINT16)(((UINT16)(*(p_payload)) << 8) + (UINT16)(*((p_payload) + 1))); (p_payload) += 2;};
                p_payload += ex_len * 4;
            }

            if (p_payload >= p_scb->p_media_buf + p_scb->frag_off) {
                {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "length check2 frag_off:%d p_media_buf:%p p_payload:%p\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_scb->frag_off, p_scb->p_media_buf, p_payload); };}
                                                                                  ;
                break;
            }
            ...
            {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Received last fragment header=%d len=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_payload - p_scb->p_media_buf, payload_len); };}
                                                                         ;


            if (p_scb->cs.p_media_cback != 
# 594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                          ((void *)0)
# 594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                              ) {
    ...
    free((p_data->p_pkt));
    p_data->p_pkt = 
# 605 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                   ((void *)0)
# 605 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                       ;
}
# 618 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_pkt(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if ( 0 != (p_scb->curr_cfg.psc_mask & (1<<6))) {
        ...
        free((p_data->p_pkt));
        p_data->p_pkt = 
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ;
        } else

            avdt_scb_hdl_pkt_no_frag(p_scb, p_data);
}
# 651 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_drop_pkt(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_scb);

    {if (avdt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVDT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s dropped incoming media packet" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", __func__); };};
    free((p_data->p_pkt));
    p_data->p_pkt = 
# 657 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                   ((void *)0)
# 657 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                       ;
}
# 670 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_reconfig_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    if (p_scb->cs.nsc_mask & 0x02) {

        p_data->msg.hdr.err_code = 0x19;
...
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                 ((void *)0)
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                     ,
                                  12,
                                  (tAVDT_CTRL *) &p_data->msg.reconfig_cmd);
    }
}
# 700 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_reconfig_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    if (p_data->msg.hdr.err_code == 0) {
        ...
        if (p_scb->req_cfg.num_codec > 0) {
            ...
            memcpy(p_scb->curr_cfg.codec_info, p_scb->req_cfg.codec_info, 10);
        }
        if (p_scb->req_cfg.num_protect > 0) {
            p_scb->curr_cfg.num_protect = p_scb->req_cfg.num_protect;
            memcpy(p_scb->curr_cfg.protect_info, p_scb->req_cfg.protect_info, 90);
        }
    }
...
# 718 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 718 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 ,
                              11,
                              (tAVDT_CTRL *) &p_data->msg.svccap);
}
# 733 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_security_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    if (p_scb->cs.nsc_mask & 0x04) {
...
# 743 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                 ((void *)0)
# 743 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                     ,
                                  14,
                                  (tAVDT_CTRL *) &p_data->msg.security_cmd);
    }
}
# 759 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_security_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              
# 763 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 763 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 ,
                              13,
                              (tAVDT_CTRL *) &p_data->msg.security_cmd);
}
# 779 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_setconfig_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (!p_scb->in_use) {
        ...
        if (p_scb->cs.cfg.codec_info[2] == p_cfg->codec_info[2]) {

            p_scb->in_use = 
# 787 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                           1
# 787 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                               ;
            ...
            (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                                      p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 795 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                              ((void *)0)
# 795 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                  ,
                                      4,
                                      (tAVDT_CTRL *) &p_data->msg.config_cmd);
        } else {
            p_data->msg.hdr.err_code = 0x29;
            p_data->msg.hdr.err_param = 0;
...
# 819 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_setconfig_rej(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_ccb_event(avdt_ccb_by_idx(p_data->msg.hdr.ccb_idx), AVDT_CCB_UL_CLOSE_EVT, 
# 825 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                                   ((void *)0)
# 825 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                       );


    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              
# 829 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 829 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 ,
                              2,
                              (tAVDT_CTRL *) &p_data->msg.hdr);
}
# 844 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_setconfig_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_scb->p_ccb != 
# 849 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 849 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
...
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_start_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 874 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 874 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              6,
                              
# 876 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 876 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 );
}
# 889 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_start_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 892 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 892 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              5,
                              (tAVDT_CTRL *) &p_data->msg.hdr);
}
# 907 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_suspend_cmd(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 912 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 912 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              8,
                              
# 914 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 914 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 );
}
# 927 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_suspend_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 930 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 930 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              7,
                              (tAVDT_CTRL *) &p_data->msg.hdr);
}
# 950 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_tc_close(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    memcpy (remote_addr, p_ccb->peer_addr, 6);
    ...
    p_scb->media_seq = 0;
    p_scb->cong = 
# 973 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                 0
# 973 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                      ;


    if (p_scb->p_pkt != 
# 976 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 976 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        free((p_scb->p_pkt));
        p_scb->p_pkt = 
# 978 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                      ((void *)0)
# 978 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                          ;
    }
    ...
    if ((p_scb->role == 1) || (p_scb->role == 3)) {

        avdt_ccb_event(p_ccb, AVDT_CCB_UL_CLOSE_EVT, 
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                    ((void *)0)
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                        );
    }
    event = (p_scb->role == 1) ? 9 : 10;
    p_scb->role = 0;

    if (p_scb->remove) {
        avdt_scb_dealloc(p_scb, 
# 992 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                               ((void *)0)
# 992 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                   );
    }
...
# 1009 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_delay_rpt_req (tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 13, (tAVDT_MSG *) &p_data->apidelay);
}
# 1024 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_delay_rpt_cmd (tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 1027 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 1027 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              20,
                              (tAVDT_CTRL *) &p_data->msg.hdr);

    if (p_scb->p_ccb) {
        avdt_msg_send_rsp(p_scb->p_ccb, 13, &p_data->msg);
    } else {
        avdt_scb_rej_not_in_use(p_scb, p_data);
    }
}
# 1048 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_delay_rpt_rsp (tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 1051 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 1051 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              21,
                              (tAVDT_CTRL *) &p_data->msg.hdr);
}
# 1067 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_tc_close_sto(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_data && p_data->close.type != AVDT_CHAN_MEDIA) {
        ...
        if (p_data->close.old_tc_state == 6) {
            avdt_ctrl.hdr.err_code = 0;
            avdt_ctrl.hdr.err_param = 0;

            (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                                      p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 1079 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                              ((void *)0)
# 1079 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                  ,
                                      19, &avdt_ctrl);
        }
    } else {

        avdt_scb_event(p_scb, AVDT_SCB_MSG_ABORT_RSP_EVT, 
# 1084 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                         ((void *)0)
# 1084 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                             );
        avdt_scb_hdl_tc_close(p_scb, p_data);
    }
}
# 1102 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_tc_open(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    event = (p_scb->role == 3) ? 2 : 3;
    p_data->open.hdr.err_code = 0;

    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "psc_mask: cfg: 0x%x, req:0x%x, cur: 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_scb->cs.cfg.psc_mask, p_scb->req_cfg.psc_mask, p_scb->curr_cfg.psc_mask); };}
                                                                                               ;

    if (p_scb->curr_cfg.psc_mask & (1<<2)) {

        role = (p_scb->role == 3) ? 0 : 1;
    ...
    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 1127 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                      ((void *)0)
# 1127 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                          ,
                              event,
                              (tAVDT_CTRL *) &p_data->open);
}
# 1145 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_tc_open_sto(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_data->open.hdr.err_code == AVDT_CHAN_REPORT) {
        ...
        (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                                  p_scb->p_ccb ? p_scb->p_ccb->peer_addr : 
# 1155 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                          ((void *)0)
# 1155 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                              ,
                                  18, &avdt_ctrl);
    }
}
# 1172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_write_req_no_frag(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_scb->p_pkt != 
# 1178 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 1178 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        free((p_scb->p_pkt));
        p_scb->p_pkt = 
# 1180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                      ((void *)0)
# 1180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                          ;


        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Dropped media packet; congested" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
    }



    if ( !(p_data->apiwrite.opt & (0x01 << 0)) ) {
        ssrc = avdt_scb_gen_ssrc(p_scb);

        p_data->apiwrite.p_buf->len += 12;
        p_data->apiwrite.p_buf->offset -= 12;
        p_scb->media_seq++;
        p = (UINT8 *)(p_data->apiwrite.p_buf + 1) + p_data->apiwrite.p_buf->offset;

        {*(p)++ = (UINT8)(0x80);};
        {*(p)++ = (UINT8)(p_data->apiwrite.m_pt);};
        {*(p)++ = (UINT8)((p_scb->media_seq) >> 8); *(p)++ = (UINT8)(p_scb->media_seq);};
        {*(p)++ = (UINT8)((p_data->apiwrite.time_stamp) >> 24); *(p)++ = (UINT8)((p_data->apiwrite.time_stamp) >> 16); *(p)++ = (UINT8)((p_data->apiwrite.time_stamp) >> 8); *(p)++ = (UINT8)(p_data->apiwrite.time_stamp); };
        {*(p)++ = (UINT8)((ssrc) >> 24); *(p)++ = (UINT8)((ssrc) >> 16); *(p)++ = (UINT8)((ssrc) >> 8); *(p)++ = (UINT8)(ssrc); };
    }


    p_scb->p_pkt = p_data->apiwrite.p_buf;
}
# 1218 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_hdl_write_req_frag(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (!fixed_queue_is_empty(p_scb->frag_q))
    {
        ...
        {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "*** Dropped media packet; congested" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
        BT_HDR *p_frag;
        while ((p_frag = (BT_HDR*)fixed_queue_try_dequeue(p_scb->frag_q)) != 
# 1229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                            ((void *)0)
# 1229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                )
             free((p_frag));
    }
    ...
    if (! fixed_queue_is_empty(p_scb->frag_q)) {
        ...
        if (node != list_end(list)) {
            ...
            *p++ = (p_scb->curr_cfg.mux_tsid_media<<3) | 0x01;


            {*(p)++ = (UINT8)((p_frag->layer_specific + 12) >> 8); *(p)++ = (UINT8)(p_frag->layer_specific + 12);};
        ...
        for ( ; node != list_end(list); node = list_next(node)) {
            ...
            *p++ = (p_scb->curr_cfg.mux_tsid_media << 3) |
            ...
            {*(p)++ = (UINT8)((p_frag->layer_specific) >> 8); *(p)++ = (UINT8)(p_frag->layer_specific);};
        }
    }
}
# 1301 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 1323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_abort_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_scb->p_ccb != 
# 1328 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 1328 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        p_scb->role = 1;

        hdr.seid = p_scb->peer_seid;

        avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 10, (tAVDT_MSG *) &hdr);
    }
}
# 1346 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_abort_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_scb);

    avdt_msg_send_rsp(avdt_ccb_by_idx(p_data->msg.hdr.ccb_idx), 10,
                      &p_data->msg);
}
# 1363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_close_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 8, (tAVDT_MSG *) &hdr);
}
# 1384 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_stream_close(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s c:%d, off:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", __func__, fixed_queue_length(p_scb->frag_q), p_scb->frag_off); };}
                                                           ;


    BT_HDR *p_frag;
    while ((p_frag = (BT_HDR*)fixed_queue_try_dequeue(p_scb->frag_q)) != 
# 1392 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                        ((void *)0)
# 1392 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                            ) {
        free((p_frag));
    }
    p_scb->frag_off = 0;
    ...
    if (p_scb->p_pkt) {
        free((p_scb->p_pkt));
        p_scb->p_pkt = 
# 1399 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                      ((void *)0)
# 1399 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                          ;
    }

    avdt_scb_snd_close_req(p_scb, p_data);
}
# 1414 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_close_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    avdt_msg_send_rsp(p_scb->p_ccb, 8, &p_data->msg);
}
# 1428 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_getconfig_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 4, (tAVDT_MSG *) &hdr);
}
# 1447 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_getconfig_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    avdt_msg_send_rsp(p_scb->p_ccb, 4, &p_data->msg);
}
# 1461 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_open_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 6, (tAVDT_MSG *) &hdr);
}
# 1482 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_open_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{

    p_scb->role = 2;
    avdt_ad_open_req(AVDT_CHAN_MEDIA, p_scb->p_ccb, p_scb, 1);


    avdt_msg_send_rsp(p_scb->p_ccb, 6, &p_data->msg);


    btu_start_timer(&p_scb->timer_entry, 64, 10);
}
# 1505 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_reconfig_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 5, &p_data->msg);
}
# 1522 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_reconfig_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    if (p_data->msg.hdr.err_code == 0) {
        ...
        avdt_msg_send_rsp(p_scb->p_ccb, 5, &p_data->msg);
    } else {

        avdt_msg_send_rej(p_scb->p_ccb, 5, &p_data->msg);
    }
}
# 1552 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_security_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    p_data->msg.hdr.seid = p_scb->peer_seid;
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 11, &p_data->msg);
}
# 1567 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_security_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    if (p_data->msg.hdr.err_code == 0) {
        avdt_msg_send_rsp(p_scb->p_ccb, 11, &p_data->msg);
    } else {
        avdt_msg_send_rej(p_scb->p_ccb, 11, &p_data->msg);
    }
}
# 1586 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_setconfig_rej(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    if (p_scb->p_ccb != 
# 1588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 1588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        avdt_msg_send_rej(p_scb->p_ccb, 3, &p_data->msg);


        avdt_scb_clr_vars(p_scb, p_data);
    }
}
# 1608 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_setconfig_req(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    p_scb->in_use = 
# 1613 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                   1
# 1613 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                       ;
    p_scb->p_ccb = avdt_ccb_by_idx(p_data->msg.config_cmd.hdr.ccb_idx);
    ...
    avdt_msg_send_cmd(p_scb->p_ccb, p_scb, 3, &p_data->msg);


    avdt_ccb_event(p_scb->p_ccb, AVDT_CCB_UL_OPEN_EVT, 
# 1631 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                      ((void *)0)
# 1631 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                          );
}
# 1645 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_snd_setconfig_rsp(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    if (p_scb->p_ccb != 
# 1647 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 1647 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        memcpy(&p_scb->curr_cfg, &p_scb->req_cfg, sizeof(tAVDT_CFG));

        avdt_msg_send_rsp(p_scb->p_ccb, 3, &p_data->msg);
    }
}
# 1664 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 1686 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_cb_err(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    avdt_ctrl.hdr.err_code = 0x31;
    avdt_ctrl.hdr.err_param = 0;


    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb),
                              
# 1697 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                             ((void *)0)
# 1697 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                 ,
                              avdt_scb_cback_evt[p_scb->curr_evt],
                              &avdt_ctrl);
}
# 1712 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_cong_state(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    p_scb->cong = p_data->llcong;
}
# 1727 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_rej_state(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_scb);

    p_data->msg.hdr.err_code = 0x31;
    p_data->msg.hdr.err_param = 0;
    avdt_msg_send_rej(avdt_ccb_by_idx(p_data->msg.hdr.ccb_idx),
                      p_data->msg.hdr.sig_id, &p_data->msg);
}
# 1747 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_rej_in_use(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_scb);

    p_data->msg.hdr.err_code = 0x13;
    p_data->msg.hdr.err_param = 0;
    avdt_msg_send_rej(avdt_ccb_by_idx(p_data->msg.hdr.ccb_idx),
                      p_data->msg.hdr.sig_id, &p_data->msg);
}
# 1767 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_rej_not_in_use(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_scb);

    p_data->msg.hdr.err_code = 0x14;
    p_data->msg.hdr.err_param = 0;
    avdt_msg_send_rej(avdt_ccb_by_idx(p_data->msg.hdr.ccb_idx),
                      p_data->msg.hdr.sig_id, &p_data->msg);
}
# 1786 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_set_remove(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_data);

    p_scb->remove = 
# 1790 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                   1
# 1790 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                       ;
}
# 1802 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_free_pkt(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if (p_data->apiwrite.p_buf) {
        free((p_data->apiwrite.p_buf));
        p_data->apiwrite.p_buf = 
# 1813 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                ((void *)0)
# 1813 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                    ;
    }
    ...
    BT_HDR *p_frag;
    while ((p_frag = (BT_HDR*)fixed_queue_try_dequeue(p_scb->frag_q)) != 
# 1819 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                        ((void *)0)
# 1819 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                            ) {
         free((p_frag));
 }


    {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "Dropped media packet" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};


    (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb), 
# 1827 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                     ((void *)0)
# 1827 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                         , 15,
                              &avdt_ctrl);
}
# 1840 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_clr_pkt(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    if ((p_ccb = p_scb->p_ccb) != 
# 1852 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                 ((void *)0)
# 1852 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                     ) {

        tcid = avdt_ad_type_to_tcid(AVDT_CHAN_MEDIA, p_scb);

        lcid = avdt_cb.ad.rt_tbl[avdt_ccb_to_idx(p_ccb)][tcid].lcid;
        L2CA_FlushChannel (lcid, 0xffff);
    }

    if (p_scb->p_pkt != 
# 1860 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       ((void *)0)
# 1860 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ) {
        free((p_scb->p_pkt));
        p_scb->p_pkt = 
# 1862 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                      ((void *)0)
# 1862 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                          ;

        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Dropped stored media packet" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};


        (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb), 
# 1867 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                         ((void *)0)
# 1867 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                             , 15,
                                  &avdt_ctrl);
    }

    else if (!fixed_queue_is_empty(p_scb->frag_q)) {
        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Dropped fragments queue" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};

        BT_HDR *p_frag;
        while ((p_frag = (BT_HDR*)fixed_queue_try_dequeue(p_scb->frag_q)) != 
# 1875 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                            ((void *)0)
# 1875 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                ) {
             free((p_frag));
  }
        p_scb->frag_off = 0;
        ...
        (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb), 
# 1881 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                         ((void *)0)
# 1881 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                             , 15,
                                  &avdt_ctrl);
    }

}
# 1900 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_chk_snd_pkt(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    ...
    BOOLEAN sent = 
# 1905 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                          0
# 1905 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                               ;
    UINT8 res = 
# 1906 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                 1
# 1906 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                ;
    tAVDT_SCB_EVT data;
    ...
    if (!p_scb->cong) {
        if (p_scb->p_pkt != 
# 1914 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                           ((void *)0)
# 1914 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                               ) {
            p_pkt = p_scb->p_pkt;
            p_scb->p_pkt = 
# 1916 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                          ((void *)0)
# 1916 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                              ;
            avdt_ad_write_req(AVDT_CHAN_MEDIA, p_scb->p_ccb, p_scb, p_pkt);

            (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb), 
# 1919 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                             ((void *)0)
# 1919 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                 , 15, &avdt_ctrl);
        }
            ...
            while ((p_pkt = (BT_HDR*)fixed_queue_try_dequeue(p_scb->frag_q)) != 
# 1928 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                               ((void *)0)
# 1928 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                                   ) {
                sent = 
# 1929 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                      1
# 1929 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                          ;
                {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Send fragment len=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_pkt->len); };};

                res = avdt_ad_write_req(AVDT_CHAN_MEDIA, p_scb->p_ccb, p_scb, p_pkt);
                if (2 == res) {
                    p_scb->cong = 
# 1934 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                 1
# 1934 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                     ;
                    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "avdt/l2c congested!!" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT"); };};
                    break;
                }
            }
            {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "res=%d left=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", res, p_scb->frag_off); };};

            if (p_scb->frag_off) {
                if (
# 1942 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                   1 
# 1942 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                   == res || fixed_queue_is_empty(p_scb->frag_q)) {
                ...
                (*p_scb->cs.p_ctrl_cback)(avdt_scb_to_hdl(p_scb), 
# 1954 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                                                                 ((void *)0)
# 1954 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                                                                     , 15, &avdt_ctrl);
            }
        }
...
# 1972 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
...
# 1988 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_clr_vars(tAVDT_SCB *p_scb, tAVDT_SCB_EVT *p_data)
{
    (void)(p_data);

    if ((p_scb->cs.tsep == 1) && (!p_scb->sink_activated)) {
        p_scb->in_use = 
# 1993 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       1
# 1993 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                           ;
    } else {
        p_scb->in_use = 
# 1995 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                       0
# 1995 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                            ;
    }
    p_scb->p_ccb = 
# 1997 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                  ((void *)0)
# 1997 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                      ;
    p_scb->peer_seid = 0;
}
# 2012 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
void avdt_scb_queue_frags(tAVDT_SCB *p_scb, UINT8 **pp_data, UINT32 *p_data_len, fixed_queue_t *pq)
{
    ...
    UINT8 *p;
    BOOLEAN al_hdr = 
# 2018 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                    0
# 2018 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                         ;
    UINT8 tcid;
    tAVDT_TC_TBL *p_tbl;
    UINT16 buf_size;
    UINT16 offset = 23 + 3;
    UINT16 cont_offset = offset - 12;
    BT_HDR *p_frag;
    ...
    if ( p_scb->frag_off != 0) {
        ...
        offset = cont_offset;
        al_hdr = 
# 2034 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
                1
# 2034 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                    ;
        num_frag = 15;
    } else {
        num_frag = L2CA_FlushChannel(lcid, 0x0000);
        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "num_q=%d lcid=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", num_frag, lcid); };};
        if (num_frag >= 15) {
            num_frag = 0;
        } else {
            num_frag = 15 - num_frag;
        }
    }


    p_tbl = avdt_ad_tc_tbl_by_type(AVDT_CHAN_MEDIA, p_scb->p_ccb, p_scb);
    buf_size = p_tbl->peer_mtu + (sizeof (BT_HDR));
    {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "peer_mtu: %d, buf_size: %d num_frag=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_tbl->peer_mtu, buf_size, num_frag); };}
                                                         ;
    ...
    mtu_used = buf_size - (sizeof (BT_HDR));

    while (*p_data_len && num_frag) {

        if (
# 2060 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c" 3 4
           ((void *)0) 
# 2060 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avdt/avdt_scb_act.c"
                == (p_frag = (BT_HDR *)malloc((buf_size)))) {
            {if (avdt_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVDT", "\033[0;" "33" "m" "W" " (%d) %s: " "avdt_scb_queue_frags len=%d(out of GKI buffers)\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", *p_data_len); };};
            break;
        }

        p_frag->layer_specific = *p_data_len;
        ...
        *p_data_len -= p_frag->len;
        {if (avdt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVDT", "D" " (%d) %s: " "Prepared fragment len=%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_AVDT", p_frag->len); };};
        ...
        if (al_hdr) {
            ...
            *p++ = (p_scb->curr_cfg.mux_tsid_media << 3) | (0x04 | 0x01);
