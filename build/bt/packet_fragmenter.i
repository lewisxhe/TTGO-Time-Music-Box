# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/include/hci/hci_internals.h" 1
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 2
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
...
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                             ((void *)0)
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                 ;
    callbacks = result_callbacks;
    partial_packets = hash_map_new(42, hash_function_naive, 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                                                          ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                                                              , 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                                                                ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
...
static void fragment_and_dispatch(BT_HDR *packet)
{
    ...
    ((packet != 
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
   ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c", 79, __func__, "packet != NULL"));


    if (event != 0x2100) {
        callbacks->fragmented(packet, 
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                     1
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                         );
        return;
    }

    max_data_size =
        ((packet->event) & 0x00FF) == 0 ?
        controller->get_acl_data_size_classic() :
        controller->get_acl_data_size_ble();

    max_packet_size = max_data_size + 4;
    remaining_length = packet->len;
    {continuation_handle = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
    continuation_handle = (((continuation_handle) & 0xCFFF) | 0x1000);
    if (remaining_length > max_packet_size) {
        current_fragment_packet = packet;
        {*(stream)++ = (UINT8)(max_data_size); *(stream)++ = (UINT8)((max_data_size) >> 8);};
        packet->len = max_packet_size;
        callbacks->fragmented(packet, 
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                     0
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                          );
        ...
        {*(stream)++ = (UINT8)(continuation_handle); *(stream)++ = (UINT8)((continuation_handle) >> 8);};
        {*(stream)++ = (UINT8)(remaining_length - 4); *(stream)++ = (UINT8)((remaining_length - 4) >> 8);};
        ...
        if (packet->layer_specific) {
            ...
            if (packet->layer_specific == 0) {
                ...
                current_fragment_packet = 
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                         ((void *)0)
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                             ;
                callbacks->transmit_finished(packet, 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                                    0
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                                         );
                return;
            }
        }
        ...
        current_fragment_packet = 
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                 ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                     ;
        callbacks->fragmented(packet, 
# 127 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                     1
# 127 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c"
                                         );
    }
}
...
{
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_HCI", "D" " (%d) %s: " "reassemble_and_dispatch\n" "\033[0m" "\n", esp_log_timestamp(), "BT_HCI"); };};

    if ((packet->event & 0xFF00) == 0x1100) {
        uint8_t *stream = packet->data + packet->offset;
        uint16_t handle;
        ...
        {acl_length = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};
        {l2cap_length = ((UINT16)(*(stream)) + (((UINT16)(*((stream) + 1))) << 8)); (stream) += 2;};

        ((acl_length == packet->len - 4) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/hci/packet_fragmenter.c", 145, __func__, "acl_length == packet->len - HCI_ACL_PREAMBLE_SIZE"));

        uint8_t boundary_flag = (((handle) >> 12) & 0x0003);
        ...
        if (boundary_flag == 2) {
            if (partial_packet) {
                {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_HCI", "\033[0;" "33" "m" "W" " (%d) %s: " "%s found unfinished packet for handle with start packet. Dropping old.\n" "\033[0m" "\n", esp_log_timestamp(), "BT_HCI", __func__); };};
                hash_map_erase(partial_packets, (void *)(uintptr_t)handle);
                buffer_allocator->free(partial_packet);
            }

            uint16_t full_length = l2cap_length + 4 + 4;
            if (full_length <= packet->len) {
                if (full_length < packet->len) {
                    {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_HCI", "\033[0;" "33" "m" "W" " (%d) %s: " "%s found l2cap full length %d less than the hci length %d.\n" "\033[0m" "\n", esp_log_timestamp(), "BT_HCI", __func__, l2cap_length, packet->len); };};
                }
            ...
            do { (stream) += 2; } while (0);
            {*(stream)++ = (UINT8)(full_length - 4); *(stream)++ = (UINT8)((full_length - 4) >> 8);};
            ...
            if (!partial_packet) {
                {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_HCI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s got continuation for unknown packet. Dropping it.\n" "\033[0m" "\n", esp_log_timestamp(), "BT_HCI", __func__); };};
                buffer_allocator->free(packet);
                return;
            }
            ...
            if (projected_offset > partial_packet->len) {
                {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_HCI", "\033[0;" "31" "m" "E" " (%d) %s: " "%s got packet which would exceed expected length of %d. Truncating.\n" "\033[0m" "\n", esp_log_timestamp(), "BT_HCI", __func__, partial_packet->len); };};
