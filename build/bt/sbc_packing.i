# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c" 2
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c"
void EncPacking(SBC_ENC_PARAMS *pstrEncParams)
{
    ...
    SINT32 s32Ch;
    SINT32 s32Sb;
    SINT32 s32PresentBit;

    SINT32 s32LoopCountJ;
    UINT32 u32QuantizedSbValue, u32QuantizedSbValue0;
    SINT32 s32LoopCount;
    UINT8 u8XoredVal;
    UINT8 u8CRC;
    SINT16 *ps16GenPtr;
    ...
    pu8PacketPtr = pstrEncParams->pu8NextPacket;
    *pu8PacketPtr++ = (UINT8)0x9C;
    ...
    for (s32Blk = s32NumOfBlocks - 1; s32Blk >= 0; s32Blk--) {
        ...
        for (s32Ch = s32Sb - 1; s32Ch >= 0; s32Ch--) {
            ...
            if (s32LoopCount != 0) {
                ...
                { s32Low = ((SINT32)(UINT16)s32Temp1 * (UINT16)s32Temp2); s32TempVal2 = (SINT32)((s32Temp1 >> 16) * (UINT16)s32Temp2); s32Carry = ( (((UINT32)(s32Low)>>16)&0xFFFF) + + (s32TempVal2 & 0xFFFF) ) >> 16; s32Low += (s32TempVal2 << 16); s32Hi = (s32TempVal2 >> 16) + s32Carry; };
...
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_packing.c"
    ...
    *pu8PacketPtr = Temp;
    ...
    pu8PacketPtr += 3;
    *pu8PacketPtr = u8CRC;
    pstrEncParams->pu8NextPacket += pstrEncParams->u16PacketLength;
}
