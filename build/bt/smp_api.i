# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/include/smp_int.h" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/include/stack/l2cdefs.h" 1
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 2
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_Init(void)
{
...
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
extern UINT8 SMP_SetTraceLevel (UINT8 new_level)
{
    if (new_level != 0xFF) {
...
# 117 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_Register (tSMP_CALLBACK *p_cback)
{
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMP_Register state=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", smp_cb.state); };};

    if (smp_cb.p_callback != 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                            ((void *)0)
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                ) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_Register: duplicate registration, overwrite it" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
    }
    smp_cb.p_callback = p_cback;

    return (
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
           1
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
               );

}
# 142 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
tSMP_STATUS SMP_Pair (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 status = (0x0E + 0x01);

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s state=%d br_state=%d flag=0x%x \n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, p_cb->state, p_cb->br_state, p_cb->flags); };}
                                                                            ;
    if (p_cb->state != SMP_STATE_IDLE || p_cb->flags & (1) ||
            p_cb->smp_over_br) {
        ...
        memcpy (p_cb->pairing_bda, bd_addr, 6);

        if (!L2CA_ConnectFixedChnl (6, bd_addr, 0XFF)) {
            {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: L2C connect fixed channel failed.\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
...
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
tSMP_STATUS SMP_BR_PairWith (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 status = (0x0E + 0x01);

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s state=%d br_state=%d flag=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, p_cb->state, p_cb->br_state, p_cb->flags); };}
                                                                        ;
    ...
    p_cb->flags = (1);
    p_cb->smp_over_br = 
# 197 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                       1
# 197 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                           ;

    memcpy (p_cb->pairing_bda, bd_addr, 6);

    if (!L2CA_ConnectFixedChnl (7, bd_addr, 0XFF)) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: L2C connect fixed channel failed." "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
...
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_PairCancel (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 err_code = 0x08;
    BOOLEAN status = 
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                      0
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                           ;

    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "SMP_CancelPair state=%d flag=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_cb->state, p_cb->flags); };};
    if ( (p_cb->state != SMP_STATE_IDLE) &&
            (!memcmp (p_cb->pairing_bda, bd_addr, 6)) ) {
        p_cb->is_pair_cancel = 
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                              1
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                  ;
        {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "Cancel Pairing: set fail reason Unknown" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
        smp_sm_event(p_cb, ((0x0F + 1) + 7), &err_code);
        status = 
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                1
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                    ;
    }

    return status;
}
# 251 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_SecurityGrant(BD_ADDR bd_addr, UINT8 res)
{
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMP_SecurityGrant " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    if (smp_cb.smp_over_br) {
        if (smp_cb.br_state != SMP_BR_STATE_WAIT_APP_RSP ||
                smp_cb.cb_evt != 2 ||
                memcmp (smp_cb.pairing_bda, bd_addr, 6)) {
            return;
        }
        ...
        smp_cb.cb_evt = 0;
        smp_br_state_machine_event(&smp_cb, (0x0E + 6), &res);
        return;
    }
    ...
    smp_cb.cb_evt = 0;
    smp_sm_event(&smp_cb, ((0x0F + 1) + 5), &res);
}
# 293 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_PasskeyReply (BD_ADDR bd_addr, UINT8 res, UINT32 passkey)
{
    tSMP_CB *p_cb = & smp_cb;
    UINT8 failure = 0x01;

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMP_PasskeyReply: Key: %d  Result:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", passkey, res); };}
                                  ;


    if (p_cb->cb_evt != 4) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "SMP_PasskeyReply() - Wrong State: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", p_cb->state); };};
        return;
    }

    if (memcmp (bd_addr, p_cb->pairing_bda, 6) != 0) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - Wrong BD Addr" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
        return;
    }

    if (btm_find_dev (bd_addr) == 
# 312 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 312 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
        return;
    }

    if (passkey > (999999) || res != 0) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "SMP_PasskeyReply() - Wrong key len: %d or passkey entry fail" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", passkey); };};

        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);

    } else if (p_cb->selected_association_model == 6) {
        smp_sm_event(&smp_cb, ((0x0F + 1) + 21), &passkey);
    } else {
...
# 343 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_ConfirmReply (BD_ADDR bd_addr, UINT8 res)
{
    tSMP_CB *p_cb = & smp_cb;
    UINT8 failure = 0x0C;

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s: Result:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, res); };};


    if (p_cb->cb_evt != 6) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "%s() - Wrong State: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, p_cb->state); };};
        return;
    }

    if (memcmp (bd_addr, p_cb->pairing_bda, 6) != 0) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - Wrong BD Addr" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
        return;
    }

    if (btm_find_dev (bd_addr) == 
# 361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
        return;
    }

    if (res != 0) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "%s() - Numeric Comparison fails" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};

        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);
    } else {
        smp_sm_event(p_cb, ((0x0F + 1) + 19), 
# 371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                            ((void *)0)
# 371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                                );
    }
}
# 387 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_OobDataReply(BD_ADDR bd_addr, tSMP_STATUS res, UINT8 len, UINT8 *p_data)
{
    ...
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s State: %d  res:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, smp_cb.state, res); };};


    if (p_cb->state != SMP_STATE_WAIT_APP_RSP || p_cb->cb_evt != 5) {
        return;
    }

    if (res != 0 || len == 0 || !p_data) {
        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);
    } else {
        if (len > 16) {
            len = 16;
...
# 426 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_SecureConnectionOobDataReply(UINT8 *p_data)
{
    ...
    if (!p_oob) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s received no data" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);
        return;
    }

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s req_oob_type: %d, loc_oob_data.present: %d, " "peer_oob_data.present: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, p_cb->req_oob_type, p_oob->loc_oob_data.present, p_oob->peer_oob_data.present); };}


                                                  ;

    if (p_cb->state != SMP_STATE_WAIT_APP_RSP || p_cb->cb_evt != 9) {
        return;
    }

    BOOLEAN data_missing = 
# 447 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                           0
# 447 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                ;
    switch (p_cb->req_oob_type) {
    case SMP_OOB_PEER:
        if (!p_oob->peer_oob_data.present) {
            data_missing = 
# 451 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 451 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    case SMP_OOB_LOCAL:
        if (!p_oob->loc_oob_data.present) {
            data_missing = 
# 456 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 456 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    case SMP_OOB_BOTH:
        if (!p_oob->loc_oob_data.present || !p_oob->peer_oob_data.present) {
            data_missing = 
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    default:
        {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "Unexpected OOB data type requested. Fail OOB" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
        data_missing = 
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                      1
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                          ;
        break;
    }
    ...
    smp_sm_event(&smp_cb, ((0x0F + 1) + 23), p_data);
}
# 496 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
...
{
    BOOLEAN status = 
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                    0
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                         ;
    status = smp_encrypt_data(key, key_len, plain_text, pt_len, p_out);
    return status;
}
# 516 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_KeypressNotification (BD_ADDR bd_addr, UINT8 value)
{
    tSMP_CB *p_cb = &smp_cb;

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s: Value: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, value); };};
    ...
    if (btm_find_dev (bd_addr) == 
# 527 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 527 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
        return;
    }
    ...
    if (p_cb->local_io_capability != 2) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - wrong local IO capabilities %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, p_cb->local_io_capability); };}
                                                                 ;
        return;
    }

    if (p_cb->selected_association_model != 6) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - wrong protocol %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, p_cb->selected_association_model); };}
                                                          ;
        return;
    }

    smp_sm_event(p_cb, ((0x0F + 1) + 22), &value);
}
# 560 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_CreateLocalSecureConnectionsOobData (tBLE_BD_ADDR *addr_to_send_to)
{
    ...
    if (addr_to_send_to == 
# 565 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          ((void *)0)
# 565 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                              ) {
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s addr_to_send_to is not provided" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
        return 
# 567 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
              0
# 567 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                   ;
    }

    bd_addr = addr_to_send_to->bda;

    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s addr type: %u,  BDA: %08x%04x,  state: %u, br_state: %u" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, addr_to_send_to->type, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], p_cb->state, p_cb->br_state); };}
    ...
    if ((p_cb->state != SMP_STATE_IDLE) || (p_cb->smp_over_br)) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "%s creation of local OOB data set " "starts only in IDLE state" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };}
                                                                     ;
        return 
# 582 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
              0
# 582 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                   ;
    }

    p_cb->sc_oob_data.loc_oob_data.addr_sent_to = *addr_to_send_to;
    smp_sm_event(p_cb, ((0x0F + 1) + 24), 
# 586 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                                  ((void *)0)
# 586 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
                                                      );

    return 
# 588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
          1
# 588 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_api.c"
              ;
}
