# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
tL2C_CB l2cb;
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_bcst_msg( BT_HDR *p_buf, UINT16 psm )
{
    ...
    if (p_buf->offset < 11) {
        {if (l2cb.l2cap_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_L2CAP", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - cannot send buffer, offset: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", p_buf->offset); };};
        free((p_buf));
        return;
    }
    ...
    {*(p)++ = (UINT8)(0x0050 | (2 << 12) | (2 << 14)); *(p)++ = (UINT8)((0x0050 | (2 << 12) | (2 << 14)) >> 8);};
    ...
    {*(p)++ = (UINT8)(p_buf->len - 4); *(p)++ = (UINT8)((p_buf->len - 4) >> 8);};
    {*(p)++ = (UINT8)(2); *(p)++ = (UINT8)((2) >> 8);};
    {*(p)++ = (UINT8)(psm); *(p)++ = (UINT8)((psm) >> 8);};
...
# 119 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_rcv_acl_data (BT_HDR *p_msg)
{
    ...
    tL2C_LCB *p_lcb;
    tL2C_CCB *p_ccb = 
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                        ((void *)0)
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                            ;
...
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                         ((void *)0)
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                             ) {
            UINT8 cmd_code;
            ...
            {hci_len = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {l2cap_len = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {rcv_cid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {cmd_code = (UINT8)(*(p)); (p) += 1;};

            if ((p_msg->layer_specific == 0) && (rcv_cid == 1)
                    && (cmd_code == 0x0A || cmd_code == 0x02)) {
                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - holding ACL for unknown handle:%d ls:%d" "  cid:%d opcode:%d cur count:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", handle, p_msg->layer_specific, rcv_cid, cmd_code, list_length(l2cb.rcv_pending_q)); };}
                ...
                if (list_length(l2cb.rcv_pending_q) == 1) {
                    btu_start_timer (&l2cb.rcv_hold_tle, 4, (2));
                }

                return;
            } else {
                {if (l2cb.l2cap_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_L2CAP", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - rcvd ACL for unknown handle:%d ls:%d cid:%d" " opcode:%d cur count:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", handle, p_msg->layer_specific, rcv_cid, cmd_code, list_length(l2cb.rcv_pending_q)); };}
        ...
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - expected pkt start or complete, got: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", pkt_type); };};
        free((p_msg));
        return;
    }
    ...
    if (p_lcb && p_lcb->transport == 2 && p_lcb->link_state != LST_DISCONNECTING)

    {
        l2cble_notify_le_connection(p_lcb->remote_bd_addr);
    }

    {if (l2cb.l2cap_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_L2CAP", "D" " (%d) %s: " "L2CAP - rcv_cid CID: 0x%04x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", rcv_cid); };};

    if (rcv_cid >= 0x0040) {
        if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, rcv_cid)) == 
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                              ((void *)0)
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                  ) {
            {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - unknown CID: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", rcv_cid); };};
            free((p_msg));
            return;
        }
    }
    ...
    if (hci_len >= 4) {
        ...
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - got incorrect hci header" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP"); };};
        free((p_msg));
        return;
    }

    if (l2cap_len != p_msg->len) {
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - bad length in pkt. Exp: %d  Act: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", l2cap_len, p_msg->len); };}
                                                   ;
    ...
    if (rcv_cid == 1) {
        ...
        {psm = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
        {if (l2cb.l2cap_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_L2CAP", "D" " (%d) %s: " "GOT CONNECTIONLESS DATA PSM:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", psm); };} ;
    ...
    else if ((rcv_cid >= 4) && (rcv_cid <= (4 + 32 - 1)) &&
             (l2cb.fixed_reg[rcv_cid - 4].pL2CA_FixedData_Cb != 
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                                    ((void *)0)
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                                        ) ) {
        ...
        if (p_lcb &&
                ...
                l2cu_initialize_fixed_ccb (p_lcb, rcv_cid, &l2cb.fixed_reg[rcv_cid - 4].fixed_chnl_opts)) {
            p_ccb = p_lcb->p_fixed_ccbs[rcv_cid - 4];
        ...
        if (p_ccb == 
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                    ((void *)0)
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                        ) {
            free((p_msg));
        } else {
            if (p_lcb->transport == 2) {
                ...
                credit = 1;
                {if (l2cb.l2cap_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_L2CAP", "D" " (%d) %s: " "%s Credits received %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP",__func__, credit); };};
                if((p_ccb->peer_conn_cfg.credits + credit) > 65535) {
...
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                           ((void *)0)
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                               , 
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                 ((void *)0)
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
            ...
            if (p_ccb->peer_cfg.fcr.mode == 0x00) {
                ...
                l2c_csm_execute (p_ccb, 20, p_msg);
...
# 325 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
static void process_l2cap_cmd (tL2C_LCB *p_lcb, UINT8 *p, UINT16 pkt_len)
{
    ...
    tL2C_CCB *p_ccb;
    tL2C_RCB *p_rcb;
    BOOLEAN cfg_rej, pkt_size_rej = 
# 334 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                           0
# 334 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                ;
    ...
    if (pkt_len > (672)) {
        ...
        pkt_size_rej = 
# 352 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                      1
# 352 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                          ;
        {if (l2cb.l2cap_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_L2CAP", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP SIG MTU Pkt Len Exceeded (672) -> pkt_len: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", pkt_len); };};
    }
    ...
    while (
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
          1
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
              ) {
        ...
        if ((p_next_cmd = p + cmd_len) > p_pkt_end) {
            {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "Command len bad  pkt_len: %d  cmd_len: %d  code: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", pkt_len, cmd_len, cmd_code); };}
                                                            ;
            break;
        }

        {if (l2cb.l2cap_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_L2CAP", "D" " (%d) %s: " "cmd_code: %d, id:%d, cmd_len:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", cmd_code, id, cmd_len); };};
        ...
        switch (cmd_code) {
        case 0x01:
            {rej_reason = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            if (rej_reason == 1) {
                {rej_mtu = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};



                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - MTU rej Handle: %d MTU: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", p_lcb->handle, rej_mtu); };};
            }
            if (rej_reason == 2) {
                {rcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                {lcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - rej with CID invalid, LCID: 0x%04x RCID: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", lcid, rcid); };};


                if (((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) != 
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                    ((void *)0)
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                        )
                        && (p_ccb->remote_cid == rcid)) {

                    l2c_csm_execute (p_ccb, 3, 
# 411 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                     ((void *)0)
# 411 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                         );
                }
            }


            else if (rej_reason == 0 && p_lcb->w4_info_rsp) {
                btu_stop_timer (&p_lcb->info_timer_entry);

                p_lcb->w4_info_rsp = 
# 419 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                    0
# 419 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                         ;
                ci.status = 0x00;
        ...
        case 0x02:
            {con_info.psm = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {rcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            if ((p_rcb = l2cu_find_rcb_by_psm (con_info.psm)) == 
# 433 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                ((void *)0)
# 433 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                    ) {
                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - rcvd conn req for unknown PSM: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", con_info.psm); };};
                l2cu_reject_connection (p_lcb, rcid, id, 2);
                break;
            } else {
                if (!p_rcb->api.pL2CA_ConnectInd_Cb) {
                    {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - rcvd conn req for outgoing-only connection PSM: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", con_info.psm); };};
                    l2cu_reject_connection (p_lcb, rcid, id, 2);
                    break;
                }
            }
            if ((p_ccb = l2cu_allocate_ccb (p_lcb, 0)) == 
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                         ((void *)0)
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                             ) {
                {if (l2cb.l2cap_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_L2CAP", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - unable to allocate CCB" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP"); };};
                l2cu_reject_connection (p_lcb, rcid, id, 4);
                break;
            }
            p_ccb->remote_id = id;
            p_ccb->p_rcb = p_rcb;
            ...
            l2c_csm_execute(p_ccb, 10, &con_info);
            break;

        case 0x03:
            {con_info.remote_cid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {lcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {con_info.l2cap_result = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {con_info.l2cap_status = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

            if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) == 
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                               ((void *)0)
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                   ) {
                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - no CCB for conn rsp, LCID: %d RCID: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", lcid, con_info.remote_cid); };}
                                                               ;
                break;
            }
            if (p_ccb->local_id != id) {
                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - con rsp - bad ID. Exp: %d Got: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", p_ccb->local_id, id); };}
                                                         ;
                break;
            }

            if (con_info.l2cap_result == 0) {
                l2c_csm_execute(p_ccb, 11, &con_info);
            } else if (con_info.l2cap_result == 1) {
                l2c_csm_execute(p_ccb, 12, &con_info);
            } else {
                l2c_csm_execute(p_ccb, 13, &con_info);
            }
        ...
        case 0x04:
            p_cfg_end = p + cmd_len;
            cfg_rej = 
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                     0
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                          ;
            cfg_rej_len = 0;

            {lcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {cfg_info.flags = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

            p_cfg_start = p;

            cfg_info.flush_to_present = cfg_info.mtu_present = cfg_info.qos_present =
                                            cfg_info.fcr_present = cfg_info.fcs_present = 
# 494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                                         0
# 494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                                              ;

            while (p < p_cfg_end) {
                {cfg_code = (UINT8)(*(p)); (p) += 1;};
                {cfg_len = (UINT8)(*(p)); (p) += 1;};

                switch (cfg_code & 0x7F) {
                case 0x01:
                    cfg_info.mtu_present = 
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 502 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.mtu = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    break;

                case 0x02:
                    cfg_info.flush_to_present = 
# 507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                               1
# 507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                   ;
                    {cfg_info.flush_to = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    break;

                case 0x03:
                    cfg_info.qos_present = 
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.qos.qos_flags = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.qos.service_type = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.qos.token_rate = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.qos.token_bucket_size = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.qos.peak_bandwidth = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.qos.latency = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.qos.delay_variation = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    break;

                case 0x04:
                    cfg_info.fcr_present = 
# 523 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 523 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.fcr.mode = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.fcr.tx_win_sz = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.fcr.max_transmit = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.fcr.rtrans_tout = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    {cfg_info.fcr.mon_tout = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    {cfg_info.fcr.mps = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    break;

                case 0x05:
                    cfg_info.fcs_present = 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.fcs = (UINT8)(*(p)); (p) += 1;};
                    break;

                case 0x06:
                    cfg_info.ext_flow_spec_present = 
# 538 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                    1
# 538 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                        ;
                    {cfg_info.ext_flow_spec.id = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.ext_flow_spec.stype = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.ext_flow_spec.max_sdu_size = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    {cfg_info.ext_flow_spec.sdu_inter_time = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.ext_flow_spec.access_latency = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    {cfg_info.ext_flow_spec.flush_timeout = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                    break;

                default:

                    if ((cfg_len + 2) <= cmd_len) {
                        p += cfg_len;
                        if ((cfg_code & 0x80) == 0) {
                            cfg_rej_len += cfg_len + 2;
                            cfg_rej = 
# 553 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                     1
# 553 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                         ;
                        }
                    }
                        ...
                        p = p_cfg_end;
                        cfg_rej = 
# 559 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                 1
# 559 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                     ;
                    }
                    break;
                }
            ...
            if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) != 
# 565 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                               ((void *)0)
# 565 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                   ) {
                p_ccb->remote_id = id;
                if (cfg_rej) {
                    l2cu_send_peer_config_rej (p_ccb, p_cfg_start, (UINT16) (cmd_len - 4), cfg_rej_len);
                } else {
                    l2c_csm_execute (p_ccb, 14, &cfg_info);
                }
            } else {

                l2cu_send_peer_cmd_reject (p_lcb, 2, id, 0, 0);
            }
            break;
        ...
        case 0x05:
            ...
            {lcid = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {cfg_info.flags = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {cfg_info.result = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

            cfg_info.flush_to_present = cfg_info.mtu_present = cfg_info.qos_present =
                                            cfg_info.fcr_present = cfg_info.fcs_present = 
# 585 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                                         0
# 585 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                                              ;
            ...
            while (p < p_cfg_end) {
                ...
                case 0x01:
                    cfg_info.mtu_present = 
# 593 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 593 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.mtu = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    break;
                ...
                case 0x02:
                    cfg_info.flush_to_present = 
# 598 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                               1
# 598 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                   ;
                    {cfg_info.flush_to = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                    break;
                ...
                case 0x03:
                    cfg_info.qos_present = 
# 603 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 603 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.qos.qos_flags = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.qos.service_type = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.qos.token_rate = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
                ...
                case 0x04:
                    cfg_info.fcr_present = 
# 614 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 614 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.fcr.mode = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.fcr.tx_win_sz = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.fcr.max_transmit = (UINT8)(*(p)); (p) += 1;};
                ...
                case 0x05:
                    cfg_info.fcs_present = 
# 624 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                          1
# 624 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                              ;
                    {cfg_info.fcs = (UINT8)(*(p)); (p) += 1;};
                    break;
                ...
                case 0x06:
                    cfg_info.ext_flow_spec_present = 
# 629 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                    1
# 629 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                        ;
                    {cfg_info.ext_flow_spec.id = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.ext_flow_spec.stype = (UINT8)(*(p)); (p) += 1;};
                    {cfg_info.ext_flow_spec.max_sdu_size = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            ...
            if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) != 
# 640 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                               ((void *)0)
# 640 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                   ) {
                if (p_ccb->local_id != id) {
                    {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - cfg rsp - bad ID. Exp: %d Got: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", p_ccb->local_id, id); };}
                                                             ;
                    break;
                }
                if ( (cfg_info.result == 0) || (cfg_info.result == 4) ) {
                    l2c_csm_execute (p_ccb, 15, &cfg_info);
                } else {
                    l2c_csm_execute (p_ccb, 16, &cfg_info);
                }
            } else {
                {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - rcvd cfg rsp for unknown CID: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", lcid); };};
            }
            break;
        ...
        case 0x06:
            ...
            if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) != 
# 661 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                               ((void *)0)
# 661 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                   ) {
                if (p_ccb->remote_cid == rcid) {
                    p_ccb->remote_id = id;
                    l2c_csm_execute (p_ccb, 17, &con_info);
                }
            } else {
        ...
        case 0x07:
            ...
            if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, lcid)) != 
# 676 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                               ((void *)0)
# 676 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                   ) {
                if ((p_ccb->remote_cid == rcid) && (p_ccb->local_id == id)) {
                    l2c_csm_execute (p_ccb, 18, &con_info);
                }
            }
            break;

        case 0x08:
            l2cu_send_peer_echo_rsp (p_lcb, id, 
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                               ((void *)0)
# 684 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                   , 0);
            break;
        ...
        case 0x09:
            if (p_lcb->p_echo_rsp_cb) {
                ...
                p_lcb->p_echo_rsp_cb = 
# 692 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                      ((void *)0)
# 692 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                          ;
        ...
        case 0x0A:
            {info_type = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
        ...
        case 0x0B:
            ...
            if (p_lcb->w4_info_rsp) {
                btu_stop_timer (&p_lcb->info_timer_entry);
                p_lcb->w4_info_rsp = 
# 707 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                    0
# 707 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                         ;
            }
            ...
            if ( (info_type == 0x0002)
                    && (result == 0) ) {
                {p_lcb->peer_ext_fea = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};


                if (p_lcb->peer_ext_fea & 0x00000080) {
                    l2cu_send_peer_info_req (p_lcb, 0x0003);
                    break;
                } else {
            ...
            if (info_type == 0x0003) {
                if (result == 0) {
                    memcpy (p_lcb->peer_chnl_mask, p, 8);
                }

                l2cu_process_fixed_chnl_resp (p_lcb);
            }
# 747 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
            ci.status = 0x00;
            memcpy (ci.bd_addr, p_lcb->remote_bd_addr, sizeof(BD_ADDR));
            for (p_ccb = p_lcb->ccb_queue.p_first_ccb; p_ccb; p_ccb = p_ccb->p_next_ccb) {
                l2c_csm_execute (p_ccb, 19, &ci);
        ...
        default:
            {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - bad cmd code: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", cmd_code); };};
...
# 776 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_process_held_packets(BOOLEAN timed_out)
{
    ...
    if (!timed_out) {
        ...
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP HOLD CONTINUE" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP"); };};
    } else {
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP HOLD TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP"); };};
    }
...
# 817 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_init (void)
{
    INT16 xx;
    ...
    l2cb.p_free_ccb_last = &l2cb.ccb_pool[16 - 1];


    l2cb.desire_role = 0x01;
    ...
    l2cb.l2cap_trace_level = 2;
# 867 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
    l2cb.l2c_ble_fixed_chnls_mask =
        (1 << 4) | (1 << 5) | (1 << 6);


    l2cb.rcv_pending_q = list_new(
# 871 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                 ((void *)0)
# 871 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                     );
    if (l2cb.rcv_pending_q == 
# 872 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                             ((void *)0)
# 872 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                 ) {
        {if (l2cb.l2cap_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_L2CAP", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate memory for link layer control block" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", __func__); };};
    }
}
...
void l2c_free(void)
{
    ...
    l2cb.rcv_pending_q = 
# 880 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                        ((void *)0)
# 880 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                            ;



}
# 895 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_process_timeout (TIMER_LIST_ENT *p_tle)
{
    ...
    case 3:
        l2c_csm_execute (((tL2C_CCB *)p_tle->param), 32, 
# 904 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                    ((void *)0)
# 904 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                        );
        break;

    case 78:
        l2c_csm_execute (((tL2C_CCB *)p_tle->param), 34, 
# 908 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                        ((void *)0)
# 908 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                            );
        break;
...
# 913 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                1
# 913 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                    );
        break;
...
# 944 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
...
# 949 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                      ((void *)0)
# 949 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                          , cid)) == 
# 949 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                     ((void *)0)
# 949 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                         ) {
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - no CCB for L2CA_DataWrite, CID: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", cid); };};
        free((p_data));
        return (
# 952 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
               0
# 952 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                              );
    }
    ...
    if (p_data->len > p_ccb->peer_cfg.mtu) {
        {if (l2cb.l2cap_trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_L2CAP", "\033[0;" "33" "m" "W" " (%d) %s: " "L2CAP - CID: 0x%04x  cannot send message bigger than peer's mtu size" "\033[0m" "\n", esp_log_timestamp(), "BT_L2CAP", cid); };};
        free((p_data));
        return (
# 960 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
               0
# 960 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                              );
    }
    ...
    if (p_ccb->cong_sent) {
        ...
        free((p_data));
        return (
# 975 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
               0
# 975 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                              );
    }
    ...
    l2c_csm_execute (p_ccb, 30, p_data);

    if (p_ccb->cong_sent) {
        return (2);
    }
    return (
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
           1
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                           );
}
