# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 2
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_get_capability_rsp (tAVRC_GET_CAPS_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    if (!((((p_rsp->capability_id == 0x02) || (p_rsp->capability_id == 0x03)) ? 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
         1 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
         : 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
         0
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
         ))) {
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_get_capability_rsp bad parameter. p_rsp: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", (int)p_rsp); };};
        status = 0x01;
        return status;
    }

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_capability_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};

    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_len = p_start + 2;

    {len = (UINT16)(((UINT16)(*(p_data)) << 8) + (UINT16)(*((p_data) + 1))); (p_data) += 2;};
    {*(p_data)++ = (UINT8)(p_rsp->capability_id);};
    p_count = p_data;
    ...
    if (p_rsp->capability_id == 0x02) {
        p_company_id = p_rsp->param.company_id;
        for (xx = 0; xx < p_rsp->count; xx++) {
            {*(p_data)++ = (UINT8)((p_company_id[xx]) >> 16); *(p_data)++ = (UINT8)((p_company_id[xx]) >> 8); *(p_data)++ = (UINT8)(p_company_id[xx]);};
        }
        len += p_rsp->count * 3;
    } else {
        ...
        *p_count = 0;
        for (xx = 0; xx < p_rsp->count; xx++) {
            if ((((p_event_id[xx] >= 0x01) && (p_event_id[xx] <= 0x08)) ? 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
               1 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
               : 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
               0
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                ...
                (*p_count)++;
                {*(p_data)++ = (UINT8)(p_event_id[xx]);};
            }
        }
        len += (*p_count);
    }
    {*(p_len)++ = (UINT8)((len) >> 8); *(p_len)++ = (UINT8)(len);};
    p_pkt->len = (p_data - p_start);
    status = 0x04;

    return status;
}
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_list_app_settings_attr_rsp (tAVRC_LIST_APP_ATTR_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_list_app_settings_attr_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
...
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
        ...
        BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_list_app_settings_values_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
...
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
        ...
        BT_HDR *p_pkt)
{
    ...
    if (!p_rsp->p_vals) {
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_get_cur_app_setting_value_rsp NULL parameter" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
        return 0x01;
    }

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_cur_app_setting_value_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    ...
    for (xx = 0; xx < p_rsp->num_val; xx++) {
        if (avrc_is_valid_player_attrib_value(p_rsp->p_vals[xx].attr_id, p_rsp->p_vals[xx].attr_val)) {
            (*p_count)++;
            {*(p_data)++ = (UINT8)(p_rsp->p_vals[xx].attr_id);};
            {*(p_data)++ = (UINT8)(p_rsp->p_vals[xx].attr_val);};
        }
    }
    len = ((*p_count) << 1) + 1;
    {*(p_len)++ = (UINT8)((len) >> 8); *(p_len)++ = (UINT8)(len);};
...
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_set_app_setting_value_rsp (tAVRC_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_set_app_setting_value_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return 0x04;
}
# 276 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_app_setting_text_rsp (tAVRC_GET_APP_ATTR_TXT_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    if (!p_rsp->p_attrs) {
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_app_setting_text_rsp NULL parameter" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
        return 0x01;
    }
    ...
    len_left = (4096 + 16) - (sizeof (BT_HDR)) - p_pkt->offset - p_pkt->len;
    ...
    for (xx = 0; xx < p_rsp->num_attr; xx++) {
        if (len_left < (p_rsp->p_attrs[xx].str_len + 4)) {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_app_setting_text_rsp out of room %d(str_len:%d, left:%d)" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", xx, p_rsp->p_attrs[xx].str_len, len_left); };}
                                                                      ;
        ...
        if ( !p_rsp->p_attrs[xx].str_len || !p_rsp->p_attrs[xx].p_str ) {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_app_setting_text_rsp NULL attr text[%d]" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", xx); };};
            continue;
        }
        {*(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].attr_id);};
        {*(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].charset_id) >> 8); *(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].charset_id);};
        {*(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].str_len);};
        {register int ijk; for (ijk = 0; ijk < p_rsp->p_attrs[xx].str_len; ijk++) *(p_data)++ = (UINT8) p_rsp->p_attrs[xx].p_str[ijk];};
        (*p_count)++;
        num_added++;
    }
    len = p_data - p_count;
...
# 345 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_get_app_setting_attr_text_rsp (tAVRC_GET_APP_ATTR_TXT_RSP *p_rsp,
        BT_HDR *p_pkt)
{
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_app_setting_attr_text_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return avrc_bld_app_setting_text_rsp(p_rsp, p_pkt);
}
# 363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_get_app_setting_value_text_rsp (tAVRC_GET_APP_ATTR_TXT_RSP *p_rsp,
        BT_HDR *p_pkt)
{
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_app_setting_value_text_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return avrc_bld_app_setting_text_rsp(p_rsp, p_pkt);
}
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_inform_charset_rsp (tAVRC_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_inform_charset_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return 0x04;
}
# 402 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_inform_battery_status_rsp (tAVRC_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_inform_battery_status_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return 0x04;
}
# 423 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_get_elem_attrs_rsp (tAVRC_GET_ELEM_ATTRS_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_elem_attrs_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    if (!p_rsp->p_attrs) {
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_get_elem_attrs_rsp NULL parameter" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
        return 0x01;
    }
    ...
    for (xx = 0; xx < p_rsp->num_attr; xx++) {
        if (!((p_rsp->p_attrs[xx].attr_id >= 0x00000001) && (p_rsp->p_attrs[xx].attr_id <= 0x00000007) ? 
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
            1 
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
            : 
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
            0
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
            )) {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_get_elem_attrs_rsp invalid attr id[%d]: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", xx, p_rsp->p_attrs[xx].attr_id); };};
            continue;
        }
        if ( !p_rsp->p_attrs[xx].name.p_str ) {
            p_rsp->p_attrs[xx].name.str_len = 0;
        }
        {*(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].attr_id) >> 24); *(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].attr_id) >> 16); *(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].attr_id) >> 8); *(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].attr_id); };
        {*(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].name.charset_id) >> 8); *(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].name.charset_id);};
        {*(p_data)++ = (UINT8)((p_rsp->p_attrs[xx].name.str_len) >> 8); *(p_data)++ = (UINT8)(p_rsp->p_attrs[xx].name.str_len);};
        {register int ijk; for (ijk = 0; ijk < p_rsp->p_attrs[xx].name.str_len; ijk++) *(p_data)++ = (UINT8) p_rsp->p_attrs[xx].name.p_str[ijk];};
        (*p_count)++;
    }
    len = p_data - p_count;
    {*(p_len)++ = (UINT8)((len) >> 8); *(p_len)++ = (UINT8)(len);};
...
# 480 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_get_play_status_rsp (tAVRC_GET_PLAY_STATUS_RSP *p_rsp, BT_HDR *p_pkt)
{
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_play_status_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_start + 2;


    {*(p_data)++ = (UINT8)((9) >> 8); *(p_data)++ = (UINT8)(9);};
    {*(p_data)++ = (UINT8)((p_rsp->song_len) >> 24); *(p_data)++ = (UINT8)((p_rsp->song_len) >> 16); *(p_data)++ = (UINT8)((p_rsp->song_len) >> 8); *(p_data)++ = (UINT8)(p_rsp->song_len); };
    {*(p_data)++ = (UINT8)((p_rsp->song_pos) >> 24); *(p_data)++ = (UINT8)((p_rsp->song_pos) >> 16); *(p_data)++ = (UINT8)((p_rsp->song_pos) >> 8); *(p_data)++ = (UINT8)(p_rsp->song_pos); };
    {*(p_data)++ = (UINT8)(p_rsp->play_status);};
    p_pkt->len = (p_data - p_start);

    return 0x04;
}
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_notify_rsp (tAVRC_REG_NOTIF_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_notify_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};

    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_len = p_start + 2;
    p_data += 2;

    {*(p_data)++ = (UINT8)(p_rsp->event_id);};
    switch (p_rsp->event_id) {
    case 0x01:

        if ((p_rsp->param.play_status <= 0x04) ||
                (p_rsp->param.play_status == 0xFF) ) {
            {*(p_data)++ = (UINT8)(p_rsp->param.play_status);};
            len = 2;
        } else {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "bad play state" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            status = 0x01;
        }
        break;

    case 0x02:
        {register int ijk; for (ijk = 0; ijk < 8; ijk++) *(p_data)++ = (UINT8) p_rsp->param.track[ijk];};
        len = (UINT8)(8 + 1);
        break;
    ...
    case 0x05:
        {*(p_data)++ = (UINT8)((p_rsp->param.play_pos) >> 24); *(p_data)++ = (UINT8)((p_rsp->param.play_pos) >> 16); *(p_data)++ = (UINT8)((p_rsp->param.play_pos) >> 8); *(p_data)++ = (UINT8)(p_rsp->param.play_pos); };
        len = 5;
        break;

    case 0x06:
        if (((p_rsp->param.battery_status <= 0x04) ? 
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
           1 
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
           : 
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
           0
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
           )) {
            {*(p_data)++ = (UINT8)(p_rsp->param.battery_status);};
            len = 2;
        } else {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "bad battery status" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            status = 0x01;
        }
        break;

    case 0x07:
        if (((p_rsp->param.system_status <= 0x02) ? 
# 562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
           1 
# 562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
           : 
# 562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
           0
# 562 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
           )) {
            {*(p_data)++ = (UINT8)(p_rsp->param.system_status);};
            len = 2;
        } else {
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "bad system status" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            status = 0x01;
        }
        break;

    case 0x08:
        if (p_rsp->param.player_setting.num_attr > 8) {
            p_rsp->param.player_setting.num_attr = 8;
        }

        if (p_rsp->param.player_setting.num_attr > 0) {
            {*(p_data)++ = (UINT8)(p_rsp->param.player_setting.num_attr);};
            len = 2;
            for (xx = 0; xx < p_rsp->param.player_setting.num_attr; xx++) {
                if (avrc_is_valid_player_attrib_value(p_rsp->param.player_setting.attr_id[xx],
                    ...
                    {*(p_data)++ = (UINT8)(p_rsp->param.player_setting.attr_id[xx]);};
                    {*(p_data)++ = (UINT8)(p_rsp->param.player_setting.attr_value[xx]);};
                } else {
                    {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "bad player app seeting attribute or value" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
                    status = 0x01;
                    break;
                }
                len += 2;
    ...
    default:
        status = 0x01;
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "unknown event_id" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    }
...
# 618 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_next_rsp (tAVRC_RSP *p_rsp, BT_HDR *p_pkt)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_next_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    return 0x04;
}
# 639 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
tAVRC_STS avrc_bld_group_navigation_rsp (UINT16 navi_id, BT_HDR *p_pkt)
{
    UINT8 *p_data;

    if (!((navi_id <= 0x01) ? 
# 643 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
        1 
# 643 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
        : 
# 643 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
        0
# 643 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
        )) {
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_bld_group_navigation_rsp bad navigation op id: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", navi_id); };};
        return 0x01;
    }

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_group_navigation_rsp" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    p_data = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    {*(p_data)++ = (UINT8)((navi_id) >> 8); *(p_data)++ = (UINT8)(navi_id);};
    p_pkt->len = 2;
    return 0x04;
}
# 665 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static tAVRC_STS avrc_bld_rejected_rsp( tAVRC_RSP *p_rsp, BT_HDR *p_pkt )
{
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_rejected_rsp: status=%d, pdu:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_rsp->status, p_rsp->pdu); };};

    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_start + 2;
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "pdu:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", *p_start); };};

    {*(p_data)++ = (UINT8)((1) >> 8); *(p_data)++ = (UINT8)(1);};
    {*(p_data)++ = (UINT8)(p_rsp->status);};
    p_pkt->len = p_data - p_start;

    return 0x04;
}
# 692 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
static BT_HDR *avrc_bld_init_rsp_buffer(tAVRC_RESPONSE *p_rsp)
{
    ...
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_init_rsp_buffer: pdu=%x, opcode=%x/%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_rsp->pdu, opcode, p_rsp->rsp.opcode); };}
                                     ;
    if (opcode != p_rsp->rsp.opcode && p_rsp->rsp.status != 0x04 &&
            avrc_is_valid_opcode(p_rsp->rsp.opcode)) {
        opcode = p_rsp->rsp.opcode;
        {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "opcode=%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", opcode); };};
    }
    ...
    BT_HDR *p_pkt = (BT_HDR *)malloc(((4096 + 16)));
    if (p_pkt) {
        UINT8 *p_data, *p_start;
...
# 759 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
tAVRC_STS AVRC_BldResponse( UINT8 handle, tAVRC_RESPONSE *p_rsp, BT_HDR **pp_pkt)
{
    tAVRC_STS status = 0x01;
    BT_HDR *p_pkt;
    BOOLEAN alloc = 
# 763 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
                   0
# 763 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                        ;
    (void)(handle);

    if (!p_rsp || !pp_pkt) {
        {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldResponse. Invalid parameters passed. p_rsp=%p, pp_pkt=%p" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_rsp, pp_pkt); };}
                                     ;
        return 0x01;
    }

    if (*pp_pkt == 
# 772 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
                  ((void *)0)
# 772 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                      ) {
        if ((*pp_pkt = avrc_bld_init_rsp_buffer(p_rsp)) == 
# 773 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
                                                          ((void *)0)
# 773 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                                                              ) {
            {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldResponse: Failed to initialize response buffer" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            return 0x03;
        }
        alloc = 
# 777 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
               1
# 777 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                   ;
    }
    status = 0x04;
    p_pkt = *pp_pkt;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldResponse: pdu=%x status=%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_rsp->rsp.pdu, p_rsp->rsp.status); };};
    if (p_rsp->rsp.status != 0x04) {
    ...
    if (alloc && (status != 0x04) ) {
        free((p_pkt));
        *pp_pkt = 
# 852 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c" 3 4
                 ((void *)0)
# 852 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_tg.c"
                     ;
    }
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldResponse: returning %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", status); };};
    return status;
}
