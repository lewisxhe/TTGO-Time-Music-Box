# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/include/device/controller.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/include/device/controller.h"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/include/stack/btm_ble_api.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/include/stack/btm_ble_api.h"
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 2
...
const bt_event_mask_t CLASSIC_EVENT_MASK = { "\x3D\xBF\xFF\xFF\xFF\xFF\xFF\xFF" };
...
static uint8_t supported_commands[64];
static bt_device_features_t features_classic[3];
...
static uint8_t ble_supported_states[8];
static bt_device_features_t features_ble;
static uint16_t ble_suggested_default_data_length;
static uint16_t ble_suggested_default_data_txtime;

static 
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           readable;
static 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           ble_supported;
static 
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           simple_pairing_supported;
static 
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
...
static void start_up(void)
{
    ...
    response = future_await(hci->transmit_command_futured(packet_factory->make_reset()));
    packet_parser->parse_generic_command_complete(response);


    response = future_await(hci->transmit_command_futured(packet_factory->make_read_buffer_size()));
    ...
    response = future_await(hci->transmit_command_futured(packet_factory->make_set_c2h_flow_control(1)));
    packet_parser->parse_generic_command_complete(response);




    response = future_await(hci->transmit_command_futured(packet_factory->make_host_buffer_size( 1691, SCO_HOST_BUFFER_SIZE, 20, 10 )))
    ...
    response = future_await(hci->transmit_command_futured(packet_factory->make_read_local_version_info()));
    packet_parser->parse_read_local_version_info_response(response, &bt_version);


    response = future_await(hci->transmit_command_futured(packet_factory->make_read_bd_addr()));
    packet_parser->parse_read_bd_addr_response(response, &address);


    response = future_await(hci->transmit_command_futured(packet_factory->make_read_local_supported_commands()));
    ...
    response = future_await(hci->transmit_command_futured(packet_factory->make_read_local_extended_features(page_number)));
    ...
    ((page_number == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 145, __func__, "page_number == 0"));
    page_number++;
    ...
    simple_pairing_supported = ((features_classic[0].as_array)[6] & 0x08);
    if (simple_pairing_supported) {
        response = future_await(hci->transmit_command_futured(packet_factory->make_write_simple_pairing_mode(0x01)));
        packet_parser->parse_generic_command_complete(response);
    }


    if (((features_classic[0].as_array)[4] & 0x40)) {
        uint8_t simultaneous_le_host = ((features_classic[0].as_array)[6] & 0x02) ? 0x01 : 0;
        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_write_host_support(0x01, simultaneous_le_host)))
...
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
    ble_supported = last_features_classic_page_index >= 1 && ((features_classic[1].as_array)[0] & 0x02);
    if (ble_supported) {

        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_white_list_size()));
        packet_parser->parse_ble_read_white_list_size_response(response, &ble_white_list_size);


        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_buffer_size()));
        ...
        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_supported_states()));
        ...
        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_local_supported_features()));
        packet_parser->parse_ble_read_local_supported_features_response(
            response,
            &features_ble
        );

        if (((features_ble.as_array)[0] & 0x40)) {
            response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_resolving_list_size()));
            packet_parser->parse_ble_read_resolving_list_size_response(
                response,
                &ble_resolving_list_max_size);
        }

        if (((features_ble.as_array)[0] & 0x20)) {

            response = future_await(hci->transmit_command_futured(packet_factory->make_ble_write_suggested_default_data_length(0x00fb, 0x0848)));
            packet_parser->parse_generic_command_complete(response);

            response = future_await(hci->transmit_command_futured(packet_factory->make_ble_read_suggested_default_data_length()));
        ...
        response = future_await(hci->transmit_command_futured(packet_factory->make_ble_set_event_mask(&BLE_EVENT_MASK)));
        packet_parser->parse_generic_command_complete(response);
    }


    if (simple_pairing_supported) {
        response = future_await(hci->transmit_command_futured(packet_factory->make_set_event_mask(&CLASSIC_EVENT_MASK)));
        packet_parser->parse_generic_command_complete(response);
    }
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
    readable = 
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
              1
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
                  ;
...
{
    readable = 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
              0
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
                   ;
}

static 
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           get_is_ready(void)
{
    return readable;
}
...
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 282, __func__, "readable"));
    return &address;
}

static const bt_version_t *get_bt_version(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 288, __func__, "readable"));
    return &bt_version;
}
...
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 295, __func__, "readable"));
    ((index < 3) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 296, __func__, "index < MAX_FEATURES_CLASSIC_PAGE_COUNT"));
    return &features_classic[index];
}

static uint8_t get_last_features_classic_index(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 302, __func__, "readable"));
    return last_features_classic_page_index;
}

static const bt_device_features_t *get_features_ble(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 308, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 309, __func__, "ble_supported"));
    return &features_ble;
}

static const uint8_t *get_ble_supported_states(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 315, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 316, __func__, "ble_supported"));
    return ble_supported_states;
}

static 
# 320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_simple_pairing(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 322, __func__, "readable"));
    return simple_pairing_supported;
}

static 
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_secure_connections(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 328, __func__, "readable"));
    return secure_connections_supported;
}

static 
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_simultaneous_le_bredr(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 334, __func__, "readable"));
    return ((features_classic[0].as_array)[6] & 0x02);
}

static 
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_reading_remote_extended_features(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 340, __func__, "readable"));
    return ((supported_commands)[2] & 0x40);
}

static 
# 344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_interlaced_inquiry_scan(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 346, __func__, "readable"));
    return ((features_classic[0].as_array)[3] & 0x10);
}

static 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_rssi_with_inquiry_results(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 352, __func__, "readable"));
    return ((features_classic[0].as_array)[3] & 0x40);
}

static 
# 356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 356 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_extended_inquiry_response(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 358, __func__, "readable"));
    return ((features_classic[0].as_array)[6] & 0x01);
}

static 
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_master_slave_role_switch(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 364, __func__, "readable"));
    return (0 & ((features_classic[0].as_array)[0] & 0x20));
}

static 
# 368 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 368 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_ble(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 370, __func__, "readable"));
    return ble_supported;
}

static 
# 374 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 374 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_ble_privacy(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 376, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 377, __func__, "ble_supported"));
    return ((features_ble.as_array)[0] & 0x40);
}

static 
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_ble_packet_extension(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 383, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 384, __func__, "ble_supported"));
    return ((features_ble.as_array)[0] & 0x20);
}

static 
# 388 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
      _Bool 
# 388 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
           supports_ble_connection_parameters_request(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 390, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 391, __func__, "ble_supported"));
    return ((features_ble.as_array)[0] & 0x02);
}

static uint16_t get_acl_data_size_classic(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 397, __func__, "readable"));
    return acl_data_size_classic;
}

static uint16_t get_acl_data_size_ble(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 403, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 404, __func__, "ble_supported"));
    return acl_data_size_ble;
}

static uint16_t get_acl_packet_size_classic(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 410, __func__, "readable"));
    return acl_data_size_classic + 4;
}

static uint16_t get_acl_packet_size_ble(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 416, __func__, "readable"));
    return acl_data_size_ble + 4;
}

static uint16_t get_ble_suggested_default_data_length(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 422, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 423, __func__, "ble_supported"));
    return ble_suggested_default_data_length;
}

static uint16_t get_ble_suggested_default_data_txtime(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 429, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 430, __func__, "ble_supported"));
    return ble_suggested_default_data_txtime;
}

static uint16_t get_acl_buffer_count_classic(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 436, __func__, "readable"));
    return acl_buffer_count_classic;
}

static uint8_t get_acl_buffer_count_ble(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 442, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 443, __func__, "ble_supported"));
    return acl_buffer_count_ble;
}

static uint8_t get_ble_white_list_size(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 449, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 450, __func__, "ble_supported"));
    return ble_white_list_size;
}

static uint8_t get_ble_resolving_list_max_size(void)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 456, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 457, __func__, "ble_supported"));
    return ble_resolving_list_max_size;
}

static void set_ble_resolving_list_max_size(int resolving_list_max_size)
{
    ((readable) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 463, __func__, "readable"));
    ((ble_supported) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c", 464, __func__, "ble_supported"));
    ble_resolving_list_max_size = resolving_list_max_size;
}
# 482 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
...
{
    static 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
          _Bool 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
               loaded = 
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
                        0
# 533 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
    ...
    if (!loaded) {
        loaded = 
# 535 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c" 3 4
                1
# 535 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/device/controller.c"
                    ;
