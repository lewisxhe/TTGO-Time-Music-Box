# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 2
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static void bta_av_acp_sig_timer_cback (TIMER_LIST_ENT *p_tle);
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
tBTA_AV_RCB *bta_av_get_rcb_by_shdl(UINT8 shdl)
{
    tBTA_AV_RCB *p_rcb = 
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
    int i;

    for (i = 0; i < (2 + 2); i++) {
        if (bta_av_cb.rcb[i].shdl == shdl && bta_av_cb.rcb[i].handle != 0xFF) {
...
# 94 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_del_rc(tBTA_AV_RCB *p_rcb)
{
    ...
    p_scb = 
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
           ((void *)0)
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
               ;
    if (p_rcb->handle != 0xFF) {
        if (p_rcb->shdl) {
            ...
            if (p_scb) {
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_del_rc shdl:%d, srch:%d rc_handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->shdl, p_scb->rc_handle, p_rcb->handle); };}
                                                                 ;
                if (p_scb->rc_handle == p_rcb->handle) {
                    p_scb->rc_handle = 0xFF;
                }
        ...
        {if (appl_trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_del_rc  handle: %d status=0x%x, rc_acp_handle:%d, idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->handle, p_rcb->status, bta_av_cb.rc_acp_handle, bta_av_cb.rc_acp_idx); };}
                                                                                                     ;
        rc_handle = p_rcb->handle;
        if (!(p_rcb->status & 0x20) ||
                ((p_rcb->status & 0x10) == 0x00) ) {
            p_rcb->status = 0;
            p_rcb->handle = 0xFF;
            p_rcb->shdl = 0;
            p_rcb->lidx = 0;
        ...
        if (rc_handle == bta_av_cb.rc_acp_handle) {
            bta_av_cb.rc_acp_handle = 0xFF;
        }
        {if (appl_trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "end del_rc handle: %d status=0x%x, rc_acp_handle:%d, lidx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->handle, p_rcb->status, bta_av_cb.rc_acp_handle, p_rcb->lidx); };}
                                                                                            ;
    }
}
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static void bta_av_close_all_rc(tBTA_AV_CB *p_cb)
{
    ...
    for (i = 0; i < (2 + 2); i++) {
        if ((p_cb->disabling == 
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                               1
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                   ) || (bta_av_cb.rcb[i].shdl != 0)) {
            bta_av_del_rc(&bta_av_cb.rcb[i]);
        }
    }
}
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                          ((void *)0)
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                              ) {
        p_msg->event = BTA_AV_SDP_AVRC_DISC_EVT;
        bta_sys_sendmsg(p_msg);
    }
}
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static void bta_av_rc_ctrl_cback(UINT8 handle, UINT8 event, UINT16 result, BD_ADDR peer_addr)
{
    ...
    {if (appl_trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_ctrl_cback handle: %d event=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", handle, event); };};
    ...
    if (msg_event) {
        if ((p_msg = (tBTA_AV_RC_CONN_CHG *) malloc((sizeof(tBTA_AV_RC_CONN_CHG)))) != 
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                        ((void *)0)
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                            ) {
...
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static void bta_av_rc_msg_cback(UINT8 handle, UINT8 label, UINT8 opcode, tAVRC_MSG *p_msg)
{
    UINT8 *p_data_src = 
# 248 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                 ((void *)0)
# 248 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                     ;
    UINT16 data_len = 0;

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s handle: %u opcode=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, handle, opcode); };};


    if (opcode == 0x00 && p_msg->vendor.p_vendor_data != 
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                  ((void *)0)
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                      ) {
        p_data_src = p_msg->vendor.p_vendor_data;
        data_len = (UINT16) p_msg->vendor.vendor_len;
    } else if (opcode == 0x7C && p_msg->pass.p_pass_data != 
# 257 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                        ((void *)0)
# 257 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                            ) {
    ...
    tBTA_AV_RC_MSG *p_buf =
        (tBTA_AV_RC_MSG *)malloc(((UINT16)(sizeof(tBTA_AV_RC_MSG) + data_len)));
    if (p_buf != 
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                ((void *)0)
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                    ) {
        ...
        if (p_data_src != 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                         ((void *)0)
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                             ) {
...
# 294 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
UINT8 bta_av_rc_create(tBTA_AV_CB *p_cb, UINT8 role, UINT8 shdl, UINT8 lidx)
{
    ...
    if (role == 0) {
        ...
        if ((p_rcb = bta_av_get_rcb_by_shdl(shdl)) != 
# 308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                     ((void *)0) 
# 308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                          ) {
            {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_rc_create ACP handle exist for shdl:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", shdl); };};
            return p_rcb->handle;
        }
    }
    ...
    ccb.control = p_cb->features & (0x0001 | 0x0002 | 4);


    if (AVRC_Open(&rc_handle, &ccb, bda) != 0) {
        return 0xFF;
    }
    ...
    if (p_rcb->handle != 0xFF) {
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_av_rc_create found duplicated handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", rc_handle); };};
    }
    ...
    if (lidx == (2 + 1)) {
        ...
        p_cb->rc_acp_idx = (i + 1);
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_acp_handle:%d idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->rc_acp_handle, p_cb->rc_acp_idx); };};
    }
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "create %d, role: %d, shdl:%d, rc_handle:%d, lidx:%d, status:0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, role, shdl, p_rcb->handle, lidx, p_rcb->status); };}
                                                                       ;

    return rc_handle;
}
# 359 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static tBTA_AV_CODE bta_av_group_navi_supported(UINT8 len, UINT8 *p_data, BOOLEAN is_inquiry)
{
    ...
    if (p_bta_av_cfg->avrc_group && len == 5) {
        {u32 = (((UINT32)(*((p_ptr) + 2))) + (((UINT32)(*((p_ptr) + 1))) << 8) + (((UINT32)(*(p_ptr))) << 16)); (p_ptr) += 3;};
        {u16 = (UINT16)(((UINT16)(*(p_ptr)) << 8) + (UINT16)(*((p_ptr) + 1))); (p_ptr) += 2;};
...
# 397 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static tBTA_AV_CODE bta_av_op_supported(tBTA_AV_RC rc_id, BOOLEAN is_inquiry)
{
    tBTA_AV_CODE ret_code = 8;
    ...
    if (p_bta_av_rc_id) {
        if (is_inquiry) {
            ...
            if (p_bta_av_rc_id[rc_id >> 4] & (1 << (rc_id & 0x0F))) {
                ret_code = 9;
            } else if ((p_bta_av_cfg->rc_pass_rsp == 15) && p_bta_av_rc_id_ac) {
...
# 429 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
tBTA_AV_LCB *bta_av_find_lcb(BD_ADDR addr, UINT8 op)
{
    ...
    UINT8 mask;
    tBTA_AV_LCB *p_lcb = 
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
    ...
    for (xx = 0; xx < 2; xx++) {
        ...
        if ((mask & p_cb->conn_lcb) && 0 == ( bdcmp(p_cb->lcb[xx].addr, addr))) {
            ...
            if (op == BTA_AV_LCB_FREE) {
                p_cb->conn_lcb &= ~mask;
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "conn_lcb: 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->conn_lcb); };};
            }
            break;
        }
    }
...
# 459 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_opened(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (p_scb && bdcmp(p_scb->peer_addr, p_data->rc_conn_chg.peer_addr) == 0) {
            ...
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_opened shdl:%d, srch %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i + 1, p_scb->rc_handle); };};
            shdl = i + 1;
            {if (appl_trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "%s allow incoming AVRCP connections:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __func__, p_scb->use_rc); };};
            bta_sys_stop_timer(&p_scb->timer);
            disc = p_scb->hndl;
            break;
        }
    ...
    if (p_cb->rcb[i].handle == 0xFF) {
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "not a valid handle:%d any more" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i); };};
        return;
    }


    if (p_cb->rcb[i].lidx == (2 + 1) && shdl != 0) {
        ...
        if (p_rcb) {
            ...
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "switching RCB rc_acp_handle:%d idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->rc_acp_handle, p_cb->rc_acp_idx); };}
                                                                   ;
        }
    }
    ...
    rc_open.rc_handle = i;
    {if (appl_trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_opened rcb[%d] shdl:%d lidx:%d/%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, shdl, p_cb->rcb[i].lidx, p_cb->lcb[2].lidx); };}
                                                                                  ;
    p_cb->rcb[i].status |= 0x20;

    if (!shdl && 0 == p_cb->lcb[2].lidx) {


        p_lcb = &p_cb->lcb[2];
        bdcpy(p_lcb->addr, p_data->rc_conn_chg.peer_addr);
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_only bd_addr:%02x-%02x-%02x-%02x-%02x-%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_lcb->addr[0], p_lcb->addr[1], p_lcb->addr[2], p_lcb->addr[3], p_lcb->addr[4], p_lcb->addr[5]); };}
        ...
        p_lcb->conn_msk = 1;
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "rcb[%d].lidx=%d, lcb.conn_msk=x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, p_cb->rcb[i].lidx, p_lcb->conn_msk); };}
                                                               ;
        disc = p_data->rc_conn_chg.handle | 0xC0;
    }

    bdcpy(rc_open.peer_addr, p_data->rc_conn_chg.peer_addr);
    rc_open.peer_features = p_cb->rcb[i].peer_features;
    rc_open.sdp_disc_done = 
# 532 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                           1
# 532 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                               ;
    rc_open.status = 0;
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "local features:x%x peer_features:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->features, rc_open.peer_features); };}
                                           ;
    if (rc_open.peer_features == 0) {


        rc_open.peer_features = 0x0002;
        rc_open.sdp_disc_done = 
# 540 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                               0
# 540 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                    ;
        bta_av_rc_disc(disc);
    }
    (*p_cb->p_cback)(8, (tBTA_AV *) &rc_open);

}
# 557 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_remote_cmd(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    tBTA_AV_RCB *p_rcb;
    if (p_cb->features & 0x0002) {
        if (p_data->hdr.layer_specific < (2 + 2)) {
...
# 580 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_vendor_cmd(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    tBTA_AV_RCB *p_rcb;
    if ( (p_cb->features & (0x0002 | 0x0008)) ==
            (0x0002 | 0x0008)) {
        if (p_data->hdr.layer_specific < (2 + 2)) {
            p_rcb = &p_cb->rcb[p_data->hdr.layer_specific];
...
# 601 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_vendor_rsp(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    tBTA_AV_RCB *p_rcb;
    if ( (p_cb->features & (0x0001 | 0x0008)) ==
            (0x0001 | 0x0008)) {
        if (p_data->hdr.layer_specific < (2 + 2)) {
            p_rcb = &p_cb->rcb[p_data->hdr.layer_specific];
...
# 622 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_meta_rsp(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    tBTA_AV_RCB *p_rcb;
    BOOLEAN do_free = 
# 625 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                             1
# 625 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                 ;

    if ((p_cb->features & 0x0040) && (p_data->hdr.layer_specific < (2 + 2))) {
        if ((p_data->api_meta_rsp.is_rsp && (p_cb->features & 0x0001)) ||
                (!p_data->api_meta_rsp.is_rsp && (p_cb->features & 0x0002)) ) {
            p_rcb = &p_cb->rcb[p_data->hdr.layer_specific];
            if (p_rcb->handle != 0xFF) {
                ...
                do_free = 
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                         0
# 635 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                              ;
            }
        }
    }
    ...
    if (do_free) {
        free((p_data->api_meta_rsp.p_pkt));
    }
}
# 654 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 670 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_free_msg (tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    (void)(p_cb);
    (void)(p_data);
}
# 687 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static tAVRC_STS bta_av_chk_notif_evt_id(tAVRC_MSG_VENDOR *p_vendor)
{
    tAVRC_STS status = 0xFF;
    UINT8 xx;
    UINT16 u16;
...
# 722 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
tBTA_AV_EVT bta_av_proc_meta_cmd(tAVRC_RESPONSE *p_rc_rsp, tBTA_AV_RC_MSG *p_msg, UINT8 *p_ctype)
{
    ...
    *p_ctype = 10;
    ...
    if (p_vendor->hdr.subunit_type != 0x09) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "SUBUNIT must be PANEL" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};

        evt = 0;
        p_vendor->hdr.ctype = 8;
        AVRC_VendorRsp(p_msg->handle, p_msg->label, &p_msg->msg.vendor);
    } else if (!AVRC_IsValidAvcType(pdu, p_vendor->hdr.ctype) ) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "Invalid pdu/ctype: 0x%x, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", pdu, p_vendor->hdr.ctype); };};

        evt = 0;
        p_rc_rsp->rsp.status = 0x00;
    } else {
        switch (pdu) {
        case 0x10:
            ...
            if ((u16 != 1) || (p_vendor->vendor_len != 5)) {
                p_rc_rsp->get_caps.status = 0x03;
            } else {
                p_rc_rsp->get_caps.status = 0x04;
                if (u8 == 0x02) {
                    *p_ctype = 12;
                    ...
                    *p_ctype = 12;
                    ...
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "Invalid capability ID: 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", u8); };};

                    p_rc_rsp->get_caps.status = 0x01;
                }
            }
            break;
...
# 808 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_msg(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    tBTA_AV_EVT evt = 0;
    tBTA_AV av;
    BT_HDR *p_pkt = 
# 812 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 812 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
    tAVRC_MSG_VENDOR *p_vendor = &p_data->rc_msg.msg.vendor;
    BOOLEAN is_inquiry = ((p_data->rc_msg.msg.hdr.ctype == 2) || p_data->rc_msg.msg.hdr.ctype == 4);

    UINT8 ctype = 0;
    tAVRC_RESPONSE rc_rsp;

    rc_rsp.rsp.status = 0xFF;


    if (p_data->rc_msg.opcode == 0x7C) {

        if ((p_data->rc_msg.msg.hdr.ctype == 0) ||
                (p_data->rc_msg.msg.hdr.ctype == 2) ||
                (p_data->rc_msg.msg.hdr.ctype == 4)
           ) {

            if (p_data->rc_msg.msg.pass.op_id == 0x7E) {
                p_data->rc_msg.msg.hdr.ctype = 8;

                if (p_cb->features & 0x0040)
            ...
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "ctype %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_data->rc_msg.msg.hdr.ctype); };}


            if (p_data->rc_msg.msg.hdr.ctype != 15) {
                AVRC_PassRsp(p_data->rc_msg.handle, p_data->rc_msg.label, &p_data->rc_msg.msg.pass);
            }


            if (p_data->rc_msg.msg.hdr.ctype == 9 || p_data->rc_msg.msg.hdr.ctype == 15) {
                evt = 10;
        ...
        else if (p_data->rc_msg.msg.hdr.ctype >= 9) {
            ...
            p_data->rc_msg.msg.hdr.ctype = 10;
            AVRC_PassRsp(p_data->rc_msg.handle, p_data->rc_msg.label, &p_data->rc_msg.msg.pass);
        }
    }

    else if (p_data->rc_msg.opcode == 0x00) {
        ...
        if ((p_cb->features & 0x0008) &&
                p_data->rc_msg.msg.hdr.ctype <= 4) {

            if ((p_cb->features & 0x0040) &&
                    (p_vendor->company_id == 0x00001958)) {
        ...
        else if ((p_cb->features & 0x0008) &&
                 p_data->rc_msg.msg.hdr.ctype >= 9) {
            ...
            if ((p_cb->features & 0x0040) &&
                ...
                evt = 13;
                 ...
                 p_data->rc_msg.msg.hdr.ctype <= 4) {
            if (p_data->rc_msg.msg.vendor.p_vendor_data[0] == 0xff) {

                p_data->rc_msg.msg.hdr.ctype = 10;
                p_data->rc_msg.msg.vendor.p_vendor_data[4] = 0x00;
            } else {
                p_data->rc_msg.msg.hdr.ctype = 8;
            }
    ...
    if (evt == 0 && rc_rsp.rsp.status != 0xFF) {
        if (!p_pkt) {
...
# 949 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_close (tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    ...
    if (handle < (2 + 2)) {
        ...
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_close handle: %d, status=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->handle, p_rcb->status); };};
        if (p_rcb->handle != 0xFF) {
            if (p_rcb->shdl) {
                p_scb = bta_av_cb.p_scb[p_rcb->shdl - 1];
                if (p_scb) {
...
# 982 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 1005 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_stream_chg(tBTA_AV_SCB *p_scb, BOOLEAN started)
{
    ...
    UINT8 *p_streams;
    BOOLEAN no_streams = 
# 1010 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        0
# 1010 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                             ;
    tBTA_AV_SCB *p_scbi;

    started_msk = ((UINT8)(1 << (p_scb->hdi)));
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_stream_chg started:%d started_msk:x%x chnl:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", started, started_msk, p_scb->chnl); };}
                                               ;
    if (0x40 == p_scb->chnl) {
    ...
    if (started) {
        ...
        L2CA_SetAclPriority(p_scb->peer_addr, 1);
    ...
    if (!started) {
        ...
        if (0x40 == p_scb->chnl) {
            if (bta_av_cb.video_streams == 0) {
                no_streams = 
# 1034 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                            1
# 1034 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                ;
            }
        } else {
            no_streams = 
# 1037 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        1
# 1037 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
            if ( bta_av_cb.audio_streams ) {
                for (; i < 2; i++) {
                    p_scbi = bta_av_cb.p_scb[i];

                    if ( p_scbi && (bta_av_cb.audio_streams & ((UINT8)(1 << (i))))
                            && bdcmp(p_scbi->peer_addr, p_scb->peer_addr) == 0) {
                        no_streams = 
# 1044 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                    0
# 1044 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                         ;
                        break;
                    }
                }
        ...
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "no_streams:%d i:%d, audio_streams:x%x, video_streams:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", no_streams, i, bta_av_cb.audio_streams, bta_av_cb.video_streams); };}
                                                                           ;
        if (no_streams) {

            L2CA_SetAclPriority(p_scb->peer_addr, 0);
        }
    }
}
# 1072 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_conn_chg(tBTA_AV_DATA *p_data)
{
    tBTA_AV_CB *p_cb = &bta_av_cb;
    tBTA_AV_SCB *p_scb = 
# 1075 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                            ((void *)0)
# 1075 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                ;
    tBTA_AV_SCB *p_scbi;
    UINT8 mask;
    UINT8 conn_msk;
    UINT8 old_msk;
    int i;
    int index = (p_data->hdr.layer_specific & 0x3F) - 1;
    tBTA_AV_LCB *p_lcb;
    tBTA_AV_LCB *p_lcb_rc;
    tBTA_AV_RCB *p_rcb, *p_rcb2;
    BOOLEAN chk_restore = 
# 1085 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                             0
# 1085 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                  ;
    ...
    if (p_data->conn_chg.is_up) {
        ...
        if (p_scb) {
            if (p_lcb) {
                ...
                for (i = 0; i < (2 + 2); i++) {
                    if (bta_av_cb.rcb[i].lidx == p_lcb->lidx) {
                        ...
                        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "conn_chg up[%d]: %d, status=0x%x, shdl:%d, lidx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, bta_av_cb.rcb[i].handle, bta_av_cb.rcb[i].status, bta_av_cb.rcb[i].shdl, bta_av_cb.rcb[i].lidx); };}
            ...
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_acp_handle:%d rc_acp_idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->rc_acp_handle, p_cb->rc_acp_idx); };};

            if (p_lcb && p_cb->rc_acp_handle != 0xFF && p_cb->rc_acp_idx) {
                p_lcb_rc = &p_cb->lcb[2];
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_acp is connected && conn_chg on same addr p_lcb_rc->conn_msk:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_lcb_rc->conn_msk); };}
                                                    ;

                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "p_lcb_rc->addr: %02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_lcb_rc->addr[0], p_lcb_rc->addr[1], p_lcb_rc->addr[2], p_lcb_rc->addr[3], p_lcb_rc->addr[4], p_lcb_rc->addr[5]); };}

                                                                       ;
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "conn_chg.peer_addr: %02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_data->conn_chg.peer_addr[0], p_data->conn_chg.peer_addr[1], p_data->conn_chg.peer_addr[2], p_data->conn_chg.peer_addr[3], p_data->conn_chg.peer_addr[4], p_data->conn_chg.peer_addr[5]); };}
                ...
                if (p_lcb_rc->conn_msk && bdcmp(p_lcb_rc->addr, p_data->conn_chg.peer_addr) == 0) {
                    ...
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "update rc_acp shdl:%d/%d srch:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", index + 1, p_rcb->shdl, p_scb->rc_handle); };}
                                                       ;
                    ...
                    if (p_rcb2) {
                        ...
                        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "new rc_acp_handle:%d, idx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->rc_acp_handle, p_cb->rc_acp_idx); };}
                                                          ;
                        p_rcb2->lidx = (2 + 1);
                        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc2 handle:%d lidx:%d/%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb2->handle, p_rcb2->lidx, p_cb->lcb[p_rcb2->lidx - 1].lidx); };}
                                                                          ;
                    }
                    p_rcb->lidx = p_lcb->lidx;
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc handle:%d lidx:%d/%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->handle, p_rcb->lidx, p_cb->lcb[p_rcb->lidx - 1].lidx); };}
                                                                     ;
                }
            }
        }
        ...
        if (p_scb) {
            ...
            if (p_scb->chnl == 0x40) {
                ...
                chk_restore = 
# 1190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                             1
# 1190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                 ;
            }
        }

        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_conn_chg shdl:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", index + 1); };};
        for (i = 0; i < (2 + 2); i++) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "conn_chg dn[%d]: %d, status=0x%x, shdl:%d, lidx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, bta_av_cb.rcb[i].handle, bta_av_cb.rcb[i].status, bta_av_cb.rcb[i].shdl, bta_av_cb.rcb[i].lidx); };}
        ...
        if (bta_av_cb.rc_acp_handle == 0xFF && bta_av_cb.features & 0x0001) {
            bta_av_rc_create(&bta_av_cb, 1, 0, 2 + 1);
        }
    }

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_conn_chg audio:%x video:%x up:%d conn_msk:0x%x chk_restore:%d audio_open_cnt:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->conn_audio, p_cb->conn_video, p_data->conn_chg.is_up, conn_msk, chk_restore, p_cb->audio_open_cnt); };}
                                                                                                                             ;
    ...
    if (chk_restore) {
        if (p_cb->audio_open_cnt == 1) {
            ...
            bta_sys_set_default_policy(18, 0x0001);
...
# 1253 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_disable(tBTA_AV_CB *p_cb, tBTA_AV_DATA *p_data)
{
    ...
    p_cb->disabling = 
# 1259 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                     1
# 1259 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                         ;
...
# 1287 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
...
# 1302 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_sig_chg(tBTA_AV_DATA *p_data)
{
    ...
    UINT8 mask;
    tBTA_AV_LCB *p_lcb = 
# 1308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 1308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_sig_chg event: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", event); };};
    if (event == 16) {
        ...
        if (!p_lcb) {
            ...
            for (xx = 0; xx < 2; xx++) {
                ...
                if ((!(mask & p_cb->conn_lcb)) && (p_cb->p_scb[xx] != 
# 1320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                     ((void *)0)
# 1320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                         )) {
                    p_lcb = &p_cb->lcb[xx];
                    p_lcb->lidx = xx + 1;
                    ...
                    if (p_cb->features & 0x0001) {
                        bta_av_rc_create(p_cb, 1, 0, p_lcb->lidx);
                    }

                    p_cb->conn_lcb |= mask;
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "start sig timer %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_data->hdr.offset); };};
                    if (p_data->hdr.offset == 1) {
                        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "Incoming L2CAP acquired, set state as incoming" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
                        bdcpy(p_cb->p_scb[xx]->peer_addr, p_data->str_msg.bd_addr);
                        p_cb->p_scb[xx]->use_rc = 
# 1335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                 1
# 1335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                     ;
                        ...
                        bta_av_sig_timer(
# 1343 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                        ((void *)0)
# 1343 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                            );


                        p_cb->p_scb[xx]->coll_mask = 0x01;

                        p_cb->acp_sig_tmr.param = (UINT32)xx;
                        p_cb->acp_sig_tmr.p_cback = (TIMER_CBACK *)&bta_av_acp_sig_timer_cback;
                        bta_sys_start_timer(&p_cb->acp_sig_tmr, 0, 2000);
                    }
                    break;
                }
            }
            ...
            if (xx == 2) {
                ...
                {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "av scb not available for avdt connection" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
                AVDT_DisconnectReq (p_data->str_msg.bd_addr, 
# 1361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                            ((void *)0)
# 1361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                );
                return;
            }
        }
        ...
        if (p_lcb && p_lcb->conn_msk) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "conn_msk: 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_lcb->conn_msk); };};
            ...
            for (xx = 0; xx < 2; xx++) {
                ...
                if ((mask & p_lcb->conn_msk) && (p_cb->p_scb[xx]) &&
                    ...
                    bta_av_ssm_execute(p_cb->p_scb[xx], BTA_AV_AVDT_DISCONNECT_EVT, 
# 1382 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                   ((void *)0)
# 1382 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                       );
                }
            }
        }
...
# 1401 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_sig_timer(tBTA_AV_DATA *p_data)
{
    ...
    UINT8 mask;
    tBTA_AV_LCB *p_lcb = 
# 1406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 1406 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
    tBTA_AV_PEND pend;
    (void)(p_data);

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_sig_timer" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL"); };};
    for (xx = 0; xx < 2; xx++) {
        mask = 1 << xx;
        if (mask & p_cb->conn_lcb) {
            ...
            p_lcb = &p_cb->lcb[xx];
            if (!p_lcb->conn_msk) {
                bta_sys_start_timer(&p_cb->sig_tmr, BTA_AV_SIG_TIMER_EVT, 8000);
                bdcpy(pend.bd_addr, p_lcb->addr);
                (*p_cb->p_cback)(16, (tBTA_AV *) &pend);
            }
        }
    }
}
# 1435 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
static void bta_av_acp_sig_timer_cback (TIMER_LIST_ENT *p_tle)
{
    UINT8 inx = (UINT8)p_tle->param;
    tBTA_AV_CB *p_cb = &bta_av_cb;
    tBTA_AV_SCB *p_scb = 
# 1439 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                        ((void *)0)
# 1439 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                            ;
    ...
    if (p_scb) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_acp_sig_timer_cback, coll_mask = 0x%02X" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_scb->coll_mask); };};

        if (p_scb->coll_mask & 0x01) {
            p_scb->coll_mask &= ~0x01;
...
# 1460 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                               ((void *)0)
# 1460 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                   );
                }
                ...
                if (p_scb->coll_mask & 0x02) {
                    p_scb->coll_mask &= ~0x02;


                    if ((p_buf = (tBTA_AV_API_OPEN *) malloc((sizeof(tBTA_AV_API_OPEN)))) != 
# 1470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                              ((void *)0)
# 1470 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                                  ) {
...
# 1490 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
tBTA_AV_FEAT bta_av_check_peer_features (UINT16 service_uuid)
{
    tBTA_AV_FEAT peer_features = 0;
    tBTA_AV_CB *p_cb = &bta_av_cb;
    tSDP_DISC_REC *p_rec = 
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                ((void *)0)
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                    ;
    tSDP_DISC_ATTR *p_attr;
    UINT16 peer_rc_version = 0;
    UINT16 categories = 0;

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_check_peer_features service_uuid:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", service_uuid); };};

    while (
# 1501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
          1
# 1501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
              ) {

        if ((p_rec = SDP_FindServiceInDb(p_cb->p_disc_db, service_uuid, p_rec)) == 
# 1503 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                  ((void *)0)
# 1503 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                      ) {
            break;
        }

        if (( SDP_FindAttributeInRec(p_rec, 0x0001)) != 
# 1507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                              ((void *)0)
# 1507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                  ) {

            if (SDP_FindServiceInDb(p_cb->p_disc_db, 0X110E, 
# 1509 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                      ((void *)0)
# 1509 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                          )) {
                peer_features |= 0x0002;
            }
            if (SDP_FindServiceInDb(p_cb->p_disc_db, 0X110C, 
# 1512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                       ((void *)0)
# 1512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                           )) {
                peer_features |= 0x0001;
            }
        }

        if (( SDP_FindAttributeInRec(p_rec, 0x0009)) != 
# 1517 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                             ((void *)0)
# 1517 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                 ) {

            SDP_FindProfileVersionInRec(p_rec, 0X110E, &peer_rc_version);
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "peer_rc_version 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", peer_rc_version); };};

            if (peer_rc_version >= 0x0103) {
                peer_features |= (0x0008 | 0x0040);
            }

            if (peer_rc_version >= 0x0104) {
                peer_features |= (0x0200);

                if ((p_attr = SDP_FindAttributeInRec(p_rec,
                                                     0x0311)) != 
# 1530 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                                                    ((void *)0)
# 1530 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                                                        ) {
                    categories = p_attr->attr_value.v.u16;
                    if (categories & 0x0040) {
                        peer_features |= (0x0010);
                    }
                }
            }
        }
    }
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "peer_features:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", peer_features); };};
    return peer_features;
}
# 1553 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_disc_done(tBTA_AV_DATA *p_data)
{
    tBTA_AV_CB *p_cb = &bta_av_cb;
    tBTA_AV_SCB *p_scb = 
# 1556 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                         ((void *)0)
# 1556 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                             ;
    tBTA_AV_LCB *p_lcb;
    tBTA_AV_RC_OPEN rc_open;
    tBTA_AV_RC_FEAT rc_feat;
    ...
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_disc_done disc:x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->disc); };};
    if (!p_cb->disc) {
        return;
    }

    if ((p_cb->disc & 0xC0) == 0xC0) {

        rc_handle = p_cb->disc & (~0xC0);
    } else {

        if (((p_cb->disc & 0x3F) - 1) < 2) {
            p_scb = p_cb->p_scb[(p_cb->disc & 0x3F) - 1];
        }
        if (p_scb) {
    ...
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_handle %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", rc_handle); };};

    peer_features = bta_av_check_peer_features (0X110E);
    if ((p_cb->features & 0x0200) && ((peer_features & 0x0200) == 0)) {


        peer_features |= bta_av_check_peer_features (0X110C);
    }

    p_cb->disc = 0;
    utl_freebuf((void **) &p_cb->p_disc_db);

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "peer_features 0x%x, features 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", peer_features, p_cb->features); };};


    if (rc_handle == 0xFF) {
        if (p_scb) {

            if ((((p_cb->features & 0x0002) && (peer_features & 0x0001)) ||
                    ((p_cb->features & 0x0001) && (peer_features & 0x0002))) ) {
                p_lcb = bta_av_find_lcb(p_scb->peer_addr, BTA_AV_LCB_FIND);
                if (p_lcb) {
                    rc_handle = bta_av_rc_create(p_cb, 0, (UINT8)(p_scb->hdi + 1), p_lcb->lidx);
                ...
                p_scb->use_rc = 
# 1617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                               0
# 1617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                    ;
                bdcpy(rc_open.peer_addr, p_scb->peer_addr);
                rc_open.peer_features = 0;
                rc_open.sdp_disc_done = 
# 1620 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                       0
# 1620 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                            ;
                rc_open.status = 2;
                (*p_cb->p_cback)(8, (tBTA_AV *) &rc_open);
            }
        ...
        (*p_cb->p_cback)(19, (tBTA_AV *) &rc_feat);
    }
}
# 1642 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_closed(tBTA_AV_DATA *p_data)
{
    ...
    int i;
    BOOLEAN conn = 
# 1650 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                  0
# 1650 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                       ;
    tBTA_AV_LCB *p_lcb;

    rc_close.rc_handle = 0xFF;
    p_scb = 
# 1654 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
           ((void *)0)
# 1654 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
               ;
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_closed rc_handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_msg->handle); };};
    for (i = 0; i < (2 + 2); i++) {
        p_rcb = &p_cb->rcb[i];
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_closed rcb[%d] rc_handle:%d, status=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i, p_rcb->handle, p_rcb->status); };};
        if (p_rcb->handle == p_msg->handle) {
            rc_close.rc_handle = i;
            p_rcb->status &= ~0x20;
            p_rcb->peer_features = 0;
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "       shdl:%d, lidx:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->shdl, p_rcb->lidx); };};
            if (p_rcb->shdl) {
                if ((p_rcb->shdl - 1) < 2) {
                    p_scb = bta_av_cb.p_scb[p_rcb->shdl - 1];
                }
                if (p_scb) {
                    ...
                    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "shdl:%d, srch:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_rcb->shdl, p_scb->rc_handle); };};
                }
                p_rcb->shdl = 0;
            } else if (p_rcb->lidx == (2 + 1) ) {

                p_lcb = &p_cb->lcb[2];
                bdcpy(rc_close.peer_addr, p_msg->peer_addr);
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_only closed bd_addr:%02x-%02x-%02x-%02x-%02x-%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_msg->peer_addr[0], p_msg->peer_addr[1], p_msg->peer_addr[2], p_msg->peer_addr[3], p_msg->peer_addr[4], p_msg->peer_addr[5]); };}
        ...
        } else if ((p_rcb->handle != 0xFF) && (p_rcb->status & 0x20)) {

            conn = 
# 1704 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                  1
# 1704 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                      ;
        }
    }
    ...
    if (!conn) {
        ...
        bta_av_sm_execute(p_cb, BTA_AV_AVRC_NONE_EVT, 
# 1710 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                                     ((void *)0)
# 1710 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                                         );
    }

    if (rc_close.rc_handle == 0xFF) {
        rc_close.rc_handle = p_msg->handle;
        bdcpy(rc_close.peer_addr, p_msg->peer_addr);
    }
    (*p_cb->p_cback)(9, (tBTA_AV *) &rc_close);
}
# 1729 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_rc_disc(UINT8 disc)
{
    ...
    tBTA_AV_SCB *p_scb;
    UINT8 *p_addr = 
# 1739 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                         ((void *)0)
# 1739 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                             ;
    UINT8 rc_handle;

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_av_rc_disc 0x%x, %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", disc, bta_av_cb.disc); };};
    ...
    if ((disc & 0xC0) == 0xC0) {
        ...
        if (p_scb) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "rc_handle %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_scb->rc_handle); };};
    ...
    if (p_addr) {
        ...
        if (p_cb->p_disc_db == 
# 1765 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                              ((void *)0)
# 1765 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                  ) {
            p_cb->p_disc_db = (tSDP_DISCOVERY_DB *) malloc((1000));
        }
        ...
        if (p_cb->p_disc_db) {
            ...
            if (AVRC_FindService(0X110E, p_addr, &db_params,
                                 bta_av_avrc_sdp_cback) == 0) {
                p_cb->disc = disc;
                {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "disc %d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->disc); };};
            }
        }
    }
}
# 1795 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
void bta_av_dereg_comp(tBTA_AV_DATA *p_data)
{
    ...
    if (p_scb) {
        {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "deregistered %d(h%d)" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_scb->chnl, p_scb->hndl); };};
        mask = ((UINT8)(1 << (p_scb->hdi)));
        if (p_scb->chnl == 0x40) {
            p_cb->reg_audio &= ~mask;
            if ((p_cb->conn_audio & mask) && bta_av_cb.audio_open_cnt) {
            ...
            if (p_scb->q_tag == 0x03 && p_scb->a2d_list) {
        ...
        p_scb->a2d_list = 
# 1851 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                         ((void *)0)
# 1851 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                             ;
        utl_freebuf((void **)&p_cb->p_scb[p_scb->hdi]);
    }

    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "audio 0x%x, video: 0x%x, disable:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", p_cb->reg_audio, p_cb->reg_video, p_cb->disabling); };}
                                                                       ;

    if ((p_cb->reg_audio + p_cb->reg_video) == 0) {


        bta_ar_dereg_avdt(18);


        bta_ar_dereg_avrc (0X110C, 18);
        bta_ar_dereg_avct(18);


        if (p_cb->disabling) {
            p_cb->disabling = 
# 1869 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c" 3 4
                                 0
# 1869 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/av/bta_av_act.c"
                                      ;
