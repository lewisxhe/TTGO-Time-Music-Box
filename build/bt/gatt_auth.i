# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 2
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
static BOOLEAN gatt_sign_data (tGATT_CLCB *p_clcb)
{
    tGATT_VALUE *p_attr = (tGATT_VALUE *)p_clcb->p_attr_buf;
    UINT8 *p_data = 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                 ((void *)0)
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                     , *p;
    UINT16 payload_size = p_clcb->p_tcb->payload_size;
    BOOLEAN status = 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                0
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                     ;
    UINT8 *p_signature;


    gatt_set_sec_act(p_clcb->p_tcb, 1);

    p_data = (UINT8 *)malloc(((UINT16)(p_attr->len + 3)));

    if (p_data != 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                 ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                     ) {
        p = p_data;
        {*(p)++ = (UINT8)(0xD2);};
        {*(p)++ = (UINT8)(p_attr->handle); *(p)++ = (UINT8)((p_attr->handle) >> 8);};
        {register int ijk; for (ijk = 0; ijk < p_attr->len; ijk++) *(p)++ = (UINT8) p_attr->value[ijk];};


        if ((payload_size - 12 - 3) < p_attr->len) {
            p_attr->len = payload_size - 12 - 3;
        }
        ...
        if (BTM_BleDataSignature(p_clcb->p_tcb->peer_bda,
                                 ...
                                 p_signature)) {
            p_attr->len += 12;
            gatt_set_ch_state(p_clcb->p_tcb, 4);



        } else {
            gatt_end_operation(p_clcb, 0x81, 
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                                           ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                                               );
        }
...
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
void gatt_verify_signature(tGATT_TCB *p_tcb, BT_HDR *p_buf)
{
    ...
    if (p_buf->len < 12 + 4) {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Data length %u less than expected %u" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", __func__, p_buf->len, 12 + 4); };}
                                                                      ;
        return;
    }
    cmd_len = p_buf->len - 12 + 4;
    p = p_orig + cmd_len - 4;
    {counter = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
    ...
    if (BTM_BleVerifySignature(p_tcb->peer_bda, p_orig, cmd_len, counter, p)) {
        ...
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "Signature Verification Failed, data ignored" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    }

    return;
}
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
void gatt_sec_check_complete(BOOLEAN sec_check_ok, tGATT_CLCB *p_clcb, UINT8 sec_act)
{
    if (p_clcb && p_clcb->p_tcb &&
        ...
        gatt_set_sec_act(p_clcb->p_tcb, 0);
    }
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
}
# 166 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
void gatt_enc_cmpl_cback(BD_ADDR bd_addr, tBT_TRANSPORT transport, void *p_ref_data, tBTM_STATUS result)
{
    tGATT_TCB *p_tcb;
    UINT8 sec_flag;
    BOOLEAN status = 
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                        0
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                             ;
    (void)(p_ref_data);

    {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "gatt_enc_cmpl_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    if ((p_tcb = gatt_find_tcb_by_addr(bd_addr, transport)) != 
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                                              ((void *)0)
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                                                  ) {
        if (gatt_get_sec_act(p_tcb) == 6) {
            return;
        }
        tGATT_PENDING_ENC_CLCB *p_buf =
            (tGATT_PENDING_ENC_CLCB *)fixed_queue_try_dequeue(p_tcb->pending_enc_clcb);
        if (p_buf != 
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                    ((void *)0)
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                        ) {
            if (result == BTM_SUCCESS) {
                if (gatt_get_sec_act(p_tcb) == 5 ) {
                    BTM_GetSecurityFlagsByTransport(bd_addr, &sec_flag, transport);

                    if (sec_flag & 0x20) {
                        status = 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                1
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                    ;
                    }
                } else {
                    status = 
# 189 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                            1
# 189 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                ;
                }
            }
            ...
            for (size_t count = fixed_queue_length(p_tcb->pending_enc_clcb);
                ...
                if (p_buf != 
# 198 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                            ((void *)0)
# 198 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                ) {
            ...
            {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown operation encryption completed" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
        }
    } else {
        {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "enc callback for unknown bd_addr" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    }
}
# 223 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
...
# 228 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                                                    ((void *)0)
# 228 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                                                        ) {
        for (i = 0; i < 8; i++) {
        ...
        if (gatt_get_sec_act(p_tcb) == 6) {
            ...
            for (; count > 0; count--) {
                tGATT_PENDING_ENC_CLCB *p_buf =
                    (tGATT_PENDING_ENC_CLCB *)fixed_queue_try_dequeue(p_tcb->pending_enc_clcb);
                if (p_buf != 
# 242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                            ((void *)0)
# 242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                ) {
                    gatt_security_check_start(p_buf->p_clcb);
                    free((p_buf));
                } else {
        ...
        {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "notify GATT for encryption completion of unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    }
    return;
}
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
...
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
tGATT_SEC_ACTION gatt_get_sec_act(tGATT_TCB *p_tcb)
{
    tGATT_SEC_ACTION sec_act = 0;
    if (p_tcb) {
        sec_act = p_tcb->sec_act;
    }
    return sec_act;
}
# 297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
tGATT_SEC_ACTION gatt_determine_sec_act(tGATT_CLCB *p_clcb )
{
    tGATT_SEC_ACTION act = 1;
    UINT8 sec_flag;
    tGATT_TCB *p_tcb = p_clcb->p_tcb;
    tGATT_AUTH_REQ auth_req = p_clcb->auth_req;
    BOOLEAN is_link_encrypted = 
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                           0
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                                ;
    BOOLEAN is_link_key_known = 
# 304 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                           0
# 304 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                                ;
    BOOLEAN is_key_mitm = 
# 305 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                     0
# 305 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                          ;

    UINT8 key_type;
    tBTM_BLE_SEC_REQ_ACT sec_act = 0;
    ...
    if (sec_flag & (0x04 | 0x10)) {
        if (sec_flag & 0x04) {
            is_link_encrypted = 
# 329 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                               1
# 329 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                   ;
        }

        is_link_key_known = 
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                           1
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                               ;

        if (sec_flag & 0x20) {
            is_key_mitm = 
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                         1
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                             ;
        }
    }
...
# 404 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
tGATT_STATUS gatt_get_link_encrypt_status(tGATT_TCB *p_tcb)
{
    tGATT_STATUS encrypt_status = 0x8e;
    UINT8 sec_flag = 0;

    BTM_GetSecurityFlagsByTransport(p_tcb->peer_bda, &sec_flag, p_tcb->transport);

    if ((sec_flag & 0x04) && (sec_flag & 0x10)) {
        encrypt_status = 0x8d;
        if (sec_flag & 0x20) {
            encrypt_status = 0x00;
        }
    ...
    {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "gatt_get_link_encrypt_status status=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", encrypt_status); };};
    return encrypt_status ;
}
# 432 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
static BOOLEAN gatt_convert_sec_action(tGATT_SEC_ACTION gatt_sec_act, tBTM_BLE_SEC_ACT *p_btm_sec_act )
{
    BOOLEAN status = 
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                    1
# 434 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                        ;
    switch (gatt_sec_act) {
    case 3:
        *p_btm_sec_act = 1;
    ...
    default:
        status = 
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                0
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                     ;
        break;
    }
...
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
BOOLEAN gatt_security_check_start(tGATT_CLCB *p_clcb)
{
    ...
    BOOLEAN status = 
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                                1
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                    ;
    ...
    case 2:
        ...
        {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "gatt_security_check_start: Do data signing" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
    ...
    case 5:
        if (sec_act_old < 3) {
            {if (gatt_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "gatt_security_check_start: Encrypt now or key upgreade first" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT"); };};
            ...
            if ( (btm_status != BTM_SUCCESS) && (btm_status != BTM_CMD_STARTED)) {
                {if (gatt_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_GATT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_security_check_start BTM_SetEncryption failed btm_status=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT", btm_status); };};
                status = 
# 495 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                        0
# 495 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                             ;
            }
...
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                               1
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                                   , p_clcb, gatt_sec_act);
        break;
    }

    if (status == 
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c" 3 4
                 0
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/gatt/gatt_auth.c"
                      ) {
        gatt_set_sec_act(p_tcb, 0);
