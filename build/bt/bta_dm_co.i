# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_dm_ci.h" 1
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_dm_ci.h"
extern void bta_dm_ci_io_req(BD_ADDR bd_addr, tBTA_IO_CAP io_cap,
                             tBTA_OOB_DATA oob_data, tBTA_AUTH_REQ auth_req);
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_dm_ci.h"
extern void bta_dm_ci_rmt_oob(BOOLEAN accept, BD_ADDR bd_addr,
                              BT_OCTET16 c, BT_OCTET16 r);
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
void btc_dm_get_ble_local_keys(tBTA_DM_BLE_LOCAL_KEY_MASK *p_key_mask, BT_OCTET16 er,
                                                            tBTA_BLE_LOCAL_ID_KEYS *p_id_keys);
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/common/include/common/bte_appl.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/common/include/common/bte_appl.h"
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 2
...
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
BOOLEAN bta_dm_co_get_compress_memory(tBTA_SYS_ID id, UINT8 **memory_p, UINT32 *memory_size)
{
    ...
    (void)(memory_size);
    return 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 3 4
          1
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
              ;
}
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                      ...
                      tBTA_AUTH_REQ *p_auth_req, BOOLEAN is_orig)
{
    ...
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_req: func not ported\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};

    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_req *p_oob_data = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF", *p_oob_data); };};
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_req *p_io_cap = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF", *p_io_cap); };};
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_req *p_auth_req = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF", *p_auth_req); };};
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_req is_orig = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF", is_orig); };};
}
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                      ...
                      tBTA_OOB_DATA oob_data, tBTA_AUTH_REQ auth_req)
{
    ...
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_io_rsp: func not ported\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};

}
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
void bta_dm_co_lk_upgrade(BD_ADDR bd_addr, BOOLEAN *p_upgrade )
{
    (void)(bd_addr);
    (void)(p_upgrade);
}
# 160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
void bta_dm_co_loc_oob(BOOLEAN valid, BT_OCTET16 c, BT_OCTET16 r)
{
    ...
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_loc_oob: func not ported\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};

}
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
void bta_dm_co_rmt_oob(BD_ADDR bd_addr)
{
    BT_OCTET16 p_c;
    BT_OCTET16 p_r;
    BOOLEAN result = 
# 189 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 3 4
                    0
# 189 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                         ;
    ...
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_rmt_oob: func not ported\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};



    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_rmt_oob: result=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF", result); };};
    bta_dm_ci_rmt_oob(result, bd_addr, p_c, p_r);
}
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                             ...
                             tBTA_LE_KEY_TYPE *p_resp_key )
{
    ...
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "##################################" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "bta_dm_co_le_io_key_req: only setting max size to 16" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};
    {if (btif_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTIF", "D" " (%d) %s: " "##################################" "\033[0m" "\n", esp_log_timestamp(), "BT_BTIF"); };};
    *p_max_key_size = 16;
    *p_init_key = *p_resp_key =
                      ((1 << 0) | (1 << 1) | (1 << 2) | ((1 << 0) << 4) | ((1 << 1) << 4) | ((1 << 2) << 4));

}
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
...
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                          ...
                          tBTA_LE_KEY_TYPE *p_resp_key )
{
    ...
    *p_oob_data = 
# 298 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c" 3 4
                 0
# 298 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/dm/bta_dm_co.c"
                      ;



    *p_auth_req = bte_appl_cfg.ble_auth_req | (bte_appl_cfg.ble_auth_req & (1 << 2)) | ((*p_auth_req) & (1 << 2));

    if (bte_appl_cfg.ble_io_cap <= 4) {
        *p_io_cap = bte_appl_cfg.ble_io_cap;
    }

    if (bte_appl_cfg.ble_init_key <= 15) {
        *p_init_key = bte_appl_cfg.ble_init_key;
    }

    if (bte_appl_cfg.ble_resp_key <= 15) {
...
void bta_dm_co_ble_set_io_cap(UINT8 ble_io_cap)
{
    ...
    if(ble_io_cap < 5 ) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "%s error:Invalid io cap value." "\033[0m" "\n", esp_log_timestamp(), "BT_APPL",__func__); };};
    }
...
void bta_dm_co_ble_set_max_key_size(UINT8 ble_key_size)
{
    ...
    if(ble_key_size >= 7 && ble_key_size <= 16) {
        ...
        {if (appl_trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_APPL", "\033[0;" "31" "m" "E" " (%d) %s: " "%s error:Invalid key size value, key_size =%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL",__func__, ble_key_size); };};
    }
