# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 2
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static tAVRC_STS avrc_bld_next_cmd (tAVRC_NEXT_CMD *p_cmd, BT_HDR *p_pkt)
{
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_next_cmd" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    ...
    {*(p_data)++ = (UINT8)(p_cmd->target_pdu);};
    p_pkt->len = (p_data - p_start);

    return 0x04;
}
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static tAVRC_STS avrc_bld_set_abs_volume_cmd (tAVRC_SET_VOLUME_CMD *p_cmd, BT_HDR *p_pkt)
{
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_set_abs_volume_cmd" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};

    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_start + 2;

    {*(p_data)++ = (UINT8)((1) >> 8); *(p_data)++ = (UINT8)(1);};
    {*(p_data)++ = (UINT8)((0x7F & p_cmd->volume));};
    p_pkt->len = (p_data - p_start);
    return 0x04;
}
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static tAVRC_STS avrc_bld_register_change_notfn(UINT8 event_id, UINT32 event_parameter, BT_HDR *p_pkt)
{
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_vol_change" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};


    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_start + 2;

    {*(p_data)++ = (UINT8)((5) >> 8); *(p_data)++ = (UINT8)(5);};
    {*(p_data)++ = (UINT8)(event_id);};
    {*(p_data)++ = (UINT8)((event_parameter) >> 24); *(p_data)++ = (UINT8)((event_parameter) >> 16); *(p_data)++ = (UINT8)((event_parameter) >> 8); *(p_data)++ = (UINT8)(event_parameter); };
    p_pkt->len = (p_data - p_start);
    return 0x04;
}
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static BT_HDR *avrc_bld_init_cmd_buffer(tAVRC_COMMAND *p_cmd)
{
    UINT8 opcode = avrc_opcode_from_pdu(p_cmd->pdu);
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_init_cmd_buffer: pdu=%x, opcode=%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_cmd->pdu, opcode); };};
    ...
    BT_HDR *p_pkt = (BT_HDR *)malloc((660));
    if (p_pkt) {
        UINT8 *p_data, *p_start;

        p_pkt->layer_specific = 0x0001;
        p_pkt->event = opcode;
        p_pkt->offset = offset;
...
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static tAVRC_STS avrc_bld_set_player_value_cmd(tAVRC_SET_APP_VALUE_CMD *p_cmd, BT_HDR *p_pkt)
{
    ...
    {*(p_data)++ = (UINT8)((3) >> 8); *(p_data)++ = (UINT8)(3);};

    {*(p_data)++ = (UINT8)(1);};
    {*(p_data)++ = (UINT8)(p_cmd->p_vals->attr_id);};
    {*(p_data)++ = (UINT8)(p_cmd->p_vals->attr_val);};

    p_pkt->len = (p_data - p_start);
    return 0x04;
}
# 215 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
static tAVRC_STS avrc_bld_get_element_attr_cmd (tAVRC_GET_ELEM_ATTRS_CMD *p_cmd, BT_HDR *p_pkt)
{
    int i;
    UINT8 *p_data, *p_start;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_element_attr_cmd num_attr: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_cmd->num_attr); };};

    p_start = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
    p_data = p_start + 2;

    {*(p_data)++ = (UINT8)((8 + 1 + p_cmd->num_attr * sizeof(UINT32)) >> 8); *(p_data)++ = (UINT8)(8 + 1 + p_cmd->num_attr * sizeof(UINT32));};

    {*(p_data)++ = (UINT8)(((UINT64)(0)) >> 56); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 48); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 40); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 32); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 24); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 16); *(p_data)++ = (UINT8)(((UINT64)(0)) >> 8); *(p_data)++ = (UINT8)((UINT64)(0)); };

    {*(p_data)++ = (UINT8)(p_cmd->num_attr);};

    for (i = 0; i < p_cmd->num_attr; i++) {
        {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "avrc_bld_get_element_attr_cmd attr_id: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_cmd->attrs[i]); };};
        {*(p_data)++ = (UINT8)((p_cmd->attrs[i]) >> 24); *(p_data)++ = (UINT8)((p_cmd->attrs[i]) >> 16); *(p_data)++ = (UINT8)((p_cmd->attrs[i]) >> 8); *(p_data)++ = (UINT8)(p_cmd->attrs[i]); };
    }

    p_pkt->len = (p_data - p_start);
    return 0x04;
}
# 251 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
tAVRC_STS AVRC_BldCommand( tAVRC_COMMAND *p_cmd, BT_HDR **pp_pkt)
{
    tAVRC_STS status = 0x01;
    BT_HDR *p_pkt;
    BOOLEAN alloc = 
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 3 4
                   0
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
                        ;

    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldCommand: pdu=%x status=%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_cmd->cmd.pdu, p_cmd->cmd.status); };};
    if (!p_cmd || !pp_pkt) {
        {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldCommand. Invalid parameters passed. p_cmd=%p, pp_pkt=%p" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_cmd, pp_pkt); };}
                                     ;
        return 0x01;
    }

    if (*pp_pkt == 
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 3 4
                  ((void *)0)
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
                      ) {
        if ((*pp_pkt = avrc_bld_init_cmd_buffer(p_cmd)) == 
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 3 4
                                                          ((void *)0)
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
                                                              ) {
            {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldCommand: Failed to initialize command buffer" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            return 0x03;
        }
        alloc = 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 3 4
               1
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
                   ;
    }
    status = 0x04;
    p_pkt = *pp_pkt;
    ...
    if (alloc && (status != 0x04) ) {
        free((p_pkt));
        *pp_pkt = 
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c" 3 4
                 ((void *)0)
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_bld_ct.c"
                     ;
    }
    {if (avrc_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_AVRC", "\033[0;" "32" "m" "I" " (%d) %s: " "AVRC_BldCommand: returning %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", status); };};
    return status;
}
