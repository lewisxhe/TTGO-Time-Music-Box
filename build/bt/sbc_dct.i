# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/include/sbc_dct.h" 1
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c" 2
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
void SBC_FastIDCT8(SINT32 *pInVect, SINT32 *pOutVect)
{
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
    register SINT32 x0, x1, x2, x3, x4, x5, x6, x7, temp;
    SINT32 res_even[4], res_odd[4];

    x0=(SINT32)(((SINT64)(0x00005a82)*(SINT64)pInVect[4])>>15);;
    ...
    temp = x0 ;
    x0=(SINT32)(((SINT64)(0x00005a82)*(SINT64)( x0 + x4 ))>>15);;
    x4=(SINT32)(((SINT64)(0x00005a82)*(SINT64)( temp - x4 ))>>15);;
    ...
    x6=(SINT32)(((SINT64)(0x00005a82)*(SINT64)x6)>>15);;
    temp = x2 ;
    x2=(SINT32)(((SINT64)(0x00007641)*(SINT64)( x2 + x6 ))>>15);;
    x6=(SINT32)(((SINT64)(0x000030fb)*(SINT64)( temp - x6 ))>>15);;
    ...
    x5=(SINT32)(((SINT64)(0x00005a82)*(SINT64)x5)>>15);;
    temp = x1 ;
    x1 = x1 + x5 ;
    x5 = temp - x5 ;
    ...
    x3 -= x7;
    x7 <<= 1 ;
    x7=(SINT32)(((SINT64)(0x00005a82)*(SINT64)x7)>>15);;


    temp = x3 ;
    x3=(SINT32)(((SINT64)(0x00007641)*(SINT64)( x3 + x7 ))>>15);;
    x7=(SINT32)(((SINT64)(0x000030fb)*(SINT64)( temp - x7 ))>>15);;


    res_odd[0]=(SINT32)(((SINT64)((0x00007d8a))*(SINT64)( x1 + x3 ))>>15);;
    res_odd[1]=(SINT32)(((SINT64)((0x00006a6d))*(SINT64)( x5 + x7 ))>>15);;
    res_odd[2]=(SINT32)(((SINT64)((0x0000471c))*(SINT64)( x5 - x7 ))>>15);;
    res_odd[3]=(SINT32)(((SINT64)((0x000018f8))*(SINT64)( x1 - x3 ))>>15);;
...
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
}
# 190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
void SBC_FastIDCT4(SINT32 *pInVect, SINT32 *pOutVect)
{
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
    SINT32 temp, x2;
    SINT32 tmp[8];

    x2 = pInVect[2] >> 1;
    temp = (pInVect[0] + pInVect[4]);
    tmp[0]=(SINT32)(((SINT64)((0x00005a82) >> 1)*(SINT64)temp)>>15);;
    tmp[1] = x2 - tmp[0];
    tmp[0] += x2;
    temp = (pInVect[1] + pInVect[3]);
    tmp[3]=(SINT32)(((SINT64)((0x000030fb) >> 1)*(SINT64)temp)>>15);;
    tmp[2]=(SINT32)(((SINT64)((0x00007641) >> 1)*(SINT64)temp)>>15);;
    temp = (pInVect[5] - pInVect[7]);
    tmp[5]=(SINT32)(((SINT64)((0x000030fb) >> 1)*(SINT64)temp)>>15);;
    tmp[4]=(SINT32)(((SINT64)((0x00007641) >> 1)*(SINT64)temp)>>15);;
    tmp[6] = tmp[2] + tmp[5];
    tmp[7] = tmp[3] - tmp[4];
...
# 242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/external/sbc/encoder/srce/sbc_dct.c"
}
