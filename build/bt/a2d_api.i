# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/include/stack/sdpdefs.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 2
...
tA2D_CB a2d_cb;
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
static void a2d_sdp_cback(UINT16 status)
{
    tSDP_DISC_REC *p_rec = 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                    ;
    tSDP_DISC_ATTR *p_attr;
    BOOLEAN found = 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                               0
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                    ;
    tA2D_Service a2d_svc;
    tSDP_PROTOCOL_ELEM elem;

    {if (a2d_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_A2D", "\033[0;" "32" "m" "I" " (%d) %s: " "a2d_sdp_cback status: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_A2D", status); };};
    ...
    if (status == 0x0000) {
        ...
        do {
            ...
            if ((p_rec = SDP_FindServiceInDb(a2d_cb.find.p_db,
                                             a2d_cb.find.service_uuid, p_rec)) == 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                                                                 ((void *)0)
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                                                                     ) {
                break;
            }
            ...
            if ((p_attr = SDP_FindAttributeInRec(p_rec,
                                                 0x0100 + 0x0000)) != 
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                                                          ((void *)0)
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                                                              ) {
                a2d_svc.p_service_name = (char *) p_attr->attr_value.v.array;
                a2d_svc.service_len = (p_attr->attr_len_type & 0x0FFF);
            }


            if ((p_attr = SDP_FindAttributeInRec(p_rec,
                                                 0x0100 + 0x0002)) != 
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                                                           ((void *)0)
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                                                               ) {
                a2d_svc.p_provider_name = (char *) p_attr->attr_value.v.array;
                a2d_svc.provider_len = (p_attr->attr_len_type & 0x0FFF);
            }


            if ((p_attr = SDP_FindAttributeInRec(p_rec,
                                                 0x0311)) != 
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                                                                ((void *)0)
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                                                                    ) {
                a2d_svc.features = p_attr->attr_value.v.u16;
            }


            if (SDP_FindProtocolListElemInRec(p_rec, 0x0019, &elem)) {
                a2d_svc.avdt_version = elem.params[0];
                {if (a2d_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_A2D", "D" " (%d) %s: " "avdt_version: 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_A2D", a2d_svc.avdt_version); };};
            }


            found = 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                   1
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                       ;
            break;

        } while (
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                1
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                    );
    }

    a2d_cb.find.service_uuid = 0;

    if (a2d_cb.find.p_cback != 
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                              ((void *)0)
# 114 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                                  ) {
...
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
void a2d_set_avdt_sdp_ver (UINT16 avdt_sdp_ver)
{
    a2d_cb.avdt_sdp_ver = avdt_sdp_ver;
}
# 166 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
tA2D_STATUS A2D_AddRecord(UINT16 service_uuid, char *p_service_name, char *p_provider_name,
                          UINT16 features, UINT32 sdp_handle)
{
    UINT16 browse_list[1];
    BOOLEAN result = 
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                        1
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                            ;
    UINT8 temp[8];
    UINT8 *p;
    tSDP_PROTOCOL_ELEM proto_list [2];

    {if (a2d_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_A2D", "\033[0;" "32" "m" "I" " (%d) %s: " "A2D_AddRecord uuid: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_A2D", service_uuid); };};

    if ( (sdp_handle == 0) ||
            (service_uuid != 0X110A && service_uuid != 0X110B) ) {
        return 0x0C;
    }
    ...
    memset((void *) proto_list, 0 , 2 * sizeof(tSDP_PROTOCOL_ELEM));


    proto_list[0].protocol_uuid = 0x0100;
    proto_list[0].num_params = 1;
    proto_list[0].params[0] = 0x0019;
    proto_list[1].protocol_uuid = 0x0019;
    proto_list[1].num_params = 1;
    proto_list[1].params[0] = a2d_cb.avdt_sdp_ver;

    result &= SDP_AddProtocolList(sdp_handle, 2, proto_list);


    result &= SDP_AddProfileDescriptorList(sdp_handle, 0X110D, 0x0102);


    if (features != 0) {
        p = temp;
        {*(p)++ = (UINT8)((features) >> 8); *(p)++ = (UINT8)(features);};
        result &= SDP_AddAttribute(sdp_handle, 0x0311, 1,
                                   (UINT32)2, (UINT8 *)temp);
    }


    if (p_provider_name != 
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                          ((void *)0)
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                              ) {
        result &= SDP_AddAttribute(sdp_handle, 0x0100 + 0x0002, 4,
                                   (UINT32)(strlen(p_provider_name) + 1), (UINT8 *) p_provider_name);
    }


    if (p_service_name != 
# 215 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                         ((void *)0)
# 215 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                             ) {
        result &= SDP_AddAttribute(sdp_handle, 0x0100 + 0x0000, 4,
                                   (UINT32)(strlen(p_service_name) + 1), (UINT8 *) p_service_name);
    }


    browse_list[0] = 0X1002;
    result &= SDP_AddUuidSequence(sdp_handle, 0x0005, 1, browse_list);


    return (result ? 0 : 0x0A);
}
# 263 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
tA2D_STATUS A2D_FindService(UINT16 service_uuid, BD_ADDR bd_addr,
                            tA2D_SDP_DB_PARAMS *p_db, tA2D_FIND_CBACK *p_cback)
{
    tBT_UUID uuid_list;
    BOOLEAN result = 
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                        1
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                            ;
    UINT16 a2d_attr_list[] = {0x0001,
                                   0x0009,
                                   0x0311,
                                   0x0100 + 0x0000,
                                   0x0004,
    ...
    {if (a2d_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_A2D", "\033[0;" "32" "m" "I" " (%d) %s: " "A2D_FindService uuid: %x" "\033[0m" "\n", esp_log_timestamp(), "BT_A2D", service_uuid); };};
    if ( (service_uuid != 0X110A && service_uuid != 0X110B) ||
            p_db == 
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                   ((void *)0) 
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                        || p_db->p_db == 
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                                         ((void *)0) 
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
...
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
    ...
    if ( a2d_cb.find.service_uuid == 0X110A ||
            a2d_cb.find.service_uuid == 0X110B) {
        return 0x0B;
    }
    ...
    if (p_db->p_attrs == 
# 291 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                        ((void *)0) 
# 291 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                             || p_db->num_attr == 0) {
    ...
    if (result == 
# 299 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
                 1
# 299 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                     ) {
        ...
        if (
# 307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c" 3 4
           0 
# 307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
                 == result) {
            a2d_cb.find.service_uuid = 0;
        }
    }
...
# 336 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
...
# 353 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
...
# 378 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
void A2D_Init(void)
{
    ...
    a2d_cb.avdt_sdp_ver = 0x0102;


    a2d_cb.trace_level = 2;



}
# 404 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/a2dp/a2d_api.c"
