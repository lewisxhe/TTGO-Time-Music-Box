# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 2
...
static BOOLEAN temp_enhanced = 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                              0
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                   ;
...
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
...
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                    ;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_SecAddBleDevice dev_type=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", dev_type); };};
    p_dev_rec = btm_find_dev (bd_addr);

    if (!p_dev_rec) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Add a new device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};



        for (i = 0; i < 15; i++) {
            if (!(btm_cb.sec_dev_rec[i].sec_flags & 0x80)) {
                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "allocate a new dev rec idx=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", i); };};
                p_dev_rec = &btm_cb.sec_dev_rec[i];


                memset (p_dev_rec, 0, sizeof (tBTM_SEC_DEV_REC));
                p_dev_rec->sec_flags = 0x80;
                memcpy (p_dev_rec->bd_addr, bd_addr, 6);
                p_dev_rec->hci_handle = BTM_GetHCIConnHandle (bd_addr, 1);
                p_dev_rec->ble_hci_handle = BTM_GetHCIConnHandle (bd_addr, 2);


                p_dev_rec->conn_params.min_conn_int =
                    p_dev_rec->conn_params.max_conn_int =
                        p_dev_rec->conn_params.supervision_tout =
                            p_dev_rec->conn_params.slave_latency = 0xffff;

                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "hci_handl=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_dev_rec->ble_hci_handle); };};
                break;
            }
        }
        ...
        if (!p_dev_rec) {
            return (
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                   0
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        );
        }
    } else {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Device already exist" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
    ...
    if (bd_name && bd_name[0]) {
        ...
        strncpy(((char *)p_dev_rec->sec_bd_name),((char *)bd_name),(64))
                                                                ;
    }
    p_dev_rec->device_type |= dev_type;
    p_dev_rec->ble.ble_addr_type = addr_type;

    memcpy (p_dev_rec->ble.pseudo_addr, bd_addr, 6);
    ...
    if (p_info) {
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "InqDb  device_type =0x%x  addr_type=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_info->results.device_type, p_info->results.ble_addr_type); };}
                                                                                    ;
    }
    return (
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
           1
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
               );
}
# 159 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_SecAddBleKey (BD_ADDR bd_addr, tBTM_LE_KEY_VALUE *p_le_key, tBTM_LE_KEY_TYPE key_type)
{
    tBTM_SEC_DEV_REC *p_dev_rec;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_SecAddBleKey" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    p_dev_rec = btm_find_dev (bd_addr);
    if (!p_dev_rec || !p_le_key ||
            (key_type != (1 << 0) && key_type != (1 << 1) &&
             key_type != (1 << 2) && key_type != ((1 << 0) << 4) &&
             key_type != ((1 << 2) << 4) && key_type != ((1 << 1) << 4))) {
        {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "BTM_SecAddBleKey()  Wrong Type, or No Device record                         for bdaddr: %08x%04x, Type: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], key_type); };}


                                                                    ;
        return (
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
               0
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    );
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_SecAddLeKey()  BDA: %08x%04x, Type: 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], key_type); };}

                                                              ;

    btm_sec_save_le_key (bd_addr, key_type, p_le_key, 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                     0
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                          );


    if (key_type == (1 << 1) || key_type == ((1 << 1) << 4)) {
    ...
    return (
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
           1
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
               );
}
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleLoadLocalKeys(UINT8 key_type, tBTM_BLE_LOCAL_KEYS *p_key)
{
    tBTM_DEVCB *p_devcb = &btm_cb.devcb;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
    if (p_key != 
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        switch (key_type) {
        case 1:
        ...
        default:
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "unknow local key type: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type); };};
            break;
        }
    }
}
# 238 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_GetDeviceEncRoot (BT_OCTET16 ble_encr_key_value)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
    memcpy (ble_encr_key_value, btm_cb.devcb.ble_encryption_key_value, 16);
}
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_GetDeviceIDRoot (BT_OCTET16 irk)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_GetDeviceIDRoot " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    memcpy (irk, btm_cb.devcb.id_keys.irk, 16);
}
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_GetDeviceDHK (BT_OCTET16 dhk)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_GetDeviceDHK" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    memcpy (dhk, btm_cb.devcb.id_keys.dhk, 16);
}
# 288 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_ReadConnectionAddr (BD_ADDR remote_bda, BD_ADDR local_conn_addr, tBLE_ADDR_TYPE *p_addr_type)
{
    tACL_CONN *p_acl = btm_bda_to_acl(remote_bda, 2);

    if (p_acl == 
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "No connection exist!" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
    memcpy(local_conn_addr, p_acl->conn_addr, 6);
    * p_addr_type = p_acl->conn_addr_type;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_ReadConnectionAddr address type: %d addr: 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_acl->conn_addr_type, p_acl->conn_addr[0]); };}
                                                                ;
}
# 313 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_IsBleConnection (UINT16 conn_handle)
{
    ...
    {if (btm_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTM", "\033[0;" "32" "m" "I" " (%d) %s: " "BTM_IsBleConnection: conn_handle: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", conn_handle); };};

    xx = btm_handle_to_acl_index (conn_handle);
    if (xx >= 4) {
        return 
# 323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }

    p = &btm_cb.acl_db[xx];

    return (p->transport == 2);



}
# 347 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_ReadRemoteConnectionAddr(BD_ADDR pseudo_addr, BD_ADDR conn_addr,
                                     tBLE_ADDR_TYPE *p_addr_type)
{
    BOOLEAN st = 
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                        1
# 350 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                            ;

    tACL_CONN *p = btm_bda_to_acl (pseudo_addr, 2);

    if (p == 
# 354 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
            ((void *)0)
# 354 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_ReadRemoteConnectionAddr can not find connection" " with matching address" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };}
                                                 ;
        return 
# 357 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 357 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }

    memcpy(conn_addr, p->active_remote_addr, 6);
    *p_addr_type = p->active_remote_addr_type;
# 370 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
    return st;

}
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_SecurityGrant(BD_ADDR bd_addr, UINT8 res)
{

    tSMP_STATUS res_smp = (res == BTM_SUCCESS) ? 0 : 0x09;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_SecurityGrant" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    SMP_SecurityGrant(bd_addr, res_smp);

}
# 409 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BlePasskeyReply (BD_ADDR bd_addr, UINT8 res, UINT32 passkey)
{

    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev (bd_addr);
    tSMP_STATUS res_smp = (res == BTM_SUCCESS) ? 0 : 0x01;

    if (p_dev_rec == 
# 415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 415 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Passkey reply to Unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }

    p_dev_rec->sec_flags |= 0x0200;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BlePasskeyReply" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    SMP_PasskeyReply(bd_addr, res_smp, passkey);

}
# 439 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleConfirmReply (BD_ADDR bd_addr, UINT8 res)
{
    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev (bd_addr);
    tSMP_STATUS res_smp = (res == BTM_SUCCESS) ? 0 : 0x01;
    ...
    if (p_dev_rec == 
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Passkey reply to Unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
...
# 467 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleOobDataReply(BD_ADDR bd_addr, UINT8 res, UINT8 len, UINT8 *p_data)
{

    tSMP_STATUS res_smp = (res == BTM_SUCCESS) ? 0 : 0x02;
    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev (bd_addr);

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleOobDataReply" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p_dev_rec == 
# 475 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 475 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_BleOobDataReply() to Unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
...
# 497 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleSetConnScanParams (UINT32 scan_interval, UINT32 scan_window)
{

    tBTM_BLE_CB *p_ble_cb = &btm_cb.ble_ctr_cb;
    BOOLEAN new_param = 
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                           0
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                ;

    if ((((scan_interval) >= (0x0004) && (scan_interval) <= (0x4000)) || ((scan_interval) == 0xffff)) &&
            (((scan_window) >= (0x0004) && (scan_window) <= (0x4000)) || ((scan_window) == 0xffff))) {
        if (p_ble_cb->scan_int != scan_interval) {
            p_ble_cb->scan_int = scan_interval;
            new_param = 
# 507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                       1
# 507 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                           ;
        }
        ...
        if (p_ble_cb->scan_win != scan_window) {
            ...
            new_param = 
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                       1
# 512 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                           ;
        }

        if (new_param && p_ble_cb->conn_state == 2) {
            btm_ble_suspend_bg_conn();
        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal Connection Scan Parameters" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }

}
# 541 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleSetPrefConnParams (BD_ADDR bd_addr,
                               UINT16 min_conn_int, UINT16 max_conn_int,
                               UINT16 slave_latency, UINT16 supervision_tout)
{
    ...
    {if (btm_cb.trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTM", "\033[0;" "32" "m" "I" " (%d) %s: " "BTM_BleSetPrefConnParams min: %u  max: %u  latency: %u                      tout: %u" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", min_conn_int, max_conn_int, slave_latency, supervision_tout); };}

                                                                               ;

    if ((((min_conn_int) >= (0x0006) && (min_conn_int) <= (0x0C80)) || ((min_conn_int) == 0xffff)) &&
            (((max_conn_int) >= (0x0006) && (max_conn_int) <= (0x0C80)) || ((max_conn_int) == 0xffff)) &&
            (((supervision_tout) >= (0x000A) && (supervision_tout) <= (0x0C80)) || ((supervision_tout) == 0xffff)) &&
            (slave_latency <= 500 || slave_latency == 0xffff)) {
        if (p_dev_rec) {

            if (min_conn_int != 0xffff || max_conn_int != 0xffff) {
                if (min_conn_int != 0xffff) {
                    p_dev_rec->conn_params.min_conn_int = min_conn_int;
                } else {
                    p_dev_rec->conn_params.min_conn_int = max_conn_int;
                }

                if (max_conn_int != 0xffff) {
                ...
                if (slave_latency != 0xffff) {
                    ...
                    p_dev_rec->conn_params.slave_latency = 0;
                }

                if (supervision_tout != 0xffff) {
                    p_dev_rec->conn_params.supervision_tout = supervision_tout;
                } else {
                    p_dev_rec->conn_params.supervision_tout = 600;
                }

            }

        } else {
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown Device, setting rejected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal Connection Parameters" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
}
# 604 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
    ...
    *p_addr_type = 0x00;
    ...
    if (!p_dev_rec) {
        *p_dev_type = 0x01;
        ...
        if (p_inq_info != 
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                         ((void *)0)
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                             ) {
            *p_dev_type = p_inq_info->results.device_type ;
            *p_addr_type = p_inq_info->results.ble_addr_type;
        } else {
            if(temp_addr_type <= 0x03) {
                *p_addr_type = temp_addr_type;
            } else {

                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_find_dev_type - unknown device, BR/EDR assumed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            }
        }
    } else {
        ...
        if (memcmp(p_dev_rec->bd_addr, remote_bda, 6) == 0 &&
                memcmp(p_dev_rec->ble.pseudo_addr, remote_bda, 6) == 0) {
            *p_dev_type = p_dev_rec->device_type;
            *p_addr_type = p_dev_rec->ble.ble_addr_type;
        } else if (memcmp(p_dev_rec->ble.pseudo_addr, remote_bda, 6) == 0) {
            *p_dev_type = 0x02;
            *p_addr_type = p_dev_rec->ble.ble_addr_type;
        } else {
            *p_dev_type = 0x01;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_find_dev_type - device_type = %d addr_type = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", *p_dev_type , *p_addr_type); };};
}
# 663 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_ReadConnectedTransportAddress(BD_ADDR remote_bda, tBT_TRANSPORT transport)
{
    ...
    if (p_dev_rec == 
# 668 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 668 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        memset(remote_bda, 0, 6);
        return 
# 670 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 670 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }

    if (transport == 1) {
        if (btm_bda_to_acl(p_dev_rec->bd_addr, transport) != 
# 674 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                            ((void *)0)
# 674 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                ) {
            memcpy(remote_bda, p_dev_rec->bd_addr, 6);
            return 
# 676 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                  1
# 676 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                      ;
        } else if (p_dev_rec->device_type & 0x01) {
            memcpy(remote_bda, p_dev_rec->bd_addr, 6);
        } else {
            memset(remote_bda, 0, 6);
        }
        return 
# 682 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 682 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }

    if (transport == 2) {
        memcpy(remote_bda, p_dev_rec->ble.pseudo_addr, 6);
        if (btm_bda_to_acl(p_dev_rec->ble.pseudo_addr, transport) != 
# 687 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                    ((void *)0)
# 687 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                        ) {
            return 
# 688 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                  1
# 688 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                      ;
        } else {
            return 
# 690 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                  0
# 690 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                       ;
        }
    }

    return 
# 694 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
          0
# 694 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
               ;
}
# 707 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleReceiverTest(UINT8 rx_freq, tBTM_CMPL_CB *p_cmd_cmpl_cback)
{
    btm_cb.devcb.p_le_test_cmd_cmpl_cb = p_cmd_cmpl_cback;

    if (btsnd_hcic_ble_receiver_test(rx_freq) == 
# 711 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                0
# 711 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                     ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unable to Trigger LE receiver test" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
    }
}
# 728 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleTransmitterTest(UINT8 tx_freq, UINT8 test_data_len,
                            UINT8 packet_payload, tBTM_CMPL_CB *p_cmd_cmpl_cback)
{
    btm_cb.devcb.p_le_test_cmd_cmpl_cb = p_cmd_cmpl_cback;
    if (btsnd_hcic_ble_transmitter_test(tx_freq, test_data_len, packet_payload) == 
# 732 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                                  0
# 732 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                                       ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unable to Trigger LE transmitter test" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
    }
}
# 746 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void BTM_BleTestEnd(tBTM_CMPL_CB *p_cmd_cmpl_cback)
{
    btm_cb.devcb.p_le_test_cmd_cmpl_cb = p_cmd_cmpl_cback;

    if (btsnd_hcic_ble_test_end() == 
# 750 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                    0
# 750 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                         ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unable to End the LE TX/RX test" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
    }
}
...
void btm_ble_test_command_complete(UINT8 *p)
{
    ...
    btm_cb.devcb.p_le_test_cmd_cmpl_cb = 
# 762 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                        ((void *)0)
# 762 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                            ;
...
# 778 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_UseLeLink (BD_ADDR bd_addr)
{
    tACL_CONN *p;
    ...
    tBLE_ADDR_TYPE addr_type;
    BOOLEAN use_le = 
# 783 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                0
# 783 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                     ;

    if ((p = btm_bda_to_acl(bd_addr, 1)) != 
# 785 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                             ((void *)0)
# 785 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                 ) {
        return use_le;
    } else if ((p = btm_bda_to_acl(bd_addr, 2)) != 
# 787 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                ((void *)0)
# 787 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                    ) {
        use_le = 
# 788 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                1
# 788 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ;
    } else {
        BTM_ReadDevInfo(bd_addr, &dev_type, &addr_type);
        use_le = (dev_type == 0x02);
    }
    return use_le;
}
# 806 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
tBTM_STATUS BTM_SetBleDataLength(BD_ADDR bd_addr, UINT16 tx_pdu_length)
{
    tACL_CONN *p_acl = btm_bda_to_acl(bd_addr, 2);
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s: tx_pdu_length =%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__, tx_pdu_length); };};

    if (!controller_get_interface()->supports_ble_packet_extension()) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s failed, request not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
        return BTM_CONTROL_LE_DATA_LEN_UNSUPPORTED;
    }

    if (!((p_acl->peer_le_features)[0] & 0x20)) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s failed, peer does not support request" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
        return BTM_PEER_LE_DATA_LEN_UNSUPPORTED;
    }

    if (p_acl != 
# 821 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 821 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        if (tx_pdu_length > 0x00fb) {
            tx_pdu_length = 0x00fb;
        } else if (tx_pdu_length < 0x001b) {
            tx_pdu_length = 0x001b;
        }
        ...
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Wrong mode: no LE link exist or LE not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
        return BTM_WRONG_MODE;
    }
}
# 855 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
tBTM_SEC_ACTION btm_ble_determine_security_act(BOOLEAN is_originator, BD_ADDR bdaddr, UINT16 security_required)
{
    ...
    if (is_originator)
    {
        if ((security_required & (0x0010 | 0x0020 | 0x0008)) == 0 &&
                (security_required & 0x2000) == 0)
        {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s No security required for outgoing connection" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            return 1;
        }

        if (security_required & 0x2000)
            auth_req |= (1 << 2);
    }
    else
    {
        if ((security_required & (0x0002 | 0x0004 | 0x0001)) == 0&& (security_required & 0x1000) == 0)
        {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s No security required for incoming connection" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            return 1;
        }

        if (security_required & 0x1000)
            auth_req |= (1 << 2);
    }

    tBTM_BLE_SEC_REQ_ACT ble_sec_act = 0;
    btm_ble_link_sec_check(bdaddr, auth_req, &ble_sec_act);

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s ble_sec_act %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__ , ble_sec_act); };};
    ...
    UINT8 sec_flag = 0;
    BTM_GetSecurityFlagsByTransport(bdaddr, &sec_flag, 2);

    BOOLEAN is_link_encrypted = 
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                               0
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                    ;
    BOOLEAN is_key_mitm = 
# 898 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                         0
# 898 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                              ;
    if (sec_flag & (0x04| 0x10))
    {
        if (sec_flag & 0x04)
            is_link_encrypted = 
# 902 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                               1
# 902 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                   ;

        if (sec_flag & 0x20)
            is_key_mitm = 
# 905 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                         1
# 905 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                             ;
    }
...
# 945 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                            ...
                            tBTM_SEC_CALLBACK *p_callback, void *p_ref_data)
{
    ...
    if (!p_serv_rec)
    {
        {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "%s PSM: %d no application registerd" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, psm); };};
        (*p_callback) (bd_addr, 2, p_ref_data, BTM_MODE_UNSUPPORTED);
        return 
# 956 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 956 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }
    ...
    tBTM_BLE_SEC_ACT ble_sec_act = 0;
    BOOLEAN status = 
# 963 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    0
# 963 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                         ;

    switch (sec_act)
    {
        case 1:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s Security met" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            p_callback(bd_addr, 2, p_ref_data, BTM_SUCCESS);
            status = 
# 970 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    1
# 970 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ;
            break;

        case 2:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s Encryption needs to be done" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            ble_sec_act = 1;
            break;

        case 4:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s Pairing with MITM needs to be done" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            ble_sec_act = 3;
            break;

        case 3:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s Pairing with No MITM needs to be done" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            ble_sec_act = 2;
            break;

        case 5:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s Ecryption pending" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            break;
    }
    ...
    tL2C_LCB *p_lcb = l2cu_find_lcb_by_bd_addr(bd_addr, 2);
    p_lcb->sec_act = sec_act;
    BTM_SetEncryption(bd_addr, 2, p_callback, p_ref_data);

    return 
# 1000 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
          0
# 1000 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
               ;
}
# 1015 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_rand_enc_complete (UINT8 *p, UINT16 op_code, tBTM_RAND_ENC_CB *p_enc_cplt_cback)
{
    tBTM_RAND_ENC params;
    UINT8 *p_dest = params.param_buf;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_rand_enc_complete" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    ...
    if (p_enc_cplt_cback && p) {
        ...
        {params.status = (UINT8)(*(p)); (p) += 1;};

        if (params.status == 0x00) {
            params.opcode = op_code;

            if (op_code == (0x0018 | (0x08 << 10))) {
                params.param_len = 8;
            } else {
                params.param_len = 16;
            }
...
# 1057 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_increment_sign_ctr(BD_ADDR bd_addr, BOOLEAN is_local )
{
    tBTM_SEC_DEV_REC *p_dev_rec;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_increment_sign_ctr is_local=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", is_local); };};

    if ((p_dev_rec = btm_find_dev (bd_addr)) != 
# 1063 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                               ((void *)0)
# 1063 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                   ) {
        if (is_local) {
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "is_local=%d local sign counter=%d peer sign counter=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", is_local, p_dev_rec->ble.keys.local_counter, p_dev_rec->ble.keys.counter); };}


                                                     ;
    }
}
# 1088 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN btm_ble_get_enc_key_type(BD_ADDR bd_addr, UINT8 *p_key_types)
{
    tBTM_SEC_DEV_REC *p_dev_rec;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_get_enc_key_type" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if ((p_dev_rec = btm_find_dev (bd_addr)) != 
# 1094 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                               ((void *)0)
# 1094 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                   ) {
        *p_key_types = p_dev_rec->ble.key_type;
        return 
# 1096 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              1
# 1096 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                  ;
    }

    return 
# 1099 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
          0
# 1099 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
               ;
}
# 1110 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN btm_get_local_div (BD_ADDR bd_addr, UINT16 *p_div)
{
    tBTM_SEC_DEV_REC *p_dev_rec;
    BOOLEAN status = 
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                               0
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                    ;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_get_local_div" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "bd_addr:%02x-%02x-%02x-%02x-%02x-%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", bd_addr[0], bd_addr[1], bd_addr[2], bd_addr[3], bd_addr[4], bd_addr[5]); };}
    ...
    *p_div = 0;
    ...
    if (p_dev_rec && p_dev_rec->ble.keys.div) {
        status = 
# 1125 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                1
# 1125 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ;
        *p_div = p_dev_rec->ble.keys.div;
    }
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_get_local_div status=%d (1-OK) DIV=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, *p_div); };};
    return status;
}
# 1146 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                         ...
                         BOOLEAN pass_to_application)
{
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_sec_save_le_key key_type=0x%x pass_to_application=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type, pass_to_application); };};
    ...
    if ((p_rec = btm_find_dev (bd_addr)) != 
# 1161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                           ((void *)0) 
# 1161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                && (p_keys || key_type == ((1 << 1) << 4))) {
        btm_ble_init_pseudo_addr (p_rec, bd_addr);

        switch (key_type) {
        case (1 << 0):
            memcpy(p_rec->ble.keys.pltk, p_keys->penc_key.ltk, 16);
            memcpy(p_rec->ble.keys.rand, p_keys->penc_key.rand, 8);
            ...
            p_rec->ble.key_type |= (1 << 0);
            p_rec->sec_flags |= 0x1000;
            if (p_keys->penc_key.sec_level == (1 << 2)) {
                p_rec->sec_flags |= 0x2000;
            } else {
                p_rec->sec_flags &= ~0x2000;
            }
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_LE_KEY_PENC key_type=0x%x sec_flags=0x%x sec_leve=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.key_type, p_rec->sec_flags, p_rec->ble.keys.sec_level); };}
        ...
        case (1 << 1):
            ...
            memcpy(p_rec->ble.static_addr, p_keys->pid_key.static_addr, 6);
            p_rec->ble.static_addr_type = p_keys->pid_key.addr_type;
            p_rec->ble.key_type |= (1 << 1);
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_LE_KEY_PID key_type=0x%x save peer IRK" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.key_type); };};

            memcpy(p_rec->bd_addr, p_keys->pid_key.static_addr, 6);

            btm_consolidate_dev(p_rec);
            break;

        case (1 << 2):
            memcpy(p_rec->ble.keys.pcsrk, p_keys->pcsrk_key.csrk, 16);
            p_rec->ble.keys.srk_sec_level = p_keys->pcsrk_key.sec_level;
            p_rec->ble.keys.counter = p_keys->pcsrk_key.counter;
            p_rec->ble.key_type |= (1 << 2);
            p_rec->sec_flags |= 0x1000;
            if ( p_keys->pcsrk_key.sec_level == (1 << 2)) {
                p_rec->sec_flags |= 0x2000;
            } else {
                p_rec->sec_flags &= ~0x2000;
            }

            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_LE_KEY_PCSRK key_type=0x%x sec_flags=0x%x sec_level=0x%x peer_counter=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.key_type, p_rec->sec_flags, p_rec->ble.keys.srk_sec_level, p_rec->ble.keys.counter); };}
        ...
        case ((1 << 0) << 4):
            memcpy(p_rec->ble.keys.lltk, p_keys->lenc_key.ltk, 16);
            p_rec->ble.keys.div = p_keys->lenc_key.div;
            p_rec->ble.keys.sec_level = p_keys->lenc_key.sec_level;
            p_rec->ble.keys.key_size = p_keys->lenc_key.key_size;
            p_rec->ble.key_type |= ((1 << 0) << 4);


            p_rec->sec_flags |= 0x1000;
            if ( p_keys->lenc_key.sec_level == (1 << 2)) {
                p_rec->sec_flags |= 0x2000;
            } else {
                p_rec->sec_flags &= ~0x2000;
            }

            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_LE_KEY_LENC key_type=0x%x DIV=0x%x key_size=0x%x sec_level=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.key_type, p_rec->ble.keys.div, p_rec->ble.keys.key_size, p_rec->ble.keys.sec_level); };}
        ...
        case ((1 << 2) << 4):
            memcpy (p_rec->ble.keys.lcsrk, p_keys->lcsrk_key.csrk, 16);
            p_rec->ble.keys.div = p_keys->lcsrk_key.div;
            p_rec->ble.keys.local_csrk_sec_level = p_keys->lcsrk_key.sec_level;
            p_rec->ble.keys.local_counter = p_keys->lcsrk_key.counter;
            p_rec->ble.key_type |= ((1 << 2) << 4);
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_LE_KEY_LCSRK key_type=0x%x DIV=0x%x scrk_sec_level=0x%x local_counter=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.key_type, p_rec->ble.keys.div, p_rec->ble.keys.local_csrk_sec_level, p_rec->ble.keys.local_counter); };}
        ...
        case ((1 << 1) << 4):
            p_rec->ble.key_type |= ((1 << 1) << 4);
            break;
        default:
            {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "btm_sec_save_le_key (Bad key_type 0x%02x)" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type); };};
            return;
        }

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BLE key type 0x%02x updated for BDA: %08x%04x (btm_sec_save_le_key)" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5]); };}
        ...
        if (pass_to_application && btm_cb.api.p_le_callback) {
            ...
            (*btm_cb.api.p_le_callback) (12 + 1, bd_addr, &cb_data);
        }
        return;
    }

    {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "BLE key type 0x%02x called for Unknown BDA or type: %08x%04x !! (btm_sec_save_le_key)" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5]); };}

                                                      ;

    if (p_rec) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "sec_flags=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->sec_flags); };};
    }
}
# 1295 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_update_sec_key_size(BD_ADDR bd_addr, UINT8 enc_key_size)
{
    tBTM_SEC_DEV_REC *p_rec;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_update_sec_key_size enc_key_size = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", enc_key_size); };};

    if ((p_rec = btm_find_dev (bd_addr)) != 
# 1301 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                           ((void *)0) 
# 1301 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                ) {
        p_rec->enc_key_size = enc_key_size;
    }
}
# 1316 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
UINT8 btm_ble_read_sec_key_size(BD_ADDR bd_addr)
{
    tBTM_SEC_DEV_REC *p_rec;

    if ((p_rec = btm_find_dev (bd_addr)) != 
# 1320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                           ((void *)0) 
# 1320 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                ) {
...
# 1337 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_link_sec_check(BD_ADDR bd_addr, tBTM_LE_AUTH_REQ auth_req, tBTM_BLE_SEC_REQ_ACT *p_sec_req_act)
{
    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev (bd_addr);
    UINT8 req_sec_level = 0, cur_sec_level = 0;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_link_sec_check auth_req =0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", auth_req); };};

    if (p_dev_rec == 
# 1344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 1344 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_link_sec_check received for unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
    ...
    if (p_dev_rec->sec_state == 2 ||
        ...
        *p_sec_req_act = 3;
        ...
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "dev_rec sec_flags=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_dev_rec->sec_flags); };};


        if (p_dev_rec->sec_flags & 0x0400) {
            if (p_dev_rec->sec_flags & 0x0200) {
                cur_sec_level = (1 << 2);
            } else {
                cur_sec_level = (1 << 0);
            }
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "cur_sec_level=%d req_sec_level=%d sec_req_act=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", cur_sec_level, req_sec_level, *p_sec_req_act); };}
...
# 1408 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
tBTM_STATUS btm_ble_set_encryption (BD_ADDR bd_addr, void *p_ref_data, UINT8 link_role)
{
    ...
    if (p_rec == 
# 1417 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 1417 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "btm_ble_set_encryption (NULL device record!! sec_act=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", sec_act); };};
        return (BTM_WRONG_MODE);
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_set_encryption sec_act=0x%x role_master=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", sec_act, p_rec->role_master); };};

    if (sec_act == 3) {
        p_rec->security_required |= 0x1000;
    }

    switch (sec_act) {
    case 1:
        if (link_role == 0x00 && (p_rec->ble.key_type & (1 << 0))) {

            cmd = btm_ble_start_encrypt(bd_addr, 
# 1432 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                0
# 1432 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                     , 
# 1432 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                       ((void *)0)
# 1432 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
    ...
    case 3:
        if ((link_role == 0x00) && (sec_act != 1)) {
            ...
            if (sec_req_act == 1) {
                cmd = btm_ble_start_encrypt(bd_addr, 
# 1445 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                    0
# 1445 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                         , 
# 1445 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                           ((void *)0)
# 1445 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
        ...
        if(link_role == 0x01 && (p_rec->ble.key_type & (1 << 0))) {
            p_rec->ble.skip_update_conn_param = 
# 1452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                               1
# 1452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                   ;
        } else {
            p_rec->ble.skip_update_conn_param = 
# 1454 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                               0
# 1454 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                    ;
        }
...
# 1482 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_ltk_request(UINT16 handle, UINT8 rand[8], UINT16 ediv)
{
    tBTM_CB *p_cb = &btm_cb;
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_ltk_request" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    p_cb->ediv = ediv;

    memcpy(p_cb->enc_rand, rand, 8);

    if (p_dev_rec != 
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 1494 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        if (!smp_proc_ltk_request(p_dev_rec->bd_addr)) {
            btm_ble_ltk_request_reply(p_dev_rec->bd_addr, 
# 1496 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                         0
# 1496 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                              , dummy_stk);
        }
    }

}
# 1514 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
tBTM_STATUS btm_ble_start_encrypt(BD_ADDR bda, BOOLEAN use_stk, BT_OCTET16 stk)
{
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_start_encrypt" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (!p_rec ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Link is not active, can not encrypt!" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_WRONG_MODE;
    }

    if (p_rec->sec_state == 2) {
        {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "Link Encryption is active, Busy!" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_BUSY;
    }
    ...
    } else if (p_rec->ble.key_type & (1 << 0)) {
        if (btsnd_hcic_ble_start_enc(p_rec->ble_hci_handle, p_rec->ble.keys.rand,
                                     p_rec->ble.keys.ediv, p_rec->ble.keys.pltk)) {
            rt = BTM_CMD_STARTED;
        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "No key available to encrypt the link" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
    if (rt == BTM_CMD_STARTED) {
        if (p_rec->sec_state == 0) {
            p_rec->sec_state = 2;
        }
    }
...
# 1569 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_link_encrypted(BD_ADDR bd_addr, UINT8 encr_enable)
{
    tBTM_SEC_DEV_REC *p_dev_rec = btm_find_dev (bd_addr);
    BOOLEAN enc_cback;
    ...
    if (!p_dev_rec) {
        {if (btm_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTM", "\033[0;" "33" "m" "W" " (%d) %s: " "btm_ble_link_encrypted (No Device Found!) encr_enable=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", encr_enable); };};
        return;
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_link_encrypted encr_enable=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", encr_enable); };};

    enc_cback = (p_dev_rec->sec_state == 2);

    smp_link_encrypted(bd_addr, encr_enable);

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " p_dev_rec->sec_flags=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_dev_rec->sec_flags); };};
...
# 1594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                               1
# 1594 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                   );
        } else if (p_dev_rec->role_master) {
            btm_sec_dev_rec_cback_event(p_dev_rec, BTM_ERR_PROCESSING, 
# 1596 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                      1
# 1596 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                          );
        }
...
# 1617 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_ltk_request_reply(BD_ADDR bda, BOOLEAN use_stk, BT_OCTET16 stk)
{
    tBTM_SEC_DEV_REC *p_rec = btm_find_dev (bda);
    tBTM_CB *p_cb = &btm_cb;
    ...
    if (p_rec == 
# 1622 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 1622 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_ble_ltk_request_reply received for unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_ltk_request_reply" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    p_cb->enc_handle = p_rec->ble_hci_handle;
    p_cb->key_size = p_rec->ble.keys.key_size;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "key size = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_rec->ble.keys.key_size); };};
    if (use_stk) {
        btsnd_hcic_ble_ltk_req_reply(btm_cb.enc_handle, stk);
    } else {
        if (p_rec->ble.key_type & ((1 << 0) << 4)) {
...
# 1652 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
UINT8 btm_ble_io_capabilities_req(tBTM_SEC_DEV_REC *p_dev_rec, tBTM_LE_IO_REQ *p_data)
{
    UINT8 callback_rc = BTM_SUCCESS;
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    if (btm_cb.api.p_le_callback) {

        callback_rc = (*btm_cb.api.p_le_callback) (1, p_dev_rec->bd_addr, (tBTM_LE_EVT_DATA *)p_data);
    }
    ...
    {
# 1677 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
        p_data->auth_req &= (0x01|(1 << 2)|(1 << 3)|(1 << 4));


        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 1: p_dev_rec->security_required = %d auth_req:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_dev_rec->security_required, p_data->auth_req); };}
                                                                        ;
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 2: i_keys=0x%x r_keys=0x%x (bit 0-LTK 1-IRK 2-CSRK)" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->init_keys, p_data->resp_keys); };}

                                           ;


        if (p_dev_rec->security_required & 0x1000) {
            p_data->auth_req |= (1 << 2);
        }

        if (!(p_data->auth_req & 0x01)) {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Non bonding: No keys should be exchanged" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            p_data->init_keys = 0;
            p_data->resp_keys = 0;
        }

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 3: auth_req:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->auth_req); };};
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 4: i_keys=0x%x r_keys=0x%x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->init_keys, p_data->resp_keys); };}

                                           ;

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 5: p_data->io_cap = %d auth_req:%d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->io_cap, p_data->auth_req); };}
                                                          ;


        if ((p_data->io_cap == 3) && p_data->oob_data == SMP_OOB_NONE) {
            p_data->auth_req &= ~(1 << 2);
        }

        if (!(p_data->auth_req & (1 << 3))) {



            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s-SC not supported -> No LK derivation, no keypress notifications" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };}
                                     ;
            p_data->auth_req &= ~(1 << 4);
            p_data->init_keys &= ~(1 << 3);
            p_data->resp_keys &= ~(1 << 3);
        }

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_io_capabilities_req 6: IO_CAP:%d oob_data:%d auth_req:0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->io_cap, p_data->oob_data, p_data->auth_req); };}
                                                                            ;
    }
    return callback_rc;
}
# 1740 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
UINT8 btm_ble_br_keys_req(tBTM_SEC_DEV_REC *p_dev_rec, tBTM_LE_IO_REQ *p_data)
{
    ...
    if (btm_cb.api.p_le_callback) {
        ...
        callback_rc = (*btm_cb.api.p_le_callback) (1, p_dev_rec->bd_addr,
                      (tBTM_LE_EVT_DATA *)p_data);
    }
    return callback_rc;
}
# 1764 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_resolve_random_addr_on_conn_cmpl(void *p_rec, void *p_data)
{
    ...
    BOOLEAN match = 
# 1772 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                       0
# 1772 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                            ;

    ++p;
    {handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
    {role = (UINT8)(*(p)); (p) += 1;};
    {bda_type = (UINT8)(*(p)); (p) += 1;};
    {register int ijk; register UINT8 *pbda = (UINT8 *)bda + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *p++;};


    if(temp_enhanced) {
        {register int ijk; register UINT8 *pbda = (UINT8 *)local_rpa + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *p++;};
        {register int ijk; register UINT8 *pbda = (UINT8 *)peer_rpa + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *p++;};
    }
    {conn_interval = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
    {conn_latency = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
    {conn_timeout = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

    handle = (UINT16)((handle) & 0x0FFF);
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};

    if (match_rec) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s matched and resolved random address" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
        match = 
# 1794 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
               1
# 1794 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
        match_rec->ble.active_addr_type = 1;
        memcpy(match_rec->ble.cur_rand_addr, bda, 6);
        if (!btm_ble_init_pseudo_addr (match_rec, bda)) {

            memcpy(bda, match_rec->ble.pseudo_addr, 6);
        } else {
            memcpy(bda, match_rec->bd_addr, 6);
        }
    } else {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s unable to match and resolve random address" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
    }

    btm_ble_connected(bda, handle, 0x00, role, bda_type, match);
...
# 1826 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ...
                        tBLE_ADDR_TYPE addr_type, BOOLEAN addr_matched)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_connected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
# 1852 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
    if (!p_dev_rec) {

        if ((p_dev_rec = btm_sec_alloc_dev (bda)) == 
# 1854 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                    ((void *)0)
# 1854 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                        ) {
            return;
        }
    } else {
    ...
    p_dev_rec->device_type |= 0x02;
    p_dev_rec->ble_hci_handle = handle;
    p_dev_rec->ble.ble_addr_type = addr_type;

    memcpy(p_dev_rec->ble.pseudo_addr, bda, 6);

    p_dev_rec->role_master = 
# 1868 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                            0
# 1868 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                 ;
    if (role == 0x00) {
        p_dev_rec->role_master = 
# 1870 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                1
# 1870 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                    ;
    }


    if (!addr_matched) {
        p_dev_rec->ble.active_addr_type = 0;
    }

    if (p_dev_rec->ble.ble_addr_type == 0x01 && !addr_matched) {
        memcpy(p_dev_rec->ble.cur_rand_addr, bda, 6);
    }


    p_cb->inq_var.directed_conn = 0x00;
...
void btm_ble_conn_complete(UINT8 *p, UINT16 evt_len, BOOLEAN enhanced)
{
    ...
    UINT16 conn_interval, conn_latency, conn_timeout;
    BOOLEAN match = 
# 1906 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                       0
# 1906 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                            ;
    (void)(evt_len);
    {status = (UINT8)(*(p)); (p) += 1;};
    {handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
    ...
    {bda_type = (UINT8)(*(p)); (p) += 1;};
    {register int ijk; register UINT8 *pbda = (UINT8 *)bda + 6 - 1; for (ijk = 0; ijk < 6; ijk++) *pbda-- = *p++;};
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "status = %d, handle = %d, role = %d, bda_type = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM",status,handle,role,bda_type); };};
    if (status == 0) {

        peer_addr_type = bda_type;
        match = btm_identity_addr_to_random_pseudo (bda, &bda_type, 
# 1917 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                   1
# 1917 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                       );
...
# 1936 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
        if (!match && ((bda[0] & 0xc0) == 0x40)) {

            temp_enhanced = enhanced;
            btm_ble_resolve_random_addr(bda, btm_ble_resolve_random_addr_on_conn_cmpl, p_data);

            temp_enhanced = 
# 1941 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                           0
# 1941 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                ;
        } else

        {
            ...
            if (enhanced) {
                ...
                if (peer_addr_type & 0x02) {
                    btm_ble_refresh_peer_resolvable_private_addr(bda, peer_rpa, 0x01);
                }
            }
        ...
        role = 0xff;
        if (status != 0x3C) {
            btm_ble_set_conn_st(0);

            btm_ble_disable_resolving_list(1, 
# 1969 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                           1
# 1969 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                               );

        } else {

            btm_cb.ble_ctr_cb.inq_var.adv_mode = 0x00;
            btm_ble_disable_resolving_list(4, 
# 1974 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                          1
# 1974 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                              );
...
# 1990 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_create_ll_conn_complete (UINT8 status)
{
    if (status != 0x00) {
        btm_ble_set_conn_st(0);
        btm_ble_update_mode_operation(0xff, 
# 1994 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                       ((void *)0)
# 1994 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                           , status);
    }
}
...
UINT8 btm_proc_smp_cback(tSMP_EVT event, BD_ADDR bd_addr, tSMP_EVT_DATA *p_data)
{
    ...
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_proc_smp_cback event = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", event); };};

    if (p_dev_rec != 
# 2011 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 2011 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        switch (event) {
        case 1:
        ...
        case 2:
            if (event == 2 && btm_cb.pairing_state != BTM_PAIR_STATE_IDLE) {
                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s: Ignoring SMP Security request" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
                break;
            }
        ...
        case 7:
            if (btm_cb.api.p_le_callback) {
                ...
                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_cb.api.p_le_callback=%p" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", btm_cb.api.p_le_callback); };};
                (*btm_cb.api.p_le_callback) (event, bd_addr, (tBTM_LE_EVT_DATA *)p_data);
            }

            if (event == 7) {
                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "evt=SMP_COMPLT_EVT before update sec_level=0x%x sec_flags=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_data->cmplt.sec_level , p_dev_rec->sec_flags); };};

                res = (p_data->cmplt.reason == 0) ? BTM_SUCCESS : BTM_ERR_PROCESSING;

                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "after update result=%d sec_level=0x%x sec_flags=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", res, p_data->cmplt.sec_level , p_dev_rec->sec_flags); };}
                                                                                      ;

                if (p_data->cmplt.is_pair_cancel && btm_cb.api.p_bond_cancel_cmpl_callback ) {
                    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Pairing Cancel completed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
                    (*btm_cb.api.p_bond_cancel_cmpl_callback)(BTM_SUCCESS);
                }
# 2069 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                if (res != BTM_SUCCESS && p_data->cmplt.reason != (0x0E + 0x0B)) {
                    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Pairing failed - prepare to remove ACL" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
                    l2cu_start_post_bond_timer(p_dev_rec->ble_hci_handle);
                }


                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_cb pairing_state=%x pairing_flags=%x pin_code_len=%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", btm_cb.pairing_state, btm_cb.pairing_flags, btm_cb.pin_code_len); };}


                                                       ;
                {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_cb.pairing_bda %02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", btm_cb.pairing_bda[0], btm_cb.pairing_bda[1], btm_cb.pairing_bda[2], btm_cb.pairing_bda[3], btm_cb.pairing_bda[4], btm_cb.pairing_bda[5]); };}
...
# 2098 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                           1
# 2098 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                               );
            }
            break;

        default:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "unknown event = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", event); };};
            break;


        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "btm_proc_smp_cback received for unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
    return 0;
}
# 2133 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_BleDataSignature (BD_ADDR bd_addr, UINT8 *p_text, UINT16 len,
                              BLE_SIGNATURE signature)
{
    tBTM_SEC_DEV_REC *p_rec = btm_find_dev (bd_addr);
    ...
    BOOLEAN ret = 
# 2140 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                 0
# 2140 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                      ;

    if (p_rec == 
# 2142 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0)
# 2142 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s-data signing can not be done from unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
    } else {
        UINT8 *p_mac = (UINT8 *)signature;
        UINT8 *p_buf, *pp;
        if ((p_buf = (UINT8 *)malloc(((UINT16)(len + 4)))) != 
# 2147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                               ((void *)0)
# 2147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                   ) {
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s-Start to generate Local CSRK" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
            pp = p_buf;
            ...
            {*(pp)++ = (UINT8)(p_rec->ble.keys.local_counter); *(pp)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 8); *(pp)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 16); *(pp)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 24);};
            {*(p_mac)++ = (UINT8)(p_rec->ble.keys.local_counter); *(p_mac)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 8); *(p_mac)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 16); *(p_mac)++ = (UINT8)((p_rec->ble.keys.local_counter) >> 24);};

            if ((ret = aes_cipher_msg_auth_code(p_rec->ble.keys.lcsrk, p_buf, (UINT16)(len + 4),
                                                8, p_mac)) == 
# 2160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                                              1
# 2160 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                                                  ) {
                btm_ble_increment_sign_ctr(bd_addr, 
# 2161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                   1
# 2161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                       );
            }

            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s p_mac = %p" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, p_mac); };};
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "p_mac[0] = 0x%02x p_mac[1] = 0x%02x p_mac[2] = 0x%02x p_mac[3] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", *p_mac, *(p_mac + 1), *(p_mac + 2), *(p_mac + 3)); };}
                                                                             ;
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "p_mac[4] = 0x%02x p_mac[5] = 0x%02x p_mac[6] = 0x%02x p_mac[7] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", *(p_mac + 4), *(p_mac + 5), *(p_mac + 6), *(p_mac + 7)); };}
                                                                                   ;
            free((p_buf));
        }
    }
...
# 2190 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_BleVerifySignature (BD_ADDR bd_addr, UINT8 *p_orig, UINT16 len, UINT32 counter,
                                UINT8 *p_comp)
{
    BOOLEAN verified = 
# 2193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                      0
# 2193 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                           ;
    tBTM_SEC_DEV_REC *p_rec = btm_find_dev (bd_addr);
    UINT8 p_mac[8];

    if (p_rec == 
# 2197 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                ((void *)0) 
# 2197 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                     || (p_rec && !(p_rec->ble.key_type & (1 << 2)))) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "can not verify signature for unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    } else if (counter < p_rec->ble.keys.counter) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "signature received with out dated sign counter" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    } else if (p_orig == 
# 2201 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                        ((void *)0)
# 2201 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                            ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "No signature to verify" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    } else {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s rcv_cnt=%d >= expected_cnt=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, counter, p_rec->ble.keys.counter); };}
                                                 ;

        if (aes_cipher_msg_auth_code(p_rec->ble.keys.pcsrk, p_orig, len, 8, p_mac)) {
            if (memcmp(p_mac, p_comp, 8) == 0) {
                btm_ble_increment_sign_ctr(bd_addr, 
# 2209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                                   0
# 2209 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                        );
                verified = 
# 2210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                          1
# 2210 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                              ;
            }
        }
    }
...
# 2229 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_GetLeSecurityState (BD_ADDR bd_addr, UINT8 *p_le_dev_sec_flags, UINT8 *p_le_key_size)
{
    ...
    *p_le_key_size = 0;
    ...
    if ((p_dev_rec = btm_find_dev (bd_addr)) == 
# 2240 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                               ((void *)0)
# 2240 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                                   ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s fails" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
        return (
# 2242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
               0
# 2242 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    );
    }

    if (p_dev_rec->ble_hci_handle == 0xFFFF) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s-this is not LE device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__); };};
        return (
# 2247 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
               0
# 2247 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                    );
    }

    dev_rec_sec_flags = p_dev_rec->sec_flags;

    if (dev_rec_sec_flags & 0x0400) {

        *p_le_key_size = p_dev_rec->enc_key_size;
        *p_le_dev_sec_flags |= 0x01;

        *p_le_dev_sec_flags |= (dev_rec_sec_flags & 0x0200)
                               ? 0x04
                               : 0x02;
    } else if (p_dev_rec->ble.key_type & (1 << 0)) {

        *p_le_key_size = p_dev_rec->ble.keys.key_size;

        *p_le_dev_sec_flags |= (dev_rec_sec_flags & 0x2000)
                               ? 0x04
                               : 0x02;
    }

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "%s - le_dev_sec_flags: 0x%02x, le_key_size: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, *p_le_dev_sec_flags, *p_le_key_size); };}
                                                                   ;

    return 
# 2272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
          1
# 2272 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
              ;



}
# 2288 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
BOOLEAN BTM_BleSecurityProcedureIsRunning(BD_ADDR bd_addr)
{
    ...
    if (p_dev_rec == 
# 2293 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                    ((void *)0)
# 2293 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                        ) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s device with BDA: %08x%04x is not found" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __func__, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5]); };}

                                                        ;
        return 
# 2297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
              0
# 2297 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                   ;
    }

    return (p_dev_rec->sec_state == 2 ||
            p_dev_rec->sec_state == 1);



}
# 2318 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
extern UINT8 BTM_BleGetSupportedKeySize (BD_ADDR bd_addr)
{
# 2351 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
    return 0;

}
# 2369 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_notify_new_key(UINT8 key_type)
{
    tBTM_BLE_LOCAL_KEYS *p_locak_keys = 
# 2371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                                       ((void *)0)
# 2371 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                                           ;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_notify_new_key key_type=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type); };};

    if (btm_cb.api.p_le_key_callback) {
        switch (key_type) {
        case 1:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_KEY_TYPE_ID" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            p_locak_keys = (tBTM_BLE_LOCAL_KEYS *)&btm_cb.devcb.id_keys;
            break;

        case 2:
            {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_KEY_TYPE_ER" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            p_locak_keys = (tBTM_BLE_LOCAL_KEYS *)&btm_cb.devcb.ble_encryption_key_value;
            break;

        default:
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "unknown key type: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", key_type); };};
            break;
        }
        if (p_locak_keys != 
# 2391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c" 3 4
                           ((void *)0)
# 2391 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
                               ) {
            (*btm_cb.api.p_le_key_callback) (key_type, p_locak_keys);
        }
    }
}
# 2407 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_er2(tBTM_RAND_ENC *p)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_er2" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p && p->opcode == (0x0018 | (0x08 << 10))) {
        memcpy(&btm_cb.devcb.ble_encryption_key_value[8], p->param_buf, 8);
        btm_notify_new_key(2);
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating ER2 exception." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        memset(&btm_cb.devcb.ble_encryption_key_value, 0, sizeof(BT_OCTET16));
    }
}
# 2430 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_er(tBTM_RAND_ENC *p)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_er" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p && p->opcode == (0x0018 | (0x08 << 10))) {
        memcpy(&btm_cb.devcb.ble_encryption_key_value[0], p->param_buf, 8);

        if (!btsnd_hcic_ble_rand((void *)btm_ble_process_er2)) {
            memset(&btm_cb.devcb.ble_encryption_key_value, 0, sizeof(BT_OCTET16));
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating ER2 failed." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        }
    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating ER1 exception." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
}
# 2456 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_irk(tSMP_ENC *p)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_irk" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    if (p && p->opcode == (0x0017 | (0x08 << 10))) {
        memcpy(btm_cb.devcb.id_keys.irk, p->param_buf, 16);
        btm_notify_new_key(1);



        if (btm_cb.ble_ctr_cb.privacy_mode != 0) {
            btm_gen_resolvable_private_addr((void *)btm_gen_resolve_paddr_low);
        }

    } else {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating IRK exception." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }


    if (!btsnd_hcic_ble_rand((void *)btm_ble_process_er)) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating ER failed." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
}
# 2491 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_dhk(tSMP_ENC *p)
{
    UINT8 btm_ble_irk_pt = 0x01;
    tSMP_ENC output;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_dhk" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p && p->opcode == (0x0017 | (0x08 << 10))) {
        memcpy(btm_cb.devcb.id_keys.dhk, p->param_buf, 16);
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BLE DHK generated." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};


        if (!SMP_Encrypt(btm_cb.devcb.id_keys.ir, 16, &btm_ble_irk_pt,
                         1, &output)) {
...
# 2527 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_ir2(tBTM_RAND_ENC *p)
{
    UINT8 btm_ble_dhk_pt = 0x03;
    tSMP_ENC output;

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_ir2" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p && p->opcode == (0x0018 | (0x08 << 10))) {

        memcpy(&btm_cb.devcb.id_keys.ir[8], p->param_buf, 8);



        SMP_Encrypt(btm_cb.devcb.id_keys.ir, 16, &btm_ble_dhk_pt,
                    1, &output);
        btm_ble_process_dhk(&output);

        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BLE IR generated." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    } else {
        memset(&btm_cb.devcb.id_keys, 0, sizeof(tBTM_BLE_LOCAL_ID_KEYS));
    }
}
# 2561 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
static void btm_ble_process_ir(tBTM_RAND_ENC *p)
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_process_ir" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (p && p->opcode == (0x0018 | (0x08 << 10))) {

        memcpy(btm_cb.devcb.id_keys.ir, p->param_buf, 8);

        if (!btsnd_hcic_ble_rand((void *)btm_ble_process_ir2)) {
            {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Generating IR2 failed." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            memset(&btm_cb.devcb.id_keys, 0, sizeof(tBTM_BLE_LOCAL_ID_KEYS));
        }
    }
}
# 2585 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble.c"
void btm_ble_reset_id( void )
{
    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_reset_id" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};


    if (!btsnd_hcic_ble_rand((void *)btm_ble_process_ir)) {
        {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "Generating IR failed." "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
    }
}
