# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 2
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
...
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static void avrc_ctrl_cback(UINT8 handle, UINT8 event, UINT16 result,
                            BD_ADDR peer_addr)
{
    UINT8 avrc_event;

    if (event <= 11 && avrc_cb.ccb[handle].p_ctrl_cback) {
...
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static UINT8 *avrc_get_data_ptr(BT_HDR *p_pkt)
{
    return (UINT8 *)(p_pkt + 1) + p_pkt->offset;
}
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static BT_HDR *avrc_copy_packet(BT_HDR *p_pkt, int rsp_pkt_len)
{
    const int offset = ((15) > (p_pkt->offset) ? (15) : (p_pkt->offset));
    const int pkt_len = ((rsp_pkt_len) > (p_pkt->len) ? (rsp_pkt_len) : (p_pkt->len));
    BT_HDR *p_pkt_copy =
        (BT_HDR *)malloc(((UINT16)((sizeof (BT_HDR)) + offset + pkt_len)));


    if (p_pkt_copy != 
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                     ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                         ) {
        memcpy(p_pkt_copy, p_pkt, (sizeof (BT_HDR)));
...
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static void avrc_prep_end_frag(UINT8 handle)
{
    ...
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "avrc_prep_end_frag" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
    ...
    rsp_type = ((*p_orig_data) & 0x0F);

    p_pkt_new = p_fcb->p_fmsg;
    p_pkt_new->len -= ((512) - 6 - 4);
    p_pkt_new->offset += ((512) - 6 - 4);
    p_data = (UINT8 *)(p_pkt_new + 1) + p_pkt_new->offset;
    *p_data++ = rsp_type;
    *p_data++ = (0x09 << 3);
    *p_data++ = 0x00;
    {*(p_data)++ = (UINT8)((0x00001958) >> 16); *(p_data)++ = (UINT8)((0x00001958) >> 8); *(p_data)++ = (UINT8)(0x00001958); };
    *p_data++ = p_fcb->frag_pdu;
    *p_data++ = 3;


    {*(p_data)++ = (UINT8)(((p_pkt_new->len - 6 - 4)) >> 8); *(p_data)++ = (UINT8)((p_pkt_new->len - 6 - 4));};
}
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static void avrc_send_continue_frag(UINT8 handle, UINT8 label)
{
    ...
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "%s handle = %u label = %u len = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", __func__, handle, label, p_pkt->len); };}
                                                         ;
    if (p_pkt->len > (512)) {
        int offset_len = ((15) > (p_pkt->offset) ? (15) : (p_pkt->offset));
        p_pkt_old = p_fcb->p_fmsg;
        p_pkt = (BT_HDR *)malloc(((UINT16)(512 + offset_len + (sizeof (BT_HDR)))));
        if (p_pkt) {
            p_pkt->len = (512);
            p_pkt->offset = 15;
            ...
            memcpy (p_data, p_old, (512));

            p_data += 6;
            p_data++;
            *p_data++ = 2;

            {*(p_data)++ = (UINT8)((((512) - 6 - 4)) >> 8); *(p_data)++ = (UINT8)(((512) - 6 - 4));};
            ...
            p_pkt = p_fcb->p_fmsg;
            p_fcb->p_fmsg = 
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                           ((void *)0)
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                               ;
            p_fcb->frag_enabled = 
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                 0
# 225 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                      ;
            {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC_MsgReq no buffers for fragmentation - send internal error" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
            p_data = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
            *p_data++ = 0x40;
            *p_data++ = 0;
            {*(p_data)++ = (UINT8)((0) >> 8); *(p_data)++ = (UINT8)(0);};
            p_pkt->len = 4;
            rej_rsp.pdu = 0x40;
            rej_rsp.status = 0x03;
        ...
        p_fcb->frag_enabled = 
# 239 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                             0
# 239 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                  ;
        p_fcb->p_fmsg = 
# 240 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                             ((void *)0)
# 240 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                 ;
    }
    AVCT_MsgReq( handle, label, cr, p_pkt);
}
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static BT_HDR *avrc_proc_vendor_command(UINT8 handle, UINT8 label,
                                        BT_HDR *p_pkt, tAVRC_MSG_VENDOR *p_msg)
{
    BT_HDR *p_rsp = 
# 257 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        ((void *)0)
# 257 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
    UINT8 *p_data;
    UINT8 *p_begin;
    UINT8 pkt_type;
    BOOLEAN abort_frag = 
# 261 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            0
# 261 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                 ;
    ...
    if (pkt_type != 0) {
        ...
        {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "commands must be in single packet pdu:0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", *p_data); };};
        ...
        p_fcb = &avrc_cb.fcb[handle];
        if (p_msg->company_id == 0x00001958) {
            switch (*p_data) {
            case 0x41:

                abort_frag = 
# 282 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            1
# 282 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                ;
                p_begin = (UINT8 *)(p_pkt + 1) + p_pkt->offset;
                *p_begin = (9 & 0x0F);
                ...
                AVCT_MsgReq( handle, label, 2, p_pkt);
                p_msg->hdr.opcode = 0xFE;
                break;

            case 0x40:
                if (*(p_data + 4) == p_fcb->frag_pdu) {
                    avrc_send_continue_frag(handle, label);
                    p_msg->hdr.opcode = 0xFD;
                } else {

                    {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "avrc_proc_vendor_command continue pdu: 0x%x does not match                     current re-assembly pdu: 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", *(p_data + 4), p_fcb->frag_pdu); };}

                                                                    ;
                    status = 0x01;
                    abort_frag = 
# 307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                1
# 307 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                    ;
                }
                break;
            ...
            default:
                ...
                abort_frag = 
# 313 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            1
# 313 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                ;
            }
        } else {
            abort_frag = 
# 316 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        1
# 316 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
        ...
        if (abort_frag) {
            if (p_fcb->p_fmsg) {
                free((p_fcb->p_fmsg));
                p_fcb->p_fmsg = 
# 323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                               ((void *)0)
# 323 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                   ;
            }
            p_fcb->frag_enabled = 
# 325 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                 0
# 325 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                      ;
        }
    }
    ...
    if (status != 0x04) {
        ...
        *p_data++ = 10;
        p_data += 6;
        *p_data++ = 0;
        {*(p_data)++ = (UINT8)((1) >> 8); *(p_data)++ = (UINT8)(1);};
        *p_data++ = status;
        p_pkt->len = 6 + 5;
        p_rsp = p_pkt;
    }
...
# 354 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                               ...
                               tAVRC_MSG_VENDOR *p_msg)
{
    ...
    UINT8 drop_code = 0;
    BT_HDR *p_rsp = 
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        ((void *)0)
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
    BT_HDR *p_cmd = 
# 361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        ((void *)0)
# 361 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
    BOOLEAN req_continue = 
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                              0
# 362 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                   ;
    BT_HDR *p_pkt_new = 
# 363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            ((void *)0)
# 363 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                ;
    UINT8 pkt_type;
    tAVRC_RASM_CB *p_rcb;
    ...
    pkt_type = *(p_data + 1) & 3;
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "pkt_type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", pkt_type); };};
    ...
    if (p_msg->company_id == 0x00001958) {
        ...
        if (pkt_type == 0 || pkt_type == 1) {
            ...
            if (p_rcb->p_rmsg) {
                free((p_rcb->p_rmsg));
                p_rcb->p_rmsg = 
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                               ((void *)0)
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                   ;
            }
        }
        ...
        if (pkt_type != 0 && cr == 2) {
            ...
            if (pkt_type == 1) {
                ...
                if ((p_rcb->p_rmsg = (BT_HDR *)malloc(((4096 + 16)))) != 
# 392 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                                                                     ((void *)0)
# 392 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                                                                         ) {
                    ...
                    *pp_pkt = p_rcb->p_rmsg;
                    ...
                    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "Unable to allocate buffer for fragmented avrc message,                                        reusing START buffer for reassembly" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };}
                                                                            ;
                ...
                req_continue = 
# 417 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                              1
# 417 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                  ;
            } else if (p_rcb->p_rmsg == 
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                       ((void *)0)
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                           ) {


                {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "Received a CONTINUE/END without no corresponding START                                    (or previous fragmented response was dropped)" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };}
                                                                                  ;
                drop_code = 5;
                free((p_pkt));
                *pp_pkt = 
# 425 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                         ((void *)0)
# 425 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                             ;
            } else {
                ...
                UINT16 buf_len = (4096 + 16) - sizeof(BT_HDR);

                p_pkt->offset += (6 + 4);
                p_pkt->len -= (6 + 4);

                if ((p_rcb->p_rmsg->offset + p_pkt->len) > buf_len) {
                    {if (avrc_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_AVRC", "\033[0;" "33" "m" "W" " (%d) %s: " "Fragmented message too big! - report the partial message" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
                ...
                if (pkt_type == 3) {
                    ...
                    p_rcb->rasm_offset = 0;
                    p_rcb->p_rmsg = 
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                   ((void *)0)
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                       ;
                    p_msg->p_vendor_data = (UINT8 *)(p_pkt_new + 1) + p_pkt_new->offset;
                    p_msg->hdr.ctype = p_msg->p_vendor_data[0] & 0x0F;

                    p_msg->p_vendor_data += 6;
                    p_msg->vendor_len = p_pkt_new->len - 6;
                    p_data = p_msg->p_vendor_data + 1;
                    *p_data++ = 0;
                    {*(p_data)++ = (UINT8)(((p_msg->vendor_len - 4)) >> 8); *(p_data)++ = (UINT8)((p_msg->vendor_len - 4));};
                    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "end frag:%d, total len:%d, offset:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", p_pkt->len, p_pkt_new->len, p_pkt_new->offset); };}
                                                                       ;
                } else {
                    p_rcb->p_rmsg->offset += p_pkt->len;
                    p_rcb->p_rmsg->len += p_pkt->len;
                    p_pkt_new = 
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                               ((void *)0)
# 466 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                   ;
                    req_continue = 
# 467 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                  1
# 467 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                      ;
                }
                free((p_pkt));
                *pp_pkt = p_pkt_new;
        ...
        if (cr == 0) {
            ...
            if (p_rsp) {
                AVCT_MsgReq( handle, label, 2, p_rsp);
                drop_code = 3;
            } else if (p_msg->hdr.opcode == 0xFE) {
                drop_code = 1;
            } else if (p_msg->hdr.opcode == 0xFD) {
                drop_code = 4;
            }

        } else if (cr == 2 && req_continue == 
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                                    1
# 485 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                                        ) {
            avrc_cmd.pdu = 0x40;
            avrc_cmd.status = 0x04;
            avrc_cmd.target_pdu = p_rcb->rasm_pdu;
            if (AVRC_BldCommand ((tAVRC_COMMAND *)&avrc_cmd, &p_cmd) == 0x04) {
                drop_code = 2;
                AVRC_MsgReq (handle, (UINT8)(label), 0, p_cmd);
            }
        }
    }
...
# 510 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                           ...
                           BT_HDR *p_pkt)
{
    ...
    UINT8 *p_begin;
    BOOLEAN drop = 
# 517 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                      0
# 517 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                           ;
    BOOLEAN do_free = 
# 518 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                         1
# 518 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                             ;
    BT_HDR *p_rsp = 
# 519 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        ((void *)0)
# 519 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
    UINT8 *p_rsp_data;
    int xx;
    BOOLEAN reject = 
# 522 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        0
# 522 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                             ;
    ...
    if (cr == 0 &&
            (p_pkt->layer_specific & 0x0001 && 512 < sizeof(p_pkt->len))) {
    ...
    {
        msg.hdr.ctype = p_data[0] & 0x0F;
        {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "avrc_msg_cback handle:%d, ctype:%d, offset:%d, len: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", handle, msg.hdr.ctype, p_pkt->offset, p_pkt->len); };}
                                                                          ;
        msg.hdr.subunit_type = (p_data[1] & 0xF8) >> 3;
        msg.hdr.subunit_id = p_data[1] & 0x07;
        opcode = p_data[2];
    }

    if ( ((avrc_cb.ccb[handle].control & 1) && (cr == 0)) ||
            ((avrc_cb.ccb[handle].control & 2) && (cr == 2)) ) {

        switch (opcode) {
        case 0x30:
            if (cr == 0) {

                p_rsp = avrc_copy_packet(p_pkt, 8);
                ...
                *p_rsp_data++ = (0x09 << 3);
                {*(p_rsp_data)++ = (UINT8)((avrc_cb.ccb[handle].company_id) >> 16); *(p_rsp_data)++ = (UINT8)((avrc_cb.ccb[handle].company_id) >> 8); *(p_rsp_data)++ = (UINT8)(avrc_cb.ccb[handle].company_id); };
                ...
                p_data += 4;
                msg.unit.unit_type = (*p_data & 0xF8) >> 3;
                msg.unit.unit = *p_data & 0x07;
                p_data++;
                {msg.unit.company_id = (((UINT32)(*((p_data) + 2))) + (((UINT32)(*((p_data) + 1))) << 8) + (((UINT32)(*(p_data))) << 16)); (p_data) += 3;};
            }
            break;
        ...
        case 0x31:
            if (cr == 0) {
                ...
                *p_rsp_data++ = (0x09 << 3);
                ...
                p_data += 3;
                msg.sub.page = (*p_data++ >> 4) & 7;
                xx = 0;
                while (*p_data != 0xFF && xx < 4) {
                    msg.sub.subunit_type[xx] = *p_data++ >> 3;
                    if (msg.sub.subunit_type[xx] == 0x09) {
                        msg.sub.panel = 
# 616 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                         1
# 616 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                             ;
                    }
                    xx++;
                }
        ...
        case 0x00:
            ...
            if (p_pkt->len < 6) {
                if (cr == 0) {
                    reject = 
# 628 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            1
# 628 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                ;
                } else {
                    drop = 
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                          1
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                              ;
                }
                break;
            }
            p_data += 3;
            {p_msg->company_id = (((UINT32)(*((p_data) + 2))) + (((UINT32)(*((p_data) + 1))) << 8) + (((UINT32)(*(p_data))) << 16)); (p_data) += 3;};
            ...
            if (p_msg->company_id == 0x00001958) {
                ...
                if (p_pkt->len < (6 + 4)) {
                    if (cr == 0) {
                        reject = 
# 645 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                1
# 645 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                    ;
                    } else {
                        drop = 
# 647 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                              1
# 647 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                  ;
                    }
                    break;
                }
                ...
                if (drop_code > 0) {
                    drop = 
# 655 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                          1
# 655 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                              ;
                }
            }
            if (drop_code > 0) {
                if (drop_code != 4) {
                    do_free = 
# 660 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                             0
# 660 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                  ;
                }
# 680 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
            }
        ...
        case 0x7C:
            if (p_pkt->len < 5) {
                if (cr == 0) {
                    reject = 
# 687 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                            1
# 687 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                ;
                } else {
                    drop = 
# 689 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                          1
# 689 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                              ;
                }
                break;
            }
            p_data += 3;
            msg.pass.op_id = (0x7F & *p_data);
            if (0x80 & *p_data) {
                msg.pass.state = 
# 696 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                 1
# 696 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                     ;
            } else {
                msg.pass.state = 
# 698 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                 0
# 698 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                      ;
            }
            p_data++;
            ...
            if (msg.pass.pass_len) {
                ...
                msg.pass.p_pass_data = 
# 708 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                      ((void *)0)
# 708 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                          ;
            }
            break;
        ...
        default:
            if ((avrc_cb.ccb[handle].control & 1) && (cr == 0)) {
                ...
                reject = 
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                        1
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                            ;
            }
            drop = 
# 718 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                     1
# 718 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                         ;
            break;
        }
    } else {
        drop = 
# 722 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                 1
# 722 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                     ;
    }

    if (reject) {

        p_rsp = avrc_copy_packet(p_pkt, 11);
        p_rsp_data = avrc_get_data_ptr(p_rsp);
        *p_rsp_data = 10;
        ...
        cr = 2;
        drop = 
# 734 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                 1
# 734 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                     ;
    }
    ...
    if (p_rsp) {
        ...
        drop = 
# 740 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
              1
# 740 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                  ;
    }

    if (drop == 
# 743 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
               0
# 743 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                    ) {
        msg.hdr.opcode = opcode;
        (*avrc_cb.ccb[handle].p_msg_cback)(handle, label, opcode, &msg);
    }
# 756 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
    if (do_free) {
        free((p_pkt));
    }
}
# 780 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
static BT_HDR *avrc_pass_msg(tAVRC_MSG_PASS *p_msg)
{
    BT_HDR *p_cmd = 
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                    ((void *)0)
# 782 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                        ;
    UINT8 *p_data;

    ((p_msg != 
# 785 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
   ((void *)0)
# 785 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c", 785, __func__, "p_msg != NULL"));
    ((288 > (20 +p_msg->pass_len)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c", 786, __func__, "AVRC_CMD_BUF_SIZE > (AVRC_MIN_CMD_LEN+p_msg->pass_len)"));

    if ((p_cmd = (BT_HDR *) malloc((288))) != 
# 788 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                                             ((void *)0)
# 788 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                                                 ) {
        p_cmd->offset = 15;
        p_cmd->layer_specific = 0x0001;
        p_data = (UINT8 *)(p_cmd + 1) + p_cmd->offset;
        *p_data++ = (p_msg->hdr.ctype & 0x0F);
        *p_data++ = (0x09 << 3);
        *p_data++ = 0x7C;
        *p_data = (0x7F & p_msg->op_id);
        if (p_msg->state) {
            *p_data |= 0x80;
        }
        p_data++;
...
# 861 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
UINT16 AVRC_Open(UINT8 *p_handle, tAVRC_CONN_CB *p_ccb, BD_ADDR_PTR peer_addr)
{
    UINT16 status;
    tAVCT_CC cc;

    cc.p_ctrl_cback = avrc_ctrl_cback;
    cc.p_msg_cback = avrc_msg_cback;
    cc.pid = 0X110E;
    cc.role = p_ccb->conn;
    cc.control = p_ccb->control;
    ...
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "AVRC_Open role: %d, control:%d status:%d, handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", cc.role, cc.control, status, *p_handle); };}
                                       ;

    return status;
}
# 904 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
UINT16 AVRC_Close(UINT8 handle)
{
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "AVRC_Close handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", handle); };};
    return AVCT_RemoveConn(handle);
}
# 927 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
UINT16 AVRC_MsgReq (UINT8 handle, UINT8 label, UINT8 ctype, BT_HDR *p_pkt)
{
    ...
    UINT8 cr = 0;
    BOOLEAN chk_frag = 
# 932 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                      1
# 932 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                          ;
    UINT8 *p_start = 
# 933 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                      ((void *)0)
# 933 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                          ;
    tAVRC_FRAG_CB *p_fcb;
    UINT16 len;
    BT_HDR *p_pkt_new;
    ...
    {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "%s handle = %u label = %u ctype = %u len = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", __func__, handle, label, ctype, p_pkt->len); };}
                                                                ;
    ...
    if (p_fcb->frag_enabled) {
        p_fcb->frag_enabled = 
# 976 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                             0
# 976 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                  ;
    }
    ...
    if (p_fcb->p_fmsg) {
        free((p_fcb->p_fmsg));
        p_fcb->p_fmsg = 
# 981 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                       ((void *)0)
# 981 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                           ;
    }
    ...
    if ((cr == 2) && (chk_frag == 
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                        1
# 986 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                            )) {
        if (p_pkt->len > (512)) {
            int offset_len = ((15) > (p_pkt->offset) ? (15) : (p_pkt->offset));
            p_pkt_new = (BT_HDR *)malloc(((UINT16)(512 + offset_len + (sizeof (BT_HDR)))))
                                                            ;
            if (p_pkt_new && (p_start != 
# 991 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                        ((void *)0)
# 991 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                            )) {
                p_fcb->frag_enabled = 
# 992 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
                                     1
# 992 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
                                         ;
                p_fcb->p_fmsg = p_pkt;
                ...
                *p_data++ = 1;
                ...
                len = ((512) - 6 - 4);
                {*(p_data)++ = (UINT8)((len) >> 8); *(p_data)++ = (UINT8)(len);};


                avrc_prep_end_frag (handle);
                {if (avrc_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_AVRC", "D" " (%d) %s: " "%s p_pkt len:%d/%d, next len:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC", __func__, p_pkt->len, len, p_fcb->p_fmsg->len); };}
                                                                       ;
            } else {
                {if (avrc_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_AVRC", "\033[0;" "31" "m" "E" " (%d) %s: " "AVRC_MsgReq no buffers for fragmentation" "\033[0m" "\n", esp_log_timestamp(), "BT_AVRC"); };};
                free((p_pkt));
                return 1;
            }
        }
...
# 1054 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
UINT16 AVRC_PassCmd(UINT8 handle, UINT8 label, tAVRC_MSG_PASS *p_msg)
{
    BT_HDR *p_buf;
    ((p_msg != 
# 1057 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
   ((void *)0)
# 1057 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c", 1057, __func__, "p_msg != NULL"));
    if (p_msg) {
        p_msg->hdr.ctype = 0;
        p_buf = avrc_pass_msg(p_msg);
        if (p_buf) {
            return AVCT_MsgReq( handle, label, 0, p_buf);
        }
    }
    return 1;
}
# 1093 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
UINT16 AVRC_PassRsp(UINT8 handle, UINT8 label, tAVRC_MSG_PASS *p_msg)
{
    BT_HDR *p_buf;
    ((p_msg != 
# 1096 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c" 3 4
   ((void *)0)
# 1096 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/avrc/avrc_api.c", 1096, __func__, "p_msg != NULL"));
    if (p_msg) {
        p_buf = avrc_pass_msg(p_msg);
        if (p_buf) {
            return AVCT_MsgReq( handle, label, 2, p_buf);
        }
    }
    return 1;
}
