# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
void smp_l2cap_if_init (void)
{
    tL2CAP_FIXED_CHNL_REG fixed_reg;
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMDBG l2c %s" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__); };};
...
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                  ((void *)0)
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                      ;
    ...
    L2CA_RegisterFixedChannel (6, &fixed_reg);

    fixed_reg.pL2CA_FixedConn_Cb = smp_br_connect_callback;
    fixed_reg.pL2CA_FixedData_Cb = smp_br_data_received;

    L2CA_RegisterFixedChannel (7, &fixed_reg);

}
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_connect_callback (UINT16 channel, BD_ADDR bd_addr, BOOLEAN connected, UINT16 reason,
                                  tBT_TRANSPORT transport)
{
    tSMP_CB *p_cb = &smp_cb;
    ...
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};

    if (transport == 1 || memcmp(bd_addr, dummy_bda, 6) == 0) {
        return;
    }

    if (memcmp(bd_addr, p_cb->pairing_bda, 6) == 0) {
        {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s()  for pairing BDA: %08x%04x  Event: %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], (connected) ? "connected" : "disconnected"); };}
        ...
        if (connected) {
            if (!p_cb->connect_initialized) {
                p_cb->connect_initialized = 
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                           1
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                               ;
                ...
                p_cb->loc_auth_req = p_cb->peer_auth_req = 0x00;
                p_cb->cb_evt = 1;
                smp_sm_event(p_cb, ((0x0F + 1) + 2), 
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                                      ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                                          );
            }
        } else {
            int_data.reason = reason;

            smp_sm_event(p_cb, ((0x0F + 1) + 3), &int_data);
        }
    }
}
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_data_received(UINT16 channel, BD_ADDR bd_addr, BT_HDR *p_buf)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 *p = (UINT8 *)(p_buf + 1) + p_buf->offset;
    UINT8 cmd ;
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "\nSMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};

    {cmd = (UINT8)(*(p)); (p) += 1;};


    if ((0x0E < cmd) || (0x01 > cmd)) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "Ignore received command with RESERVED code 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", cmd); };};
        free((p_buf));
        return;
    }


    if (0x01 == cmd || 0x0B == cmd) {
        if ((p_cb->state == SMP_STATE_IDLE) && (p_cb->br_state == SMP_BR_STATE_IDLE) &&
            !(p_cb->flags & (1))) {
            p_cb->role = L2CA_GetBleConnRole(bd_addr);
            memcpy(&p_cb->pairing_bda[0], bd_addr, 6);
        } else if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6)) {
            free((p_buf));
    ...
    if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6) == 0) {
        btu_stop_timer (&p_cb->rsp_timer_ent);
        btu_start_timer (&p_cb->rsp_timer_ent, 102,
                         30);

        if (cmd == 0x03) {
            {if (smp_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "in %s cmd = 0x%02x, peer_auth_req = 0x%02x," "loc_auth_req = 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, cmd, p_cb->peer_auth_req, p_cb->loc_auth_req); };}

                                                                                        ;

            if ((p_cb->peer_auth_req & (1 << 3)) &&
...
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_tx_complete_callback (UINT16 cid, UINT16 num_pkt)
{
    tSMP_CB *p_cb = &smp_cb;
    ...
    if (p_cb->total_tx_unacked >= num_pkt) {
        ...
        {if (smp_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "Unexpected %s: num_pkt = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, num_pkt); };};
    }
...
# 238 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                    ...
                                    UINT16 reason, tBT_TRANSPORT transport)
{
    ...
    if (transport != 1) {
        {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s is called on unexpected transport %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, transport); };}
                                              ;
        return;
    }
    ...
    {if (smp_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s for pairing BDA: %08x%04x  Event: %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], (connected) ? "connected" : "disconnected"); };}
    ...
    if (connected) {
        if (!p_cb->connect_initialized) {
            p_cb->connect_initialized = 
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                       1
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                           ;

            p_cb->local_r_key = p_cb->local_i_key = ((1 << 0) | (1 << 1) | (1 << 2));
            p_cb->loc_auth_req = p_cb->peer_auth_req = 0;
            p_cb->cb_evt = 12;
            smp_br_state_machine_event(p_cb, (0x0E + 3), 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                                                   ((void *)0)
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                                                       );
        }
    } else {
        int_data.reason = reason;

        smp_br_state_machine_event(p_cb, (0x0E + 4), &int_data);
    }
}
# 288 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_br_data_received(UINT16 channel, BD_ADDR bd_addr, BT_HDR *p_buf)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 *p = (UINT8 *)(p_buf + 1) + p_buf->offset;
    ...
    if ((0x0E < cmd) || (0x01 > cmd)) {
        {if (smp_cb.trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "Ignore received command with RESERVED code 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", cmd); };};
        free((p_buf));
        return;
    }
    ...
    if (0x01 == cmd) {
        if ((p_cb->state == SMP_STATE_IDLE) && (p_cb->br_state == SMP_BR_STATE_IDLE)) {
            p_cb->role = 0x01;
            p_cb->smp_over_br = 
# 308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                               1
# 308 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                   ;
            memcpy(&p_cb->pairing_bda[0], bd_addr, 6);
        } else if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6)) {
            free((p_buf));
