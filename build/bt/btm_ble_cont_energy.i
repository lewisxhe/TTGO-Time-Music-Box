# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 2




tBTM_BLE_ENERGY_INFO_CB ble_energy_info_cb;
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
void btm_ble_cont_energy_cmpl_cback (tBTM_VSC_CMPL *p_params)
{
    ...
    if (len < 17) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "wrong length for btm_ble_cont_energy_cmpl_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }

    {status = (UINT8)(*(p)); (p) += 1;};
    {total_tx_time = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
    {total_rx_time = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
    {total_idle_time = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};
    {total_energy_used = (((UINT32)(*(p))) + ((((UINT32)(*((p) + 1)))) << 8) + ((((UINT32)(*((p) + 2)))) << 16) + ((((UINT32)(*((p) + 3)))) << 24)); (p) += 4;};

    {if (btm_cb.trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "energy_info status=%d,tx_t=%u, rx_t=%u, ener_used=%u, idle_t=%u" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status, total_tx_time, total_rx_time, total_energy_used, total_idle_time); };}
                                                                                             ;

    if (
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 3 4
       ((void *)0) 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
...
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
tBTM_STATUS BTM_BleGetEnergyInfo(tBTM_BLE_ENERGY_INFO_CBACK *p_ener_cback)
{
    ...
    {if (btm_cb.trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleGetEnergyInfo\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (0 == cmn_ble_vsc_cb.energy_support) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Controller does not support get energy info\n" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }

    ble_energy_info_cb.p_ener_cback = p_ener_cback;
    if ((status = BTM_VendorSpecificCommand ((0x0159 | (0x3F << 10)), 0, 
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c" 3 4
                                                                        ((void *)0)
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/stack/btm/btm_ble_cont_energy.c"
                                                                            ,
                  btm_ble_cont_energy_cmpl_cback)) != BTM_CMD_STARTED) {
        {if (btm_cb.trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_BleGetEnergyInfo status: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
