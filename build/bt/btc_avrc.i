# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/btc_av.h" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 2
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
typedef struct {
    UINT8 bNotify;
    UINT8 label;
...
typedef struct {
    ...
    btc_rc_cmd_ctxt_t rc_pdu_info[8];
    btc_rc_reg_notifications_t rc_notif[0x08];
...
typedef struct {
    osi_mutex_t lbllock;
    rc_transaction_t transaction[16];
} rc_device_t;
...
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
static void handle_rc_connect (tBTA_AV_RC_OPEN *p_rc_open)
{
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: rc_handle: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, p_rc_open->rc_handle); };};
    bt_bdaddr_t rc_addr;

    if (p_rc_open->status == 0) {

        if (btc_rc_vb.rc_connected) {
            {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "Got RC OPEN in connected state, Connected RC: %d                 and Current RC: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", btc_rc_vb.rc_handle, p_rc_open->rc_handle); };}
                                                                                ;
            if ((btc_rc_vb.rc_handle != p_rc_open->rc_handle)
                    && (bdcmp(btc_rc_vb.rc_addr, p_rc_open->peer_addr))) {
                {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Got RC connected for some other handle" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC"); };};
        ...
        btc_rc_vb.rc_vol_label = 16;
        btc_rc_vb.rc_volume = 128;

        btc_rc_vb.rc_connected = 
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                                1
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                    ;
...
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                                   1
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                       ;
        ...
        if (p_rc_open->sdp_disc_done == 
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                                       1
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                           ) {
            handle_rc_features();
        }
    } else {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s Connect failed with error code: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, p_rc_open->status); };}
                                                  ;
        btc_rc_vb.rc_connected = 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                                0
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                     ;
    }
}
# 191 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
static void handle_rc_disconnect (tBTA_AV_RC_CLOSE *p_rc_close)
{
    bt_bdaddr_t rc_addr;

    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: rc_handle: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, p_rc_close->rc_handle); };};
    if ((p_rc_close->rc_handle != btc_rc_vb.rc_handle)
            && (bdcmp(btc_rc_vb.rc_addr, p_rc_close->peer_addr))) {
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "Got disconnect of unknown device" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC"); };};
        return;
    }

    btc_rc_vb.rc_handle = 0;
    btc_rc_vb.rc_connected = 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                            0
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                 ;
    ...
    memset(&param, 0, sizeof(esp_avrc_ct_cb_param_t));
    param.conn_stat.connected = 
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                               0
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                    ;
    memcpy(param.conn_stat.remote_bda, &rc_addr, sizeof(esp_bd_addr_t));
    btc_avrc_ct_cb_to_app(ESP_AVRC_CT_CONNECTION_STATE_EVT, &param);
}
...
# 278 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
static void handle_rc_metadata_rsp ( tBTA_AV_META_MSG *p_remote_rsp)
{
    ...
    case 13:
        if (vendor_msg->p_vendor_data[0] == 0x31) {
            handle_rc_notification_rsp(vendor_msg);
        }
        break;

    case 12:
        if (vendor_msg->p_vendor_data[0] == 0x20) {
...
# 311 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
static void handle_rc_passthrough_rsp ( tBTA_AV_REMOTE_RSP *p_remote_rsp)
{

    const char *status;
    if (btc_rc_vb.rc_features & 0x0001) {
        int key_state;
        if (p_remote_rsp->key_state == 1) {
            status = "released";
            key_state = 1;
        } else {
            status = "pressed";
        ...
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: rc_id=%d status=%s" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, p_remote_rsp->rc_id, status); };};
        ...
        {if (2 >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTC", "\033[0;" "31" "m" "E" " (%d) %s: " "%s DUT does not support AVRCP controller role" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
    }



}
# 351 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
void btc_rc_handler(tBTA_AV_EVT event, tBTA_AV *p_data)
{
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s event:%s" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, dump_rc_event(event)); };};
    switch (event) {
    case 8: {
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Peer_features:%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", p_data->rc_open.peer_features); };};
    ...
    case 11: {
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "RSP: rc_id:0x%x key_state:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", p_data->remote_rsp.rc_id, p_data->remote_rsp.key_state); };}
                                               ;
    ...
    case 19: {
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Peer_features:%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", p_data->rc_feat.peer_features); };};
    ...
    case 10:
    default:
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "Unhandled RC event : 0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", event); };};
    }
}
# 398 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
BOOLEAN btc_rc_get_connected_peer(BD_ADDR peer_addr)
{
    if (btc_rc_vb.rc_connected == 
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                                 1
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                                     ) {
        bdcpy(peer_addr, btc_rc_vb.rc_addr);
        return 
# 402 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
              1
# 402 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                  ;
    }
    return 
# 404 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
          0
# 404 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
               ;
}
# 420 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
...
# 439 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
static void btc_avrc_ct_deinit(void)
{
    {if (2 >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTC", "\033[0;" "32" "m" "I" " (%d) %s: " "## %s ##" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};

    memset(&btc_rc_vb, 0, sizeof(btc_rc_cb_t));
    {if (2 >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTC", "\033[0;" "32" "m" "I" " (%d) %s: " "## %s ## completed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
}
...
static bt_status_t btc_avrc_ct_send_set_player_value_cmd(uint8_t tl, uint8_t attr_id, uint8_t value_id)
{
    ...
    do { {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "## %s ##" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; if (btc_rc_vb.rc_connected == 
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
   0
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
   ) { {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTC", "\033[0;" "33" "m" "W" " (%d) %s: " "Function %s() called when RC is not connected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; return 0x103; } } while (0);

    tAVRC_COMMAND avrc_cmd = {0};
    BT_HDR *p_msg = 
# 455 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                   ((void *)0)
# 455 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                       ;
    ...
    avrc_cmd.set_app_val.opcode = 0x00;
    avrc_cmd.set_app_val.status = 0x04;
    avrc_cmd.set_app_val.num_val = 1;
    avrc_cmd.set_app_val.p_vals = &values;
    avrc_cmd.set_app_val.pdu = 0x14;

    status = AVRC_BldCommand(&avrc_cmd, &p_msg);
    if (status == 0x04) {
        if (btc_rc_vb.rc_features & 0x0040) {
            BTA_AvMetaCmd(btc_rc_vb.rc_handle, tl, 0, p_msg);
            status = BT_STATUS_SUCCESS;
        } else {
            status = BT_STATUS_FAIL;
            {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: feature not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
        }
    }
...
static bt_status_t btc_avrc_ct_send_register_notification_cmd(uint8_t tl, uint8_t event_id, uint32_t event_parameter)
{
    ...
    do { {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "## %s ##" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; if (btc_rc_vb.rc_connected == 
# 490 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
   0
# 490 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
   ) { {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTC", "\033[0;" "33" "m" "W" " (%d) %s: " "Function %s() called when RC is not connected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; return 0x103; } } while (0);

    tAVRC_COMMAND avrc_cmd = {0};
    BT_HDR *p_msg = 
# 493 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                   ((void *)0)
# 493 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                       ;

    avrc_cmd.reg_notif.opcode = 0x00;
    avrc_cmd.reg_notif.status = 0x04;
    avrc_cmd.reg_notif.event_id = event_id;
    avrc_cmd.reg_notif.param = event_parameter;
    avrc_cmd.reg_notif.pdu = 0x31;

    status = AVRC_BldCommand(&avrc_cmd, &p_msg);
    if (status == 0x04) {
        if (btc_rc_vb.rc_features & 0x0040) {
            BTA_AvMetaCmd(btc_rc_vb.rc_handle, tl, 3, p_msg);
            status = BT_STATUS_SUCCESS;
        } else {
            status = BT_STATUS_FAIL;
            {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: feature not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
...
static bt_status_t btc_avrc_ct_send_metadata_cmd (uint8_t tl, uint8_t attr_mask)
{
    ...
    do { {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "## %s ##" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; if (btc_rc_vb.rc_connected == 
# 524 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
   0
# 524 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
   ) { {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTC", "\033[0;" "33" "m" "W" " (%d) %s: " "Function %s() called when RC is not connected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; return 0x103; } } while (0);
    uint32_t index = 0;

    tAVRC_COMMAND avrc_cmd = {0};
    BT_HDR *p_msg = 
# 528 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
                   ((void *)0)
# 528 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
                       ;

    avrc_cmd.get_elem_attrs.opcode = 0x00;
    avrc_cmd.get_elem_attrs.status = 0x04;
    avrc_cmd.get_elem_attrs.pdu = 0x20;
    ...
    if (status == 0x04) {
        if (btc_rc_vb.rc_features & 0x0040) {
            BTA_AvMetaCmd(btc_rc_vb.rc_handle, tl, 1, p_msg);
            status = BT_STATUS_SUCCESS;
        } else {
            status = BT_STATUS_FAIL;
            {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: feature not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
...
static bt_status_t btc_avrc_ct_send_passthrough_cmd(uint8_t tl, uint8_t key_code, uint8_t key_state)
{
    ...
    do { {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "## %s ##" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; if (btc_rc_vb.rc_connected == 
# 566 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c" 3 4
   0
# 566 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/avrc/btc_avrc.c"
   ) { {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTC", "\033[0;" "33" "m" "W" " (%d) %s: " "Function %s() called when RC is not connected" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };}; return 0x103; } } while (0);
    {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: key-code: %d, key-state: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, key_code, key_state); };}
                                  ;
    if (btc_rc_vb.rc_features & 0x0001) {
        BTA_AvRemoteCmd(btc_rc_vb.rc_handle, tl,
                        (tBTA_AV_RC)key_code, (tBTA_AV_STATE)key_state);
        status = BT_STATUS_SUCCESS;
        {if (2 >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_BTC", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: succesfully sent passthrough command to BTA" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
    } else {
        status = BT_STATUS_FAIL;
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: feature not supported" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__); };};
    }
