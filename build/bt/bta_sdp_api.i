# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_sdp_api.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_sdp_api.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/bt_sdp.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/btc/profile/std/include/bt_sdp.h"
typedef enum {
    SDP_TYPE_RAW,
    SDP_TYPE_MAP_MAS,
    SDP_TYPE_MAP_MNS,
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/include/bta/bta_sdp_api.h" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
   ((void *)0)

# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
};
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
tBTA_SDP_STATUS BTA_SdpEnable(tBTA_SDP_DM_CBACK *p_cback)
{
    tBTA_SDP_STATUS status = 1;
    tBTA_SDP_API_ENABLE *p_buf;

    {if (appl_trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_APPL", "\033[0;" "32" "m" "I" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __FUNCTION__); };};
    if (p_cback && 
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
                  0 
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
                        == bta_sys_is_register(33)) {
        memset(&bta_sdp_cb, 0, sizeof(tBTA_SDP_CB));


        bta_sys_register(33, &bta_sdp_reg);

        if (p_cback &&
                (p_buf = (tBTA_SDP_API_ENABLE *) malloc((sizeof(tBTA_SDP_API_ENABLE)))) != 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
                                                                                            ((void *)0)
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
                                                                                                ) {
...
# 94 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
tBTA_SDP_STATUS BTA_SdpSearch(BD_ADDR bd_addr, tBT_UUID *uuid)
{
    tBTA_SDP_STATUS ret = 1;
    tBTA_SDP_API_SEARCH *p_msg;

    {if (appl_trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_APPL", "\033[0;" "32" "m" "I" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __FUNCTION__); };};
    if ((p_msg = (tBTA_SDP_API_SEARCH *)malloc((sizeof(tBTA_SDP_API_SEARCH)))) != 
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
                                                                                   ((void *)0)
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
                                                                                       ) {
...
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
tBTA_SDP_STATUS BTA_SdpCreateRecordByUser(void *user_data)
{
    ...
    {if (appl_trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_APPL", "\033[0;" "32" "m" "I" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __FUNCTION__); };};
    if ((p_msg = (tBTA_SDP_API_RECORD_USER *)malloc((sizeof(tBTA_SDP_API_RECORD_USER)))) != 
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
                                                                                             ((void *)0)
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
                                                                                                 ) {
...
# 152 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
tBTA_SDP_STATUS BTA_SdpRemoveRecordByUser(void *user_data)
{
    ...
    {if (appl_trace_level >= 3 && (((2) > (3) ? (2) : (3)) >= 3)) {esp_log_write(ESP_LOG_INFO, "BT_APPL", "\033[0;" "32" "m" "I" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", __FUNCTION__); };};
    if ((p_msg = (tBTA_SDP_API_RECORD_USER *)malloc((sizeof(tBTA_SDP_API_RECORD_USER)))) != 
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c" 3 4
                                                                                             ((void *)0)
# 158 "D:/ESP32/esp-idf-v3.1-rc1/components/bt/bluedroid/bta/sdp/bta_sdp_api.c"
                                                                                                 ) {
