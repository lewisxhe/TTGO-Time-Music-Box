# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 2
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 2
...
options_start(coap_pdu_t *pdu) {
  ...
  if (pdu && pdu->hdr &&
    ...
    return (*opt == 0xFF) ? 
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
                                         ((void *)0) 
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
                                              : opt;

  } else
    return 
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
              ;
}
...
coap_opt_parse(const coap_opt_t *opt, size_t length, coap_option_t *result) {
  ...
  ((opt) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 43, __func__, "opt")); ((result) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 43, __func__, "result"));
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
  if (length < 1)
    return 0;
  ...
  case 15:
    if (*opt != 0xFF) {
      coap_log_impl(LOG_DEBUG, "ignored reserved option delta 15\n");
    }
    return 0;
  case 14:
    ...
    if ((length) < 1) { coap_log_impl(LOG_DEBUG, "cannot advance opt past end\n"); return 0; } else { (length) -= 1; (opt) = ((unsigned char *)(opt)) + 1; };
    result->delta = ((*opt & 0xff) << 8) + 269;
    if (result->delta < 269) {
      coap_log_impl(LOG_DEBUG, "delta too large\n");
      return 0;
    }
  ...
  case 15:
    coap_log_impl(LOG_DEBUG, "found reserved option length 15\n");
    return 0;
  case 14:
  ...
  if (length < result->length) {
    coap_log_impl(LOG_DEBUG, "invalid option length\n");
    return 0;
  }
...
coap_option_iterator_init(coap_pdu_t *pdu, coap_opt_iterator_t *oi,
     const coap_opt_filter_t filter) {
  ((pdu) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 122, __func__, "pdu"));
  ((pdu->hdr) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 123, __func__, "pdu->hdr"));
  ((oi) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 124, __func__, "oi"));
  ...
  if ((unsigned char *)pdu->hdr + pdu->length <= oi->next_option) {
    oi->bad = 1;
    return 
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
              ;
  }

  (((sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 135, __func__, "(sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length"));
...
opt_finished(coap_opt_iterator_t *oi) {
  ((oi) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 148, __func__, "oi"));

  if (oi->bad || oi->length == 0 ||
      !oi->next_option || *oi->next_option == 0xFF) {
    oi->bad = 1;
  }
...
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
                           ((void *)0)
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
                               ;
  size_t optsize;
  int b;

  ((oi) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 165, __func__, "oi"));

  if (opt_finished(oi))
    return 
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
              ;
  ...
  while (1) {
    ...
    if (optsize) {
      ((optsize <= oi->length) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 180, __func__, "optsize <= oi->length"));
      ...
      oi->bad = 1;
      return 
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
                ;
    }
 ...
 (b = coap_option_getb(oi->filter, oi->type)) > 0)
      ...
      oi->bad = 1;
      return 
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
                ;
    }
  }
...
coap_opt_delta(const coap_opt_t *opt) {
  ...
  switch (n) {
  case 15:
    coap_log_impl(LOG_WARNING, "coap_opt_delta: illegal option delta\n");
...
coap_opt_length(const coap_opt_t *opt) {
  ...
  switch (*opt & 0xf0) {
  case 0xf0:
    coap_log_impl(LOG_DEBUG, "illegal option delta\n");
    return 0;
  case 0xe0:
    ++opt;
  ...
  switch (length) {
  case 0x0f:
    coap_log_impl(LOG_DEBUG, "illegal option length\n");
    return 0;
  case 0x0e:
    length = (*opt++ << 8) + 269;
...
coap_opt_setheader(coap_opt_t *opt, size_t maxlen,
  ...
  ((opt) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 333, __func__, "opt"));
  ...
  if (delta < 13) {
    ...
    if (maxlen < 2) {
      coap_log_impl(LOG_DEBUG, "insufficient space to encode option delta %d\n", delta);
      return 0;
    }
  ...
  if (length < 13) {
    ...
    if (maxlen < skip + 2) {
      coap_log_impl(LOG_DEBUG, "insufficient space to encode option length %zu\n", length);
      return 0;
    }
...
coap_opt_encode(coap_opt_t *opt, size_t maxlen, unsigned short delta,
  ...
  ((l <= maxlen) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c", 389, __func__, "l <= maxlen"));

  if (!l) {
    coap_log_impl(LOG_DEBUG, "coap_opt_encode: cannot set option header\n");
    return 0;
  }
  ...
  if (maxlen < length) {
    coap_log_impl(LOG_DEBUG, "coap_opt_encode: option too large for buffer\n");
    return 0;
  }
...
typedef struct {
  ...
  uint16_t long_opts[2];
  uint8_t short_opts[6];
} opt_filter;
...
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/option.c"
static int
