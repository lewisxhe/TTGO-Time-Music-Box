# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 2
...
coap_register_async(coap_context_t *context, coap_address_t *peer,
  ...
  do { for(s=context->async_state;s;s=(s)->next) { if ((s)->id == (id)) break; } } while(0);

  if (s != 
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
              ) {


    coap_log_impl(LOG_DEBUG, "asynchronous state for transaction %d already registered\n", id);
    return 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
              ;
  }
  ...
  if (!s) {
    coap_log_impl(LOG_CRIT, "coap_register_async: insufficient memory\n");
    return 
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
              ;
  }
  ...
  do { (s)->next = context->async_state; context->async_state = s; } while (0);
...
coap_find_async(coap_context_t *context, coap_tid_t id) {
  ...
  do { for(tmp=context->async_state;tmp;tmp=(tmp)->next) { if ((tmp)->id == (id)) break; } } while(0);
  return tmp;
}
...
coap_remove_async(coap_context_t *context, coap_tid_t id,
  ...
  if (tmp)
    do { __typeof(context->async_state) _tmp; if ((context->async_state) == (tmp)) { (context->async_state)=(context->async_state)->next; } else { _tmp = context->async_state; while (_tmp->next && (_tmp->next != (tmp))) { _tmp = _tmp->next; } if (_tmp->next) { _tmp->next = ((tmp)->next); } } } while (0);

  *s = tmp;
  return tmp != 
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c" 3 4
               ((void *)0)
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/async.c"
                   ;
}
