# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/include/coap/pdu.h" 1
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/include/coap/uri.h" 1
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
...
strnchr(unsigned char *s, size_t len, unsigned char c) {
  ...
  return len ? s : 
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 3 4
                  ((void *)0)
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
                      ;
}
...
coap_split_uri(const unsigned char *str_var, size_t len, coap_uri_t *uri) {
  ...
  while (len && *q && ((*p) == (*q) || (((((__ctype_ptr__+sizeof(""[*q]))[(int)(*q)])&(01|02))==02) && ((*p) == ((*q) - 0x20))))) {
    ++p; ++q; --len;
  }
  ...
  if (len && *p == '[') {
    ...
    { (&uri->host)->length = (q - p), (&uri->host)->s = ((unsigned char *)p); };
    ++q; --len;
  } else {
    while (len && *q != ':' && *q != '/' && *q != '?') {
      ++q;
  ...
  if (len && *q == ':') {
    ...
    while (len && (((__ctype_ptr__+sizeof(""[*q]))[(int)(*q)])&04)) {
      ++q;
      --len;
    }
 ...
 path:
  ...
  if (*q == '/') {
    ...
    if (p < q) {
      { (&uri->path)->length = (q - p), (&uri->path)->s = ((unsigned char *)p); };
      p = q;
    }
  }
  ...
  if (len && *p == '?') {
    ++p;
    --len;
    { (&uri->query)->length = (len), (&uri->query)->s = ((unsigned char *)p); };
    len = 0;
  }
...
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
static void
decode_segment(const unsigned char *seg, size_t length, unsigned char *buf) {
  ...
  while (length--) {
    ...
    if (*seg == '%') {
      *buf = (((seg[1]) & 0x40 ? ((seg[1]) & 0x0F) + 9 : ((seg[1]) & 0x0F)) << 4) + ((seg[2]) & 0x40 ? ((seg[2]) & 0x0F) + 9 : ((seg[2]) & 0x0F));
...
check_segment(const unsigned char *s, size_t length) {
  ...
  while (length) {
    if (*s == '%') {
      if (length < 2 || !((((__ctype_ptr__+sizeof(""[s[1]]))[(int)(s[1])])&(0100|04)) && (((__ctype_ptr__+sizeof(""[s[2]]))[(int)(s[2])])&(0100|04))))
 return -1;
...
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
static int
make_decoded_option(const unsigned char *s, size_t length,
  ...
  if (!buflen) {
    coap_log_impl(LOG_DEBUG, "make_decoded_option(): buflen is 0!\n");
    return -1;
  }
  ...
  ((written <= buflen) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c", 283, __func__, "written <= buflen"));
  ...
  if (buflen < (size_t)res) {
    coap_log_impl(LOG_DEBUG, "buffer too small for option\n");
    return -1;
  }
...
# 327 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
static size_t
...
write_option(unsigned char *s, size_t len, void *data) {
  ...
  int res;
  ((state) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c", 365, __func__, "state"));
...
coap_new_uri(const unsigned char *uri, unsigned int length) {
  ...
  if (!result)
    return 
# 420 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 3 4
          ((void *)0)
# 420 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
              ;

  memcpy(((unsigned char *)(result) + sizeof(coap_uri_t)), uri, length);
  ((unsigned char *)(result) + sizeof(coap_uri_t))[length] = '\0';

  if (coap_split_uri(((unsigned char *)(result) + sizeof(coap_uri_t)), length, (coap_uri_t *)result) < 0) {
    coap_free(result);
    return 
# 427 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 3 4
          ((void *)0)
# 427 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
              ;
  }
...
coap_clone_uri(const coap_uri_t *uri) {
  ...
  if ( !uri )
    return 
# 437 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 3 4
           ((void *)0)
# 437 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
               ;
  ...
  if ( !result )
    return 
# 443 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c" 3 4
          ((void *)0)
# 443 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/uri.c"
              ;
  ...
  if ( uri->host.length ) {
    result->host.s = ((unsigned char *)(result) + sizeof(coap_uri_t));
  ...
  if ( uri->path.length ) {
    result->path.s = ((unsigned char *)(result) + sizeof(coap_uri_t)) + uri->host.length;
  ...
  if ( uri->query.length ) {
    result->query.s = ((unsigned char *)(result) + sizeof(coap_uri_t)) + uri->host.length + uri->path.length;
