# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdarg.h" 1 3 4
# 98 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdarg.h" 3 4

# 98 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/ctype.h"
int isalnum (int __c);
int isalpha (int __c);
int iscntrl (int __c);
int isdigit (int __c);
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2


# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/port/arpa/inet.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/include/coap/block.h" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/include/coap/encode.h" 1
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
...
coap_pdu_t *coap_wellknown_response(coap_context_t *context,
                                    coap_pdu_t *request);
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 2
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
static coap_log_t maxlog = LOG_WARNING;

const char *coap_package_name(void) {
  return "libcoap-posix";
}
...
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
...
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
static unsigned int
print_readable( const unsigned char *data, unsigned int len,
  ...
  unsigned int cnt = 0;
  ((data || len == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c", 125, __func__, "data || len == 0"));
  ...
  while (len) {
    if (!encode_always && (((__ctype_ptr__+sizeof(""[*data]))[(int)(*data)])&(020|01|02|04|0200))) {
      if (cnt+1 < buflen) {
      *result++ = *data;
      ++cnt;
      } else {
...
coap_print_addr(const struct coap_address_t *addr, unsigned char *buf, size_t len) {
  ...
  const void *addrptr = 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
                       ((void *)0)
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
                           ;
  in_port_t port;
  unsigned char *p = buf;
  ...
  case 2:
    ...
    port = lwip_ntohs(addr->addr.sin.sin_port);
    break;
  case 10:
    if (len < 7)
      return 0;
    ...
    *p++ = '[';
    ...
    port = lwip_ntohs(addr->addr.sin6.sin6_port);

    break;
  default:
    memcpy(buf, "(unknown address type)", ((22) < (len) ? (22) : (len)));
    return ((22) < (len) ? (22) : (len));
  }

  if ((((addr->addr.sa.sa_family) == 10) ? ip6addr_ntoa_r((const ip6_addr_t*)(addrptr),((char *)p),(len)) : (((addr->addr.sa.sa_family) == 2) ? ip4addr_ntoa_r((const ip4_addr_t*)(addrptr),((char *)p),(len)) : 
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
     ((void *)0)
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
     )) == 0) {
  ...
  return buf + len - p;
# 249 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
}
# 263 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
static const char *
msg_type_string(uint8_t t) {
  static char *types[] = { "CON", "NON", "ACK", "RST", "???" };

  return types[((t) < (sizeof(types)/sizeof(char *) - 1) ? (t) : (sizeof(types)/sizeof(char *) - 1))];
}
...
coap_show_pdu(const coap_pdu_t *pdu) {
  ...
  fprintf(((__getreent())->_stdout), "v:%d t:%s c:%s i:%04x {",
   pdu->hdr->version, msg_type_string(pdu->hdr->type),
   msg_code_string(pdu->hdr->code), lwip_ntohs(pdu->hdr->id));

  for (i = 0; i < pdu->hdr->token_length; i++) {
    fprintf(((__getreent())->_stdout), "%02x", pdu->hdr->token[i]);
  }
  fprintf(((__getreent())->_stdout), "}");


  coap_option_iterator_init((coap_pdu_t *)pdu, &opt_iter, 
# 395 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
                                                         ((void *)0)
# 395 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
                                                                     );
  ...
  while ((option = coap_option_next(&opt_iter))) {
    ...
    case 12:
      content_format = (int)coap_decode_var_bytes(coap_opt_value((coap_opt_t *)option),
    ...
    (coap_opt_length(option) ? (*(coap_opt_length(option) ? (coap_opt_value((coap_opt_t *)option) + (coap_opt_length(option)-1)) : 0) & 0x08) : 0) ? 'M' : '_',
    (1 << ((coap_opt_length(option) ? (*(coap_opt_length(option) ? (coap_opt_value((coap_opt_t *)option) + (coap_opt_length(option)-1)) : 0) & 0x07) : 0) + 4)));
    ...
    coap_decode_var_bytes(coap_opt_value((coap_opt_t *)option),
            coap_opt_length(option)));
      break;
 ...
 encode = 1;
      ...
      buf_len = print_readable(coap_opt_value((coap_opt_t *)option),
          coap_opt_length(option),
          buf, sizeof(buf), encode);
    }

    fprintf(((__getreent())->_stdout), " %s:%.*s", msg_option_string(opt_iter.type),
     (int)buf_len, buf);
  }
  ...
  if (coap_get_data((coap_pdu_t *)pdu, &data_len, &data)) {
    ...
    if (is_binary(content_format)) {
      fprintf(((__getreent())->_stdout), "<<");
      while (data_len--) {
 fprintf(((__getreent())->_stdout), "%02x", *data++);
      }
      fprintf(((__getreent())->_stdout), ">>");
    } else {
      if (print_readable(data, data_len, buf, sizeof(buf), 0)) {
 fprintf(((__getreent())->_stdout), "'%s'", buf);
      }
    }
  }
...
coap_log_impl(coap_log_t level, const char *format, ...) {
  ...
  log_fd = level <= LOG_CRIT ? ((__getreent())->_stderr) : ((__getreent())->_stdout);
...
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
 __builtin_va_start(
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
 ap
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
 ,
# 501 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
...
# 503 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
 __builtin_va_end(
# 503 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
 ap
# 503 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c" 3 4
 )
# 503 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/libcoap/src/debug.c"
