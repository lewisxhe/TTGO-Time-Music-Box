# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/posix/sys/socket.h" 1
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
...
int coap_get_data(coap_pdu_t *pdu,
                  size_t *len,
                  unsigned char **data);
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
...
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
...
void coap_packet_get_memmapped(coap_packet_t *packet,
                               ...
                               size_t *length);
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 2
# 68 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
struct coap_packet_t {
...
# 136 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
...
coap_new_endpoint(const coap_address_t *addr, int flags) {
  int sockfd = socket(addr->addr.sa.sa_family, 2, 0);
  int on = 1;
  struct coap_endpoint_t *ep;

  if (sockfd < 0) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: socket");
    return 
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 154 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
              ;
  }

  if (setsockopt(sockfd, 0xfff, 0x0004, &on, sizeof(on)) < 0)
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: setsockopt SO_REUSEADDR");

  if (bind(sockfd, &addr->addr.sa, addr->size) < 0) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: bind");
    close (sockfd);
    return 
# 163 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 163 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
              ;
  }

  ep = coap_malloc_posix_endpoint();
  if (!ep) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: malloc");
    close(sockfd);
    return 
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 170 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (getsockname(sockfd, &ep->addr.addr.sa, &ep->addr.size) < 0) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: cannot determine local address");
    close (sockfd);
    return 
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (LOG_DEBUG <= coap_get_log_level()) {
    ...
    unsigned char addr_str[46 +8];

    if (coap_print_addr(&ep->addr, addr_str, 46 +8)) {
      coap_log_impl(LOG_DEBUG, "created %sendpoint %s\n", ep->flags & 0x01 ? "DTLS " : "", addr_str)
...
# 220 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
struct in6_pktinfo {
...
# 243 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
ssize_t
coap_network_send(struct coap_context_t *context __attribute__ ((unused)),
    const coap_endpoint_t *local_interface,
    const coap_address_t *dst,
    unsigned char *data,
    size_t datalen) {
...
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
static coap_packet_t *
coap_malloc_packet(void) {
  coap_packet_t *packet;
  const size_t need = sizeof(coap_packet_t) + 1400;
...
# 300 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
static inline size_t
coap_get_max_packetlength(const coap_packet_t *packet __attribute__ ((unused))) {
  return 1400;
}
...
coap_network_read(coap_endpoint_t *ep, coap_packet_t **packet) {
  ...
  char *soc_appdata = 
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
                     ((void *)0)
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
                         ;
  struct sockaddr_in soc_srcipaddr;
  socklen_t soc_srcsize = sizeof(struct sockaddr_in);


  ((ep) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c", 347, __func__, "ep"));
  ((packet) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c", 348, __func__, "packet"));

  *packet = coap_malloc_packet();

  if (!*packet) {
    coap_log_impl(LOG_WARNING, "coap_network_read: insufficient memory, drop packet\n");
    return -1;
  }

  coap_address_init(&(*packet)->dst);
  coap_address_init(&(*packet)->src);


  soc_appdata = coap_malloc(1460);
  if (soc_appdata){
   len = recvfrom(ep->handle.fd, soc_appdata, 1460, 0, (struct sockaddr *)&soc_srcipaddr, (socklen_t *)&soc_srcsize);

   if (len < 0){
    coap_log_impl(LOG_WARNING, "coap_network_read: %s\n", strerror((*__errno())));
    goto error;
   } else {

       (*packet)->dst.size = sizeof((*packet)->dst.addr);
       if (getsockname(ep->handle.fd, &(*packet)->dst.addr.sa, &(*packet)->dst.size) < 0) {
          coap_log_impl(LOG_DEBUG, "cannot determine local port\n");
          goto error;
       }
       ...
       if (len > coap_get_max_packetlength(*packet)) {
          ...
          coap_log_impl(LOG_WARNING, "discarded oversized packet\n");
          goto error;
       }

       if (!is_local_if(&ep->addr, &(*packet)->dst)) {
         coap_log_impl(LOG_DEBUG, "packet received on wrong interface, dropped\n");
        printf("error 3\n");
         goto error;
       }
   ...
   soc_appdata = 
# 398 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
                ((void *)0)
# 398 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
                    ;
  } else {
   goto error;
  }
# 452 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
  (*packet)->interface = ep;
 ...
 error:
  ...
  if (soc_appdata)
   coap_free(soc_appdata);
  soc_appdata = 
# 459 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
               ((void *)0)
# 459 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
                   ;

  coap_free_packet(*packet);
  *packet = 
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c" 3 4
           ((void *)0)
# 462 "D:/ESP32/esp-idf-v3.1-rc1/components/coap/port/coap_io_socket.c"
               ;
  return -1;
}
