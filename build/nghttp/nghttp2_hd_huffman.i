# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\nghttp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.h"
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.h" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.h" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c" 2


# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd.h" 1
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd.h"
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c" 2
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c"
static ssize_t huff_encode_sym(nghttp2_bufs *bufs, size_t *avail_ptr,
  ...
  if (rembits > nbits) {
    do { uint8_t *p = (bufs)->cur->buf.last; *p = (uint8_t)(*p | ((uint8_t)(code << (rembits - nbits)))); } while (0);
    return (ssize_t)(rembits - nbits);
  }

  if (rembits == nbits) {
    do { uint8_t **p = &(bufs)->cur->buf.last; **p = (uint8_t)(**p | ((uint8_t)code)); ++(*p); } while (0);
    --*avail_ptr;
    return 8;
  }

  do { uint8_t **p = &(bufs)->cur->buf.last; **p = (uint8_t)(**p | ((uint8_t)(code >> (nbits - rembits)))); ++(*p); } while (0);
  --*avail_ptr;
  ...
  if (*avail_ptr < (nbits + 7) / 8) {
    ...
    if (nbits == 8) {
      ...
      *avail_ptr = ((size_t)((&(bufs)->cur->buf)->end - (&(bufs)->cur->buf)->last));
      return 8;
    }
  ...
  if (nbits < 8) {
    do { *(bufs)->cur->buf.last = (uint8_t)code; } while (0);
    *avail_ptr = ((size_t)((&(bufs)->cur->buf)->end - (&(bufs)->cur->buf)->last));
    return (ssize_t)(8 - nbits);
  }
  ...
  if (nbits > 24) {
    do { *(bufs)->cur->buf.last++ = (uint8_t)(code >> 24); } while (0);
    nbits -= 8;
  }

  if (nbits > 16) {
    do { *(bufs)->cur->buf.last++ = (uint8_t)(code >> 16); } while (0);
    nbits -= 8;
  }

  if (nbits > 8) {
    do { *(bufs)->cur->buf.last++ = (uint8_t)(code >> 8); } while (0);
    nbits -= 8;
  }
...
int nghttp2_hd_huff_encode(nghttp2_bufs *bufs, const uint8_t *src,
  ...
  avail = ((size_t)((&(bufs)->cur->buf)->end - (&(bufs)->cur->buf)->last));

  for (i = 0; i < srclen; ++i) {
    const nghttp2_huff_sym *sym = &huff_sym_table[src[i]];
    if (rembits == 8) {
      if (avail) {
        do { *(bufs)->cur->buf.last = 0; } while (0);
      } else {
  ...
  if (rembits < 8) {
    ...
    ((avail) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_hd_huffman.c", 184, __func__, "avail"));

    do { uint8_t **p = &(bufs)->cur->buf.last; **p = (uint8_t)(**p | ((uint8_t)(sym->code >> (sym->nbits - (size_t)rembits)))); ++(*p); } while (0)
                                                                     ;
  }
