# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\nghttp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.h"
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.h" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.h" 2
...
int nghttp2_map_each(nghttp2_map *map,
                     int (*func)(nghttp2_map_entry *entry, void *ptr),
                     void *ptr);
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 2
...
int nghttp2_map_init(nghttp2_map *map, nghttp2_mem *mem) {
  ...
  if (map->table == 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ) {
...
void nghttp2_map_each_free(nghttp2_map *map,
  ...
  for (i = 0; i < map->tablelen; ++i) {
    ...
    map->table[i] = 
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ;
  }
}
...
void nghttp2_map_entry_init(nghttp2_map_entry *entry, key_type key) {
  entry->key = key;
  entry->next = 
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
               ((void *)0)
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                   ;
}
...
static int insert(nghttp2_map_entry **table, uint32_t tablelen,
  ...
  if (table[h] == 
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                 ((void *)0)
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                     ) {
    table[h] = entry;
  } else {
    nghttp2_map_entry *p;
...
static int resize(nghttp2_map *map, uint32_t new_tablelen) {
  ...
  if (new_table == 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                  ((void *)0)
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                      ) {
    return NGHTTP2_ERR_NOMEM;
  }
  ...
  for (i = 0; i < map->tablelen; ++i) {
    ...
    for (entry = map->table[i]; entry;) {
      nghttp2_map_entry *next = entry->next;
      entry->next = 
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ;
...
nghttp2_map_entry *nghttp2_map_find(nghttp2_map *map, key_type key) {
  ...
  return 
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
        ((void *)0)
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/nghttp/nghttp2/lib/nghttp2_map.c"
            ;
}
