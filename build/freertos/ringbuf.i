# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
typedef struct {
...
struct Ringbuffer_t {
    size_t xSize;
    UBaseType_t uxRingbufferFlags;
    size_t xMaxItemSize;

    CheckItemFitsFunction_t xCheckItemFits;
    CopyItemFunction_t vCopyItem;
    GetItemFunction_t pvGetItem;
    ReturnItemFunction_t vReturnItem;
    GetCurMaxSizeFunction_t xGetCurMaxSize;
    ...
    BaseType_t xItemsWaiting;
    SemaphoreHandle_t xFreeSpaceSemaphore;
    SemaphoreHandle_t xItemsBufferedSemaphore;
    portMUX_TYPE mux;
};
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
...
{
    size_t xReturn;
    if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 )) {
        xReturn = 0;
    } else {
    ...
    if (!(xReturn <= pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 156, __FUNCTION__); abort(); };
    return xReturn;
}
...
static BaseType_t prvCheckItemFitsDefault( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 163, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 164, __FUNCTION__); abort(); };

    size_t xTotalItemSize = ( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) ) + sizeof(ItemHeader_t);
    if (pxRingbuffer->pucWrite == pxRingbuffer->pucFree) {

        return (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 )) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 );
    }
    if (pxRingbuffer->pucFree > pxRingbuffer->pucWrite) {

        return (xTotalItemSize <= pxRingbuffer->pucFree - pxRingbuffer->pucWrite) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    }
    ...
    if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) {

        return (xTotalItemSize + sizeof(ItemHeader_t) <= pxRingbuffer->xSize - (pxRingbuffer->pucWrite - pxRingbuffer->pucFree)) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    } else {
        return (xTotalItemSize <= pxRingbuffer->pucFree - pxRingbuffer->pucHead) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    }
}
...
static BaseType_t prvCheckItemFitsByteBuffer( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 191, __FUNCTION__); abort(); };
    ...
    if (pxRingbuffer->pucFree > pxRingbuffer->pucWrite) {
        ...
        return (xItemSize <= pxRingbuffer->pucFree - pxRingbuffer->pucWrite) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    }

    return (xItemSize <= pxRingbuffer->xSize - (pxRingbuffer->pucWrite - pxRingbuffer->pucFree)) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
}

static void prvCopyItemNoSplit(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{

    size_t xAlignedItemSize = ( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) );
    size_t xRemLen = pxRingbuffer->pucTail - pxRingbuffer->pucWrite;
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 210, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 211, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 212, __FUNCTION__); abort(); };


    if (xRemLen < xAlignedItemSize + sizeof(ItemHeader_t)) {
        ItemHeader_t *pxDummy = (ItemHeader_t *)pxRingbuffer->pucWrite;
        pxDummy->uxItemFlags = ( ( UBaseType_t ) 2 );
        pxDummy->xItemLen = 0;
    ...
    pxRingbuffer->pucWrite += sizeof(ItemHeader_t);
    memcpy(pxRingbuffer->pucWrite, pucItem, xItemSize);
    pxRingbuffer->xItemsWaiting++;
    pxRingbuffer->pucWrite += xAlignedItemSize;


    if (pxRingbuffer->pucTail - pxRingbuffer->pucWrite < sizeof(ItemHeader_t)) {
        pxRingbuffer->pucWrite = pxRingbuffer->pucHead;
    }

    if (pxRingbuffer->pucWrite == pxRingbuffer->pucFree) {

        pxRingbuffer->uxRingbufferFlags |= ( ( UBaseType_t ) 4 );
    }
}
...
static void prvCopyItemAllowSplit(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    size_t xAlignedItemSize = ( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) );
    size_t xRemLen = pxRingbuffer->pucTail - pxRingbuffer->pucWrite;
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 247, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 248, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 249, __FUNCTION__); abort(); };
    ...
    if (xRemLen < xAlignedItemSize + sizeof(ItemHeader_t)) {
        ...
        pxFirstHeader->xItemLen = xRemLen - sizeof(ItemHeader_t);
        pxRingbuffer->pucWrite += sizeof(ItemHeader_t);
        xRemLen -= sizeof(ItemHeader_t);
        if (xRemLen > 0) {
            ...
            pxFirstHeader->uxItemFlags |= ( ( UBaseType_t ) 4 );
        } else {

            pxFirstHeader->uxItemFlags |= ( ( UBaseType_t ) 2 );
        }
        pxRingbuffer->pucWrite = pxRingbuffer->pucHead;
    }
...
static void prvCopyItemByteBuf(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 297, __FUNCTION__); abort(); };
...
static BaseType_t prvCheckItemAvail(Ringbuffer_t *pxRingbuffer)
{
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && pxRingbuffer->pucRead != pxRingbuffer->pucFree) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 )))) {
        return ( ( BaseType_t ) 1 );
    } else {
        return ( ( BaseType_t ) 0 );
    }
...
static void *prvGetItemDefault(Ringbuffer_t *pxRingbuffer, BaseType_t *pxIsSplit, size_t xUnusedParam, size_t *pxItemSize)
{
    ...
    if (!(pxIsSplit != 
# 340 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 340 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 340, __FUNCTION__); abort(); };
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 341, __FUNCTION__); abort(); };
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucRead & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 342, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 343, __FUNCTION__); abort(); };
    if (!((pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize) || (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 344, __FUNCTION__); abort(); };

    uint8_t *pcReturn;

    if (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
        pxRingbuffer->pucRead = pxRingbuffer->pucHead;

        pxHeader = (ItemHeader_t *)pxRingbuffer->pucRead;
        if (!(pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 352, __FUNCTION__); abort(); };
    }
    pcReturn = pxRingbuffer->pucRead + sizeof(ItemHeader_t);
    if (pxHeader->xItemLen == 0) {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 357, __FUNCTION__); abort(); };
    } else {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 360, __FUNCTION__); abort(); };
    }
    *pxItemSize = pxHeader->xItemLen;
    pxRingbuffer->xItemsWaiting --;
    *pxIsSplit = (pxHeader->uxItemFlags & ( ( UBaseType_t ) 4 )) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );

    pxRingbuffer->pucRead += sizeof(ItemHeader_t) + ( ( pxHeader->xItemLen + ( 0x0003 ) ) & ~( 0x0003 ) );

    if ((pxRingbuffer->pucTail - pxRingbuffer->pucRead) < sizeof(ItemHeader_t)) {
        pxRingbuffer->pucRead = pxRingbuffer->pucHead;
    }
...
static void *prvGetItemByteBuf(Ringbuffer_t *pxRingbuffer, BaseType_t *pxUnusedParam ,size_t xMaxSize, size_t *pxItemSize)
{
    ...
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 377, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 378, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead == pxRingbuffer->pucFree)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 379, __FUNCTION__); abort(); };

    uint8_t *ret = pxRingbuffer->pucRead;
    if ((pxRingbuffer->pucRead > pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))) {
...
static void prvReturnItemDefault(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!(( ( ( UBaseType_t ) pucItem & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 415, __FUNCTION__); abort(); };
    if (!(pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 416, __FUNCTION__); abort(); };
    if (!(pucItem <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 417, __FUNCTION__); abort(); };


    ItemHeader_t *pxCurHeader = (ItemHeader_t *)(pucItem - sizeof(ItemHeader_t));
    if (!(pxCurHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 421, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 422, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 1 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 423, __FUNCTION__); abort(); };
    pxCurHeader->uxItemFlags &= ~( ( UBaseType_t ) 4 );
    pxCurHeader->uxItemFlags |= ( ( UBaseType_t ) 1 );
    ...
    while (((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 1 )) || (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 ))) && pxRingbuffer->pucFree != pxRingbuffer->pucRead) {
        if (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
            pxCurHeader->uxItemFlags |= ( ( UBaseType_t ) 1 );
            pxRingbuffer->pucFree = pxRingbuffer->pucHead;
        } else {

            size_t xAlignedItemSize = ( ( pxCurHeader->xItemLen + ( 0x0003 ) ) & ~( 0x0003 ) );
            pxRingbuffer->pucFree += xAlignedItemSize + sizeof(ItemHeader_t);

            if (!(pxRingbuffer->pucFree <= pxRingbuffer->pucHead + pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 444, __FUNCTION__); abort(); };
        }

        if ((pxRingbuffer->pucTail - pxRingbuffer->pucFree) < sizeof(ItemHeader_t)) {
            pxRingbuffer->pucFree = pxRingbuffer->pucHead;
        }
        pxCurHeader = (ItemHeader_t *)pxRingbuffer->pucFree;
    }
...
static void prvReturnItemByteBuf(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!((uint8_t *)pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 467, __FUNCTION__); abort(); };
    if (!((uint8_t *)pucItem < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 468, __FUNCTION__); abort(); };
...
static BaseType_t prvReceiveGeneric(Ringbuffer_t *pxRingbuffer, void **pvItem1, void **pvItem2, size_t *xItemSize1, size_t *xItemSize2, size_t xMaxSize, TickType_t xTicksToWait)
{
    ...
    BaseType_t xReturnSemaphore = ( ( BaseType_t ) 0 );
    ...
    while (xTicksRemaining <= xTicksToWait) {
        ...
        if (xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 563 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
           ((void *)0)
# 563 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
           , ( xTicksRemaining ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            xReturn = ( ( BaseType_t ) 0 );
            break;
        }


        vTaskEnterCritical(&pxRingbuffer->mux);
        if (prvCheckItemAvail(pxRingbuffer) == ( ( BaseType_t ) 1 )) {

            BaseType_t xIsSplit;
            if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) {

                *pvItem1 = pxRingbuffer->pvGetItem(pxRingbuffer, 
# 575 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                ((void *)0)
# 575 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                    , xMaxSize, xItemSize1);
            } else {
            ...
            if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) && (pvItem2 != 
# 581 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                                     ((void *)0)
# 581 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                         ) && (xItemSize2 != 
# 581 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                                                             ((void *)0)
# 581 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                                                 )) {
                if (xIsSplit == ( ( BaseType_t ) 1 )) {
                    *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                    if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 584, __FUNCTION__); abort(); };
                    if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 585, __FUNCTION__); abort(); };
                } else {
                    *pvItem2 = 
# 587 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                              ((void *)0)
# 587 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                  ;
                }
            }
            xReturn = ( ( BaseType_t ) 1 );
            if (pxRingbuffer->xItemsWaiting > 0) {
                xReturnSemaphore = ( ( BaseType_t ) 1 );
            }
            vTaskExitCritical(&pxRingbuffer->mux);
            break;
        }
    ...
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 609 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 609 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
...
static BaseType_t prvReceiveGenericFromISR(Ringbuffer_t *pxRingbuffer, void **pvItem1, void **pvItem2, size_t *xItemSize1, size_t *xItemSize2, size_t xMaxSize)
{
    ...
    if(prvCheckItemAvail(pxRingbuffer) == ( ( BaseType_t ) 1 )) {
        ...
        if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) {
            ...
            *pvItem1 = pxRingbuffer->pvGetItem(pxRingbuffer, 
# 624 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                            ((void *)0)
# 624 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                , xMaxSize, xItemSize1);
        } else {
        ...
        if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) && pvItem2 != 
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                                ((void *)0) 
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                     && xItemSize2 != 
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                                                      ((void *)0)
# 630 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
            ...
            if (xIsSplit == ( ( BaseType_t ) 1 )) {
                *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 633, __FUNCTION__); abort(); };
                if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 634, __FUNCTION__); abort(); };
            } else {
                *pvItem2 = 
# 636 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                          ((void *)0)
# 636 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                              ;
            }
        }
        xReturn = ( ( BaseType_t ) 1 );
    ...
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGiveFromISR( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), ( 
# 647 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0) 
# 647 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       ) );
    }
    return xReturn;
}
...
RingbufHandle_t xRingbufferCreate(size_t xBufferSize, ringbuf_type_t xBufferType)
{
    ...
    if (pxRingbuffer == 
# 658 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                       ((void *)0)
# 658 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                           ) {
        goto err;
    }
    if (xBufferType != RINGBUF_TYPE_BYTEBUF) {
        xBufferSize = ( ( xBufferSize + ( 0x0003 ) ) & ~( 0x0003 ) );
    }
    pxRingbuffer->pucHead = malloc(xBufferSize);
    if (pxRingbuffer->pucHead == 
# 665 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                ((void *)0)
# 665 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                    ) {
        goto err;
    }
    ...
    pxRingbuffer->xFreeSpaceSemaphore = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    pxRingbuffer->xItemsBufferedSemaphore = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    ...
    if (xBufferType == RINGBUF_TYPE_NOSPLIT) {
        ...
        pxRingbuffer->xMaxItemSize = ( ( pxRingbuffer->xSize / 2 + ( 0x0003 ) ) & ~( 0x0003 ) ) - sizeof(ItemHeader_t);
        pxRingbuffer->xGetCurMaxSize = prvGetCurMaxSizeNoSplit;
    } else if (xBufferType == RINGBUF_TYPE_ALLOWSPLIT) {
        pxRingbuffer->uxRingbufferFlags |= ( ( UBaseType_t ) 1 );
        pxRingbuffer->xCheckItemFits = prvCheckItemFitsDefault;
        ...
        pxRingbuffer->uxRingbufferFlags |= ( ( UBaseType_t ) 2 );
        ...
        if (!(0)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 713, __FUNCTION__); abort(); };
    }

    if (pxRingbuffer->xFreeSpaceSemaphore == 
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                            ((void *)0) 
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                 || pxRingbuffer->xItemsBufferedSemaphore == 
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                                             ((void *)0)
# 716 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                                 ) {
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 719 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 719 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
err:
    ...
    if (pxRingbuffer) {
        ...
        if (pxRingbuffer->xFreeSpaceSemaphore) {
            vQueueDelete( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ) );
        }
        if (pxRingbuffer->xItemsBufferedSemaphore) {
            vQueueDelete( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ) );
        }
    }
    free(pxRingbuffer);
    return 
# 736 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
          ((void *)0)
# 736 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
              ;
}

RingbufHandle_t xRingbufferCreateNoSplit(size_t xItemSize, size_t xItemNum)
{
    return xRingbufferCreate((( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) ) + sizeof(ItemHeader_t)) * xItemNum, RINGBUF_TYPE_NOSPLIT);
}
...
BaseType_t xRingbufferSend(RingbufHandle_t xRingbuffer, const void *pvItem, size_t xItemSize, TickType_t xTicksToWait)
{
    ...
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 748, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 749 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0) 
# 749 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 749, __FUNCTION__); abort(); };
    if (xItemSize > pxRingbuffer->xMaxItemSize) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && xItemSize == 0) {
        return ( ( BaseType_t ) 1 );
    }
    ...
    while (xTicksRemaining <= xTicksToWait) {
        ...
        if (xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 764 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
           ((void *)0)
# 764 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
           , ( xTicksRemaining ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            xReturn = ( ( BaseType_t ) 0 );
            break;
        }
        ...
        vTaskEnterCritical(&pxRingbuffer->mux);
        if(pxRingbuffer->xCheckItemFits(pxRingbuffer, xItemSize) == ( ( BaseType_t ) 1 )) {
    ...
    if (xReturn == ( ( BaseType_t ) 1 )) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 794 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 794 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 797 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 797 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    return xReturn;
}
...
BaseType_t xRingbufferSendFromISR(RingbufHandle_t xRingbuffer, const void *pvItem, size_t xItemSize, BaseType_t *pxHigherPriorityTaskWoken)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 806, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 807 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0) 
# 807 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 807, __FUNCTION__); abort(); };
    if (xItemSize > pxRingbuffer->xMaxItemSize) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && xItemSize == 0) {
    ...
    BaseType_t xReturnSemaphore = ( ( BaseType_t ) 0 );
    vTaskEnterCritical(&pxRingbuffer->mux);
    if (pxRingbuffer->xCheckItemFits(xRingbuffer, xItemSize) == ( ( BaseType_t ) 1 )) {
    ...
    if (xReturn == ( ( BaseType_t ) 1 )) {
        ...
        xQueueGiveFromISR( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), ( pxHigherPriorityTaskWoken ) );
    }
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGiveFromISR( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), ( pxHigherPriorityTaskWoken ) );
    }
    return xReturn;
}
...
void *xRingbufferReceive(RingbufHandle_t xRingbuffer, size_t *pxItemSize, TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 845, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                    ((void *)0)
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                        , &xTempSize, 
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                      ((void *)0)
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                          , 0, xTicksToWait) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 851 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                         ((void *)0)
# 851 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                             ) {
        ...
        return 
# 856 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 856 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 864, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                           ((void *)0)
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                               , &xTempSize, 
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                             ((void *)0)
# 869 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                 , 0) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 870 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                         ((void *)0)
# 870 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 875 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 875 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
}
...
BaseType_t xRingbufferReceiveSplit(RingbufHandle_t xRingbuffer, void **ppvHeadItem, void **ppvTailItem, size_t *pxHeadItemSize, size_t *pxTailItemSize, TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 883, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 884, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 885 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0) 
# 885 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   && ppvTailItem != 
# 885 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 885 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 885, __FUNCTION__); abort(); };


    void *pvTempHeadItem, *pvTempTailItem;
    size_t xTempHeadSize, xTempTailSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0, xTicksToWait) == ( ( BaseType_t ) 1 )) {

        *ppvHeadItem = pvTempHeadItem;
        if(pxHeadItemSize != 
# 893 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                            ((void *)0)
# 893 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                ){
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                             ((void *)0)
# 897 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 899 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                 ((void *)0)
# 899 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 903 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                          ((void *)0)
# 903 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        ...
        *ppvHeadItem = 
# 908 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                      ((void *)0)
# 908 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                          ;
        *ppvTailItem = 
# 909 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                      ((void *)0)
# 909 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
...
BaseType_t xRingbufferReceiveSplitFromISR(RingbufHandle_t xRingbuffer, void **ppvHeadItem, void **ppvTailItem, size_t *pxHeadItemSize, size_t *pxTailItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 918, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 919, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0) 
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   && ppvTailItem != 
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 920 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 920, __FUNCTION__); abort(); };


    void *pvTempHeadItem, *pvTempTailItem;
    size_t xTempHeadSize, xTempTailSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0) == ( ( BaseType_t ) 1 )) {

        *ppvHeadItem = pvTempHeadItem;
        if (pxHeadItemSize != 
# 928 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                             ((void *)0)
# 928 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                 ) {
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 932 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                             ((void *)0)
# 932 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 934 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                 ((void *)0)
# 934 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 938 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                          ((void *)0)
# 938 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        *ppvHeadItem = 
# 942 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                      ((void *)0)
# 942 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                          ;
        *ppvTailItem = 
# 943 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                      ((void *)0)
# 943 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
...
void *xRingbufferReceiveUpTo(RingbufHandle_t xRingbuffer, size_t *pxItemSize, TickType_t xTicksToWait, size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 952, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 953, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 955 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 955 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 961 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                    ((void *)0)
# 961 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                        , &xTempSize, 
# 961 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                      ((void *)0)
# 961 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                          , xMaxSize, xTicksToWait) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 962 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                         ((void *)0)
# 962 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 967 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 967 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveUpToFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize, size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 975, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 976, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 978 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 978 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 984 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                           ((void *)0)
# 984 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                               , &xTempSize, 
# 984 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                                                                             ((void *)0)
# 984 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                                                                                 , xMaxSize) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 985 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                         ((void *)0)
# 985 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 990 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 990 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                  ;
    }
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 997, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 998 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 998 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 998, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    pxRingbuffer->vReturnItem(pxRingbuffer, (uint8_t *)pvItem);
    vTaskExitCritical(&pxRingbuffer->mux);
    xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1003 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 1003 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1009, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1010 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 1010 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1010, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1021, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1038, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1045, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1057, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1062 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                               ((void *)0)
# 1062 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueAddToSet(pxRingbuffer->xItemsBufferedSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1066 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 1066 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1066, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
BaseType_t xRingbufferCanRead(RingbufHandle_t xRingbuffer, QueueSetMemberHandle_t xMember)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1076, __FUNCTION__); abort(); };
    return (pxRingbuffer->xItemsBufferedSemaphore == xMember) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
}

BaseType_t xRingbufferRemoveFromQueueSetRead(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1083, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1088 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                               ((void *)0)
# 1088 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueRemoveFromSet(pxRingbuffer->xItemsBufferedSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1092 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 1092 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1092, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1101, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    if (uxFree != 
# 1104 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                 ((void *)0)
# 1104 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                     ) {
        *uxFree = (UBaseType_t)(pxRingbuffer->pucFree - pxRingbuffer->pucHead);
    }
    if (uxRead != 
# 1107 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                 ((void *)0)
# 1107 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                     ) {
        *uxRead = (UBaseType_t)(pxRingbuffer->pucRead - pxRingbuffer->pucHead);
    }
    if (uxWrite != 
# 1110 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                  ((void *)0)
# 1110 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                      ) {
        *uxWrite = (UBaseType_t)(pxRingbuffer->pucWrite - pxRingbuffer->pucHead);
    }
    if (uxItemsWaiting != 
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                         ((void *)0)
# 1113 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                             ) {
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1122, __FUNCTION__); abort(); };
...
# 1133 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
_Bool 
# 1133 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
    xRingbufferIsNextItemWrapped(RingbufHandle_t xRingbuffer)
{

    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1137, __FUNCTION__); abort(); };
    
# 1138 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
   _Bool 
# 1138 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
        is_wrapped;

    vTaskEnterCritical(&pxRingbuffer->mux);
    ItemHeader_t *xHeader = (ItemHeader_t *)pxRingbuffer->pucRead;
    is_wrapped = xHeader->uxItemFlags & ( ( UBaseType_t ) 4 );
    vTaskExitCritical(&pxRingbuffer->mux);
    return is_wrapped;
}
...
BaseType_t xRingbufferAddToQueueSetWrite(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1151, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1156 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                               ((void *)0)
# 1156 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueAddToSet(pxRingbuffer->xFreeSpaceSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1160 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 1160 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1160, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
BaseType_t xRingbufferRemoveFromQueueSetWrite(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1170, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1175 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
                               ((void *)0)
# 1175 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueRemoveFromSet(pxRingbuffer->xFreeSpaceSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1179 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c" 3 4
       ((void *)0)
# 1179 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/ringbuf.c", 1179, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
