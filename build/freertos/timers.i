# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
...
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
...
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
...
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
...
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
...
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/portmacro.h" 1
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 2
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
...
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                  ((void *)0)
# 174 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                      ;


 portMUX_TYPE xTimerMux = { .owner = 0xB33FFFFF, .count = 0, };
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
...
# 270 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
 prvCheckForValidListAndQueue();

 if( xTimerQueue != 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                        )
 {
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
  {

   xReturn = xTaskCreatePinnedToCore( prvTimerTask, "Tmr Svc", ( uint16_t ) 2048, 
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                                                                         ((void *)0)
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                                                                             , ( ( UBaseType_t ) 1 ) | ( ( UBaseType_t ) 0x00 ), 
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                                                                                                                                                  ((void *)0)
# 286 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                                                                                                                                                      , 0 );
 ...
 if (!(xReturn)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 295, __FUNCTION__); abort(); };
 return xReturn;
}
 ...
 Timer_t *pxNewTimer;
  ...
  pxNewTimer = ( Timer_t * ) malloc( sizeof( Timer_t ) );

  if( pxNewTimer != 
# 312 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 312 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                        )
  {
   prvInitialiseNewTimer( pcTimerName, xTimerPeriodInTicks, uxAutoReload, pvTimerID, pxCallbackFunction, pxNewTimer );
# 324 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
  }

  return pxNewTimer;
 }
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
static void prvInitialiseNewTimer( const char * const pcTimerName,
         const TickType_t xTimerPeriodInTicks,
         const UBaseType_t uxAutoReload,
         void * const pvTimerID,
         ...
         Timer_t *pxNewTimer )
{
 ...
 if (!(( xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 384, __FUNCTION__); abort(); };

 if( pxNewTimer != 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                  ((void *)0) 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                       )
 {
...
DaemonTaskMessage_t xMessage;
 ...
 if( xTimerQueue != 
# 412 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 412 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                        )
 {
...
# 459 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
TickType_t xTimerGetPeriod( TimerHandle_t xTimer )
{
Timer_t *pxTimer = ( Timer_t * ) xTimer;

    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 463, __FUNCTION__); abort(); };
...
TickType_t xReturn;
    ...
    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 473, __FUNCTION__); abort(); };
...
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                                                         ((void *)0)
# 508 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                                                             , ( TickType_t ) 0U );
   if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 509, __FUNCTION__); abort(); };
   ( void ) xResult;
  }
  else
  {
...
{
TickType_t xNextExpireTime;
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
 ...
 while( xQueueGenericReceive( ( xTimerQueue ), ( &xMessage ), ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 0 ) ) )
 {

  {
   ...
   if( xMessage.xMessageID < ( BaseType_t ) 0 )
   {
    ...
    if (!(pxCallback)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 713, __FUNCTION__); abort(); };
  ...
  if( xMessage.xMessageID >= ( BaseType_t ) 0 )
  {
   ...
   if( ( ( BaseType_t ) ( ( &( pxTimer->xTimerListItem ) )->pvContainer == ( void * ) ( 
# 733 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
      ((void *)0) 
# 733 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
      ) ) ) == ( ( BaseType_t ) 0 ) )
   {
...
# 770 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                                                                                                                      ((void *)0)
# 770 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                                                                                                                          , ( TickType_t ) 0U );
       if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 771, __FUNCTION__); abort(); };
       ( void ) xResult;
      }
      else
      {
    ...
    case ( ( BaseType_t ) 9 ) :
     ...
     if (!(( pxTimer->xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 794, __FUNCTION__); abort(); };
...
# 830 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
     break;
...
BaseType_t xResult;
 ...
 while( ( ( BaseType_t ) ( ( pxCurrentTimerList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
 {
  ...
  if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
  {
   ...
   {
    xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, 
# 883 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                                                                          ((void *)0)
# 883 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                                                                              , ( TickType_t ) 0U );
    if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 884, __FUNCTION__); abort(); };
    ( void ) xResult;
   }
  }
  else
...
static void prvCheckForValidListAndQueue( void )
{
# 910 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
 if( xTimerQueue == 
# 910 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 910 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                        ) vPortCPUInitializeMutex( &xTimerMux );

 vTaskEnterCritical(&xTimerMux);
 {
  if( xTimerQueue == 
# 914 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                    ((void *)0) 
# 914 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                         )
  {
   ...
   if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 921, __FUNCTION__); abort(); };
# 935 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
  }
  else
  {
   ;
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 vTaskEnterCritical(&xTimerMux);
 {
  ...
  xTimerIsInActiveList = ( BaseType_t ) !( ( ( BaseType_t ) ( ( &( pxTimer->xTimerListItem ) )->pvContainer == ( void * ) ( 
# 956 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c" 3 4
                                          ((void *)0) 
# 956 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c"
                                          ) ) ) );
 }
 vTaskExitCritical(&xTimerMux);
...
Timer_t * const pxTimer = ( Timer_t * ) xTimer;
    ...
    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 976, __FUNCTION__); abort(); };
 ...
 BaseType_t xReturn;
  ...
  if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/timers.c", 1020, __FUNCTION__); abort(); };
