# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\xtensa-debug-module//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/include/xtensa-debug-module.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/trax.c" 2
...
int trax_enable(trax_ena_select_t which)
{
    ...
    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Trax_enable called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Trax_enable called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Trax_enable called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Trax_enable called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Trax_enable called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    return 0x101;


    if (which == TRAX_ENA_PRO_APP || which == TRAX_ENA_PRO_APP_SWAP) return 0x101;

    if (which == TRAX_ENA_PRO_APP || which == TRAX_ENA_PRO_APP_SWAP) {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x070))))) = (uint32_t)(((which == TRAX_ENA_PRO_APP_SWAP)?3:0));
    } else {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x070))))) = (uint32_t)((1));
    }
    (*((volatile uint32_t *)(((0x3ff00000 + 0x074))))) = (uint32_t)(((which == TRAX_ENA_PRO_APP || which == TRAX_ENA_PRO_APP_SWAP || which == TRAX_ENA_PRO)));
    (*((volatile uint32_t *)(((0x3ff00000 + 0x078))))) = (uint32_t)(((which == TRAX_ENA_PRO_APP || which == TRAX_ENA_PRO_APP_SWAP || which == TRAX_ENA_APP)));
    return 0;
}
...
int trax_start_trace(trax_downcount_unit_t units_until_stop)
{
    ...
    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Trax_start_trace called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Trax_start_trace called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Trax_start_trace called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Trax_start_trace called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Trax_start_trace called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    return 0x101;

    uint32_t v;
    if (eri_read(((0x100000 +0)+0x08))&(1<<0)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Stopping active trace first." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Stopping active trace first." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Stopping active trace first." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Stopping active trace first." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Stopping active trace first." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);

        eri_write(((0x100000 +0)+0x1C), 0);
        eri_write(((0x100000 +0)+0x04), eri_read(((0x100000 +0)+0x04))|(1<<1));

        eri_write(((0x100000 +0)+0x04), 0);
    }
    eri_write(((0x100000 +0)+0x18), 31);
    v=(1<<0) | (1<<7) | (1<<17) | (1<<12);
    if (units_until_stop == TRAX_DOWNCOUNT_INSTRUCTIONS) v|=(1<<9);

    eri_write(((0x100000 +0)+0x04), v);
    return 0;
}
...
int trax_trigger_traceend_after_delay(int delay)
{
    ...
    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Trax_trigger_traceend_after_delay called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Trax_trigger_traceend_after_delay called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Trax_trigger_traceend_after_delay called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Trax_trigger_traceend_after_delay called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Trax_trigger_traceend_after_delay called, but trax is disabled in menuconfig!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    return 0x101;

    eri_write(((0x100000 +0)+0x1C), delay);
    eri_write(((0x100000 +0)+0x04), eri_read(((0x100000 +0)+0x04))|(1<<1));
    return 0;
}
