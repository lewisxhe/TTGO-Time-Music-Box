# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\ulp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/sens_reg.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 2
...
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
        ...
        reloc_info_t label_info, reloc_info_t branch_info)
{
    ...
    ((insn->b.opcode == 8 && "branch macro was applied to a non-branch instruction") ? (void)0 : __assert_func (
                                                                     "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
    ,
                                                                     108
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
    ...
    switch (insn->b.sub_opcode) {
        case 1: {
            ...
            if (abs_offset > 127) {
                do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); } } while(0); } while(0)
                                                          ;
                return (0x1200 + 5);
            }
        ...
        case 0: {
            ((insn->bx.reg == 0 && "relocation applied to a jump with offset in register") ? (void)0 : __assert_func (
                                                                          "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
            ,
                                                                          125
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
        ...
        default:
            ((
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 3 4
           0 
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
           && "unexpected sub-opcode") ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c", 130, __func__, "false && \"unexpected sub-opcode\""));
    }
    return 0;
}
...
esp_err_t ulp_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize)
{
    ...
    while (read_ptr < end) {
        ...
        if (r_insn.macro.opcode == 15) {
            ++macro_count;
        }
        ++read_ptr;
    }
    size_t real_program_size = *psize - macro_count;
    const size_t ulp_mem_end = 0 / sizeof(ulp_insn_t);
    if (load_addr > ulp_mem_end) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); } } while(0); } while(0)
                                       ;
        return (0x1200 + 2);
    }
    if (real_program_size + load_addr > ulp_mem_end) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); } } while(0); } while(0)
                                               ;
        return (0x1200 + 1);
    }

    if (macro_count == 0) {
        memcpy(((ulp_insn_t*) ((uint32_t*) 0x50000000)) + load_addr, program, *psize * sizeof(ulp_insn_t));
        return 0;
    }
    reloc_info_t* reloc_info =
            (reloc_info_t*) malloc(sizeof(reloc_info_t) * macro_count);
    if (reloc_info == 
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c" 3 4
                     ((void *)0)
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c"
                         ) {
        return 0x101;
    }
    ...
    read_ptr = program;
    ulp_insn_t* output_program = ((ulp_insn_t*) ((uint32_t*) 0x50000000)) + load_addr;
    ...
    while (read_ptr < end) {
        ...
        if (r_insn.macro.opcode == 15) {
            switch(r_insn.macro.sub_opcode) {
                case 0:
                    *cur_reloc = (reloc_info_t) { .label = r_insn.macro.label, .addr = cur_insn_addr, .unused = 0, .type = 0 }
                                          ;
                    break;
                case 1:
                    *cur_reloc = (reloc_info_t) { .label = r_insn.macro.label, .addr = cur_insn_addr, .unused = 0, .type = 1 }
                                          ;
                    break;
                default:
                    ((0 && "invalid sub_opcode for macro insn") ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c", 191, __func__, "0 && \"invalid sub_opcode for macro insn\""));
            }
            ++read_ptr;
            ((read_ptr != end && "program can not end with macro insn") ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c", 194, __func__, "read_ptr != end && \"program can not end with macro insn\""));
            ++cur_reloc;
        } else {
    ...
    while(cur_reloc < reloc_end) {
        ...
        ((label_info.type == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/ulp/ulp_macro.c", 232, __func__, "label_info.type == RELOC_TYPE_LABEL"));
        ++cur_reloc;
        while (cur_reloc < reloc_end) {
            if (cur_reloc->type == 0) {
                if(cur_reloc->label == label_info.label) {
                    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); } } while(0); } while(0)
                                             ;
                    free(reloc_info);
                    return (0x1200 + 3);
                }
            ...
            if (cur_reloc->label != label_info.label) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); } } while(0); } while(0)
                                         ;
                free(reloc_info);
                return (0x1200 + 4);
            }
