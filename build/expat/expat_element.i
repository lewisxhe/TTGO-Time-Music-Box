# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c"
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 2
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 2
...
startElement(void *userData, const char *name, const char **atts)
{
  ...
  for (i = 0; i < *depthPtr; i++)
    (--(((__getreent())->_stdout))->_w < 0 ? (((__getreent())->_stdout))->_w >= (((__getreent())->_stdout))->_lbfsize ? (*(((__getreent())->_stdout))->_p = ('\t')), *(((__getreent())->_stdout))->_p != '\n' ? (int)*(((__getreent())->_stdout))->_p++ : __swbuf_r((__getreent()), '\n', ((__getreent())->_stdout)) : __swbuf_r((__getreent()), (int)('\t'), ((__getreent())->_stdout)) : (*(((__getreent())->_stdout))->_p = ('\t'), (int)*(((__getreent())->_stdout))->_p++));
  puts(name);
  *depthPtr += 1;
}
...
{
  char *buf = 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 3 4
             ((void *)0)
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c"
                 ;
  int depth = 0;
  if (argv == 
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 3 4
             ((void *)0)
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c"
                 ){
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c" 3 4
                                      ((void *)0)
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/expat/port/expat_element.c"
                                          );
  if (parser){
