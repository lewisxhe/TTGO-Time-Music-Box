# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 2
...
static void rtc_brownout_isr_handler()
{
    ...
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x48))) >= 0x3ff00000) && (((0x3ff48000 + 0x48))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x48))) >= 0x3ff00000) && (((0x3ff48000 + 0x48))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0x48))) >= 0x3ff00000) && (((0x3ff48000 + 0x48))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c", 40, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0x48))) >= 0x3ff00000) && (((0x3ff48000 + 0x48))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x48))) = (((1UL << (7)))); });
...
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC))) ? (void)0 : __assert_func (




 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
    ,
 ...
 56
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
    , __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0xd4))) = (((1UL << (30))) | ((1UL << (15))) | (2 << 16) | (0 << 27)); })
    ...
    do { esp_err_t __err_rc = (rtc_isr_register(rtc_brownout_isr_handler, 
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c" 3 4
   ((void *)0)
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c"
   , ((1UL << (7))))); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c", 58, __func__, "rtc_isr_register(rtc_brownout_isr_handler, NULL, RTC_CNTL_BROWN_OUT_INT_ENA_M)"); } } while(0);;

    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)"); (("(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)" && (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/brownout.c", 60, __func__, "\"(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)\" && (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t*)((0x3ff48000 + 0x3c)) |= (((1UL << (7))))); });
}
