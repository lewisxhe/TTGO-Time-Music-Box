# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/ets_sys.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/queue.h" 1
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/portmacro.h" 1
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 2





static portMUX_TYPE reason_spinlock = { .owner = 0xB33FFFFF, .count = 0, };
static volatile uint32_t reason[ 2 ];





static inline void __attribute__((section(".iram1"))) esp_crosscore_isr_handle_yield()
{
    {; _frxt_setup_switch();};
}

static void __attribute__((section(".iram1"))) esp_crosscore_isr(void *arg) {
    ...
    if (xPortGetCoreID()==0) {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x0DC))))) = (uint32_t)((0));
    } else {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x0E0))))) = (uint32_t)((0));
    }

    vTaskEnterCritical(&reason_spinlock);
    my_reason_val=*my_reason;
    *my_reason=0;
    vTaskExitCritical(&reason_spinlock);


    if (my_reason_val & (1UL << (0))) {
        esp_crosscore_isr_handle_yield();
    }
    if (my_reason_val & (1UL << (1))) {
...
void esp_crosscore_int_init() {
    ...
    esp_err_t err;
    if (xPortGetCoreID()==0) {
        err = esp_intr_alloc(24, (1<<10), esp_crosscore_isr, (void*)&reason[0], 
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 3 4
                                                                                                                 ((void *)0)
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c"
                                                                                                                     );
    } else {
        err = esp_intr_alloc(25, (1<<10), esp_crosscore_isr, (void*)&reason[1], 
# 91 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c" 3 4
                                                                                                                 ((void *)0)
# 91 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c"
                                                                                                                     );
    }
    ((err == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c", 93, __func__, "err == ESP_OK"));
}

static void __attribute__((section(".iram1"))) esp_crosscore_int_send(int core_id, uint32_t reason_mask) {
    ((core_id<2) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/crosscore_int.c", 97, __func__, "core_id<portNUM_PROCESSORS"));
    ...
    if (core_id==0) {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x0DC))))) = (uint32_t)((((1UL << (0)))));
    } else {
        (*((volatile uint32_t *)(((0x3ff00000 + 0x0E0))))) = (uint32_t)((((1UL << (0)))));
    }
}

void __attribute__((section(".iram1"))) esp_crosscore_int_send_yield(int core_id)
{
    esp_crosscore_int_send(core_id, (1UL << (0)));
}

void __attribute__((section(".iram1"))) esp_crosscore_int_send_freq_switch(int core_id)
{
    esp_crosscore_int_send(core_id, (1UL << (1)));
}
