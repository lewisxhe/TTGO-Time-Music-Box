# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_pm.h" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_pm.h" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_pm.h" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/queue.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 2
...
typedef struct esp_pm_lock {
    ...
    pm_mode_t mode;
    const char* name;
    struct { struct esp_pm_lock *sle_next; } next;
    size_t count;
...
static struct esp_pm_locks_head { struct esp_pm_lock *slh_first; } s_list =
        { 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
       ((void *)0) 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
       };
        ...
        const char* name, esp_pm_lock_handle_t* out_handle)
{
    ...
    if (out_handle == 
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
                     ((void *)0)
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
                         ) {
        return 0x102;
    }
    ...
    new_lock->name = name;
    new_lock->spinlock = (portMUX_TYPE) { .owner = 0xB33FFFFF, .count = 0, };
    *out_handle = new_lock;

    _lock_acquire(&s_list_lock);
    do { (((new_lock))->next.sle_next) = (((&s_list))->slh_first); (((&s_list))->slh_first) = (new_lock); } while (0);
...
esp_err_t esp_pm_lock_delete(esp_pm_lock_handle_t handle)
{
    ...
    if (handle == 
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
                 ((void *)0)
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
                     ) {
        return 0x102;
    }
    ...
    _lock_acquire(&s_list_lock);
    do { ; if ((((&s_list))->slh_first) == (handle)) { do { ((((&s_list)))->slh_first) = ((((((&s_list)))->slh_first))->next.sle_next); } while (0); } else { struct esp_pm_lock *curelm = (((&s_list))->slh_first); while (((curelm)->next.sle_next) != (handle)) curelm = ((curelm)->next.sle_next); do { ((curelm)->next.sle_next) = ((((curelm)->next.sle_next))->next.sle_next); } while (0); } ; } while (0);
    _lock_release(&s_list_lock);
    free(handle);
    return 0;
}

esp_err_t __attribute__((section(".iram1"))) esp_pm_lock_acquire(esp_pm_lock_handle_t handle)
{
    ...
    if (handle == 
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
                 ((void *)0)
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
                     ) {
        return 0x102;
    }

    vTaskEnterCritical(&handle->spinlock);
    if (handle->count++ == 0) {
        pm_time_t now = 0;
    ...
    vTaskExitCritical(&handle->spinlock);
    return 0;
}

esp_err_t __attribute__((section(".iram1"))) esp_pm_lock_release(esp_pm_lock_handle_t handle)
{
    ...
    if (handle == 
# 136 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
                 ((void *)0)
# 136 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
                     ) {
        return 0x102;
    }
    esp_err_t ret = 0;
...
esp_err_t esp_pm_dump_locks(FILE* stream)
{
    ...
    esp_pm_lock_t* it;
    for ((it) = (((&s_list))->slh_first); (it); (it) = (((it))->next.sle_next)) {
        vTaskEnterCritical(&it->spinlock);
        if (it->name == 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c" 3 4
                       ((void *)0)
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
                           ) {
            fprintf(stream, "lock@%p ", it);
        } else {
            fprintf(stream, "%-15s ", it->name);
        }
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_locks.c"
        fprintf(stream, "%10s  %3d  %3d\n", s_lock_type_names[it->type], it->arg, it->count);

        vTaskExitCritical(&it->spinlock);
    }
    _lock_release(&s_list_lock);
