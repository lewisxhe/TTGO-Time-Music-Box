# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_event.h" 1
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 2


static const char* TAG = "event";
static 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
      _Bool 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
           s_event_init_flag = 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                               0
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                                    ((void *)0)
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                                        ;
static system_event_cb_t s_event_handler_cb = 
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                                             ((void *)0)
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                                                 ;
static void *s_event_ctx = 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                          ((void *)0)
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                              ;
...
static void esp_event_loop_task(void *pvParameters)
{
    while (1) {
        system_event_t evt;
        if (xQueueGenericReceive( ( s_event_queue ), ( &evt ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) == ( ( ( BaseType_t ) 1 ) )) {
            esp_err_t ret = esp_event_process_default(&evt);
            if (ret != 0) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            }
            ret = esp_event_post_to_user(&evt);
            if (ret != 0) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            }
        }
    }
}
...
{
    if (s_event_queue == 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                        ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                            ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }
    ...
    int ret = xQueueGenericSend( ( s_event_queue ), ( event ), ( 0 ), ( ( BaseType_t ) 0 ) );
    if (ret != ( ( ( BaseType_t ) 1 ) )) {
        if (event) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } } while(0); } while(0);
        } else {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        }
        return -1;
    }
    return 0;
...
esp_err_t esp_event_loop_init(system_event_cb_t cb, void *ctx)
{
    ...
    s_event_handler_cb = cb;
    s_event_ctx = ctx;
    s_event_queue = xQueueGenericCreate( ( 32 ), ( sizeof(system_event_t) ), ( ( ( uint8_t ) 0U ) ) );

    xTaskCreatePinnedToCore(esp_event_loop_task, "eventTask",
            (2304 + (512)), 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                                  ((void *)0)
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                                      , ((( 25 )) - 5), 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                                                              ((void *)0)
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
    ...
    s_event_init_flag = 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c" 3 4
                       1
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_loop.c"
                           ;
    return 0;
}
