# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_wifi.h" 1
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_wifi.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_wifi.h" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_event.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 2

static const char* TAG = "event";
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
...
esp_err_t system_event_eth_connected_handle_default(system_event_t *event)
{
    ...
    if (status == TCPIP_ADAPTER_DHCP_INIT) {
        ...
        if (!(((eth_ip.ip).addr == ((u32_t)0x00000000UL)) || ((eth_ip.netmask).addr == ((u32_t)0x00000000UL)) || ((eth_ip.gw).addr == ((u32_t)0x00000000UL)))) {
            system_event_t evt;
...
static esp_err_t system_event_eth_got_ip_default(system_event_t *event)
{
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "eth ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "eth ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "eth ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "eth ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "eth ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } } while(0); } while(0)
...
static esp_err_t system_event_sta_got_ip_default(system_event_t *event)
{
    do{ esp_err_t __err = (esp_wifi_internal_set_sta_ip()); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 140, ("esp_wifi_internal_set_sta_ip"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 140, ("esp_wifi_internal_set_sta_ip"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 140, ("esp_wifi_internal_set_sta_ip"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 140, ("esp_wifi_internal_set_sta_ip"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 140, ("esp_wifi_internal_set_sta_ip"), __err); } } while(0); } while(0); return __err; }} while(0);

    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sta ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sta ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sta ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sta ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sta ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&event->event_info.got_ip.ip_info.gw)->addr))[3]))); } } while(0); } while(0)
...
static esp_err_t system_event_sta_lost_ip_default(system_event_t *event)
{
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "station ip lost" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "station ip lost" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "station ip lost" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "station ip lost" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "station ip lost" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    return 0;
}
...
esp_err_t system_event_ap_start_handle_default(system_event_t *event)
{
    ...
    do{ esp_err_t __err = (esp_wifi_internal_reg_rxcb(ESP_IF_WIFI_AP, (wifi_rxcb_t)tcpip_adapter_ap_input)); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 161, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 161, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 161, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 161, ("esp_wifi_internal_reg_rxcb"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 161, ("esp_wifi_internal_reg_rxcb"), __err); } } while(0); } while(0); return __err; }} while(0);
    do{ esp_err_t __err = (esp_wifi_get_mac(ESP_IF_WIFI_AP, ap_mac)); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162, ("esp_wifi_mac_get"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162, ("esp_wifi_mac_get"), __err); } } while(0); } while(0); return __err; }} while(0);
...
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
   ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
   )); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 172, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 172, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 172, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 172, ("esp_wifi_internal_reg_rxcb"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 172, ("esp_wifi_internal_reg_rxcb"), __err); } } while(0); } while(0); return __err; }} while(0);
...
esp_err_t system_event_sta_start_handle_default(system_event_t *event)
{
    ...
    do{ esp_err_t __err = (esp_wifi_get_mac(ESP_IF_WIFI_STA, sta_mac)); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 184, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 184, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 184, ("esp_wifi_mac_get"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 184, ("esp_wifi_mac_get"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 184, ("esp_wifi_mac_get"), __err); } } while(0); } while(0); return __err; }} while(0);
...
esp_err_t system_event_sta_connected_handle_default(system_event_t *event)
{
    ...
    do{ esp_err_t __err = (esp_wifi_internal_reg_rxcb(ESP_IF_WIFI_STA, (wifi_rxcb_t)tcpip_adapter_sta_input)); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 202, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 202, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 202, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 202, ("esp_wifi_internal_reg_rxcb"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 202, ("esp_wifi_internal_reg_rxcb"), __err); } } while(0); } while(0); return __err; }} while(0);
    ...
    if (status == TCPIP_ADAPTER_DHCP_INIT) {
        ...
        if (!(((sta_ip.ip).addr == ((u32_t)0x00000000UL)) || ((sta_ip.netmask).addr == ((u32_t)0x00000000UL)) || ((sta_ip.gw).addr == ((u32_t)0x00000000UL)))) {
            system_event_t evt;

            evt.event_id = SYSTEM_EVENT_STA_GOT_IP;
            evt.event_info.got_ip.ip_changed = 
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
                                              0
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
                                                   ;

            if (memcmp(&sta_ip, &sta_old_ip, sizeof(sta_ip))) {
                evt.event_info.got_ip.ip_changed = 
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
                                                  1
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
                                                      ;
            }
...
# 243 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
   ((void *)0)
# 243 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
   )); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 243, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 243, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 243, ("esp_wifi_internal_reg_rxcb"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 243, ("esp_wifi_internal_reg_rxcb"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 243, ("esp_wifi_internal_reg_rxcb"), __err); } } while(0); } while(0); return __err; }} while(0);
    return 0;
}
...
{
    if (event == 
# 249 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
                ((void *)0)
# 249 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
                    ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }

    switch (event->event_id) {
    case SYSTEM_EVENT_WIFI_READY: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_WIFI_READY" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_WIFI_READY" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_WIFI_READY" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_WIFI_READY" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_WIFI_READY" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_SCAN_DONE: {
        system_event_sta_scan_done_t *scan_done = &event->event_info.scan_done;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_SCAN_DONE, status:%d, number:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, scan_done->status, scan_done->number); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_SCAN_DONE, status:%d, number:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, scan_done->status, scan_done->number); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_SCAN_DONE, status:%d, number:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, scan_done->status, scan_done->number); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_SCAN_DONE, status:%d, number:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, scan_done->status, scan_done->number); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_SCAN_DONE, status:%d, number:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, scan_done->status, scan_done->number); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_START: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_STOP: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_CONNECTED: {
        system_event_sta_connected_t *connected = &event->event_info.connected;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_CONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", channel:%d, authmode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, connected->ssid, connected->ssid_len, (connected->bssid)[0], (connected->bssid)[1], (connected->bssid)[2], (connected->bssid)[3], (connected->bssid)[4], (connected->bssid)[5], connected->channel, connected->authmode); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_CONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", channel:%d, authmode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, connected->ssid, connected->ssid_len, (connected->bssid)[0], (connected->bssid)[1], (connected->bssid)[2], (connected->bssid)[3], (connected->bssid)[4], (connected->bssid)[5], connected->channel, connected->authmode); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_CONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", channel:%d, authmode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, connected->ssid, connected->ssid_len, (connected->bssid)[0], (connected->bssid)[1], (connected->bssid)[2], (connected->bssid)[3], (connected->bssid)[4], (connected->bssid)[5], connected->channel, connected->authmode); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_CONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", channel:%d, authmode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, connected->ssid, connected->ssid_len, (connected->bssid)[0], (connected->bssid)[1], (connected->bssid)[2], (connected->bssid)[3], (connected->bssid)[4], (connected->bssid)[5], connected->channel, connected->authmode); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_CONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", channel:%d, authmode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, connected->ssid, connected->ssid_len, (connected->bssid)[0], (connected->bssid)[1], (connected->bssid)[2], (connected->bssid)[3], (connected->bssid)[4], (connected->bssid)[5], connected->channel, connected->authmode); } } while(0); } while(0)
                                                                                                                            ;
        break;
    }
    case SYSTEM_EVENT_STA_DISCONNECTED: {
        system_event_sta_disconnected_t *disconnected = &event->event_info.disconnected;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_DISCONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", reason:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, disconnected->ssid, disconnected->ssid_len, (disconnected->bssid)[0], (disconnected->bssid)[1], (disconnected->bssid)[2], (disconnected->bssid)[3], (disconnected->bssid)[4], (disconnected->bssid)[5], disconnected->reason); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_DISCONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", reason:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, disconnected->ssid, disconnected->ssid_len, (disconnected->bssid)[0], (disconnected->bssid)[1], (disconnected->bssid)[2], (disconnected->bssid)[3], (disconnected->bssid)[4], (disconnected->bssid)[5], disconnected->reason); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_DISCONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", reason:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, disconnected->ssid, disconnected->ssid_len, (disconnected->bssid)[0], (disconnected->bssid)[1], (disconnected->bssid)[2], (disconnected->bssid)[3], (disconnected->bssid)[4], (disconnected->bssid)[5], disconnected->reason); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_DISCONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", reason:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, disconnected->ssid, disconnected->ssid_len, (disconnected->bssid)[0], (disconnected->bssid)[1], (disconnected->bssid)[2], (disconnected->bssid)[3], (disconnected->bssid)[4], (disconnected->bssid)[5], disconnected->reason); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_DISCONNECTED, ssid:%s, ssid_len:%d, bssid:" "%02x:%02x:%02x:%02x:%02x:%02x" ", reason:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, disconnected->ssid, disconnected->ssid_len, (disconnected->bssid)[0], (disconnected->bssid)[1], (disconnected->bssid)[2], (disconnected->bssid)[3], (disconnected->bssid)[4], (disconnected->bssid)[5], disconnected->reason); } } while(0); } while(0)
                                                                                                                  ;
        break;
    }
    case SYSTEM_EVENT_STA_AUTHMODE_CHANGE: {
        system_event_sta_authmode_change_t *auth_change = &event->event_info.auth_change;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_AUTHMODE_CHNAGE, old_mode:%d, new_mode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, auth_change->old_mode, auth_change->new_mode); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_AUTHMODE_CHNAGE, old_mode:%d, new_mode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, auth_change->old_mode, auth_change->new_mode); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_AUTHMODE_CHNAGE, old_mode:%d, new_mode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, auth_change->old_mode, auth_change->new_mode); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_AUTHMODE_CHNAGE, old_mode:%d, new_mode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, auth_change->old_mode, auth_change->new_mode); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_AUTHMODE_CHNAGE, old_mode:%d, new_mode:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, auth_change->old_mode, auth_change->new_mode); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_GOT_IP: {
        system_event_sta_got_ip_t *got_ip = &event->event_info.got_ip;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_GOT_IP, ip:" "%d.%d.%d.%d" ", mask:" "%d.%d.%d.%d" ", gw:" "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_GOT_IP, ip:" "%d.%d.%d.%d" ", mask:" "%d.%d.%d.%d" ", gw:" "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_GOT_IP, ip:" "%d.%d.%d.%d" ", mask:" "%d.%d.%d.%d" ", gw:" "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_GOT_IP, ip:" "%d.%d.%d.%d" ", mask:" "%d.%d.%d.%d" ", gw:" "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[3]))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_GOT_IP, ip:" "%d.%d.%d.%d" ", mask:" "%d.%d.%d.%d" ", gw:" "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.ip)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.netmask)->addr))[3])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[0])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[1])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[2])), ((u16_t)(((const u8_t*)(&(&got_ip->ip_info.gw)->addr))[3]))); } } while(0); } while(0)
    ...
    case SYSTEM_EVENT_STA_LOST_IP: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_LOST_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_LOST_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_LOST_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_LOST_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_LOST_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_WPS_ER_SUCCESS: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_WPS_ER_FAILED: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_FAILED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_FAILED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_FAILED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_FAILED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_FAILED" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_WPS_ER_TIMEOUT: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_STA_WPS_ER_PIN: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_PIN" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_PIN" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_PIN" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_PIN" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_STA_WPS_ER_PIN" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_AP_START: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_AP_STOP: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_AP_STACONNECTED: {
        system_event_ap_staconnected_t *staconnected = &event->event_info.sta_connected;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_STACONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (staconnected->mac)[0], (staconnected->mac)[1], (staconnected->mac)[2], (staconnected->mac)[3], (staconnected->mac)[4], (staconnected->mac)[5], staconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_STACONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (staconnected->mac)[0], (staconnected->mac)[1], (staconnected->mac)[2], (staconnected->mac)[3], (staconnected->mac)[4], (staconnected->mac)[5], staconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_STACONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (staconnected->mac)[0], (staconnected->mac)[1], (staconnected->mac)[2], (staconnected->mac)[3], (staconnected->mac)[4], (staconnected->mac)[5], staconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_STACONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (staconnected->mac)[0], (staconnected->mac)[1], (staconnected->mac)[2], (staconnected->mac)[3], (staconnected->mac)[4], (staconnected->mac)[5], staconnected->aid); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_STACONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (staconnected->mac)[0], (staconnected->mac)[1], (staconnected->mac)[2], (staconnected->mac)[3], (staconnected->mac)[4], (staconnected->mac)[5], staconnected->aid); } } while(0); } while(0)
                                                                 ;
        break;
    }
    case SYSTEM_EVENT_AP_STADISCONNECTED: {
        system_event_ap_stadisconnected_t *stadisconnected = &event->event_info.sta_disconnected;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_STADISCONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (stadisconnected->mac)[0], (stadisconnected->mac)[1], (stadisconnected->mac)[2], (stadisconnected->mac)[3], (stadisconnected->mac)[4], (stadisconnected->mac)[5], stadisconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_STADISCONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (stadisconnected->mac)[0], (stadisconnected->mac)[1], (stadisconnected->mac)[2], (stadisconnected->mac)[3], (stadisconnected->mac)[4], (stadisconnected->mac)[5], stadisconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_STADISCONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (stadisconnected->mac)[0], (stadisconnected->mac)[1], (stadisconnected->mac)[2], (stadisconnected->mac)[3], (stadisconnected->mac)[4], (stadisconnected->mac)[5], stadisconnected->aid); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_STADISCONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (stadisconnected->mac)[0], (stadisconnected->mac)[1], (stadisconnected->mac)[2], (stadisconnected->mac)[3], (stadisconnected->mac)[4], (stadisconnected->mac)[5], stadisconnected->aid); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_STADISCONNECTED, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" ", aid:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, (stadisconnected->mac)[0], (stadisconnected->mac)[1], (stadisconnected->mac)[2], (stadisconnected->mac)[3], (stadisconnected->mac)[4], (stadisconnected->mac)[5], stadisconnected->aid); } } while(0); } while(0)
                                                                       ;
        break;
    }
    case SYSTEM_EVENT_AP_STAIPASSIGNED: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_STAIPASSIGNED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_STAIPASSIGNED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_STAIPASSIGNED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_STAIPASSIGNED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_STAIPASSIGNED" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_AP_PROBEREQRECVED: {
        system_event_ap_probe_req_rx_t *ap_probereqrecved = &event->event_info.ap_probereqrecved;
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_PROBEREQRECVED, rssi:%d, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, ap_probereqrecved->rssi, (ap_probereqrecved->mac)[0], (ap_probereqrecved->mac)[1], (ap_probereqrecved->mac)[2], (ap_probereqrecved->mac)[3], (ap_probereqrecved->mac)[4], (ap_probereqrecved->mac)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_PROBEREQRECVED, rssi:%d, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, ap_probereqrecved->rssi, (ap_probereqrecved->mac)[0], (ap_probereqrecved->mac)[1], (ap_probereqrecved->mac)[2], (ap_probereqrecved->mac)[3], (ap_probereqrecved->mac)[4], (ap_probereqrecved->mac)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_PROBEREQRECVED, rssi:%d, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, ap_probereqrecved->rssi, (ap_probereqrecved->mac)[0], (ap_probereqrecved->mac)[1], (ap_probereqrecved->mac)[2], (ap_probereqrecved->mac)[3], (ap_probereqrecved->mac)[4], (ap_probereqrecved->mac)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_PROBEREQRECVED, rssi:%d, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, ap_probereqrecved->rssi, (ap_probereqrecved->mac)[0], (ap_probereqrecved->mac)[1], (ap_probereqrecved->mac)[2], (ap_probereqrecved->mac)[3], (ap_probereqrecved->mac)[4], (ap_probereqrecved->mac)[5]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_PROBEREQRECVED, rssi:%d, mac:" "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, ap_probereqrecved->rssi, (ap_probereqrecved->mac)[0], (ap_probereqrecved->mac)[1], (ap_probereqrecved->mac)[2], (ap_probereqrecved->mac)[3], (ap_probereqrecved->mac)[4], (ap_probereqrecved->mac)[5]); } } while(0); } while(0)
    ...
    case SYSTEM_EVENT_GOT_IP6: {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_AP_STA_GOT_IP6 address %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(lwip_htonl((addr)->addr[0]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[0])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3])) & 0xffff)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_AP_STA_GOT_IP6 address %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(lwip_htonl((addr)->addr[0]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[0])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3])) & 0xffff)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_AP_STA_GOT_IP6 address %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(lwip_htonl((addr)->addr[0]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[0])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3])) & 0xffff)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_AP_STA_GOT_IP6 address %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(lwip_htonl((addr)->addr[0]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[0])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3])) & 0xffff)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_AP_STA_GOT_IP6 address %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, ((u16_t)(lwip_htonl((addr)->addr[0]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[0])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[1])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[2])) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3]) >> 16) & 0xffff), ((u16_t)(lwip_htonl((addr)->addr[3])) & 0xffff)); } } while(0); } while(0)
    ...
    case SYSTEM_EVENT_ETH_START: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_ETH_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_ETH_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_ETH_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_ETH_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_ETH_START" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_ETH_STOP: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_ETH_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_ETH_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_ETH_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_ETH_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_ETH_STOP" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_ETH_CONNECTED: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_ETH_CONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_ETH_CONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_ETH_CONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_ETH_CONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_ETH_CONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_ETH_DISCONNECTED: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_ETH_DISCONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_ETH_DISCONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_ETH_DISCONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_ETH_DISCONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_ETH_DISCONNECETED" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }
    case SYSTEM_EVENT_ETH_GOT_IP: {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SYSTEM_EVENT_ETH_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SYSTEM_EVENT_ETH_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SYSTEM_EVENT_ETH_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SYSTEM_EVENT_ETH_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SYSTEM_EVENT_ETH_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        break;
    }

    default: {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "unexpected system event %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "unexpected system event %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "unexpected system event %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "unexpected system event %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "unexpected system event %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } } while(0); } while(0);
        break;
    }
    }
...
{
    if (event == 
# 393 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
                ((void *)0)
# 393 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
                    ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error: event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error: event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error: event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error: event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error: event is null!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }

    esp_system_event_debug(event);
    if ((event->event_id < SYSTEM_EVENT_MAX)) {
        if (default_event_handlers[event->event_id] != 
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c" 3 4
                                                      ((void *)0)
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/event_default_handlers.c"
                                                          ) {
            do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "enter default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "enter default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "enter default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "enter default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "enter default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            default_event_handlers[event->event_id](event);
            do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "exit default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "exit default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "exit default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "exit default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "exit default callback" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        }
    } else {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "mismatch or invalid event, id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "mismatch or invalid event, id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "mismatch or invalid event, id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "mismatch or invalid event, id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "mismatch or invalid event, id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); } } while(0); } while(0);
        return -1;
    }
    return 0;
}
