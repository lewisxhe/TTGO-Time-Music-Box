# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c"
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dport_access.h" 1
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dport_access.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dport_access.h" 2
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c" 2
...
void esp_cache_err_int_init()
{
    ...
    intr_matrix_set(core_id, 68, 25);
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/cache_err_int.c"
    if (core_id == (0)) {
        (*((volatile uint32_t *)((((0x3ff00000 + 0x5A0)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x5A0))|((1UL << (19)) | (1UL << (18)) | (1UL << (14)) | (1UL << (17)) | (1UL << (15)) | (1UL << (16))))))
        ...
        (*((volatile uint32_t *)((((0x3ff00000 + 0x5A0)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x5A0))|((1UL << (5)) | (1UL << (4)) | (1UL << (0)) | (1UL << (3)) | (1UL << (1)) | (1UL << (2))))))
...
int __attribute__((section(".iram1"))) esp_cache_err_get_cpuid()
{
    ...
    if ((DPORT_READ_PERI_REG((0x3ff00000 + 0x3FC)) & (pro_mask))) {
        return (0);
    }
    ...
    if ((DPORT_READ_PERI_REG((0x3ff00000 + 0x424)) & (app_mask))) {
        return (1);
    }
    return -1;
}
