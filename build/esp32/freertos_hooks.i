# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 2





static portMUX_TYPE hooks_spinlock = { .owner = 0xB33FFFFF, .count = 0, };
static esp_freertos_idle_cb_t idle_cb[2][8]={0};
static esp_freertos_tick_cb_t tick_cb[2][8]={0};

void __attribute__((section(".iram1"))) esp_vApplicationTickHook()
{
    int n;
    int core = xPortGetCoreID();
    for (n=0; n<8; n++) {
        if (tick_cb[core][n]!=
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                             ((void *)0)
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                 ) {
            tick_cb[core][n]();
        }
    }
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
   _Bool 
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
        can_go_idle=
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                    1
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
    ...
    for (int n = 0; n < 8; n++) {
        if (idle_cb[core][n] != 
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                               ((void *)0) 
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                    && !idle_cb[core][n]()) {
            can_go_idle = 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                         0
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                              ;
        }
    }
    if (!can_go_idle) {
...
esp_err_t esp_register_freertos_idle_hook_for_cpu(esp_freertos_idle_cb_t new_idle_cb, UBaseType_t cpuid)
{
    ...
    vTaskEnterCritical(&hooks_spinlock);
    for(int n = 0; n < 8; n++){
        if (idle_cb[cpuid][n]==
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                              ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                  ) {
            idle_cb[cpuid][n]=new_idle_cb;
            vTaskExitCritical(&hooks_spinlock);
            return 0;
        }
    }
    vTaskExitCritical(&hooks_spinlock);
...
esp_err_t esp_register_freertos_tick_hook_for_cpu(esp_freertos_tick_cb_t new_tick_cb, UBaseType_t cpuid)
{
    ...
    for(int n = 0; n < 8; n++){
        if (tick_cb[cpuid][n]==
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                              ((void *)0)
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                  ) {
...
void esp_deregister_freertos_idle_hook_for_cpu(esp_freertos_idle_cb_t old_idle_cb, UBaseType_t cpuid)
{
    ...
    for(int n = 0; n < 8; n++){
        if(idle_cb[cpuid][n] == old_idle_cb) idle_cb[cpuid][n] = 
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                                                                ((void *)0)
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                                                    ;
    }
    vTaskExitCritical(&hooks_spinlock);
}
...
void esp_deregister_freertos_tick_hook_for_cpu(esp_freertos_tick_cb_t old_tick_cb, UBaseType_t cpuid)
{
    ...
    for(int n = 0; n < 8; n++){
        if(tick_cb[cpuid][n] == old_tick_cb) tick_cb[cpuid][n] = 
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c" 3 4
                                                                ((void *)0)
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/freertos_hooks.c"
                                                                    ;
    }
    vTaskExitCritical(&hooks_spinlock);
}
