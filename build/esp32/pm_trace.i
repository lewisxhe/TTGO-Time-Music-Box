# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c"
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c" 2
...
# 582 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c" 2
...
static const int __attribute__((section(".dram1"))) s_trace_io[] = {
        (1UL << (4)), (1UL << (5)),
        (1UL << (16)), (1UL << (17)),
        (1UL << (18)), (1UL << (18)),
        (1UL << (19)), (1UL << (19)),
...
void __attribute__((section(".iram1"))) esp_pm_trace_enter(esp_pm_trace_event_t event, int core_id)
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c", 46, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x0008))) = (s_trace_io[2 * event + core_id]); });
}

void __attribute__((section(".iram1"))) esp_pm_trace_exit(esp_pm_trace_event_t event, int core_id)
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/pm_trace.c", 51, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x000c))) = (s_trace_io[2 * event + core_id]); });
}
