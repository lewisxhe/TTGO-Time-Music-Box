# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/ets_sys.h" 1
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/spi_reg.h" 1
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/queue.h" 1
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/portmacro.h" 1
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 2


static portMUX_TYPE g_dport_mux = { .owner = 0xB33FFFFF, .count = 0, };



static uint32_t volatile dport_core_state[2];


uint32_t volatile dport_access_start[2];
uint32_t volatile dport_access_end[2];

static uint32_t volatile dport_access_ref[2];
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
static BaseType_t oldInterruptLevel[2];



void __attribute__((section(".iram1"))) esp_dport_access_stall_other_cpu_start(void)
{

    if (dport_core_state[0] == 0
        || dport_core_state[1] == 0) {
        return;
    }
    ...
    if (dport_access_ref[cpu_id] == 0) {
        vTaskEnterCritical(&g_dport_mux);
        ...
        if (cpu_id == 0) {
            (*(volatile uint32_t *)((0x3ff00000 + 0x0E8))) = (((1UL << (0))));
        } else {
            (*(volatile uint32_t *)((0x3ff00000 + 0x0E4))) = (((1UL << (0))));
        }

        while (!dport_access_start[cpu_id]) {};

        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC)), (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c", 102, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)(((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))); });
    }
    ...
    if (dport_access_ref[cpu_id] > 1) {
        ...
        do { ; _xtos_set_intlevel(intLvl); } while (0);
    }

}


void __attribute__((section(".iram1"))) esp_dport_access_stall_other_cpu_end(void)
{
    ...
    if (dport_access_ref[cpu_id] == 0) {
        ((0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c", 126, __func__, "0"));
    }
    ...
    if (dport_access_ref[cpu_id] == 0) {
        ...
        vTaskExitCritical(&g_dport_mux);

        do { ; _xtos_set_intlevel(oldInterruptLevel[cpu_id]); } while (0);
    }
...
void __attribute__((section(".iram1"))) esp_dport_access_stall_other_cpu_start_wrap(void)
{
    esp_dport_access_stall_other_cpu_start();
}

void __attribute__((section(".iram1"))) esp_dport_access_stall_other_cpu_end_wrap(void)
{
...
static void dport_access_init_core(void *arg)
{
    ...
    xt_ints_off((1<<28));
    intr_matrix_set(core_id, intr_source, 28);
    xt_ints_on((1<<28));

    dport_access_ref[core_id] = 0;
    dport_access_start[core_id] = 0;
    dport_access_end[core_id] = 0;
    dport_core_state[core_id] = 1;

    vTaskDelete(
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 3 4
               ((void *)0)
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
                   );
}
...
void esp_dport_access_int_init(void)
{
    ...
    int res = xTaskCreatePinnedToCore(&dport_access_init_core, "dport", 768, 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 3 4
                                                                                                           ((void *)0)
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
                                                                                                               , 5, 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c" 3 4
                                                                                                                    ((void *)0)
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
                                                                                                                        , xPortGetCoreID());
    ((res == ( ( BaseType_t ) 1 )) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c", 187, __func__, "res == pdTRUE"));

}

void __attribute__((section(".iram1"))) esp_dport_access_int_pause(void)
{

    vTaskEnterCritical(&g_dport_mux);
    dport_core_state[0] = 0;
    dport_core_state[1] = 0;
    vTaskExitCritical(&g_dport_mux);
...
void __attribute__((section(".iram1"))) esp_dport_access_int_abort(void)
{
...
void __attribute__((section(".iram1"))) esp_dport_access_int_resume(void)
{

    vTaskEnterCritical(&g_dport_mux);
    dport_core_state[0] = 1;
    dport_core_state[1] = 1;
    vTaskExitCritical(&g_dport_mux);

}
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
void __attribute__((section(".iram1"))) esp_dport_access_read_buffer(uint32_t *buff_out, uint32_t address, uint32_t num_words)
{
...
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
uint32_t __attribute__((section(".iram1"))) esp_dport_access_reg_read(uint32_t reg)
{
...
# 296 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dport_access.c"
uint32_t __attribute__((section(".iram1"))) esp_dport_access_sequence_reg_read(uint32_t reg)
{
