# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c"
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c"
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/hwcrypto_reg.h" 1
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 2
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c"
static portMUX_TYPE aes_spinlock = { .owner = 0xB33FFFFF, .count = 0, };

void esp_aes_acquire_hardware( void )
{

    vTaskEnterCritical(&aes_spinlock);


    (*(volatile uint32_t *)((((0x3ff00000 + 0x01C))))) = (((DPORT_REG_READ((0x3ff00000 + 0x01C))|((1<<0)))));


    (*(volatile uint32_t *)((((0x3ff00000 + 0x020))))) = (((DPORT_REG_READ((0x3ff00000 + 0x020)) & (~((1<<0) | (1<<4) | (1<<3))))))
...
void esp_aes_release_hardware( void )
{
    ...
    (*(volatile uint32_t *)((((0x3ff00000 + 0x020))))) = (((DPORT_REG_READ((0x3ff00000 + 0x020))|((1<<0)))));


    (*(volatile uint32_t *)((((0x3ff00000 + 0x01C))))) = (((DPORT_REG_READ((0x3ff00000 + 0x01C)) & (~((1<<0))))));

    vTaskExitCritical(&aes_spinlock);
}
...
{
    if ( ctx == 
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c" 3 4
               ((void *)0) 
# 84 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hwcrypto/aes.c"
                    ) {
        return;
    }
...
static inline void esp_aes_setkey_hardware( esp_aes_context *ctx, int mode)
{
    ...
    unsigned mode_reg_base = (mode == 1) ? 0 : MODE_DECRYPT_BIT;

    memcpy((uint32_t *)((0x3ff01000) + 0x10), ctx->key, ctx->key_bytes);
    (*(volatile uint32_t *)((((0x3ff01000) + 0x08)))) = ((mode_reg_base + ((ctx->key_bytes / 8) - 2)));
}
...
static inline void esp_aes_block(const void *input, void *output)
{
    ...
    uint32_t *mem_block = (uint32_t *)((0x3ff01000) + 0x30);

    for(int i = 0; i < 4; i++) {
        mem_block[i] = input_words[i];
    }

    (*(volatile uint32_t *)((((0x3ff01000) + 0x00)))) = ((1));
    while (DPORT_REG_READ(((0x3ff01000) + 0x04)) != 1) { }
