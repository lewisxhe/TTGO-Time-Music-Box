# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 2


static TaskHandle_t s_ipc_tasks[2];
static SemaphoreHandle_t s_ipc_mutex;
static SemaphoreHandle_t s_ipc_sem[2];
static SemaphoreHandle_t s_ipc_ack;

static volatile esp_ipc_func_t s_func;
static void * volatile s_func_arg;
typedef enum {
    IPC_WAIT_FOR_START,
    IPC_WAIT_FOR_END
} esp_ipc_wait_t;

static volatile esp_ipc_wait_t s_ipc_wait;



static void __attribute__((section(".iram1"))) ipc_task(void* arg)
{
    const uint32_t cpuid = (uint32_t) arg;
    ((cpuid == xPortGetCoreID()) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c", 47, __func__, "cpuid == xPortGetCoreID()"));
    while (
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
          1
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
              ) {



        if (xQueueGenericReceive( ( QueueHandle_t ) ( s_ipc_sem[cpuid] ), 
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
           ((void *)0)
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
        ...
        if (s_ipc_wait == IPC_WAIT_FOR_START) {
            xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_ack ), 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
           ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
        (*func)(arg);
        if (s_ipc_wait == IPC_WAIT_FOR_END) {
            xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_ack ), 
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
           ((void *)0)
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
    ...
    vTaskDelete(
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
               ((void *)0)
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
                   );
}

void esp_ipc_init()
{
    s_ipc_mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    s_ipc_ack = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    char task_name[8];
    for (int i = 0; i < 2; ++i) {
        sprintf(task_name,"ipc%d",i);
        s_ipc_sem[i] = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
        int res = xTaskCreatePinnedToCore(ipc_task, task_name, 1024, (void*) i,
                                                    ( 25 ) - 1, &s_ipc_tasks[i], i);
        ((res == ( ( BaseType_t ) 1 )) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c", 86, __func__, "res == pdTRUE"));
    }
}
...
static esp_err_t esp_ipc_call_and_wait(uint32_t cpu_id, esp_ipc_func_t func, void* arg, esp_ipc_wait_t wait_for)
{
    ...
    xQueueGenericReceive( ( QueueHandle_t ) ( s_ipc_mutex ), 
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
   ((void *)0)
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );

    s_func = func;
    s_func_arg = arg;
    s_ipc_wait = IPC_WAIT_FOR_START;
    xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_sem[cpu_id] ), 
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
   ((void *)0)
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    xQueueGenericReceive( ( QueueHandle_t ) ( s_ipc_ack ), 
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
   ((void *)0)
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_mutex ), 
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c" 3 4
   ((void *)0)
# 106 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ipc.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return 0;
}
