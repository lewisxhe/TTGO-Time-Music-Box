# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/frc_timer_reg.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/frc_timer_reg.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/soc.h" 1
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/frc_timer_reg.h" 2
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 2
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
static __attribute__((section(".iram1"))) 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                _Bool 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                     timer_initialized(ETSTimer *ptimer)
{
    return ((ptimer)->timer_expire) == 0x12121212;
}
...
void ets_timer_setfn(ETSTimer *ptimer, ETSTimerFunc *pfunction, void *parg)
{
    if (!timer_initialized(ptimer)) {
        ...
        ((ptimer)->timer_expire) = 0x12121212;
    }

    if (((esp_timer_handle_t) (ptimer)->timer_arg) == 
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                            ((void *)0)
# 58 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                                ) {
        ...
        do { esp_err_t __err_rc = (esp_timer_create(&create_args, (esp_timer_handle_t*)&(ptimer->timer_arg))); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 66, __func__, "esp_timer_create(&create_args, (esp_timer_handle_t*)&(ptimer->timer_arg))"); } } while(0);;
    }
}


void __attribute__((section(".iram1"))) ets_timer_arm_us(ETSTimer *ptimer, uint32_t time_us, 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                                                                   _Bool 
# 71 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                                                                        repeat_flag)
{
    ((timer_initialized(ptimer)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 73, __func__, "timer_initialized(ptimer)"));
    esp_timer_stop(((esp_timer_handle_t) (ptimer)->timer_arg));
    if (!repeat_flag) {
        do { esp_err_t __err_rc = (esp_timer_start_once(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 76, __func__, "esp_timer_start_once(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    } else {
        do { esp_err_t __err_rc = (esp_timer_start_periodic(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 78, __func__, "esp_timer_start_periodic(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    }
}

void __attribute__((section(".iram1"))) ets_timer_arm(ETSTimer *ptimer, uint32_t time_ms, 
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                                                                _Bool 
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                                                                     repeat_flag)
{
    uint64_t time_us = 1000LL * (uint64_t) time_ms;
    ((timer_initialized(ptimer)) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 85, __func__, "timer_initialized(ptimer)"));
    esp_timer_stop(((esp_timer_handle_t) (ptimer)->timer_arg));
    if (!repeat_flag) {
        do { esp_err_t __err_rc = (esp_timer_start_once(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 88, __func__, "esp_timer_start_once(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    } else {
        do { esp_err_t __err_rc = (esp_timer_start_periodic(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c", 90, __func__, "esp_timer_start_periodic(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    }
}
...
{
    if (timer_initialized(ptimer)) {
        esp_timer_delete(((esp_timer_handle_t) (ptimer)->timer_arg));
        ptimer->timer_arg = 
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                           ((void *)0)
# 98 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                               ;
        ((ptimer)->timer_expire) = 0;
    }
}

void __attribute__((section(".iram1"))) ets_timer_disarm(ETSTimer *ptimer)
{
    if (timer_initialized(ptimer)) {
        esp_timer_stop(((esp_timer_handle_t) (ptimer)->timer_arg));
    }
...
void os_timer_arm_us(ETSTimer *ptimer,uint32_t u_seconds,
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                                                        _Bool 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                                                             repeat_flag) __attribute__((alias("ets_timer_arm_us")));
void os_timer_arm(ETSTimer *ptimer,uint32_t milliseconds,
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c" 3 4
                                                        _Bool 
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/ets_timer_legacy.c"
                                                             repeat_flag) __attribute__((alias("ets_timer_arm")));
