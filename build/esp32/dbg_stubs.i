# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c"
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c"
...
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/include/eri.h" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/xtensa-debug-module/include/xtensa-debug-module.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dbg_stubs.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dbg_stubs.h"
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_dbg_stubs.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c"
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/dbg_stubs.c" 2
...
static uint8_t s_stub_min_stack[2048];
static __attribute__((section(".iram1"))) uint8_t s_stub_code_buf[32];


static void * esp_dbg_stubs_data_alloc(uint32_t size)
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, size); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, size); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, size); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, size); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, size); } } while(0); } while(0);
 void *p = malloc(size);
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, p); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, p); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, p); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, p); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, p); } } while(0); } while(0);
    return p;
}

static void esp_dbg_stubs_data_free(void *addr)
{
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } } while(0); } while(0);
    free(addr);
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s EXIT %p" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, addr); } } while(0); } while(0);
}
...
void esp_dbg_stubs_init()
{
    ...
    eri_write(((0x100000 +0)+0x14), (uint32_t)s_stub_entry);
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s stubs %x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, eri_read(((0x100000 +0)+0x14))); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s stubs %x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, eri_read(((0x100000 +0)+0x14))); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s stubs %x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, eri_read(((0x100000 +0)+0x14))); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s stubs %x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, eri_read(((0x100000 +0)+0x14))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s stubs %x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, eri_read(((0x100000 +0)+0x14))); } } while(0); } while(0);
}

esp_err_t esp_dbg_stub_entry_set(esp_dbg_stub_id_t id, uint32_t entry)
{
    if (id < ESP_DBG_STUB_ENTRY_FIRST || id >= ESP_DBG_STUB_ENTRY_MAX) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid stub id %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid stub id %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Invalid stub id %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Invalid stub id %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid stub id %d!" "\033[0m" "\n", esp_log_timestamp(), TAG, id); } } while(0); } while(0);
        return 0x102;
    }
