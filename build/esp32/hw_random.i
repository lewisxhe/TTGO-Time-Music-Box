# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c"
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c" 2

uint32_t __attribute__((section(".iram1"))) esp_random(void)
{
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c"
    ...
    uint32_t result = 0;
    do {
        ccount = ({ int __ccount; __asm__ __volatile__("rsr.ccount %0" : "=a"(__ccount)); __ccount; });
        result ^= ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC)), (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c", 52, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)(0x60035144)); });
    } while (ccount - last_ccount < cpu_to_apb_freq_ratio * 16);
    last_ccount = ccount;
    return result ^ ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC)), (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/esp32/hw_random.c", 55, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((0x60035144)) >= 0x3ff00000) && ((0x60035144)) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)(0x60035144)); });
}
