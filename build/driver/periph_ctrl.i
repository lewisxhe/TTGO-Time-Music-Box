# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 2

static portMUX_TYPE periph_spinlock = { .owner = 0xB33FFFFF, .count = 0, };
...
void periph_module_enable(periph_module_t periph)
{
    ...
    (*((volatile uint32_t *)(((get_clk_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_clk_en_reg(periph))|(get_clk_en_mask(periph)))));
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))&(~(get_rst_en_mask(periph))))));
...
static 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 3 4
      _Bool 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
           is_wifi_clk_peripheral(periph_module_t periph)
{
    ...
    case PERIPH_BT_LC_MODULE:
        return 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 3 4
              1
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
                  ;
    default:
        return 
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c" 3 4
              0
# 208 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/periph_ctrl.c"
                   ;
    }
}
...
static uint32_t get_clk_en_reg(periph_module_t periph)
{
    return is_wifi_clk_peripheral(periph) ? (0x3ff00000 + 0x0CC) : (0x3ff00000 + 0x0C0);
}

static uint32_t get_rst_en_reg(periph_module_t periph)
{
    return is_wifi_clk_peripheral(periph) ? (0x3ff00000 + 0x0D0) : (0x3ff00000 + 0x0C4);
}
