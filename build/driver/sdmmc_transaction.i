# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/sdmmc_reg.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/sdmmc_struct.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/sdmmc_struct.h"
typedef struct {
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_private.h" 1
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_private.h"
       


# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_private.h" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 2
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
...
static 
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
      _Bool 
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
           s_is_app_cmd;
...
{
    ((s_request_mutex == 
# 87 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
   ((void *)0)
# 87 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 87, __func__, "s_request_mutex == NULL"));
    s_request_mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    if (!s_request_mutex) {
        return 0x101;
    }
    s_is_app_cmd = 
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
                  0
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                       ;
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
    return 0;
}

void sdmmc_host_transaction_handler_deinit()
{
    ((s_request_mutex) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 106, __func__, "s_request_mutex"));
    ...
    s_request_mutex = 
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
                     ((void *)0)
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                         ;
}
...
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
   ((void *)0)
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    ...
    if (cmdinfo->data) {
        ...
        if (cmdinfo->datalen >= 4 && cmdinfo->datalen % 4 != 0) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: invalid size: total=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->datalen); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: invalid size: total=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->datalen); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: invalid size: total=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->datalen); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: invalid size: total=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->datalen); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: invalid size: total=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->datalen); } } while(0); } while(0)
                                               ;
            ret = 0x104;
            goto out;
        }
        if ((intptr_t) cmdinfo->data % 4 != 0 ||
            ...
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: buffer %p can not be used for DMA" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->data); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: buffer %p can not be used for DMA" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->data); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: buffer %p can not be used for DMA" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->data); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: buffer %p can not be used for DMA" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->data); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: buffer %p can not be used for DMA" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmdinfo->data); } } while(0); } while(0);
            ret = 0x102;
            goto out;
        }
...
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
   ((void *)0)
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
...
static size_t get_free_descriptors_count()
{
    ...
    for (size_t i = 0; i < 4; ++i) {
        sdmmc_desc_t* desc = &s_dma_desc[(next + i) % 4];
        if (desc->owned_by_idmac) {
            break;
        }
        ++count;
        if (desc->next_desc_ptr == 
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
                                  ((void *)0)
# 193 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                                      ) {
...
static void fill_dma_descriptors(size_t num_desc)
{
    for (size_t i = 0; i < num_desc; ++i) {
        ...
        ((!desc->owned_by_idmac) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 209, __func__, "!desc->owned_by_idmac"));
        size_t size_to_fill =
            (s_cur_transfer.size_remaining < 4096) ?
                s_cur_transfer.size_remaining : 4096;
        
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
       _Bool 
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
...
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
                                      ((void *)0) 
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                                           : &s_dma_desc[(next + 1) % 4];
        ((size_to_fill < 4 || size_to_fill % 4 == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 219, __func__, "size_to_fill < 4 || size_to_fill % 4 == 0"));
        ...
        do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "fill %d desc=%d rem=%d next=%d last=%d sz=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, num_desc, next, s_cur_transfer.size_remaining, s_cur_transfer.next_desc, desc->last_descriptor, desc->buffer1_size); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "fill %d desc=%d rem=%d next=%d last=%d sz=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, num_desc, next, s_cur_transfer.size_remaining, s_cur_transfer.next_desc, desc->last_descriptor, desc->buffer1_size); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "fill %d desc=%d rem=%d next=%d last=%d sz=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, num_desc, next, s_cur_transfer.size_remaining, s_cur_transfer.next_desc, desc->last_descriptor, desc->buffer1_size); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "fill %d desc=%d rem=%d next=%d last=%d sz=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, num_desc, next, s_cur_transfer.size_remaining, s_cur_transfer.next_desc, desc->last_descriptor, desc->buffer1_size); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "fill %d desc=%d rem=%d next=%d last=%d sz=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, num_desc, next, s_cur_transfer.size_remaining, s_cur_transfer.next_desc, desc->last_descriptor, desc->buffer1_size); } } while(0); } while(0)
...
static esp_err_t handle_idle_state_events()
{
    ...
    while (sdmmc_host_wait_for_event(0, &evt) == 0) {
        if (evt.sdmmc_status & (1UL << (0))) {
            do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "card detect event" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "card detect event" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "card detect event" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "card detect event" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "card detect event" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            evt.sdmmc_status &= ~(1UL << (0));
        }
        if (evt.sdmmc_status != 0 || evt.dma_status != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "handle_idle_state_events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "handle_idle_state_events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "handle_idle_state_events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "handle_idle_state_events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.sdmmc_status, evt.dma_status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "handle_idle_state_events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.sdmmc_status, evt.dma_status); } } while(0); } while(0)
                                                     ;
        }
...
{
    sdmmc_event_t event;
    esp_err_t err = sdmmc_host_wait_for_event(cmd->timeout_ms / ( ( TickType_t ) 1000 / ( 100 ) ), &event);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_host_wait_for_event returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_host_wait_for_event returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_host_wait_for_event returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_host_wait_for_event returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_host_wait_for_event returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        if (err == 0x107) {
            sdmmc_host_dma_stop();
        }
        return err;
    }
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_handle_event: event %08x %08x, unhandled %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, event.sdmmc_status, event.dma_status, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_handle_event: event %08x %08x, unhandled %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, event.sdmmc_status, event.dma_status, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_handle_event: event %08x %08x, unhandled %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, event.sdmmc_status, event.dma_status, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_handle_event: event %08x %08x, unhandled %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, event.sdmmc_status, event.dma_status, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_handle_event: event %08x %08x, unhandled %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, event.sdmmc_status, event.dma_status, unhandled_events->sdmmc_status, unhandled_events->dma_status); } } while(0); } while(0)
    ...
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_handle_event: events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "sdmmc_handle_event: events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "sdmmc_handle_event: events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "sdmmc_handle_event: events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, unhandled_events->sdmmc_status, unhandled_events->dma_status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "sdmmc_handle_event: events unhandled: %08x %08x" "\033[0m" "\n", esp_log_timestamp(), TAG, unhandled_events->sdmmc_status, unhandled_events->dma_status); } } while(0); } while(0);
    return 0;
}

static 
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
      _Bool 
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
           cmd_needs_auto_stop(const sdmmc_command_t* cmd)
{
...
static sdmmc_hw_cmd_t make_hw_cmd(sdmmc_command_t* cmd)
{
    ...
    if (cmd->data) {
        ...
        ((cmd->datalen % cmd->blklen == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 315, __func__, "cmd->datalen % cmd->blklen == 0"));
        res.send_auto_stop = cmd_needs_auto_stop(cmd) ? 1 : 0;
    }
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: opcode=%d, rexp=%d, crc=%d, auto_stop=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, res.cmd_index, res.response_expect, res.check_response_crc, res.send_auto_stop); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: opcode=%d, rexp=%d, crc=%d, auto_stop=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, res.cmd_index, res.response_expect, res.check_response_crc, res.send_auto_stop); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: opcode=%d, rexp=%d, crc=%d, auto_stop=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, res.cmd_index, res.response_expect, res.check_response_crc, res.send_auto_stop); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: opcode=%d, rexp=%d, crc=%d, auto_stop=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, res.cmd_index, res.response_expect, res.check_response_crc, res.send_auto_stop); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: opcode=%d, rexp=%d, crc=%d, auto_stop=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, res.cmd_index, res.response_expect, res.check_response_crc, res.send_auto_stop); } } while(0); } while(0)
...
static void process_command_response(uint32_t status, sdmmc_command_t* cmd)
{
    ...
    if (status & (1UL << (8))) {
        ...
        ((cmd->flags & 0x1000) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c", 340, __func__, "cmd->flags & SCF_RSP_PRESENT"));
        err = 0x107;
    ...
    if (err != 0) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: error 0x%x  (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err, status); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: error 0x%x  (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err, status); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: error 0x%x  (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err, status); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: error 0x%x  (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err, status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: error 0x%x  (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err, status); } } while(0); } while(0);
    }
}
...
static void process_data_status(uint32_t status, sdmmc_command_t* cmd)
{
    ...
    if (cmd->error != 0) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: error 0x%x (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmd->error, status); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: error 0x%x (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmd->error, status); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: error 0x%x (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmd->error, status); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: error 0x%x (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmd->error, status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: error 0x%x (status=%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, cmd->error, status); } } while(0); } while(0);
    }

}

static inline 
# 380 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
             _Bool 
# 380 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                  mask_check_and_clear(uint32_t* state, uint32_t mask) {
    
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
   _Bool 
# 381 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
        ret = ((*state) & mask) != 0;
    *state &= ~mask;
    return ret;
}
        ...
        sdmmc_req_state_t* pstate, sdmmc_event_t* unhandled_events)
{
    ...
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: state=%s evt=%x dma=%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[*pstate], evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: state=%s evt=%x dma=%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[*pstate], evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: state=%s evt=%x dma=%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[*pstate], evt.sdmmc_status, evt.dma_status); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: state=%s evt=%x dma=%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[*pstate], evt.sdmmc_status, evt.dma_status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: state=%s evt=%x dma=%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[*pstate], evt.sdmmc_status, evt.dma_status); } } while(0); } while(0)
                                             ;
        ...
        switch (state) {
            ...
            case SDMMC_SENDING_CMD:
                ...
                if (mask_check_and_clear(&evt.sdmmc_status, (1UL << (2)))) {
                    ...
                    if (cmd->data == 
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c" 3 4
                                    ((void *)0)
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdmmc_transaction.c"
                                        ) {
                        next_state = SDMMC_IDLE;
                    } else {
        ...
        do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s state=%s next_state=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[state], s_state_names[next_state]); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s state=%s next_state=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[state], s_state_names[next_state]); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s state=%s next_state=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[state], s_state_names[next_state]); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s state=%s next_state=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[state], s_state_names[next_state]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s state=%s next_state=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, s_state_names[state], s_state_names[next_state]); } } while(0); } while(0);
    }
    *pstate = state;
