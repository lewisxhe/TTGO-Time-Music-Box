# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
...
# 83 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
...
# 94 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_free(spi_host_device_t host);
# 117 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_queue_trans(spi_host_device_t host, const spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait);
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_get_trans_result(spi_host_device_t host, spi_slave_transaction_t **trans_desc, TickType_t ticks_to_wait);
# 159 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_transmit(spi_host_device_t host, spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 2


static const char *SPI_TAG = "spi_slave";
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
typedef struct {
...
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
   _Bool 
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
        spi_chan_claimed, dma_chan_claimed;
    esp_err_t ret = 0;
    esp_err_t err;

    if (!((host>SPI_HOST && host<=VSPI_HOST))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 77, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 77, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 77, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 77, "invalid host"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 77, "invalid host"); } } while(0); } while(0); return (0x102); };
    if (!(dma_chan >= 0 && dma_chan <= 2)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 78, "invalid dma channel"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 78, "invalid dma channel"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 78, "invalid dma channel"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 78, "invalid dma channel"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 78, "invalid dma channel"); } } while(0); } while(0); return (0x102); };

    spi_chan_claimed=spicommon_periph_claim(host);
    if (!(spi_chan_claimed)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 81, "host already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 81, "host already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 81, "host already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 81, "host already in use"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 81, "host already in use"); } } while(0); } while(0); return (0x103); };

    if ( dma_chan != 0 ) {
        dma_chan_claimed=spicommon_dma_chan_claim(dma_chan);
        if ( !dma_chan_claimed ) {
            spicommon_periph_free( host );
            if (!(dma_chan_claimed)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 87, "dma channel already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 87, "dma channel already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 87, "dma channel already in use"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 87, "dma channel already in use"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 87, "dma channel already in use"); } } while(0); } while(0); return (0x103); };
        }
    }

    spihost[host] = malloc(sizeof(spi_slave_t));
    if (spihost[host] == 
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                        ((void *)0)
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                            ) {
        ret = 0x101;
        goto cleanup;
    }
    ...
    err = spicommon_bus_initialize_io(host, bus_config, dma_chan, 0|bus_config->flags, &spihost[host]->flags);
    if (err!=0) {
        ret = err;
        goto cleanup;
    }
    gpio_set_direction(slave_config->spics_io_num, GPIO_MODE_INPUT);
    spicommon_cs_initialize(host, slave_config->spics_io_num, 0, !(spihost[host]->flags&(1<<1)));
...
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    spihost[host]->trans_queue = xQueueGenericCreate( ( slave_config->queue_size ), ( sizeof(spi_slave_transaction_t *) ), ( ( ( uint8_t ) 0U ) ) );
    spihost[host]->ret_queue = xQueueGenericCreate( ( slave_config->queue_size ), ( sizeof(spi_slave_transaction_t *) ), ( ( ( uint8_t ) 0U ) ) );
    if (!spihost[host]->trans_queue || !spihost[host]->ret_queue) {
        ret = 0x101;
        goto cleanup;
    }

    err = esp_intr_alloc(spicommon_irqsource_for_host(host), (1<<11), spi_intr, (void *)spihost[host], &spihost[host]->intr);
    if (err != 0) {
        ret = err;
        goto cleanup;
    }
    ...
    spihost[host]->hw->user.doutdin = 1;
...
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
   _Bool 
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
        nodelay = 
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                  1
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                      ;
    spihost[host]->hw->ctrl.rd_bit_order = (slave_config->flags & (1<<1)) ? 1 : 0;
    spihost[host]->hw->ctrl.wr_bit_order = (slave_config->flags & (1<<0)) ? 1 : 0;
...
cleanup:
    ...
    free(spihost[host]);
    spihost[host] = 
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                   ((void *)0)
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                       ;
    spicommon_periph_free(host);
...
esp_err_t spi_slave_free(spi_host_device_t host)
{
    if (!((host>SPI_HOST && host<=VSPI_HOST))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232, "invalid host"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232, "invalid host"); } } while(0); } while(0); return (0x102); };
    if (!(spihost[host])) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 233, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 233, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 233, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 233, "host not slave"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 233, "host not slave"); } } while(0); } while(0); return (0x102); };
    if (spihost[host]->trans_queue) vQueueDelete(spihost[host]->trans_queue);
    if (spihost[host]->ret_queue) vQueueDelete(spihost[host]->ret_queue);
    ...
    free(spihost[host]);
    spihost[host] = 
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                   ((void *)0)
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                       ;
    spicommon_periph_free(host);
    return 0;
}
...
{
    BaseType_t r;
    if (!((host>SPI_HOST && host<=VSPI_HOST))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 256, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 256, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 256, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 256, "invalid host"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 256, "invalid host"); } } while(0); } while(0); return (0x102); };
    if (!(spihost[host])) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 257, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 257, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 257, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 257, "host not slave"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 257, "host not slave"); } } while(0); } while(0); return (0x102); };
    if (!(spihost[host]->dma_chan == 0 || trans_desc->tx_buffer==
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
   ((void *)0) 
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
   || esp_ptr_dma_capable(trans_desc->tx_buffer))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 259
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "txdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 259
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "txdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 259
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "txdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 259
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "txdata not in DMA-capable memory"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 259
# 258 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "txdata not in DMA-capable memory"); } } while(0); } while(0); return (0x102); }
                                                           ;
    if (!(spihost[host]->dma_chan == 0 || trans_desc->rx_buffer==
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
   ((void *)0) 
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
   || esp_ptr_dma_capable(trans_desc->rx_buffer))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 261
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "rxdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 261
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "rxdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 261
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "rxdata not in DMA-capable memory"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 261
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "rxdata not in DMA-capable memory"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__,
 261
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
    , "rxdata not in DMA-capable memory"); } } while(0); } while(0); return (0x102); }
                                                           ;

    if (!(trans_desc->length <= spihost[host]->max_transfer_sz * 8)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 263, "data transfer > host maximum"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 263, "data transfer > host maximum"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 263, "data transfer > host maximum"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 263, "data transfer > host maximum"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 263, "data transfer > host maximum"); } } while(0); } while(0); return (0x102); };
    r = xQueueGenericSend( ( spihost[host]->trans_queue ), ( (void *)&trans_desc ), ( ticks_to_wait ), ( ( BaseType_t ) 0 ) );
    if (!r) return 0x107;
...
{
    BaseType_t r;
    if (!((host>SPI_HOST && host<=VSPI_HOST))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 274, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 274, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 274, "invalid host"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 274, "invalid host"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 274, "invalid host"); } } while(0); } while(0); return (0x102); };
    if (!(spihost[host])) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 275, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 275, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 275, "host not slave"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 275, "host not slave"); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 275, "host not slave"); } } while(0); } while(0); return (0x102); };
    r = xQueueGenericReceive( ( spihost[host]->ret_queue ), ( (void *)trans_desc ), ( ticks_to_wait ), ( ( BaseType_t ) 0 ) );
    if (!r) return 0x107;
    return 0;
}
...
esp_err_t spi_slave_transmit(spi_host_device_t host, spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait)
{
    ...
    if (ret != 0) return ret;
    ((ret_trans == trans_desc) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c", 291, __func__, "ret_trans == trans_desc"));
    return 0;
}
# 319 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
static void __attribute__((section(".iram1"))) spi_slave_restart_after_dmareset(void *arg)
{
...
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                                    ((void *)0)
# 332 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                                        ;
    spi_slave_t *host = (spi_slave_t *)arg;
    ...
    if (host->cur_trans) {
        ...
        xQueueGenericSendFromISR( ( host->ret_queue ), ( &host->cur_trans ), ( &do_yield ), ( ( BaseType_t ) 0 ) );
        host->cur_trans = 
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                         ((void *)0)
# 376 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                             ;
    }
    if (host->dma_chan != 0) {
    ...
    if (!r) {
        ...
        if (host->dma_chan != 0) {
            ...
            if (trans->rx_buffer) {
                ...
                spicommon_setup_dma_desc_links(host->dmadesc_rx, ((trans->length + 7) / 8), trans->rx_buffer, 
# 411 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                                                                                                             1
# 411 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                                                                                                                 );
            ...
            if (trans->tx_buffer) {
                spicommon_setup_dma_desc_links(host->dmadesc_tx, (trans->length + 7) / 8, trans->tx_buffer, 
# 417 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                                                                                                           0
# 417 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                                                                                                                );
        ...
        host->hw->user.usr_mosi = (trans->tx_buffer == 
# 449 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                                                      ((void *)0)
# 449 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                                                          ) ? 0 : 1;
        host->hw->user.usr_miso = (trans->rx_buffer == 
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c" 3 4
                                                      ((void *)0)
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/spi_slave.c"
                                                          ) ? 0 : 1;
