# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 2

static const char* TAG = "sdspi_transaction";

static _lock_t s_lock;
static 
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 3 4
      _Bool 
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
           s_app_cmd;

static uint8_t sdspi_msg_crc7(sdspi_hw_cmd_t* hw_cmd)
{
    const size_t bytes_to_crc = 
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 3 4
                               __builtin_offsetof (
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
                               sdspi_hw_cmd_t
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 3 4
                               , 
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
...
{
    if (r1 & (1<<7)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x107;
    } else if (r1 & (1<<3)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x109;
    } else if (r1 & (1<<2)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x106;
    } else if (r1 & (1<<5)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: alignment error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: alignment error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: alignment error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: alignment error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: alignment error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x102;
    } else if (r1 & (1<<6)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x104;
    } else if ((r1 & (1<<1)) ||
               (r1 & (1<<4))) {
        *out_err = 0x103;
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } } while(0); } while(0);
        *out_err = 0x108;
    }
}
...
esp_err_t sdspi_host_do_transaction(int slot, sdmmc_command_t *cmdinfo)
{
    ...
    int flags = 0;
    if (((cmdinfo->flags) & 0x00f0) == 0x0010) {
        flags = (1UL << (0)) | (1UL << (1));
    } else if (((cmdinfo->flags) & 0x00f0) == (0x0010 | 0x0040)) {
        flags = (1UL << (0));
    }
    ...
    if (!s_app_cmd && cmdinfo->opcode == 8) {
        flags |= (1UL << (5));
    } else if (!s_app_cmd && cmdinfo->opcode == 13) {
        flags |= (1UL << (3));
    } else if (!s_app_cmd && cmdinfo->opcode == 58) {
        flags |= (1UL << (4));
    } else if (s_app_cmd && cmdinfo->opcode == 13) {
        flags |= (1UL << (3));
    } else if (!s_app_cmd && cmdinfo->opcode == 0 &&
            !(cmdinfo->flags & (0x1000|0x0400|0x0800))) {
    ...
    if (ret == 0) {
        do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); } } while(0); } while(0);
    ...
    if (ret == 0) {
        s_app_cmd = (cmdinfo->opcode == 55);
    } else {
        s_app_cmd = 
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c" 3 4
                   0
# 141 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/sdspi_transaction.c"
                        ;
    }
