# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/timer.h" 1
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/timer.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/timer_group_reg.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/timer.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/include/driver/timer.h" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 2

static const char* TIMER_TAG = "timer_group";
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
...
esp_err_t timer_get_counter_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* timer_val)
{
    ...
    if (!(timer_val != 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
...
esp_err_t timer_get_counter_time_sec(timer_group_t group_num, timer_idx_t timer_num, double* time)
{
    ...
    if (!(time != 
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
    ...
    if (err == 0) {
        ...
        *time = (double)timer_val * div / (( 80*1000000 ));
    }
    return err;
}
...
esp_err_t timer_get_alarm_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* alarm_value)
{
    ...
    if (!(alarm_value != 
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
    ...
    void (*fn)(void*), void * arg, int intr_alloc_flags, timer_isr_handle_t *handle)
{
    ...
    if (!(fn != 
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
    ...
    switch(group_num) {
        case TIMER_GROUP_0:
        default:
            if((intr_alloc_flags & (1<<9)) == 0) {
                intr_source = 14 + timer_num;
            } else {
                intr_source = 58 + timer_num;
            }
            status_reg = ((0x3ff5F000 + 0*0x1000) + 0x00a0);
            mask = 1<<timer_num;
            break;
        case TIMER_GROUP_1:
            if((intr_alloc_flags & (1<<9)) == 0) {
                intr_source = 18 + timer_num;
            } else {
                intr_source = 62 + timer_num;
            }
            status_reg = ((0x3ff5F000 + 1*0x1000) + 0x00a0);
            mask = 1<<timer_num;
            break;
    }
...
esp_err_t timer_init(timer_group_t group_num, timer_idx_t timer_num, const timer_config_t *config)
{
    ...
    if (!(config != 
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
...
esp_err_t timer_get_config(timer_group_t group_num, timer_idx_t timer_num, timer_config_t *config)
{
    ...
    if (!(config != 
# 237 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c" 3 4
   ((void *)0)
# 237 "D:/ESP32/esp-idf-v3.1-rc1/components/driver/timer.c"
