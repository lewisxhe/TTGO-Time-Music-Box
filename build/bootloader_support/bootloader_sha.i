# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include_priv/bootloader_sha.h"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include_priv/bootloader_sha.h" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include_priv/bootloader_sha.h" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 2
...
bootloader_sha256_handle_t bootloader_sha256_start()
{
    ...
    if (!ctx) {
        return 
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
              ((void *)0)
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
                  ;
    }
    mbedtls_sha256_init(ctx);
    int ret = mbedtls_sha256_starts_ret(ctx, 
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
                                            0
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
                                                 );
    if (ret != 0) {
        return 
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
              ((void *)0)
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
                  ;
    }
    return ctx;
}
...
{
    ((handle != 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
   ((void *)0)
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c", 40, __func__, "handle != NULL"));
    mbedtls_sha256_context *ctx = (mbedtls_sha256_context *)handle;
    int ret = mbedtls_sha256_update_ret(ctx, data, data_len);
    ((ret == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c", 43, __func__, "ret == 0"));
}

void bootloader_sha256_finish(bootloader_sha256_handle_t handle, uint8_t *digest)
{
    ((handle != 
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
   ((void *)0)
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c", 48, __func__, "handle != NULL"));
    mbedtls_sha256_context *ctx = (mbedtls_sha256_context *)handle;
    if (digest != 
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c" 3 4
                 ((void *)0)
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c"
                     ) {
        int ret = mbedtls_sha256_finish_ret(ctx, digest);
        ((ret == 0) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/bootloader_sha.c", 52, __func__, "ret == 0"));
    }
