# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c"
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_partitions.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_partitions.h"
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_partitions.h" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/include/esp_flash_partitions.h" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/spi_flash.h" 1
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/spi_flash.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/spi_flash.h" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 2


static const char *TAG = "flash_parts";

esp_err_t esp_partition_table_verify(const esp_partition_info_t *partition_table, 
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c" 3 4
                                                                                 _Bool 
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/flash_partitions.c"
                                                                                      log_errors, int *num_partitions)
{
    int md5_found = 0;
    int num_parts;
    ...
    *num_partitions = 0;
    ...
    for (num_parts = 0; num_parts < (0xC00 / sizeof(esp_partition_info_t)); num_parts++) {
        const esp_partition_info_t *part = &partition_table[num_parts];

        if (part->magic == 0x50AA) {
            const esp_partition_pos_t *pos = &part->pos;
            if (pos->offset > chip_size || pos->offset + pos->size > chip_size) {
                if (log_errors) {
                    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); } } while(0); } while(0)
                                                                          ;
                }
                return 0x104;
            }
        } else if (part->magic == 0xEBEB) {
            if (md5_found) {
                if (log_errors) {
                    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Only one MD5 checksum is allowed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Only one MD5 checksum is allowed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Only one MD5 checksum is allowed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Only one MD5 checksum is allowed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Only one MD5 checksum is allowed" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                }
                return 0x103;
            }
            ...
            if (memcmp(md5sum, digest, sizeof(digest)) != 0) {
                if (log_errors) {
                    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Incorrect MD5 checksum" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Incorrect MD5 checksum" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Incorrect MD5 checksum" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Incorrect MD5 checksum" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Incorrect MD5 checksum" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                }
                return 0x103;
            }
            ...
            md5_found = 1;
                   ...
                   && part->type == 0xff
                   && part->subtype == 0xff) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); } } while(0); } while(0);
            *num_partitions = num_parts - md5_found;
            return 0;
        } else {
            if (log_errors) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); } } while(0); } while(0);
            }
            return 0x103;
        }
    }
    ...
    if (log_errors) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }
    return 0x103;
}
