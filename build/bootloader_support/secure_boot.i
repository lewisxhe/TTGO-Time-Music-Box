# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/efuse_reg.h" 1
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 2
...
static 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
      _Bool 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
...
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
                        ((void *)0)
# 60 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                            );

    err = bootloader_flash_erase_sector(0);
    if (err != 0)
    {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SPI erase failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SPI erase failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SPI erase failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SPI erase failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SPI erase failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return 
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
              0
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                   ;
    }
    ...
    if (!image) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_mmap(0x1000, 0x%x) failed" "\033[0m" "\n", esp_log_timestamp(), TAG, image_len); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "bootloader_mmap(0x1000, 0x%x) failed" "\033[0m" "\n", esp_log_timestamp(), TAG, image_len); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "bootloader_mmap(0x1000, 0x%x) failed" "\033[0m" "\n", esp_log_timestamp(), TAG, image_len); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "bootloader_mmap(0x1000, 0x%x) failed" "\033[0m" "\n", esp_log_timestamp(), TAG, image_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "bootloader_mmap(0x1000, 0x%x) failed" "\033[0m" "\n", esp_log_timestamp(), TAG, image_len); } } while(0); } while(0);
        return 
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
              0
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                   ;
    }
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "write iv+digest to flash" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "write iv+digest to flash" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "write iv+digest to flash" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "write iv+digest to flash" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "write iv+digest to flash" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    err = bootloader_flash_write(0, &digest,
                           sizeof(digest), esp_flash_encryption_enabled());
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SPI write failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SPI write failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SPI write failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SPI write failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SPI write failed: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return 
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
              0
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                   ;
    }
    Cache_Read_Enable(0);
    return 
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
          1
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
              ;
}
...
esp_err_t esp_secure_boot_permanently_enable(void) {
    ...
    {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "bootloader secure boot is already enabled, continuing.." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "bootloader secure boot is already enabled, continuing.." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "bootloader secure boot is already enabled, continuing.." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "bootloader secure boot is already enabled, continuing.." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "bootloader secure boot is already enabled, continuing.." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0;
    }

    err = esp_image_verify_bootloader(&image_len);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "bootloader image appears invalid! error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "bootloader image appears invalid! error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "bootloader image appears invalid! error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "bootloader image appears invalid! error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "bootloader image appears invalid! error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return err;
    }

    uint32_t dis_reg = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x000))) >= 0x3ff00000) && (((0x3ff5A000 + 0x000))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x000))) >= 0x3ff00000) && (((0x3ff5A000 + 0x000))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x000))) >= 0x3ff00000) && (((0x3ff5A000 + 0x000))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 120, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x000))) >= 0x3ff00000) && (((0x3ff5A000 + 0x000))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x000))); });
    
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
   _Bool 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
        efuse_key_read_protected = dis_reg & (1<<17);
    
# 122 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
   _Bool 
# 122 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
        efuse_key_write_protected = dis_reg & (1<<8);
    if (efuse_key_read_protected == 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
                                   0
        
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
       && efuse_key_write_protected == 
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
                                       0
        
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
       && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x058))) >= 0x3ff00000) && (((0x3ff5A000 + 0x058))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x058))) >= 0x3ff00000) && (((0x3ff5A000 + 0x058))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x058))) >= 0x3ff00000) && (((0x3ff5A000 + 0x058))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 125, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x058))) >= 0x3ff00000) && (((0x3ff5A000 + 0x058))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x058))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x05c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x05c))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x05c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x05c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x05c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x05c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 126, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x05c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x05c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x05c))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x060))) >= 0x3ff00000) && (((0x3ff5A000 + 0x060))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x060))) >= 0x3ff00000) && (((0x3ff5A000 + 0x060))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x060))) >= 0x3ff00000) && (((0x3ff5A000 + 0x060))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 127, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x060))) >= 0x3ff00000) && (((0x3ff5A000 + 0x060))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x060))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x064))) >= 0x3ff00000) && (((0x3ff5A000 + 0x064))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x064))) >= 0x3ff00000) && (((0x3ff5A000 + 0x064))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x064))) >= 0x3ff00000) && (((0x3ff5A000 + 0x064))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 128, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x064))) >= 0x3ff00000) && (((0x3ff5A000 + 0x064))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x064))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x068))) >= 0x3ff00000) && (((0x3ff5A000 + 0x068))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x068))) >= 0x3ff00000) && (((0x3ff5A000 + 0x068))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x068))) >= 0x3ff00000) && (((0x3ff5A000 + 0x068))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 129, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x068))) >= 0x3ff00000) && (((0x3ff5A000 + 0x068))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x068))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x06c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x06c))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x06c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x06c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x06c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x06c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 130, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x06c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x06c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x06c))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x070))) >= 0x3ff00000) && (((0x3ff5A000 + 0x070))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x070))) >= 0x3ff00000) && (((0x3ff5A000 + 0x070))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x070))) >= 0x3ff00000) && (((0x3ff5A000 + 0x070))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 131, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x070))) >= 0x3ff00000) && (((0x3ff5A000 + 0x070))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x070))); }) == 0
        && ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x074))) >= 0x3ff00000) && (((0x3ff5A000 + 0x074))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x074))) >= 0x3ff00000) && (((0x3ff5A000 + 0x074))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x074))) >= 0x3ff00000) && (((0x3ff5A000 + 0x074))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 132, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x074))) >= 0x3ff00000) && (((0x3ff5A000 + 0x074))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x074))); }) == 0) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Generating new secure boot key..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Generating new secure boot key..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Generating new secure boot key..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Generating new secure boot key..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Generating new secure boot key..." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        uint32_t buf[8];
        bootloader_fill_random(buf, sizeof(buf));
        for (int i = 0; i < 8; i++) {
            do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "EFUSE_BLK2_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "EFUSE_BLK2_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "EFUSE_BLK2_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "EFUSE_BLK2_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "EFUSE_BLK2_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } } while(0); } while(0);
            ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x0b8) + 4*i)) >= 0x3ff00000) && (((0x3ff5A000 + 0x0b8) + 4*i)) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x0b8) + 4*i)) >= 0x3ff00000) && (((0x3ff5A000 + 0x0b8) + 4*i)) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff5A000 + 0x0b8) + 4*i)) >= 0x3ff00000) && (((0x3ff5A000 + 0x0b8) + 4*i)) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 138, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff5A000 + 0x0b8) + 4*i)) >= 0x3ff00000) && (((0x3ff5A000 + 0x0b8) + 4*i)) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x0b8) + 4*i)) = (buf[i]); });
        }
        ...
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x01c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x01c))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x01c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x01c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff5A000 + 0x01c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x01c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 143, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff5A000 + 0x01c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x01c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x01c))) = ((1<<8) | (1<<17)); });
        burn_efuses();
        efuse_key_read_protected = 
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
                                  1
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                                      ;
        efuse_key_write_protected = 
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
                                   1
# 146 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
                                       ;

    } else {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Using pre-loaded secure boot key in EFUSE block 2" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Using pre-loaded secure boot key in EFUSE block 2" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Using pre-loaded secure boot key in EFUSE block 2" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Using pre-loaded secure boot key in EFUSE block 2" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Using pre-loaded secure boot key in EFUSE block 2" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }

    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Generating secure boot digest..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Generating secure boot digest..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Generating secure boot digest..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Generating secure boot digest..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Generating secure boot digest..." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    if (
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c" 3 4
       0 
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c"
             == secure_boot_generate(image_len)){
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "secure boot generation failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "secure boot generation failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "secure boot generation failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "secure boot generation failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "secure boot generation failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Digest generation complete." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Digest generation complete." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Digest generation complete." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Digest generation complete." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Digest generation complete." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);


    if (!efuse_key_read_protected) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Pre-loaded key is not read protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Pre-loaded key is not read protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Pre-loaded key is not read protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Pre-loaded key is not read protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Pre-loaded key is not read protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }
    if (!efuse_key_write_protected) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Pre-loaded key is not write protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Pre-loaded key is not write protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Pre-loaded key is not write protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Pre-loaded key is not write protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Pre-loaded key is not write protected. Refusing to blow secure boot efuse." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }


    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "blowing secure boot efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "blowing secure boot efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "blowing secure boot efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "blowing secure boot efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "blowing secure boot efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "before updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 171, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); })); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "before updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 171, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); })); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "before updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 171, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); })); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "before updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 171, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); })); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "before updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 171, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); })); } } while(0); } while(0);
    ...
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x034))) >= 0x3ff00000) && (((0x3ff5A000 + 0x034))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x034))) >= 0x3ff00000) && (((0x3ff5A000 + 0x034))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff5A000 + 0x034))) >= 0x3ff00000) && (((0x3ff5A000 + 0x034))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 189, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff5A000 + 0x034))) >= 0x3ff00000) && (((0x3ff5A000 + 0x034))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x034))) = (new_wdata6); });
    burn_efuses();
    uint32_t after = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/bootloader_support/src/secure_boot.c", 191, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); });
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "after updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, after); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "after updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, after); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "after updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, after); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "after updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, after); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "after updating, EFUSE_BLK0_RDATA6 %x" "\033[0m" "\n", esp_log_timestamp(), TAG, after); } } while(0); } while(0);
    if (after & ((1UL << (4)))) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "secure boot is now enabled for bootloader image" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "secure boot is now enabled for bootloader image" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "secure boot is now enabled for bootloader image" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "secure boot is now enabled for bootloader image" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "secure boot is now enabled for bootloader image" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0;
    } else {



        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "secure boot not enabled for bootloader image, EFUSE_RD_ABS_DONE_0 is probably write protected!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "secure boot not enabled for bootloader image, EFUSE_RD_ABS_DONE_0 is probably write protected!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "secure boot not enabled for bootloader image, EFUSE_RD_ABS_DONE_0 is probably write protected!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "secure boot not enabled for bootloader image, EFUSE_RD_ABS_DONE_0 is probably write protected!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "secure boot not enabled for bootloader image, EFUSE_RD_ABS_DONE_0 is probably write protected!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
