# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\smartconfig_ack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 130 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_smartconfig.h"
                                        enable);
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 2

static const char *TAG = "smartconfig";


static 
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
      _Bool 
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
           s_sc_ack_send = 
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                           0
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
...
static void sc_ack_send_task(void *pvParameters)
{
    ...
    int remote_port = (ack->type == SC_ACK_TYPE_ESPTOUCH) ? 18266 : 10000;
    struct sockaddr_in server_addr;
    socklen_t sin_size = sizeof(server_addr);
    int send_sock = -1;
    int optval = 1;
    int sendlen;
    int ack_len = (ack->type == SC_ACK_TYPE_ESPTOUCH) ? 11 : 7;
    ...
    vTaskDelay(200 / ( ( TickType_t ) 1000 / ( 100 ) ));
    ...
    while (s_sc_ack_send) {
        ...
        if ((0 == ret) && (local_ip.ip.addr != ((u32_t)0x00000000UL))) {
            ...
            vTaskDelay((TickType_t)(100 / ( ( TickType_t ) 1000 / ( 100 ) )));
        }
    }
...
_end:
    ...
    free(ack);
    vTaskDelete(
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
               ((void *)0)
# 126 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                   );
}
...
{
    sc_ack_t *ack = 
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                   ((void *)0)
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                       ;

    if (param == 
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                ((void *)0)
# 133 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                    ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return;
    }

    ack = malloc(sizeof(sc_ack_t));
    if (ack == 
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
              ((void *)0)
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                  ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return;
    }
    memcpy(ack, param, sizeof(sc_ack_t));

    s_sc_ack_send = 
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                   1
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                       ;

    if (xTaskCreate(sc_ack_send_task, "sc_ack_send_task", 2048, ack, 2, 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                                                                                                            ((void *)0)
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                                                                                                                ) != ( ( ( BaseType_t ) 1 ) )) {
...
{
    s_sc_ack_send = 
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c" 3 4
                   0
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/smartconfig_ack/smartconfig_ack.c"
                        ;
}
