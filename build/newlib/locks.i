# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\newlib//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/portmacro.h" 1
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/freertos/include/freertos/portable.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 2
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
static portMUX_TYPE lock_init_spinlock = { .owner = 0xB33FFFFF, .count = 0, };
...
static void __attribute__((section(".iram1"))) lock_init_generic(_lock_t *lock, uint8_t mutex_type) {
    vTaskEnterCritical(&lock_init_spinlock);
    if (xTaskGetSchedulerState() == ( ( BaseType_t ) 1 )) {

        vTaskExitCritical(&lock_init_spinlock);
        return;
    }
    ...
    {
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
...
void __attribute__((section(".iram1"))) _lock_init(_lock_t *lock) {
    *lock = 0;
    lock_init_generic(lock, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1"))) _lock_init_recursive(_lock_t *lock) {
    *lock = 0;
    lock_init_generic(lock, ( ( uint8_t ) 4U ));
}
# 108 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
void __attribute__((section(".iram1"))) _lock_close(_lock_t *lock) {
    vTaskEnterCritical(&lock_init_spinlock);
    if (*lock) {
        SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);

        if (!(xQueueGetMutexHolder( ( h ) ) == 
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
       ((void *)0)
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c", 113, __FUNCTION__); abort(); };

        vQueueDelete( ( QueueHandle_t ) ( h ) );
        *lock = 0;
    }
    vTaskExitCritical(&lock_init_spinlock);
}
...
static int __attribute__((section(".iram1"))) lock_acquire_generic(_lock_t *lock, uint32_t delay, uint8_t mutex_type) {
    SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);
    if (!h) {
        if (xTaskGetSchedulerState() == ( ( BaseType_t ) 1 )) {
            return 0;
        ...
        if (!(h != 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
       ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c", 134, __FUNCTION__); abort(); };
    }

    BaseType_t success;
    if (xPortInIsrContext()) {

        if (mutex_type == ( ( uint8_t ) 4U )) {
            abort();
        }
        BaseType_t higher_task_woken = 
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
                                      0
# 143 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
                                           ;
        success = xQueueReceiveFromISR( ( QueueHandle_t ) ( h ), 
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
                 ((void *)0)
# 144 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
                 , ( &higher_task_woken ) );
        if (!success && delay > 0) {
            abort();
        }
        ...
        if (mutex_type == ( ( uint8_t ) 4U )) {
            success = xQueueTakeMutexRecursive( ( h ), ( delay ) );
        } else {
            success = xQueueGenericReceive( ( QueueHandle_t ) ( h ), 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
                     ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
                     , ( delay ), ( ( BaseType_t ) 0 ) );
        }
    }

    return (success == ( ( BaseType_t ) 1 )) ? 0 : -1;
}

void __attribute__((section(".iram1"))) _lock_acquire(_lock_t *lock) {
    lock_acquire_generic(lock, ( TickType_t ) 0xffffffffUL, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1"))) _lock_acquire_recursive(_lock_t *lock) {
    lock_acquire_generic(lock, ( TickType_t ) 0xffffffffUL, ( ( uint8_t ) 4U ));
}

int __attribute__((section(".iram1"))) _lock_try_acquire(_lock_t *lock) {
    return lock_acquire_generic(lock, 0, ( ( uint8_t ) 1U ));
}

int __attribute__((section(".iram1"))) _lock_try_acquire_recursive(_lock_t *lock) {
    return lock_acquire_generic(lock, 0, ( ( uint8_t ) 4U ));
}




static void __attribute__((section(".iram1"))) lock_release_generic(_lock_t *lock, uint8_t mutex_type) {
    SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);
    if (h == 
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
            ((void *)0)
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
                ) {
    ...
    if (xPortInIsrContext()) {
        ...
        BaseType_t higher_task_woken = 
# 196 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
                                      0
# 196 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
                                           ;
        xQueueGiveFromISR( ( QueueHandle_t ) ( h ), ( &higher_task_woken ) );
        if (higher_task_woken) {
            {; _frxt_setup_switch();};
        }
    } else {
        if (mutex_type == ( ( uint8_t ) 4U )) {
            xQueueGiveMutexRecursive( ( h ) );
        } else {
            xQueueGenericSend( ( QueueHandle_t ) ( h ), 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c" 3 4
           ((void *)0)
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/locks.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
}

void __attribute__((section(".iram1"))) _lock_release(_lock_t *lock) {
    lock_release_generic(lock, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1"))) _lock_release_recursive(_lock_t *lock) {
    lock_release_generic(lock, ( ( uint8_t ) 4U ));
}
