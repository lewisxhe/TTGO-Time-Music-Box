# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\newlib//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
...
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/xtensa/config/core-isa.h" 1
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/reent.h" 1
# 99 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/reent.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/reent.h" 2
...
struct timeval;
struct timezone;
# 140 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/reent.h"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
int setitimer (int __which, const struct itimerval *restrict __value, struct itimerval *restrict __ovalue)
                                            ;
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/sys/times.h" 1
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/sys/times.h"
struct tms {
 clock_t tms_utime;
 clock_t tms_stime;
 clock_t tms_cutime;
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/esp_attr.h" 1
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/frc_timer_reg.h" 1
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/ets_sys.h" 1
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
...
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/build/include/sdkconfig.h" 1
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/include/limits.h" 1
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 2
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
static uint64_t get_rtc_time_us()
{
    const uint64_t ticks = rtc_time_get();
    const uint32_t cal = esp_clk_slowclk_cal_get();
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
    const uint64_t ticks_low = ticks & 0xffffffffUL;
    const uint64_t ticks_high = ticks >> 32;
    return ((ticks_low * cal) >> 19) +
           ((ticks_high * cal) << (32 - 19));
}
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
...
static void set_boot_time(uint64_t time_us)
{
    ...
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 101, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x54))) = ((uint32_t) (time_us & 0xffffffff)); });
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 102, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x58))) = ((uint32_t) (time_us >> 32)); });
...
static uint64_t get_boot_time()
{
    ...
    result = ((uint64_t) ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 114, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48000 + 0x54))) >= 0x3ff00000) && (((0x3ff48000 + 0x54))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x54))); })) + (((uint64_t) ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 114, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48000 + 0x58))) >= 0x3ff00000) && (((0x3ff48000 + 0x58))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x58))); })) << 32);
...
static uint64_t adjust_boot_time()
{
    ...
    if (adjtime_start > 0) {
        ...
        int64_t correction = (since_boot - adjtime_start) >> 6;
        if (correction > 0) {
...
int adjtime(const struct timeval *delta, struct timeval *outdelta)
{
    ...
    if(delta != 
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 3 4
               ((void *)0)
# 185 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
                   ){
        int64_t sec = delta->tv_sec;
        int64_t usec = delta->tv_usec;
        if(llabs(sec) > ((0x7fffffff / 1000000L) - 1L)) {
            return -1;
        }
    ...
    if(outdelta != 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 3 4
                  ((void *)0)
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
                      ){
        _lock_acquire(&s_adjust_time_lock);
        adjust_boot_time();
        if (adjtime_start != 0) {
...
{
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
    const int64_t ticks = (int64_t) rtc_time_get();
    const uint32_t cur_cal = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 233, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x50))); });
    int32_t cal_diff = (int32_t) (cur_cal - new_cal);
    int64_t boot_time_diff = ticks * cal_diff / (1LL << 19);
    uint64_t boot_time_adj = get_boot_time() + boot_time_diff;
    set_boot_time(boot_time_adj);

    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 239, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x50))) = (new_cal); });
}

uint32_t esp_clk_slowclk_cal_get()
{
    return ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c", 244, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48000 + 0x50))) >= 0x3ff00000) && (((0x3ff48000 + 0x50))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0x50))); });
}
...
clock_t __attribute__((section(".iram1"))) _times_r(struct _reent *r, struct tms *ptms)
{
    clock_t t = xTaskGetTickCount() * (( ( TickType_t ) 1000 / ( 100 ) ) * 1000 / 1000);
    ptms->tms_cstime = 0;
    ptms->tms_cutime = 0;
    ptms->tms_stime = t;
    ptms->tms_utime = 0;
    struct timeval tv = {0, 0};
    _gettimeofday_r(r, &tv, 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c" 3 4
                           ((void *)0)
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/newlib/time.c"
                               );
...
int __attribute__((section(".iram1"))) _gettimeofday_r(struct _reent *r, struct timeval *tv, void *tz)
{
    (void) tz;
...
{
    const int us_per_tick = ( ( TickType_t ) 1000 / ( 100 ) ) * 1000;
    if (us < us_per_tick) {
