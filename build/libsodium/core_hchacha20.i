# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c" 2
...
# 4 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c" 2
...
# 6 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_core_hchacha20.h" 2
...
# 6 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c" 2
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c" 2
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c"
int
                      ...
                      const unsigned char *k, const unsigned char *c)
{
    ...
    if (c == 
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c" 3 4
            ((void *)0)
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_core/hchacha20/core_hchacha20.c"
                ) {
        x0 = 0x61707865;
        x1 = 0x3320646e;
        x2 = 0x79622d32;
    ...
    for (i = 0; i < 10; i++) {
        do { x0 += x4; x12 = rotl32((x12 ^ x0), (16)); x8 += x12; x4 = rotl32((x4 ^ x8), (12)); x0 += x4; x12 = rotl32((x12 ^ x0), (8)); x8 += x12; x4 = rotl32((x4 ^ x8), (7)); } while(0);
        do { x1 += x5; x13 = rotl32((x13 ^ x1), (16)); x9 += x13; x5 = rotl32((x5 ^ x9), (12)); x1 += x5; x13 = rotl32((x13 ^ x1), (8)); x9 += x13; x5 = rotl32((x5 ^ x9), (7)); } while(0);
        do { x2 += x6; x14 = rotl32((x14 ^ x2), (16)); x10 += x14; x6 = rotl32((x6 ^ x10), (12)); x2 += x6; x14 = rotl32((x14 ^ x2), (8)); x10 += x14; x6 = rotl32((x6 ^ x10), (7)); } while(0);
        do { x3 += x7; x15 = rotl32((x15 ^ x3), (16)); x11 += x15; x7 = rotl32((x7 ^ x11), (12)); x3 += x7; x15 = rotl32((x15 ^ x3), (8)); x11 += x15; x7 = rotl32((x7 ^ x11), (7)); } while(0);
        do { x0 += x5; x15 = rotl32((x15 ^ x0), (16)); x10 += x15; x5 = rotl32((x5 ^ x10), (12)); x0 += x5; x15 = rotl32((x15 ^ x0), (8)); x10 += x15; x5 = rotl32((x5 ^ x10), (7)); } while(0);
        do { x1 += x6; x12 = rotl32((x12 ^ x1), (16)); x11 += x12; x6 = rotl32((x6 ^ x11), (12)); x1 += x6; x12 = rotl32((x12 ^ x1), (8)); x11 += x12; x6 = rotl32((x6 ^ x11), (7)); } while(0);
        do { x2 += x7; x13 = rotl32((x13 ^ x2), (16)); x8 += x13; x7 = rotl32((x7 ^ x8), (12)); x2 += x7; x13 = rotl32((x13 ^ x2), (8)); x8 += x13; x7 = rotl32((x7 ^ x8), (7)); } while(0);
        do { x3 += x4; x14 = rotl32((x14 ^ x3), (16)); x9 += x14; x4 = rotl32((x4 ^ x9), (12)); x3 += x4; x14 = rotl32((x14 ^ x3), (8)); x9 += x14; x4 = rotl32((x4 ^ x9), (7)); } while(0);
    }
