# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
# 4 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
int crypto_box_open_afternm(unsigned char *m, const unsigned char *c,
                            ...
                            const unsigned char *k)
            __attribute__ ((warn_unused_result));
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
int crypto_secretbox_open(unsigned char *m, const unsigned char *c,
                          ...
                          const unsigned char *k)
            __attribute__ ((warn_unused_result));
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_easy.c" 2
                        ...
                        const unsigned char *k)
{
    ...
    return crypto_box_detached_afternm(c + 16U, c, m, mlen, n,
                                       k);
}
                ...
                const unsigned char *pk, const unsigned char *sk)
{
    ...
    return crypto_box_detached(c + 16U, c, m, mlen, n,
                               pk, sk);
}
                             ...
                             const unsigned char *k)
{
    ...
    return crypto_box_open_detached_afternm(m, c + 16U, c,
                                            clen - 16U,
                                            n, k);
}
                     ...
                     const unsigned char *pk, const unsigned char *sk)
{
    ...
    return crypto_box_open_detached(m, c + 16U, c,
                                    clen - 16U,
                                    n, pk, sk);
}
