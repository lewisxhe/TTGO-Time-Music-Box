# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
...
int crypto_hash_sha512_final(crypto_hash_sha512_state *state,
                             unsigned char *out);
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
...
int crypto_sign_ed25519ph_final_verify(crypto_sign_ed25519ph_state *state,
                                       ...
                                       const unsigned char *pk)
            __attribute__ ((warn_unused_result));
# 6 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
...
int _crypto_sign_ed25519_verify_detached(const unsigned char *sig,
                                         ...
                                         const unsigned char *pk,
                                         int prehashed);
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 2
                              ...
                              const unsigned char *sk, int prehashed)
{
    ...
    crypto_core_curve25519_ref10_sc_muladd(sig + 32, hram, az, nonce);

    sodium_memzero(az, sizeof az);

    if (siglen_p != 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 3 4
                   ((void *)0)
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c"
                       ) {
        *siglen_p = 64U;
    }
    return 0;
                    ...
                    const unsigned char *sk)
{
    ...
    memmove(sm + 64U, m, mlen);

    if (crypto_sign_ed25519_detached(
            sm, &siglen, sm + 64U, mlen, sk) != 0 ||
        siglen != 64U) {
        if (smlen_p != 
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 3 4
                      ((void *)0)
# 89 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c"
                          ) {
            *smlen_p = 0;
        }
        memset(sm, 0, mlen + 64U);
        return -1;
    }


    if (smlen_p != 
# 97 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c" 3 4
                  ((void *)0)
# 97 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign.c"
                      ) {
        *smlen_p = mlen + siglen;
    }
    return 0;
