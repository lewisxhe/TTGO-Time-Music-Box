# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 2
...
int crypto_box_open_afternm(unsigned char *m, const unsigned char *c,
                            ...
                            const unsigned char *k)
            __attribute__ ((warn_unused_result));
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 2
...
# 6 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 2
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 2
                       ...
                       const unsigned char *pk1, const unsigned char *pk2)
{
    ...
    crypto_generichash_init(&st, 
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c" 3 4
                                ((void *)0)
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_box/crypto_box_seal.c"
                                    , 0U, 24U);
    crypto_generichash_update(&st, pk1, 32U);
    crypto_generichash_update(&st, pk2, 32U);
    crypto_generichash_final(&st, nonce, 24U);
                ...
                unsigned long long mlen, const unsigned char *pk)
{
    ...
    unsigned char epk[32U];
    unsigned char esk[32U];
    int ret;
    ...
    ret = crypto_box_easy(c + 32U, m, mlen,
                          nonce, pk, esk);
                     ...
                     const unsigned char *pk, const unsigned char *sk)
{
    ...
    (void) sizeof(char[(32U < (32U + 16U)) ? 1 : -1]);
    return crypto_box_open_easy(m, c + 32U,
                                clen - 32U,
                                nonce, c, sk);
}
