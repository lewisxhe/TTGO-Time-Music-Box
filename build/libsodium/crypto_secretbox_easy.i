# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 4 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox.h" 1



# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox.h" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox_xsalsa20poly1305.h" 1



# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox_xsalsa20poly1305.h" 2
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox_xsalsa20poly1305.h"
__attribute__ ((visibility ("default")))
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox.h" 2
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_secretbox.h"
__attribute__ ((visibility ("default")))
...
int crypto_secretbox_open(unsigned char *m, const unsigned char *c,
                          ...
                          const unsigned char *k)
            __attribute__ ((warn_unused_result));
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 2
                          ...
                          const unsigned char *k)
{
    ...
    unsigned char subkey[32U];
    unsigned long long i;
    unsigned long long mlen0;

    crypto_core_hsalsa20(subkey, n, k, 
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 3 4
                                      ((void *)0)
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c"
                                          );
    ...
    memset(block0, 0U, (16U + 16U));
    (void) sizeof(char[(64U >= (16U + 16U)) ? 1 : -1]);
    mlen0 = mlen;
    if (mlen0 > 64U - (16U + 16U)) {
        mlen0 = 64U - (16U + 16U);
    }
    for (i = 0U; i < mlen0; i++) {
        block0[i + (16U + 16U)] = m[i];
    }
    crypto_stream_salsa20_xor(block0, block0,
                              mlen0 + (16U + 16U),
                              n + 16, subkey);
    (void) sizeof(char[((16U + 16U) >= 32U) ? 1 : -1])
                                                         ;
    crypto_onetimeauth_poly1305_init(&state, block0);

    for (i = 0U; i < mlen0; i++) {
        c[i] = block0[(16U + 16U) + i];
    }
...
crypto_secretbox_easy(unsigned char *c, const unsigned char *m,
                      ...
                      const unsigned char *k)
{
    if (mlen > 0xffffffffU - 16U) {
        return -1;
    }
    return crypto_secretbox_detached(c + 16U,
                                     c, m, mlen, n, k);
}
                               ...
                               const unsigned char *k)
{
    ...
    crypto_core_hsalsa20(subkey, n, k, 
# 93 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 3 4
                                      ((void *)0)
# 93 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c"
                                          );
    crypto_stream_salsa20(block0, 32U,
                          n + 16, subkey);
    ...
    if (m == 
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c" 3 4
            ((void *)0)
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c"
                ) {
        return 0;
    }
    if (((uintptr_t) c >= (uintptr_t) m &&
    ...
    for (i = 0U; i < mlen0; i++) {
        block0[(16U + 16U) + i] = c[i];
    }
    crypto_stream_salsa20_xor(block0, block0,
                              (16U + 16U) + mlen0,
                              n + 16, subkey);
    for (i = 0U; i < mlen0; i++) {
        m[i] = block0[i + (16U + 16U)];
    }
    if (clen > mlen0) {
                           ...
                           const unsigned char *k)
{
    ...
    return crypto_secretbox_open_detached(m, c + 16U, c,
                                          clen - 16U,
                                          n, k);
}
