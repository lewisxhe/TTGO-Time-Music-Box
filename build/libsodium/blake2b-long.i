# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
...
# 2 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 4 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 2
...
blake2b_long(void *pout, size_t outlen, const void *in, size_t inlen)
{
    ...
    if (outlen > 0xffffffffUL) {
        goto fail;
    }


    store32_le((outlen_bytes), ((uint32_t) outlen));
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
    if (outlen <= 64U) {
        do { ret = crypto_generichash_blake2b_init(&blake_state, 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 3 4
       ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
       , 0U, outlen); if (ret < 0) { goto fail; } } while ((void) 0, 0);
        ...
        uint32_t toproduce;
        uint8_t out_buffer[64U];
        uint8_t in_buffer[64U];
        do { ret = crypto_generichash_blake2b_init( &blake_state, 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 3 4
       ((void *)0)
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
       , 0U, 64U); if (ret < 0) { goto fail; } } while ((void) 0, 0)
                                                                          ;
        do { ret = crypto_generichash_blake2b_update(&blake_state, outlen_bytes, sizeof(outlen_bytes)); if (ret < 0) { goto fail; } } while ((void) 0, 0)
                                                                    ;
        do { ret = crypto_generichash_blake2b_update( &blake_state, (const unsigned char *) in, inlen); if (ret < 0) { goto fail; } } while ((void) 0, 0)
                                                             ;
        do { ret = crypto_generichash_blake2b_final( &blake_state, out_buffer, 64U); if (ret < 0) { goto fail; } } while ((void) 0, 0)
                                                                            ;
        memcpy(out, out_buffer, 64U / 2);
        out += 64U / 2;
        toproduce =
            (uint32_t) outlen - 64U / 2;

        while (toproduce > 64U) {
            memcpy(in_buffer, out_buffer, 64U);
            do { ret = crypto_generichash_blake2b( out_buffer, 64U, in_buffer, 64U, 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 3 4
           ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
           , 0U); if (ret < 0) { goto fail; } } while ((void) 0, 0)
        ...
        memcpy(in_buffer, out_buffer, 64U);
        do { ret = crypto_generichash_blake2b(out_buffer, toproduce, in_buffer, 64U, 
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c" 3 4
       ((void *)0)
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_pwhash/argon2/blake2b-long.c"
       , 0U); if (ret < 0) { goto fail; } } while ((void) 0, 0)
