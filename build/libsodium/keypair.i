# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
int crypto_hash_sha512_final(crypto_hash_sha512_state *state,
                             unsigned char *out);
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
# 6 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
int crypto_sign_ed25519ph_final_verify(crypto_sign_ed25519ph_state *state,
                                       ...
                                       const unsigned char *pk)
            __attribute__ ((warn_unused_result));
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/keypair.c" 2
                                     ...
                                     const unsigned char *ed25519_pk)
{
    crypto_core_curve25519_ref10_ge_p3 A;
    crypto_core_curve25519_ref10_fe x;
    crypto_core_curve25519_ref10_fe one_minus_y;

    if (crypto_core_curve25519_ref10_ge_frombytes_negate_vartime(&A, ed25519_pk) != 0) {
        return -1;
    }
    crypto_core_curve25519_ref10_fe_1(one_minus_y);
    crypto_core_curve25519_ref10_fe_sub(one_minus_y, one_minus_y, A.Y);
    crypto_core_curve25519_ref10_fe_invert(one_minus_y, one_minus_y);
    crypto_core_curve25519_ref10_fe_1(x);
    crypto_core_curve25519_ref10_fe_add(x, x, A.Y);
    crypto_core_curve25519_ref10_fe_mul(x, x, one_minus_y);
    crypto_core_curve25519_ref10_fe_tobytes(curve25519_pk, x);
