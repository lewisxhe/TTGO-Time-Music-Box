# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c"
...
# 3 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 4 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 5 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
int crypto_hash_sha512_final(crypto_hash_sha512_state *state,
                             unsigned char *out);
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_sign_edwards25519sha512batch.h" 1
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_sign_edwards25519sha512batch.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_sign_edwards25519sha512batch.h" 2
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/include/sodium/crypto_sign_edwards25519sha512batch.h"
__attribute__ ((visibility ("default")))
...
int crypto_sign_edwards25519sha512batch_keypair(unsigned char *pk,
                                                unsigned char *sk)
       __attribute__ ((deprecated));
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/libsodium/libsodium/src/libsodium/crypto_sign/ed25519/ref10/obsolete.c" 2
                                            ...
                                            unsigned char *sk)
{
    ...
    sk[31] &= 63;
    sk[31] |= 64;
    crypto_core_curve25519_ref10_ge_scalarmult_base(&A, sk);
    crypto_core_curve25519_ref10_ge_p3_tobytes(pk, &A);
                                    ...
                                    const unsigned char *sk)
{
    ...
    crypto_core_curve25519_ref10_ge_p3 A;
    crypto_core_curve25519_ref10_ge_p3 R;
    ...
    crypto_core_curve25519_ref10_ge_scalarmult_base(&A, sk);
    crypto_core_curve25519_ref10_ge_p3_tobytes(sig + 32, &A);
    crypto_core_curve25519_ref10_sc_reduce(nonce);
    crypto_core_curve25519_ref10_ge_scalarmult_base(&R, nonce);
    crypto_core_curve25519_ref10_ge_p3_tobytes(sig, &R);
    crypto_hash_sha512_init(&hs);
    crypto_hash_sha512_update(&hs, sig, 32);
    crypto_hash_sha512_update(&hs, m, mlen);
    crypto_hash_sha512_final(&hs, hram);
    crypto_core_curve25519_ref10_sc_reduce(hram);
    crypto_core_curve25519_ref10_sc_muladd(sig + 32, hram, nonce, sk);
                                         ...
                                         const unsigned char *pk)
{
    ...
    unsigned long long mlen;
    crypto_core_curve25519_ref10_ge_cached Ai;
    crypto_core_curve25519_ref10_ge_p1p1 csa;
    crypto_core_curve25519_ref10_ge_p2 cs;
    crypto_core_curve25519_ref10_ge_p3 A;
    crypto_core_curve25519_ref10_ge_p3 R;
    crypto_core_curve25519_ref10_ge_p3 cs3;

    *mlen_p = 0;
    if (smlen < 64 || smlen > 0xffffffffU) {
        return -1;
    }
    mlen = smlen - 64;
    if (sm[smlen - 1] & 224) {
    ...
    if (crypto_core_curve25519_ref10_ge_frombytes_negate_vartime(&A, pk) != 0 ||
        crypto_core_curve25519_ref10_ge_frombytes_negate_vartime(&R, sm) != 0) {
        return -1;
    }
    crypto_core_curve25519_ref10_ge_p3_to_cached(&Ai, &A);
    crypto_hash_sha512(h, sm, mlen + 32);
    crypto_core_curve25519_ref10_sc_reduce(h);
    crypto_core_curve25519_ref10_ge_scalarmult_vartime(&cs3, h, &R);
    crypto_core_curve25519_ref10_ge_add(&csa, &cs3, &Ai);
    crypto_core_curve25519_ref10_ge_p1p1_to_p2(&cs, &csa);
    crypto_core_curve25519_ref10_ge_tobytes(t1, &cs);
    t1[31] ^= 1 << 7;
    crypto_core_curve25519_ref10_ge_scalarmult_base(&R, sm + 32 + mlen);
    crypto_core_curve25519_ref10_ge_p3_tobytes(t2, &R);
