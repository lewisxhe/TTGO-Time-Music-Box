# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\heap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_private.h" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_private.h" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 2
...
static void register_heap(heap_t *region)
{
    ...
    if (region->heap != 
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                       ((void *)0)
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                           ) {
        do { if (3 >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "New heap initialised at %p" "\033[0m" "\n", esp_log_timestamp(), TAG, region->heap); }} while(0);
    }
}
...
void heap_caps_enable_nonos_stack_heaps()
{
    ...
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        ...
        if (heap->heap == 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                             ) {
            register_heap(heap);
            if (heap->heap != 
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                                 ) {
...
static void disable_mem_region(soc_memory_region_t *regions, intptr_t from, intptr_t to)
{
    ...
    for (int i = 0; i < soc_memory_region_count; i++) {
        ...
        if (regStart >= from && regEnd <= to) {
            ...
            do { if (3 >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "region %d: hole punching is not supported!" "\033[0m" "\n", esp_log_timestamp(), TAG, i); }} while(0);
            regions->type = -1;
        }
    }
}
...
void heap_caps_init()
{
    ...
    disable_mem_region(regions, (intptr_t)&_data_start, (intptr_t)&_heap_start);
    disable_mem_region(regions, (intptr_t)&_init_start, (intptr_t)&_iram_text_end);
    ...
    do { if (3 >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Initializing. RAM available for dynamic allocation:" "\033[0m" "\n", esp_log_timestamp(), TAG); }} while(0);
    for (int i = 0; i < soc_memory_region_count; i++) {
        soc_memory_region_t *region = &regions[i];
        ...
        heap_idx++;
        ((heap_idx <= num_heaps) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c", 156, __func__, "heap_idx <= num_heaps"));
        ...
        if (type->startup_stack) {
            ...
            heap->heap = 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                        ((void *)0)
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                            ;
        } else {
            register_heap(heap);
        }
        ((heap)->next.sle_next) = 
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                                ((void *)0)
# 168 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                                    ;

        do { if (3 >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "At %08X len %08X (%d KiB): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, region->start, region->size, region->size / 1024, type->name); }} while(0)
                                                                                    ;
    }

    ((heap_idx == num_heaps) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c", 174, __func__, "heap_idx == num_heaps"));




    ((((&registered_heaps)->slh_first == 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
   )) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c", 179, __func__, "SLIST_EMPTY(&registered_heaps)"));

    heap_t *heaps_array = 
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                             ;
    for (int i = 0; i < num_heaps; i++) {
        if (heap_caps_match(&temp_heaps[i], (1<<2)|(1<<11))) {

            heaps_array = multi_heap_malloc(temp_heaps[i].heap, sizeof(heap_t) * num_heaps);
            if (heaps_array != 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                              ((void *)0)
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                                  ) {
                break;
            }
        }
    ...
    ((heaps_array != 
# 191 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 191 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
   ) ? (void)0 : __assert_func ("D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c", 191, __func__, "heaps_array != NULL"));

    memcpy(heaps_array, temp_heaps, sizeof(heap_t)*num_heaps);


    for (int i = 0; i < num_heaps; i++) {
        if (heaps_array[i].heap != 
# 197 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                                  ((void *)0)
# 197 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                                      ) {
            multi_heap_set_lock(heaps_array[i].heap, &heaps_array[i].heap_mux);
        }
        if (i == 0) {
            do { (((&heaps_array[0]))->next.sle_next) = (((&registered_heaps))->slh_first); (((&registered_heaps))->slh_first) = (&heaps_array[0]); } while (0);
        } else {
            do { (((&heaps_array[i]))->next.sle_next) = (((&heaps_array[i-1]))->next.sle_next); (((&heaps_array[i-1]))->next.sle_next) = (&heaps_array[i]); } while (0);
        }
    }
}
...
esp_err_t heap_caps_add_region_with_caps(const uint32_t caps[], intptr_t start, intptr_t end)
{
    esp_err_t err = -1;
    if (caps == 
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
               ((void *)0) 
# 229 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                    || start == 0 || end == 0 || end <= start) {
        return 0x102;
    }
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
    heap_t *heap;
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
    ...
    if (p_new == 
# 263 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                ((void *)0)
# 263 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c" 3 4
                      ((void *)0)
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/heap/heap_caps_init.c"
                          ) {
        err = -1;
        goto done;
    }
    ...
    do { (((p_new))->next.sle_next) = (((&registered_heaps))->slh_first); (((&registered_heaps))->slh_first) = (p_new); } while (0);
