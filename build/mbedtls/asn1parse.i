# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
...
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 2
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
int mbedtls_asn1_get_len( unsigned char **p,
                  const unsigned char *end,
                  size_t *len )
{
    ...
    while( *p < end )
    {
        ...
        *p += buf->len;
        ...
        if( *p < end )
        {
            ...
            if( cur->next == 
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 3 4
                            ((void *)0) 
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
                                 )
                return( -0x006A );
    ...
    cur->next = 
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 3 4
               ((void *)0)
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
                   ;
...
{
    if( cur == 
# 351 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 3 4
              ((void *)0) 
# 351 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
                   )
        return;
...
void mbedtls_asn1_free_named_data_list( mbedtls_asn1_named_data **head )
{
    ...
    while( ( cur = *head ) != 
# 364 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 3 4
                             ((void *)0) 
# 364 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
                                  )
    {
        *head = cur->next;
...
{
    while( list != 
# 375 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c" 3 4
                  ((void *)0) 
# 375 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/asn1parse.c"
                       )
    {
        if( list->oid.len == len &&
