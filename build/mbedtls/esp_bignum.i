# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
# 23 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
...
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/bignum.h"
...
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/bignum.h" 2
...
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 1
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mod_power_prepare(uint32_t *x, uint32_t *y, uint32_t *m,
                                  uint32_t m_dash, uint32_t *rb, uint32_t len, 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
                                                                              _Bool 
# 40 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
                                                                                   again);


# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mod_power_getz(uint32_t *z, uint32_t len);


# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mult_prepare(uint32_t *x, uint32_t *y, uint32_t len);


# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mult_getz(uint32_t *z, uint32_t len);


# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_montgomery_mult_prepare(uint32_t *x, uint32_t *y, uint32_t *m,
                                        uint32_t m_dash, uint32_t len, 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
                                                                      _Bool 
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
                                                                           again);


# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 51 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_montgomery_mult_getz(uint32_t *z, uint32_t len);


# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mod_mult_prepare(uint32_t *x, uint32_t *y, uint32_t *m,
                                 uint32_t m_dash, uint32_t *rb, uint32_t len, 
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
                                                                             _Bool 
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
                                                                                  again);


# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h" 3 4
_Bool 
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/esp32/include/rom/bigint.h"
    ets_bigint_mod_mult_getz(uint32_t *m, uint32_t *z, uint32_t len);
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/hwcrypto_reg.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/hwcrypto_reg.h"
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/soc/esp32/include/soc/hwcrypto_reg.h" 2
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c" 2

static const __attribute__((unused)) char *TAG = "bignum";
# 72 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
...
void esp_mpi_acquire_hardware( void )
{
    ...
    (*(volatile uint32_t *)((((0x3ff00000 + 0x01C))))) = (((DPORT_REG_READ((0x3ff00000 + 0x01C))|((1<<2)))));

    (*(volatile uint32_t *)((((0x3ff00000 + 0x020))))) = (((DPORT_REG_READ((0x3ff00000 + 0x020)) & (~((1<<2) | (1<<4))))))

                                                         ;

    (*(volatile uint32_t *)((((0x3ff00000 + 0x490))))) = (((DPORT_REG_READ((0x3ff00000 + 0x490)) & (~(((1UL << (0))))))));

    while(DPORT_REG_READ((0x3ff02000 + 0x818)) != 1);
...
void esp_mpi_release_hardware( void )
{
    ...
    (*(volatile uint32_t *)((((0x3ff00000 + 0x020))))) = (((DPORT_REG_READ((0x3ff00000 + 0x020))|((1<<2)))));
    (*(volatile uint32_t *)((((0x3ff00000 + 0x01C))))) = (((DPORT_REG_READ((0x3ff00000 + 0x01C)) & (~((1<<2))))));

    _lock_release(&mpi_lock);
}
# 117 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
...
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
...
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
static inline int mem_block_to_mpi(mbedtls_mpi *x, uint32_t mem_base, int num_words)
{
    int ret = 0;

    do { if( ( ret = mbedtls_mpi_grow(x, num_words) ) != 0 ) goto cleanup; } while( 0 );
...
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
static mbedtls_mpi_uint modular_inverse(const mbedtls_mpi *M)
{
    ...
    return (mbedtls_mpi_uint)(0xffffffffUL - t + 1);
}
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
static int calculate_rinv(mbedtls_mpi *Rinv, const mbedtls_mpi *M, int num_words)
{
    ...
    mbedtls_mpi RR;
    mbedtls_mpi_init(&RR);
    do { if( ( ret = mbedtls_mpi_set_bit(&RR, num_bits * 2, 1) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_mod_mpi(Rinv, &RR, M) ) != 0 ) goto cleanup; } while( 0 );

 cleanup:
    mbedtls_mpi_free(&RR);
    return ret;
}
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
static inline void start_op(uint32_t op_reg)
{

    (*(volatile uint32_t *)(((0x3ff02000 + 0x814)))) = ((1));




    (*(volatile uint32_t *)((op_reg))) = ((1));
}
...
static inline void wait_op_complete(uint32_t op_reg)
{
    ...
    while(DPORT_REG_READ((0x3ff02000 + 0x814)) != 1)
       { }
...
int esp_mpi_mul_mpi_mod(mbedtls_mpi *Z, const mbedtls_mpi *X, const mbedtls_mpi *Y, const mbedtls_mpi *M)
{
    ...
    do { if( ( ret = calculate_rinv(&Rinv, M, num_words) ) != 0 ) goto cleanup; } while( 0 );
    ...
    mpi_to_mem_block(((0x3ff02000)+0x000), M, num_words);
    mpi_to_mem_block(((0x3ff02000)+0x600), X, num_words);
    mpi_to_mem_block(((0x3ff02000)+0x200), &Rinv, num_words);
    (*(volatile uint32_t *)(((0x3ff02000 + 0x800)))) = (((uint32_t)Mprime));


    (*(volatile uint32_t *)(((0x3ff02000 + 0x80c)))) = (((num_words / 16) - 1));


    start_op((0x3ff02000 + 0x810));

    wait_op_complete((0x3ff02000 + 0x810));
...
# 432 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/esp_bignum.c"
static int modular_multiply_finish(mbedtls_mpi *Z, const mbedtls_mpi *X, const mbedtls_mpi *Y, size_t num_words)
{
    int ret = 0;


    mpi_to_mem_block(((0x3ff02000)+0x600), Y, num_words);
    ...
    ret = mem_block_to_mpi(Z, ((0x3ff02000)+0x200), num_words);
