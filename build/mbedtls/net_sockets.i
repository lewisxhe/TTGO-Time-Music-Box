# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
...
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
...
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/lwip/include/lwip/port/lwipopts.h"
...
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
...
# 49 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 2
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
...
int mbedtls_net_connect( mbedtls_net_context *ctx, const char *host, const char *port, int proto )
{
    ...
    hints.ai_family = 0;
    hints.ai_socktype = proto == 1 ? 2 : 1;
    hints.ai_protocol = proto == 1 ? 17 : 6;
    ...
    ret = -0x0052;
    for ( cur = addr_list; cur != 
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                 ((void *)0)
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                                     ; cur = cur->ai_next ) {
...
int mbedtls_net_bind( mbedtls_net_context *ctx, const char *bind_ip, const char *port, int proto )
{
    ...
    ret = -0x0052;
    for ( cur = addr_list; cur != 
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                 ((void *)0)
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                                     ; cur = cur->ai_next ) {
        int fd = socket( cur->ai_family, cur->ai_socktype, cur->ai_protocol );
        if ( fd < 0 ) {
            ret = -0x0042;
...
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                       ((void *)0)
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                                           ;
        serv_addr = (struct sockaddr_in *)cur->ai_addr;
        serv_addr->sin_addr.s_addr = lwip_htonl(((u32_t)0x00000000UL));
...
static int net_would_block( const mbedtls_net_context *ctx, int *errout )
{
    ...
    if ( ( fcntl( ctx->fd, 3, 0) & 0x4000 ) != 0x4000 ) {
        return ( 0 );
    }
                        ...
                        void *client_ip, size_t buf_size, size_t *ip_len )
{
    ...
    if ( getsockopt( bind_ctx->fd, 0xfff, 0x1008,
    ...
    if ( type == 1 ) {
        ...
        ret = recvfrom( bind_ctx->fd, buf, sizeof( buf ), 0x01,
                        (struct sockaddr *) &client_addr, &n );

    }

    if ( ret < 0 ) {
        if ( net_would_block( bind_ctx, 
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                       ((void *)0) 
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                                            ) != 0 ) {
            return ( -0x6900 );
        }
    ...
    if ( type != 1 ) {
        ...
        if ( getsockname( client_ctx->fd,
                ...
                ( bind_ctx->fd = (int) socket( 2,
                                               2, 17 ) ) < 0 ||
                setsockopt( bind_ctx->fd, 0xfff, 0x0004,
    ...
    if ( client_ip != 
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                     ((void *)0) 
# 303 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                          ) {
...
int mbedtls_net_set_block( mbedtls_net_context *ctx )
{
    return ( fcntl( ctx->fd, 4, fcntl( ctx->fd, 3, 0 ) & ~0x4000 ) );
}
...
void mbedtls_net_usleep( unsigned long usec )
{
    ...
    select( 0, 
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
              ((void *)0)
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                  , 
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                    ((void *)0)
# 338 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                              ...
                              uint32_t timeout )
{
    ...
    (__extension__ (void)({ size_t __i; char *__tmp = (char *)&read_fds; for (__i = 0; __i < sizeof (*(&read_fds)); ++__i) *__tmp++ = 0; }));
    ((&read_fds)->fds_bits[(fd)/(sizeof (fd_mask) * 8)] |= (1L << ((fd) % (sizeof (fd_mask) * 8))));

    tv.tv_sec = timeout / 1000;
    tv.tv_usec = ( timeout % 1000 ) * 1000;

    ret = select( fd + 1, &read_fds, 
# 396 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                    ((void *)0)
# 396 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
                                        , 
# 396 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c" 3 4
                                          ((void *)0)
# 396 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/port/net_sockets.c"
