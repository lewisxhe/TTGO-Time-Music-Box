# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
# 35 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
...
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
int mbedtls_x509write_csr_pem( mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng );
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
...
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 2
# 67 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                        ...
                        const unsigned char *buf, size_t buflen )
{
    ...
    if( csr == 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                   || buf == 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
                             ((void *)0) 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
    ...
    if( p == 
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
            ((void *)0) 
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                 )
        return( -0x2880 );
...
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
...
# 214 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x80 ) ) != 0 )
    {
        mbedtls_x509_csr_free( csr );
...
int mbedtls_x509_csr_parse( mbedtls_x509_csr *csr, const unsigned char *buf, size_t buflen )
{
    ...
    if( csr == 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                   || buf == 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
                             ((void *)0) 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
    ...
    if( buf[buflen - 1] == '\0' )
    {
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               buf, 
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
                                   ((void *)0)
# 284 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                                       , 0, &use_len );
                   ...
                   const mbedtls_x509_csr *csr )
{
    ...
    if( ( ret = mbedtls_x509_key_size_helper( key_size_str, 14,
...
void mbedtls_x509_csr_free( mbedtls_x509_csr *csr )
{
    ...
    if( csr == 
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                   )
        return;
    ...
    while( name_cur != 
# 393 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
                      ((void *)0) 
# 393 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                           )
    {
        name_prv = name_cur;
    ...
    if( csr->raw.p != 
# 401 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c" 3 4
                     ((void *)0) 
# 401 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/x509_csr.c"
                          )
    {
