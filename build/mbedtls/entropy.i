# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/sha512.h" 2
...
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/entropy_poll.h" 1
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/entropy_poll.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/entropy_poll.h" 2
# 92 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/entropy_poll.h"
int mbedtls_hardware_poll( void *data,
                           unsigned char *output, size_t len, size_t *olen );
# 38 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
...
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
...
# 41 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
...
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
...
# 53 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 2
# 65 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
void mbedtls_entropy_init( mbedtls_entropy_context *ctx )
{
    ctx->source_count = 0;
...
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
    mbedtls_entropy_add_source( ctx, mbedtls_hardware_poll, 
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 3 4
                                                           ((void *)0)
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
                                                               ,
                                32,
                                1 );
# 120 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
}
...
# 230 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
cleanup:
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    if( len > 64 )
        return( -0x003C );
# 355 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
    do
    {
        if( count++ > 256 )
        {
    ...
    if( ( ret = mbedtls_sha512_ret( buf, 64,
                                    buf, 0 ) ) != 0 )
        goto exit;
# 424 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
    for( i = 0; i < ctx->source_count; i++ )
        ctx->source[i].size = 0;
...
# 464 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
int mbedtls_entropy_write_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    int ret = -0x003F;
    FILE *f;
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 470 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );
...
int mbedtls_entropy_update_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 498 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 498 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );
...
static int mbedtls_entropy_source_self_test_gather( unsigned char *buf, size_t buf_len )
{
    ...
    {
        if( ( ret = mbedtls_hardware_poll( 
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 3 4
                                          ((void *)0)
# 552 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
                                              , buf + entropy_len,
...
# 596 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
int mbedtls_entropy_source_self_test( int verbose )
{
    int ret = 0;
...
# 644 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
int mbedtls_entropy_self_test( int verbose )
{
    int ret = 1;
    ...
    ret = mbedtls_entropy_add_source( &ctx, entropy_dummy_source, 
# 664 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c" 3 4
                                                                 ((void *)0)
# 664 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
                                                                     , 16,
                                      0 );
    if( ret != 0 )
        goto cleanup;
    ...
    if( ( ret = mbedtls_entropy_update_manual( &ctx, buf, sizeof buf ) ) != 0 )
        goto cleanup;
# 680 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/library/entropy.c"
    for( i = 0; i < 8; i++ )
    {
