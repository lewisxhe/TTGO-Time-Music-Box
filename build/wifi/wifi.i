...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
EventGroupHandle_t wifi_event_group = 
# 22 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c" 3 4
                                     ((void *)0)
# 22 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
                                         ;
...
static void sc_callback(smartconfig_status_t status, void *pdata)
{
    ...
    case SC_STATUS_LINK:
        ...
        do { esp_err_t __err_rc = (esp_wifi_disconnect()); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 53, __func__, "esp_wifi_disconnect()"); } } while(0);;
        do { esp_err_t __err_rc = (esp_wifi_set_config(ESP_IF_WIFI_STA, wifi_config)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 54, __func__, "esp_wifi_set_config(ESP_IF_WIFI_STA, wifi_config)"); } } while(0);;
        do { esp_err_t __err_rc = (esp_wifi_connect()); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 55, __func__, "esp_wifi_connect()"); } } while(0);;
        break;
    ...
    case SC_STATUS_LINK_OVER:
        ...
        if (pdata != 
# 60 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c" 3 4
                    ((void *)0)
# 60 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
                        )
        {
...
# 80 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
static esp_err_t sys_event_handler(void *ctx, system_event_t *event)
{
    ...
    case SYSTEM_EVENT_STA_START:
        ...
        {
            do { esp_err_t __err_rc = (esp_wifi_connect()); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 92, __func__, "esp_wifi_connect()"); } } while(0);;
        }
        break;
    ...
    case SYSTEM_EVENT_STA_GOT_IP:
        ...
        TFT_print(tmp_buf, 12, 8000 + TFT_getfontheight() + 2);
...
# 129 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c" 3 4
   ((void *)0)
# 129 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
   )); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 129, __func__, "esp_event_loop_init(sys_event_handler, NULL)"); } } while(0);;
    ...
    do { esp_err_t __err_rc = (esp_wifi_init(&cfg)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 133, __func__, "esp_wifi_init(&cfg)"); } } while(0);;
    do { esp_err_t __err_rc = (esp_wifi_set_storage(WIFI_STORAGE_FLASH)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 134, __func__, "esp_wifi_set_storage(WIFI_STORAGE_FLASH)"); } } while(0);;
    do { esp_err_t __err_rc = (esp_wifi_set_mode(WIFI_MODE_STA)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 135, __func__, "esp_wifi_set_mode(WIFI_MODE_STA)"); } } while(0);;

    wifi_config_t conf;
    do { esp_err_t __err_rc = (esp_wifi_get_config(ESP_IF_WIFI_STA, &conf)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 138, __func__, "esp_wifi_get_config(ESP_IF_WIFI_STA, &conf)"); } } while(0);;
    ...
    if (!strlen(conf.sta.ssid))
    {
        ...
        do { esp_err_t __err_rc = (esp_wifi_start()); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 149, __func__, "esp_wifi_start()"); } } while(0);;
        do { esp_err_t __err_rc = (esp_smartconfig_set_type(SC_TYPE_ESPTOUCH)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 150, __func__, "esp_smartconfig_set_type(SC_TYPE_ESPTOUCH)"); } } while(0);;
        do { esp_err_t __err_rc = (esp_smartconfig_start(sc_callback)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 151, __func__, "esp_smartconfig_start(sc_callback)"); } } while(0);;

        xEventGroupWaitBits(wifi_event_group, 0x01, 
# 153 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c" 3 4
                                                                1
# 153 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
                                                                    , 
# 153 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c" 3 4
                                                                      0
# 153 "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c"
    ...
    else
    {
        ...
        do { esp_err_t __err_rc = (esp_wifi_start()); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "D:/ESP32/esp-idf-v3.1-rc1/ESP32_PIC_A2DP/components/wifi/wifi.c", 166, __func__, "esp_wifi_start()"); } } while(0);;
