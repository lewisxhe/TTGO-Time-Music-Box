# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
void fast_sha256_prf(const uint8_t *key, size_t key_len, const char *label,
              const uint8_t *data, size_t data_len, uint8_t *buf, size_t buf_len);
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
int tls_prf(u16 ver, const u8 *secret, size_t secret_len, const char *label,
     const u8 *seed, size_t seed_len, u8 *out, size_t outlen);
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 2
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
static const struct tls_cipher_suite tls_cipher_suites[] = {
 { 0x0000, TLS_KEY_X_NULL, TLS_CIPHER_NULL,
   TLS_HASH_NULL },
 { 0x0004, TLS_KEY_X_RSA, TLS_CIPHER_RC4_128,
   TLS_HASH_MD5 },
 { 0x0005, TLS_KEY_X_RSA, TLS_CIPHER_RC4_128,
   TLS_HASH_SHA },
 { 0x0009, TLS_KEY_X_RSA, TLS_CIPHER_DES_CBC,
   TLS_HASH_SHA },
 { 0x000A, TLS_KEY_X_RSA,
   TLS_CIPHER_3DES_EDE_CBC, TLS_HASH_SHA },
  { 0x0018, TLS_KEY_X_DH_anon,
   TLS_CIPHER_RC4_128, TLS_HASH_MD5 },
  { 0x001A, TLS_KEY_X_DH_anon,
   TLS_CIPHER_DES_CBC, TLS_HASH_SHA },
  { 0x001B, TLS_KEY_X_DH_anon,
   TLS_CIPHER_3DES_EDE_CBC, TLS_HASH_SHA },
 { 0x002F, TLS_KEY_X_RSA, TLS_CIPHER_AES_128_CBC,
   TLS_HASH_SHA },
 { 0x0034, TLS_KEY_X_DH_anon,
   TLS_CIPHER_AES_128_CBC, TLS_HASH_SHA },
 { 0x0035, TLS_KEY_X_RSA, TLS_CIPHER_AES_256_CBC,
   TLS_HASH_SHA },
 { 0x003A, TLS_KEY_X_DH_anon,
   TLS_CIPHER_AES_256_CBC, TLS_HASH_SHA },
 { 0x003C, TLS_KEY_X_RSA,
   TLS_CIPHER_AES_128_CBC, TLS_HASH_SHA256 },
 { 0x003D, TLS_KEY_X_RSA,
   TLS_CIPHER_AES_256_CBC, TLS_HASH_SHA256 },
 { 0x006C, TLS_KEY_X_DH_anon,
   TLS_CIPHER_AES_128_CBC, TLS_HASH_SHA256 },
 { 0x006D, TLS_KEY_X_DH_anon,
   TLS_CIPHER_AES_256_CBC, TLS_HASH_SHA256 }
};
...
# 97 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
const struct tls_cipher_suite * tls_get_cipher_suite(u16 suite)
{
 size_t i;
 for (i = 0; i < (sizeof(tls_cipher_suites) / sizeof((tls_cipher_suites)[0])); i++)
  if (tls_cipher_suites[i].suite == suite)
   return &tls_cipher_suites[i];
 return 
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
       ((void *)0)
# 103 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
           ;
}
...
{
 size_t i;
 for (i = 0; i < (sizeof(tls_ciphers) / sizeof((tls_ciphers)[0])); i++)
  if (tls_ciphers[i].cipher == cipher)
   return &tls_ciphers[i];
 return 
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
       ((void *)0)
# 113 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
           ;
}
...
int tls_server_key_exchange_allowed(tls_cipher cipher)
{
 ...
 if (suite == 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
             ((void *)0)
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                 )
  return 0;
...
# 153 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
int tls_parse_cert(const u8 *buf, size_t len, struct crypto_public_key **pk)
{
 struct x509_certificate *cert;

 wpa_hexdump(ESP_LOG_VERBOSE, "TLSv1: Parse ASN.1 DER certificate",
      buf, len);
 ...
 *pk = crypto_public_key_from_cert(buf, len);
 ...
 if (cert == 
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
            ((void *)0)
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to parse X.509 " "certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to parse X.509 " "certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to parse X.509 " "certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to parse X.509 " "certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to parse X.509 " "certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
  return -1;
 }
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
 *pk = crypto_public_key_import(cert->public_key, cert->public_key_len);
 x509_certificate_free(cert);

 if (*pk == 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
           ((void *)0)
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
               ) {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to import " "server public key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to import " "server public key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to import " "server public key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to import " "server public key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to import " "server public key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                          ;
  return -1;
 }
...
int tls_verify_hash_init(struct tls_verify_hash *verify)
{
 ...
 verify->md5_client = crypto_hash_init(CRYPTO_HASH_ALG_MD5, 
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                           ((void *)0)
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                               , 0);
 verify->md5_server = crypto_hash_init(CRYPTO_HASH_ALG_MD5, 
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                           ((void *)0)
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                               , 0);
 verify->md5_cert = crypto_hash_init(CRYPTO_HASH_ALG_MD5, 
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                         ((void *)0)
# 201 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                             , 0);
 verify->sha1_client = crypto_hash_init(CRYPTO_HASH_ALG_SHA1, 
# 202 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                             ((void *)0)
# 202 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                                 , 0);
 verify->sha1_server = crypto_hash_init(CRYPTO_HASH_ALG_SHA1, 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                             ((void *)0)
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                                 , 0);
 verify->sha1_cert = crypto_hash_init(CRYPTO_HASH_ALG_SHA1, 
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                           ((void *)0)
# 204 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                               , 0);
 if (verify->md5_client == 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                          ((void *)0) 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                               || verify->md5_server == 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                        ((void *)0) 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                             ||
     verify->md5_cert == 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                        ((void *)0) 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                             || verify->sha1_client == 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                       ((void *)0) 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                            ||
     verify->sha1_server == 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                           ((void *)0) 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                || verify->sha1_cert == 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                                        ((void *)0)
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
...
# 227 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
 return 0;
}
...
# 259 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
}


void tls_verify_hash_free(struct tls_verify_hash *verify)
{
 crypto_hash_finish(verify->md5_client, 
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                       ((void *)0)
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                           , 
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                             ((void *)0)
# 264 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
...
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                       ((void *)0)
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                           , 
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                             ((void *)0)
# 265 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                 );
 crypto_hash_finish(verify->md5_cert, 
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                     ((void *)0)
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                         , 
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                           ((void *)0)
# 266 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                               );
 crypto_hash_finish(verify->sha1_client, 
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                        ((void *)0)
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                            , 
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                              ((void *)0)
# 267 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                  );
 crypto_hash_finish(verify->sha1_server, 
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                        ((void *)0)
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                            , 
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                              ((void *)0)
# 268 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                                  );
 crypto_hash_finish(verify->sha1_cert, 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                      ((void *)0)
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                                          , 
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                                            ((void *)0)
# 269 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
 ...
 verify->md5_client = 
# 270 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                     ((void *)0)
# 270 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                         ;
 verify->md5_server = 
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                     ((void *)0)
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                         ;
 verify->md5_cert = 
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                   ((void *)0)
# 272 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                       ;
 verify->sha1_client = 
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                      ((void *)0)
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                          ;
 verify->sha1_server = 
# 274 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                      ((void *)0)
# 274 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                          ;
 verify->sha1_cert = 
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c" 3 4
                    ((void *)0)
# 275 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
                        ;
# 289 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
}
...
int tls_version_ok(u16 ver)
{
 if (ver == 0x0301)
  return 1;
# 305 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
 return 0;
}
...
int tls_prf(u16 ver, const u8 *secret, size_t secret_len, const char *label,
     const u8 *seed, size_t seed_len, u8 *out, size_t outlen)
{
# 335 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_common.c"
