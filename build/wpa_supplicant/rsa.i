# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
...
int bignum_exptmod(const struct bignum *a, const struct bignum *b,
     const struct bignum *c, struct bignum *d);
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 2
        ...
        struct bignum *num)
{
 ...
 if (pos == 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  return 
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 37 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;

 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
     hdr.class != 0 || hdr.tag != 0x02) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                                     ;
  return 
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;
 }

 if (bignum_set_unsigned_bin(num, hdr.payload, hdr.length) < 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Failed to parse INTEGER" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Failed to parse INTEGER" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Failed to parse INTEGER" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Failed to parse INTEGER" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Failed to parse INTEGER" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;
 }

 return hdr.payload + hdr.length;
}
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
struct crypto_rsa_key *
crypto_rsa_import_public_key(const u8 *buf, size_t len)
{
 ...
 key = (struct crypto_rsa_key *)calloc(1, (sizeof(*key)));
 if (key == 
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 69 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  return 
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;

 key->n = bignum_init();
 key->e = bignum_init();
 if (key->n == 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
              ((void *)0) 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                   || key->e == 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                ((void *)0)
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
  ...
  crypto_rsa_free(key);
  return 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;
 }
# 87 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
 if (asn1_get_next(buf, len, &hdr) < 0 ||
     hdr.class != 0 ||
     hdr.tag != 0x10) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
 ...
 if (pos == 
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 101 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  goto error;
...
error:
 crypto_rsa_free(key);
 return 
# 115 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
       ((void *)0)
# 115 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
           ;
}
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
struct crypto_rsa_key *
crypto_rsa_import_private_key(const u8 *buf, size_t len)
{
 struct crypto_rsa_key *key;
 ...
 key = (struct crypto_rsa_key *)calloc(1, (sizeof(*key)));
 if (key == 
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  return 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;
 ...
 if (key->n == 
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
              ((void *)0) 
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                   || key->e == 
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                ((void *)0) 
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
...
# 148 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                                                       ||
     key->p == 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
              ((void *)0) 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                   || key->q == 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                ((void *)0) 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
...
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                                                          ||
     key->dmq1 == 
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                 ((void *)0) 
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                      || key->iqmp == 
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                      ((void *)0)
# 150 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
  ...
  crypto_rsa_free(key);
  return 
# 152 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
        ((void *)0)
# 152 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
            ;
 }
# 171 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
 if (asn1_get_next(buf, len, &hdr) < 0 ||
     hdr.class != 0 ||
     hdr.tag != 0x10) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
 ...
 zero = bignum_init();
 if (zero == 
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
            ((void *)0)
# 183 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                )
  goto error;
 pos = crypto_rsa_parse_integer(pos, end, zero);
 if (pos == 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0) 
# 186 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                || bignum_cmp_d(zero, 0) != 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected zero INTEGER in the " "beginning of private key; not found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected zero INTEGER in the " "beginning of private key; not found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected zero INTEGER in the " "beginning of private key; not found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected zero INTEGER in the " "beginning of private key; not found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected zero INTEGER in the " "beginning of private key; not found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                            ;
  bignum_deinit(zero);
  goto error;
 }
 ...
 if (pos == 
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 203 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  goto error;
...
error:
 crypto_rsa_free(key);
 return 
# 217 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
       ((void *)0)
# 217 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
           ;
}
...
# 242 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
int crypto_rsa_exptmod(const u8 *in, size_t inlen, u8 *out, size_t *outlen,
         struct crypto_rsa_key *key, int use_private)
{
 struct bignum *tmp, *a = 
# 245 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                         ((void *)0)
# 245 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                             , *b = 
# 245 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                    ((void *)0)
# 245 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
 ...
 tmp = bignum_init();
 if (tmp == 
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
           ((void *)0)
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               )
  return -1;
 ...
 if (use_private) {
# 277 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
  a = bignum_init();
  b = bignum_init();
  if (a == 
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
          ((void *)0) 
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
               || b == 
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                       ((void *)0)
# 279 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
 ...
 *outlen = modlen;
 ...
 if (bignum_get_unsigned_bin(
      tmp, out +
      (modlen - bignum_get_unsigned_bin_len(tmp)), 
# 319 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c" 3 4
                                                  ((void *)0)
# 319 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
                                                      ) < 0)
  goto error;
...
# 340 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/rsa.c"
void crypto_rsa_free(struct crypto_rsa_key *key)
{
 if (key) {
  bignum_deinit(key->n);
