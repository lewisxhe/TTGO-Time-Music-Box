# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
int rc4_skip(const u8 *key, size_t keylen, size_t skip,
      u8 *data, size_t data_len);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
void fast_sha256_prf(const uint8_t *key, size_t key_len, const char *label,
              const uint8_t *data, size_t data_len, uint8_t *buf, size_t buf_len);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/crypto/random.h" 1
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 2
      ...
      const char *label, u8 *res, size_t res_len)
{
 ...
 do { (key_bits)[0] = (u8) ((((u32) (res_len * 8)) >> 24) & 0xff); (key_bits)[1] = (u8) ((((u32) (res_len * 8)) >> 16) & 0xff); (key_bits)[2] = (u8) ((((u32) (res_len * 8)) >> 8) & 0xff); (key_bits)[3] = (u8) (((u32) (res_len * 8)) & 0xff); } while (0);
 ...
 iter = (res_len + 32 - 1) / 32;
 opos = res;
 left = res_len;

 for (i = 1; i <= iter; i++) {
  do { (i_buf)[0] = (u8) ((((u32) (i)) >> 24) & 0xff); (i_buf)[1] = (u8) ((((u32) (i)) >> 16) & 0xff); (i_buf)[2] = (u8) ((((u32) (i)) >> 8) & 0xff); (i_buf)[3] = (u8) (((u32) (i)) & 0xff); } while (0);
  if (wps_crypto_funcs.hmac_sha256_vector) {
          wps_crypto_funcs.hmac_sha256_vector(key, 32, 4, addr, (int *)len, hash);
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to reigster hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to reigster hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to reigster hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to reigster hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to reigster hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
   return ;
  }
  if (i < iter) {
   memcpy((opos), (hash), (32));
...
int wps_derive_keys(struct wps_data *wps)
{
 ...
 if (wps->dh_privkey == 
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                       ((void *)0)
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                           ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Own DH private key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Own DH private key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Own DH private key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Own DH private key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Own DH private key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 pubkey = wps->registrar ? wps->dh_pubkey_e : wps->dh_pubkey_r;
 if (pubkey == 
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
              ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                  ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Peer DH public key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Peer DH public key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Peer DH public key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Peer DH public key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Peer DH public key not available" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_buf_key(ESP_LOG_DEBUG, "WPS: DH Private Key", wps->dh_privkey);
 wpa_hexdump_buf(ESP_LOG_DEBUG, "WPS: DH peer Public Key", pubkey);
 dh_shared = dh5_derive_shared(wps->dh_ctx, pubkey, wps->dh_privkey);
 dh5_free(wps->dh_ctx);
 wps->dh_ctx = 
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
              ((void *)0)
# 88 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                  ;
 dh_shared = wpabuf_zeropad(dh_shared, 192);
 if (dh_shared == 
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                 ((void *)0)
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                     ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Failed to derive DH shared key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Failed to derive DH shared key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Failed to derive DH shared key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Failed to derive DH shared key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Failed to derive DH shared key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
 wpa_hexdump_buf_key(ESP_LOG_DEBUG, "WPS: DH shared key", dh_shared);
 ...
 if (wps_crypto_funcs.sha256_vector) {
  ...
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, Fail to register sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, Fail to register sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, Fail to register sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, Fail to register sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, Fail to register sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
  return -1;
 }
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: DHKey", dhkey, sizeof(dhkey));
 ...
 if (wps_crypto_funcs.hmac_sha256_vector) {
  ...
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, Fail to register hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, Fail to register hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, Fail to register hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, Fail to register hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, Fail to register hmac sha256 vector function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
  return -1;
 }
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: KDK", kdk, sizeof(kdk));

 wps_kdf(kdk, 
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
             ((void *)0)
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                 , 0, "Wi-Fi Easy and Secure Key Derivation",
  keys, sizeof(keys));
 memcpy((wps->authkey), (keys), (32));
 memcpy((wps->keywrapkey), (keys + 32), (16));
 memcpy((wps->emsk), (keys + 32 + 16), (32))
                 ;

 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: AuthKey",
   wps->authkey, 32);
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: KeyWrapKey",
   wps->keywrapkey, 16);
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: EMSK", wps->emsk, 32);
      ...
      size_t dev_passwd_len)
{
 ...
 if (wps_crypto_funcs.hmac_sha256) {
         wps_crypto_funcs.hmac_sha256(wps->authkey, 32, dev_passwd,
                               (dev_passwd_len + 1) / 2, hash);
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register hmac_sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register hmac_sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register hmac_sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register hmac_sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register hmac_sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
  return ;
 }
 memcpy((wps->psk1), (hash), (16));
 if (wps_crypto_funcs.hmac_sha256) {
         wps_crypto_funcs.hmac_sha256(wps->authkey, 32,
 ...
 memcpy((wps->psk2), (hash), (16));

 wpa_hexdump_ascii_key(ESP_LOG_DEBUG, "WPS: Device Password",
         dev_passwd, dev_passwd_len);
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: PSK1", wps->psk1, 16);
 wpa_hexdump_key(ESP_LOG_DEBUG, "WPS: PSK2", wps->psk2, 16);
}
       ...
       size_t encr_len)
{
 ...
 if (encr == 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
            ((void *)0) 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                 || encr_len < 2 * block_size || encr_len % block_size)
 {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Encrypted Settings received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Encrypted Settings received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Encrypted Settings received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Encrypted Settings received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Encrypted Settings received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 }

 decrypted = wpabuf_alloc(encr_len - block_size);
 if (decrypted == 
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                 ((void *)0)
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                     )
  return 
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;

 wpa_hexdump(ESP_LOG_VERBOSE, "WPS: Encrypted Settings", encr, encr_len);
 wpabuf_put_data(decrypted, encr + block_size, encr_len - block_size);
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: AES Decrypt setting" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: AES Decrypt setting" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: AES Decrypt setting" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: AES Decrypt setting" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: AES Decrypt setting" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 if (wps_crypto_funcs.aes_128_decrypt) {
         if (wps_crypto_funcs.aes_128_decrypt(wps->keywrapkey, encr, wpabuf_mhead(decrypted),
          ...
          return 
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                ((void *)0)
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                    ;
     }
 } else {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register aes 128 decrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register aes 128 decrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register aes 128 decrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register aes 128 decrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register aes 128 decrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
  return 
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 213 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 }

 wpa_hexdump_buf_key(ESP_LOG_VERBOSE, "WPS: Decrypted Encrypted Settings",
       decrypted);

 pos = wpabuf_head_u8(decrypted) + wpabuf_len(decrypted) - 1;
 pad = *pos;
 if (pad > wpabuf_len(decrypted)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  wpabuf_free(decrypted);
  return 
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 224 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 }
 for (i = 0; i < pad; i++) {
  if (*pos-- != pad) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad " "string" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad " "string" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad " "string" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad " "string" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Invalid PKCS#5 v2.0 pad " "string" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   wpabuf_free(decrypted);
   return 
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
         ((void *)0)
# 231 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
             ;
  }
 }
 decrypted->used -= pad;
      ...
      u16 config_error, u16 error_indication)
{
 union wps_event_data *data;
        ...
        data = (union wps_event_data *)calloc(1, (sizeof(union wps_event_data)));
 if (data == 
# 311 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
            ((void *)0)
# 311 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                )
  return;

 if (wps->event_cb == 
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                     ((void *)0)
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                         ) {
  free((data));
  return;
 }

 memset(data, 0, sizeof(union wps_event_data));
 data->fail.msg = msg;
...
{
 if (wps->event_cb == 
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                     ((void *)0)
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                         )
  return;

 wps->event_cb(wps->cb_ctx, WPS_EV_SUCCESS, 
# 333 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                                           ((void *)0)
# 333 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                                               );
}
...
void wps_pwd_auth_fail_event(struct wps_context *wps, int enrollee, int part)
{
 union wps_event_data *data;
        ...
        data = (union wps_event_data *)calloc(1, (sizeof(union wps_event_data)));
 if (data == 
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
            ((void *)0)
# 342 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                )
  return;

 if (wps->event_cb == 
# 345 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                     ((void *)0)
# 345 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                         ) {
  free((data));
  return;
 }
...
{
 if (wps->event_cb == 
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                     ((void *)0)
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                         )
  return;

 wps->event_cb(wps->cb_ctx, WPS_EV_PBC_OVERLAP, 
# 363 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                                               ((void *)0)
# 363 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                                                   );
}
...
{
 if (wps->event_cb == 
# 369 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                     ((void *)0)
# 369 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                         )
  return;

 wps->event_cb(wps->cb_ctx, WPS_EV_PBC_TIMEOUT, 
# 372 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                                               ((void *)0)
# 372 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                                                   );
}
# 465 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
int wps_dev_type_str2bin(const char *str, u8 dev_type[8])
{
 const char *pos;


 do { (dev_type)[0] = ((u16) (atoi(str))) >> 8; (dev_type)[1] = ((u16) (atoi(str))) & 0xff; } while (0);
 pos = (char *)strchr((str), ('-'));
 if (pos == 
# 472 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
           ((void *)0)
# 472 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
               )
  return -1;
 pos++;
 ...
 pos = (char *)strchr((pos), ('-'));
 if (pos == 
# 478 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
           ((void *)0)
# 478 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
               )
  return -1;
 pos++;
 do { (&dev_type[6])[0] = ((u16) (atoi(pos))) >> 8; (&dev_type[6])[1] = ((u16) (atoi(pos))) & 0xff; } while (0);
       ...
       size_t buf_len)
{
 ...
 ret = snprintf(buf, buf_len, "%u-%08X-%u",
     ((u16) (((dev_type)[0] << 8) | (dev_type)[1])), ((((u32) (&dev_type[2])[0]) << 24) | (((u32) (&dev_type[2])[1]) << 16) | (((u32) (&dev_type[2])[2]) << 8) | ((u32) (&dev_type[2])[3])),
     ((u16) (((&dev_type[6])[0] << 8) | (&dev_type[6])[1])));
 if (ret < 0 || (unsigned int) ret >= buf_len)
  return 
# 497 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 497 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
...
u16 wps_config_methods_str2bin(const char *str)
{
 ...
 if (str == 
# 535 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
           ((void *)0)
# 535 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
               ) {

  methods |= 0x0008 | 0x0100;
...
struct wpabuf * wps_build_wsc_ack(struct wps_data *wps)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Building Message WSC_ACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Building Message WSC_ACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Building Message WSC_ACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Building Message WSC_ACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Building Message WSC_ACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);

 msg = wpabuf_alloc(1000);
 if (msg == 
# 584 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
           ((void *)0)
# 584 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
               )
  return 
# 585 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 585 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
...
# 591 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                              ((void *)0)
# 591 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                                  , 0)) {
  wpabuf_free(msg);
  return 
# 593 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 593 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 }
...
struct wpabuf * wps_build_wsc_nack(struct wps_data *wps)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Building Message WSC_NACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Building Message WSC_NACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Building Message WSC_NACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Building Message WSC_NACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Building Message WSC_NACK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);

 msg = wpabuf_alloc(1000);
 if (msg == 
# 607 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
           ((void *)0)
# 607 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
               )
  return 
# 608 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 608 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 ...
 if (wps_build_version(msg) ||
     ...
     wps_build_wfa_ext(msg, 0, 
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
                              ((void *)0)
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
                                  , 0)) {
  wpabuf_free(msg);
  return 
# 617 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c" 3 4
        ((void *)0)
# 617 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_common.c"
            ;
 }
