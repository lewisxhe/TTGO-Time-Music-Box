# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 2
...
int wps_build_req_dev_type(struct wps_device_data *dev, struct wpabuf *msg,
      unsigned int num_req_dev_types,
      const u8 *req_dev_types);
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 2

int wps_build_manufacturer(struct wps_device_data *dev, struct wpabuf *msg)
{
 size_t len;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Manufacturer" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Manufacturer" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Manufacturer" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Manufacturer" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Manufacturer" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_MANUFACTURER);
 len = dev->manufacturer ? strlen(dev->manufacturer) : 0;
# 32 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
...
{
 size_t len;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Model Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Model Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Model Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Model Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Model Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_MODEL_NAME);
 len = dev->model_name ? strlen(dev->model_name) : 0;
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
 wpabuf_put_be16(msg, len);
...
{
 size_t len;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Model Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Model Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Model Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Model Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Model Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_MODEL_NUMBER);
 len = dev->model_number ? strlen(dev->model_number) : 0;
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
 wpabuf_put_be16(msg, len);
...
{
 size_t len;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Serial Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Serial Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Serial Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Serial Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Serial Number" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_SERIAL_NUMBER);
 len = dev->serial_number ? strlen(dev->serial_number) : 0;
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
 wpabuf_put_be16(msg, len);
...
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Primary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Primary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Primary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Primary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Primary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_PRIMARY_DEV_TYPE);
 wpabuf_put_be16(msg, 8);
 wpabuf_put_data(msg, dev->pri_dev_type, 8);
 return 0;
}
      ...
      struct wpabuf *msg)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Secondary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Secondary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Secondary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Secondary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Secondary Device Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_SECONDARY_DEV_TYPE_LIST);
 wpabuf_put_be16(msg, 8 * dev->num_sec_dev_types);
 wpabuf_put_data(msg, dev->sec_dev_type,
   8 * dev->num_sec_dev_types);
      ...
      const u8 *req_dev_types)
{
 ...
 for (i = 0; i < num_req_dev_types; i++) {
  wpa_hexdump(ESP_LOG_DEBUG, "WPS: * Requested Device Type",
       req_dev_types + i * 8,
       8);
  wpabuf_put_be16(msg, ATTR_REQUESTED_DEV_TYPE);
  wpabuf_put_be16(msg, 8);
  wpabuf_put_data(msg, req_dev_types + i * 8,
    8);
 }
...
{
 size_t len;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Device Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Device Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Device Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Device Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Device Name" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_DEV_NAME);
 len = dev->device_name ? strlen(dev->device_name) : 0;
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
 wpabuf_put_be16(msg, len);
...
int wps_build_os_version(struct wps_device_data *dev, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * OS Version" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * OS Version" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * OS Version" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * OS Version" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * OS Version" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_vendor_ext_m1(struct wps_device_data *dev, struct wpabuf *msg)
{
 if (dev->vendor_ext_m1 != 
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                          ((void *)0)
# 206 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                              ) {
  wpa_hexdump(ESP_LOG_DEBUG, "WPS:  * Vendor Extension M1",
...
int wps_build_rf_bands(struct wps_device_data *dev, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * RF Bands (%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * RF Bands (%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * RF Bands (%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * RF Bands (%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * RF Bands (%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } } while(0); } while(0);
...
int wps_build_vendor_ext(struct wps_device_data *dev, struct wpabuf *msg)
{
 ...
 for (i = 0; i < 10; i++) {
  if (dev->vendor_ext[i] == 
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                           ((void *)0)
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                               )
   continue;
  wpa_hexdump(ESP_LOG_DEBUG, "WPS:  * Vendor Extension",
...
{
 if (str == 
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 250 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Manufacturer received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Manufacturer received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Manufacturer received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Manufacturer received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Manufacturer received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_ascii(ESP_LOG_DEBUG, "WPS: Manufacturer", str, str_len);

 free((dev->manufacturer));
 dev->manufacturer = (char *)malloc((str_len + 1));
 if (dev->manufacturer == 
# 259 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                         ((void *)0)
# 259 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                             )
  return -1;
...
{
 if (str == 
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 271 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Model Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Model Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Model Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Model Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Model Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_ascii(ESP_LOG_DEBUG, "WPS: Model Name", str, str_len);

 free((dev->model_name));
 dev->model_name = (char *)malloc((str_len + 1));
 if (dev->model_name == 
# 280 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                       ((void *)0)
# 280 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                           )
  return -1;
...
{
 if (str == 
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 292 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Model Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Model Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Model Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Model Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Model Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_ascii(ESP_LOG_DEBUG, "WPS: Model Number", str, str_len);

 free((dev->model_number));
 dev->model_number = (char *)malloc((str_len + 1));
 if (dev->model_number == 
# 301 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                         ((void *)0)
# 301 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                             )
  return -1;
...
{
 if (str == 
# 313 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 313 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Serial Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Serial Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Serial Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Serial Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Serial Number received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_ascii(ESP_LOG_DEBUG, "WPS: Serial Number", str, str_len);

 free((dev->serial_number));
 dev->serial_number = (char *)malloc((str_len + 1));
 if (dev->serial_number == 
# 322 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                          ((void *)0)
# 322 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                              )
  return -1;
...
{
 if (str == 
# 334 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 334 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Device Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Device Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Device Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Device Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Device Name received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 wpa_hexdump_ascii(ESP_LOG_DEBUG, "WPS: Device Name", str, str_len);

 free((dev->device_name));
 dev->device_name = (char *)malloc((str_len + 1));
 if (dev->device_name == 
# 343 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                        ((void *)0)
# 343 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                            )
  return -1;
     ...
     const u8 *dev_type)
{
 ...
 if (dev_type == 
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                ((void *)0)
# 360 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                    ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No Primary Device Type received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No Primary Device Type received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No Primary Device Type received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No Primary Device Type received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No Primary Device Type received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 memcpy((dev->pri_dev_type), (dev_type), (8));
...
{
 if (ver == 
# 394 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
           ((void *)0)
# 394 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No OS Version received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No OS Version received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No OS Version received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No OS Version received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No OS Version received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 dev->os_version = ((((u32) (ver)[0]) << 24) | (((u32) (ver)[1]) << 16) | (((u32) (ver)[2]) << 8) | ((u32) (ver)[3]));
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: OS Version %08x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->os_version); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: OS Version %08x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->os_version); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: OS Version %08x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->os_version); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: OS Version %08x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->os_version); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: OS Version %08x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->os_version); } } while(0); } while(0);
...
{
 if (bands == 
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
             ((void *)0)
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                 ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: No RF Bands received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: No RF Bands received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: No RF Bands received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: No RF Bands received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: No RF Bands received" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }

 dev->rf_bands = *bands;
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Enrollee RF Bands 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Enrollee RF Bands 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Enrollee RF Bands 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Enrollee RF Bands 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Enrollee RF Bands 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", dev->rf_bands); } } while(0); } while(0);
...
{
 if (src->device_name)
  dst->device_name = strdup(src->device_name);
 if (src->manufacturer)
  dst->manufacturer = strdup(src->manufacturer);
 if (src->model_name)
  dst->model_name = strdup(src->model_name);
 if (src->model_number)
  dst->model_number = strdup(src->model_number);
 if (src->serial_number)
  dst->serial_number = strdup(src->serial_number);
...
void wps_device_data_free(struct wps_device_data *dev)
{
 free((dev->device_name));
 dev->device_name = 
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                   ((void *)0)
# 442 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                       ;
 free((dev->manufacturer));
 dev->manufacturer = 
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                    ((void *)0)
# 444 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                        ;
 free((dev->model_name));
 dev->model_name = 
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                  ((void *)0)
# 446 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                      ;
 free((dev->model_number));
 dev->model_number = 
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                    ((void *)0)
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                        ;
 free((dev->serial_number));
 dev->serial_number = 
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c" 3 4
                     ((void *)0)
# 450 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_dev_attr.c"
                         ;
}
