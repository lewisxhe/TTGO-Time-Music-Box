# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
...
int hmac_md5(const uint8_t *key, size_t key_len, const uint8_t *data, size_t data_len,
      uint8_t *mac);
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/pkcs5.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/pkcs5.h"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 2
       ...
       struct pkcs5_params *params)
{
 ...
 if (asn1_get_oid(enc_alg, enc_alg_end - enc_alg, &oid, &pos)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Failed to parse OID " "(algorithm)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Failed to parse OID " "(algorithm)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Failed to parse OID " "(algorithm)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Failed to parse OID " "(algorithm)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Failed to parse OID " "(algorithm)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
  return -1;
 }

 asn1_oid_to_str(&oid, obuf, sizeof(obuf));
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: encryption algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: encryption algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: encryption algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: encryption algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: encryption algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } } while(0); } while(0);
 params->alg = pkcs5_get_alg(&oid);
 if (params->alg == PKCS5_ALG_UNKNOWN) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: unsupported encryption " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: unsupported encryption " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: unsupported encryption " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: unsupported encryption " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: unsupported encryption " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } } while(0); } while(0)
                           ;
  return -1;
 }
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
 if (asn1_get_next(pos, enc_alg_end - pos, &hdr) < 0 ||
     hdr.class != 0 ||
     hdr.tag != 0x10) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Expected SEQUENCE " "(PBEParameter) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Expected SEQUENCE " "(PBEParameter) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Expected SEQUENCE " "(PBEParameter) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Expected SEQUENCE " "(PBEParameter) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Expected SEQUENCE " "(PBEParameter) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
     ...
     hdr.tag != 0x04 ||
     hdr.length != 8) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Expected OCTETSTRING SIZE(8) " "(salt) - found class %d tag 0x%x size %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag, hdr.length); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Expected OCTETSTRING SIZE(8) " "(salt) - found class %d tag 0x%x size %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag, hdr.length); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Expected OCTETSTRING SIZE(8) " "(salt) - found class %d tag 0x%x size %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag, hdr.length); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Expected OCTETSTRING SIZE(8) " "(salt) - found class %d tag 0x%x size %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag, hdr.length); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Expected OCTETSTRING SIZE(8) " "(salt) - found class %d tag 0x%x size %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag, hdr.length); } } while(0); } while(0)
 ...
 wpa_hexdump(ESP_LOG_DEBUG, "PKCS #5: salt",
      params->salt, params->salt_len);


 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
     hdr.class != 0 || hdr.tag != 0x02) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Expected INTEGER - found " "class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Expected INTEGER - found " "class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Expected INTEGER - found " "class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Expected INTEGER - found " "class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Expected INTEGER - found " "class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                                              ;
  return -1;
 }
 if (hdr.length == 1)
  ...
  params->iter_count = ((u16) (((hdr.payload)[0] << 8) | (hdr.payload)[1]));
 else if (hdr.length == 4)
  params->iter_count = ((((u32) (hdr.payload)[0]) << 24) | (((u32) (hdr.payload)[1]) << 16) | (((u32) (hdr.payload)[2]) << 8) | ((u32) (hdr.payload)[3]));
 else {
  wpa_hexdump(ESP_LOG_DEBUG, "PKCS #5: Unsupported INTEGER value "
       " (iterationCount)",
       hdr.payload, hdr.length);
  return -1;
 }
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } } while(0); } while(0)
                        ;
 if (params->iter_count == 0 || params->iter_count > 0xffff) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Unsupported " "iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Unsupported " "iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Unsupported " "iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Unsupported " "iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Unsupported " "iterationCount=0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", params->iter_count); } } while(0); } while(0)
                                                ;
  return -1;
 }
      ...
      const char *passwd)
{
 ...
 if (params->alg != PKCS5_ALG_MD5_DES_CBC) {
  return 
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 149 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }
 ...
 if (md5_vector(2, addr, len, hash) < 0)
  return 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 addr[0] = hash;
 len[0] = 16;
 for (i = 1; i < params->iter_count; i++) {
  if (md5_vector(1, addr, len, hash) < 0)
   return 
# 162 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
         ((void *)0)
# 162 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
             ;
 }

 wpa_hexdump_key(ESP_LOG_DEBUG, "PKCS #5: DES key", hash, 8);
 wpa_hexdump_key(ESP_LOG_DEBUG, "PKCS #5: DES IV", hash + 8, 8);

 if (wpa2_crypto_funcs.crypto_cipher_init) {
  return wpa2_crypto_funcs.crypto_cipher_init(CRYPTO_CIPHER_ALG_DES, hash + 8, hash, 8);
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto_cipher_init function! \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto_cipher_init function! \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto_cipher_init function! \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto_cipher_init function! \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto_cipher_init function! \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
  return 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }
}
...
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
                            ((void *)0)
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
                                ;
 u8 *eb, pad;
 struct pkcs5_params params;
 unsigned int i;
 ...
 if (pkcs5_get_params(enc_alg, enc_alg_len, &params) < 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Unsupported parameters" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Unsupported parameters" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Unsupported parameters" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Unsupported parameters" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Unsupported parameters" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 187 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }
 ...
 if (ctx == 
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
           ((void *)0)
# 192 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Failed to initialize crypto" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Failed to initialize crypto" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Failed to initialize crypto" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Failed to initialize crypto" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Failed to initialize crypto" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }


 if (enc_data_len < 16 || enc_data_len % 8) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: invalid length of ciphertext " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) enc_data_len); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: invalid length of ciphertext " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) enc_data_len); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: invalid length of ciphertext " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) enc_data_len); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: invalid length of ciphertext " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) enc_data_len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: invalid length of ciphertext " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) enc_data_len); } } while(0); } while(0)
                               ;
  if (wpa2_crypto_funcs.crypto_cipher_deinit) {
   ...
   return 
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
         ((void *)0)
# 205 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
             ;
  }
  return 
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }

 eb = malloc((enc_data_len));
 if (eb == 
# 211 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
          ((void *)0)
# 211 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
              ) {
  if (wpa2_crypto_funcs.crypto_cipher_deinit) {
   wpa2_crypto_funcs.crypto_cipher_deinit(ctx);
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   return 
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
         ((void *)0)
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
             ;
  }
  return 
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 218 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }

 if (wpa2_crypto_funcs.crypto_cipher_decrypt) {
  if ((int)wpa2_crypto_funcs.crypto_cipher_decrypt(ctx, enc_data, eb, enc_data_len) < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Failed to decrypt EB" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Failed to decrypt EB" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Failed to decrypt EB" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Failed to decrypt EB" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Failed to decrypt EB" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   wpa2_crypto_funcs.crypto_cipher_deinit(ctx);
   free((eb));
   return 
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
         ((void *)0)
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
             ;
  }
 } else {
  ...
  free((eb));
  return 
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }
 ...
 if (wpa2_crypto_funcs.crypto_cipher_deinit) {
  ...
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 239 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 239 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }

 pad = eb[enc_data_len - 1];
 if (pad > 8) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #5: Invalid PS octet 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pad); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #5: Invalid PS octet 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pad); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #5: Invalid PS octet 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pad); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #5: Invalid PS octet 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pad); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #5: Invalid PS octet 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pad); } } while(0); } while(0);
  free((eb));
  return 
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
        ((void *)0)
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
            ;
 }
 for (i = enc_data_len - pad; i < enc_data_len; i++) {
  if (eb[i] != pad) {
   wpa_hexdump(ESP_LOG_INFO, "PKCS #5: Invalid PS",
        eb + enc_data_len - pad, pad);
   free((eb));
   return 
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c" 3 4
         ((void *)0)
# 253 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs5.c"
             ;
  }
 }

 wpa_hexdump_key(ESP_LOG_VERBOSE, "PKCS #5: message M (encrypted key)",
   eb, enc_data_len - pad);
