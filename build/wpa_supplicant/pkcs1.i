# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/pkcs1.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/pkcs1.h"
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c" 2
        ...
        u8 *out, size_t *outlen)
{
 size_t ps_len;
 u8 *pos;
# 33 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c"
 if (modlen < 12 || modlen > *outlen || inlen > modlen - 11) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #1: %s - Invalid buffer " "lengths (modlen=%lu outlen=%lu inlen=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, (unsigned long) modlen, (unsigned long) *outlen, (unsigned long) inlen); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #1: %s - Invalid buffer " "lengths (modlen=%lu outlen=%lu inlen=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, (unsigned long) modlen, (unsigned long) *outlen, (unsigned long) inlen); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #1: %s - Invalid buffer " "lengths (modlen=%lu outlen=%lu inlen=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, (unsigned long) modlen, (unsigned long) *outlen, (unsigned long) inlen); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #1: %s - Invalid buffer " "lengths (modlen=%lu outlen=%lu inlen=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, (unsigned long) modlen, (unsigned long) *outlen, (unsigned long) inlen); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #1: %s - Invalid buffer " "lengths (modlen=%lu outlen=%lu inlen=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, (unsigned long) modlen, (unsigned long) *outlen, (unsigned long) inlen); } } while(0); } while(0)
 ...
 *pos++ = block_type;
 ...
 case 2:
  if (os_get_random(pos, ps_len) < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #1: %s - Failed to get " "random data for PS" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #1: %s - Failed to get " "random data for PS" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #1: %s - Failed to get " "random data for PS" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #1: %s - Failed to get " "random data for PS" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #1: %s - Failed to get " "random data for PS" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__); } } while(0); } while(0)
                                      ;
   return -1;
  }
  while (ps_len--) {
  ...
  break;
 default:
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #1: %s - Unsupported block type " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, block_type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #1: %s - Unsupported block type " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, block_type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #1: %s - Unsupported block type " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, block_type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #1: %s - Unsupported block type " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, block_type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #1: %s - Unsupported block type " "%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", __func__, block_type); } } while(0); } while(0)
                                 ;
  return -1;
 }
 *pos++ = 0x00;
        ...
        u8 *plain, size_t *plain_len)
{
 ...
 if (crypto_rsa_exptmod(crypt, crypt_len, plain, &len, key, 0) < 0)
  return -1;
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/pkcs1.c"
 if (len < 3 + 8 + 16 ||
     plain[0] != 0x00 || (plain[1] != 0x00 && plain[1] != 0x01)) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                  ;
  return -1;
 }
 ...
 if (plain[1] == 0x00) {
  ...
  if (plain[2] != 0x00) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=00)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=00)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=00)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=00)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=00)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
   return -1;
  }
  ...
  if (plain[2] != 0xff) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=01)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=01)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=01)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=01)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "LibTomCrypt: Invalid signature " "PS (BT=01)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
   return -1;
  }
 ...
 if (pos - plain - 2 < 8) {
  ...
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "LibTomCrypt: Too short signature " "padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "LibTomCrypt: Too short signature " "padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "LibTomCrypt: Too short signature " "padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "LibTomCrypt: Too short signature " "padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "LibTomCrypt: Too short signature " "padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
  return -1;
 }

 if (pos + 16 >= plain + len || *pos != 0x00) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure (2)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure (2)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure (2)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure (2)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "LibTomCrypt: Invalid signature EB " "structure (2)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                      ;
  return -1;
 }
 pos++;
