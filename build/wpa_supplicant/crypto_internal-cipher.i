# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
void aes_decrypt(void *ctx, const u8 *crypt, u8 *plain);
void aes_decrypt_deinit(void *ctx);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
struct crypto_cipher {
...
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 } u;
};
       ...
       size_t key_len)
{
 ...
 ctx = (struct crypto_cipher *)calloc(1, (sizeof(*ctx)));
 if (ctx == 
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
           ((void *)0)
# 61 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
               )
  return 
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 ...
 case CRYPTO_CIPHER_ALG_RC4:
  if (key_len > sizeof(ctx->u.rc4.key)) {
   free((ctx));
   return 
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 70 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  if (ctx->u.aes.ctx_enc == 
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
                           ((void *)0)
# 77 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
                               ) {
   free((ctx));
   return 
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 79 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
  ctx->u.aes.ctx_dec = aes_decrypt_init(key, key_len);
  if (ctx->u.aes.ctx_dec == 
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
                           ((void *)0)
# 82 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
                               ) {
   aes_encrypt_deinit(ctx->u.aes.ctx_enc);
   free((ctx));
   return 
# 85 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 85 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
  memcpy((ctx->u.aes.cbc), (iv), (16));
  break;
# 109 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  free((ctx));
  return 
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 }
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  for (i = 0; i < blocks; i++) {
   ...
   aes_encrypt(ctx->u.aes.ctx_enc, ctx->u.aes.cbc,
        ctx->u.aes.cbc);
   memcpy((crypt), (ctx->u.aes.cbc), (16));
   plain += 16;
   crypt += 16;
  }
  break;
# 177 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
     ...
     u8 *plain, size_t len)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  for (i = 0; i < blocks; i++) {
   ...
   memcpy((ctx->u.aes.cbc), (tmp), (16));
   plain += 16;
   crypt += 16;
  }
  break;
# 245 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
