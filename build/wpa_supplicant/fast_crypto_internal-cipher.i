# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 2
...
void aes_decrypt(void *ctx, const u8 *crypt, u8 *plain);
void aes_decrypt_deinit(void *ctx);
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 2



# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/aes.h" 1
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/aes.h"
...
# 48 "D:/ESP32/esp-idf-v3.1-rc1/components/mbedtls/mbedtls/include/mbedtls/aes.h" 2
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 2
...
# 52 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
    } u;
};
       ...
       size_t key_len)
{
    ...
    ctx = (struct fast_crypto_cipher *)calloc(1, (sizeof(*ctx)));
    if (ctx == 
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 3 4
              ((void *)0)
# 63 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
                  ) {
        return 
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 3 4
              ((void *)0)
# 64 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
                  ;
    }
    ...
    switch (alg) {
        case CRYPTO_CIPHER_ALG_RC4:
         ...
         free((ctx));
         return 
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 3 4
               ((void *)0)
# 73 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
                   ;
            }
        ...
        case CRYPTO_CIPHER_ALG_AES:
            esp_aes_init(&(ctx->u.aes.ctx_enc));
            esp_aes_setkey(&(ctx->u.aes.ctx_enc), key, 256);
            esp_aes_init(&(ctx->u.aes.ctx_dec));
            esp_aes_setkey(&(ctx->u.aes.ctx_dec), key, 256);
            memcpy((ctx->u.aes.cbc), (iv), (16));
            break;
# 105 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
        default:
            free((ctx));
            return 
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c" 3 4
                  ((void *)0)
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
                      ;
    }
    ...
    switch (fast_ctx->alg) {
        ...
        case CRYPTO_CIPHER_ALG_AES:
            ...
            for (i = 0; i < blocks; i++) {
                ...
                if (esp_internal_aes_encrypt(&(fast_ctx->u.aes.ctx_enc), fast_ctx->u.aes.cbc, fast_ctx->u.aes.cbc) != 0) {
                    return -1;
                }
                memcpy((crypt), (fast_ctx->u.aes.cbc), (16));
                plain += 16;
                crypt += 16;
            }
            break;
# 181 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
        default:
            return -1;
    }
     ...
     uint8_t *plain, size_t len)
{
    ...
    switch (fast_ctx->alg) {
        ...
        case CRYPTO_CIPHER_ALG_AES:
            ...
            for (i = 0; i < blocks; i++) {
                memcpy((tmp), (crypt), (16));
                if (esp_internal_aes_decrypt(&(fast_ctx->u.aes.ctx_dec), crypt, plain) != 0) {
                    return -1;
                }
                for (j = 0; j < 16; j++)
                    plain[j] ^= fast_ctx->u.aes.cbc[j];
                memcpy((fast_ctx->u.aes.cbc), (tmp), (16));
                plain += 16;
                crypt += 16;
            }
            break;
# 260 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_crypto_internal-cipher.c"
        default:
            return -1;
}
...
void fast_crypto_cipher_deinit(struct crypto_cipher *ctx)
{
    ...
    switch (fast_ctx->alg) {
        case CRYPTO_CIPHER_ALG_AES:
            esp_aes_free(&(fast_ctx->u.aes.ctx_enc));
            esp_aes_free(&(fast_ctx->u.aes.ctx_dec));
            break;
