# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c" 2
...
# 43 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
int
...
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
...
# 100 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
static int
sha256_compress(struct sha256_state *md, unsigned char *buf)
{
 ...
 for (i = 0; i < 16; i++)
  W[i] = ((((u32) (buf + (4 * i))[0]) << 24) | (((u32) (buf + (4 * i))[1]) << 16) | (((u32) (buf + (4 * i))[2]) << 8) | ((u32) (buf + (4 * i))[3]));


 for (i = 16; i < 64; i++) {
  W[i] = (( ((((unsigned long) ((W[i - 2])) & 0xFFFFFFFFUL) >> (unsigned long) (((17)) & 31)) | ((unsigned long) ((W[i - 2])) << (unsigned long) (32 - (((17)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((W[i - 2])) & 0xFFFFFFFFUL) >> (unsigned long) (((19)) & 31)) | ((unsigned long) ((W[i - 2])) << (unsigned long) (32 - (((19)) & 31)))) & 0xFFFFFFFFUL) ^ (((W[i - 2])&0xFFFFFFFFUL)>>(10))) + W[i - 7] + (( ((((unsigned long) ((W[i - 15])) & 0xFFFFFFFFUL) >> (unsigned long) (((7)) & 31)) | ((unsigned long) ((W[i - 15])) << (unsigned long) (32 - (((7)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((W[i - 15])) & 0xFFFFFFFFUL) >> (unsigned long) (((18)) & 31)) | ((unsigned long) ((W[i - 15])) << (unsigned long) (32 - (((18)) & 31)))) & 0xFFFFFFFFUL) ^ (((W[i - 15])&0xFFFFFFFFUL)>>(3))) +
   W[i - 16];
 }
# 129 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
 for (i = 0; i < 64; ++i) {
  t0 = S[7] + (( ((((unsigned long) ((S[4])) & 0xFFFFFFFFUL) >> (unsigned long) (((6)) & 31)) | ((unsigned long) ((S[4])) << (unsigned long) (32 - (((6)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((S[4])) & 0xFFFFFFFFUL) >> (unsigned long) (((11)) & 31)) | ((unsigned long) ((S[4])) << (unsigned long) (32 - (((11)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((S[4])) & 0xFFFFFFFFUL) >> (unsigned long) (((25)) & 31)) | ((unsigned long) ((S[4])) << (unsigned long) (32 - (((25)) & 31)))) & 0xFFFFFFFFUL)) + (S[6] ^ (S[4] & (S[5] ^ S[6]))) + K[i] + W[i]; t1 = (( ((((unsigned long) ((S[0])) & 0xFFFFFFFFUL) >> (unsigned long) (((2)) & 31)) | ((unsigned long) ((S[0])) << (unsigned long) (32 - (((2)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((S[0])) & 0xFFFFFFFFUL) >> (unsigned long) (((13)) & 31)) | ((unsigned long) ((S[0])) << (unsigned long) (32 - (((13)) & 31)))) & 0xFFFFFFFFUL) ^ ( ((((unsigned long) ((S[0])) & 0xFFFFFFFFUL) >> (unsigned long) (((22)) & 31)) | ((unsigned long) ((S[0])) << (unsigned long) (32 - (((22)) & 31)))) & 0xFFFFFFFFUL)) + (((S[0] | S[1]) & S[2]) | (S[0] & S[1])); S[3] += t0; S[7] = t0 + t1;;
...
# 166 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
static int
...
# 207 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/sha256-internal.c"
static int
sha256_done(struct sha256_state *md, unsigned char *out)
{
 ...
 do { (md->buf + 56)[0] = (u8) (((u64) (md->length)) >> 56); (md->buf + 56)[1] = (u8) (((u64) (md->length)) >> 48); (md->buf + 56)[2] = (u8) (((u64) (md->length)) >> 40); (md->buf + 56)[3] = (u8) (((u64) (md->length)) >> 32); (md->buf + 56)[4] = (u8) (((u64) (md->length)) >> 24); (md->buf + 56)[5] = (u8) (((u64) (md->length)) >> 16); (md->buf + 56)[6] = (u8) (((u64) (md->length)) >> 8); (md->buf + 56)[7] = (u8) (((u64) (md->length)) & 0xff); } while (0);
 sha256_compress(md, md->buf);


 for (i = 0; i < 8; i++)
  do { (out + (4 * i))[0] = (u8) ((((u32) (md->state[i])) >> 24) & 0xff); (out + (4 * i))[1] = (u8) ((((u32) (md->state[i])) >> 16) & 0xff); (out + (4 * i))[2] = (u8) ((((u32) (md->state[i])) >> 8) & 0xff); (out + (4 * i))[3] = (u8) (((u32) (md->state[i])) & 0xff); } while (0);
