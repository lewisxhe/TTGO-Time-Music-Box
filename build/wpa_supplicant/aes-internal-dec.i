# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 2
...
# 29 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 2
# 39 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
static int rijndaelKeySetupDec(u32 rk[], const u8 cipherKey[], int keyBits)
{
 ...
 for (i = 1; i < Nr; i++) {
  rk += 4;
  for (j = 0; j < 4; j++) {
   rk[j] = Td0[(((Te0[((rk[j] >> 24))] >> 8) & 0x000000ff)) & 0xff] ^
    rotr(Td0[(((Te0[((rk[j] >> 16) & 0xff)] >> 8) & 0x000000ff)) & 0xff], 8) ^
    rotr(Td0[(((Te0[((rk[j] >> 8) & 0xff)] >> 8) & 0x000000ff)) & 0xff], 16) ^
    rotr(Td0[(((Te0[((rk[j] ) & 0xff)] >> 8) & 0x000000ff)) & 0xff], 24);
  }
 }
...
void * aes_decrypt_init(const u8 *key, size_t len)
{
 ...
 rk = malloc(((4 * 4 * 15 + 4)));
 if (rk == 
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 3 4
          ((void *)0)
# 75 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
              )
  return 
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 3 4
        ((void *)0)
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
            ;
 res = rijndaelKeySetupDec(rk, key, len * 8);
 if (res < 0) {
  free((rk));
  return 
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c" 3 4
        ((void *)0)
# 80 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
            ;
 }
 rk[(4 * 15)] = res;
 return rk;
...
static void rijndaelDecrypt(const u32 rk[ ], int Nr, const u8 ct[16],
       u8 pt[16])
{
...
# 134 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
 r = Nr >> 1;
 for (;;) {
  ...
  if (--r == 0)
   break;
  s0 = Td0[((t0) >> 24) & 0xff] ^ rotr(Td0[((t3) >> 16) & 0xff], 8) ^ rotr(Td0[((t2) >> 8) & 0xff], 16) ^ rotr(Td0[(t1) & 0xff], 24) ^ rk[4 * 0]; s1 = Td0[((t1) >> 24) & 0xff] ^ rotr(Td0[((t0) >> 16) & 0xff], 8) ^ rotr(Td0[((t3) >> 8) & 0xff], 16) ^ rotr(Td0[(t2) & 0xff], 24) ^ rk[4 * 0 + 1]; s2 = Td0[((t2) >> 24) & 0xff] ^ rotr(Td0[((t1) >> 16) & 0xff], 8) ^ rotr(Td0[((t0) >> 8) & 0xff], 16) ^ rotr(Td0[(t3) & 0xff], 24) ^ rk[4 * 0 + 2]; s3 = Td0[((t3) >> 24) & 0xff] ^ rotr(Td0[((t2) >> 16) & 0xff], 8) ^ rotr(Td0[((t1) >> 8) & 0xff], 16) ^ rotr(Td0[(t0) & 0xff], 24) ^ rk[4 * 0 + 3];
 }
# 151 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-dec.c"
...
{
 u32 *rk = ctx;
 rijndaelDecrypt(ctx, rk[(4 * 15)], crypt, plain);
}
