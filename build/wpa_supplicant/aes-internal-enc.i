# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
# 24 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
...
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 2
...
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 2
...
# 27 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 2
...
# 28 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 2
...
# 78 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
 r = Nr >> 1;
 for (;;) {
  t0 = Te0[((s0) >> 24) & 0xff] ^ rotr(Te0[((s1) >> 16) & 0xff], 8) ^ rotr(Te0[((s2) >> 8) & 0xff], 16) ^ rotr(Te0[(s3) & 0xff], 24) ^ rk[4 * 1]; t1 = Te0[((s1) >> 24) & 0xff] ^ rotr(Te0[((s2) >> 16) & 0xff], 8) ^ rotr(Te0[((s3) >> 8) & 0xff], 16) ^ rotr(Te0[(s0) & 0xff], 24) ^ rk[4 * 1 + 1]; t2 = Te0[((s2) >> 24) & 0xff] ^ rotr(Te0[((s3) >> 16) & 0xff], 8) ^ rotr(Te0[((s0) >> 8) & 0xff], 16) ^ rotr(Te0[(s1) & 0xff], 24) ^ rk[4 * 1 + 2]; t3 = Te0[((s3) >> 24) & 0xff] ^ rotr(Te0[((s0) >> 16) & 0xff], 8) ^ rotr(Te0[((s1) >> 8) & 0xff], 16) ^ rotr(Te0[(s2) & 0xff], 24) ^ rk[4 * 1 + 3];
  rk += 8;
  if (--r == 0)
   break;
  s0 = Te0[((t0) >> 24) & 0xff] ^ rotr(Te0[((t1) >> 16) & 0xff], 8) ^ rotr(Te0[((t2) >> 8) & 0xff], 16) ^ rotr(Te0[(t3) & 0xff], 24) ^ rk[4 * 0]; s1 = Te0[((t1) >> 24) & 0xff] ^ rotr(Te0[((t2) >> 16) & 0xff], 8) ^ rotr(Te0[((t3) >> 8) & 0xff], 16) ^ rotr(Te0[(t0) & 0xff], 24) ^ rk[4 * 0 + 1]; s2 = Te0[((t2) >> 24) & 0xff] ^ rotr(Te0[((t3) >> 16) & 0xff], 8) ^ rotr(Te0[((t0) >> 8) & 0xff], 16) ^ rotr(Te0[(t1) & 0xff], 24) ^ rk[4 * 0 + 2]; s3 = Te0[((t3) >> 24) & 0xff] ^ rotr(Te0[((t0) >> 16) & 0xff], 8) ^ rotr(Te0[((t1) >> 8) & 0xff], 16) ^ rotr(Te0[(t2) & 0xff], 24) ^ rk[4 * 0 + 3];
 }
# 95 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
 s0 = ((Te0[((t0) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t1) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t2) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t3) & 0xff] >> 8) & 0x000000ff) ^ rk[0];
 { (ct)[0] = (u8)((s0) >> 24); (ct)[1] = (u8)((s0) >> 16); (ct)[2] = (u8)((s0) >> 8); (ct)[3] = (u8)(s0); };
 s1 = ((Te0[((t1) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t2) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t3) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t0) & 0xff] >> 8) & 0x000000ff) ^ rk[1];
 { (ct + 4)[0] = (u8)((s1) >> 24); (ct + 4)[1] = (u8)((s1) >> 16); (ct + 4)[2] = (u8)((s1) >> 8); (ct + 4)[3] = (u8)(s1); };
 s2 = ((Te0[((t2) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t3) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t0) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t1) & 0xff] >> 8) & 0x000000ff) ^ rk[2];
 { (ct + 8)[0] = (u8)((s2) >> 24); (ct + 8)[1] = (u8)((s2) >> 16); (ct + 8)[2] = (u8)((s2) >> 8); (ct + 8)[3] = (u8)(s2); };
 s3 = ((Te0[((t3) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t0) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t1) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t2) & 0xff] >> 8) & 0x000000ff) ^ rk[3];
...
void * aes_encrypt_init(const u8 *key, size_t len)
{
 ...
 rk = malloc(((4 * 4 * 15 + 4)));
 if (rk == 
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 3 4
          ((void *)0)
# 111 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
              )
  return 
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 3 4
        ((void *)0)
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
            ;
 res = rijndaelKeySetupEnc(rk, key, len * 8);
 if (res < 0) {
  free((rk));
  return 
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c" 3 4
        ((void *)0)
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/aes-internal-enc.c"
            ;
 }
 rk[(4 * 15)] = res;
 return rk;
...
{
 u32 *rk = ctx;
 rijndaelEncrypt(ctx, rk[(4 * 15)], plain, crypt);
}


void aes_encrypt_deinit(void *ctx)
{
 memset(ctx, 0, (4 * 4 * 15 + 4));
 free((ctx));
}
