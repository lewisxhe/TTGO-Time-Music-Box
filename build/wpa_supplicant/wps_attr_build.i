# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/wpa_debug.h" 1
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2

# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/crypto/aes_wrap.h" 1
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/crypto/aes_wrap.h"
int __attribute__((__warn_unused_result__)) aes_wrap(const u8 *kek, int n, const u8 *plain, u8 *cipher);
int __attribute__((__warn_unused_result__)) aes_unwrap(const u8 *kek, int n, const u8 *cipher, u8 *plain);
...
int __attribute__((__warn_unused_result__)) aes_128_cbc_decrypt(const u8 *key, const u8 *iv, u8 *data,
         size_t data_len);
int __attribute__((__warn_unused_result__)) fast_aes_wrap(const uint8_t *kek, int n, const uint8_t *plain, uint8_t *cipher);
int __attribute__((__warn_unused_result__)) fast_aes_unwrap(const uint8_t *kek, int n, const uint8_t *cipher, uint8_t *plain);
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_encrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
int rc4_skip(const u8 *key, size_t keylen, size_t skip,
      u8 *data, size_t data_len);
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/crypto/random.h" 1
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 2
...
int wps_build_public_key(struct wps_data *wps, struct wpabuf *msg, wps_key_mode_t mode)
{
 ...
 if (mode != WPS_CALC_KEY_NO_CALC) {
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Public Key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Public Key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Public Key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Public Key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Public Key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  wpabuf_free(wps->dh_privkey);
  if (wps->dev_pw_id != DEV_PW_DEFAULT && wps->wps->dh_privkey) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Using pre-configured DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Using pre-configured DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Using pre-configured DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Using pre-configured DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Using pre-configured DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   wps->dh_privkey = wpabuf_dup(wps->wps->dh_privkey);
   wps->dh_ctx = wps->wps->dh_ctx;
   wps->wps->dh_ctx = 
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
                     ((void *)0)
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
                         ;
   pubkey = wpabuf_dup(wps->wps->dh_pubkey);
# 44 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
  } else {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Generate new DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Generate new DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Generate new DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Generate new DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Generate new DH keys" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   wps->dh_privkey = 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
                    ((void *)0)
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
                        ;
   dh5_free(wps->dh_ctx);

   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "build public key start\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "build public key start\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "build public key start\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "build public key start\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "build public key start\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);

   wps->dh_ctx = dh5_init(&wps->dh_privkey, &pubkey);

   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "build public key finish\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "build public key finish\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "build public key finish\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "build public key finish\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "build public key finish\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);

   pubkey = wpabuf_zeropad(pubkey, 192);
  }
  if (wps->dh_ctx == 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
                    ((void *)0) 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
                         || wps->dh_privkey == 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
                                               ((void *)0) 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
...
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
   ...
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Failed to initialize " "Diffie-Hellman handshake" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Failed to initialize " "Diffie-Hellman handshake" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Failed to initialize " "Diffie-Hellman handshake" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Failed to initialize " "Diffie-Hellman handshake" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Failed to initialize " "Diffie-Hellman handshake" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                ;
   wpabuf_free(pubkey);
   return -1;
  }
  wpa_hexdump_buf_key(ESP_LOG_DEBUG, "WPS: DH Private Key", wps->dh_privkey);
  wpa_hexdump_buf(ESP_LOG_DEBUG, "WPS: DH own Public Key", pubkey);
...
int wps_build_req_type(struct wpabuf *msg, enum wps_request_type type)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Request Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Request Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Request Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Request Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Request Type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_resp_type(struct wpabuf *msg, enum wps_response_type type)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Response Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Response Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Response Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Response Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Response Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } } while(0); } while(0);
...
int wps_build_uuid_e(struct wpabuf *msg, const u8 *uuid)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * UUID-E" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * UUID-E" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * UUID-E" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * UUID-E" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * UUID-E" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_UUID_E);
 wpabuf_put_be16(msg, 16);
 wpabuf_put_data(msg, uuid, 16);
 return 0;
}
...
int wps_build_config_error(struct wpabuf *msg, u16 err)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Configuration Error (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Configuration Error (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Configuration Error (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Configuration Error (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", err); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Configuration Error (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", err); } } while(0); } while(0);
...
int wps_build_authenticator(struct wps_data *wps, struct wpabuf *msg)
{
 ...
 if (wps->last_msg == 
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
                     ((void *)0)
# 157 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
                         ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS: Last message not available for " "building authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS: Last message not available for " "building authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS: Last message not available for " "building authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS: Last message not available for " "building authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS: Last message not available for " "building authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                               ;
  return -1;
 }
 ...
 if (wps_crypto_funcs.hmac_sha256_vector) {
         wps_crypto_funcs.hmac_sha256_vector(wps->authkey, 32, 2, addr, (int *)len, hash);
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register hmac sha256 vector!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register hmac sha256 vector!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register hmac sha256 vector!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register hmac sha256 vector!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register hmac sha256 vector!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_AUTHENTICATOR);
 wpabuf_put_be16(msg, 8);
 wpabuf_put_data(msg, hash, 8);
...
int wps_build_version(struct wpabuf *msg)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Version (hardcoded 0x10)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Version (hardcoded 0x10)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Version (hardcoded 0x10)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Version (hardcoded 0x10)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Version (hardcoded 0x10)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
        ...
        const u8 *auth_macs, size_t auth_macs_count)
{
 ...
 wpabuf_put_be24(msg, 14122);

 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Version2 (0x%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", 0x20); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Version2 (0x%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", 0x20); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Version2 (0x%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", 0x20); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Version2 (0x%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", 0x20); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Version2 (0x%x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", 0x20); } } while(0); } while(0);
 wpabuf_put_u8(msg, WFA_ELEM_VERSION2);
 wpabuf_put_u8(msg, 1);
 wpabuf_put_u8(msg, 0x20);

 if (req_to_enroll) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Request to Enroll (1)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Request to Enroll (1)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Request to Enroll (1)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Request to Enroll (1)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Request to Enroll (1)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 ...
 if (auth_macs && auth_macs_count) {
  size_t i;
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * AuthorizedMACs (count=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) auth_macs_count); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * AuthorizedMACs (count=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) auth_macs_count); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * AuthorizedMACs (count=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) auth_macs_count); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * AuthorizedMACs (count=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) auth_macs_count); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * AuthorizedMACs (count=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (int) auth_macs_count); } } while(0); } while(0)
                            ;
  wpabuf_put_u8(msg, WFA_ELEM_AUTHORIZEDMACS);
  wpabuf_put_u8(msg, auth_macs_count * 6);
  wpabuf_put_data(msg, auth_macs, auth_macs_count * 6);
  for (i = 0; i < auth_macs_count; i++)
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:    AuthorizedMAC: " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (&auth_macs[i * 6])[0], (&auth_macs[i * 6])[1], (&auth_macs[i * 6])[2], (&auth_macs[i * 6])[3], (&auth_macs[i * 6])[4], (&auth_macs[i * 6])[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:    AuthorizedMAC: " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (&auth_macs[i * 6])[0], (&auth_macs[i * 6])[1], (&auth_macs[i * 6])[2], (&auth_macs[i * 6])[3], (&auth_macs[i * 6])[4], (&auth_macs[i * 6])[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:    AuthorizedMAC: " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (&auth_macs[i * 6])[0], (&auth_macs[i * 6])[1], (&auth_macs[i * 6])[2], (&auth_macs[i * 6])[3], (&auth_macs[i * 6])[4], (&auth_macs[i * 6])[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:    AuthorizedMAC: " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (&auth_macs[i * 6])[0], (&auth_macs[i * 6])[1], (&auth_macs[i * 6])[2], (&auth_macs[i * 6])[3], (&auth_macs[i * 6])[4], (&auth_macs[i * 6])[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:    AuthorizedMAC: " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (&auth_macs[i * 6])[0], (&auth_macs[i * 6])[1], (&auth_macs[i * 6])[2], (&auth_macs[i * 6])[3], (&auth_macs[i * 6])[4], (&auth_macs[i * 6])[5]); } } while(0); } while(0)
                                         ;
 }

 do { (len)[0] = ((u16) ((u8 *) wpabuf_put(msg, 0) - len - 2)) >> 8; (len)[1] = ((u16) ((u8 *) wpabuf_put(msg, 0) - len - 2)) & 0xff; } while (0);
# 246 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
 return 0;
}
...
int wps_build_msg_type(struct wpabuf *msg, enum wps_msg_type msg_type)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Message Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", msg_type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Message Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", msg_type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Message Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", msg_type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Message Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", msg_type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Message Type (%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", msg_type); } } while(0); } while(0);
...
int wps_build_enrollee_nonce(struct wps_data *wps, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Enrollee Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Enrollee Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Enrollee Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Enrollee Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Enrollee Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_ENROLLEE_NONCE);
 wpabuf_put_be16(msg, 16);
 wpabuf_put_data(msg, wps->nonce_e, 16);
 return 0;
}
...
int wps_build_registrar_nonce(struct wps_data *wps, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Registrar Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Registrar Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Registrar Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Registrar Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Registrar Nonce" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 wpabuf_put_be16(msg, ATTR_REGISTRAR_NONCE);
 wpabuf_put_be16(msg, 16);
 wpabuf_put_data(msg, wps->nonce_r, 16);
 return 0;
}
...
int wps_build_auth_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
 u16 auth_types = (0x0001 | 0x0002 | 0x0004 | 0x0008 | 0x0010 | 0x0020);

 auth_types &= ~0x0004;

 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Authentication Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Authentication Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Authentication Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Authentication Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Authentication Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_encr_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
 u16 encr_types = (0x0001 | 0x0002 | 0x0004 | 0x0008);

 encr_types &= ~0x0002;

 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Encryption Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Encryption Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Encryption Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Encryption Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Encryption Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_conn_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Connection Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Connection Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Connection Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Connection Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Connection Type Flags" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_assoc_state(struct wps_data *wps, struct wpabuf *msg)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Association State" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Association State" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Association State" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Association State" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Association State" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
...
int wps_build_key_wrap_auth(struct wps_data *wps, struct wpabuf *msg)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Key Wrap Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Key Wrap Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Key Wrap Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Key Wrap Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Key Wrap Authenticator" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 if (wps_crypto_funcs.hmac_sha256) {
         wps_crypto_funcs.hmac_sha256(wps->authkey, 32, wpabuf_head(msg),
                               wpabuf_len(msg), hash);
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register hmac sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register hmac sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register hmac sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register hmac sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register hmac sha256 function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }
       ...
       struct wpabuf *plain)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPS:  * AES 128 Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPS:  * AES 128 Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPS:  * AES 128 Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPS:  * AES 128 Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPS:  * AES 128 Encrypted Settings" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 if (wps_crypto_funcs.aes_128_encrypt) {
         if (wps_crypto_funcs.aes_128_encrypt(wps->keywrapkey, iv, data, wpabuf_len(plain)))
          return -1;
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register aes_128_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register aes_128_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register aes_128_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register aes_128_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register aes_128_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }
 return 0;
}
# 410 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
struct wpabuf * wps_ie_encapsulate(struct wpabuf *data)
{
 struct wpabuf *ie;
 const u8 *pos, *end;
 ...
 if (ie == 
# 416 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
          ((void *)0)
# 416 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
              ) {
  wpabuf_free(data);
  return 
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c" 3 4
        ((void *)0)
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/wps_attr_build.c"
            ;
 }
