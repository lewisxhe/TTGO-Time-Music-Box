# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c"
...
# 7 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c" 2
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c" 2
...
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c" 2
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c" 2
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c"
int
fast_aes_128_cbc_encrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data, size_t data_len)
{
    ...
    ret = esp_aes_setkey(&ctx, key, 128);
    ...
    ret = esp_aes_crypt_cbc(&ctx, 1, data_len, cbc, data, data);

    esp_aes_free(&ctx);

    return ret;
}
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-cbc.c"
int
fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data, size_t data_len)
{
    ...
    ret = esp_aes_crypt_cbc(&ctx, 0, data_len, cbc, data, data);
