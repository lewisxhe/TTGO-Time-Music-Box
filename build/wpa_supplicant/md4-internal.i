# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c"
...
# 8 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c" 2
...
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c" 2
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c" 2
...
static void MD4Transform(u32 state[4], const u8 block[64]);
# 56 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c"
...
static void MD4Pad(MD4_CTX *ctx)
{
 ...
 do { (count)[7] = (ctx->count) >> 56; (count)[6] = (ctx->count) >> 48; (count)[5] = (ctx->count) >> 40; (count)[4] = (ctx->count) >> 32; (count)[3] = (ctx->count) >> 24; (count)[2] = (ctx->count) >> 16; (count)[1] = (ctx->count) >> 8; (count)[0] = (ctx->count); } while (0);
...
static void MD4Final(unsigned char digest[16], MD4_CTX *ctx)
{
 ...
 MD4Pad(ctx);
 if (digest != 
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c" 3 4
              ((void *)0)
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c"
                  ) {
  for (i = 0; i < 4; i ++)
...
# 135 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/md4-internal.c"
static void MD4Transform(u32 state[4], const u8 block[64])
{
 u32 a, b, c, d, in[64 / 4];
 ...
 ( a += (d ^ (b & (c ^ d))) + in[ 0], a = a<<3 | a>>(32-3) );
 ( d += (c ^ (a & (b ^ c))) + in[ 1], d = d<<7 | d>>(32-7) );
 ( c += (b ^ (d & (a ^ b))) + in[ 2], c = c<<11 | c>>(32-11) );
 ( b += (a ^ (c & (d ^ a))) + in[ 3], b = b<<19 | b>>(32-19) );
 ( a += (d ^ (b & (c ^ d))) + in[ 4], a = a<<3 | a>>(32-3) );
 ( d += (c ^ (a & (b ^ c))) + in[ 5], d = d<<7 | d>>(32-7) );
 ( c += (b ^ (d & (a ^ b))) + in[ 6], c = c<<11 | c>>(32-11) );
 ( b += (a ^ (c & (d ^ a))) + in[ 7], b = b<<19 | b>>(32-19) );
 ( a += (d ^ (b & (c ^ d))) + in[ 8], a = a<<3 | a>>(32-3) );
 ( d += (c ^ (a & (b ^ c))) + in[ 9], d = d<<7 | d>>(32-7) );
 ( c += (b ^ (d & (a ^ b))) + in[10], c = c<<11 | c>>(32-11) );
 ( b += (a ^ (c & (d ^ a))) + in[11], b = b<<19 | b>>(32-19) );
 ( a += (d ^ (b & (c ^ d))) + in[12], a = a<<3 | a>>(32-3) );
 ( d += (c ^ (a & (b ^ c))) + in[13], d = d<<7 | d>>(32-7) );
 ( c += (b ^ (d & (a ^ b))) + in[14], c = c<<11 | c>>(32-11) );
 ( b += (a ^ (c & (d ^ a))) + in[15], b = b<<19 | b>>(32-19) );

 ( a += ((b & c) | (b & d) | (c & d)) + in[ 0] + 0x5a827999, a = a<<3 | a>>(32-3) );
 ( d += ((a & b) | (a & c) | (b & c)) + in[ 4] + 0x5a827999, d = d<<5 | d>>(32-5) );
 ( c += ((d & a) | (d & b) | (a & b)) + in[ 8] + 0x5a827999, c = c<<9 | c>>(32-9) );
 ( b += ((c & d) | (c & a) | (d & a)) + in[12] + 0x5a827999, b = b<<13 | b>>(32-13) );
 ( a += ((b & c) | (b & d) | (c & d)) + in[ 1] + 0x5a827999, a = a<<3 | a>>(32-3) );
 ( d += ((a & b) | (a & c) | (b & c)) + in[ 5] + 0x5a827999, d = d<<5 | d>>(32-5) );
 ( c += ((d & a) | (d & b) | (a & b)) + in[ 9] + 0x5a827999, c = c<<9 | c>>(32-9) );
 ( b += ((c & d) | (c & a) | (d & a)) + in[13] + 0x5a827999, b = b<<13 | b>>(32-13) );
 ( a += ((b & c) | (b & d) | (c & d)) + in[ 2] + 0x5a827999, a = a<<3 | a>>(32-3) );
 ( d += ((a & b) | (a & c) | (b & c)) + in[ 6] + 0x5a827999, d = d<<5 | d>>(32-5) );
 ( c += ((d & a) | (d & b) | (a & b)) + in[10] + 0x5a827999, c = c<<9 | c>>(32-9) );
 ( b += ((c & d) | (c & a) | (d & a)) + in[14] + 0x5a827999, b = b<<13 | b>>(32-13) );
 ( a += ((b & c) | (b & d) | (c & d)) + in[ 3] + 0x5a827999, a = a<<3 | a>>(32-3) );
 ( d += ((a & b) | (a & c) | (b & c)) + in[ 7] + 0x5a827999, d = d<<5 | d>>(32-5) );
 ( c += ((d & a) | (d & b) | (a & b)) + in[11] + 0x5a827999, c = c<<9 | c>>(32-9) );
 ( b += ((c & d) | (c & a) | (d & a)) + in[15] + 0x5a827999, b = b<<13 | b>>(32-13) );

 ( a += (b ^ c ^ d) + in[ 0] + 0x6ed9eba1, a = a<<3 | a>>(32-3) );
 ( d += (a ^ b ^ c) + in[ 8] + 0x6ed9eba1, d = d<<9 | d>>(32-9) );
 ( c += (d ^ a ^ b) + in[ 4] + 0x6ed9eba1, c = c<<11 | c>>(32-11) );
 ( b += (c ^ d ^ a) + in[12] + 0x6ed9eba1, b = b<<15 | b>>(32-15) );
 ( a += (b ^ c ^ d) + in[ 2] + 0x6ed9eba1, a = a<<3 | a>>(32-3) );
 ( d += (a ^ b ^ c) + in[10] + 0x6ed9eba1, d = d<<9 | d>>(32-9) );
 ( c += (d ^ a ^ b) + in[ 6] + 0x6ed9eba1, c = c<<11 | c>>(32-11) );
 ( b += (c ^ d ^ a) + in[14] + 0x6ed9eba1, b = b<<15 | b>>(32-15) );
 ( a += (b ^ c ^ d) + in[ 1] + 0x6ed9eba1, a = a<<3 | a>>(32-3) );
 ( d += (a ^ b ^ c) + in[ 9] + 0x6ed9eba1, d = d<<9 | d>>(32-9) );
 ( c += (d ^ a ^ b) + in[ 5] + 0x6ed9eba1, c = c<<11 | c>>(32-11) );
 ( b += (c ^ d ^ a) + in[13] + 0x6ed9eba1, b = b<<15 | b>>(32-15) );
 ( a += (b ^ c ^ d) + in[ 3] + 0x6ed9eba1, a = a<<3 | a>>(32-3) );
 ( d += (a ^ b ^ c) + in[11] + 0x6ed9eba1, d = d<<9 | d>>(32-9) );
 ( c += (d ^ a ^ b) + in[ 7] + 0x6ed9eba1, c = c<<11 | c>>(32-11) );
 ( b += (c ^ d ^ a) + in[15] + 0x6ed9eba1, b = b<<15 | b>>(32-15) );
