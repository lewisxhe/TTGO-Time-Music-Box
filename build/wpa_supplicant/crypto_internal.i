# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
...
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 2
...
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 2
          ...
          size_t key_len)
{
 ...
 ctx = (struct crypto_hash *)calloc(1, (sizeof(*ctx)));
 if (ctx == 
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
           ((void *)0)
# 45 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
               )
  return 
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
        ((void *)0)
# 46 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
            ;
 ...
 case CRYPTO_HASH_ALG_HMAC_SHA1:
  ...
  break;
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
 default:
  free((ctx));
  return 
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
        ((void *)0)
# 123 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
            ;
 }
...
{
 if (ctx == 
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
           ((void *)0)
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
               )
  return;
...
int crypto_hash_finish(struct crypto_hash *ctx, u8 *mac, size_t *len)
{
 ...
 if (ctx == 
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
           ((void *)0)
# 161 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
               )
  return -2;

 if (mac == 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
           ((void *)0) 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
                || len == 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c" 3 4
                          ((void *)0)
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
  ...
  *len = 20;
  ...
  break;
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
 case CRYPTO_HASH_ALG_HMAC_MD5:
  if (*len < 16) {
   *len = 16;
   free((ctx));
  ...
  *len = 16;
  ...
  memset(k_pad + ctx->key_len, 0, sizeof(k_pad) - ctx->key_len)
                                  ;
  for (i = 0; i < sizeof(k_pad); i++)
   k_pad[i] ^= 0x5c;
  MD5Init(&ctx->u.md5);
  ...
  *len = 20;
  ...
  SHA1Final(mac, &ctx->u.sha1);
  break;
# 261 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/crypto_internal.c"
 default:
  free((ctx));
  return -1;
 }
