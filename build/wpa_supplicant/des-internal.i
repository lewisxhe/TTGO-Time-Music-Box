# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c"
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c" 2
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/des-internal.c"
...
static void desfunc(u32 *block, const u32 *keys)
{
 ...
 right = ((((unsigned long) (right) << (unsigned long) ((1) & 31)) | (((unsigned long) (right) & 0xFFFFFFFFUL) >> (unsigned long) (32 - ((1) & 31)))) & 0xFFFFFFFFUL);
 work = (leftt ^ right) & 0xaaaaaaaaL;

 leftt ^= work;
 right ^= work;
 leftt = ((((unsigned long) (leftt) << (unsigned long) ((1) & 31)) | (((unsigned long) (leftt) & 0xFFFFFFFFUL) >> (unsigned long) (32 - ((1) & 31)))) & 0xFFFFFFFFUL);

 for (cur_round = 0; cur_round < 8; cur_round++) {
  work = (((((unsigned long) (right) & 0xFFFFFFFFUL) >> (unsigned long) ((4) & 31)) | ((unsigned long) (right) << (unsigned long) (32 - ((4) & 31)))) & 0xFFFFFFFFUL) ^ *keys++;
  ...
  work = (((((unsigned long) (leftt) & 0xFFFFFFFFUL) >> (unsigned long) ((4) & 31)) | ((unsigned long) (leftt) << (unsigned long) (32 - ((4) & 31)))) & 0xFFFFFFFFUL) ^ *keys++;
 ...
 right = (((((unsigned long) (right) & 0xFFFFFFFFUL) >> (unsigned long) ((1) & 31)) | ((unsigned long) (right) << (unsigned long) (32 - ((1) & 31)))) & 0xFFFFFFFFUL);
 work = (leftt ^ right) & 0xaaaaaaaaL;
 leftt ^= work;
 right ^= work;
 leftt = (((((unsigned long) (leftt) & 0xFFFFFFFFUL) >> (unsigned long) ((1) & 31)) | ((unsigned long) (leftt) << (unsigned long) (32 - ((1) & 31)))) & 0xFFFFFFFFUL);
...
void des_encrypt(const u8 *clear, const u8 *key, u8 *cypher)
{
 ...
 work[0] = ((((u32) (clear)[0]) << 24) | (((u32) (clear)[1]) << 16) | (((u32) (clear)[2]) << 8) | ((u32) (clear)[3]));
 work[1] = ((((u32) (clear + 4)[0]) << 24) | (((u32) (clear + 4)[1]) << 16) | (((u32) (clear + 4)[2]) << 8) | ((u32) (clear + 4)[3]));
 desfunc(work, ek);
 do { (cypher)[0] = (u8) ((((u32) (work[0])) >> 24) & 0xff); (cypher)[1] = (u8) ((((u32) (work[0])) >> 16) & 0xff); (cypher)[2] = (u8) ((((u32) (work[0])) >> 8) & 0xff); (cypher)[3] = (u8) (((u32) (work[0])) & 0xff); } while (0);
 do { (cypher + 4)[0] = (u8) ((((u32) (work[1])) >> 24) & 0xff); (cypher + 4)[1] = (u8) ((((u32) (work[1])) >> 16) & 0xff); (cypher + 4)[2] = (u8) ((((u32) (work[1])) >> 8) & 0xff); (cypher + 4)[3] = (u8) (((u32) (work[1])) & 0xff); } while (0);
