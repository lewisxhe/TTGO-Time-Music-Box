# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
int tls_prf(u16 ver, const u8 *secret, size_t secret_len, const char *label,
     const u8 *seed, size_t seed_len, u8 *out, size_t outlen);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
void tlsv1_server_set_session_ticket_cb(struct tlsv1_server *conn,
     ...
     void *ctx);
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 2
...
# 107 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
u8 * tlsv1_server_handshake(struct tlsv1_server *conn,
       const u8 *in_data, size_t in_len,
       size_t *out_len)
{
 const u8 *pos, *end;
 u8 *msg = 
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
          ((void *)0)
# 112 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
              , *in_msg, *in_pos, *in_end, alert, ct;
 size_t in_msg_len;
 int used;

 if (in_data == 
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
               ((void *)0) 
# 116 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                    || in_len == 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: No input data to server" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: No input data to server" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: No input data to server" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: No input data to server" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: No input data to server" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
        ((void *)0)
# 118 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
            ;
 }
 ...
 if (in_msg == 
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
              ((void *)0)
# 124 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                  )
  return 
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
        ((void *)0)
# 125 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
            ;
 ...
 while (pos < end) {
  ...
  if (used < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                       ;
   tlsv1_server_alert(conn, 2, alert);
   goto failed;
  }
  if (used == 0) {

   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Partial processing not " "yet supported" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Partial processing not " "yet supported" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Partial processing not " "yet supported" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Partial processing not " "yet supported" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Partial processing not " "yet supported" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                       ;
   tlsv1_server_alert(conn, 2, alert);
   goto failed;
  }
 ...
 free((in_msg));
 in_msg = 
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
         ((void *)0)
# 164 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
             ;
...
failed:
 ...
 if (conn->alert_level) {
  if (conn->state == FAILED) {
   ...
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Drop alert loop" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Drop alert loop" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Drop alert loop" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Drop alert loop" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Drop alert loop" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   free((msg));
   return 
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
         ((void *)0)
# 175 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
             ;
  }
  conn->state = FAILED;
  free((msg));
...
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_encrypt(struct tlsv1_server *conn,
    const u8 *in_data, size_t in_len,
    u8 *out_data, size_t out_len)
{
...
# 233 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_decrypt(struct tlsv1_server *conn,
    const u8 *in_data, size_t in_len,
    u8 *out_data, size_t out_len)
{
 ...
 while (pos < in_end) {
  ...
  if (ct != TLS_CONTENT_TYPE_APPLICATION_DATA) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } } while(0); } while(0)
                      ;
   tlsv1_server_alert(conn, 2,
        10);
   return -1;
  ...
  out_pos += olen;
  if (out_pos > out_end) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Buffer not large enough " "for processing the received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Buffer not large enough " "for processing the received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Buffer not large enough " "for processing the received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Buffer not large enough " "for processing the received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Buffer not large enough " "for processing the received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                            ;
   tlsv1_server_alert(conn, 2,
        80);
   return -1;
...
# 317 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_global_init(void)
{
 return crypto_global_init();
}
# 330 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
void tlsv1_server_global_deinit(void)
{
...
struct tlsv1_server * tlsv1_server_init(struct tlsv1_credentials *cred)
{
 ...
 conn = (struct tlsv1_server *)calloc(1, (sizeof(*conn)));
 if (conn == 
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
            ((void *)0)
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                )
  return 
# 349 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
        ((void *)0)
# 349 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
            ;
 ...
 if (tls_verify_hash_init(&conn->verify) < 0) {
  ...
  free((conn));
  return 
# 359 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
        ((void *)0)
# 359 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
            ;
 }
...
static void tlsv1_server_clear_data(struct tlsv1_server *conn)
{
 ...
 conn->client_rsa_key = 
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
                       ((void *)0)
# 383 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                           ;

 free((conn->session_ticket));
 conn->session_ticket = 
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
                       ((void *)0)
# 386 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                           ;
 ...
 free((conn->dh_secret));
 conn->dh_secret = 
# 391 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c" 3 4
                  ((void *)0)
# 391 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
                      ;
...
# 428 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_prf(struct tlsv1_server *conn, const char *label,
       int server_random_first, u8 *out, size_t out_len)
{
 u8 seed[2 * 32];
...
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_get_cipher(struct tlsv1_server *conn, char *buf,
       size_t buflen)
{
# 500 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
    char cipher[20];
...
# 572 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_get_keys(struct tlsv1_server *conn, struct tls_keys *keys)
{
...
# 598 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_get_keyblock_size(struct tlsv1_server *conn)
{
...
# 615 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_server.c"
int tlsv1_server_set_cipher_list(struct tlsv1_server *conn, u8 *ciphers)
{
 size_t count;
 u16 *suites;
