# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
int tls_prf(u16 ver, const u8 *secret, size_t secret_len, const char *label,
     const u8 *seed, size_t seed_len, u8 *out, size_t outlen);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
void tlsv1_client_set_session_ticket_cb(struct tlsv1_client *conn,
     ...
     void *ctx);
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
int tlsv1_client_process_handshake(struct tlsv1_client *conn, u8 ct,
       ...
       u8 **out_data, size_t *out_len);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 2
...
void tlsv1_client_free_dh(struct tlsv1_client *conn)
{
 ...
 free((conn->dh_g));
 free((conn->dh_ys));
 conn->dh_p = conn->dh_g = conn->dh_ys = 
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                                        ((void *)0)
# 36 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                                            ;
}
...
int tls_derive_pre_master_secret(u8 *pre_master_secret)
{
 do { (pre_master_secret)[0] = ((u16) (0x0301)) >> 8; (pre_master_secret)[1] = ((u16) (0x0301)) & 0xff; } while (0);
...
{
 u8 seed[2 * 32];
 u8 key_block[(2 * (32 + 32 + 16))];
 u8 *pos;
 size_t key_block_len;

 if (pre_master_secret) {
  wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: pre_master_secret",
  ...
  if (tls_prf(conn->rl.tls_version,
       pre_master_secret, pre_master_secret_len,
       "master secret", seed, 2 * 32,
       conn->master_secret, 48)) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to derive " "master_secret" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to derive " "master_secret" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to derive " "master_secret" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to derive " "master_secret" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to derive " "master_secret" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                       ;
   return -1;
  }
  wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: master_secret",
    conn->master_secret, 48);
 }
 ...
 if (conn->rl.tls_version == 0x0301)
  key_block_len += 2 * conn->rl.iv_size;
 if (tls_prf(conn->rl.tls_version,
      conn->master_secret, 48,
      "key expansion", seed, 2 * 32,
      key_block, key_block_len)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to derive key_block" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to derive key_block" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to derive key_block" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to derive key_block" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to derive key_block" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return -1;
 }
 wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: key_block",
   key_block, key_block_len);
 ...
 if (conn->rl.tls_version == 0x0301) {
  ...
  memset(conn->rl.write_iv, 0, conn->rl.iv_size);
 }

 return 0;
}
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
u8 * tlsv1_client_handshake(struct tlsv1_client *conn,
       const u8 *in_data, size_t in_len,
       size_t *out_len, u8 **appl_data,
       size_t *appl_data_len, int *need_more_data)
{
 const u8 *pos, *end;
 u8 *msg = 
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
          ((void *)0)
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
              , *in_msg = 
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                          ((void *)0)
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                              , *in_pos, *in_end, alert, ct;
 size_t in_msg_len;
 int no_appl_data;
 int used;
 ...
 if (conn->state == CLIENT_HELLO) {
  if (in_len)
   return 
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
         ((void *)0)
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
             ;
 ...
 if (conn->partial_input) {
  if (wpabuf_resize(&conn->partial_input, in_len) < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to allocate " "memory for pending record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to allocate " "memory for pending record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to allocate " "memory for pending record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to allocate " "memory for pending record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to allocate " "memory for pending record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                   ;
   tls_alert(conn, 2,
      80);
   goto failed;
 ...
 if (in_data == 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
               ((void *)0) 
# 172 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                    || in_len == 0)
  return 
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
        ((void *)0)
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
            ;
 ...
 if (in_msg == 
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
              ((void *)0)
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                  )
  return 
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
        ((void *)0)
# 179 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
            ;
 ...
 while (pos < end) {
  ...
  if (used < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Processing received " "record failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                       ;
   tls_alert(conn, 2, alert);
   goto failed;
  }
  if (used == 0) {
   struct wpabuf *partial;
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   partial = wpabuf_alloc_copy(pos, end - pos);
   wpabuf_free(conn->partial_input);
   conn->partial_input = partial;
   if (conn->partial_input == 
# 198 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                             ((void *)0)
# 198 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                                 ) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
    ...
    *need_more_data = 1;
   return 
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
         ((void *)0)
# 209 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
             ;
  }
  ct = pos[0];
 ...
 free((in_msg));
 in_msg = 
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
         ((void *)0)
# 232 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
             ;

 no_appl_data = appl_data == 
# 234 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                            ((void *)0) 
# 234 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                                 || *appl_data == 
# 234 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                                                  ((void *)0)
# 234 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
...
failed:
 ...
 if (conn->alert_level) {
  wpabuf_free(conn->partial_input);
  conn->partial_input = 
# 241 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                       ((void *)0)
# 241 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                           ;
  conn->state = FAILED;
  free((msg));
...
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                  ((void *)0)
# 247 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                      ) {
  msg = (u8 *)calloc(1, (1));
  *out_len = 0;
 }
 ...
 if (need_more_data == 
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                      ((void *)0) 
# 252 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                           || !(*need_more_data)) {
  wpabuf_free(conn->partial_input);
  conn->partial_input = 
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                       ((void *)0)
# 254 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                           ;
 }

 return msg;
}
# 273 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_encrypt(struct tlsv1_client *conn,
    const u8 *in_data, size_t in_len,
    u8 *out_data, size_t out_len)
{
 ...
 wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: Plaintext AppData",
   in_data, in_len);
...
# 306 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
struct wpabuf * tlsv1_client_decrypt(struct tlsv1_client *conn,
         const u8 *in_data, size_t in_len,
         int *need_more_data)
{
 ...
 size_t olen;
 struct wpabuf *buf = 
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                     ((void *)0)
# 314 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                         ;
 ...
 while (pos < in_end) {
  ...
  used = tlsv1_record_receive(&conn->rl, pos, in_end - pos,
         out_pos, &olen, &alert);
  if (used < 0) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record layer processing " "failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record layer processing " "failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record layer processing " "failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record layer processing " "failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record layer processing " "failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   goto fail;
  }
  if (used == 0) {
   ...
   conn->partial_input = partial;
   if (conn->partial_input == 
# 355 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                             ((void *)0)
# 355 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                                 ) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to " "allocate memory for pending " "record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
  ...
  if (ct == TLS_CONTENT_TYPE_ALERT) {
   ...
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received alert %d:%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", out_pos[0], out_pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received alert %d:%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", out_pos[0], out_pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received alert %d:%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", out_pos[0], out_pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received alert %d:%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", out_pos[0], out_pos[1]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received alert %d:%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", out_pos[0], out_pos[1]); } } while(0); } while(0)
                              ;
   if (out_pos[0] == 1) {
  ...
  if (ct != TLS_CONTENT_TYPE_APPLICATION_DATA) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x when decrypting application data" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x when decrypting application data" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x when decrypting application data" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x when decrypting application data" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Unexpected content type " "0x%x when decrypting application data" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0]); } } while(0); } while(0)
 ...
 wpabuf_free(conn->partial_input);
 conn->partial_input = 
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                      ((void *)0)
# 400 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                          ;
 return buf;
...
fail:
 ...
 wpabuf_free(conn->partial_input);
 conn->partial_input = 
# 406 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                      ((void *)0)
# 406 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                          ;
 tls_alert(conn, 2, alert);
 return 
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
       ((void *)0)
# 408 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
           ;
}
# 418 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_global_init(void)
{
 return crypto_global_init();
}
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
void tlsv1_client_global_deinit(void)
{
...
struct tlsv1_client * tlsv1_client_init(void)
{
 ...
 conn = (struct tlsv1_client *)calloc(1, (sizeof(*conn)));
 if (conn == 
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
            ((void *)0)
# 448 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                )
  return 
# 449 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
        ((void *)0)
# 449 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
            ;

 conn->state = CLIENT_HELLO;

 if (tls_verify_hash_init(&conn->verify) < 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
             ;
  free((conn));
  return 
# 457 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
        ((void *)0)
# 457 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
            ;
 }
...
void tlsv1_client_deinit(struct tlsv1_client *conn)
{
 ...
 tlsv1_record_set_cipher_suite(&conn->rl, 0x0000);
...
# 517 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_prf(struct tlsv1_client *conn, const char *label,
       int server_random_first, u8 *out, size_t out_len)
{
 u8 seed[2 * 32];
 ...
 return tls_prf(conn->rl.tls_version,
         conn->master_secret, 48,
         label, seed, 2 * 32, out, out_len);
}
# 550 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_get_cipher(struct tlsv1_client *conn, char *buf,
       size_t buflen)
{
# 595 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
    char cipher[20];
    ...
    memcpy(((u8 *)buf), ((u8 *)cipher), (buflen));
...
int tlsv1_client_shutdown(struct tlsv1_client *conn)
{
 ...
 if (tls_verify_hash_init(&conn->verify) < 0) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to re-initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to re-initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to re-initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to re-initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to re-initialize verify " "hash" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
             ;
  return -1;
 }
 ...
 crypto_public_key_free(conn->server_rsa_key);
 conn->server_rsa_key = 
# 660 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                       ((void *)0)
# 660 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                           ;
...
# 686 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_hello_ext(struct tlsv1_client *conn, int ext_type,
      const u8 *data, size_t data_len)
{
 u8 *pos;
 ...
 free((conn->client_hello_ext));
 conn->client_hello_ext = 
# 693 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
                         ((void *)0)
# 693 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                             ;
 conn->client_hello_ext_len = 0;

 if (data == 
# 696 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
            ((void *)0) 
# 696 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
                 || data_len == 0)
  return 0;

 pos = conn->client_hello_ext = malloc((6 + data_len));
 if (pos == 
# 700 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c" 3 4
           ((void *)0)
# 700 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
               )
  return -1;

 do { (pos)[0] = ((u16) (4 + data_len)) >> 8; (pos)[1] = ((u16) (4 + data_len)) & 0xff; } while (0);
 pos += 2;
 do { (pos)[0] = ((u16) (ext_type)) >> 8; (pos)[1] = ((u16) (ext_type)) & 0xff; } while (0);
 pos += 2;
 do { (pos)[0] = ((u16) (data_len)) >> 8; (pos)[1] = ((u16) (data_len)) & 0xff; } while (0);
 pos += 2;
 ...
 if (ext_type == 35) {
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Using session ticket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Using session ticket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Using session ticket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Using session ticket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Using session ticket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 }

 return 0;
}
# 727 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_get_keys(struct tlsv1_client *conn, struct tls_keys *keys)
{
...
# 753 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_get_keyblock_size(struct tlsv1_client *conn)
{
...
# 770 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_set_cipher_list(struct tlsv1_client *conn, u8 *ciphers)
{
 size_t count;
 u16 *suites;
 ...
 if (ciphers[0] == TLS_CIPHER_ANON_DH_AES128_SHA) {
  ...
  suites[count++] = 0x0018;
  suites[count++] = 0x001A;
# 796 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
  suites[count++] = 0x0034;
  conn->num_cipher_suites = count;
 }
...
# 814 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client.c"
int tlsv1_client_set_cred(struct tlsv1_client *conn,
     struct tlsv1_credentials *cred)
{
 tlsv1_cred_free(conn->cred);
...
void tlsv1_client_set_session_ticket_cb(struct tlsv1_client *conn,
     ...
     void *ctx)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: SessionTicket callback set %p (ctx %p)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cb, ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: SessionTicket callback set %p (ctx %p)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cb, ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: SessionTicket callback set %p (ctx %p)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cb, ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: SessionTicket callback set %p (ctx %p)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cb, ctx); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: SessionTicket callback set %p (ctx %p)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cb, ctx); } } while(0); } while(0)
             ;
