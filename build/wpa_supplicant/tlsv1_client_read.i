# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
int hmac_md5(const uint8_t *key, size_t key_len, const uint8_t *data, size_t data_len,
      uint8_t *mac);
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
void fast_sha256_prf(const uint8_t *key, size_t key_len, const char *label,
              const uint8_t *data, size_t data_len, uint8_t *buf, size_t buf_len);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
int tls_prf(u16 ver, const u8 *secret, size_t secret_len, const char *label,
     const u8 *seed, size_t seed_len, u8 *out, size_t outlen);
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/tlsv1_client.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/tlsv1_client.h"
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/tlsv1_client.h" 2
...
void tlsv1_client_set_session_ticket_cb(struct tlsv1_client *conn,
     ...
     void *ctx);
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/tlsv1_client_i.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/tls/tlsv1_client_i.h"
struct tlsv1_client {
 enum {
...
int tlsv1_client_process_handshake(struct tlsv1_client *conn, u8 ct,
       ...
       u8 **out_data, size_t *out_len);
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
...
# 22 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 2
        ...
        const u8 *in_data, size_t *in_len)
{
 ...
 if (*pos != TLS_HANDSHAKE_TYPE_SERVER_HELLO) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHello)" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHello)" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHello)" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHello)" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHello)" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } } while(0); } while(0)
                                                ;
  tls_alert(conn, 2,
     10);
  return -1;
 }
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 pos++;
 ...
 wpa_hexdump(ESP_LOG_VERBOSE, "TLSv1: ServerHello", pos, len);
 end = pos + len;


 if (end - pos < 2)
  goto decode_error;
 tls_version = ((u16) (((pos)[0] << 8) | (pos)[1]));
 if (!tls_version_ok(tls_version)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Unexpected protocol version in " "ServerHello %u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Unexpected protocol version in " "ServerHello %u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Unexpected protocol version in " "ServerHello %u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Unexpected protocol version in " "ServerHello %u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Unexpected protocol version in " "ServerHello %u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1]); } } while(0); } while(0)
                                          ;
  tls_alert(conn, 2,
     70);
  return -1;
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Using TLS v%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", tls_version_str(tls_version)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Using TLS v%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", tls_version_str(tls_version)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Using TLS v%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", tls_version_str(tls_version)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Using TLS v%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", tls_version_str(tls_version)); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Using TLS v%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", tls_version_str(tls_version)); } } while(0); } while(0)
                                  ;
 ...
 memcpy((conn->server_random), (pos), (32));
 pos += 32;
 ...
 if (conn->session_id_len && conn->session_id_len == *pos &&
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Resuming old session" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Resuming old session" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Resuming old session" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Resuming old session" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Resuming old session" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 ...
 if (end - pos < 2)
  goto decode_error;
 cipher_suite = ((u16) (((pos)[0] << 8) | (pos)[1]));
 pos += 2;
 ...
 if (i == conn->num_cipher_suites) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Server selected unexpected " "cipher suite 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Server selected unexpected " "cipher suite 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Server selected unexpected " "cipher suite 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Server selected unexpected " "cipher suite 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Server selected unexpected " "cipher suite 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } } while(0); } while(0)
                                          ;
  tls_alert(conn, 2,
     47);
  return -1;
 ...
 if (conn->session_resumed && cipher_suite != conn->prev_cipher_suite) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Server selected a different " "cipher suite for a resumed connection (0x%04x != " "0x%04x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite, conn->prev_cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Server selected a different " "cipher suite for a resumed connection (0x%04x != " "0x%04x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite, conn->prev_cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Server selected a different " "cipher suite for a resumed connection (0x%04x != " "0x%04x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite, conn->prev_cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Server selected a different " "cipher suite for a resumed connection (0x%04x != " "0x%04x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite, conn->prev_cipher_suite); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Server selected a different " "cipher suite for a resumed connection (0x%04x != " "0x%04x)" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite, conn->prev_cipher_suite); } } while(0); } while(0)
 ...
 if (end - pos < 1)
  goto decode_error;
 if (*pos != 0) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Server selected unexpected " "compression 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Server selected unexpected " "compression 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Server selected unexpected " "compression 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Server selected unexpected " "compression 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Server selected unexpected " "compression 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", *pos); } } while(0); } while(0)
                                 ;
  tls_alert(conn, 2,
     47);
  return -1;
 ...
 if (end != pos) {
  ...
  wpa_hexdump(ESP_LOG_DEBUG, "TLSv1: Unexpected extra data in the "
...
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                               ((void *)0)
# 180 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                   , 0,
...
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                          ((void *)0)
# 194 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                              , 0)) {
...
decode_error:
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to decode ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to decode ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to decode ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to decode ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to decode ServerHello" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 tls_alert(conn, 2, 50);
 return -1;
}
       ...
       const u8 *in_data, size_t *in_len)
{
 ...
 u8 type;
 struct x509_certificate *chain = 
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                 ((void *)0)
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                     , *last = 
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                               ((void *)0)
# 221 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
 ...
 if (type != TLS_HANDSHAKE_TYPE_CERTIFICATE) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected Certificate/" "ServerKeyExchange/CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected Certificate/" "ServerKeyExchange/CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected Certificate/" "ServerKeyExchange/CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected Certificate/" "ServerKeyExchange/CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected Certificate/" "ServerKeyExchange/CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } } while(0); } while(0)
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received Certificate (certificate_list len %lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received Certificate (certificate_list len %lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received Certificate (certificate_list len %lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received Certificate (certificate_list len %lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received Certificate (certificate_list len %lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len); } } while(0); } while(0)
                         ;
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
 end = pos + len;
 ...
 while (pos < end) {
  ...
  if (cert == 
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
             ((void *)0)
# 348 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                 ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to parse " "the certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to parse " "the certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to parse " "the certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to parse " "the certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to parse " "the certificate" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                         ;
   tls_alert(conn, 2,
  ...
  if (last == 
# 357 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
             ((void *)0)
# 357 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                 )
   chain = cert;
  else
   last->next = cert;
     ...
     const u8 *buf, size_t len)
{
 ...
 if (end - pos < 3)
  goto fail;
 conn->dh_p_len = ((u16) (((pos)[0] << 8) | (pos)[1]));
 pos += 2;
 if (conn->dh_p_len == 0 || end - pos < (int) conn->dh_p_len) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Invalid dh_p length %lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) conn->dh_p_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Invalid dh_p length %lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) conn->dh_p_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Invalid dh_p length %lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) conn->dh_p_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Invalid dh_p length %lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) conn->dh_p_len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Invalid dh_p length %lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) conn->dh_p_len); } } while(0); } while(0)
                                     ;
  goto fail;
 }
 conn->dh_p = malloc((conn->dh_p_len));
 if (conn->dh_p == 
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                  ((void *)0)
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                      )
  goto fail;
 memcpy((conn->dh_p), (pos), (conn->dh_p_len));
 pos += conn->dh_p_len;
 wpa_hexdump(ESP_LOG_DEBUG, "TLSv1: DH p (prime)",
      conn->dh_p, conn->dh_p_len);

 if (end - pos < 3)
  goto fail;
 conn->dh_g_len = ((u16) (((pos)[0] << 8) | (pos)[1]));
 pos += 2;
 if (conn->dh_g_len == 0 || end - pos < (int) conn->dh_g_len)
  goto fail;
 conn->dh_g = malloc((conn->dh_g_len));
 if (conn->dh_g == 
# 445 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                  ((void *)0)
# 445 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                      )
  goto fail;
 memcpy((conn->dh_g), (pos), (conn->dh_g_len));
 pos += conn->dh_g_len;
 wpa_hexdump(ESP_LOG_DEBUG, "TLSv1: DH g (generator)",
 ...
 if (end - pos < 3)
  goto fail;
 conn->dh_ys_len = ((u16) (((pos)[0] << 8) | (pos)[1]));
 pos += 2;
 if (conn->dh_ys_len == 0 || end - pos < (int) conn->dh_ys_len)
  goto fail;
 conn->dh_ys = malloc((conn->dh_ys_len));
 if (conn->dh_ys == 
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                   ((void *)0)
# 461 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                       )
  goto fail;
...
fail:
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Processing DH params failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Processing DH params failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Processing DH params failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Processing DH params failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Processing DH params failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 tlsv1_client_free_dh(conn);
 return -1;
}
        ...
        const u8 *in_data, size_t *in_len)
{
 ...
 if (left < 4) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short ServerKeyExchange " "(Left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short ServerKeyExchange " "(Left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short ServerKeyExchange " "(Left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short ServerKeyExchange " "(Left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short ServerKeyExchange " "(Left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } } while(0); } while(0)
                                         ;
  tls_alert(conn, 2, 50);
  return -1;
 }
 ...
 if (len > left) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Mismatch in ServerKeyExchange " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Mismatch in ServerKeyExchange " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Mismatch in ServerKeyExchange " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Mismatch in ServerKeyExchange " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Mismatch in ServerKeyExchange " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } } while(0); } while(0)
 ...
 if (type == TLS_HANDSHAKE_TYPE_SERVER_HELLO_DONE)
  return tls_process_server_hello_done(conn, ct, in_data,
           in_len);
 if (type != TLS_HANDSHAKE_TYPE_SERVER_KEY_EXCHANGE) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerKeyExchange/" "CertificateRequest/ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerKeyExchange/" "CertificateRequest/ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerKeyExchange/" "CertificateRequest/ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerKeyExchange/" "CertificateRequest/ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerKeyExchange/" "CertificateRequest/ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } } while(0); } while(0)
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received ServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received ServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received ServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received ServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received ServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);

 if (!tls_server_key_exchange_allowed(conn->rl.cipher_suite)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: ServerKeyExchange not allowed " "with the selected cipher suite" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: ServerKeyExchange not allowed " "with the selected cipher suite" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: ServerKeyExchange not allowed " "with the selected cipher suite" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: ServerKeyExchange not allowed " "with the selected cipher suite" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: ServerKeyExchange not allowed " "with the selected cipher suite" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                       ;
  tls_alert(conn, 2,
     10);
  return -1;
 ...
 wpa_hexdump(ESP_LOG_DEBUG, "TLSv1: ServerKeyExchange", pos, len);
 ...
 if (suite && suite->key_exchange == TLS_KEY_X_DH_anon) {
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: UnexpectedServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: UnexpectedServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: UnexpectedServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: UnexpectedServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: UnexpectedServerKeyExchange" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  tls_alert(conn, 2,
     10);
  return -1;
 }
        ...
        const u8 *in_data, size_t *in_len)
{
 ...
 if (left < 4) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short CertificateRequest " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short CertificateRequest " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short CertificateRequest " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short CertificateRequest " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short CertificateRequest " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } } while(0); } while(0)
                                         ;
  tls_alert(conn, 2, 50);
  return -1;
 }
 ...
 if (len > left) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Mismatch in CertificateRequest " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Mismatch in CertificateRequest " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Mismatch in CertificateRequest " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Mismatch in CertificateRequest " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Mismatch in CertificateRequest " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } } while(0); } while(0)
 ...
 if (type == TLS_HANDSHAKE_TYPE_SERVER_HELLO_DONE)
  return tls_process_server_hello_done(conn, ct, in_data,
           in_len);
 if (type != TLS_HANDSHAKE_TYPE_CERTIFICATE_REQUEST) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected CertificateRequest/" "ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } } while(0); } while(0)
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received CertificateRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received CertificateRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received CertificateRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received CertificateRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received CertificateRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
      ...
      const u8 *in_data, size_t *in_len)
{
 ...
 if (left < 4) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short ServerHelloDone " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short ServerHelloDone " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short ServerHelloDone " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short ServerHelloDone " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short ServerHelloDone " "(left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) left); } } while(0); } while(0)
                                         ;
  tls_alert(conn, 2, 50);
  return -1;
 }
 ...
 if (len > left) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Mismatch in ServerHelloDone " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Mismatch in ServerHelloDone " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Mismatch in ServerHelloDone " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Mismatch in ServerHelloDone " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Mismatch in ServerHelloDone " "length (len=%lu != left=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) len, (unsigned long) left); } } while(0); } while(0)
 ...
 if (type != TLS_HANDSHAKE_TYPE_SERVER_HELLO_DONE) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received unexpected handshake " "message %d (expected ServerHelloDone)" "\033[0m" "\n", esp_log_timestamp(), "wpa", type); } } while(0); } while(0)
                                                    ;
  tls_alert(conn, 2,
     10);
  return -1;
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received ServerHelloDone" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received ServerHelloDone" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received ServerHelloDone" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received ServerHelloDone" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received ServerHelloDone" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
       ...
       size_t *in_len)
{
 ...
 if (ct != TLS_CONTENT_TYPE_CHANGE_CIPHER_SPEC) {
  ...
  if (conn->use_session_ticket) {
   int res;
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Server may have " "rejected SessionTicket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Server may have " "rejected SessionTicket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Server may have " "rejected SessionTicket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Server may have " "rejected SessionTicket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Server may have " "rejected SessionTicket" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                ;
   ...
   res = conn->session_ticket_cb(
    conn->session_ticket_cb_ctx, 
# 702 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                ((void *)0)
# 702 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                    , 0, 
# 702 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                         ((void *)0)
# 702 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
...
# 703 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
   ((void *)0)
# 703 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
       , 
# 703 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
         ((void *)0)
# 703 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
           ...
           const u8 *in_data, size_t *in_len)
{
 ...
 wpa_hexdump(ESP_LOG_VERBOSE, "TLSv1: verify_data in Finished",
      pos, 12);
# 835 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
 hlen = 16;
 if (conn->verify.md5_server == 
# 836 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                               ((void *)0) 
# 836 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                    ||
     crypto_hash_finish(conn->verify.md5_server, hash, &hlen) < 0) {
  tls_alert(conn, 2,
     80);
  conn->verify.md5_server = 
# 840 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                           ((void *)0)
# 840 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                               ;
  crypto_hash_finish(conn->verify.sha1_server, 
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                              ((void *)0)
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                                  , 
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                                    ((void *)0)
# 841 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
...
# 842 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                            ((void *)0)
# 842 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                ;
  return -1;
 }
 conn->verify.md5_server = 
# 845 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                          ((void *)0)
# 845 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                              ;
 hlen = 20;
 if (conn->verify.sha1_server == 
# 847 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                                ((void *)0) 
# 847 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                     ||
     crypto_hash_finish(conn->verify.sha1_server, hash + 16,
          &hlen) < 0) {
  conn->verify.sha1_server = 
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                            ((void *)0)
# 850 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                                ;
  tls_alert(conn, 2,
     80);
  return -1;
 ...
 conn->verify.sha1_server = 
# 855 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c" 3 4
                           ((void *)0)
# 855 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_client_read.c"
                               ;
 hlen = 16 + 20;
     ...
     u8 **out_data, size_t *out_len)
{
 ...
 if (ct != TLS_CONTENT_TYPE_APPLICATION_DATA) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Expected Application Data; " "received content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Expected Application Data; " "received content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Expected Application Data; " "received content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Expected Application Data; " "received content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Expected Application Data; " "received content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } } while(0); } while(0)
                                       ;
  tls_alert(conn, 2,
     10);
  return -1;
 ...
 wpa_hexdump(ESP_LOG_DEBUG, "TLSv1: Application Data included in Handshake",
      pos, left);

 *out_data = malloc((left));
 if (*out_data) {
       ...
       u8 **out_data, size_t *out_len)
{
 ...
 if (ct == TLS_CONTENT_TYPE_HANDSHAKE && *len >= 4 &&
  ...
  size_t hr_len = ((((u32) (buf + 1)[0]) << 16) | (((u32) (buf + 1)[1]) << 8) | ((u32) (buf + 1)[2]));
  if (hr_len > *len - 4) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: HelloRequest underflow" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: HelloRequest underflow" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: HelloRequest underflow" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: HelloRequest underflow" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: HelloRequest underflow" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   tls_alert(conn, 2,
      50);
   return -1;
  }
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Ignored HelloRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Ignored HelloRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Ignored HelloRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Ignored HelloRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Ignored HelloRequest" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  *len = 4 + hr_len;
  return 0;
 }
