# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h" 1
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/wpabuf.h" 1
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 2
# 25 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
int eap_hdr_len_valid(const struct wpabuf *msg, size_t min_payload)
{
 ...
 if (msg == 
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
           ((void *)0)
# 30 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
               )
  return 0;
 ...
 if (wpabuf_len(msg) < sizeof(*hdr)) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Too short EAP frame" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Too short EAP frame" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Too short EAP frame" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Too short EAP frame" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Too short EAP frame" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 0;
 }
 ...
 if (len < sizeof(*hdr) + min_payload || len > wpabuf_len(msg)) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid EAP length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid EAP length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid EAP length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid EAP length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid EAP length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 0;
 }

 return 1;
}
# 66 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
const u8 * eap_hdr_validate(int vendor, EapType eap_type,
       const struct wpabuf *msg, size_t *plen)
{
 const struct eap_hdr *hdr;
 ...
 if (!eap_hdr_len_valid(msg, 1))
  return 
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
        ((void *)0)
# 74 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
            ;
 ...
 if (*pos == EAP_TYPE_EXPANDED) {
  ...
  u32 exp_type;
  if (len < sizeof(*hdr) + 8) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   return 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
  pos++;
  exp_vendor = ((((u32) (pos)[0]) << 16) | (((u32) (pos)[1]) << 8) | ((u32) (pos)[2]));
  pos += 3;
  exp_type = ((((u32) (pos)[0]) << 24) | (((u32) (pos)[1]) << 16) | (((u32) (pos)[2]) << 8) | ((u32) (pos)[3]));
  pos += 4;
  if (exp_vendor != vendor || exp_type != (u32) eap_type) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
              ;
   return 
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 96 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
  ...
  *plen = len - sizeof(*hdr) - 8;
  ...
  if (vendor != EAP_VENDOR_IETF || *pos != eap_type) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid frame type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid frame type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid frame type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid frame type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid frame type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   return 
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 104 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
...
# 128 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
struct wpabuf * eap_msg_alloc(int vendor, EapType type, size_t payload_len,
         u8 code, u8 identifier)
{
 struct wpabuf *buf;
 ...
 if (buf == 
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
           ((void *)0)
# 138 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
               )
  return 
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c" 3 4
        ((void *)0)
# 139 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
            ;

 hdr = wpabuf_put(buf, sizeof(*hdr));
 hdr->code = code;
 hdr->identifier = identifier;
 hdr->length = (( be16) (__extension__ ({ unsigned short int __bsx = ((len)); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); })));
...
# 167 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wps/eap_common.c"
void eap_update_len(struct wpabuf *msg)
{
 struct eap_hdr *hdr;
 ...
 if (wpabuf_len(msg) < sizeof(*hdr))
  return;
 hdr->length = (( be16) (__extension__ ({ unsigned short int __bsx = ((wpabuf_len(msg))); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); })));
}
