# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c"
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c"
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c" 2
...
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c" 2
...
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
# 20 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c" 2
...
# 21 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c" 2
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c"
int fast_aes_wrap(const uint8_t *kek, int n, const uint8_t *plain, uint8_t *cipher)
{
    ...
    esp_aes_init(&ctx);
    ret = esp_aes_setkey(&ctx, kek, 128);
    if (ret < 0) {
        esp_aes_free(&ctx);
        return ret;
    }
# 59 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/fast_crypto/fast_aes-wrap.c"
    for (j = 0; j <= 5; j++) {
 r = cipher + 8;
 for (i = 1; i <= n; i++) {
            memcpy((b), (a), (8));
            memcpy((b + 8), (r), (8));
            ret = esp_internal_aes_encrypt(&ctx, b, b);
            if (ret != 0) {
                break;
            }
            memcpy((a), (b), (8));
