# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
# 26 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
      ...
      size_t *ucs2_string_size)
{
 ...
 for (i = 0, j = 0; i < utf8_string_len; i++) {
  ...
  if (c <= 0x7F) {
   do { (ucs2_buffer + j)[1] = ((u16) (c)) >> 8; (ucs2_buffer + j)[0] = ((u16) (c)) & 0xff; } while (0);
   j += 2;
   ...
   if ((c & 0xE0) == 0xC0) {
    ...
    do { (ucs2_buffer + j)[1] = ((u16) (((c & 0x1F) << 6) | (c2 & 0x3F))) >> 8; (ucs2_buffer + j)[0] = ((u16) (((c & 0x1F) << 6) | (c2 & 0x3F))) & 0xff; } while (0)
                                          ;
    j += 2;
    ...
    u8 c3 = utf8_string[++i];
    do { (ucs2_buffer + j)[1] = ((u16) (((c & 0xF) << 12) | ((c2 & 0x3F) << 6) | (c3 & 0x3F))) >> 8; (ucs2_buffer + j)[0] = ((u16) (((c & 0xF) << 12) | ((c2 & 0x3F) << 6) | (c3 & 0x3F))) & 0xff; } while (0)
...
# 81 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
...
# 110 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int nt_password_hash(const u8 *password, size_t password_len,
   u8 *password_hash)
{
 u8 buf[512], *pos;
...
# 132 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int hash_nt_password_hash(const u8 *password_hash, u8 *password_hash_hash)
{
 size_t len = 16;
 return md4_vector(1, &password_hash, &len, password_hash_hash);
}
# 145 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
void challenge_response(const u8 *challenge, const u8 *password_hash,
     u8 *response)
{
 u8 zpwd[7];
...
# 169 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_nt_response(const u8 *auth_challenge, const u8 *peer_challenge,
       const u8 *username, size_t username_len,
       const u8 *password, size_t password_len,
       u8 *response)
...
# 197 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_nt_response_pwhash(const u8 *auth_challenge,
       const u8 *peer_challenge,
       const u8 *username, size_t username_len,
       const u8 *password_hash,
...
# 226 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_authenticator_response_pwhash(
 const u8 *password_hash,
 const u8 *peer_challenge, const u8 *auth_challenge,
 const u8 *username, size_t username_len,
 const u8 *nt_response, u8 *response)
{
 ...
 const size_t len2[3] = { 20, 8, sizeof(magic2) };
...
# 285 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_authenticator_response(const u8 *password, size_t password_len,
    const u8 *peer_challenge,
    const u8 *auth_challenge,
    const u8 *username, size_t username_len,
...
# 308 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int nt_challenge_response(const u8 *challenge, const u8 *password,
        size_t password_len, u8 *response)
{
 u8 password_hash[16];
...
# 326 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int get_master_key(const u8 *password_hash_hash, const u8 *nt_response,
        u8 *master_key)
{
...
# 358 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int get_asymetric_start_key(const u8 *master_key, u8 *session_key,
   size_t session_key_len, int is_send,
   int is_server)
{
 ...
 if (session_key_len > 20)
  session_key_len = 20;
 memcpy((session_key), (digest), (session_key_len));
 return 0;
}
# 430 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int encrypt_pw_block_with_password_hash(
 const u8 *password, size_t password_len,
 const u8 *password_hash, u8 *pw_block)
{
 ...
 if (offset != 0) {
  memmove((pw_block + offset), (pw_block), (ucs2_len * 2));
 ...
 pos = &pw_block[2 * 256];
 do { (pos)[1] = ((u16) (password_len * 2)) >> 8; (pos)[0] = ((u16) (password_len * 2)) & 0xff; } while (0);
 rc4_skip(password_hash, 16, 0, pw_block, 516);
 return 0;
}
# 471 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
...
# 494 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
void nt_password_hash_encrypted_with_block(const u8 *password_hash,
          const u8 *block, u8 *cypher)
{
...
# 511 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/crypto/ms_funcs.c"
int old_nt_password_hash_encrypted_with_new_nt_password_hash(
 const u8 *new_password, size_t new_password_len,
 const u8 *old_password, size_t old_password_len,
 u8 *encrypted_password_hash)
