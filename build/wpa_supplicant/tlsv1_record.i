# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
# 9 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
# 12 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
int hmac_md5(const uint8_t *key, size_t key_len, const uint8_t *data, size_t data_len,
      uint8_t *mac);
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
void fast_sha256_prf(const uint8_t *key, size_t key_len, const char *label,
              const uint8_t *data, size_t data_len, uint8_t *buf, size_t buf_len);
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
# 16 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
...
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 2
# 31 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
int tlsv1_record_set_cipher_suite(struct tlsv1_record_layer *rl,
      u16 cipher_suite)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Selected cipher suite: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Selected cipher suite: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Selected cipher suite: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Selected cipher suite: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Selected cipher suite: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", cipher_suite); } } while(0); } while(0)
                  ;
 rl->cipher_suite = cipher_suite;

 suite = tls_get_cipher_suite(cipher_suite);
 if (suite == 
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 42 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                 )
  return -1;
 ...
 if (data == 
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
            ((void *)0)
# 57 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                )
  return -1;
...
# 76 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
int tlsv1_record_change_write_cipher(struct tlsv1_record_layer *rl)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - New write cipher suite " "0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - New write cipher suite " "0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - New write cipher suite " "0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - New write cipher suite " "0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - New write cipher suite " "0x%04x" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } } while(0); } while(0)
                                ;
 rl->write_cipher_suite = rl->cipher_suite;
 memset(rl->write_seq_num, 0, 8);

 if (rl->write_cbc) {
  if (wpa2_crypto_funcs.crypto_cipher_deinit) {
   wpa2_crypto_funcs.crypto_cipher_deinit(rl->write_cbc);
   rl->write_cbc = 
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                  ((void *)0)
# 86 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                      ;
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   return -1;
  }
 }
 if (rl->cipher_alg != CRYPTO_CIPHER_NULL) {
  if (wpa2_crypto_funcs.crypto_cipher_init) {
   ...
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto_cipher_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto_cipher_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto_cipher_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto_cipher_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto_cipher_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   return -1;
  }

  if (rl->write_cbc == 
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                      ((void *)0)
# 102 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                          ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   return -1;
  }
 }
...
# 121 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
int tlsv1_record_change_read_cipher(struct tlsv1_record_layer *rl)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - New read cipher suite " "0x%04x \n" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - New read cipher suite " "0x%04x \n" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - New read cipher suite " "0x%04x \n" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - New read cipher suite " "0x%04x \n" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - New read cipher suite " "0x%04x \n" "\033[0m" "\n", esp_log_timestamp(), "wpa", rl->cipher_suite); } } while(0); } while(0)
                                   ;
 rl->read_cipher_suite = rl->cipher_suite;
 memset(rl->read_seq_num, 0, 8);

 if (rl->read_cbc) {
  if (wpa2_crypto_funcs.crypto_cipher_deinit) {
   wpa2_crypto_funcs.crypto_cipher_deinit(rl->read_cbc);
   rl->read_cbc = 
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                  ((void *)0)
# 131 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                      ;
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto cipher deinit function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
   return -1;
 ...
 if (rl->cipher_alg != CRYPTO_CIPHER_NULL) {
  ...
  if (rl->read_cbc == 
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                     ((void *)0)
# 147 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                         ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   return -1;
...
# 173 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
int tlsv1_record_send(struct tlsv1_record_layer *rl, u8 content_type, u8 *buf,
        size_t buf_size, const u8 *payload, size_t payload_len,
        size_t *out_len)
{
...
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                           ((void *)0)
# 178 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                               ;
 size_t clen;
 int explicit_iv;

 pos = buf;
 if (pos + 5 > buf + buf_size)
  return -1;
 ...
 *pos++ = content_type;
 ...
 do { (pos)[0] = ((u16) (rl->tls_version)) >> 8; (pos)[1] = ((u16) (rl->tls_version)) & 0xff; } while (0);
 pos += 2;

 length = pos;
 do { (length)[0] = ((u16) (payload_len)) >> 8; (length)[1] = ((u16) (payload_len)) & 0xff; } while (0);
 pos += 2;

 cpayload = pos;
 explicit_iv = rl->write_cipher_suite != 0x0000 &&
  rl->iv_size && rl->tls_version >= 0x0302;
 if (explicit_iv) {
 ...
 if (pos + payload_len > buf + buf_size)
  return -1;
 memmove((pos), (payload), (payload_len));
 pos += payload_len;

 if (rl->write_cipher_suite != 0x0000) {
  ...
  if (wpa2_crypto_funcs.crypto_hash_init) {
   ...
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto hash init!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto hash init!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto hash init!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto hash init!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto hash init!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
   return -1;
  }
  if (hmac == 
# 236 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 236 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                 ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                            ;
   return -1;
  }
         if (wpa2_crypto_funcs.crypto_hash_update) {
   wpa2_crypto_funcs.crypto_hash_update(hmac, rl->write_seq_num, 8);

   wpa2_crypto_funcs.crypto_hash_update(hmac, ct_start, 5);
   wpa2_crypto_funcs.crypto_hash_update(hmac, payload, payload_len);
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto hash update!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto hash update!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto hash update!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto hash update!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto hash update!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
   return -1;
  }
  clen = buf + buf_size - pos;
  if (clen < rl->hash_size) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                             ;
   if (wpa2_crypto_funcs.crypto_hash_finish) {
    wpa2_crypto_funcs.crypto_hash_finish(hmac, 
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                                              ((void *)0)
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                                                  , 
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                                                    ((void *)0)
# 255 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
    ...
    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto hash finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto hash finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto hash finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto hash finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto hash finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
    return -1;
   }
  ...
  if (wpa2_crypto_funcs.crypto_hash_finish) {
   if ((int)wpa2_crypto_funcs.crypto_hash_finish(hmac, pos, (int *)&clen) < 0) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Failed to calculate HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Failed to calculate HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Failed to calculate HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Failed to calculate HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Failed to calculate HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
    return -1;
   }
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto_hash_finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa",__FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto_hash_finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa",__FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto_hash_finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa",__FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto_hash_finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa",__FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto_hash_finish function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa",__FUNCTION__); } } while(0); } while(0);
   return -1;
  }
  wpa_hexdump(ESP_LOG_VERBOSE, "TLSv1: Record Layer - Write HMAC",
       pos, clen);
  pos += clen;
  if (rl->iv_size) {
   ...
   if (pos + pad + 1 > buf + buf_size) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: No room for " "block cipher padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: No room for " "block cipher padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: No room for " "block cipher padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: No room for " "block cipher padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: No room for " "block cipher padding" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                               ;
    return -1;
   }
  ...
  if (wpa2_crypto_funcs.crypto_cipher_encrypt) {
   if ((int)wpa2_crypto_funcs.crypto_cipher_encrypt(rl->write_cbc, cpayload,
          ...
          do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto_cipher_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto_cipher_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto_cipher_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto_cipher_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto_cipher_encrypt function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
          return -1;
  }
 }

 do { (length)[0] = ((u16) (pos - length - 2)) >> 8; (length)[1] = ((u16) (pos - length - 2)) & 0xff; } while (0);
 inc_byte_array(rl->write_seq_num, 8);

 *out_len = pos - buf;

 return 0;
}
# 325 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
int tlsv1_record_receive(struct tlsv1_record_layer *rl,
    const u8 *in_data, size_t in_len,
    u8 *out_data, size_t *out_len, u8 *alert)
{
 ...
 u8 padlen;
 struct crypto_hash *hmac = 
# 331 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
                           ((void *)0)
# 331 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                               ;
 u8 len[2], hash[100];
 ...
 if (in_len < 5) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short record (in_len=%lu) - " "need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short record (in_len=%lu) - " "need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short record (in_len=%lu) - " "need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short record (in_len=%lu) - " "need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) in_len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short record (in_len=%lu) - " "need more data" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) in_len); } } while(0); } while(0)

                             ;
  wpa_hexdump(ESP_LOG_VERBOSE, "TLSv1: Record Layer - Received",
       in_data, in_len);
  return 0;
 }

 ct = in_data[0];
 rlen = ((u16) (((in_data + 3)[0] << 8) | (in_data + 3)[1]));
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Received content type %d version %d.%d " "length %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct, in_data[1], in_data[2], (int) rlen); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Received content type %d version %d.%d " "length %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct, in_data[1], in_data[2], (int) rlen); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Received content type %d version %d.%d " "length %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct, in_data[1], in_data[2], (int) rlen); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Received content type %d version %d.%d " "length %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct, in_data[1], in_data[2], (int) rlen); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Received content type %d version %d.%d " "length %d" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct, in_data[1], in_data[2], (int) rlen); } } while(0); } while(0)
                                                         ;
 ...
 if (in_data[1] != 0x03) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Unexpected protocol version " "%u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", in_data[1], in_data[2]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Unexpected protocol version " "%u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", in_data[1], in_data[2]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Unexpected protocol version " "%u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", in_data[1], in_data[2]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Unexpected protocol version " "%u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", in_data[1], in_data[2]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Unexpected protocol version " "%u.%u" "\033[0m" "\n", esp_log_timestamp(), "wpa", in_data[1], in_data[2]); } } while(0); } while(0)
                                      ;
  *alert = 70;
  return -1;
 }
 ...
 if (5 + rlen > 18432) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + rlen)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + rlen)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + rlen)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + rlen)); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + rlen)); } } while(0); } while(0)
                                                     ;
  *alert = 22;
  return -1;
 }
 ...
 if (rlen > in_len) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Not all record data included " "(rlen=%lu > in_len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rlen, (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Not all record data included " "(rlen=%lu > in_len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rlen, (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Not all record data included " "(rlen=%lu > in_len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rlen, (unsigned long) in_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Not all record data included " "(rlen=%lu > in_len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rlen, (unsigned long) in_len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Not all record data included " "(rlen=%lu > in_len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rlen, (unsigned long) in_len); } } while(0); } while(0)
 ...
 if (ct != TLS_CONTENT_TYPE_HANDSHAKE &&
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Ignore record with unknown " "content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Ignore record with unknown " "content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Ignore record with unknown " "content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Ignore record with unknown " "content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Ignore record with unknown " "content type 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", ct); } } while(0); } while(0)
                              ;
  *alert = 10;
  return -1;
 }
 ...
 if (*out_len < in_len) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Not enough output buffer for " "processing received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Not enough output buffer for " "processing received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Not enough output buffer for " "processing received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Not enough output buffer for " "processing received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Not enough output buffer for " "processing received record" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                   ;
  *alert = 80;
  return -1;
 }

 if (rl->read_cipher_suite != 0x0000) {
  size_t plen;
  if (wpa2_crypto_funcs.crypto_cipher_decrypt) {
    ...
    *alert = 21;
    return -1;
          ...
          do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Fail to register crypto cipher decrypt function. \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Fail to register crypto cipher decrypt function. \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Fail to register crypto cipher decrypt function. \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Fail to register crypto cipher decrypt function. \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Fail to register crypto cipher decrypt function. \r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
          *alert = 21;
          return -1;
  }
  plen = in_len;
  wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: Record Layer - Decrypted "
    "data", out_data, plen);

  if (rl->iv_size) {
# 431 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
   if (rl->tls_version >= 0x0302) {

    if (plen < rl->iv_size) {
     do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1.1: Not " "enough room for IV" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1.1: Not " "enough room for IV" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1.1: Not " "enough room for IV" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1.1: Not " "enough room for IV" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1.1: Not " "enough room for IV" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                              ;
     force_mac_error = 1;
     goto check_mac;
    }
    memmove((out_data), (out_data + rl->iv_size), (plen - rl->iv_size))
                           ;
    plen -= rl->iv_size;
   }
   ...
   if (plen == 0) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short record" " (no pad)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short record" " (no pad)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short record" " (no pad)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short record" " (no pad)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short record" " (no pad)" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
    force_mac_error = 1;
    goto check_mac;
   }
   ...
   if (padlen >= plen) {
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Incorrect pad " "length (%u, plen=%lu) in " "received record" "\033[0m" "\n", esp_log_timestamp(), "wpa", padlen, (unsigned long) plen); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Incorrect pad " "length (%u, plen=%lu) in " "received record" "\033[0m" "\n", esp_log_timestamp(), "wpa", padlen, (unsigned long) plen); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Incorrect pad " "length (%u, plen=%lu) in " "received record" "\033[0m" "\n", esp_log_timestamp(), "wpa", padlen, (unsigned long) plen); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Incorrect pad " "length (%u, plen=%lu) in " "received record" "\033[0m" "\n", esp_log_timestamp(), "wpa", padlen, (unsigned long) plen); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Incorrect pad " "length (%u, plen=%lu) in " "received record" "\033[0m" "\n", esp_log_timestamp(), "wpa", padlen, (unsigned long) plen); } } while(0); } while(0)
   ...
   wpa_hexdump_key(ESP_LOG_VERBOSE, "TLSv1: Record Layer - "
 ...
 check_mac:
  if (plen < rl->hash_size) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Too short record; no " "hash value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Too short record; no " "hash value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Too short record; no " "hash value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Too short record; no " "hash value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Too short record; no " "hash value" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                    ;
   *alert = 20;
   return -1;
  }
  ...
  if (wpa2_crypto_funcs.crypto_hash_init) {
   ...
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto_hash_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto_hash_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto_hash_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto_hash_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto_hash_init function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
   return -1;
  }

  if (hmac == 
# 496 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 496 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/tls/tlsv1_record.c"
                 ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                            ;
   *alert = 80;
  ...
  if (wpa2_crypto_funcs.crypto_hash_update) {
   wpa2_crypto_funcs.crypto_hash_update(hmac, rl->read_seq_num, 8);

   wpa2_crypto_funcs.crypto_hash_update(hmac, in_data - 5, 3);
   do { (len)[0] = ((u16) (plen)) >> 8; (len)[1] = ((u16) (plen)) & 0xff; } while (0);
   wpa2_crypto_funcs.crypto_hash_update(hmac, len, 2);
   wpa2_crypto_funcs.crypto_hash_update(hmac, out_data, plen);
  } else {
   do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "In function %s, fail to register crypto hash update function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "In function %s, fail to register crypto hash update function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "In function %s, fail to register crypto hash update function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "In function %s, fail to register crypto hash update function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "In function %s, fail to register crypto hash update function!\r\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", __FUNCTION__); } } while(0); } while(0);
   return -1;
  }
  hlen = sizeof(hash);
  if (wpa2_crypto_funcs.crypto_hash_finish) {
  ...
  if (hlen != rl->hash_size ||
      memcmp((hash), (out_data + plen), (hlen)) != 0 ||
      force_mac_error) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Invalid HMAC value in " "received message (force_mac_error=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", force_mac_error); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Invalid HMAC value in " "received message (force_mac_error=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", force_mac_error); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Invalid HMAC value in " "received message (force_mac_error=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", force_mac_error); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Invalid HMAC value in " "received message (force_mac_error=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", force_mac_error); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Invalid HMAC value in " "received message (force_mac_error=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", force_mac_error); } } while(0); } while(0)
 ...
 if (5 + *out_len > 17408) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + *out_len)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + *out_len)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + *out_len)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + *out_len)); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record overflow (len=%lu)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) (5 + *out_len)); } } while(0); } while(0)
                                                         ;
  *alert = 22;
  return -1;
 }

 inc_byte_array(rl->read_seq_num, 8);
