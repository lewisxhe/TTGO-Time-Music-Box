# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
# 1 "D:\\ESP32\\esp-idf-v3.1-rc1\\ESP32_PIC_A2DP\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
# 10 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa/includes.h" 1
# 11 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
# 13 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
# 14 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
# 15 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
# 17 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
# 1 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/include/wpa2/eap_peer/eap_config.h" 1
# 18 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
void eap_peer_unregister_methods(void);
int eap_peer_register_methods(void);
# 19 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 2
...
static void eap_tls_deinit(struct eap_sm *sm, void *priv)
{
 ...
 if (data == 
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
            ((void *)0)
# 34 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                )
  return;
...
static void * eap_tls_init(struct eap_sm *sm)
{
 ...
 if (config == 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
              ((void *)0) 
# 47 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                   ||
     config->private_key == 0) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Private key not configured" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Private key not configured" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Private key not configured" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Private key not configured" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Private key not configured" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  return 
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 50 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;
 }

 data = (struct eap_tls_data *)calloc(1, (sizeof(*data)));
 if (data == 
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
            ((void *)0)
# 54 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                )
  return 
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 55 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;

 data->ssl_ctx = sm->ssl_ctx;

 if (eap_peer_tls_ssl_init(sm, &data->ssl, config, EAP_TYPE_TLS)) {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Failed to initialize SSL." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Failed to initialize SSL." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Failed to initialize SSL." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Failed to initialize SSL." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Failed to initialize SSL." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  eap_tls_deinit(sm, data);
  return 
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 62 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;
 }
...
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: TLS processing failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: TLS processing failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: TLS processing failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: TLS processing failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: TLS processing failed" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 ...
 if (res == -1) {
  ...
  if (config) {
   ...
   free((config->pin));
   config->pin = 
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
                ((void *)0)
# 90 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                    ;
  }
 }
...
static void eap_tls_success(struct eap_sm *sm, struct eap_tls_data *data,
       struct eap_method_ret *ret)
{
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Done" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Done" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Done" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Done" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Done" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 ...
 data->key_data = eap_peer_tls_derive_key(sm, &data->ssl,
       ...
       64);
 if (data->key_data) {
  wpa_hexdump_key(ESP_LOG_DEBUG, "EAP-TLS: Derived key",
    data->key_data, 64);
  wpa_hexdump_key(ESP_LOG_DEBUG, "EAP-TLS: Derived EMSK",
    data->key_data + 64,
    64);
 } else {
  do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Failed to derive key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Failed to derive key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Failed to derive key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Failed to derive key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Failed to derive key" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 }
 ...
 data->session_id = eap_peer_tls_derive_session_id(sm, &data->ssl,
         EAP_TYPE_TLS,
                                     &data->id_len);
 if (data->session_id) {
  wpa_hexdump(ESP_LOG_DEBUG, "EAP-TLS: Derived Session-Id",
       data->session_id, data->id_len);
 } else {
  do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Failed to derive Session-Id" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Failed to derive Session-Id" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Failed to derive Session-Id" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Failed to derive Session-Id" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Failed to derive Session-Id" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 }
}
           ...
           const struct wpabuf *reqData)
{
 ...
 pos = eap_peer_tls_process_init(sm, &data->ssl, data->eap_type, ret,
     reqData, &left, &flags);
 if (pos == 
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
           ((void *)0)
# 155 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
               )
  return 
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 156 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;
 id = eap_get_id(reqData);

 if (flags & 0x20) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP-TLS: Start" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP-TLS: Start" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP-TLS: Start" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP-TLS: Start" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP-TLS: Start" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
  left = 0;

 }

 resp = 
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
       ((void *)0)
# 165 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
           ;
...
static 
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
      _Bool 
# 184 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
           eap_tls_isKeyAvailable(struct eap_sm *sm, void *priv)
{
 struct eap_tls_data *data = priv;

 return data->key_data != 
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
                         ((void *)0)
# 188 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                             ;
}
static u8 * eap_tls_getKey(struct eap_sm *sm, void *priv, size_t *len)
{
 ...
 if (data->key_data == 
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
                      ((void *)0)
# 195 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
                          )
  return 
# 196 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 196 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;

 key = malloc((64));
 if (key == 
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
           ((void *)0)
# 199 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
               )
  return 
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
        ((void *)0)
# 200 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
            ;
...
int eap_peer_tls_register(void)
{
 ...
 if (eap == 
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c" 3 4
           ((void *)0)
# 216 "D:/ESP32/esp-idf-v3.1-rc1/components/wpa_supplicant/src/wpa2/eap_peer/eap_tls.c"
               )
  return -1;
