...
#define PIN_NUM_MOSI TFT_SPI_MOSI//23		// SPI MOSI
#define PIN_NUM_CLK  TFT_SPI_SCLK//18		// SPI CLOCK pin
#define PIN_NUM_CS   TFT_SPI_CS//5		// Display CS pin
#define PIN_NUM_DC   TFT_DC   //16		// Display command/data pin
#define PIN_NUM_TCS  0		// Touch screen CS pin (NOT used if USE_TOUCH=0)

// --------------------------------------------------------------
// ** Set Reset and Backlight pins to 0 if not used !
// ** If you want to use them, set them to some valid GPIO number
#define PIN_NUM_RST  TFT_RESET   //17  	// GPIO used for RESET control
